...
final class InstantPeriodicTask implements Callable, Disposable {
    ...
    void setFirst(Future future) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.first, future2, future));
    }
    ...
    void setRest(Future future) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.rest, future2, future));
    }
}
