...
public final class IoScheduler extends Scheduler {
    ...
    public void start() {
        ...
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
