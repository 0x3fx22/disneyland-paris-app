...
public final class ComputationScheduler extends Scheduler implements SchedulerMultiWorkerSupport {
    ...
    public void start() {
        ...
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pool, NONE, fixedSchedulerPool)) {
            return;
        }
        fixedSchedulerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pool, fixedSchedulerPool, fixedSchedulerPool2));
        fixedSchedulerPool.shutdown();
    }
