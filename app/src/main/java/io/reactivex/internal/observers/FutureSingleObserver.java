...
public final class FutureSingleObserver<T> extends CountDownLatch implements SingleObserver<T>, Future<T>, Disposable {
    ...
    public boolean cancel(boolean z) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.upstream, disposable, disposableHelper));
        if (disposable != null) {
            disposable.dispose();
        }
        countDown();
    ...
    public void onSuccess(T t) {
        ...
        this.value = t;
        PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.upstream, disposable, this);
        countDown();
    }
    ...
    public void onError(Throwable th) {
        ...
        do {
            ...
            this.error = th;
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.upstream, disposable, this));
        countDown();
    }
