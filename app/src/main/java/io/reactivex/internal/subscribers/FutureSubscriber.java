...
public final class FutureSubscriber<T> extends CountDownLatch implements FlowableSubscriber<T>, Future<T>, Subscription {
    ...
    public boolean cancel(boolean z) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.upstream, subscription, subscriptionHelper));
    ...
    public void onError(Throwable th) {
        ...
        do {
            ...
            this.error = th;
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.upstream, subscription, this));
        countDown();
    }
