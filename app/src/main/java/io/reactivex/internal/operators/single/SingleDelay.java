...
public final class SingleDelay<T> extends Single<T> {
    ...
    final class Delay implements SingleObserver {
        ...
        private final SequentialDisposable f3905sd;

        Delay(SequentialDisposable sequentialDisposable, SingleObserver singleObserver) {
            this.f3905sd = sequentialDisposable;
            this.downstream = singleObserver;
        }

        @Override // io.reactivex.SingleObserver
        public void onSubscribe(Disposable disposable) {
            this.f3905sd.replace(disposable);
        }

        @Override // io.reactivex.SingleObserver
        public void onSuccess(Object obj) {
            SequentialDisposable sequentialDisposable = this.f3905sd;
        ...
        final class OnError implements Runnable {
            ...
            private final Throwable f3906e;
            ...
            @Override // java.lang.Runnable
            public void run() {
                Delay.this.downstream.onError(this.f3906e);
            }
        }
    }
}
