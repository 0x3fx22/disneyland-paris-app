...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ObservablePublishClassic<T> {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.current, publishObserver, publishObserver2)) {
    ...
    static final class PublishObserver implements Observer, Disposable {
        ...
        boolean add(InnerDisposable innerDisposable) {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.observers, innerDisposableArr, innerDisposableArr2));
            return true;
        }
        ...
        public void subscribe(Observer observer) {
            ...
            while (true) {
                ...
                if (publishObserver == null || publishObserver.isDisposed()) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.curr, publishObserver, publishObserver2)) {
                        publishObserver = publishObserver2;
                    } else {
                        continue;
                    }
