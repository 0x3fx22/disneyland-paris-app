...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(Throwable th) {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.terminalEvent, null, th)) {
    ...
    public void onComplete() {
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
    ...
    boolean add(BehaviorSubscription behaviorSubscription) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.subscribers, behaviorSubscriptionArr, behaviorSubscriptionArr2));
        return true;
    }
