...
final class JUnitReporter {
    ...
    /* JADX INFO: renamed from: io.cucumber.junit.JUnitReporter$5 */
    static /* synthetic */ class C68625 {
    ...
    void handleStepResult(PickleStepTestStep pickleStepTestStep, Result result) {
        ...
        switch (C68625.$SwitchMap$cucumber$api$Result$Type[result.getStatus().ordinal()]) {
            case 1:
                break;
            case 2:
                if (error == null) {
    ...
    void handleTestCaseResult(Result result) {
        int i = C68625.$SwitchMap$cucumber$api$Result$Type[result.getStatus().ordinal()];
        if (i == 2) {
