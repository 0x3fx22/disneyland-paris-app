...
public class TagExpressionParser {
    ...
    private void pushExpr(String str, Deque deque) {
        ...
        switch (str) {
            case "or":
                deque.push(new C6869Or((Expression) pop(deque), (Expression) pop(deque)));
                break;
            case "and":
    ...
    /* JADX INFO: renamed from: io.cucumber.tagexpressions.TagExpressionParser$Or */
    private class C6869Or implements Expression {
        private final Expression left;
        private final Expression right;

        C6869Or(Expression expression, Expression expression2) {
