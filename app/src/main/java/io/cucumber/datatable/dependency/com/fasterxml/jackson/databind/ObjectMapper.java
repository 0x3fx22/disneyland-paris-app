...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.core.p103io.CharacterEscapes;
import io.cucumber.datatable.dependency.com.fasterxml.jackson.core.p103io.SegmentedStringWriter;
...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(JavaType javaType) {
            ...
            int i = C66893.f3821x3ef634e7[this._appliesFor.ordinal()];
            if (i == 1) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.ObjectMapper$3 */
    static /* synthetic */ class C66893 {

        /* JADX INFO: renamed from: $SwitchMap$com$fasterxml$jackson$databind$ObjectMapper$DefaultTyping */
        static final /* synthetic */ int[] f3821x3ef634e7;
        ...
        static {
            ...
            try {
                f3821x3ef634e7[DefaultTyping.OBJECT_AND_NON_CONCRETE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3821x3ef634e7[DefaultTyping.NON_FINAL.ordinal()] = 3;
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.EnumC6683As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.EnumC6683As enumC6683As) {
        if (enumC6683As == JsonTypeInfo.EnumC6683As.EXTERNAL_PROPERTY) {
            throw new IllegalArgumentException("Cannot use includeAs of " + enumC6683As);
        }
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC6684Id.CLASS, (TypeIdResolver) null).inclusion(enumC6683As));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.EnumC6684Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.EnumC6683As.PROPERTY).typeProperty(str));
    }
