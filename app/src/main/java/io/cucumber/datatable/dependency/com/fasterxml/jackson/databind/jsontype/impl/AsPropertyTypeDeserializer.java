...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    protected final JsonTypeInfo.EnumC6683As _inclusion;
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z, javaType2, JsonTypeInfo.EnumC6683As.PROPERTY);
    }

    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC6683As enumC6683As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC6683As;
    }
