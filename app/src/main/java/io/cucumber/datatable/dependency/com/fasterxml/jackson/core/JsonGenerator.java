...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        Object obj = writableTypeId.f3820id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C66851.f3801xa51b40dc[inclusion.ordinal()];
            if (i != 1 && i != 2) {
                if (i == 3) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.core.JsonGenerator$1 */
    static /* synthetic */ class C66851 {

        /* JADX INFO: renamed from: $SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion */
        static final /* synthetic */ int[] f3801xa51b40dc;
        ...
        static {
            ...
            try {
                f3801xa51b40dc[WritableTypeId.Inclusion.PAYLOAD_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3801xa51b40dc[WritableTypeId.Inclusion.METADATA_PROPERTY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3801xa51b40dc[WritableTypeId.Inclusion.WRAPPER_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3801xa51b40dc[WritableTypeId.Inclusion.WRAPPER_ARRAY.ordinal()] = 5;
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C66851.f3801xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f3820id;
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (jsonTokenCurrentToken.m1809id()) {
            case -1:
                _reportError("No current event to copy");
                break;
            case 0:
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int iM1809id = jsonTokenCurrentToken.m1809id();
        if (iM1809id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            iM1809id = jsonParser.nextToken().m1809id();
        }
        if (iM1809id == 1) {
            writeStartObject();
