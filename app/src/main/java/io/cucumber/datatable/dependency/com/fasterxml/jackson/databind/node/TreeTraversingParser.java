...
public class TreeTraversingParser extends ParserMinimalBase {
    ...
    public String getText() {
        ...
        int i = C67101.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.node.TreeTraversingParser$1 */
