...
public class TokenBuffer extends JsonGenerator {
    ...
    public void serialize(JsonGenerator jsonGenerator) throws IOException {
        ...
        while (true) {
            ...
            switch (C67251.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenType.ordinal()]) {
                case 1:
    ...
    public TokenBuffer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonParser.getCurrentTokenId() != JsonToken.FIELD_NAME.m1809id()) {
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (C67251.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonParser.getCurrentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C67251.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
            ...
            case 8:
                ...
                int i2 = C67251.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i2 == 3) {
                    writeNumber(jsonParser.getDecimalValue());
                    return;
                } else if (i2 == 4) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.util.TokenBuffer$1 */
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C67251.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            writeStartObject();
    ...
    protected static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            ...
            return jsonLocation == null ? JsonLocation.f3802NA : jsonLocation;
        }
        ...
        public String getText() {
            ...
            int i = C67251.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()];
            if (i == 7 || i == 8) {
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            int i = C67251.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[getNumberType().ordinal()];
            if (i != 1) {
                if (i == 2) {
