...
public abstract class TypeDeserializer {
    ...
    public static Object deserializeIfNatural(JsonParser jsonParser, DeserializationContext deserializationContext, Class<?> cls) throws IOException {
        ...
        int i = C67071.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.jsontype.TypeDeserializer$1 */
