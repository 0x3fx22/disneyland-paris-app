...
public final class CharTypes {
    ...
    private static final byte[] f3803HB;

    /* JADX INFO: renamed from: HC */
    private static final char[] f3804HC;
    ...
    static {
        ...
        f3803HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f3803HB[i2] = (byte) f3804HC[i2];
        }
    ...
    public static char[] copyHexChars() {
        return (char[]) f3804HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f3803HB.clone();
    }
}
