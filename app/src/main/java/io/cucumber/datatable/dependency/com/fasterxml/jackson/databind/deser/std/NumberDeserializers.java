...
import io.cucumber.datatable.dependency.com.fasterxml.jackson.core.p103io.NumberInput;
...
public class NumberDeserializers {
    ...
    public static final class BooleanDeserializer extends PrimitiveOrWrapperDeserializer<Boolean> {
        ...
        protected final Boolean _parseBoolean(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            if (currentToken == JsonToken.VALUE_STRING) {
                ...
                if ("true".equals(strTrim) || AlAppCenterEventTracker.APPCENTER_PROPERTY_SUCCESSFUL_TRUE.equals(strTrim)) {
    ...
    public static class BigIntegerDeserializer extends StdScalarDeserializer<BigInteger> {
        ...
        public BigInteger deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            if (currentTokenId == 7) {
                int i = C66931.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1 || i == 2 || i == 3) {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.dependency.com.fasterxml.jackson.databind.deser.std.NumberDeserializers$1 */
    static /* synthetic */ class C66931 {
