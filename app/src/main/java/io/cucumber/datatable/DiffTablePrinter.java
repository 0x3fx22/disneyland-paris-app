...
class DiffTablePrinter extends TablePrinter {
    ...
    /* JADX INFO: renamed from: io.cucumber.datatable.DiffTablePrinter$1 */
    ...
    protected void printStartIndent(Appendable appendable, int i) throws IOException {
        int i2 = C66811.$SwitchMap$io$cucumber$datatable$DiffType[((DiffType) this.diffTypes.get(i)).ordinal()];
        if (i2 == 1) {
            appendable.append("      ");
        } else if (i2 == 2) {
            appendable.append("    - ");
