    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i7 <= 0 || j == 0 || (i7 >= i11 - 1 && !z8 && iMax2 <= 1)) {
            ...
            if (z8) {
                ...
                if ((j & ((long) (1 << i27))) != 0 && !((LayoutParams) getChildAt(i27).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i28 = fBitCount > BitmapDescriptorFactory.HUE_RED ? (int) ((i7 * i9) / fBitCount) : i4;
            z2 = z;
