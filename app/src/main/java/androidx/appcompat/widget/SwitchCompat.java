...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        TextPaint textPaint = this.mTextPaint;
        return new StaticLayout(charSequence, textPaint, charSequence != null ? (int) Math.ceil(Layout.getDesiredWidth(charSequence, textPaint)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, BitmapDescriptorFactory.HUE_RED, true);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (i == 1) {
                ...
                float fConstrain = constrain(this.mThumbPosition + f, BitmapDescriptorFactory.HUE_RED, 1.0f);
