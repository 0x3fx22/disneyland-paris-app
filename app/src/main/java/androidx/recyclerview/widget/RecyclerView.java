...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
  ...
  0x00df: PHI (r0v37 int) = (r0v26 int), (r0v41 int) binds: [B:41:0x00c8, B:45:0x00db] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (((double) (this.mPhysicalCoef * 0.015f)) * Math.exp((((double) f) / (((double) f) - 1.0d)) * dLog));
    }
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Code duplicated, block: B:117:0x027d A[ADDED_TO_REGION] */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        boolean canRestoreState() {
            int i = C12007.f152x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i != 1) {
    ...
    static /* synthetic */ class C12007 {
        ...
        static {
            ...
            try {
                f152x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
