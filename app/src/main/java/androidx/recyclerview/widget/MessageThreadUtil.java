...
class MessageThreadUtil implements ThreadUtil {
    ...
    class C11881 implements ThreadUtil.MainThreadCallback {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C11881.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C11881.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C11881.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C11881.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = C11881.this.mQueue.next();
                }
            }
        };

        C11881(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback getMainThreadProxy(ThreadUtil.MainThreadCallback mainThreadCallback) {
        return new C11881(mainThreadCallback);
    }

    /* JADX INFO: renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    class C11892 implements ThreadUtil.BackgroundCallback {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C11892.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C11892.this.mQueue.removeMessages(1);
                            C11892.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C11892.this.mQueue.removeMessages(2);
                            C11892.this.mQueue.removeMessages(3);
                            C11892.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C11892.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C11892.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
                        C11892.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C11892(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback getBackgroundProxy(ThreadUtil.BackgroundCallback backgroundCallback) {
        return new C11892(backgroundCallback);
    }
