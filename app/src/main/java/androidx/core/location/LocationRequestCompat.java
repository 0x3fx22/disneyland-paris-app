...
public final class LocationRequestCompat {
    ...
    @IntRange(from = 1, m4to = 2147483647L)
    public int getMaxUpdates() {
        return this.mMaxUpdates;
    }

    @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 3.4028234663852886E38d)
    ...
    public LocationRequest toLocationRequest(String str) {
        ...
        return LocationRequestCompat$$ExternalSyntheticApiModelOutline0.m111m(Api19Impl.toLocationRequest(this, str));
    }
    ...
    public static final class Builder {
        ...
        public Builder setMaxUpdates(@IntRange(from = 1, m4to = 2147483647L) int i) {
        ...
        public Builder setMinUpdateDistanceMeters(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 3.4028234663852886E38d) float f) {
            this.mMinUpdateDistanceMeters = f;
