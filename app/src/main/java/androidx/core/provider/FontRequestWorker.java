...
abstract class FontRequestWorker {
    ...
    static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWrapper callbackWrapper, final int i, int i2) {
        final String strCreateCacheId = createCacheId(ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{fontRequest}), i);
        ...
        if (i2 == -1) {
            TypefaceResult fontSync = getFontSync(strCreateCacheId, context, ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{fontRequest}), i);
        ...
        try {
            TypefaceResult typefaceResult = (TypefaceResult) RequestExecutor.submit(DEFAULT_EXECUTOR_SERVICE, new Callable() { // from class: androidx.core.provider.FontRequestWorker.1
                ...
                public TypefaceResult call() {
                    return FontRequestWorker.getFontSync(strCreateCacheId, context, ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{fontRequest}), i);
                }
            }, i2);
