...
public final class BitmapCompat {
    ...
    public static Bitmap createScaledBitmap(Bitmap bitmap, int i, int i2, Rect rect, boolean z) {
        ...
        while (true) {
            ...
            if (bitmap2 == null || bitmap2 == bitmap || ((z && !Api27Impl.isAlreadyF16AndLinear(bitmap2)) || (z2 && !(z3 && i4 == 0)))) {
                if (bitmap2 != bitmap && bitmap2 != null) {
                    bitmap2.recycle();
                }
                bitmapCopyBitmapIfHardware = Api27Impl.createBitmapWithSourceColorspace(sizeAtStep(iWidth, i, i9 > 0 ? i4 : i9, i7), sizeAtStep(iHeight, i2, i10 > 0 ? i4 : i10, i8), bitmap, z && !z2);
            } else {
