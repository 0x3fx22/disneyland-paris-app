...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i3, float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i2) {
        if (i2 < 0 || i2 > 255) {
    ...
    public static void RGBToLAB(@IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i3, double[] dArr) {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i2, @IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void XYZToLAB(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 95.047d) double d, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) double d2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 108.883d) double d3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) double d, @FloatRange(from = -128.0d, m3to = 127.0d) double d2, @FloatRange(from = -128.0d, m3to = 127.0d) double d3, double[] dArr) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 95.047d) double d, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) double d2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 108.883d) double d3) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) double d, @FloatRange(from = -128.0d, m3to = 127.0d) double d2, @FloatRange(from = -128.0d, m3to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), (int) ((Color.red(i) * f2) + (Color.red(i2) * f)), (int) ((Color.green(i) * f2) + (Color.green(i2) * f)), (int) ((Color.blue(i) * f2) + (Color.blue(i2) * f)));
    }

    public static void blendHSL(float[] fArr, float[] fArr2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f, float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(double[] dArr, double[] dArr2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) double d, double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    @ColorInt
    public static int M3HCTToColor(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 360.0d, toInclusive = false) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) float f3) {
