...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        ...
        return ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m134m(wrapped);
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = ContentInfoCompat$$ExternalSyntheticApiModelOutline0.m134m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int i) {
            this.mPlatformBuilder = AbstractC0484xffe8451d.m141m(clipData, i);
        }

        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            AbstractC0486xffe8451f.m143m();
            this.mPlatformBuilder = AbstractC0485xffe8451e.m142m(contentInfoCompat.toContentInfo());
        }
