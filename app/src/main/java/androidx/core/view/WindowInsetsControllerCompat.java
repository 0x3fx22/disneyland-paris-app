...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl26 extends Impl23 {
        ...
        public void setAppearanceLightNavigationBars(boolean z) {
            if (z) {
                unsetWindowFlag(C0740C.BUFFER_FLAG_FIRST_SAMPLE);
                setWindowFlag(Integer.MIN_VALUE);
                setSystemUiFlag(16);
                return;
            }
    ...
    static class Impl30 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsControllerCompat.Impl
        void removeOnControllableInsetsChangedListener(OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListenerM204m = AbstractC0550xec4fc4df.m204m(this.mListeners.remove(onControllableInsetsChangedListener));
            if (onControllableInsetsChangedListenerM204m != null) {
                this.mInsetsController.removeOnControllableInsetsChangedListener(onControllableInsetsChangedListenerM204m);
            }
        }
