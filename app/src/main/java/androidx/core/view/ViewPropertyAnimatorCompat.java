...
public final class ViewPropertyAnimatorCompat {
    ...
    public ViewPropertyAnimatorCompat m155x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    public ViewPropertyAnimatorCompat m156y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    public ViewPropertyAnimatorCompat m157z(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            Api21Impl.m158z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* JADX INFO: renamed from: z */
        static ViewPropertyAnimator m158z(ViewPropertyAnimator viewPropertyAnimator, float f) {
