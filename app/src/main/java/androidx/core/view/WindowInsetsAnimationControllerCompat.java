...
public final class WindowInsetsAnimationControllerCompat {
    ...
    public void setInsetsAndAlpha(Insets insets, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f2) {
