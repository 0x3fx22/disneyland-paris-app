...
public abstract class Protection {
    ...
    Insets updateLayout() {
        ...
        if (i2 == 1) {
            ...
            if (occupiesCorners()) {
                insetsM101of = Insets.m101of(0, 0, 0, getThickness(i));
            }
        }
    ...
    public void setInsetAmount(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
        if (f < BitmapDescriptorFactory.HUE_RED || f > 1.0f) {
