...
public abstract class FragmentTransaction {
    ...
    static final class C0653Op {
        ...
        C0653Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0653Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0653Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0653Op(C0653Op c0653Op) {
            this.mCmd = c0653Op.mCmd;
            this.mFragment = c0653Op.mFragment;
            this.mFromExpandedOp = c0653Op.mFromExpandedOp;
            this.mEnterAnim = c0653Op.mEnterAnim;
            this.mExitAnim = c0653Op.mExitAnim;
            this.mPopEnterAnim = c0653Op.mPopEnterAnim;
            this.mPopExitAnim = c0653Op.mPopExitAnim;
            this.mOldMaxState = c0653Op.mOldMaxState;
            this.mCurrentMaxState = c0653Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        while (it.hasNext()) {
            this.mOps.add(new C0653Op((C0653Op) it.next()));
        }
    ...
    void addOp(C0653Op c0653Op) {
        this.mOps.add(c0653Op);
        c0653Op.mEnterAnim = this.mEnterAnim;
        c0653Op.mExitAnim = this.mExitAnim;
        c0653Op.mPopEnterAnim = this.mPopEnterAnim;
        c0653Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        addOp(new C0653Op(3, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0653Op(4, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction show(@NonNull Fragment fragment) {
        addOp(new C0653Op(5, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        addOp(new C0653Op(6, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction attach(@NonNull Fragment fragment) {
        addOp(new C0653Op(7, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0653Op(8, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0653Op(10, fragment, state));
        return this;
    }
