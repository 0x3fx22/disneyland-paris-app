...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, @DrawableRes int i, @StringRes int i2, @StringRes int i3) {
        ...
        slideDrawable.setOffset(z ? 0.33333334f : BitmapDescriptorFactory.HUE_RED);
    }
    ...
    public void onDrawerSlide(View view, float f) {
        ...
        if (f > 0.5f) {
            fMin = Math.max(position, Math.max(BitmapDescriptorFactory.HUE_RED, f - 0.5f) * 2.0f);
        } else {
    ...
    private class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.translate((-this.mOffset) * fWidth * this.mPosition * i, BitmapDescriptorFactory.HUE_RED);
            if (z && !this.mHasMirroring) {
                canvas.translate(fWidth, BitmapDescriptorFactory.HUE_RED);
