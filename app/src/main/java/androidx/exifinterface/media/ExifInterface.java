...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f3522CR, 10, Ascii.SUB, 10};
    ...
    /* JADX WARN: Code duplicated, block: B:70:0x00f1 A[Catch: all -> 0x0101, Exception -> 0x0105, TryCatch #21 {Exception -> 0x0105, all -> 0x0101, blocks: (B:68:0x00ed, B:70:0x00f1, B:77:0x0110, B:76:0x0108), top: B:122:0x00ed }] */
    /* JADX WARN: Code duplicated, block: B:76:0x0108 A[Catch: all -> 0x0101, Exception -> 0x0105, TryCatch #21 {Exception -> 0x0105, all -> 0x0101, blocks: (B:68:0x00ed, B:70:0x00f1, B:77:0x0110, B:76:0x0108), top: B:122:0x00ed }] */
    ...
    /* JADX WARN: Code duplicated, block: B:59:0x0170 A[LOOP:0: B:10:0x0037->B:59:0x0170, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:76:0x0177 A[SYNTHETIC] */
    ...
    /* JADX WARN: Code duplicated, block: B:145:0x0338 A[SYNTHETIC] */
    ...
    /* JADX WARN: Code duplicated, block: B:71:0x01f0 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:72:0x01f2  */
    /* JADX WARN: Code duplicated, block: B:74:0x01f5 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:99:0x0280 A[DONT_INVERT] */
    /* JADX WARN: Instruction removed from duplicated block: B:100:0x0282, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:102:0x0299, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:51:0x013d, please report this as an issue */
    ...
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws IOException {
        ...
        while (s2 < s) {
            ...
            ExifTag exifTag3 = (ExifTag) sExifTagMapsForReading[i].get(Integer.valueOf(unsignedShort2));
            boolean z2 = DEBUG;
            if (z2) {
                Log.d("ExifInterface", String.format("ifdType: %d, tagNumber: %d, tagName: %s, dataFormat: %d, numberOfComponents: %d", Integer.valueOf(i), Integer.valueOf(unsignedShort2), exifTag3 != null ? exifTag3.name : null, Integer.valueOf(unsignedShort3), Integer.valueOf(i4)));
            }
            if (exifTag3 != null) {
                if (unsignedShort3 > 0) {
                    ...
                    if (!z) {
                        ...
                        if (num != null) {
                            ...
                            if (((!TAG_MAKE.equals(exifTag2.name) || TAG_MODEL.equals(exifTag2.name)) && exifAttribute.getStringValue(this.mExifByteOrder).contains("PENTAX")) || (TAG_COMPRESSION.equals(exifTag2.name) && exifAttribute.getIntValue(this.mExifByteOrder) == 65535)) {
                                this.mMimeType = 8;
                            }
                ...
                if (!z) {
                    ...
                    if (num != null) {
                        ...
                        this.mAttributes[i].put(exifTag2.name, exifAttribute2);
                        if (TAG_DNG_VERSION.equals(exifTag2.name)) {
                            this.mMimeType = 3;
                        }
            ...
            if (!z) {
                ...
                if (num != null) {
                    ...
                    this.mAttributes[i].put(exifTag2.name, exifAttribute3);
                    if (TAG_DNG_VERSION.equals(exifTag2.name)) {
                        this.mMimeType = 3;
                    }
                    if (!TAG_MAKE.equals(exifTag2.name)) {
    ...
    private void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap map) throws IOException {
        ...
        while (i2 < jArrConvertToLongArray.length) {
            ...
            if (i2 < jArrConvertToLongArray.length - 1) {
                bArr = bArr2;
                if (i5 + i6 != jArrConvertToLongArray[i2 + 1]) {
