...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        this.f173mX = new float[iMin];
        this.f174mY = new float[iMin];
        ...
        if (Math.abs(this.f173mX[0]) <= 1.0E-5d && Math.abs(this.f174mY[0]) <= 1.0E-5d) {
            int i3 = iMin - 1;
            if (Math.abs(this.f173mX[i3] - 1.0f) <= 1.0E-5d && Math.abs(this.f174mY[i3] - 1.0f) <= 1.0E-5d) {
                float f = BitmapDescriptorFactory.HUE_RED;
                int i4 = 0;
                while (i < iMin) {
                    float[] fArr2 = this.f173mX;
                    int i5 = i4 + 1;
                    float f2 = fArr2[i4];
                    if (f2 < f) {
        ...
        sb.append(this.f173mX[0]);
        sb.append(",");
        sb.append(this.f174mY[0]);
        sb.append(" end:");
        int i6 = iMin - 1;
        sb.append(this.f173mX[i6]);
        sb.append(",");
        sb.append(this.f174mY[i6]);
