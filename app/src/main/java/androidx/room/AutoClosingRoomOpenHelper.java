...
public final class AutoClosingRoomOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    public static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        public boolean inTransaction() {
            ...
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C1216x5693171d.INSTANCE)).booleanValue();
        }
        ...
        public boolean yieldIfContendedSafely() {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C1235x2da6dfee.INSTANCE)).booleanValue();
        }

        @Override // androidx.sqlite.p009db.SupportSQLiteDatabase
        public boolean yieldIfContendedSafely(long sleepAfterYieldDelayMillis) {
            return ((Boolean) this.autoCloser.executeRefCountingFunction(C1236x2da6dfef.INSTANCE)).booleanValue();
        }
