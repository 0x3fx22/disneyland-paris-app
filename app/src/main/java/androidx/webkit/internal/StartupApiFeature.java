...
public abstract class StartupApiFeature {
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m402of(640L)).metaData;
    ...
    public static class C1599P extends StartupApiFeature {
        @Override // androidx.webkit.internal.StartupApiFeature
        public final boolean isSupportedByFramework() {
            return true;
        }

        C1599P(String str, String str2) {
            super(str, str2);
        }
    }
