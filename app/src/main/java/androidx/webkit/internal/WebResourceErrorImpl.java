...
public class WebResourceErrorImpl extends WebResourceErrorCompat {
    ...
    public int getErrorCode() {
        ApiFeature.C1589M c1589m = WebViewFeatureInternal.WEB_RESOURCE_ERROR_GET_CODE;
    ...
    public CharSequence getDescription() {
        ApiFeature.C1589M c1589m = WebViewFeatureInternal.WEB_RESOURCE_ERROR_GET_DESCRIPTION;
        if (c1589m.isSupportedByFramework()) {
