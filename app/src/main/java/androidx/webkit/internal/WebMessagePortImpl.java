...
public class WebMessagePortImpl extends WebMessagePortCompat {
    ...
    public void postMessage(@NonNull WebMessageCompat webMessageCompat) {
        ApiFeature.C1589M c1589m = WebViewFeatureInternal.WEB_MESSAGE_PORT_POST_MESSAGE;
    ...
    @Override // androidx.webkit.WebMessagePortCompat
    public void close() {
        ApiFeature.C1589M c1589m = WebViewFeatureInternal.WEB_MESSAGE_PORT_CLOSE;
    ...
    public void setWebMessageCallback(@NonNull WebMessagePortCompat.WebMessageCallbackCompat webMessageCallbackCompat) {
        ApiFeature.C1589M c1589m = WebViewFeatureInternal.WEB_MESSAGE_PORT_SET_MESSAGE_CALLBACK;
        if (c1589m.isSupportedByWebView()) {
