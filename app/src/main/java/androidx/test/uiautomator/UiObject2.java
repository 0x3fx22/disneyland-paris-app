...
public class UiObject2 implements Searchable {
    ...
    public List<UiObject2> getChildren() {
        return findObjects(C1491By.depth(1));
    }
    ...
    public boolean fling(Direction direction, int i) {
        ...
        return !((Boolean) this.mGestureController.performGestureAndWait(Until.scrollFinished(direction), 5000L, this.mGestures.swipeRect(getVisibleBoundsForGestures(), Direction.reverse(direction), 1.0f, i))).booleanValue();
    }
    ...
    public void legacySetText(String str) {
        ...
        ((UiObject2) getDevice().wait(Until.findObject(C1491By.descContains("Select all")), 50L)).click();
