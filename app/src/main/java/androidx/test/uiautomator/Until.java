...
public class Until {
        ...
        return new EventCondition<Boolean>() { // from class: androidx.test.uiautomator.Until.18
            ...
            public Boolean apply(AccessibilityEvent accessibilityEvent) {
                if (accessibilityEvent.getFromIndex() != -1 && accessibilityEvent.getToIndex() != -1 && accessibilityEvent.getItemCount() != -1) {
                    int i = C151519.$SwitchMap$android$support$test$uiautomator$Direction[this.mDirection.ordinal()];
                    if (i == 1) {
                    ...
                    int i2 = C151519.$SwitchMap$android$support$test$uiautomator$Direction[this.mDirection.ordinal()];
                    if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: androidx.test.uiautomator.Until$19 */
    static /* synthetic */ class C151519 {
