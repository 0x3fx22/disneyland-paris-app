...
class GestureController {
    ...
    public void performGesture(PointerGesture... pointerGestureArr) {
        ...
        PriorityQueue<PointerGesture> priorityQueue = new PriorityQueue(pointerGestureArr.length, END_TIME_COMPARATOR);
        ...
        while (true) {
            ...
            while (!priorityQueue.isEmpty() && j2 > ((PointerGesture) priorityQueue.peek()).delay() + ((PointerGesture) priorityQueue.peek()).duration()) {
                ...
                for (PointerGesture pointerGesture4 : priorityQueue) {
            ...
            for (PointerGesture pointerGesture5 : priorityQueue) {
