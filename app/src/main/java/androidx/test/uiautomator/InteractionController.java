...
class InteractionController {
    ...
    public boolean swipe(Point[] pointArr, int i) {
        ...
        while (i5 < pointArr.length) {
            ...
            double d = i4;
            double d2 = ((double) (i7 - point3.x)) / d;
            ...
            while (true) {
                ...
                int i9 = i5;
                i3 = i6;
                z &= touchMove(point4.x + ((int) (d2 * d4)), point4.y + ((int) (d4 * d3)));
                if (!z) {
                    break;
                }
                SystemClock.sleep(5L);
    ...
    public boolean performMultiPointerGesture(MotionEvent.PointerCoords[]... pointerCoordsArr) {
        ...
        for (int i6 = 0; i6 < pointerCoordsArr.length; i6++) {
            MotionEvent.PointerCoords[] pointerCoordsArr5 = pointerCoordsArr[i6];
            pointerCoordsArr3[i6] = pointerCoordsArr5[pointerCoordsArr5.length - 1];
        }
        int i7 = 1;
