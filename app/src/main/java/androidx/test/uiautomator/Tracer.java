...
public class Tracer {
    ...
    private class LogcatSink implements TracerSink {
        ...
        /* synthetic */ LogcatSink(Tracer tracer, C15011 c15011) {
            this();
        }
    ...
    public void setOutputMode(Mode mode) {
        ...
        try {
            int i = C15011.$SwitchMap$android$support$test$uiautomator$Tracer$Mode[mode.ordinal()];
            if (i == 1) {
            ...
            C15011 c15011 = null;
            if (i == 2) {
                this.mSinks.add(new LogcatSink(this, c15011));
                return;
            }
            if (i != 3) {
                return;
    ...
    /* JADX INFO: renamed from: androidx.test.uiautomator.Tracer$1 */
