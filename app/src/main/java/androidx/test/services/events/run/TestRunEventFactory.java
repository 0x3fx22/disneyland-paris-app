...
final class TestRunEventFactory implements Parcelable.Creator<TestRunEvent> {
    ...
    /* JADX INFO: renamed from: androidx.test.services.events.run.TestRunEventFactory$1 */
    static /* synthetic */ class C14901 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$test$services$events$run$TestRunEvent$EventType */
        static final /* synthetic */ int[] f170xe62b46e6;
        ...
        static {
            ...
            try {
                f170xe62b46e6[TestRunEvent.EventType.TEST_STARTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f170xe62b46e6[TestRunEvent.EventType.TEST_FINISHED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f170xe62b46e6[TestRunEvent.EventType.TEST_ASSUMPTION_FAILURE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f170xe62b46e6[TestRunEvent.EventType.TEST_FAILURE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f170xe62b46e6[TestRunEvent.EventType.TEST_IGNORED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f170xe62b46e6[TestRunEvent.EventType.FINISHED.ordinal()] = 7;
    ...
    public TestRunEvent createFromParcel(Parcel parcel) {
        ...
        switch (C14901.f170xe62b46e6[eventTypeValueOf.ordinal()]) {
            case 1:
