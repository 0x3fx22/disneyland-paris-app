...
abstract class InteractionResultsHandler {
    ...
    private static class ExecutionResult<T> {
        ...
        public String toString() {
            return MoreObjects.toStringHelper(this).omitNullValues().add(Constants.FirelogAnalytics.PARAM_PRIORITY, this.priority).add(OneIDTrackerEvent.EVENT_PARAM_SUCCESS, this.success).add("result", this.result).add("failure", this.failure).toString();
        }
