...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.core.internal.deps.guava.collect.AbstractIterator$1 */
    static /* synthetic */ class C13931 {
    ...
    public final boolean hasNext() {
        ...
        int i = C13931.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
