...
public final class Stopwatch {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.core.internal.deps.guava.base.Stopwatch$1 */
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C13611.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
