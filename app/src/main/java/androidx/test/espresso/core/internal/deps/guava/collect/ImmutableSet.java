...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static <E> ImmutableSet<E> copyOf(E[] eArr) {
        ...
        if (length != 0) {
            return length != 1 ? construct(eArr.length, (Object[]) eArr.clone()) : m394of((Object) eArr[0]);
        }
        return m393of();
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m393of() {
    ...
    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m394of(E e) {
    ...
    public static class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
        ...
        public ImmutableSet<E> build() {
            ...
            int i = this.size;
            if (i == 0) {
                return ImmutableSet.m393of();
            }
            if (i == 1) {
                return ImmutableSet.m394of(this.contents[0]);
            }
