...
public abstract class Optional<T> implements Serializable {
    ...
    public static <T> Optional<T> m385of(T t) {
    ...
    public abstract Optional<T> mo381or(Optional<? extends T> optional);

    /* JADX INFO: renamed from: or */
    public abstract T mo382or(Supplier<? extends T> supplier);

    /* JADX INFO: renamed from: or */
    public abstract T mo383or(T t);
