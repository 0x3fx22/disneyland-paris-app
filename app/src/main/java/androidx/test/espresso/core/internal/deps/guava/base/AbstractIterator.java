...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.core.internal.deps.guava.base.AbstractIterator$1 */
    ...
    public final boolean hasNext() {
        ...
        int i = C13571.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
