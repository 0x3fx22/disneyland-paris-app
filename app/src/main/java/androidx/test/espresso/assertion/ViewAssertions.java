    ...
    static class DoesNotExistViewAssertion implements ViewAssertion {
        ...
        public void check(View view, NoMatchingViewException noMatchingViewException) {
            if (view != null) {
                ...
                ViewMatchers.assertThat(strValueOf.length() != 0 ? "View is present in the hierarchy: ".concat(strValueOf) : new String("View is present in the hierarchy: "), Boolean.TRUE, Matchers.m2121is(Boolean.FALSE));
            }
        }
    }
