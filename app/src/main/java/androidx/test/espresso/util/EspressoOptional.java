...
public final class EspressoOptional<T> {
    ...
    public static <T> EspressoOptional<T> m396of(T t) {
        return new EspressoOptional<>(Optional.m385of(t));
    }
    ...
    public Optional<T> m397or(Optional<? extends T> optional) {
        return this.delegate.mo381or((Optional) optional);
    }
    ...
    /* JADX INFO: renamed from: or */
    public T m398or(Supplier<? extends T> supplier) {
        return (T) this.delegate.mo382or((Supplier) supplier);
    }

    /* JADX INFO: renamed from: or */
    public T m399or(T t) {
        return (T) this.delegate.mo383or(t);
    }
}
