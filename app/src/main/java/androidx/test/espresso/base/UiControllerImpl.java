...
final class UiControllerImpl implements InterruptableUiController, Handler.Callback, IdlingUiController {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.base.UiControllerImpl$7 */
    static /* synthetic */ class C13547 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$test$espresso$base$UiControllerImpl$IdleCondition */
        static final /* synthetic */ int[] f165x22726293;
        ...
        static {
            ...
            try {
                f165x22726293[IdleCondition.COMPAT_TASKS_HAVE_IDLED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f165x22726293[IdleCondition.DYNAMIC_TASKS_HAVE_IDLED.ordinal()] = 3;
        ...
        try {
            ...
            while (it2.hasNext()) {
                ...
                if (!idleCondition.isSignaled(this.conditionSet)) {
                    ...
                    int i = C13547.f165x22726293[idleCondition.ordinal()];
                    if (i != 1) {
                        if (i != 2) {
