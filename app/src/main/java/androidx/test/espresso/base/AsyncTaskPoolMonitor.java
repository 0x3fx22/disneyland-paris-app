...
class AsyncTaskPoolMonitor {
    ...
    private class IdleMonitor {
            ...
            this.barrier = new CyclicBarrier(AsyncTaskPoolMonitor.this.pool.getCorePoolSize(), new Runnable() { // from class: androidx.test.espresso.base.AsyncTaskPoolMonitor.IdleMonitor.1
                ...
                public void run() {
                    if (!AsyncTaskPoolMonitor.this.pool.getQueue().isEmpty()) {
                        ...
                        PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(AsyncTaskPoolMonitor.this.monitor, IdleMonitor.this, null);
                        runnable.run();
                    }
                }
            });
        ...
        public void monitorForIdle() {
            ...
            if (AsyncTaskPoolMonitor.this.isIdleNow()) {
                PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(AsyncTaskPoolMonitor.this.monitor, this, null);
                this.onIdle.run();
                return;
            }
    ...
    void notifyWhenIdle(Runnable runnable) {
        ...
        Preconditions.checkState(PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.monitor, null, idleMonitor), "cannot monitor for idle recursively!");
