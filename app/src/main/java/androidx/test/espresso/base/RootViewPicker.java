...
public final class RootViewPicker implements Provider<View> {
    private static final ImmutableList CREATED_WAIT_TIMES = ImmutableList.m389of((Integer) 10, (Integer) 50, (Integer) 150, Integer.valueOf(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION));
    private static final ImmutableList RESUMED_WAIT_TIMES = ImmutableList.m390of(10, 50, 100, 500, 2000, 30000);
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.base.RootViewPicker$1 */
    static /* synthetic */ class C13421 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$test$espresso$base$RootViewPicker$RootResults$State */
        static final /* synthetic */ int[] f164xebad5cb2;
        ...
        static {
            ...
            try {
                f164xebad5cb2[RootResults.State.NO_ROOTS_PRESENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f164xebad5cb2[RootResults.State.NO_ROOTS_PICKED.ordinal()] = 3;
    ...
    private static final class NoActiveRootsBackoff extends BackOff {
        private static final ImmutableList NO_ACTIVE_ROOTS_BACKOFF = ImmutableList.m392of((Integer) 10, (Integer) 10, (Integer) 20, (Integer) 30, (Integer) 50, (Integer) 80, Integer.valueOf(TsExtractor.TS_STREAM_TYPE_HDMV_DTS), (Integer) 210, Integer.valueOf(Currencies.HNL));
    ...
    private static final class NoMatchingRootBackoff extends BackOff {
        private static final ImmutableList NO_MATCHING_ROOT_BACKOFF = ImmutableList.m390of(10, 20, 200, 400, 1000, 2000);
    ...
    private static final class RootReadyBackoff extends BackOff {
        private static final ImmutableList ROOT_READY_BACKOFF = ImmutableList.m391of(10, 25, 50, 100, 200, 400, (int) Integer.valueOf(Currencies.UGX), 1000);
    ...
    private Root pickARoot() {
        ...
        while (System.currentTimeMillis() <= jCurrentTimeMillis) {
            int i = C13421.f164xebad5cb2[rootResultsFetch.getState().ordinal()];
            if (i == 1) {
    ...
    private static final class RootViewWithoutFocusException extends RuntimeException implements EspressoException {
        ...
        /* synthetic */ RootViewWithoutFocusException(String str, C13421 c13421) {
            this(str);
        }
    }
    ...
    private static class RootResults {
        ...
        public State getState() {
            ...
            return this.pickedRoots.size() > 0 ? State.ROOTS_PICKED : State.NO_ROOTS_PICKED;
        }

        /* synthetic */ RootResults(List list, List list2, Matcher matcher, C13421 c13421) {
