...
public final class CursorMatchers {
    ...
    public static CursorMatcher withRowDouble(int i, double d) {
        return withRowDouble(i, (Matcher<Double>) Matchers.m2121is(Double.valueOf(d)));
    }

    public static CursorMatcher withRowFloat(int i, float f) {
        return withRowFloat(i, (Matcher<Float>) Matchers.m2121is(Float.valueOf(f)));
    }

    public static CursorMatcher withRowInt(int i, int i2) {
        return withRowInt(i, (Matcher<Integer>) Matchers.m2121is(Integer.valueOf(i2)));
    }

    public static CursorMatcher withRowLong(int i, long j) {
        return withRowLong(i, (Matcher<Long>) Matchers.m2121is(Long.valueOf(j)));
    }
    ...
    public static CursorMatcher withRowString(int i, String str) {
        return withRowString(i, (Matcher<String>) Matchers.m2121is(str));
    }
    ...
    public static CursorMatcher withRowBlob(int i, byte[] bArr) {
        return withRowBlob(i, (Matcher<byte[]>) Matchers.m2121is(bArr));
    }
    ...
    public static CursorMatcher withRowShort(int i, short s) {
        return withRowShort(i, (Matcher<Short>) Matchers.m2121is(Short.valueOf(s)));
    }
    ...
    public static CursorMatcher withRowBlob(String str, Matcher<byte[]> matcher) {
        return withRowBlob((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowDouble(String str, double d) {
        return withRowDouble(str, (Matcher<Double>) Matchers.m2121is(Double.valueOf(d)));
    }

    public static CursorMatcher withRowFloat(String str, float f) {
        return withRowFloat(str, (Matcher<Float>) Matchers.m2121is(Float.valueOf(f)));
    }

    public static CursorMatcher withRowInt(String str, int i) {
        return withRowInt(str, (Matcher<Integer>) Matchers.m2121is(Integer.valueOf(i)));
    }

    public static CursorMatcher withRowLong(String str, long j) {
        return withRowLong(str, (Matcher<Long>) Matchers.m2121is(Long.valueOf(j)));
    }

    public static CursorMatcher withRowShort(String str, Matcher<Short> matcher) {
        return withRowShort((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowString(String str, String str2) {
        return withRowString((Matcher<String>) Matchers.m2121is(str), (Matcher<String>) Matchers.m2121is(str2));
    }

    public static CursorMatcher withRowBlob(String str, byte[] bArr) {
        return withRowBlob((Matcher<String>) Matchers.m2121is(str), (Matcher<byte[]>) Matchers.m2121is(bArr));
    }

    public static CursorMatcher withRowDouble(String str, Matcher<Double> matcher) {
        return withRowDouble((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowFloat(String str, Matcher<Float> matcher) {
        return withRowFloat((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowInt(String str, Matcher<Integer> matcher) {
        return withRowInt((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowLong(String str, Matcher<Long> matcher) {
        return withRowLong((Matcher<String>) Matchers.m2121is(str), matcher);
    }

    public static CursorMatcher withRowShort(String str, short s) {
        return withRowShort(str, (Matcher<Short>) Matchers.m2121is(Short.valueOf(s)));
    }

    public static CursorMatcher withRowString(String str, Matcher<String> matcher) {
        return withRowString((Matcher<String>) Matchers.m2121is(str), matcher);
    }
