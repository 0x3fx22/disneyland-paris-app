...
public final class ViewMatchers {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.matcher.ViewMatchers$2 */
    static /* synthetic */ class C14262 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$test$espresso$matcher$ViewMatchers$WithCharSequenceMatcher$TextViewMethod */
        static final /* synthetic */ int[] f166x6a05bebb;
        ...
        static {
            ...
            try {
                f166x6a05bebb[WithCharSequenceMatcher.TextViewMethod.GET_HINT.ordinal()] = 2;
    ...
    static final class IsDisplayingAtLeastMatcher extends TypeSafeDiagnosingMatcher<View> {
        ...
        public boolean matchesSafely(View view, Description description) {
            ...
            int iHeight = (int) ((((double) (rect.height() * rect.width())) / ((double) (Math.min(view.getHeight() * Math.abs(view.getScaleY()), screenWithoutStatusBarActionBar.height()) * Math.min(view.getWidth() * Math.abs(view.getScaleX()), screenWithoutStatusBarActionBar.width())))) * 100.0d);
    ...
    static final class WithCharSequenceMatcher extends BoundedDiagnosingMatcher<View, TextView> {
        ...
        @Override // androidx.test.espresso.matcher.BoundedDiagnosingMatcher
        protected void describeMoreTo(Description description) {
            int i = C14262.f166x6a05bebb[this.method.ordinal()];
            if (i == 1) {
    ...
    public static Matcher<View> hasErrorText(String str) {
        return hasErrorText((Matcher<String>) Matchers.m2121is(str));
    }
    ...
    public static Matcher<View> hasImeAction(int i) {
        return hasImeAction((Matcher<Integer>) Matchers.m2121is(Integer.valueOf(i)));
    }
    ...
    public static Matcher<View> isChecked() {
        return withCheckBoxState(Matchers.m2121is(Boolean.TRUE));
    }
    ...
    public static Matcher<View> isNotChecked() {
        return withCheckBoxState(Matchers.m2121is(Boolean.FALSE));
    }
    ...
    public static Matcher<View> withId(int i) {
        return withId((Matcher<Integer>) Matchers.m2121is(Integer.valueOf(i)));
    }
    ...
    public static Matcher<View> withResourceName(String str) {
        return withResourceName((Matcher<String>) Matchers.m2121is(str));
    }
    ...
    public static Matcher<View> withContentDescription(String str) {
        return new WithContentDescriptionTextMatcher(Matchers.m2121is(str));
    }

    public static Matcher<View> withHint(String str) {
        return withHint((Matcher<String>) Matchers.m2121is((String) Preconditions.checkNotNull(str)));
    }
    ...
    public static Matcher<View> withSpinnerText(String str) {
        return withSpinnerText((Matcher<String>) Matchers.m2121is(str));
    }
    ...
    public static Matcher<View> withText(String str) {
        return withText((Matcher<String>) Matchers.m2121is(str));
    }
