...
public final class IdlingPolicy {
    ...
    /* JADX INFO: renamed from: androidx.test.espresso.IdlingPolicy$1 */
    ...
    public void handleTimeout(List<String> list, String str) {
        int i = C12831.$SwitchMap$androidx$test$espresso$IdlingPolicy$ResponseAction[this.errorHandler.ordinal()];
        if (i == 1) {
    ...
    static class Builder {
        ...
        /* synthetic */ Builder(IdlingPolicy idlingPolicy, C12831 c12831) {
            this(idlingPolicy);
        }
    }

    /* synthetic */ IdlingPolicy(Builder builder, C12831 c12831) {
        this(builder);
    }
}
