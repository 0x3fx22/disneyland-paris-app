...
public final class OrchestrationListenerManager {
    ...
    private void cacheStatus(Bundle bundle) {
        ...
        int i = C14621.f167x9b59c564[TestEvent.valueOf(bundle.getString(KEY_TEST_EVENT)).ordinal()];
        if (i == 1) {
            this.markTerminationAsFailure = true;
        } else if (i == 2) {
    ...
    /* JADX INFO: renamed from: androidx.test.orchestrator.listeners.OrchestrationListenerManager$1 */
    static /* synthetic */ class C14621 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$test$orchestrator$listeners$OrchestrationListenerManager$TestEvent */
        static final /* synthetic */ int[] f167x9b59c564;
        ...
        static {
            ...
            try {
                f167x9b59c564[TestEvent.TEST_FAILURE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f167x9b59c564[TestEvent.TEST_RUN_FINISHED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f167x9b59c564[TestEvent.TEST_STARTED.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f167x9b59c564[TestEvent.TEST_FINISHED.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f167x9b59c564[TestEvent.TEST_ASSUMPTION_FAILURE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f167x9b59c564[TestEvent.TEST_IGNORED.ordinal()] = 7;
    ...
    private void handleNotificationForListener(OrchestrationRunListener orchestrationRunListener, Bundle bundle) {
        switch (C14621.f167x9b59c564[TestEvent.valueOf(bundle.getString(KEY_TEST_EVENT)).ordinal()]) {
            case 1:
