...
public final class ThrowableExtension {
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x001c A[Catch: all -> 0x0014, TryCatch #0 {all -> 0x0014, blocks: (B:4:0x0006, B:6:0x000e, B:9:0x0016, B:11:0x001c, B:12:0x0022), top: B:24:0x0006 }] */
    /* JADX WARN: Code duplicated, block: B:12:0x0022 A[Catch: all -> 0x0014, TRY_LEAVE, TryCatch #0 {all -> 0x0014, blocks: (B:4:0x0006, B:6:0x000e, B:9:0x0016, B:11:0x001c, B:12:0x0022), top: B:24:0x0006 }] */
    /* JADX WARN: Code duplicated, block: B:9:0x0016 A[Catch: all -> 0x0014, TryCatch #0 {all -> 0x0014, blocks: (B:4:0x0006, B:6:0x000e, B:9:0x0016, B:11:0x001c, B:12:0x0022), top: B:24:0x0006 }] */
    static {
        Integer apiLevelFromBuildVersion;
        AbstractDesugaringStrategy nullDesugaringStrategy;
        try {
            apiLevelFromBuildVersion = readApiLevelFromBuildVersion();
            if (apiLevelFromBuildVersion != null) {
                try {
                    if (apiLevelFromBuildVersion.intValue() >= 19) {
                        nullDesugaringStrategy = new ReuseDesugaringStrategy();
                    } else if (useMimicStrategy()) {
                        nullDesugaringStrategy = new MimicDesugaringStrategy();
                    } else {
            ...
            th = th2;
            apiLevelFromBuildVersion = null;
        }
        STRATEGY = nullDesugaringStrategy;
        API_LEVEL = apiLevelFromBuildVersion == null ? 1 : apiLevelFromBuildVersion.intValue();
    }
