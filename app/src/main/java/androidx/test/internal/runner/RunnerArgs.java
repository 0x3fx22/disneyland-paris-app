...
public class RunnerArgs {
    ...
    public static class Builder {
        ...
        private List parseLoadAndInstantiateClasses(String str, Class cls, Bundle bundle) {
            ArrayList arrayList = new ArrayList();
            if (str != null) {
                for (String str2 : str.split(",")) {
        ...
        private Object parseLoadAndInstantiateClass(String str, Class cls) {
        ...
        private void loadClassByNameInstantiateAndAdd(List list, String str, Class cls, Bundle bundle) {
        ...
        private List parseAndLoadClasses(String str, Class cls) {
            ArrayList arrayList = new ArrayList();
            if (str != null) {
                for (String str2 : str.split(",")) {
        ...
        private void loadClassByNameAndAdd(List list, String str, Class cls) {
            if (str == null || str.length() == 0) {
                return;
            }
            try {
