...
public final class ScatterMapKt {
    ...
    public static final int m88h1(int i) {
        return i >>> 7;
    }

    /* JADX INFO: renamed from: h2 */
    public static final int m89h2(int i) {
        return i & 127;
    }
