...
public final class SparseArrayKt {
    ...
    @Metadata(m1835d1 = {"\u0000\u001b\n\u0000\n\u0002\u0010(\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\t\u0010\b\u001a\u00020\tH\u0096\u0002J\u000e\u0010\n\u001a\u00028\u0000H\u0096\u0002¢\u0006\u0002\u0010\u000bR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0004\u0010\u0005\"\u0004\b\u0006\u0010\u0007¨\u0006\f"}, m1836d2 = {"androidx/collection/SparseArrayKt$valueIterator$1", "", ArrayContainsMatcher.INDEX_KEY, "", "getIndex", "()I", "setIndex", "(I)V", "hasNext", "", "next", "()Ljava/lang/Object;", "collection"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
    public static final class C03621<T> implements Iterator<T>, KMappedMarker {
        ...
        C03621(SparseArrayCompat sparseArrayCompat) {
    ...
    public static final <T> Iterator<T> valueIterator(@NotNull SparseArrayCompat<T> sparseArrayCompat) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        return new C03621(sparseArrayCompat);
    }
}
