...
abstract class CryptoObjectUtils {
    ...
    private static class Api30Impl {
        @NonNull
        static android.hardware.biometrics.BiometricPrompt.CryptoObject create(@NonNull IdentityCredential identityCredential) {
            return new android.hardware.biometrics.BiometricPrompt.CryptoObject(identityCredential);
        }

        @Nullable
        static IdentityCredential getIdentityCredential(@NonNull android.hardware.biometrics.BiometricPrompt.CryptoObject cryptoObject) {
    ...
    private static class Api28Impl {
        @NonNull
        static android.hardware.biometrics.BiometricPrompt.CryptoObject create(@NonNull Cipher cipher) {
            return new android.hardware.biometrics.BiometricPrompt.CryptoObject(cipher);
        }

        @NonNull
        static android.hardware.biometrics.BiometricPrompt.CryptoObject create(@NonNull Signature signature) {
        ...
        @Nullable
        static Cipher getCipher(@NonNull android.hardware.biometrics.BiometricPrompt.CryptoObject cryptoObject) {
            return cryptoObject.getCipher();
        }

        @Nullable
        static Signature getSignature(@NonNull android.hardware.biometrics.BiometricPrompt.CryptoObject cryptoObject) {
            return cryptoObject.getSignature();
        }

        @Nullable
        static Mac getMac(@NonNull android.hardware.biometrics.BiometricPrompt.CryptoObject cryptoObject) {
