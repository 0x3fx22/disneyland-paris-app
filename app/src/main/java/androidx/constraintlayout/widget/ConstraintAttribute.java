...
public class ConstraintAttribute {
    ...
    static /* synthetic */ class C04051 {
        ...
        static {
            ...
            try {
                f74x66adad53[AttributeType.BOOLEAN_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f74x66adad53[AttributeType.STRING_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f74x66adad53[AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f74x66adad53[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f74x66adad53[AttributeType.INT_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f74x66adad53[AttributeType.FLOAT_TYPE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f74x66adad53[AttributeType.DIMENSION_TYPE.ordinal()] = 8;
    ...
    public boolean isContinuous() {
        int i = C04051.f74x66adad53[this.mType.ordinal()];
    ...
    public float getValueToInterpolate() {
        switch (C04051.f74x66adad53[this.mType.ordinal()]) {
            case 2:
    ...
    public boolean diff(ConstraintAttribute constraintAttribute) {
        ...
        switch (C04051.f74x66adad53[attributeType.ordinal()]) {
            case 1:
            case 6:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                switch (C04051.f74x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
