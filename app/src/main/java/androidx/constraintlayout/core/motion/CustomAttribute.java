...
public class CustomAttribute {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.motion.CustomAttribute$1 */
    static /* synthetic */ class C03681 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$constraintlayout$core$motion$CustomAttribute$AttributeType */
        static final /* synthetic */ int[] f31xbc2a0812;
        ...
        static {
            ...
            try {
                f31xbc2a0812[AttributeType.BOOLEAN_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f31xbc2a0812[AttributeType.STRING_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f31xbc2a0812[AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f31xbc2a0812[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f31xbc2a0812[AttributeType.INT_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f31xbc2a0812[AttributeType.FLOAT_TYPE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f31xbc2a0812[AttributeType.DIMENSION_TYPE.ordinal()] = 8;
    ...
    public boolean isContinuous() {
        int i = C03681.f31xbc2a0812[this.mType.ordinal()];
    ...
    public float getValueToInterpolate() {
        switch (C03681.f31xbc2a0812[this.mType.ordinal()]) {
            case 2:
    ...
    public boolean diff(CustomAttribute customAttribute) {
        ...
        switch (C03681.f31xbc2a0812[attributeType.ordinal()]) {
            case 1:
            case 6:
