        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case -908189618:
                    ...
                    break;
                case -908189617:
                    b = !str.equals("scaleY") ? (byte) -1 : Ascii.f3535VT;
                    break;
                case -880905839:
                    b = !str.equals(S_TARGET) ? (byte) -1 : Ascii.f3524FF;
                    break;
                case -4379043:
                    b = !str.equals("elevation") ? (byte) -1 : Ascii.f3522CR;
                    break;
                case 92909918:
                    b = !str.equals("alpha") ? (byte) -1 : Ascii.f3532SO;
                    break;
                case 97692013:
                    b = !str.equals(S_FRAME) ? (byte) -1 : Ascii.f3531SI;
                    break;
                case 579057826:
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case -908189617:
                    ...
                    break;
                case 92909918:
                    b = !str.equals("alpha") ? (byte) -1 : Ascii.f3524FF;
                    break;
                case 579057826:
                    b = !str.equals("curveFit") ? (byte) -1 : Ascii.f3522CR;
                    break;
                case 803192288:
                    b = !str.equals("pathRotate") ? (byte) -1 : Ascii.f3532SO;
                    break;
                case 1941332754:
                    b = !str.equals("visibility") ? (byte) -1 : Ascii.f3531SI;
                    break;
                default:
                    b = -1;
                    break;
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 1401391082:
                    ...
                    break;
                case 1535404999:
                    b = !str.equals("triggerReceiver") ? (byte) -1 : Ascii.f3535VT;
                    break;
                default:
                    b = -1;
                    break;
        ...
        static int getId(String str) {
            ...
            switch (str.hashCode()) {
                ...
                case 1639368448:
                    ...
                    break;
                case 1900899336:
                    b = !str.equals(S_ANIMATE_RELATIVE_TO) ? (byte) -1 : Ascii.f3535VT;
                    break;
                case 2109694967:
                    b = !str.equals(S_PATHMOTION_ARC) ? (byte) -1 : Ascii.f3524FF;
                    break;
                default:
                    b = -1;
                    break;
