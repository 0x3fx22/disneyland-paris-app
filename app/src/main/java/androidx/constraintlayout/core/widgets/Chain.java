  ...
  0x0035: PHI (r16v3 boolean) = (r16v1 boolean), (r16v8 boolean) binds: [B:26:0x004b, B:15:0x0031] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        if (constraintWidget3 != null && (constraintWidget3 == constraintWidget4 || z3)) {
            ...
            if (z5 && constraintWidget3 != null) {
                ...
                while (constraintWidget12 != null) {
                    ...
                    if (constraintWidget12 == constraintWidget3 || constraintWidget12 == constraintWidget4 || constraintWidget13 == null) {
                        ...
                        int i18 = margin3;
                        int margin4 = constraintWidget11.mListAnchors[i17].getMargin() + margin2;
                        int i19 = z9 ? 8 : 4;
                ...
                int i20 = i2 + 1;
                ConstraintAnchor constraintAnchor22 = constraintWidget4.mListAnchors[i20];
                ConstraintAnchor constraintAnchor23 = constraintWidget2.mListAnchors[i20].mTarget;
            ...
            boolean z10 = i21 > 0 && chainHead.mWidgetsCount == i21;
            ...
            while (constraintWidget16 != null) {
                ...
                if (constraintWidget17 != null || constraintWidget16 == constraintWidget4) {
                    ...
                    int i22 = i2 + 1;
                    int margin6 = constraintWidget16.mListAnchors[i22].getMargin();
                    if (constraintWidget17 != null) {
                        ...
                        SolverVariable solverVariable18 = constraintWidget16.mListAnchors[i22].mSolverVariable;
                        if (constraintAnchor2 != null) {
                            margin6 += constraintAnchor2.getMargin();
                        }
                        int margin7 = margin5 + constraintWidget15.mListAnchors[i22].getMargin();
                        if (solverVariable16 == null && solverVariable17 != null && solverVariable3 != null && solverVariable18 != null) {
                            ...
                            linearSystem.addCentering(solverVariable16, solverVariable17, margin7, 0.5f, solverVariable3, solverVariable18, constraintWidget16 == constraintWidget4 ? constraintWidget4.mListAnchors[i22].getMargin() : margin6, z10 ? 8 : 5);
                        }
                    ...
                    SolverVariable solverVariable19 = constraintWidget16.mListAnchors[i22].mSolverVariable;
                    if (constraintAnchor2 != null) {
                        margin6 += constraintAnchor2.getMargin();
                    }
                    int margin8 = margin5 + constraintWidget15.mListAnchors[i22].getMargin();
        ...
        int i23 = i2 + 1;
        ConstraintAnchor constraintAnchor28 = constraintWidget4.mListAnchors[i23];
        ...
        if (constraintWidget2 != constraintWidget4) {
            ConstraintAnchor constraintAnchor31 = constraintWidget2.mListAnchors[i23].mTarget;
        ...
        linearSystem.addCentering(constraintAnchor27.mSolverVariable, solverVariable20, constraintAnchor27.getMargin(), 0.5f, r5, constraintAnchor28.mSolverVariable, constraintWidget4.mListAnchors[i23].getMargin(), 5);
    }
}
