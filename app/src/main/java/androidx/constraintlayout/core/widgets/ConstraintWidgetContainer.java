        ...
        while (zAddChildrenToSolver) {
            ...
            if (z5 && i8 < 8 && Optimizer.flags[2]) {
                ...
                while (i11 < size) {
                    ...
                    iMax4 = Math.max(iMax4, constraintWidget3.f55mX + constraintWidget3.getWidth());
                    iMax3 = Math.max(iMax3, constraintWidget3.f56mY + constraintWidget3.getHeight());
                    i11++;
            ...
            if (r2 == 0) {
                ...
                if (dimensionBehaviour9 == dimensionBehaviour10 && i2 > 0) {
                    r2 = r2;
                    if (getWidth() > i2) {
