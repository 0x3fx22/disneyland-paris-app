...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C03821 {
        ...
        static final /* synthetic */ int[] f63x56910102;
        ...
        static {
            ...
            try {
                f63x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f63x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i;
        int i2 = C03821.f63x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {
                ...
                if (i3 == 3 && constraintWidget2.horizontalRun.dimension.resolved) {
                    ...
                    if (dimensionRatioSide == -1) {
                        ...
                        if (dimensionRatioSide == 0) {
                            ...
                            dimensionRatio2 = constraintWidget4.horizontalRun.dimension.value * constraintWidget4.getDimensionRatio();
