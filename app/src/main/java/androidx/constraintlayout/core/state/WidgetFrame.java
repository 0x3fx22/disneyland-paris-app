...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        float f7 = widgetFrame2.visibility == 4 ? BitmapDescriptorFactory.HUE_RED : f2;
        float f8 = widgetFrame3.visibility == 4 ? BitmapDescriptorFactory.HUE_RED : f6;
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i5 = (int) (keyPositionFindPreviousPosition.f52x * i);
                i9 = i2;
                i6 = (int) (keyPositionFindPreviousPosition.f53y * i9);
            ...
            if (keyPositionFindNextPosition != null) {
                i8 = (int) (keyPositionFindNextPosition.f52x * i);
                i16 = (int) (keyPositionFindNextPosition.f53y * i9);
        ...
        int i22 = (int) (i7 + ((i8 - i7) * f3));
        widgetFrame.left = i22;
        int i23 = (int) (i21 + (f3 * (i16 - i21)));
        widgetFrame.top = i23;
        float f9 = 1.0f - f;
        widgetFrame.right = i22 + ((int) ((i3 * f9) + (i19 * f)));
        widgetFrame.bottom = i23 + ((int) ((f9 * i4) + (i20 * f)));
        ...
        for (String str : setKeySet) {
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    ...
                    for (int i24 = 0; i24 < iNumberOfInterpolatedValues; i24++) {
                        fArr[i24] = interpolate(fArr[i24], fArr2[i24], BitmapDescriptorFactory.HUE_RED, f);
