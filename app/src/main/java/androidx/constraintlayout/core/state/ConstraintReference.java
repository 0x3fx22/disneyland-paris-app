...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int i) {
        ...
        if (constraint != null) {
            switch (C03731.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    public ConstraintReference bias(float f) {
        ...
        int i = C03731.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        if (i == 17) {
            this.mHorizontalBias = f;
        } else if (i != 18) {
            switch (i) {
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int[] iArr = C03731.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint;
