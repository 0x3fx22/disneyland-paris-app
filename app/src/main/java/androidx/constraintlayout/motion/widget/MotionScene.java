...
public class MotionScene {
    ...
    void setTransition(int i, int i2) {
        ...
        if (stateSet != null) {
            ...
            while (true) {
                if (it.hasNext()) {
                    ...
                    for (Transition transition5 : this.mAbstractTransitionList) {
                        if (transition5.mConstraintSetEnd == i2) {
                ...
                transition4 = (Transition) it.next();
                if ((transition4.mConstraintSetEnd != iStateGetConstraintID2 && transition4.mConstraintSetStart == iStateGetConstraintID) || (transition4.mConstraintSetEnd == i2 && transition4.mConstraintSetStart == i)) {
                    break;
                }
            }
        ...
        while (true) {
            ...
            transition4 = (Transition) it.next();
            if (transition4.mConstraintSetEnd != iStateGetConstraintID2) {
            }
        }
        this.mCurrentTransition = transition4;
        if (transition4 != null) {
    ...
    public static class Transition {
        ...
        public void removeOnClick(int i) {
            ...
            } while (transitionOnClick.mTargetId != i);
