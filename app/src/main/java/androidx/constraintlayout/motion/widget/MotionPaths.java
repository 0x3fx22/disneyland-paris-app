...
class MotionPaths implements Comparable {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f71x;
        float f9 = motionPaths.f72y;
        float f10 = (motionPaths2.f71x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f72y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f71x = (int) ((f8 + (f10 * f)) - f13);
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f72y = (int) ((f9 + (f11 * f)) - f15);
        ...
        float f18 = zIsNaN ? 0.0f : keyPosition.mAltPercentY;
        ...
        this.mMode = 0;
        this.f71x = (int) (((motionPaths.f71x + (f16 * f10)) + (f17 * f11)) - f13);
        this.f72y = (int) (((motionPaths.f72y + (f10 * f18)) + (f11 * f)) - f15);
    ...
    void initPolar(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f71x;
            float f11 = motionPaths.f71x;
            this.f71x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f2 = keyPosition.mPercentY;
            }
            float f12 = motionPaths2.f72y;
            float f13 = motionPaths.f72y;
            this.f72y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(keyPosition.mPercentX)) {
                float f14 = motionPaths2.f71x;
                float f15 = motionPaths.f71x;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f71x = fMin;
            if (Float.isNaN(keyPosition.mPercentY)) {
                float f16 = motionPaths2.f72y;
                float f17 = motionPaths.f72y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = keyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f71x;
            float f20 = motionPaths.f71x;
            this.f71x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f2 = keyPosition.mPercentY;
            }
            float f21 = motionPaths2.f72y;
            float f22 = motionPaths.f72y;
            this.f72y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(MotionController motionController, MotionPaths motionPaths) {
        double d = ((this.f71x + (this.width / 2.0f)) - motionPaths.f71x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f72y + (this.height / 2.0f)) - motionPaths.f72y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motionController;
        this.f71x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f72y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f72y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f71x;
        float f9 = motionPaths.f72y;
        float f10 = motionPaths2.f71x + (f4 / 2.0f);
        float f11 = motionPaths2.f72y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f71x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f72y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f71x = (int) (keyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f72y = (int) (keyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f71x;
        float f7 = motionPaths.width;
        float f8 = motionPaths.f72y;
        float f9 = motionPaths.height;
        float f10 = (motionPaths2.f71x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f72y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f71x = (int) ((f6 + f12) - f14);
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f72y = (int) ((f8 + f15) - f17);
        this.width = (int) (f7 + f13);
        this.height = (int) (f9 + f16);
        float f18 = Float.isNaN(keyPosition.mPercentY) ? BitmapDescriptorFactory.HUE_RED : keyPosition.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f71x + f12) - f14);
        float f20 = (int) ((motionPaths.f72y + f15) - f17);
        this.f71x = f19 + ((-f11) * f18);
        this.f72y = f20 + (f10 * f18);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f71x, motionPaths.f71x);
        boolean zDiff2 = diff(this.f72y, motionPaths.f72y);
    ...
    void setView(float f, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z) {
        ...
        if (motionController != null) {
            ...
            f2 = f7;
            if (!Float.isNaN(f15)) {
                view.setRotation((float) (((double) BitmapDescriptorFactory.HUE_RED) + ((double) f15) + Math.toDegrees(Math.atan2(f10 + (f12 / 2.0f), f9 + (f11 / 2.0f)))));
            }
        }
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f71x, this.f72y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[i2];
