...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo2723clone = transition.mo2723clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo2723clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo2723clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo2723clone);
    }
    ...
    public static void m400go(@NonNull Scene scene) {
    ...
    public static TransitionSeekController createSeekController(@NonNull Scene scene, @NonNull Transition transition) {
        ...
        transitionSet.addTransition(transitionMo2723clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    /* JADX INFO: renamed from: go */
    public static void m401go(@NonNull Scene scene, @Nullable Transition transition) {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo2723clone = transition.mo2723clone();
        sceneChangeSetup(viewGroup, transitionMo2723clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2723clone);
    }
