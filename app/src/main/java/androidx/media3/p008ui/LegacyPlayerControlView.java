...
public class LegacyPlayerControlView extends FrameLayout {
    ...
    public LegacyPlayerControlView(Context context, @Nullable AttributeSet attributeSet, int i, @Nullable AttributeSet attributeSet2) {
        ...
        this.hideAtMs = C0740C.TIME_UNSET;
        ...
        this.currentPosition = C0740C.TIME_UNSET;
        this.currentBufferedPosition = C0740C.TIME_UNSET;
    }
    ...
    private static boolean canShowMultiWindowTimeBar(Timeline timeline, Timeline.Window window) {
        ...
        for (int i = 0; i < windowCount; i++) {
            if (timeline.getWindow(i, window).durationUs == C0740C.TIME_UNSET) {
                return false;
            }
        }
        return true;
