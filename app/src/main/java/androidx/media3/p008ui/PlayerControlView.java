...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, @Nullable AttributeSet attributeSet, int i, @Nullable AttributeSet attributeSet2) {
        ...
        if (attributeSet2 != null) {
            ...
            try {
                int resourceId3 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_controller_layout_id, i19);
                int resourceId4 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_play_icon, i20);
                int resourceId5 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_pause_icon, i21);
                int resourceId6 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_next_icon, i22);
                int resourceId7 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fastforward_icon, i23);
                int resourceId8 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_previous_icon, i24);
                int resourceId9 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_rewind_icon, i25);
                int resourceId10 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fullscreen_exit_icon, i26);
                int resourceId11 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fullscreen_enter_icon, i27);
                int resourceId12 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_off_icon, i28);
                int resourceId13 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_one_icon, i29);
                int resourceId14 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_all_icon, i30);
                int resourceId15 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_shuffle_on_icon, i31);
                int resourceId16 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_shuffle_off_icon, i32);
                resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_subtitle_on_icon, i33);
                resourceId2 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_subtitle_off_icon, i34);
                int resourceId17 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_vr_icon, i35);
        ...
        if (viewFindViewById != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(viewFindViewById, componentListener);
        }
        ...
        if (imageView4 != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(imageView4, componentListener);
        }
        ImageView imageView5 = (ImageView) playerControlView2.findViewById(R.id.exo_prev);
        playerControlView2.previousButton = imageView5;
        if (imageView5 != null) {
            imageView5.setImageDrawable(Util.getDrawable(context, resources, i15));
            InstrumentationCallbacks.setOnClickListenerCalled(imageView5, componentListener);
        }
        ImageView imageView6 = (ImageView) playerControlView2.findViewById(R.id.exo_next);
        playerControlView2.nextButton = imageView6;
        if (imageView6 != null) {
            imageView6.setImageDrawable(Util.getDrawable(context, resources, i8));
            InstrumentationCallbacks.setOnClickListenerCalled(imageView6, componentListener);
        }
        ...
        if (imageView7 != null) {
            imageView7.setImageDrawable(Util.getDrawable(context, resources, i36));
        ...
        if (view != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(view, componentListener);
        }
        ...
        if (view2 != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(view2, componentListener);
        }
        ...
        if (imageView9 != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(imageView9, componentListener);
        }
        ...
        if (imageView10 != null) {
            InstrumentationCallbacks.setOnClickListenerCalled(imageView10, componentListener);
        }
        ...
        if (imageView11 != null) {
            imageView11.setImageDrawable(Util.getDrawable(context, resources, i9));
        ...
        playerControlView2.subtitleOnButtonDrawable = Util.getDrawable(context, resources, i17);
        playerControlView2.subtitleOffButtonDrawable = Util.getDrawable(context, resources, i18);
        ...
        playerControlView2.fullScreenExitDrawable = Util.getDrawable(context, resources, i2);
        ...
        playerControlViewLayoutManager.setShowButton(imageView5, z7);
        ...
        playerControlViewLayoutManager.setShowButton(imageView9, playerControlView2.repeatToggleModes != 0 ? true : z9);
        playerControlView2.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.media3.ui.PlayerControlView$$ExternalSyntheticLambda2
            ...
            public final void onLayoutChange(View view3, int i37, int i38, int i39, int i40, int i41, int i42, int i43, int i44) {
                this.f$0.onLayoutChange(view3, i37, i38, i39, i40, i41, i42, i43, i44);
            }
        });
    }
    ...
    private void initTrackSelectionAdapter() {
        ...
        if (player != null && player.isCommandAvailable(30) && this.player.isCommandAvailable(29)) {
            ...
            if (this.controlViewLayoutManager.getShowButton(this.subtitleButton)) {
                ...
                this.textTrackSelectionAdapter.init(ImmutableList.m1516of());
            }
        }
    }
    ...
    public void updateTimeline() {
        ...
        if (!currentTimeline.isEmpty()) {
            ...
            while (i2 <= windowCount) {
                ...
                if (window2.durationUs == C0740C.TIME_UNSET) {
            ...
            if (player.isCommandAvailable(16)) {
                ...
                if (contentDuration != C0740C.TIME_UNSET) {
    ...
    private static boolean canShowMultiWindowTimeBar(Player player, Timeline.Window window) {
        ...
        for (int i = 0; i < windowCount; i++) {
            if (currentTimeline.getWindow(i, window).durationUs == C0740C.TIME_UNSET) {
                return false;
            }
        }
        return true;
    ...
    abstract class TrackSelectionAdapter extends RecyclerView.Adapter {
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0(Player player, TrackGroup trackGroup, TrackInformation trackInformation, View view) {
            if (player.isCommandAvailable(29)) {
                player.setTrackSelectionParameters(player.getTrackSelectionParameters().buildUpon().setOverrideForType(new TrackSelectionOverride(trackGroup, ImmutableList.m1517of(Integer.valueOf(trackInformation.trackIndex)))).setTrackTypeDisabled(trackInformation.trackGroup.getType(), false).build());
