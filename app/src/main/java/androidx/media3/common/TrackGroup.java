...
public final class TrackGroup {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f107id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f107id.equals(trackGroup.f107id) && Arrays.equals(this.formats, trackGroup.formats);
    }
    ...
    private static String normalizeLanguage(String str) {
        return (str == null || str.equals(C0740C.LANGUAGE_UNDETERMINED)) ? "" : str;
    }

    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m227e("TrackGroup", "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
