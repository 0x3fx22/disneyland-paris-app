...
public final class MediaMetadata {
    ...
    public static final class Builder {
        ...
        @CanIgnoreReturnValue
        public Builder setRecordingMonth(@IntRange(from = 1, m4to = 12) @Nullable Integer num) {
            this.recordingMonth = num;
            return this;
        }

        @CanIgnoreReturnValue
        public Builder setRecordingDay(@IntRange(from = 1, m4to = 31) @Nullable Integer num) {
        ...
        @CanIgnoreReturnValue
        public Builder setReleaseMonth(@IntRange(from = 1, m4to = 12) @Nullable Integer num) {
            this.releaseMonth = num;
            return this;
        }

        @CanIgnoreReturnValue
        public Builder setReleaseDay(@IntRange(from = 1, m4to = 31) @Nullable Integer num) {
            this.releaseDay = num;
            return this;
        }
