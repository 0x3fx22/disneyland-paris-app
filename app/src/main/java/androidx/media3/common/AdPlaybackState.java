...
public final class AdPlaybackState {
    ...
    public static final AdPlaybackState NONE = new AdPlaybackState(null, new AdGroup[0], 0, C0740C.TIME_UNSET, 0);
    ...
    public static final class AdGroup {
        ...
        private static long[] copyDurationsUsWithSpaceForAdCount(long[] jArr, int i) {
            ...
            Arrays.fill(jArrCopyOf, length, iMax, C0740C.TIME_UNSET);
            return jArrCopyOf;
        }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, createEmptyAdGroups(jArr), 0L, C0740C.TIME_UNSET, 0);
    }
    ...
    private boolean isPositionBeforeAdGroup(long j, long j2, int i) {
        ...
        if (j3 == Long.MIN_VALUE) {
            return j2 == C0740C.TIME_UNSET || (adGroup.isServerSideInserted && adGroup.count == -1) || j < j2;
        }
        return j < j3;
    }
