...
public class TrackSelectionParameters {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m1516of();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = ImmutableList.m1516of();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = ImmutableList.m1516of();
            this.audioOffloadPreferences = AudioOffloadPreferences.DEFAULT;
            this.preferredTextLanguages = ImmutableList.m1516of();
        ...
        public Builder setPreferredTextLanguageAndRoleFlagsToCaptioningManagerSettings(Context context) {
            ...
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                ...
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m1517of(Util.getLocaleLanguageTag(locale));
                }
            }
            return this;
        }
