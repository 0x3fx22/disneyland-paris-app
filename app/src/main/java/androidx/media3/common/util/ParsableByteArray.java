...
public final class ParsableByteArray {
    private static final char[] CR_AND_LF = {CharUtils.f3982CR, '\n'};

    /* JADX INFO: renamed from: LF */
    private static final char[] f108LF = {'\n'};
    private static final ImmutableSet SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.m1568of(Charsets.US_ASCII, Charsets.UTF_8, Charsets.UTF_16, Charsets.UTF_16BE, Charsets.UTF_16LE);
    private byte[] data;
    private int limit;
    ...
    private void skipLineTerminator(Charset charset) {
        if (readCharacterIfInList(charset, CR_AND_LF) == '\r') {
            readCharacterIfInList(charset, f108LF);
        }
    }
