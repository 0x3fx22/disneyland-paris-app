...
public final class MediaItem {
    ...
    public static final class Builder {
        ...
        public Builder setSubtitles(@Nullable List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m1516of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder() {
                this.licenseRequestHeaders = ImmutableMap.m1535of();
                this.playClearContentWithoutKey = true;
                this.forcedSessionTrackTypes = ImmutableList.m1516of();
            }
            ...
            public Builder setForceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList immutableListM1516of;
                if (z) {
                    immutableListM1516of = ImmutableList.m1518of(2, 1);
                } else {
                    immutableListM1516of = ImmutableList.m1516of();
                }
                setForcedSessionTrackTypes(immutableListM1516of);
                return this;
            }
    ...
    public static final class LocalConfiguration {
        ...
        private LocalConfiguration(Uri uri, String str, DrmConfiguration drmConfiguration, AdsConfiguration adsConfiguration, List list, String str2, ImmutableList immutableList, Object obj, long j) {
            ...
            for (int i = 0; i < immutableList.size(); i++) {
                builder.add(((SubtitleConfiguration) immutableList.get(i)).buildUpon().buildSubtitle());
            }
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList2 == null) {
                immutableListFromBundleList2 = ImmutableList.m1516of();
            } else {
    ...
    public static final class LiveConfiguration {
        ...
        public static final class Builder {
            ...
            public Builder() {
                this.targetOffsetMs = C0740C.TIME_UNSET;
                this.minOffsetMs = C0740C.TIME_UNSET;
                this.maxOffsetMs = C0740C.TIME_UNSET;
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f105id = subtitleConfiguration.f104id;
            }
