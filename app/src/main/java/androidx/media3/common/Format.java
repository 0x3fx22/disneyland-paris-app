...
public final class Format {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.labels = ImmutableList.m1516of();
        ...
        public Builder setId(int i) {
            this.f103id = Integer.toString(i);
            return this;
        }
    ...
    private Format(Builder builder) {
        ...
        if (!builder.labels.isEmpty() || builder.label == null) {
            ...
            this.labels = ImmutableList.m1517of(new Label(strNormalizeLanguageCode, builder.label));
            this.label = builder.label;
        }
    ...
    public String toString() {
        return "Format(" + this.f102id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(@Nullable Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C0740C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add(C0740C.CENC_TYPE_cenc);
                } else if (uuid.equals(C0740C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C0740C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C0740C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C0740C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m1488on(',').appendTo(sb, (Iterable<? extends Object>) linkedHashSet);
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            Joiner.m1488on(',').appendTo(sb, (Iterable<? extends Object>) format.labels);
            sb.append("]");
        }
        if (format.selectionFlags != 0) {
            sb.append(", selectionFlags=[");
            Joiner.m1488on(',').appendTo(sb, (Iterable<? extends Object>) Util.getSelectionFlagStrings(format.selectionFlags));
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            Joiner.m1488on(',').appendTo(sb, (Iterable<? extends Object>) Util.getRoleFlagStrings(format.roleFlags));
            sb.append("]");
        }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f102id);
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.f102id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label));
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(FIELD_LABELS);
        if (parcelableArrayList == null) {
            immutableListFromBundleList = ImmutableList.m1516of();
        } else {
