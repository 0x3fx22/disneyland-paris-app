...
public final class AdtsReader implements ElementaryStreamReader {
    ...
    public AdtsReader(boolean z, @Nullable String str, int i) {
        ...
        this.sampleDurationUs = C0740C.TIME_UNSET;
    ...
    private void parseAdtsHeader() throws ParserException {
        ...
        if (!this.hasOutputFormat) {
            ...
            if (bits != 2) {
                Log.m230w("AdtsReader", "Detected audio object type: " + bits + ", but assuming AAC LC.");
            } else {
                i = bits;
            }
    ...
    private void readSample(ParsableByteArray parsableByteArray) {
        ...
        if (i == this.sampleSize) {
            Assertions.checkState(this.timeUs != C0740C.TIME_UNSET);
