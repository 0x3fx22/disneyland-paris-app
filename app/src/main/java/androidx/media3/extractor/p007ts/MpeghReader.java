...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private int samplingRate = C0740C.RATE_UNSET_INT;
    ...
    public void seek() {
        ...
        this.frameBytes = 0;
        this.samplingRate = C0740C.RATE_UNSET_INT;
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        if (j != j2) {
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setSampleMimeType(MimeTypes.AUDIO_MPEGH_MHM1).setSampleRate(this.samplingRate).setCodecs(str).setInitializationData((bArr == null || bArr.length <= 0) ? null : ImmutableList.m1518of(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }
