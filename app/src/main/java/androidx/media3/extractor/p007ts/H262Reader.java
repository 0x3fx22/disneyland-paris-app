...
public final class H262Reader implements ElementaryStreamReader {
    ...
    H262Reader(UserDataReader userDataReader) {
        ...
        this.pesTimeUs = C0740C.TIME_UNSET;
        this.sampleTimeUs = C0740C.TIME_UNSET;
    }
            ...
            if (i3 == 0 || i3 == 179) {
                ...
                if (!this.startedFirstSample || this.sampleHasPicture) {
                    ...
                    if (j2 == C0740C.TIME_UNSET) {
                        ...
                        j2 = j3 != C0740C.TIME_UNSET ? j3 + this.frameDurationUs : -9223372036854775807L;
                    }
    ...
    private static Pair parseCsdBuffer(CsdBuffer csdBuffer, String str) {
        ...
        byte b = bArrCopyOf[5];
        int i6 = (i5 << 4) | ((b & 255) >> 4);
        int i7 = ((b & Ascii.f3531SI) << 8) | (bArrCopyOf[6] & 255);
        ...
        if (i2 >= 0) {
            ...
            if (i2 < dArr.length) {
                ...
                i3 = (b3 & CBORConstants.BYTE_EMPTY_STRING) >> 5;
                i4 = b3 & Ascii.f3534US;
                if (i3 != i4) {
                    d *= (((double) i3) + 1.0d) / ((double) (i4 + 1));
                }
