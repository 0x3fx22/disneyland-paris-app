...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(C0740C.CENC_TYPE_cbc1)) {
                    b = 0;
                }
                break;
            case 3046671:
                if (str.equals(C0740C.CENC_TYPE_cbcs)) {
                    b = 1;
                }
                break;
            case 3049879:
                if (str.equals(C0740C.CENC_TYPE_cenc)) {
                    b = 2;
                }
                break;
            case 3049895:
                if (str.equals(C0740C.CENC_TYPE_cens)) {
                    b = 3;
                }
                break;
        }
        switch (b) {
            ...
            case 1:
                return 2;
            default:
                Log.m230w("TrackEncryptionBox", "Unsupported protection scheme type '" + str + "'. Assuming AES-CTR crypto mode.");
            case 2:
            case 3:
                return 1;
        }
