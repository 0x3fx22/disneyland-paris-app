...
public final class Cea608Decoder extends CeaDecoder {
    ...
    public Cea608Decoder(String str, int i, long j) {
        if (j != C0740C.TIME_UNSET) {
            ...
            this.validDataChannelTimeoutUs = C0740C.TIME_UNSET;
        }
        ...
        if (i == 1) {
            ...
            Log.m230w("Cea608Decoder", "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        }
        setCaptionMode(0);
        ...
        this.lastCueUpdateUs = C0740C.TIME_UNSET;
    }
    ...
    private static char getSpecialNorthAmericanChar(byte b) {
        return (char) SPECIAL_CHARACTER_SET[b & Ascii.f3531SI];
    }
    ...
    private static char getExtendedEsFrChar(byte b) {
        return (char) SPECIAL_ES_FR_CHARACTER_SET[b & Ascii.f3534US];
    }

    private static char getExtendedPtDeChar(byte b) {
        return (char) SPECIAL_PT_DE_CHARACTER_SET[b & Ascii.f3534US];
    }
    ...
    private boolean shouldClearStuckCaptions() {
        return (this.validDataChannelTimeoutUs == C0740C.TIME_UNSET || this.lastCueUpdateUs == C0740C.TIME_UNSET || getPositionUs() - this.lastCueUpdateUs < this.validDataChannelTimeoutUs) ? false : true;
    }
}
