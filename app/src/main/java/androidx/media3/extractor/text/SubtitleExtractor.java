...
public class SubtitleExtractor implements Extractor {
    ...
    private long seekTimeUs = C0740C.TIME_UNSET;
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        extractorOutput.seekMap(new IndexSeekMap(new long[]{0}, new long[]{0}, C0740C.TIME_UNSET));
        this.state = 1;
    }
    ...
    public /* synthetic */ void lambda$parseAndWriteToOutput$0(CuesWithTiming cuesWithTiming) {
        ...
        long j = this.seekTimeUs;
        if (j == C0740C.TIME_UNSET || cuesWithTiming.startTimeUs >= j) {
    ...
    private void writeToOutput() {
        long j = this.seekTimeUs;
        for (int iBinarySearchFloor = j == C0740C.TIME_UNSET ? 0 : Util.binarySearchFloor(this.timestamps, j, true, true); iBinarySearchFloor < this.samples.size(); iBinarySearchFloor++) {
