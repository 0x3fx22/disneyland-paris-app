...
public final class DownloadRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            ...
            List listM1516of = this.streamKeys;
            if (listM1516of == null) {
                listM1516of = ImmutableList.m1516of();
            }
            return new DownloadRequest(str, uri, str2, listM1516of, this.keySetId, this.customCacheKey, this.data);
        }
    }
    ...
    DownloadRequest(Parcel parcel) {
        this.f117id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(@Nullable byte[] bArr) {
        return new DownloadRequest(this.f117id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List listEmptyList;
        Assertions.checkArgument(this.f117id.equals(downloadRequest.f117id));
        ...
        return new DownloadRequest(this.f117id, downloadRequest.uri, downloadRequest.mimeType, listEmptyList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f117id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).build();
    }

    public String toString() {
        return this.mimeType + ":" + this.f117id;
    }
