...
public class ImageRenderer extends BaseRenderer {
    ...
    public ImageRenderer(ImageDecoder.Factory factory, ImageOutput imageOutput) {
        ...
        this.largestQueuedPresentationTimeUs = C0740C.TIME_UNSET;
        this.lastProcessedOutputBufferTimeUs = C0740C.TIME_UNSET;
    ...
    */
    protected void onStreamChanged(Format[] formatArr, long j, long j2, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException {
        ...
        if (this.outputStreamInfo.streamOffsetUs != C0740C.TIME_UNSET) {
        ...
        this.outputStreamInfo = new OutputStreamInfo(C0740C.TIME_UNSET, j2);
    }
    ...
    private static final class OutputStreamInfo {
        public static final OutputStreamInfo UNSET = new OutputStreamInfo(C0740C.TIME_UNSET, C0740C.TIME_UNSET);
