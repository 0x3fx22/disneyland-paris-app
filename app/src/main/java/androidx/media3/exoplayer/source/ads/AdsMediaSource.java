...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f120id;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i2 < adMediaSourceHolderArr2.length) {
                    ...
                    jArr[i][i2] = adMediaSourceHolder == null ? C0740C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    i2++;
                }
            }
            i++;
    ...
    private final class AdMediaSourceHolder {
        ...
        private final MediaSource.MediaPeriodId f122id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f122id = mediaPeriodId;
        }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, MediaItem mediaItem) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f122id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    MaskingMediaPeriod maskingMediaPeriod = (MaskingMediaPeriod) this.activeMediaPeriods.get(i);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f120id.windowSequenceNumber));
                }
            }
        ...
        public long getDurationUs() {
            Timeline timeline = this.timeline;
            return timeline == null ? C0740C.TIME_UNSET : timeline.getPeriod(0, AdsMediaSource.this.period).getDurationUs();
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f122id);
            }
        }
