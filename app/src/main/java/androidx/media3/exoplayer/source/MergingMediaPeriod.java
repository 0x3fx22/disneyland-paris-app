...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            num = sampleStream != null ? (Integer) this.streamPeriodIndices.get(sampleStream) : null;
            iArr[i2] = num == null ? -1 : num.intValue();
            ExoTrackSelection exoTrackSelection = exoTrackSelectionArr[i2];
            if (exoTrackSelection != null) {
                String str = exoTrackSelection.getTrackGroup().f107id;
        ...
        while (i3 < this.periods.length) {
            for (int i4 = i; i4 < exoTrackSelectionArr.length; i4++) {
                ...
                if (iArr2[i4] == i3) {
                    ...
                    objArr[i4] = new ForwardingTrackSelection(exoTrackSelection2, (TrackGroup) Assertions.checkNotNull((TrackGroup) this.childTrackGroupByMergedTrackGroup.get(exoTrackSelection2.getTrackGroup())));
                } else {
                    objArr[i4] = num;
                }
            }
    ...
    public long readDiscontinuity() {
        ...
        for (MediaPeriod mediaPeriod : this.enabledPeriods) {
            ...
            if (discontinuity == C0740C.TIME_UNSET) {
                if (j != C0740C.TIME_UNSET && mediaPeriod.seekToUs(j) != j) {
                    throw new IllegalStateException("Unexpected child seekToUs result.");
                }
            } else if (j == C0740C.TIME_UNSET) {
        ...
        while (true) {
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    TrackGroup trackGroup2 = new TrackGroup(i2 + ":" + trackGroup.f107id, formatArr);
