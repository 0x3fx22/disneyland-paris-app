...
public final class ClippingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z, long j, long j2) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? j : C0740C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j2;
    }
    ...
    public long readDiscontinuity() {
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C0740C.TIME_UNSET;
            long discontinuity = readDiscontinuity();
            return discontinuity != C0740C.TIME_UNSET ? discontinuity : j;
        }
        long discontinuity2 = this.mediaPeriod.readDiscontinuity();
        if (discontinuity2 == C0740C.TIME_UNSET) {
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C0740C.TIME_UNSET;
    }
