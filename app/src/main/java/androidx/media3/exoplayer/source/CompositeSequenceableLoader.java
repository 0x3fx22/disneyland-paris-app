...
public final class CompositeSequenceableLoader implements SequenceableLoader {
    ...
    public CompositeSequenceableLoader(SequenceableLoader[] sequenceableLoaderArr) {
        this(ImmutableList.copyOf(sequenceableLoaderArr), Collections.nCopies(sequenceableLoaderArr.length, ImmutableList.m1517of(-1)));
    }
    ...
    public CompositeSequenceableLoader(List<? extends SequenceableLoader> list, List<List<Integer>> list2) {
        ...
        this.lastAudioVideoBufferedPositionUs = C0740C.TIME_UNSET;
    }
    ...
    public long getBufferedPositionUs() {
        ...
        return j != C0740C.TIME_UNSET ? j : jMin2;
    }
