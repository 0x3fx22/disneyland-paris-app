...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws MediaDrmCallbackException {
        ...
        if (TextUtils.isEmpty(licenseServerUrl)) {
            ...
            Uri uri = Uri.EMPTY;
            throw new MediaDrmCallbackException(builder.setUri(uri).build(), uri, ImmutableMap.m1535of(), 0L, new IllegalStateException("No license URL"));
        }
        ...
        if (uuid2.equals(uuid)) {
            ...
            str = C0740C.CLEARKEY_UUID.equals(uuid) ? "application/json" : Mimetypes.MIMETYPE_OCTET_STREAM;
        }
