...
public final class PercentileTimeToFirstByteEstimator implements TimeToFirstByteEstimator {
    ...
    public long getTimeToFirstByteEstimateUs() {
        return !this.isEmpty ? (long) this.slidingPercentile.getPercentile(this.percentile) : C0740C.TIME_UNSET;
    }
    ...
    public void onTransferStart(DataSpec dataSpec) {
        ...
        this.slidingPercentile.addSample(1, Util.msToUs(this.clock.elapsedRealtime()) - l.longValue());
        this.isEmpty = false;
    }
