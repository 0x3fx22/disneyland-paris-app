...
public final class Loader implements LoaderErrorThrower {
    ...
    static {
        ...
        RETRY = createRetryAction(false, C0740C.TIME_UNSET);
        RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0740C.TIME_UNSET);
    ...
    private final class LoadTask extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m227e("LoadTask", "Unexpected exception loading stream", e2);
                obtainMessage(3, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (OutOfMemoryError e3) {
                if (this.released) {
                    return;
                }
                Log.m227e("LoadTask", "OutOfMemory error loading stream", e3);
                obtainMessage(3, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (Error e4) {
                if (!this.released) {
                    Log.m227e("LoadTask", "Unexpected error loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 2) {
                try {
                    ...
                    Log.m227e("LoadTask", "Unexpected exception handling load completed", e);
            ...
            if (loadErrorActionOnLoadError.type != 3) {
                if (loadErrorActionOnLoadError.type != 2) {
                    ...
                    if (loadErrorActionOnLoadError.retryDelayMillis != C0740C.TIME_UNSET) {
