...
public class DebugTextViewHelper {
    ...
    protected String getVideoString() {
        ...
        return "\n" + videoFormat.sampleMimeType + "(id:" + videoFormat.f102id + " r:" + videoSize.width + "x" + videoSize.height + getColorInfoString(videoFormat.colorInfo) + getPixelAspectRatioString(videoSize.pixelWidthHeightRatio) + getDecoderCountersBufferCountString(videoDecoderCounters) + " vfpo: " + getVideoFrameProcessingOffsetAverageString(videoDecoderCounters.totalVideoFrameProcessingOffsetUs, videoDecoderCounters.videoFrameProcessingOffsetCount) + ")";
    }
    ...
    protected String getAudioString() {
        ...
        return "\n" + audioFormat.sampleMimeType + "(id:" + audioFormat.f102id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + ")";
    }
