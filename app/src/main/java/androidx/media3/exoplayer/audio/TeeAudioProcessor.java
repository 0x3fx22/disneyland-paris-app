    ...
    public static final class WavFileAudioBufferSink implements AudioBufferSink {
        ...
        public void flush(int i, int i2, int i3) {
            try {
                ...
                Log.m227e("WaveFileAudioBufferSink", "Error resetting", e);
            }
            this.sampleRateHz = i;
        ...
        public void handleBuffer(ByteBuffer byteBuffer) {
            try {
                ...
                Log.m227e("WaveFileAudioBufferSink", "Error writing data", e);
            }
        }
        ...
        private void reset() {
            ...
            try {
                ...
                Log.m231w("WaveFileAudioBufferSink", "Error updating file size", e);
            }
            try {
