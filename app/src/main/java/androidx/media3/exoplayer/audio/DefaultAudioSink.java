...
public final class DefaultAudioSink implements AudioSink {
    ...
    private DefaultAudioSink(Builder builder) {
        ...
        this.toIntPcmAvailableAudioProcessors = ImmutableList.m1519of((TrimmingAudioProcessor) new ToInt16PcmAudioProcessor(), (TrimmingAudioProcessor) channelMappingAudioProcessor, trimmingAudioProcessor);
        this.toFloatPcmAvailableAudioProcessors = ImmutableList.m1517of(new ToFloatPcmAudioProcessor());
        this.volume = 1.0f;
    ...
    public int getFormatSupport(Format format) {
        ...
        if (!Util.isEncodingLinearPcm(format.pcmEncoding)) {
            Log.m230w("DefaultAudioSink", "Invalid PCM encoding: " + format.pcmEncoding);
            return 0;
        }
    ...
    public void configure(Format format, int i, @Nullable int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            try {
                ...
                int i8 = audioFormatConfigure.sampleRate;
                int audioTrackChannelConfig = Util.getAudioTrackChannelConfig(audioFormatConfigure.channelCount);
                z = false;
                pcmFrameSize = Util.getPcmFrameSize(i7, audioFormatConfigure.channelCount);
            ...
            audioProcessingPipeline = new AudioProcessingPipeline(ImmutableList.m1516of());
        ...
        if (MimeTypes.AUDIO_DTS_EXPRESS.equals(format.sampleMimeType) && i9 == -1) {
            i9 = 768000;
        }
        int i10 = i9;
        if (i != 0) {
            ...
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i2, iIntValue, i3), i3, i4, pcmFrameSize != -1 ? pcmFrameSize : 1, i2, i10, z2 ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        Configuration configuration = new Configuration(format, i5, i4, pcmFrameSize, i2, iIntValue, i3, bufferSizeInBytes, audioProcessingPipeline, z2, z, this.tunneling);
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws Exception {
        ...
        Log.m230w("DefaultAudioSink", "Resetting stalled audio track");
        flush();
        return true;
    }
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws Exception {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (Util.SDK_INT < 21) {
                ...
                Assertions.checkState(j != C0740C.TIME_UNSET);
                if (j == Long.MIN_VALUE) {
    ...
    private void setAudioTrackPlaybackParametersV23() {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m231w("DefaultAudioSink", "Failed to set playback params", e);
            }
    ...
    private void setAudioProcessorPlaybackParameters(PlaybackParameters playbackParameters) {
        MediaPositionParameters mediaPositionParameters = new MediaPositionParameters(playbackParameters, C0740C.TIME_UNSET, C0740C.TIME_UNSET);
        if (isAudioTrackInitialized()) {
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            Log.m230w("DefaultAudioSink", str);
        }
        ...
        public void onInvalidLatency(long j) {
            Log.m230w("DefaultAudioSink", "Ignoring impossibly large audio latency: " + j);
        }
