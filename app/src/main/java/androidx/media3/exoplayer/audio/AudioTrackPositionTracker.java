...
final class AudioTrackPositionTracker {
    ...
    public void setAudioTrack(AudioTrack audioTrack, boolean z, int i, int i2, int i3) {
        ...
        this.hasData = false;
        this.stopTimestampUs = C0740C.TIME_UNSET;
        this.forceResetWorkaroundTimeMs = C0740C.TIME_UNSET;
    ...
    public void start() {
        if (this.stopTimestampUs != C0740C.TIME_UNSET) {
    ...
    public boolean isStalled(long j) {
        return this.forceResetWorkaroundTimeMs != C0740C.TIME_UNSET && j > 0 && this.clock.elapsedRealtime() - this.forceResetWorkaroundTimeMs >= 200;
    }
    ...
    private void updateRawPlaybackHeadPosition(long j) {
        ...
        if (Util.SDK_INT <= 29) {
            if (playbackHeadPosition == 0 && this.rawPlaybackHeadPosition > 0 && playState == 3) {
                if (this.forceResetWorkaroundTimeMs == C0740C.TIME_UNSET) {
