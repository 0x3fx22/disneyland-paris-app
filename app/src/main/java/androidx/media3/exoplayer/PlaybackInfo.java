...
final class PlaybackInfo {
    ...
    public static PlaybackInfo createDummy(TrackSelectorResult trackSelectorResult) {
        ...
        return new PlaybackInfo(timeline, mediaPeriodId, C0740C.TIME_UNSET, 0L, 1, null, false, TrackGroupArray.EMPTY, trackSelectorResult, ImmutableList.m1516of(), mediaPeriodId, false, 1, 0, PlaybackParameters.DEFAULT, 0L, 0L, 0L, 0L, false);
    }
