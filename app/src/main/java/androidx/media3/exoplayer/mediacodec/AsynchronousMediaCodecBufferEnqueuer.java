...
class AsynchronousMediaCodecBufferEnqueuer implements MediaCodecBufferEnqueuer {
    ...
    public void doHandleMessage(Message message) {
        ...
        if (i == 1) {
            ...
            if (i == 3) {
                ...
                PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
            }
        } else {
            messageParams = (MessageParams) message.obj;
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) {
        try {
            ...
            PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.pendingRuntimeException, null, e);
        }
    }
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        cryptoInfo2.iv = (byte[]) Assertions.checkNotNull(copy(cryptoInfo.f110iv, cryptoInfo2.iv));
