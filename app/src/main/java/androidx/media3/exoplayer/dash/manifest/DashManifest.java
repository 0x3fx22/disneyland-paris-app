...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    public final DashManifest copy(List<StreamKey> list) {
        ...
        while (true) {
            ...
            if (((StreamKey) linkedList.peek()).periodIndex != i) {
                ...
                if (periodDurationMs != C0740C.TIME_UNSET) {
                    j2 += periodDurationMs;
                }
            } else {
                Period period = getPeriod(i);
                arrayList.add(new Period(period.f116id, period.startMs - j2, copyAdaptationSets(period.adaptationSets, linkedList), period.eventStreams));
            }
            i++;
        }
    ...
    private static ArrayList copyAdaptationSets(List list, LinkedList linkedList) {
        ...
        do {
            ...
            arrayList.add(new AdaptationSet(adaptationSet.f114id, adaptationSet.type, arrayList2, adaptationSet.accessibilityDescriptors, adaptationSet.essentialProperties, adaptationSet.supplementalProperties));
