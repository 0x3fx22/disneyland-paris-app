...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    public void updateManifest(DashManifest dashManifest) {
        ...
        this.expiredManifestPublishTimeUs = C0740C.TIME_UNSET;
        this.manifest = dashManifest;
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private long maxLoadedChunkEndTimeUs = C0740C.TIME_UNSET;
        ...
        public void onChunkLoadCompleted(Chunk chunk) {
            ...
            if (j == C0740C.TIME_UNSET || chunk.endTimeUs > j) {
        ...
        public boolean onChunkLoadError(Chunk chunk) {
            long j = this.maxLoadedChunkEndTimeUs;
            return PlayerEmsgHandler.this.onChunkLoadError(j != C0740C.TIME_UNSET && j < chunk.startTimeUs);
        }
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (manifestPublishTimeMsInEmsg == C0740C.TIME_UNSET) {
                return;
            }
