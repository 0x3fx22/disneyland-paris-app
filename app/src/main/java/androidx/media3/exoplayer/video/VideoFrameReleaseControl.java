...
public final class VideoFrameReleaseControl {
    ...
    private long initialPositionUs = C0740C.TIME_UNSET;
    private long lastPresentationTimeUs = C0740C.TIME_UNSET;
    private long joiningDeadlineMs = C0740C.TIME_UNSET;
    ...
    public static class FrameReleaseInfo {
        private long earlyUs = C0740C.TIME_UNSET;
        private long releaseTimeNs = C0740C.TIME_UNSET;
        ...
        public void reset() {
            this.earlyUs = C0740C.TIME_UNSET;
            this.releaseTimeNs = C0740C.TIME_UNSET;
        }
    }
    ...
    public void onStopped() {
        this.started = false;
        this.joiningDeadlineMs = C0740C.TIME_UNSET;
    ...
    public boolean isReady(boolean z) {
        ...
        if (this.joiningDeadlineMs == C0740C.TIME_UNSET) {
            return false;
        }
    ...
    public void join(boolean z) {
        ...
        this.joiningDeadlineMs = this.allowedJoiningTimeMs > 0 ? this.clock.elapsedRealtime() + this.allowedJoiningTimeMs : C0740C.TIME_UNSET;
    }
    ...
    public int getFrameReleaseAction(long j, long j2, long j3, long j4, boolean z, FrameReleaseInfo frameReleaseInfo) throws ExoPlaybackException {
        ...
        if (this.initialPositionUs == C0740C.TIME_UNSET) {
        ...
        if (this.joiningDeadlineMs != C0740C.TIME_UNSET && !this.joiningRenderNextFrameImmediately) {
            z2 = true;
        }
    ...
    public void reset() {
        ...
        this.lastPresentationTimeUs = C0740C.TIME_UNSET;
        this.initialPositionUs = C0740C.TIME_UNSET;
        lowerFirstFrameState(1);
        this.joiningDeadlineMs = C0740C.TIME_UNSET;
    }
