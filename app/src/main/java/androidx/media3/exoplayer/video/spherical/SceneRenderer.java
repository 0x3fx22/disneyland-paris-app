...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public SurfaceTexture init() {
        try {
            ...
            Log.m227e("SceneRenderer", "Failed to initialize the renderer", e);
        }
    ...
    public void drawFrame(float[] fArr, boolean z) {
        ...
        try {
            ...
            Log.m227e("SceneRenderer", "Failed to draw a frame", e);
        }
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.m227e("SceneRenderer", "Failed to draw a frame", e2);
            }
