            ...
            try {
                if (i != 1) {
                    ...
                    try {
                        ...
                        try {
                            Log.m227e("PlaceholderSurface", "Failed to release placeholder surface", th);
                        } finally {
                            quit();
                        }
                    }
                ...
                try {
                    ...
                    Log.m227e("PlaceholderSurface", "Failed to initialize placeholder surface", e);
                    this.initException = new IllegalStateException(e);
                    synchronized (this) {
                        notify();
                    }
                } catch (Error e2) {
                    Log.m227e("PlaceholderSurface", "Failed to initialize placeholder surface", e2);
                    this.initError = e2;
                    synchronized (this) {
                        notify();
                    }
                } catch (RuntimeException e3) {
                    Log.m227e("PlaceholderSurface", "Failed to initialize placeholder surface", e3);
