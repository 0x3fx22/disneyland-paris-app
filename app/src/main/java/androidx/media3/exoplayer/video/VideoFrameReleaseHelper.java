...
public final class VideoFrameReleaseHelper {
    ...
    public VideoFrameReleaseHelper(@Nullable Context context) {
        ...
        this.vsyncDurationNs = C0740C.TIME_UNSET;
        this.vsyncOffsetNs = C0740C.TIME_UNSET;
    ...
    public long adjustReleaseTime(long j) {
        ...
        if (vSyncSampler == null || this.vsyncDurationNs == C0740C.TIME_UNSET) {
            return j2;
        }
        long j3 = vSyncSampler.sampledVsyncTimeNs;
        return j3 == C0740C.TIME_UNSET ? j2 : closestVsync(j2, j3, this.vsyncDurationNs) - this.vsyncOffsetNs;
    }
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        if (display != null) {
            ...
            Log.m230w("VideoFrameReleaseHelper", "Unable to query display refresh rate");
            this.vsyncDurationNs = C0740C.TIME_UNSET;
            this.vsyncOffsetNs = C0740C.TIME_UNSET;
        }
    }
    ...
    private static final class Api30 {
        ...
        public static void setSurfaceFrameRate(Surface surface, float f) {
            try {
                ...
                Log.m227e("VideoFrameReleaseHelper", "Failed to call Surface.setFrameRate", e);
            }
        }
    }
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C0740C.TIME_UNSET;
        ...
        private void createChoreographerInstanceInternal() {
            try {
                ...
                Log.m231w("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", e);
            }
        }
        ...
        private void removeObserverInternal() {
            ...
            if (choreographer != null) {
                ...
                if (i == 0) {
                    ...
                    this.sampledVsyncTimeNs = C0740C.TIME_UNSET;
                }
            }
        }
    }
