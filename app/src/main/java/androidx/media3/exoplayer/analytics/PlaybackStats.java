...
public final class PlaybackStats {
    ...
    public static PlaybackStats merge(PlaybackStats... playbackStatsArr) {
        ...
        int i4 = 0;
        int i5 = -1;
        long jMax = C0740C.TIME_UNSET;
        long jMin = C0740C.TIME_UNSET;
        int i6 = 0;
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        long j11 = C0740C.TIME_UNSET;
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        int i13 = 0;
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i == 0 ? C0740C.TIME_UNSET : this.totalValidJoinTimeMs / ((long) i);
    }
    ...
    public long getMeanPlayTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalPlayTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanPausedTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalPausedTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanRebufferTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalRebufferTimeMs() / ((long) this.foregroundPlaybackCount);
    }

    public long getMeanSingleRebufferTimeMs() {
        return this.totalRebufferCount == 0 ? C0740C.TIME_UNSET : (getPlaybackStateDurationMs(6) + getPlaybackStateDurationMs(7)) / ((long) this.totalRebufferCount);
    }
    ...
    public long getMeanSeekTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.foregroundPlaybackCount);
    }

    public long getMeanSingleSeekTimeMs() {
        return this.totalSeekCount == 0 ? C0740C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.totalSeekCount);
    }
    ...
    public long getMeanWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalWaitTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanPlayAndWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C0740C.TIME_UNSET : getTotalPlayAndWaitTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanElapsedTimeMs() {
        return this.playbackCount == 0 ? C0740C.TIME_UNSET : getTotalElapsedTimeMs() / ((long) this.playbackCount);
    }
