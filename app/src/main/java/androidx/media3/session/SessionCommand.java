...
public final class SessionCommand {
    ...
    static final ImmutableList SESSION_COMMANDS = ImmutableList.m1517of(Integer.valueOf(COMMAND_CODE_SESSION_SET_RATING));
