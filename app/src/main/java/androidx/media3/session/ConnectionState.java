...
class ConnectionState {
    ...
    public static ConnectionState fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList != null) {
            immutableListM1516of = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.session.ConnectionState$$ExternalSyntheticLambda1
        ...
        ImmutableList immutableList = immutableListM1516of;
