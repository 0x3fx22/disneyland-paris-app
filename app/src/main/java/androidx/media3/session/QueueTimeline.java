...
final class QueueTimeline extends Timeline {
    public static final QueueTimeline DEFAULT = new QueueTimeline(ImmutableList.m1516of(), null);
    ...
    public static QueueTimeline create(List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            builder.add(new QueuedMediaItem(LegacyConversions.convertToMediaItem(queueItem), queueItem.getQueueId(), C0740C.TIME_UNSET));
        }
    ...
    public QueueTimeline copyWithNewMediaItems(int i, List list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            builder.add(new QueuedMediaItem((MediaItem) list.get(i2), -1L, C0740C.TIME_UNSET));
        }
        ImmutableList immutableList = this.queuedMediaItems;
    ...
    public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
        ...
        window.set(FAKE_WINDOW_UID, queuedMediaItem.mediaItem, null, C0740C.TIME_UNSET, C0740C.TIME_UNSET, C0740C.TIME_UNSET, true, false, null, 0L, Util.msToUs(queuedMediaItem.durationMs), i, i, 0L);
        return window;
    }
