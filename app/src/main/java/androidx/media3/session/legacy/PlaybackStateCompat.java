...
public final class PlaybackStateCompat implements Parcelable {
    ...
    PlaybackStateCompat(int i, long j, long j2, float f, long j3, int i2, CharSequence charSequence, long j4, List list, long j5, Bundle bundle) {
        ...
        this.mUpdateTime = j4;
        this.mCustomActions = list == null ? ImmutableList.m1516of() : new ArrayList(list);
    ...
    PlaybackStateCompat(Parcel parcel) {
        ...
        this.mCustomActions = listCreateTypedArrayList == null ? ImmutableList.m1516of() : listCreateTypedArrayList;
