...
class PlayerInfo {
    ...
    public static class Builder {
        ...
        @CanIgnoreReturnValue
        public Builder setVolume(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
            this.volume = f;
            return this;
        }
    ...
    public Bundle toBundleForRemoteProcess(int i) {
        ...
        long j5 = i >= 6 ? C0740C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS : 0L;
    ...
    public static PlayerInfo fromBundle(Bundle bundle, int i) {
        ...
        long j3 = bundle.getLong(FIELD_MAX_SEEK_TO_PREVIOUS_POSITION_MS, i >= 4 ? C0740C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS : 0L);
