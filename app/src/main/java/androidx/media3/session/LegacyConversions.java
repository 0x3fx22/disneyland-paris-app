...
abstract class LegacyConversions {
    ...
    public static final ImmutableSet KNOWN_METADATA_COMPAT_KEYS = ImmutableSet.m1569of("android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.DURATION", "android.media.metadata.ALBUM", "android.media.metadata.AUTHOR", "android.media.metadata.WRITER", "android.media.metadata.COMPOSER", "android.media.metadata.COMPILATION", "android.media.metadata.DATE", "android.media.metadata.YEAR", "android.media.metadata.GENRE", "android.media.metadata.TRACK_NUMBER", "android.media.metadata.NUM_TRACKS", "android.media.metadata.DISC_NUMBER", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.ART", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART", "android.media.metadata.ALBUM_ART_URI", "android.media.metadata.USER_RATING", "android.media.metadata.RATING", "android.media.metadata.DISPLAY_TITLE", "android.media.metadata.DISPLAY_SUBTITLE", "android.media.metadata.DISPLAY_DESCRIPTION", "android.media.metadata.DISPLAY_ICON", "android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.MEDIA_ID", "android.media.metadata.MEDIA_URI", "android.media.metadata.BT_FOLDER_TYPE", "android.media.metadata.ADVERTISEMENT", "android.media.metadata.DOWNLOAD_STATUS", MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT);
    ...
    public static ImmutableList convertBrowserItemListToMediaItemList(List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            builder.add(convertToMediaItem((MediaBrowserCompat.MediaItem) list.get(i)));
        }
        return builder.build();
    }
    ...
    public static Timeline.Window convertToWindow(MediaItem mediaItem, int i) {
        Timeline.Window window = new Timeline.Window();
        window.set(0, mediaItem, null, 0L, 0L, 0L, true, false, null, 0L, C0740C.TIME_UNSET, i, i, 0L);
        return window;
    }

    public static Timeline.Period convertToPeriod(int i) {
        Timeline.Period period = new Timeline.Period();
        period.set(null, null, i, C0740C.TIME_UNSET, 0L, AdPlaybackState.NONE, true);
        return period;
    }
    ...
    private static MediaMetadata convertToMediaMetadata(MediaDescriptionCompat mediaDescriptionCompat, int i, boolean z, boolean z2) {
        ...
        if (iconBitmap != null) {
            try {
                ...
                Log.m231w("LegacyConversions", "Failed to convert iconBitmap to artworkData", e);
    ...
    public static MediaMetadata convertToMediaMetadata(MediaMetadataCompat mediaMetadataCompat, int i) {
        ...
        if (firstBitmap != null) {
            try {
                ...
                Log.m231w("LegacyConversions", "Failed to convert artworkBitmap to artworkData", e);
            }
        }
    ...
    public static MediaMetadataCompat convertToMediaMetadataCompat(MediaMetadata mediaMetadata, String str, Uri uri, long j, Bitmap bitmap) {
        ...
        if (num != null) {
            builderPutString.putLong("android.media.metadata.YEAR", num.intValue());
        }
        if (uri != null) {
        ...
        if (j == C0740C.TIME_UNSET && (l = mediaMetadata.durationMs) != null) {
            j = l.longValue();
        }
        if (j != C0740C.TIME_UNSET) {
        ...
        Integer num3 = mediaMetadata.mediaType;
        if (num3 != null) {
            builderPutString.putLong(MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT, num3.intValue());
        }
    ...
    public static int convertToPlaybackState(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat, long j) {
        ...
        switch (playbackStateCompat.getState()) {
            ...
            case 2:
                ...
                return (jConvertToDurationMs != C0740C.TIME_UNSET && convertToCurrentPositionMs(playbackStateCompat, mediaMetadataCompat, j) >= jConvertToDurationMs) ? 4 : 3;
            case 3:
                return 3;
            case 4:
            case 5:
    ...
    public static long convertToCurrentPositionMs(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat, long j) {
        ...
        long j2 = position;
        long jConvertToDurationMs = convertToDurationMs(mediaMetadataCompat);
        if (jConvertToDurationMs == C0740C.TIME_UNSET) {
    ...
    private static long getCurrentPosition(PlaybackStateCompat playbackStateCompat, long j) {
        return playbackStateCompat.getCurrentPosition(j == C0740C.TIME_UNSET ? null : Long.valueOf(j));
    }
    ...
    public static long convertToDurationMs(MediaMetadataCompat mediaMetadataCompat) {
        ...
        long j = mediaMetadataCompat.getLong("android.media.metadata.DURATION");
        return j <= 0 ? C0740C.TIME_UNSET : j;
    }
    ...
    public static int convertToRepeatMode(int i) {
        ...
        if (i != 1) {
            i2 = 2;
            if (i != 2 && i != 3) {
                Log.m230w("LegacyConversions", "Unrecognized PlaybackStateCompat.RepeatMode: " + i + " was converted to `Player.REPEAT_MODE_OFF`");
                return 0;
            }
        }
        return i2;
    ...
    public static int convertToPlaybackStateCompatRepeatMode(int i) {
        ...
        if (i != 1) {
            i2 = 2;
            if (i != 2) {
                Log.m230w("LegacyConversions", "Unrecognized RepeatMode: " + i + " was converted to `PlaybackStateCompat.REPEAT_MODE_NONE`");
                return 0;
            }
        }
        return i2;
    ...
    public static Object getFutureResult(Future future, long j) {
        ...
        while (true) {
            try {
                try {
                    Object obj = future.get(j2, TimeUnit.MILLISECONDS);
                    if (z) {
