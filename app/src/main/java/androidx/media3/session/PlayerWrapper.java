...
final class PlayerWrapper extends ForwardingPlayer {
    ...
    public static final class LegacyError {
        ...
        /* synthetic */ LegacyError(boolean z, int i, String str, Bundle bundle, C10621 c10621) {
            this(z, i, str, bundle);
        }
    ...
    public long getDurationWithCommandCheck() {
        return isCommandAvailable(16) ? getDuration() : C0740C.TIME_UNSET;
    }
    ...
    public VolumeProviderCompat createVolumeProviderCompat() {
        ...
        return new C10621(i2, deviceInfo.maxVolume, deviceVolumeWithCommandCheck, deviceInfo.routingControllerId, handler, 1);
    }

    /* JADX INFO: renamed from: androidx.media3.session.PlayerWrapper$1 */
    class C10621 extends VolumeProviderCompat {
        final /* synthetic */ Handler val$handler;
        final /* synthetic */ int val$legacyVolumeFlag;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10621(int i, int i2, int i3, String str, Handler handler, int i4) {
            super(i, i2, i3, str);
        ...
        public /* synthetic */ void lambda$onAdjustVolume$1(int i, int i2) {
            if (PlayerWrapper.this.isCommandAvailable(26) || PlayerWrapper.this.isCommandAvailable(34)) {
                ...
                Log.m230w("VolumeProviderCompat", "onAdjustVolume: Ignoring unknown direction: " + i);
            }
        }
    }
    ...
    public SessionPositionInfo createSessionPositionInfoForBundling() {
        ...
        long contentDuration = C0740C.TIME_UNSET;
    ...
    private static final class CurrentMediaItemOnlyTimeline extends Timeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            window.set(UID, this.mediaItem, null, C0740C.TIME_UNSET, C0740C.TIME_UNSET, C0740C.TIME_UNSET, this.isSeekable, this.isDynamic, this.liveConfiguration, 0L, this.durationUs, 0, 0, 0L);
            return window;
        }
