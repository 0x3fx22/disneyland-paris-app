...
public class MediaSession {
    ...
    public static final class Builder extends BuilderBase {
        ...
        public MediaSession build() {
            ...
            return new MediaSession(this.context, this.f143id, this.player, this.sessionActivity, this.customLayout, this.callback, this.tokenExtras, this.sessionExtras, (androidx.media3.common.util.BitmapLoader) Assertions.checkNotNull(this.bitmapLoader), this.playIfSuppressed, this.isPeriodicPositionUpdateEnabled, 0);
        }
    }
    ...
    public static final class ConnectionResult {
        ...
        public static ConnectionResult reject() {
            return new ConnectionResult(false, SessionCommands.EMPTY, Player.Commands.EMPTY, ImmutableList.m1516of(), Bundle.EMPTY, null);
        }
    }
    ...
    static abstract class BuilderBase {
        ...
        public BuilderBase(Context context, Player player, Callback callback) {
            ...
            this.sessionExtras = bundle;
            this.customLayout = ImmutableList.m1516of();
        ...
        public BuilderBase setId(String str) {
            this.f143id = (String) Assertions.checkNotNull(str);
            return this;
        }
