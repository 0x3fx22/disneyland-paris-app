...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    public static final class Factory implements HttpDataSource.Factory {
        ...
        public Factory(HttpEngine httpEngine, Executor executor) {
            this.httpEngine = HttpEngineDataSource$$ExternalSyntheticApiModelOutline2.m250m(Assertions.checkNotNull(httpEngine));
    ...
    public long open(DataSpec dataSpec) throws HttpDataSource.HttpDataSourceException {
        ...
        try {
            ...
            try {
                ...
                UrlResponseInfo urlResponseInfoM253m = HttpEngineDataSource$$ExternalSyntheticApiModelOutline5.m253m(Assertions.checkNotNull(this.responseInfo));
                int httpStatusCode = urlResponseInfoM253m.getHttpStatusCode();
                Map asMap = urlResponseInfoM253m.getHeaders().getAsMap();
                long j = 0;
                if (httpStatusCode < 200 || httpStatusCode > 299) {
                    ...
                    throw new HttpDataSource.InvalidResponseCodeException(httpStatusCode, urlResponseInfoM253m.getHttpStatusText(), httpStatusCode == 416 ? new DataSourceException(2008) : null, asMap, dataSpec, responseBody);
                }
                ...
                if (!isCompressed(urlResponseInfoM253m)) {
    ...
    private final class UrlRequestCallback implements UrlRequest$Callback {
        ...
        public synchronized void onFailed(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, HttpException httpException) {
            try {
                ...
                if (!AbstractC0771xa9fb8b1d.m258m(httpException) || AbstractC0772xa9fb8b1e.m259m(httpException).getErrorCode() != 1) {
