...
public final class SimpleCache implements Cache {
            ...
            if (databaseProvider != null) {
                ...
                if (jLoadUid != -1) {
                    try {
                        ...
                        Log.m230w("SimpleCache", "Failed to delete file metadata: " + jLoadUid);
                    }
                    try {
    ...
    public synchronized void release() {
        ...
        try {
            ...
            Log.m227e("SimpleCache", "Storing index file failed", e);
            unlockFolder(this.cacheDir);
        }
        this.released = true;
    }
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f109id, j, System.currentTimeMillis());
    }
    ...
    public void initialize() {
        ...
        try {
            ...
            try {
                ...
                Log.m227e("SimpleCache", "Storing index file failed", e3);
            }
        } catch (IOException e4) {
            String str3 = "Failed to initialize cache indices: " + this.cacheDir;
            Log.m227e("SimpleCache", str3, e4);
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m230w("SimpleCache", "Failed to update index with new touch timestamp.");
            }
            z = false;
        } else {
            z = true;
    ...
    private void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                Log.m230w("SimpleCache", "Failed to remove file index entry for: " + name);
            }
        }
        this.contentIndex.maybeRemove(cachedContent.key);
    ...
    private void removeStaleSpans() {
        ...
        while (it.hasNext()) {
            for (CacheSpan cacheSpan : ((CachedContent) it.next()).getSpans()) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (name.endsWith(".uid")) {
                try {
                    ...
                    Log.m226e("SimpleCache", "Malformed UID file: " + file);
                    file.delete();
                }
            }
        }
