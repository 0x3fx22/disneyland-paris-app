...
public final class Mp4LocationData implements Metadata.Entry {
    ...
    public Mp4LocationData(@FloatRange(from = RegionEvent.MIN_LATITUDE, m3to = RegionEvent.MAX_LATITUDE) float f, @FloatRange(from = RegionEvent.MIN_LONGITUDE, m3to = RegionEvent.MAX_LONGITUDE) float f2) {
