...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (i3 < iPosition) {
                ...
                if (i2 == 3) {
                    if (i4 == 1 && (byteBuffer.get(i3) & Ascii.f3534US) == 7) {
    ...
    public static boolean isNalUnitSei(@Nullable String str, byte b) {
        if (MimeTypes.VIDEO_H264.equals(str) && (b & Ascii.f3534US) == 6) {
            return true;
        }
    ...
    /* JADX WARN: Instruction removed from duplicated block: B:93:0x0181, please report this as an issue */
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    if (bits == 255) {
                        ...
                        if (bits < fArr.length) {
                            ...
                            Log.m230w("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + bits);
                        }
                    }
                }
                if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (bits5 == 255) {
                    ...
                    if (bits5 < fArr.length) {
                        ...
                        Log.m230w("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + bits5);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
