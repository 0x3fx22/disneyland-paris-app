...
public class BasicVendorExtender implements VendorExtender {
    ...
    public BasicVendorExtender(int i) {
        ...
        try {
            ...
            Logger.m30e("BasicVendorExtender", "OEM implementation for extension mode " + i + "does not exist!");
        }
    }
    ...
    public void init(@NonNull CameraInfo cameraInfo) {
        ...
        Logger.m28d("BasicVendorExtender", "PreviewExtender processorType= " + this.mPreviewExtenderImpl.getProcessorType());
        Logger.m28d("BasicVendorExtender", "ImageCaptureExtender processor= " + this.mImageCaptureExtenderImpl.getCaptureProcessor());
    }
    ...
    private List getSupportedParameterKeys(Context context) {
        if (ExtensionVersion.isMinimumCompatibleVersion(Version.VERSION_1_3)) {
            try {
                ...
                Logger.m31e("BasicVendorExtender", "ImageCaptureExtenderImpl.getAvailableCaptureRequestKeys throws exceptions", e);
            }
    ...
    public List<CaptureResult.Key> getSupportedCaptureResultKeys() {
        if (ExtensionVersion.isMinimumCompatibleVersion(Version.VERSION_1_3)) {
            try {
                ...
                Logger.m31e("BasicVendorExtender", "ImageCaptureExtenderImpl.getAvailableCaptureResultKeys throws exceptions", e);
            }
        }
        return Collections.emptyList();
    }
