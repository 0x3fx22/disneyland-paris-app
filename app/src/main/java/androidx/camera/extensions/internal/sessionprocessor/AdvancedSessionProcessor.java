...
public class AdvancedSessionProcessor extends SessionProcessorBase {
    ...
    public void setExtensionStrength(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
    ...
    public int startCapture(boolean z, @NonNull TagBundle tagBundle, @NonNull SessionProcessor.CaptureCallback captureCallback) {
        Logger.m28d("AdvancedSessionProcessor", "startCapture postviewEnabled = " + z + " mWillReceiveOnCaptureCompleted = " + this.mWillReceiveOnCaptureCompleted);
