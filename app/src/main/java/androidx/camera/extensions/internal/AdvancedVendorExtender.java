...
public class AdvancedVendorExtender implements VendorExtender {
    ...
    private List getSupportedParameterKeys() {
        ...
        try {
            ...
            Logger.m31e("AdvancedVendorExtender", "AdvancedExtenderImpl.getAvailableCaptureRequestKeys throws exceptions", e);
            return listEmptyList;
        }
    }
    ...
    public List<CaptureResult.Key> getSupportedCaptureResultKeys() {
        ...
        try {
            ...
            Logger.m31e("AdvancedVendorExtender", "AdvancedExtenderImpl.getAvailableCaptureResultKeys throws exceptions", e);
            return listEmptyList;
        }
    }
