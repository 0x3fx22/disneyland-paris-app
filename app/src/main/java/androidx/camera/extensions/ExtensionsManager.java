        ...
        try {
            InitializerImpl.init(clientVersion.toVersionString(), ContextUtil.getApplicationContext(context), new InitializerImpl.OnExtensionsInitializedCallback() { // from class: androidx.camera.extensions.ExtensionsManager.1
                public void onSuccess() {
                    Logger.m28d("ExtensionsManager", "Successfully initialized extensions");
                ...
                public void onFailure(int i) {
                    Logger.m30e("ExtensionsManager", "Failed to initialize extensions");
            ...
            Logger.m30e("ExtensionsManager", "Failed to initialize extensions. Some classes or methods are missed in the vendor library. " + e);
            ...
            Logger.m30e("ExtensionsManager", "Failed to initialize extensions. Something wents wrong when initializing the vendor library. " + e2);
