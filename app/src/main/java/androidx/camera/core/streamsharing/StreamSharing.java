...
public class StreamSharing extends UseCase {
    ...
    private List createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            SurfaceProcessorNode.Out outTransform2 = this.mSharingNode.transform(SurfaceProcessorNode.AbstractC0278In.m60of(this.mSharingInputEdge, new ArrayList(childrenOutConfigs.values())));
            ...
            return ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{this.mSessionConfigBuilder.build()});
        }
        ...
        DualSurfaceProcessorNode.Out outTransform3 = this.mDualSharingNode.transform(DualSurfaceProcessorNode.AbstractC0280In.m62of(this.mSharingInputEdge, this.mSecondarySharingInputEdge, new ArrayList(childrenOutConfigs2.values())));
        HashMap map2 = new HashMap();
        for (Map.Entry entry2 : childrenOutConfigs2.entrySet()) {
            map2.put((UseCase) entry2.getKey(), outTransform3.get(entry2.getValue()));
        }
        this.mVirtualCameraAdapter.setChildrenEdges(map2);
        return ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
    }
    ...
    private SurfaceEdge getSharingInputEdge(SurfaceEdge surfaceEdge, CameraInternal cameraInternal) {
        ...
        OutConfig outConfigM64of = OutConfig.m64of(surfaceEdge.getTargets(), surfaceEdge.getFormat(), cropRectAppliedByEffect, TransformUtils.getRotatedSize(cropRectAppliedByEffect, rotationAppliedByEffect), rotationAppliedByEffect, getMirroringAppliedByEffect(), true);
        SurfaceEdge surfaceEdge2 = this.mEffectNode.transform(SurfaceProcessorNode.AbstractC0278In.m60of(surfaceEdge, Collections.singletonList(outConfigM64of))).get(outConfigM64of);
