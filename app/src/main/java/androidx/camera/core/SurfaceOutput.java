...
public interface SurfaceOutput extends Closeable {
    ...
    public static abstract class Event {
        ...
        public static Event m39of(int i, @NonNull SurfaceOutput surfaceOutput) {
    ...
    public static abstract class CameraInputInfo {
        ...
        @NonNull
        /* JADX INFO: renamed from: of */
        public static CameraInputInfo m38of(@NonNull Size size, @NonNull Rect rect, @Nullable CameraInternal cameraInternal, int i, boolean z) {
