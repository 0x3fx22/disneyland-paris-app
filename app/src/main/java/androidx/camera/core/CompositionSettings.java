...
public class CompositionSettings {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAlpha(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
            this.mAlpha = f;
            return this;
        }

        @NonNull
        public Builder setOffset(@FloatRange(from = Screen.SHEET_FIT_TO_CONTENTS, m3to = 1.0d) float f, @FloatRange(from = Screen.SHEET_FIT_TO_CONTENTS, m3to = 1.0d) float f2) {
