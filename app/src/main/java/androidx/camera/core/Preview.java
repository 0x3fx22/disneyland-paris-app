...
public final class Preview extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(PreviewConfig previewConfig, StreamSpec streamSpec) {
        ...
        if (effect != null) {
            ...
            SurfaceEdge surfaceEdge = this.mNode.transform(SurfaceProcessorNode.AbstractC0278In.m60of(this.mCameraEdge, Collections.singletonList(outConfigM65of))).get(outConfigM65of);
