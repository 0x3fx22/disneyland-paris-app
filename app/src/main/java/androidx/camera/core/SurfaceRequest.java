...
public final class SurfaceRequest {
        ...
        if (this.mSurfaceCompleter.set(surface) || this.mSurfaceFuture.isCancelled()) {
            Futures.addCallback(this.mSessionStatusFuture, new FutureCallback() { // from class: androidx.camera.core.SurfaceRequest.4
                ...
                public void onSuccess(Void r2) {
                    consumer.accept(Result.m40of(0, surface));
                }
                ...
                public void onFailure(Throwable th) {
                    ...
                    consumer.accept(Result.m40of(1, surface));
                }
            }, executor);
            return;
        }
    ...
    public static abstract class Result {
        ...
        static Result m40of(int i, Surface surface) {
    ...
    public static abstract class TransformationInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        /* JADX INFO: renamed from: of */
        public static TransformationInfo m41of(@NonNull Rect rect, int i, int i2, boolean z, @NonNull Matrix matrix, boolean z2) {
