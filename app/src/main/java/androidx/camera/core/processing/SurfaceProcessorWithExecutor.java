...
public class SurfaceProcessorWithExecutor implements SurfaceProcessorInternal {
    ...
    public /* synthetic */ void lambda$onInputSurface$0(SurfaceRequest surfaceRequest) {
        try {
            ...
            Logger.m31e("SurfaceProcessor", "Failed to setup SurfaceProcessor input.", e);
    ...
    public /* synthetic */ void lambda$onOutputSurface$1(SurfaceOutput surfaceOutput) {
        try {
            ...
            Logger.m31e("SurfaceProcessor", "Failed to setup SurfaceProcessor output.", e);
            this.mErrorListener.accept(e);
        }
    }
    ...
    @Override // androidx.camera.core.processing.SurfaceProcessorInternal
    @NonNull
    public ListenableFuture<Void> snapshot(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i, @IntRange(from = 0, m4to = 359) int i2) {
