...
public class DefaultSurfaceProcessor implements SurfaceProcessorInternal, SurfaceTexture.OnFrameAvailableListener {
    ...
    @Override // androidx.camera.core.processing.SurfaceProcessorInternal
    @NonNull
    public ListenableFuture<Void> snapshot(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) final int i, @IntRange(from = 0, m4to = 359) final int i2) {
    ...
    public /* synthetic */ Object lambda$snapshot$8(int i, int i2, final CallbackToFutureAdapter.Completer completer) {
        final AutoValue_DefaultSurfaceProcessor_PendingSnapshot autoValue_DefaultSurfaceProcessor_PendingSnapshotM55of = PendingSnapshot.m55of(i, i2, completer);
        executeSafely(new Runnable() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$snapshot$6(autoValue_DefaultSurfaceProcessor_PendingSnapshotM55of);
            }
        ...
        for (Map.Entry entry : this.mOutputSurfaces.entrySet()) {
            ...
            if (surfaceOutput.getFormat() == 34) {
                try {
                    ...
                    Logger.m31e("DefaultSurfaceProcessor", "Failed to render with OpenGL.", e);
                }
            } else {
    ...
    private void executeSafely(final Runnable runnable, final Runnable runnable2) {
        try {
            ...
            Logger.m35w("DefaultSurfaceProcessor", "Unable to executor runnable", e);
            runnable2.run();
        }
    }
    ...
    static abstract class PendingSnapshot {
        ...
        static AutoValue_DefaultSurfaceProcessor_PendingSnapshot m55of(int i, int i2, CallbackToFutureAdapter.Completer completer) {
