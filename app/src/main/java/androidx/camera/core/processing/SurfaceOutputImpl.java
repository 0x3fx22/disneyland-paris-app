...
final class SurfaceOutputImpl implements SurfaceOutput {
    ...
    public void requestClose() {
        ...
        if (executor != null) {
            try {
                ...
                Logger.m29d("SurfaceOutputImpl", "Processor executor closed. Close request not posted.", e);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$requestClose$1(AtomicReference atomicReference) {
        ((Consumer) atomicReference.get()).accept(SurfaceOutput.Event.m39of(0, this));
    }
