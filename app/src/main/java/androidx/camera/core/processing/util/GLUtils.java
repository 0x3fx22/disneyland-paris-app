...
public final class GLUtils {
    ...
    static {
        ...
        NO_OUTPUT_SURFACE = OutputSurface.m66of(EGL14.EGL_NO_SURFACE, 0, 0);
    }
    ...
    public static abstract class Program2D {
        ...
        protected Program2D(@NonNull String str, @NonNull String str2) throws Throwable {
            int iLoadShader;
            int iLoadShader2;
    ...
    public static int loadShader(int i, @NonNull String str) {
        ...
        Logger.m34w(TAG, "Could not compile shader: " + str);
    ...
    public static int[] chooseSurfaceAttrib(@NonNull String str, @NonNull DynamicRange dynamicRange) {
        ...
        Logger.m34w(TAG, "Dynamic range uses HLG encoding, but device does not support EGL_EXT_gl_colorspace_bt2020_hlg.Fallback to default colorspace.");
        return iArr;
    }
