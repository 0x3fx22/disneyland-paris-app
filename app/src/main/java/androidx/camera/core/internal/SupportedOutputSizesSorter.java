...
public class SupportedOutputSizesSorter {
    ...
    private List getResolutionCandidateList(List list, int i) {
        ...
        if (arrayList.isEmpty()) {
            Logger.m34w("SupportedOutputSizesCollector", "The retrieved supported resolutions from camera info internal is empty. Format is " + i + InstructionFileId.DOT);
        }
        return arrayList;
    }
    ...
    static Rational getTargetAspectRatioRationalValue(int i, boolean z) {
        if (i != -1) {
            ...
            Logger.m30e("SupportedOutputSizesCollector", "Undefined target aspect ratio: " + i);
        }
        return null;
    }
