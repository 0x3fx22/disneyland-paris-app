...
public class JpegBytes2Image implements Operation<Packet<byte[]>, Packet<ImageProxy>> {
    ...
    public Packet<ImageProxy> apply(@NonNull Packet<byte[]> packet) throws ImageCaptureException {
        ...
        return Packet.m57of(imageProxyConvertJpegBytesToImage, exif, packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}
