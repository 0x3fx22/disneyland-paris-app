...
public class BitmapEffect implements Operation<Packet<Bitmap>, Packet<Bitmap>> {
    ...
    public Packet<Bitmap> apply(@NonNull Packet<Bitmap> packet) throws ImageCaptureException {
        ...
        return Packet.m56of(bitmapCreateBitmapFromPlane, exif, packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}
