...
final class JpegBytes2CroppedBitmap implements Operation {
    ...
    public Packet apply(Packet packet) throws ImageCaptureException {
        ...
        return Packet.m56of(bitmapCreateCroppedBitmap, exif, new Rect(0, 0, bitmapCreateCroppedBitmap.getWidth(), bitmapCreateCroppedBitmap.getHeight()), packet.getRotationDegrees(), TransformUtils.updateSensorToBufferTransform(packet.getSensorToBufferTransform(), cropRect), packet.getCameraCaptureResult());
    }
