...
public class ProcessingNode implements Node<AbstractC0238In, Void> {
    ...
    private AbstractC0238In mInputEdge;
    ...
    @Override // androidx.camera.core.processing.Node
    @NonNull
    public Void transform(@NonNull AbstractC0238In abstractC0238In) {
        this.mInputEdge = abstractC0238In;
        abstractC0238In.getEdge().setListener(new Consumer() { // from class: androidx.camera.core.imagecapture.ProcessingNode$$ExternalSyntheticLambda0
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.f$0.lambda$transform$1((ProcessingNode.InputPacket) obj);
            }
        });
        abstractC0238In.getPostviewEdge().setListener(new Consumer() { // from class: androidx.camera.core.imagecapture.ProcessingNode$$ExternalSyntheticLambda1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
        ...
        if (abstractC0238In.getInputFormat() == 35 || this.mImageProcessor != null || this.mHasIncorrectJpegMetadataQuirk) {
    ...
    public /* synthetic */ void lambda$transform$3(final InputPacket inputPacket) {
        if (inputPacket.getProcessingRequest().isAborted()) {
            Logger.m34w("ProcessingNode", "The postview image is closed due to request aborted");
            inputPacket.getImageProxy().close();
        } else {
    ...
    public void lambda$transform$2(InputPacket inputPacket) {
        ...
        try {
            ...
            inputPacket.getImageProxy().close();
            Logger.m31e("ProcessingNode", "process postview input packet failed.", e);
        }
    }
    ...
    private ImageCapture.OutputFileResults saveRawToDisk(Packet packet, ImageCapture.OutputFileOptions outputFileOptions) throws ImageCaptureException {
        ...
        Objects.requireNonNull(outputFileOptions);
        return dngImage2Disk.apply(DngImage2Disk.AbstractC0235In.m44of(imageProxy, rotationDegrees, outputFileOptions));
    }
    ...
    private ImageCapture.OutputFileResults saveJpegToDisk(Packet packet, ImageCapture.OutputFileOptions outputFileOptions, int i) {
        Packet packetCropAndMaybeApplyEffect = (Packet) this.mImage2JpegBytes.apply(Image2JpegBytes.AbstractC0236In.m45of(packet, i));
        ...
        Objects.requireNonNull(outputFileOptions);
        return (ImageCapture.OutputFileResults) operation.apply(JpegBytes2Disk.AbstractC0237In.m46of(packetCropAndMaybeApplyEffect, outputFileOptions));
    }
    ...
    ImageProxy processInMemoryCapture(InputPacket inputPacket) {
        ...
        if ((packet.getFormat() == 35 || this.mBitmapEffect != null || this.mHasIncorrectJpegMetadataQuirk) && iIntValue == 256) {
            Packet packetCropAndMaybeApplyEffect = (Packet) this.mImage2JpegBytes.apply(Image2JpegBytes.AbstractC0236In.m45of(packet, processingRequest.getJpegQuality()));
    ...
    private Packet cropAndMaybeApplyEffect(Packet packet, int i) {
        ...
        return (Packet) this.mBitmap2JpegBytes.apply(Bitmap2JpegBytes.AbstractC0231In.m42of(packet2, i));
    }
    ...
    static abstract class InputPacket {
        ...
        static InputPacket m48of(ProcessingRequest processingRequest, ImageProxy imageProxy) {
            return new AutoValue_ProcessingNode_InputPacket(processingRequest, imageProxy);
        }
    }

    /* JADX INFO: renamed from: androidx.camera.core.imagecapture.ProcessingNode$In */
    static abstract class AbstractC0238In {
        ...
        /* JADX INFO: renamed from: of */
        static AbstractC0238In m47of(int i, List list) {
