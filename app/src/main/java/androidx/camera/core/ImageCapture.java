...
public final class ImageCapture extends UseCase {
    ...
    protected UseCaseConfig<?> onMergeConfig(@NonNull CameraInfoInternal cameraInfoInternal, @NonNull UseCaseConfig.Builder<?, ?, ?> builder) {
        if (cameraInfoInternal.getCameraQuirks().contains(SoftwareJpegEncodingPreferredQuirk.class)) {
            ...
            if (bool.equals(mutableConfig.retrieveOption(option, bool2))) {
                Logger.m34w("ImageCapture", "Device quirk suggests software JPEG encoder, but it has been explicitly disabled.");
            } else {
                Logger.m32i("ImageCapture", "Requesting software JPEG due to device quirk.");
    ...
    public void onCameraControlReady() {
        Logger.m28d("ImageCapture", "onCameraControlReady");
    ...
    public void setFlashMode(int i) {
        Logger.m28d("ImageCapture", "setFlashMode: flashMode = " + i);
        if (i != 0 && i != 1 && i != 2) {
            if (i == 3) {
    ...
    @IntRange(from = 1, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS)
    ...
    boolean enforceSoftwareJpegConstraints(MutableConfig mutableConfig) {
        ...
        if (bool.equals(mutableConfig.retrieveOption(option, bool2))) {
            if (isSessionProcessorEnabledInCurrentCamera()) {
                Logger.m34w("ImageCapture", "Software JPEG cannot be used with Extensions.");
                z = false;
            } else {
                z = true;
            }
            ...
            if (num == null || num.intValue() == 256) {
                ...
                Logger.m34w("ImageCapture", "Software JPEG cannot be used with non-JPEG output buffer format.");
            }
            if (!z2) {
                Logger.m34w("ImageCapture", "Unable to support software JPEG. Disabling.");
    ...
    protected StreamSpec onSuggestedStreamSpecUpdated(@NonNull StreamSpec streamSpec, @Nullable StreamSpec streamSpec2) {
        ...
        updateSessionConfig(ImageAnalysis$$ExternalSyntheticBackport2.m23m(new Object[]{builderCreatePipeline.build()}));
        notifyActive();
        return streamSpec;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:27:0x00ec A[PHI: r5
  0x00ec: PHI (r5v2 int) = (r5v1 int), (r5v1 int), (r5v5 int), (r5v5 int) binds: [B:6:0x004d, B:8:0x0053, B:16:0x0088, B:18:0x008e] A[DONT_GENERATE, DONT_INLINE]] */
    private SessionConfig.Builder createPipeline(String str, ImageCaptureConfig imageCaptureConfig, StreamSpec streamSpec) {
        ...
        this.mImagePipeline = new ImagePipeline(imageCaptureConfig, resolution, cameraCharacteristics, getEffect(), z, size, i);
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda7
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.lambda$createPipeline$4(sessionConfig, sessionError);
            }
        });
    ...
    private void takePictureInternal(Executor executor, OnImageCapturedCallback onImageCapturedCallback, OnImageSavedCallback onImageSavedCallback, OutputFileOptions outputFileOptions, OutputFileOptions outputFileOptions2) {
        ...
        takePictureManager.offerRequest(TakePictureRequest.m50of(executor, onImageCapturedCallback, onImageSavedCallback, outputFileOptions, outputFileOptions2, getTakePictureCropRect(), getSensorToBufferTransformMatrix(), getRelativeRotation(camera), getJpegQualityInternal(), getCaptureMode(), z, this.mSessionConfigBuilder.getSingleCameraCaptureCallbacks()));
    }
    ...
    public static final class Builder implements UseCaseConfig.Builder<ImageCapture, ImageCaptureConfig, Builder>, ImageOutputConfig.Builder<Builder>, IoConfig.Builder<Builder>, ImageInputConfig.Builder<Builder> {
        ...
        @NonNull
        public Builder setJpegQuality(@IntRange(from = 1, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
