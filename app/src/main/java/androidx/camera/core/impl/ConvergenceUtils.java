...
public class ConvergenceUtils {
    ...
    public static boolean is3AConverged(@NonNull CameraCaptureResult cameraCaptureResult, boolean z) {
        ...
        Logger.m28d("ConvergenceUtils", "checkCaptureResult, AE=" + cameraCaptureResult.getAeState() + " AF =" + cameraCaptureResult.getAfState() + " AWB=" + cameraCaptureResult.getAwbState());
        return z2 && z4 && z5;
    }
}
