...
public class AudioExecutor implements Executor {
    ...
    private final ExecutorService mAudioService = Executors.newFixedThreadPool(2, new ThreadFactoryC02611());

    /* JADX INFO: renamed from: androidx.camera.core.impl.utils.executor.AudioExecutor$1 */
    class ThreadFactoryC02611 implements ThreadFactory {
        ...
        public Thread newThread(final Runnable runnable) {
            Thread thread = new Thread(new Runnable() { // from class: androidx.camera.core.impl.utils.executor.AudioExecutor$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AudioExecutor.ThreadFactoryC02611.lambda$newThread$0(runnable);
                }
            });
