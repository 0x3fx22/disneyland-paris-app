...
public final class Camera2CameraInfoImpl implements CameraInfoInternal {
    ...
    private void logDeviceLevel() {
        ...
        Logger.m32i("Camera2CameraInfo", "Device Level: " + str);
    }
    ...
    public float getIntrinsicZoomRatio() {
        ...
        try {
            ...
            Logger.m30e("Camera2CameraInfo", "The camera is unable to provide necessary information to resolve its intrinsic zoom ratio with error: " + e);
            return 1.0f;
        }
    }
    ...
    public Object getPhysicalCameraCharacteristics(@NonNull String str) {
        try {
            ...
            Logger.m31e("Camera2CameraInfo", "Failed to get CameraCharacteristics for cameraId " + str, e);
            return null;
        }
    }
