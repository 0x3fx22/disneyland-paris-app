...
public class StreamConfigurationMapCompat {
    ...
    public Size[] getOutputSizes(int i) {
        ...
        if (outputSizes == null || outputSizes.length == 0) {
            Logger.m34w("StreamConfigurationMapCompat", "Retrieved output sizes array is null or empty for format " + i);
            return outputSizes;
        }
    ...
    public <T> Size[] getOutputSizes(@NonNull Class<T> cls) {
        ...
        if (outputSizes == null || outputSizes.length == 0) {
            Logger.m34w("StreamConfigurationMapCompat", "Retrieved output sizes array is null or empty for class " + cls);
            return outputSizes;
        }
