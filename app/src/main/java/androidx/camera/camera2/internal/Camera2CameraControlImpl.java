...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    void setActive(boolean z) {
        Logger.m28d("Camera2CameraControlImp", "setActive: isActive = " + z);
    ...
    public void setFlashMode(int i) {
        if (!isControlInUse()) {
            Logger.m34w("Camera2CameraControlImp", "Camera is not active.");
            return;
        }
        this.mFlashMode = i;
        Logger.m28d("Camera2CameraControlImp", "setFlashMode: mFlashMode = " + this.mFlashMode);
    ...
    public boolean isInVideoUsage() {
        ...
        Logger.m28d("Camera2CameraControlImp", "isInVideoUsage: mVideoUsageControl value = " + usage);
        return usage > 0;
    }
        ...
        public void onCaptureCompleted(final int i, final CameraCaptureResult cameraCaptureResult) {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    ...
                    Logger.m31e("Camera2CameraControlImp", "Executor rejected to invoke onCaptureCompleted.", e);
                }
            }
        }
        ...
        public void onCaptureFailed(final int i, final CameraCaptureFailure cameraCaptureFailure) {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    ...
                    Logger.m31e("Camera2CameraControlImp", "Executor rejected to invoke onCaptureFailed.", e);
                }
            }
        }
        ...
        public void onCaptureCancelled(final int i) {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    ...
                    Logger.m31e("Camera2CameraControlImp", "Executor rejected to invoke onCaptureCancelled.", e);
                }
            }
        }
    }
