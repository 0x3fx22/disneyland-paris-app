...
public class Camera2CameraCoordinator implements CameraCoordinator {
    ...
    private void retrieveConcurrentCameraIds() {
        ...
        try {
            ...
            Logger.m30e("Camera2CameraCoordinator", "Failed to get concurrent camera ids");
        }
        ...
        while (it.hasNext()) {
            ...
            if (arrayList.size() >= 2) {
                ...
                try {
                    ...
                    Logger.m28d("Camera2CameraCoordinator", "Concurrent camera id pair: (" + str + ", " + str2 + ") is not backward compatible");
                }
            }
        }
    }
