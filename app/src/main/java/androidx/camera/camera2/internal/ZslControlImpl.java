...
final class ZslControlImpl implements ZslControl {
    ...
    public /* synthetic */ void lambda$addZslConfig$1(ImageReaderProxy imageReaderProxy) {
        try {
            ...
            Logger.m30e("ZslControlImpl", "Failed to acquire latest image IllegalStateException = " + e.getMessage());
        }
    }
    ...
    public ImageProxy dequeueImageFromBuffer() {
        try {
            ...
            Logger.m30e("ZslControlImpl", "dequeueImageFromBuffer no such element");
            return null;
        }
    }
    ...
    public boolean enqueueImageToImageWriter(ImageProxy imageProxy) {
        ...
        if (imageWriter != null && image != null) {
            try {
                ...
                Logger.m30e("ZslControlImpl", "enqueueImageToImageWriter throws IllegalStateException = " + e.getMessage());
            }
        }
        return false;
    }
    ...
    private Map createReprocessingInputSizeMap(CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        ...
        try {
            ...
            Logger.m30e("ZslControlImpl", "Failed to retrieve StreamConfigurationMap, error = " + e.getMessage());
