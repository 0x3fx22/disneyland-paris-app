...
public abstract class VideoSpec {
    ...
    static {
        ...
        QUALITY_SELECTOR_AUTO = QualitySelector.fromOrderedList(Arrays.asList(quality, Quality.f28HD, Quality.f29SD), FallbackStrategy.higherQualityOrLowerThan(quality));
    }
