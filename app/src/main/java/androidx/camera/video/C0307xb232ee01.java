...
/* JADX INFO: renamed from: androidx.camera.video.AutoValue_MediaStoreOutputOptions_MediaStoreOutputOptionsInternal */
/* JADX INFO: loaded from: classes.dex */
final class C0307xb232ee01 extends MediaStoreOutputOptions.MediaStoreOutputOptionsInternal {
    ...
    private C0307xb232ee01(long j, long j2, Location location, ContentResolver contentResolver, Uri uri, ContentValues contentValues) {
    ...
    /* JADX INFO: renamed from: androidx.camera.video.AutoValue_MediaStoreOutputOptions_MediaStoreOutputOptionsInternal$Builder */
    static final class Builder extends MediaStoreOutputOptions.MediaStoreOutputOptionsInternal.Builder {
        ...
        MediaStoreOutputOptions.MediaStoreOutputOptionsInternal build() {
            ...
            return new C0307xb232ee01(this.fileSizeLimit.longValue(), this.durationLimitMillis.longValue(), this.location, this.contentResolver, this.collectionUri, this.contentValues);
        }
    }
}
