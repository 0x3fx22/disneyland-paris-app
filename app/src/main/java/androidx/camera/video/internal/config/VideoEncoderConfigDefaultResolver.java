...
public class VideoEncoderConfigDefaultResolver implements Supplier<VideoEncoderConfig> {
    ...
    public VideoEncoderConfig get() {
        ...
        Logger.m28d("VidEncCfgDefaultRslvr", "Resolved VIDEO frame rate: " + iResolveFrameRate + "fps");
        Range<Integer> bitrate = this.mVideoSpec.getBitrate();
        Logger.m28d("VidEncCfgDefaultRslvr", "Using fallback VIDEO bitrate");
    ...
    private int resolveFrameRate() {
        ...
        Logger.m28d("VidEncCfgDefaultRslvr", String.format("Default resolved frame rate: %dfps. [Expected operating range: %s]", Integer.valueOf(iIntValue), Objects.equals(this.mExpectedFrameRateRange, range2) ? this.mExpectedFrameRateRange : "<UNSPECIFIED>"));
        return iIntValue;
    }
}
