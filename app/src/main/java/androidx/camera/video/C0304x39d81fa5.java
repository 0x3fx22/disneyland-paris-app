...
/* JADX INFO: renamed from: androidx.camera.video.AutoValue_FileDescriptorOutputOptions_FileDescriptorOutputOptionsInternal */
/* JADX INFO: loaded from: classes.dex */
final class C0304x39d81fa5 extends FileDescriptorOutputOptions.FileDescriptorOutputOptionsInternal {
    private final long durationLimitMillis;
    private final long fileSizeLimit;
    private final Location location;
    private final ParcelFileDescriptor parcelFileDescriptor;

    private C0304x39d81fa5(long j, long j2, Location location, ParcelFileDescriptor parcelFileDescriptor) {
    ...
    /* JADX INFO: renamed from: androidx.camera.video.AutoValue_FileDescriptorOutputOptions_FileDescriptorOutputOptionsInternal$Builder */
    static final class Builder extends FileDescriptorOutputOptions.FileDescriptorOutputOptionsInternal.Builder {
        ...
        FileDescriptorOutputOptions.FileDescriptorOutputOptionsInternal build() {
            ...
            return new C0304x39d81fa5(this.fileSizeLimit.longValue(), this.durationLimitMillis.longValue(), this.location, this.parcelFileDescriptor);
        }
    }
}
