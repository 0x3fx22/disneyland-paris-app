...
final class PreviewTransformation {
    ...
    void setTransformationInfo(SurfaceRequest.TransformationInfo transformationInfo, Size size, boolean z) {
        Logger.m28d("PreviewTransform", "Transformation info set: " + transformationInfo + " " + size + " " + z);
    ...
    void transformView(Size size, int i, View view) {
        if (size.getHeight() == 0 || size.getWidth() == 0) {
            Logger.m34w("PreviewTransform", "Transform not applied due to PreviewView size: " + size);
            return;
        }
        if (isTransformationInfoReady()) {
            if (view instanceof TextureView) {
                ...
                if (z2 || z) {
                    Logger.m30e("PreviewTransform", "Custom rotation not supported with SurfaceView/PERFORMANCE mode.");
                }
            }
    ...
    private static void setMatrixRectToRect(Matrix matrix, RectF rectF, RectF rectF2, PreviewView.ScaleType scaleType) {
        ...
        switch (C03431.$SwitchMap$androidx$camera$view$PreviewView$ScaleType[scaleType.ordinal()]) {
            case 1:
            case 2:
            ...
            case 6:
                ...
                break;
            default:
                Logger.m30e("PreviewTransform", "Unexpected crop rect: " + scaleType);
