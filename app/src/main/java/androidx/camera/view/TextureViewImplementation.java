...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    public void initializePreview() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC03491());
        this.mParent.removeAllViews();
        this.mParent.addView(this.mTextureView);
    }

    /* JADX INFO: renamed from: androidx.camera.view.TextureViewImplementation$1 */
    class TextureViewSurfaceTextureListenerC03491 implements TextureView.SurfaceTextureListener {
        TextureViewSurfaceTextureListenerC03491() {
        }

        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            Logger.m28d("TextureViewImpl", "SurfaceTexture available. Size: " + i + "x" + i2);
            ...
            if (textureViewImplementation.mSurfaceReleaseFuture != null) {
                ...
                Logger.m28d("TextureViewImpl", "Surface invalidated " + TextureViewImplementation.this.mSurfaceRequest);
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            Logger.m28d("TextureViewImpl", "SurfaceTexture size changed: " + i + "x" + i2);
        }
        ...
        public boolean onSurfaceTextureDestroyed(final SurfaceTexture surfaceTexture) {
            ...
            if (listenableFuture != null) {
                Futures.addCallback(listenableFuture, new FutureCallback() { // from class: androidx.camera.view.TextureViewImplementation.1.1
                    ...
                    public void onSuccess(SurfaceRequest.Result result) {
                        ...
                        Logger.m28d("TextureViewImpl", "SurfaceTexture about to manually be destroyed");
            ...
            Logger.m28d("TextureViewImpl", "SurfaceTexture about to be destroyed");
            return true;
        }
        ...
        public void onSurfaceTextureUpdated(final SurfaceTexture surfaceTexture) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    TextureViewImplementation.TextureViewSurfaceTextureListenerC03491.lambda$onSurfaceTextureUpdated$0(onFrameUpdateListener, surfaceTexture);
                }
            });
        }
    ...
    public /* synthetic */ Object lambda$tryToProvidePreviewSurface$1(Surface surface, final CallbackToFutureAdapter.Completer completer) {
        Logger.m28d("TextureViewImpl", "Surface set on Preview.");
    ...
    public /* synthetic */ void lambda$tryToProvidePreviewSurface$2(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
        Logger.m28d("TextureViewImpl", "Safe to release surface.");
        notifySurfaceNotInUse();
        surface.release();
