...
final class SurfaceViewImplementation extends PreviewViewImplementation {
        ...
        try {
            try {
                if (!semaphore.tryAcquire(1, 100L, TimeUnit.MILLISECONDS)) {
                    Logger.m30e("SurfaceViewImpl", "Timed out while trying to acquire screenshot.");
                }
            } catch (InterruptedException e) {
                Logger.m31e("SurfaceViewImpl", "Interrupted while trying to acquire screenshot.", e);
            }
    ...
    public static /* synthetic */ void lambda$getPreviewBitmap$1(Semaphore semaphore, int i) {
        if (i == 0) {
            Logger.m28d("SurfaceViewImpl", "PreviewView.SurfaceViewImplementation.getBitmap() succeeded");
        } else {
            Logger.m30e("SurfaceViewImpl", "PreviewView.SurfaceViewImplementation.getBitmap() failed with error " + i);
        }
        semaphore.release();
    }
    ...
    class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        void setSurfaceRequest(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
            ...
            Logger.m28d("SurfaceViewImpl", "Wait for new Surface creation.");
        ...
        private boolean tryToComplete() {
            ...
            Logger.m28d("SurfaceViewImpl", "Surface set on Preview.");
        ...
        public static /* synthetic */ void lambda$tryToComplete$0(PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener, SurfaceRequest.Result result) {
            Logger.m28d("SurfaceViewImpl", "Safe to release surface.");
            if (onSurfaceNotInUseListener != null) {
                onSurfaceNotInUseListener.onSurfaceNotInUse();
            }
        }
        ...
        private void cancelPreviousRequest() {
            if (this.mSurfaceRequest != null) {
                Logger.m28d("SurfaceViewImpl", "Request canceled: " + this.mSurfaceRequest);
        ...
        private void closeSurface() {
            if (this.mSurfaceRequest != null) {
                Logger.m28d("SurfaceViewImpl", "Surface closed " + this.mSurfaceRequest);
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            Logger.m28d("SurfaceViewImpl", "Surface created.");
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            Logger.m28d("SurfaceViewImpl", "Surface changed. Size: " + i2 + "x" + i3);
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            Logger.m28d("SurfaceViewImpl", "Surface destroyed.");
