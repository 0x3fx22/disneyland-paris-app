...
public final class SplitPairFilter {
    ...
    public SplitPairFilter(@NotNull ComponentName primaryActivityName, @NotNull ComponentName secondaryActivityName, @Nullable String str) {
        ...
        if (StringsKt.contains$default(packageName2, (CharSequence) r12, (boolean) r11, (int) r10, (Object) r9) && StringsKt.indexOf$default((CharSequence) packageName2, "*", 0, false, 6, (Object) null) != packageName2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.");
        }
        if (StringsKt.contains$default((CharSequence) className2, (CharSequence) "*", false, 2, (Object) 0) && StringsKt.indexOf$default((CharSequence) className2, "*", 0, false, 6, (Object) null) != className2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in class name is only allowed at the end.");
        }
    }
