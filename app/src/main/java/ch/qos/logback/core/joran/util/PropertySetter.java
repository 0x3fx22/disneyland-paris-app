...
public class PropertySetter extends ContextAwareBase {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.joran.util.PropertySetter$1 */
    ...
    public AggregationType computeAggregationType(String str) {
        ...
        if (methodFindAdderMethod != null) {
            ...
            int i = C17231.$SwitchMap$ch$qos$logback$core$util$AggregationType[aggregationTypeComputeRawAggregationType.ordinal()];
            if (i == 1) {
                return AggregationType.NOT_FOUND;
            }
            if (i == 2) {
