...
public class FixedWindowRollingPolicy extends RollingPolicyBase {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.rolling.FixedWindowRollingPolicy$1 */
    ...
    public void rollover() throws Throwable {
        if (this.maxIndex >= 0) {
            ...
            int i2 = C17311.$SwitchMap$ch$qos$logback$core$rolling$helper$CompressionMode[this.compressionMode.ordinal()];
            if (i2 == 1) {
