...
public class TimeBasedArchiveRemover extends ContextAwareBase implements ArchiveRemover {
    ...
    private final RollingCalendar f198rc;
    ...
    private FilenameFilter createExpiredFileFilter(final Date date) {
        return new FilenameFilter() { // from class: ch.qos.logback.core.rolling.helper.TimeBasedArchiveRemover.1
            ...
            public boolean accept(File file, String str) {
                return TimeBasedArchiveRemover.this.f198rc.normalizeDate(TimeBasedArchiveRemover.this.dateParser.parseFilename(str)).compareTo(TimeBasedArchiveRemover.this.f198rc.normalizeDate(TimeBasedArchiveRemover.this.f198rc.getEndOfNextNthPeriod(date, -TimeBasedArchiveRemover.this.maxHistory))) < 0;
            }
        };
    }
