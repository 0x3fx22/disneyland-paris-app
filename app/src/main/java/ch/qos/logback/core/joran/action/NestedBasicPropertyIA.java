...
public class NestedBasicPropertyIA extends ImplicitAction {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.joran.action.NestedBasicPropertyIA$1 */
    ...
    public void body(InterpretationContext interpretationContext, String str) {
        ...
        int i = C17191.$SwitchMap$ch$qos$logback$core$util$AggregationType[iADataForBasicProperty.aggregationType.ordinal()];
        if (i == 4) {
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i = C17191.$SwitchMap$ch$qos$logback$core$util$AggregationType[aggregationTypeComputeAggregationType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4 || i == 5) {
