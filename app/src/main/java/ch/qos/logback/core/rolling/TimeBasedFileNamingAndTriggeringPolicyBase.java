...
public abstract class TimeBasedFileNamingAndTriggeringPolicyBase<E> extends ContextAwareBase implements TimeBasedFileNamingAndTriggeringPolicy<E> {
    ...
    protected RollingCalendar f196rc;
    ...
    protected void computeNextCheck() {
        this.nextCheck = this.f196rc.getNextTriggeringDate(this.dateInCurrentPeriod).getTime();
    }
    ...
    public void start() {
        ...
        this.f196rc = primaryDateTokenConverter.getTimeZone() != null ? new RollingCalendar(primaryDateTokenConverter.getDatePattern(), primaryDateTokenConverter.getTimeZone(), Locale.US) : new RollingCalendar(primaryDateTokenConverter.getDatePattern());
        ...
        this.f196rc.printPeriodicity(this);
        if (!this.f196rc.isCollisionFree()) {
