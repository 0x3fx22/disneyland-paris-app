...
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.joran.action.NestedComplexPropertyIA$1 */
    ...
    public void end(InterpretationContext interpretationContext, String str) {
        ...
        if (interpretationContext.peekObject() != iADataForComplexProperty.getNestedComplexProperty()) {
            ...
            int i = C17201.$SwitchMap$ch$qos$logback$core$util$AggregationType[iADataForComplexProperty.aggregationType.ordinal()];
            if (i == 4) {
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i = C17201.$SwitchMap$ch$qos$logback$core$util$AggregationType[aggregationTypeComputeAggregationType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4 || i == 5) {
