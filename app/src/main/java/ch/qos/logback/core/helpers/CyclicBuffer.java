...
public class CyclicBuffer<E> {
    ...
    public CyclicBuffer(CyclicBuffer<E> cyclicBuffer) {
        ...
        this.f190ea = objArr;
        System.arraycopy(cyclicBuffer.f190ea, 0, objArr, 0, i);
    ...
    public E get(int i) {
        ...
        return (E) this.f190ea[(this.first + i) % this.maxSize];
    }
