...
class TokenStream {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.pattern.parser.TokenStream$1 */
    static /* synthetic */ class C17301 {

        /* JADX INFO: renamed from: $SwitchMap$ch$qos$logback$core$pattern$parser$TokenStream$TokenizerState */
        static final /* synthetic */ int[] f193x920259b8;
        ...
        static {
            ...
            try {
                f193x920259b8[TokenizerState.FORMAT_MODIFIER_STATE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f193x920259b8[TokenizerState.OPTION_STATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f193x920259b8[TokenizerState.KEYWORD_STATE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f193x920259b8[TokenizerState.RIGHT_PARENTHESIS_STATE.ordinal()] = 5;
    ...
    List tokenize() throws ScanException {
        ...
        while (true) {
            ...
            this.pointer++;
            int i2 = C17301.f193x920259b8[this.state.ordinal()];
            if (i2 == 1) {
        ...
        int i3 = C17301.f193x920259b8[this.state.ordinal()];
        if (i3 == 1) {
