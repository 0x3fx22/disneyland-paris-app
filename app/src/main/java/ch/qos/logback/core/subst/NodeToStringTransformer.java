...
public class NodeToStringTransformer {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.subst.NodeToStringTransformer$1 */
    ...
    private void compileNode(Node node, StringBuilder sb, Stack stack) {
        while (node != null) {
            int i = C17411.$SwitchMap$ch$qos$logback$core$subst$Node$Type[node.type.ordinal()];
            if (i == 1) {
