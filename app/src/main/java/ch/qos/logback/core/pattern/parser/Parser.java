...
public class Parser<E> extends ContextAwareBase {
    ...
    FormattingNode COMPOSITE(String str) throws ScanException {
        ...
        compositeNode.setChildNode(m414E());
    ...
    Node m414E() {
        Node nodeM415T = m415T();
        if (nodeM415T == null) {
            return null;
        }
        Node nodeEopt = Eopt();
        if (nodeEopt != null) {
            nodeM415T.setNext(nodeEopt);
        }
        return nodeM415T;
    }
    ...
    Node m415T() {
        ...
        advanceTokenPointer();
        FormattingNode formattingNodeM413C = m413C();
        formattingNodeM413C.setFormatInfo(formatInfoValueOf);
        return formattingNodeM413C;
    }
