...
public class Tokenizer {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.subst.Tokenizer$1 */
    static /* synthetic */ class C17431 {
    ...
    List tokenize() {
        ...
        while (true) {
            ...
            this.pointer++;
            int i2 = C17431.$SwitchMap$ch$qos$logback$core$subst$Tokenizer$TokenizerState[this.state.ordinal()];
            if (i2 == 1) {
        ...
        int i3 = C17431.$SwitchMap$ch$qos$logback$core$subst$Tokenizer$TokenizerState[this.state.ordinal()];
        if (i3 == 1) {
