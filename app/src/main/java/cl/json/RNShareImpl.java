...
public class RNShareImpl implements ActivityEventListener {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i == 16845) {
            if (i2 == 0) {
                ...
                writableMapCreateMap.putBoolean(OneIDTrackerEvent.EVENT_PARAM_SUCCESS, false);
            ...
            if (i2 == -1) {
                ...
                writableMapCreateMap2.putBoolean(OneIDTrackerEvent.EVENT_PARAM_SUCCESS, true);
    ...
    private enum SHARES {
        ...
        public static ShareIntent getShareClass(String str, ReactApplicationContext reactApplicationContext) {
            switch (C17471.$SwitchMap$cl$json$RNShareImpl$SHARES[valueOf(str).ordinal()]) {
                case 1:
