...
public final class ImmutableMapParameter<K, V> implements Map<K, V> {
    ...
    public static <K, V> ImmutableMapParameter<K, V> m475of(K k, V v) {
        return new ImmutableMapParameter<>(Collections.singletonMap(k, v));
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m476of(K k, V v, K k2, V v2) {
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m477of(K k, V v, K k2, V v2, K k3, V v3) {
        HashMap map = new HashMap();
        putAndWarnDuplicateKeys(map, k, v);
        putAndWarnDuplicateKeys(map, k2, v2);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m478of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        HashMap map = new HashMap();
        putAndWarnDuplicateKeys(map, k, v);
        putAndWarnDuplicateKeys(map, k2, v2);
        putAndWarnDuplicateKeys(map, k3, v3);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMapParameter<K, V> m479of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        HashMap map = new HashMap();
        putAndWarnDuplicateKeys(map, k, v);
        putAndWarnDuplicateKeys(map, k2, v2);
        putAndWarnDuplicateKeys(map, k3, v3);
