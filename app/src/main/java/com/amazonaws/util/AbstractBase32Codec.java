...
abstract class AbstractBase32Codec {
    ...
    private final void encode4bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        bArr2[i2 + 7] = kotlin.p163io.encoding.Base64.padSymbol;
    }
    ...
    private final void encode3bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i4 = i2 + 5;
        bArr2[i3] = bArr3[(b3 & Ascii.f3531SI) << 1];
        int i5 = 0;
        while (i5 < 3) {
            bArr2[i4] = kotlin.p163io.encoding.Base64.padSymbol;
            i5++;
            i4++;
        }
    }
    ...
    private final void encode2bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i6 = 0;
        while (i6 < 4) {
            bArr2[i5] = kotlin.p163io.encoding.Base64.padSymbol;
            i6++;
            i5++;
        }
    }
