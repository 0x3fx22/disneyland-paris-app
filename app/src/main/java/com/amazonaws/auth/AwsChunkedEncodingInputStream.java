    ...
    public synchronized void mark(int i) {
        try {
            ...
            if (this.f333is.markSupported()) {
                ...
                this.f333is.mark(Integer.MAX_VALUE);
            } else {
                Log log3 = log;
    ...
    private boolean setUpNextChunk() throws IOException {
        ...
        while (i < 131072) {
            ...
            if (decodedStreamBuffer != null && decodedStreamBuffer.hasNext()) {
                ...
                int i2 = this.f333is.read(bArr, i, 131072 - i);
                if (i2 == -1) {
                    break;
                }
