...
public class Principal {
    ...
    public Principal(Services services) {
        ...
        this.f337id = services.getServiceId();
        this.provider = "Service";
    }

    public Principal(String str, String str2) {
        this.provider = str;
        this.f337id = "AWS".equals(str) ? str2.replaceAll("-", "") : str2;
    }
    ...
    public Principal(WebIdentityProviders webIdentityProviders) {
        ...
        this.f337id = webIdentityProviders.getWebIdentityProvider();
    ...
    public int hashCode() {
        return ((this.provider.hashCode() + 31) * 31) + this.f337id.hashCode();
    }
