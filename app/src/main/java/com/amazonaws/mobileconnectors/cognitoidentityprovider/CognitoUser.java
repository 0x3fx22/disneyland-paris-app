...
public class CognitoUser {
    ...
    public void confirmSignUpInternal(String str, boolean z, Map map) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void confirmPasswordInternal(String str, String str2, Map map) {
            ...
            public void run() {
                ...
                try {
                    ...
                    runnable = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.5.1
                        @Override // java.lang.Runnable
                        public void run() {
                            RunnableC19775 runnableC19775 = RunnableC19775.this;
                    ...
                    runnable = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.5.2
                        ...
                        public void run() {
                            ...
                            RunnableC19775 runnableC19776 = RunnableC19775.this;
                ...
                try {
                    ...
                    if (z) {
                        runnable = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.13.1
                            @Override // java.lang.Runnable
                            public void run() {
                                RunnableC194613 runnableC194613 = RunnableC194613.this;
                                ...
                                RunnableC194613 runnableC194614 = RunnableC194613.this;
        ...
        new Thread(new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.CognitoUser.14
            ...
            public void run() {
                ...
                try {
                    ...
                    final String session = verifySoftwareTokenResultVerifyTotpAssociationWithTokens.getSession();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void deleteAttributesInternal(List list, CognitoUserSession cognitoUserSession) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setUserMfaSettingsInternal(List list, CognitoUserSession cognitoUserSession) {
        if (cognitoUserSession != null && cognitoUserSession.isValid()) {
            if (list == null || list.size() < 1) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public RespondToAuthChallengeRequest userSrpAuthRequest(Map map, Map map2, String str, String str2, String str3, AuthenticationHelper authenticationHelper) {
        ...
        if (bigInteger.mod(AuthenticationHelper.f343N).equals(BigInteger.ZERO)) {
    ...
    private static class AuthenticationHelper {
        ...
        private static final BigInteger f341GG;

        /* JADX INFO: renamed from: KK */
        private static final BigInteger f342KK;

        /* JADX INFO: renamed from: N */
        private static final BigInteger f343N;
        ...
        public AuthenticationHelper(String str) {
            ...
            do {
                ...
                this.f345a = bigIntegerMod;
                bigIntegerModPow = f341GG.modPow(bigIntegerMod, bigInteger);
                this.f344A = bigIntegerModPow;
        ...
        static {
            ...
            try {
                ...
                f342KK = new BigInteger(1, messageDigest.digest(bigIntegerValueOf.toByteArray()));
            } catch (NoSuchAlgorithmException e) {
        ...
        public byte[] getPasswordAuthenticationKey(String str, String str2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            messageDigest.reset();
            messageDigest.update(this.f344A.toByteArray());
            ...
            BigInteger bigInteger5 = f342KK;
            BigInteger bigInteger6 = f341GG;
            BigInteger bigInteger7 = f343N;
            BigInteger bigIntegerMod = bigInteger.subtract(bigInteger5.multiply(bigInteger6.modPow(bigInteger4, bigInteger7))).modPow(this.f345a.add(bigInteger3.multiply(bigInteger4)), bigInteger7).mod(bigInteger7);
            try {
