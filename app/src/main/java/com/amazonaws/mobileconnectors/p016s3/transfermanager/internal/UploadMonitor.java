...
import com.amazonaws.mobileconnectors.p016s3.transfermanager.PauseResult;
import com.amazonaws.mobileconnectors.p016s3.transfermanager.PauseStatus;
...
public class UploadMonitor implements Callable<UploadResult>, TransferMonitor {
    ...
    @Override // com.amazonaws.mobileconnectors.p016s3.transfermanager.internal.TransferMonitor
    ...
    public UploadMonitor(TransferManager transferManager, UploadImpl uploadImpl, ExecutorService executorService, UploadCallable uploadCallable, PutObjectRequest putObjectRequest, ProgressListenerChain progressListenerChain) {
        this.f354s3 = transferManager.getAmazonS3Client();
    ...
    private UploadResult completeMultipartUpload() {
        CompleteMultipartUploadResult completeMultipartUploadResultCompleteMultipartUpload = this.f354s3.completeMultipartUpload(new CompleteMultipartUploadRequest(this.putObjectRequest.getBucketName(), this.putObjectRequest.getKey(), this.uploadId, collectPartETags()));
        uploadComplete();
