...
class TransferDBUtil {
    ...
    public int updateTransferRecord(TransferRecord transferRecord) {
        ...
        contentValues.put("_id", Integer.valueOf(transferRecord.f358id));
        ...
        return transferDBBase.update(getRecordUri(transferRecord.f358id), contentValues, null, null);
    }
