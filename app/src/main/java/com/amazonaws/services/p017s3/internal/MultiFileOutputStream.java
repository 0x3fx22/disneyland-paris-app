...
import com.amazonaws.services.p017s3.OnFileDelete;
...
public class MultiFileOutputStream extends OutputStream implements OnFileDelete {
    ...
    private FileOutputStream f372os;
    ...
    private FileOutputStream fos() throws IOException {
        ...
        FileOutputStream fileOutputStream = this.f372os;
        if (fileOutputStream == null || this.currFileBytesWritten >= this.partSize) {
            ...
            file.deleteOnExit();
            this.f372os = new FileOutputStream(file);
        }
        return this.f372os;
    }

    @Override // com.amazonaws.services.p017s3.OnFileDelete
