...
final class S3CryptoScheme {
    ...
    /* JADX INFO: renamed from: com.amazonaws.services.s3.internal.crypto.S3CryptoScheme$1 */
    ...
    static S3CryptoScheme from(CryptoMode cryptoMode) {
        int i = C20211.$SwitchMap$com$amazonaws$services$s3$model$CryptoMode[cryptoMode.ordinal()];
        if (i == 1) {
