...
import com.amazonaws.services.p017s3.internal.DeleteObjectsResponse;
import com.amazonaws.services.p017s3.internal.ObjectExpirationResult;
import com.amazonaws.services.p017s3.internal.S3HttpUtils;
import com.amazonaws.services.p017s3.internal.S3RequesterChargedResult;
import com.amazonaws.services.p017s3.internal.S3VersionResult;
...
import com.amazonaws.services.p017s3.model.AbortIncompleteMultipartUpload;
import com.amazonaws.services.p017s3.model.AccessControlList;
import com.amazonaws.services.p017s3.model.AmazonS3Exception;
import com.amazonaws.services.p017s3.model.Bucket;
import com.amazonaws.services.p017s3.model.BucketAccelerateConfiguration;
import com.amazonaws.services.p017s3.model.BucketCrossOriginConfiguration;
import com.amazonaws.services.p017s3.model.BucketLifecycleConfiguration;
import com.amazonaws.services.p017s3.model.BucketLoggingConfiguration;
import com.amazonaws.services.p017s3.model.BucketReplicationConfiguration;
import com.amazonaws.services.p017s3.model.BucketTaggingConfiguration;
import com.amazonaws.services.p017s3.model.BucketVersioningConfiguration;
import com.amazonaws.services.p017s3.model.BucketWebsiteConfiguration;
import com.amazonaws.services.p017s3.model.CORSRule;
import com.amazonaws.services.p017s3.model.CanonicalGrantee;
import com.amazonaws.services.p017s3.model.CompleteMultipartUploadResult;
import com.amazonaws.services.p017s3.model.CopyObjectResult;
import com.amazonaws.services.p017s3.model.DeleteObjectsResult;
import com.amazonaws.services.p017s3.model.EmailAddressGrantee;
import com.amazonaws.services.p017s3.model.GetBucketAnalyticsConfigurationResult;
import com.amazonaws.services.p017s3.model.GetBucketInventoryConfigurationResult;
import com.amazonaws.services.p017s3.model.GetBucketMetricsConfigurationResult;
import com.amazonaws.services.p017s3.model.GetObjectTaggingResult;
import com.amazonaws.services.p017s3.model.Grantee;
import com.amazonaws.services.p017s3.model.GroupGrantee;
import com.amazonaws.services.p017s3.model.InitiateMultipartUploadResult;
import com.amazonaws.services.p017s3.model.ListBucketAnalyticsConfigurationsResult;
import com.amazonaws.services.p017s3.model.ListBucketInventoryConfigurationsResult;
import com.amazonaws.services.p017s3.model.ListBucketMetricsConfigurationsResult;
import com.amazonaws.services.p017s3.model.ListObjectsV2Result;
import com.amazonaws.services.p017s3.model.MultiObjectDeleteException;
import com.amazonaws.services.p017s3.model.MultipartUpload;
import com.amazonaws.services.p017s3.model.MultipartUploadListing;
import com.amazonaws.services.p017s3.model.ObjectListing;
...
import com.amazonaws.services.p017s3.model.Permission;
import com.amazonaws.services.p017s3.model.RedirectRule;
import com.amazonaws.services.p017s3.model.ReplicationDestinationConfig;
import com.amazonaws.services.p017s3.model.ReplicationRule;
import com.amazonaws.services.p017s3.model.RequestPaymentConfiguration;
import com.amazonaws.services.p017s3.model.RoutingRule;
import com.amazonaws.services.p017s3.model.RoutingRuleCondition;
import com.amazonaws.services.p017s3.model.S3ObjectSummary;
import com.amazonaws.services.p017s3.model.S3VersionSummary;
import com.amazonaws.services.p017s3.model.Tag;
import com.amazonaws.services.p017s3.model.TagSet;
import com.amazonaws.services.p017s3.model.VersionListing;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsAndOperator;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsConfiguration;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsExportDestination;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsFilter;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsPrefixPredicate;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsS3BucketDestination;
import com.amazonaws.services.p017s3.model.analytics.AnalyticsTagPredicate;
import com.amazonaws.services.p017s3.model.analytics.StorageClassAnalysis;
import com.amazonaws.services.p017s3.model.analytics.StorageClassAnalysisDataExport;
import com.amazonaws.services.p017s3.model.inventory.InventoryConfiguration;
import com.amazonaws.services.p017s3.model.inventory.InventoryDestination;
import com.amazonaws.services.p017s3.model.inventory.InventoryFilter;
import com.amazonaws.services.p017s3.model.inventory.InventoryPrefixPredicate;
import com.amazonaws.services.p017s3.model.inventory.InventoryS3BucketDestination;
import com.amazonaws.services.p017s3.model.inventory.InventorySchedule;
import com.amazonaws.services.p017s3.model.lifecycle.LifecycleAndOperator;
import com.amazonaws.services.p017s3.model.lifecycle.LifecycleFilter;
import com.amazonaws.services.p017s3.model.lifecycle.LifecyclePrefixPredicate;
import com.amazonaws.services.p017s3.model.lifecycle.LifecycleTagPredicate;
import com.amazonaws.services.p017s3.model.metrics.MetricsAndOperator;
import com.amazonaws.services.p017s3.model.metrics.MetricsConfiguration;
import com.amazonaws.services.p017s3.model.metrics.MetricsFilter;
import com.amazonaws.services.p017s3.model.metrics.MetricsPrefixPredicate;
import com.amazonaws.services.p017s3.model.metrics.MetricsTagPredicate;
...
public class XmlResponsesSaxParser {
    ...
    private XMLReader f395xr;

    public XmlResponsesSaxParser() throws AmazonClientException {
        this.f395xr = null;
        try {
            this.f395xr = XMLReaderFactory.createXMLReader();
    ...
    protected void parseXmlInputStream(DefaultHandler defaultHandler, InputStream inputStream) throws IOException {
        try {
            ...
            this.f395xr.setContentHandler(defaultHandler);
            this.f395xr.setErrorHandler(defaultHandler);
            this.f395xr.parse(new InputSource(bufferedReader));
        } catch (IOException e) {
            throw e;
        } catch (Throwable th) {
            try {
        ...
        try {
            ...
            while (true) {
                ...
                if (i != -1) {
                    ...
                    return new ByteArrayInputStream(sb.toString().replaceAll(StringUtils.f3984CR, "&#013;").getBytes(com.amazonaws.util.StringUtils.UTF8));
                }
            }
        } catch (IOException e) {
            throw e;
    ...
    public static class ListBucketHandler extends AbstractHandler {
        ...
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            ...
            if (m474in("ListBucketResult", "Contents") && str2.equals("Owner")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ListBucketResult", "Contents")) {
                if (str2.equals("Key")) {
                    String text = getText();
                    this.lastKey = text;
            ...
            if (m474in("ListBucketResult", "Contents", "Owner")) {
                if (str2.equals("ID")) {
            ...
            if (m474in("ListBucketResult", "CommonPrefixes") && str2.equals("Prefix")) {
    ...
    public static class ListAllMyBucketsHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (!m474in("ListAllMyBucketsResult")) {
                if (m474in("ListAllMyBucketsResult", "Buckets") && str2.equals("Bucket")) {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("ListAllMyBucketsResult", "Owner")) {
                if (str2.equals("ID")) {
            ...
            if (m474in("ListAllMyBucketsResult", "Buckets")) {
            ...
            if (m474in("ListAllMyBucketsResult", "Buckets", "Bucket")) {
                if (str2.equals("Name")) {
    ...
    public static class AccessControlListHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (!m474in("AccessControlPolicy")) {
                if (m474in("AccessControlPolicy", "AccessControlList", "Grant") && str2.equals("Grantee")) {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("AccessControlPolicy", "Owner")) {
                if (str2.equals("ID")) {
            ...
            if (m474in("AccessControlPolicy", "AccessControlList")) {
            ...
            if (!m474in("AccessControlPolicy", "AccessControlList", "Grant")) {
                if (m474in("AccessControlPolicy", "AccessControlList", "Grant", "Grantee")) {
                    if (str2.equals("ID")) {
    ...
    public static class BucketLoggingConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("BucketLoggingStatus", "LoggingEnabled")) {
    ...
    public static class CopyObjectResultHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3RequesterChargedResult, S3VersionResult {
        ...
        @Override // com.amazonaws.services.p017s3.internal.S3VersionResult
        ...
        @Override // com.amazonaws.services.p017s3.internal.S3RequesterChargedResult
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("CopyObjectResult") || m474in("CopyPartResult")) {
                if (str2.equals("LastModified")) {
    ...
    public static class RequestPaymentConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("RequestPaymentConfiguration") && str2.equals("Payer")) {
                this.payer = getText();
            }
        }
    }
    ...
    public static class ListVersionsHandler extends AbstractHandler {
        ...
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            ...
            if ((m474in("ListVersionsResult", "Version") || m474in("ListVersionsResult", "DeleteMarker")) && str2.equals("Owner")) {
                this.currentOwner = new Owner();
            }
        }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (!m474in("ListVersionsResult")) {
                if (m474in("ListVersionsResult", "CommonPrefixes")) {
                    if (str2.equals("Prefix")) {
                ...
                if (m474in("ListVersionsResult", "Version") || m474in("ListVersionsResult", "DeleteMarker")) {
                    if (str2.equals("Key")) {
                ...
                if (m474in("ListVersionsResult", "Version", "Owner") || m474in("ListVersionsResult", "DeleteMarker", "Owner")) {
                    if (str2.equals("ID")) {
                        this.currentOwner.setId(getText());
                        return;
                    } else {
    ...
    public static class BucketWebsiteConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (!m474in("WebsiteConfiguration")) {
                if (m474in("WebsiteConfiguration", "RoutingRules")) {
                    ...
                    if (m474in("WebsiteConfiguration", "RoutingRules", "RoutingRule")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (!m474in("WebsiteConfiguration")) {
                if (!m474in("WebsiteConfiguration", "IndexDocument")) {
                    if (!m474in("WebsiteConfiguration", "ErrorDocument")) {
                        if (m474in("WebsiteConfiguration", "RoutingRules")) {
                            if (str2.equals("RoutingRule")) {
                        ...
                        if (m474in("WebsiteConfiguration", "RoutingRules", "RoutingRule", JsonDocumentFields.CONDITION)) {
                        ...
                        if (m474in("WebsiteConfiguration", "RedirectAllRequestsTo") || m474in("WebsiteConfiguration", "RoutingRules", "RoutingRule", "Redirect")) {
    ...
    public static class BucketVersioningConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("VersioningConfiguration")) {
    ...
    public static class BucketAccelerateConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("AccelerateConfiguration") && str2.equals("Status")) {
                this.configuration.setStatus(getText());
            }
        }
    }
    ...
    public static class CompleteMultipartUploadHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3VersionResult, S3RequesterChargedResult {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("CompleteMultipartUploadResult")) {
    ...
    public static class InitiateMultipartUploadHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doEndElement(String str, String str2, String str3) {
            if (m474in("InitiateMultipartUploadResult")) {
                if (str2.equals("Bucket")) {
                    this.result.setBucketName(getText());
                } else if (str2.equals("Key")) {
                    this.result.setKey(getText());
    ...
    public static class ListMultipartUploadsHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("ListMultipartUploadsResult")) {
                if (str2.equals("Upload")) {
                    this.currentMultipartUpload = new MultipartUpload();
                }
            } else if (m474in("ListMultipartUploadsResult", "Upload")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (!m474in("ListMultipartUploadsResult")) {
                if (m474in("ListMultipartUploadsResult", "CommonPrefixes")) {
                    if (str2.equals("Prefix")) {
                ...
                if (m474in("ListMultipartUploadsResult", "Upload")) {
                    if (str2.equals("Key")) {
                ...
                if (m474in("ListMultipartUploadsResult", "Upload", "Owner") || m474in("ListMultipartUploadsResult", "Upload", "Initiator")) {
                    if (str2.equals("ID")) {
    ...
    public static class ListPartsHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ListPartsResult", "Part")) {
            ...
            if (m474in("ListPartsResult", "Owner") || m474in("ListPartsResult", "Initiator")) {
                if (str2.equals("ID")) {
                    this.currentOwner.setId(XmlResponsesSaxParser.checkForEmptyString(getText()));
    ...
    public static class BucketReplicationConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("ReplicationConfiguration")) {
                if (str2.equals("Rule")) {
                    this.currentRule = new ReplicationRule();
                }
            } else if (m474in("ReplicationConfiguration", "Rule") && str2.equals("Destination")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ReplicationConfiguration", "Rule")) {
                if (str2.equals("ID")) {
            ...
            if (m474in("ReplicationConfiguration", "Rule", "Destination")) {
                if (str2.equals("Bucket")) {
    ...
    public static class BucketTaggingConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("Tagging") && str2.equals("TagSet")) {
    ...
    public static class DeleteObjectsHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("DeleteResult", "Deleted")) {
                if (str2.equals("Key")) {
    ...
    public static class BucketLifecycleConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("LifecycleConfiguration")) {
                if (str2.equals("Rule")) {
            ...
            if (m474in("LifecycleConfiguration", "Rule")) {
            ...
            if (m474in("LifecycleConfiguration", "Rule", "Filter") && str2.equals("And")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (!m474in("LifecycleConfiguration", "Rule")) {
                if (m474in("LifecycleConfiguration", "Rule", "Expiration")) {
                    if (str2.equals("Date")) {
                ...
                if (!m474in("LifecycleConfiguration", "Rule", "Transition")) {
                    if (m474in("LifecycleConfiguration", "Rule", "NoncurrentVersionExpiration")) {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "NoncurrentVersionTransition")) {
                        if (str2.equals("StorageClass")) {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "AbortIncompleteMultipartUpload")) {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "Filter")) {
                        if (str2.equals("Prefix")) {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "Filter", "Tag")) {
                        if (str2.equals("Key")) {
                            this.currentTagKey = getText();
                            return;
                        } else {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "Filter", "And")) {
                        if (str2.equals("Prefix")) {
                    ...
                    if (m474in("LifecycleConfiguration", "Rule", "Filter", "And", "Tag")) {
                        if (str2.equals("Key")) {
                            this.currentTagKey = getText();
                            return;
                        } else {
    ...
    public static class BucketCrossOriginConfigurationHandler extends AbstractHandler {
        ...
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            ...
            if (m474in("CORSConfiguration", "CORSRule")) {
    ...
    public static class GetBucketMetricsConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("MetricsConfiguration")) {
                if (str2.equals("Filter")) {
                    this.filter = new MetricsFilter();
                }
            } else if (m474in("MetricsConfiguration", "Filter") && str2.equals("And")) {
                this.andOperandsList = new ArrayList();
            }
        }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("MetricsConfiguration", "Filter")) {
                if (str2.equals("Prefix")) {
            ...
            if (m474in("MetricsConfiguration", "Filter", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("MetricsConfiguration", "Filter", "And")) {
                if (str2.equals("Prefix")) {
            ...
            if (m474in("MetricsConfiguration", "Filter", "And", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                } else if (str2.equals("Value")) {
                    this.currentTagValue = getText();
    ...
    public static class ListBucketMetricsConfigurationsHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("ListMetricsConfigurationsResult")) {
                if (str2.equals("MetricsConfiguration")) {
                    this.currentConfiguration = new MetricsConfiguration();
                }
            } else if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration")) {
                if (str2.equals("Filter")) {
                    this.currentFilter = new MetricsFilter();
                }
            } else if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration", "Filter") && str2.equals("And")) {
                this.andOperandsList = new ArrayList();
            }
        }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration")) {
                if (str2.equals(JsonDocumentFields.POLICY_ID)) {
            ...
            if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration", "Filter")) {
                if (str2.equals("Prefix")) {
            ...
            if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration", "Filter", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration", "Filter", "And")) {
                if (str2.equals("Prefix")) {
                    this.andOperandsList.add(new MetricsPrefixPredicate(getText()));
                    return;
                } else {
            ...
            if (m474in("ListMetricsConfigurationsResult", "MetricsConfiguration", "Filter", "And", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                } else if (str2.equals("Value")) {
                    this.currentTagValue = getText();
    ...
    public static class GetBucketAnalyticsConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("AnalyticsConfiguration")) {
                if (str2.equals("Filter")) {
            ...
            if (m474in("AnalyticsConfiguration", "Filter")) {
                if (str2.equals("And")) {
                    this.andOperandsList = new ArrayList();
                }
            } else if (m474in("AnalyticsConfiguration", "StorageClassAnalysis")) {
                if (str2.equals("DataExport")) {
                    this.dataExport = new StorageClassAnalysisDataExport();
                }
            } else if (m474in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport")) {
                if (str2.equals("Destination")) {
                    this.destination = new AnalyticsExportDestination();
                }
            } else if (m474in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination") && str2.equals("S3BucketDestination")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("AnalyticsConfiguration", "Filter", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("AnalyticsConfiguration", "Filter", "And")) {
                if (str2.equals("Prefix")) {
            ...
            if (m474in("AnalyticsConfiguration", "Filter", "And", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("AnalyticsConfiguration", "StorageClassAnalysis")) {
                if (str2.equals("DataExport")) {
            ...
            if (m474in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport")) {
            ...
            if (m474in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination")) {
                if (str2.equals("S3BucketDestination")) {
                    this.destination.setS3BucketDestination(this.s3BucketDestination);
                }
            } else if (m474in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination", "S3BucketDestination")) {
    ...
    public static class ListBucketAnalyticsConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("ListBucketAnalyticsConfigurationsResult")) {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration")) {
                if (str2.equals("Filter")) {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "Filter")) {
                if (str2.equals("And")) {
                    this.andOperandsList = new ArrayList();
                }
            } else if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis")) {
                if (str2.equals("DataExport")) {
                    this.dataExport = new StorageClassAnalysisDataExport();
                }
            } else if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis", "DataExport")) {
                if (str2.equals("Destination")) {
                    this.destination = new AnalyticsExportDestination();
                }
            } else if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination") && str2.equals("S3BucketDestination")) {
                this.s3BucketDestination = new AnalyticsS3BucketDestination();
            }
        }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "Filter", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "Filter", "And")) {
                if (str2.equals("Prefix")) {
                    this.andOperandsList.add(new AnalyticsPrefixPredicate(getText()));
                    return;
                } else {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "Filter", "And", "Tag")) {
                if (str2.equals("Key")) {
                    this.currentTagKey = getText();
                    return;
                } else {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis")) {
                if (str2.equals("DataExport")) {
                    this.storageClassAnalysis.setDataExport(this.dataExport);
                    return;
                }
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis", "DataExport")) {
                if (str2.equals("OutputSchemaVersion")) {
                    this.dataExport.setOutputSchemaVersion(getText());
                    return;
                } else {
            ...
            if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination")) {
                if (str2.equals("S3BucketDestination")) {
                    this.destination.setS3BucketDestination(this.s3BucketDestination);
                }
            } else if (m474in("ListBucketAnalyticsConfigurationsResult", "AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", "Destination", "S3BucketDestination")) {
                if (str2.equals("Format")) {
                    this.s3BucketDestination.setFormat(getText());
                    return;
                }
    ...
    public static class GetBucketInventoryConfigurationHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("InventoryConfiguration")) {
                if (str2.equals("Destination")) {
            ...
            if (m474in("InventoryConfiguration", "Destination") && str2.equals("S3BucketDestination")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("InventoryConfiguration", "Destination")) {
                if (str2.equals("S3BucketDestination")) {
            ...
            if (m474in("InventoryConfiguration", "Destination", "S3BucketDestination")) {
            ...
            if (m474in("InventoryConfiguration", "Filter")) {
                if (str2.equals("Prefix")) {
                    this.filter.setPredicate(new InventoryPrefixPredicate(getText()));
                }
            } else if (m474in("InventoryConfiguration", "Schedule")) {
                if (str2.equals("Frequency")) {
                    this.inventorySchedule.setFrequency(getText());
                }
            } else if (m474in("InventoryConfiguration", "OptionalFields") && str2.equals("Field")) {
    ...
    public static class ListBucketInventoryConfigurationsHandler extends AbstractHandler {
        ...
        @Override // com.amazonaws.services.p017s3.model.transform.AbstractHandler
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (m474in("ListInventoryConfigurationsResult")) {
            ...
            if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration")) {
                if (str2.equals("Destination")) {
            ...
            if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "Destination") && str2.equals("S3BucketDestination")) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "Destination")) {
                if (str2.equals("S3BucketDestination")) {
            ...
            if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "Destination", "S3BucketDestination")) {
                if (str2.equals("AccountId")) {
            ...
            if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "Filter")) {
                if (str2.equals("Prefix")) {
                    this.currentFilter.setPredicate(new InventoryPrefixPredicate(getText()));
                }
            } else if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "Schedule")) {
                if (str2.equals("Frequency")) {
                    this.currentSchedule.setFrequency(getText());
                }
            } else if (m474in("ListInventoryConfigurationsResult", "InventoryConfiguration", "OptionalFields") && str2.equals("Field")) {
