...
import com.amazonaws.services.p017s3.internal.crypto.CryptoRuntime;
...
public class CryptoConfiguration implements Cloneable, Serializable {
    ...
    private static final class ReadOnly extends CryptoConfiguration {
        @Override // com.amazonaws.services.p017s3.model.CryptoConfiguration
        public boolean isReadOnly() {
            return true;
        }
        ...
        public /* bridge */ /* synthetic */ Object mo2889clone() {
            return super.mo2889clone();
        }
    ...
    public CryptoConfiguration mo2889clone() {
