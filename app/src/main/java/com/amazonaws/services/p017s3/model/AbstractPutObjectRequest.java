...
public abstract class AbstractPutObjectRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, SSEAwsKeyManagementParamsProvider, S3DataSource, Serializable {
    ...
    @Override // com.amazonaws.services.p017s3.model.S3DataSource
    public File getFile() {
        return this.file;
    }
    ...
    @Override // com.amazonaws.services.p017s3.model.SSECustomerKeyProvider
    ...
    @Override // com.amazonaws.services.p017s3.model.SSEAwsKeyManagementParamsProvider
