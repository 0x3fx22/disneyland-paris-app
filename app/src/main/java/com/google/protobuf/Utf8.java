...
abstract class Utf8 {
        ...
        */
        final int partialIsValidUtf8Default(int i, ByteBuffer byteBuffer, int i2, int i3) {
            ...
            if (i != 0) {
                ...
                if (b5 <= -65 && (((b2 << Ascii.f3525FS) + (b5 + 112)) >> 30) == 0 && b <= -65) {
                    i2 = i4 + 1;
                }
                return -1;
                i2 = i5;
            ...
            while (iEstimateConsecutiveAscii < i2) {
                ...
                if (b >= 0) {
                    ...
                    if (b >= -16) {
                        ...
                        if (b2 <= -65 && (((b << Ascii.f3525FS) + (b2 + 112)) >> 30) == 0) {
        ...
        */
        int partialIsValidUtf8(int i, byte[] bArr, int i2, int i3) {
            ...
            if (i != 0) {
                ...
                if (b4 <= -65 && (((b2 << Ascii.f3525FS) + (b4 + 112)) >> 30) == 0 && b <= -65) {
                    j = j2 + 1;
                }
                return -1;
                j2 = j;
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 >= 128 || j3 >= j4) {
                    if (cCharAt2 >= 2048 || j3 > j4 - 2) {
                            ...
                            if (j3 <= j4 - 4) {
                                ...
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                        int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                        j2 = 1;
                                        UnsafeUtil.putByte(bArr, j3, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                        ...
                        UnsafeUtil.putByte(bArr, j3, (byte) ((cCharAt2 >>> '\f') | Currencies.MUR));
                        long j6 = j3 + 2;
                        ...
                        str3 = str5;
                        long j7 = j3 + j;
                        UnsafeUtil.putByte(bArr, j3, (byte) ((cCharAt2 >>> 6) | Currencies.XDR));
                        j3 += 2;
    ...
    private static class DecodeUtil {
        ...
        public static void handleTwoBytes(byte b, byte b2, char[] cArr, int i) throws InvalidProtocolBufferException {
            ...
            cArr[i] = (char) (((b & Ascii.f3534US) << 6) | trailingByteValue(b2));
        }
        ...
        public static void handleThreeBytes(byte b, byte b2, byte b3, char[] cArr, int i) throws InvalidProtocolBufferException {
            ...
            cArr[i] = (char) (((b & Ascii.f3531SI) << 12) | (trailingByteValue(b2) << 6) | trailingByteValue(b3));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws InvalidProtocolBufferException {
            if (isNotTrailingByte(b2) || (((b << Ascii.f3525FS) + (b2 + 112)) >> 30) != 0 || isNotTrailingByte(b3) || isNotTrailingByte(b4)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
