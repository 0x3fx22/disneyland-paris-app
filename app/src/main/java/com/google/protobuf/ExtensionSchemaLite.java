...
final class ExtensionSchemaLite extends ExtensionSchema {
    ...
    Object parseExtension(Object obj, Reader reader, Object obj2, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet, Object obj3, UnknownFieldSchema unknownFieldSchema) {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            switch (C43131.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                case 1:
            ...
            if (generatedExtension.isRepeated()) {
                ...
                int i = C43131.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()];
    ...
    void serializeExtension(Writer writer, Map.Entry entry) {
        ...
        if (extensionDescriptor.isRepeated()) {
            switch (C43131.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionDescriptor.getLiteType().ordinal()]) {
                case 1:
