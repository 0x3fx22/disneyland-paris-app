            ...
            if (i3 != i2) {
                ...
                if (i3 - i4 >= 9) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = i2 + 3;
                        int i8 = (bArr[i5] << Ascii.f3532SO) ^ i6;
                        if (i8 >= 0) {
                            i = i8 ^ 16256;
                        } else {
                            int i9 = i2 + 4;
                            ...
                            if (i10 < 0) {
                                ...
                                i7 = i2 + 5;
                                byte b2 = bArr[i9];
                                int i11 = (i10 ^ (b2 << Ascii.f3525FS)) ^ 266354560;
                                if (b2 < 0) {
                                    i9 = i2 + 6;
                                    if (bArr[i7] < 0) {
                                        i7 = i2 + 7;
            ...
            if (i2 != i) {
                ...
                if (i2 - i3 >= 9) {
                    ...
                    if (i5 < 0) {
                        ...
                        int i6 = i + 3;
                        int i7 = (bArr[i4] << Ascii.f3532SO) ^ i5;
                        if (i7 >= 0) {
                            j = i7 ^ 16256;
                            i4 = i6;
                        } else {
            ...
            if (this.limit != j) {
                ...
                if (this.limit - j2 >= 9) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j3) << Ascii.f3532SO);
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            j3 = 4 + j;
                            ...
                            if (i4 < 0) {
                                ...
                                int i5 = (i4 ^ (b2 << Ascii.f3525FS)) ^ 266354560;
                                if (b2 < 0) {
                                    j3 = 6 + j;
        ...
        public long readRawVarint64() {
            ...
            if (this.limit != j4) {
                ...
                if (this.limit - j5 >= 9) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j6) << Ascii.f3532SO);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                            j6 = j7;
                        } else {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = (UnsafeUtil.getByte(j3) << Ascii.f3532SO) ^ i2;
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            long j5 = 4 + j;
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i < 0) {
                        ...
                        long j7 = 3 + j4;
                        int i2 = (UnsafeUtil.getByte(j6) << Ascii.f3532SO) ^ i;
                        if (i2 >= 0) {
                            j = i2 ^ 16256;
                            j6 = j7;
                        } else {
