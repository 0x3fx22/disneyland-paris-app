...
final class CodedInputStreamReader implements Reader {
    ...
    @Override // com.google.protobuf.Reader
    public void readMap(Map map, MapEntryLite.Metadata metadata, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
    ...
    private Object readField(WireFormat.FieldType fieldType, Class cls, ExtensionRegistryLite extensionRegistryLite) {
        switch (C43051.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
