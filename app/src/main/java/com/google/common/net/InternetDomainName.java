...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m1495on('.');
    private static final Joiner DOT_JOINER = Joiner.m1488on('.');
    ...
    static {
        ...
        CharMatcher charMatcherMo1487or = CharMatcher.inRange('a', 'z').mo1487or(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO));
        LETTER_MATCHER = charMatcherMo1487or;
        PART_CHAR_MATCHER = charMatcherInRange.mo1487or(charMatcherMo1487or).mo1487or(charMatcherAnyOf);
    }
    ...
    private int registrySuffixIndex() {
        ...
        int iFindSuffixOfType = findSuffixOfType(Optional.m1490of(PublicSuffixType.REGISTRY));
