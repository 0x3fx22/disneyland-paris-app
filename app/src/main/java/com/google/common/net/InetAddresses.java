...
public final class InetAddresses {
    private static final CharMatcher IPV4_DELIMITER_MATCHER = CharMatcher.m1486is('.');
    private static final CharMatcher IPV6_DELIMITER_MATCHER = CharMatcher.m1486is(':');
