...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        ...
        if (i2 >= 4) {
            return hashLength16(((long) i2) + ((((long) LittleEndianByteArray.load32(bArr, i)) & BodyPartID.bodyIdMax) << 3), ((long) LittleEndianByteArray.load32(bArr, (i + i2) - 4)) & BodyPartID.bodyIdMax, ((long) (i2 * 2)) - 7286425919675154353L);
        }
        if (i2 <= 0) {
    ...
    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        ...
        return hashLength16((LittleEndianByteArray.load64(bArr, i3 - 16) * (-7286425919675154353L)) + Long.rotateRight(jLoad64 + jLoad65, 43) + Long.rotateRight(jLoad66, 30), jLoad66 + jLoad64 + Long.rotateRight(jLoad65 - 7286425919675154353L, 18), j);
    }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i3 = i + i2;
        long jLoad66 = LittleEndianByteArray.load64(bArr, i3 - 8) * j;
        long jRotateRight = Long.rotateRight(jLoad64 + jLoad65, 43) + Long.rotateRight(jLoad66, 30) + (LittleEndianByteArray.load64(bArr, i3 - 16) * (-7286425919675154353L));
