...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (i3 >= 32) {
                this.f3548h1 = Murmur3_32HashFunction.mixH1(this.f3548h1, Murmur3_32HashFunction.mixK1((int) j4));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int iMixK1 = this.f3548h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f3548h1 = iMixK1;
