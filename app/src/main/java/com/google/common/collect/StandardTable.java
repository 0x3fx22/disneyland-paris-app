    ...
    private class Column extends Maps.ViewCachingAbstractMap {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet {
            ...
            public boolean retainAll(Collection collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m1491in(collection)));
            }
        }
        ...
        private class KeySet extends Maps.KeySet {
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m1491in(collection))));
            }
        }
        ...
        private class Values extends Maps.Values {
            ...
            public boolean removeAll(Collection collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m1491in(collection)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m1491in(collection))));
            }
        }
    }
