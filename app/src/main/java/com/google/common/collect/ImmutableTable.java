...
public abstract class ImmutableTable<R, C, V> extends AbstractTable implements Serializable {
    ...
    public static <R, C, V> ImmutableTable<R, C, V> m1624of() {
        return SparseImmutableTable.EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m1625of(R r, C c, V v) {
    ...
    public ImmutableMap<R, V> column(C c) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c), ImmutableMap.m1535of());
    }
    ...
    public ImmutableMap<C, V> row(R r) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r), ImmutableMap.m1535of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m1625of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
