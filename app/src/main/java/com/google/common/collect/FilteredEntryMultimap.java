...
class FilteredEntryMultimap extends AbstractMultimap implements FilteredMultimap {
    ...
    class AsMap extends Maps.ViewCachingAbstractMap {
        ...
        Set createKeySet() {
            return new Maps.KeySet() { // from class: com.google.common.collect.FilteredEntryMultimap.AsMap.1KeySetImpl
                ...
                public boolean removeAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.m1491in(collection)));
                }

                @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean retainAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m1491in(collection))));
                }
        ...
        Set createEntrySet() {
            return new Maps.EntrySet() { // from class: com.google.common.collect.FilteredEntryMultimap.AsMap.1EntrySetImpl
                ...
                public boolean removeAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.m1491in(collection));
                }

                @Override // com.google.common.collect.Maps.EntrySet, com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean retainAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.not(Predicates.m1491in(collection)));
                }
        ...
        Collection createValues() {
            return new Maps.Values() { // from class: com.google.common.collect.FilteredEntryMultimap.AsMap.1ValuesImpl
                ...
                @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                public boolean removeAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.m1491in(collection)));
                }

                @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                public boolean retainAll(Collection collection) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m1491in(collection))));
                }
            };
        }
    }
    ...
    class Keys extends Multimaps.Keys {
        ...
        class C38381 extends Multisets.EntrySet {
            C38381() {
            }
            ...
            private boolean removeEntriesIf(final Predicate predicate) {
                return FilteredEntryMultimap.this.removeEntriesIf(new Predicate() { // from class: com.google.common.collect.FilteredEntryMultimap$Keys$1$$ExternalSyntheticLambda0
                    ...
                    public final boolean apply(Object obj) {
                        return FilteredEntryMultimap.Keys.C38381.lambda$removeEntriesIf$0(predicate, (Map.Entry) obj);
                    }
                });
            }
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean removeAll(Collection collection) {
                return removeEntriesIf(Predicates.m1491in(collection));
            }

            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection collection) {
                return removeEntriesIf(Predicates.not(Predicates.m1491in(collection)));
            }
        }
