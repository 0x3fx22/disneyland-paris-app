...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable iterable) {
        this.iterableDelegate = Optional.m1490of(iterable);
    }

    private Iterable getDelegate() {
        return (Iterable) this.iterableDelegate.mo1484or(this);
    }
    ...
    public static <E> FluentIterable<E> m1501of() {
        return from(Collections.emptyList());
    }

    /* JADX INFO: renamed from: of */
    public static <E> FluentIterable<E> m1502of(E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m1490of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m1490of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m1490of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m1490of(next);
    }
