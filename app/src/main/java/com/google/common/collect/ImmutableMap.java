...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static <K, V> ImmutableMap<K, V> m1535of() {
        return RegularImmutableMap.EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1536of(K k, V v) {
        CollectPreconditions.checkEntryNotNull(k, v);
        return RegularImmutableMap.create(1, new Object[]{k, v});
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1537of(K k, V v, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k, v);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1538of(K k, V v, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1539of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1540of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1541of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1542of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1543of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1544of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1545of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m1570of();
        }
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap {
        ...
        public ImmutableSet get(Object obj) {
            ...
            return ImmutableSet.m1564of(obj2);
        }
                ...
                public Map.Entry next() {
                    ...
                    return new AbstractMapEntry(this) { // from class: com.google.common.collect.ImmutableMap.MapViewOfValuesAsSingletonSets.1.1
                        ...
                        public ImmutableSet getValue() {
                            return ImmutableSet.m1564of(entry.getValue());
                        }
                    };
                }
            };
