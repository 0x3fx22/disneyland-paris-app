        ...
        class SubRangeMapAsMap extends AbstractMap {
            ...
            public Set keySet() {
                return new Maps.KeySet(this) { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.1
                    ...
                    public boolean retainAll(Collection collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m1491in(collection)), Maps.keyFunction()));
                    }
                };
            }
            ...
            public Set entrySet() {
                return new Maps.EntrySet() { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.2
                    ...
                    public boolean retainAll(Collection collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.not(Predicates.m1491in(collection)));
                    }
            ...
            public Collection values() {
                return new Maps.Values(this) { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.4
                    ...
                    public boolean removeAll(Collection collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.m1491in(collection), Maps.valueFunction()));
                    }

                    @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                    public boolean retainAll(Collection collection) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m1491in(collection)), Maps.valueFunction()));
                    }
                };
            }
        }
