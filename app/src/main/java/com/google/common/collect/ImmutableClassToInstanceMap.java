...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap EMPTY = new ImmutableClassToInstanceMap(ImmutableMap.m1535of());
    private final ImmutableMap delegate;

    /* JADX INFO: renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m1514of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m1515of(Class<T> cls, T t) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m1536of(cls, t));
    }
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (immutableMapBuildOrThrow.isEmpty()) {
                return ImmutableClassToInstanceMap.m1514of();
            }
