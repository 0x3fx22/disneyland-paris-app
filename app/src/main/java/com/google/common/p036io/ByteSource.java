...
public abstract class ByteSource {
    ...
    class AsCharSource extends CharSource {
        ...
        @Override // com.google.common.p036io.CharSource
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        @Override // com.google.common.p036io.ByteSource
        ...
        public Optional sizeIfKnown() {
            ...
            if (optionalSizeIfKnown.isPresent()) {
                ...
                return Optional.m1490of(Long.valueOf(Math.min(this.length, jLongValue - Math.min(this.offset, jLongValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p036io.ByteSource
        public Optional sizeIfKnown() {
            return Optional.m1490of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.io.ByteSource.ByteArrayByteSource, com.google.common.p036io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional sizeIfKnown() {
            ...
            while (it.hasNext()) {
                ...
                if (jLongValue < 0) {
                    return Optional.m1490of(Long.MAX_VALUE);
                }
            }
            return Optional.m1490of(Long.valueOf(jLongValue));
        }
