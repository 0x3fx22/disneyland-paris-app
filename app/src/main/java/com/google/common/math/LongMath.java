...
public final class LongMath {
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f3531SI, Ascii.f3531SI, Ascii.f3531SI, Ascii.f3531SI, Ascii.f3532SO, Ascii.f3532SO, Ascii.f3532SO, Ascii.f3522CR, Ascii.f3522CR, Ascii.f3522CR, Ascii.f3524FF, Ascii.f3524FF, Ascii.f3524FF, Ascii.f3524FF, Ascii.f3535VT, Ascii.f3535VT, Ascii.f3535VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US, 1000000, 10000000, 100000000, C0740C.NANOS_PER_SECOND, RealConnection.IDLE_CONNECTION_HEALTHY_NS, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C40791.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C40791 c40791) {
            this();
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        int[] iArr = C40791.$SwitchMap$java$math$RoundingMode;
