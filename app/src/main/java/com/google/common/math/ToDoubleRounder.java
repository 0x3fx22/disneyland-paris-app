...
abstract class ToDoubleRounder {
    ...
    final double roundToDouble(Number number, RoundingMode roundingMode) {
        ...
        if (Double.isInfinite(dRoundToDoubleArbitrarily)) {
            switch (C40831.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
                    return ((double) sign(number)) * Double.MAX_VALUE;
                case 5:
        ...
        int[] iArr = C40831.$SwitchMap$java$math$RoundingMode;
