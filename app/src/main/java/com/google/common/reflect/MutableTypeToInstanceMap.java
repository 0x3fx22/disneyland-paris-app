...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    public <T extends B> T getInstance(Class<T> cls) {
        return (T) trustedGet(TypeToken.m1670of((Class) cls));
    }
    ...
    public <T extends B> T putInstance(Class<T> cls, T t) {
        return (T) trustedPut(TypeToken.m1670of((Class) cls), t);
    }
    ...
    static final class UnmodifiableEntry extends ForwardingMapEntry {
        ...
        public static /* synthetic */ UnmodifiableEntry m4621$r8$lambda$PXRRP_NYxQ7IKAyO13H8YX2pq0(Map.Entry entry) {
        ...
        public static Iterator transformEntries(Iterator it) {
            return Iterators.transform(it, new Function() { // from class: com.google.common.reflect.MutableTypeToInstanceMap$UnmodifiableEntry$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    return MutableTypeToInstanceMap.UnmodifiableEntry.m4621$r8$lambda$PXRRP_NYxQ7IKAyO13H8YX2pq0((Map.Entry) obj);
                }
            });
        }
