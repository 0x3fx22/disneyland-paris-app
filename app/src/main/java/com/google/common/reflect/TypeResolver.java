...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f3567id;
        ...
        TypeVariable captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f3567id.incrementAndGet() + "-of ? extends " + Joiner.m1488on(Typography.amp).join(typeArr), typeArr);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable typeVariable) {
            return new WildcardCapturer(this, this.f3567id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f3567id);
        }
