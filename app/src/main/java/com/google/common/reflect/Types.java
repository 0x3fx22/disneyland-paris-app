...
abstract class Types {
    private static final Joiner COMMA_JOINER = Joiner.m1489on(", ").useForNull("null");
    ...
    private enum ClassOwnership {
        ...
        private static ClassOwnership detectJvmBehavior() {
            ...
            ParameterizedType parameterizedType = (ParameterizedType) C41063.class.getGenericSuperclass();
    ...
    static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder(CallerData.f188NA);
