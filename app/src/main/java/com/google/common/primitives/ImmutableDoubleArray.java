...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static ImmutableDoubleArray m1643of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1644of(double d) {
        return new ImmutableDoubleArray(new double[]{d});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1645of(double d, double d2) {
        return new ImmutableDoubleArray(new double[]{d, d2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1646of(double d, double d2, double d3) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1647of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1648of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1649of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m1650of(double d, double... dArr) {
