...
public final class ImmutableIntArray implements Serializable {
    ...
    public static ImmutableIntArray m1651of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1652of(int i) {
        return new ImmutableIntArray(new int[]{i});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1653of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1654of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1655of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1656of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1657of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m1658of(int i, int... iArr) {
