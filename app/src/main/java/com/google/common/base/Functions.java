...
public final class Functions {
    ...
    private static class FunctionComposition implements Function, Serializable {
        ...
        private final Function f3536f;

        /* JADX INFO: renamed from: g */
        private final Function f3537g;

        public FunctionComposition(Function function, Function function2) {
            this.f3537g = (Function) Preconditions.checkNotNull(function);
            this.f3536f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        public Object apply(Object obj) {
            return this.f3537g.apply(this.f3536f.apply(obj));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return this.f3536f.equals(functionComposition.f3536f) && this.f3537g.equals(functionComposition.f3537g);
        }

        public int hashCode() {
            return this.f3537g.hashCode() ^ this.f3536f.hashCode();
        }

        public String toString() {
            return this.f3537g + "(" + this.f3536f + ")";
        }
    }
