...
public final class Predicates {
    ...
    public static <T> Predicate<T> m1493or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m1494or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m1492or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    public static <T> Predicate<T> m1491in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate implements Predicate, Serializable {
        ...
        final Function f3538f;

        /* JADX INFO: renamed from: p */
        final Predicate f3539p;

        private CompositionPredicate(Predicate predicate, Function function) {
            this.f3539p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f3538f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(Object obj) {
            return this.f3539p.apply(this.f3538f.apply(obj));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return this.f3538f.equals(compositionPredicate.f3538f) && this.f3539p.equals(compositionPredicate.f3539p);
        }

        public int hashCode() {
            return this.f3539p.hashCode() ^ this.f3538f.hashCode();
        }

        public String toString() {
            return this.f3539p + "(" + this.f3538f + ")";
        }
    }
