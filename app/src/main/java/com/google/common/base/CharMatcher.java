...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher m1486is(char c) {
        return new C3751Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m1486is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    public CharMatcher mo1487or(CharMatcher charMatcher) {
        return new C3752Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m1486is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C3752Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C3752Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C3751Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo1487or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo1487or(charMatcher);
        }
    ...
    private static final class IsNot extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher.FastMatcher, com.google.common.base.CharMatcher
        public CharMatcher negate() {
            return CharMatcher.m1486is(this.match);
        }
