...
final class UndirectedGraphConnections implements GraphConnections {
    ...
    static UndirectedGraphConnections m1633of(ElementOrder elementOrder) {
        int i = C40361.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
