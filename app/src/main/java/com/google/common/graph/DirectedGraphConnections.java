...
final class DirectedGraphConnections implements GraphConnections {
    ...
    static DirectedGraphConnections m1626of(ElementOrder elementOrder) {
        ArrayList arrayList;
        int i = C40165.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
