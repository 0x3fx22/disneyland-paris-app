...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C40091 extends AbstractGraph {
        C40091() {
        }
        ...
        class AnonymousClass1 extends AbstractSet {
            ...
            public boolean contains(Object obj) {
                ...
                return C40091.this.isOrderingCompatible(endpointPair) && C40091.this.nodes().contains(endpointPair.nodeU()) && C40091.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV());
            }
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return (Set<E>) edgeInvalidatableSet(Sets.difference(Sets.union(incidentEdges(endpointPairIncidentNodes.nodeU()), incidentEdges(endpointPairIncidentNodes.nodeV())), ImmutableSet.m1564of((Object) e)), e);
    }
    ...
    protected final <T> Set<T> edgeInvalidatableSet(Set<T> set, final E e) {
        return InvalidatableSet.m1632of((Set) set, new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda4
    ...
    protected final <T> Set<T> nodeInvalidatableSet(Set<T> set, final N n) {
        return InvalidatableSet.m1632of((Set) set, new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
    ...
    protected final <T> Set<T> nodePairInvalidatableSet(Set<T> set, final N n, final N n2) {
        return InvalidatableSet.m1632of((Set) set, new Supplier() { // from class: com.google.common.graph.AbstractNetwork$$ExternalSyntheticLambda2
            @Override // com.google.common.base.Supplier
            public final Object get() {
