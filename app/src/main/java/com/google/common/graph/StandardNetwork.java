...
abstract class StandardNetwork extends AbstractNetwork {
    ...
    StandardNetwork(NetworkBuilder networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(((Integer) networkBuilder.expectedNodeCount.mo1484or(10)).intValue()), networkBuilder.edgeOrder.createMap(((Integer) networkBuilder.expectedEdgeCount.mo1484or(20)).intValue()));
    }
    ...
    public EndpointPair incidentNodes(Object obj) {
        ...
        return EndpointPair.m1630of(this, objCheckedReferenceNode, networkConnections.adjacentNode(obj));
    }
