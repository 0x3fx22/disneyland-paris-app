...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder {
    ...
    public NetworkBuilder<N, E> expectedNodeCount(int i) {
        this.expectedNodeCount = Optional.m1490of(Integer.valueOf(Graphs.checkNonNegative(i)));
        return this;
    }

    @CanIgnoreReturnValue
    public NetworkBuilder<N, E> expectedEdgeCount(int i) {
        this.expectedEdgeCount = Optional.m1490of(Integer.valueOf(Graphs.checkNonNegative(i)));
        return this;
    }
