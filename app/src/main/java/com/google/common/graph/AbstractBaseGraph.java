...
abstract class AbstractBaseGraph implements BaseGraph {
    ...
    public Set edges() {
        return new AbstractSet() { // from class: com.google.common.graph.AbstractBaseGraph.1
            ...
            public UnmodifiableIterator iterator() {
                return EndpointPairIterator.m1631of(AbstractBaseGraph.this);
            }
    ...
    public Set incidentEdges(Object obj) {
        ...
        return nodeInvalidatableSet(new C40072(this, this, obj), obj);
    }

    /* JADX INFO: renamed from: com.google.common.graph.AbstractBaseGraph$2 */
    class C40072 extends IncidentEdgeSet {
        C40072(AbstractBaseGraph abstractBaseGraph, BaseGraph baseGraph, Object obj) {
            super(baseGraph, obj);
        }
        ...
        public UnmodifiableIterator iterator() {
            if (this.graph.isDirected()) {
                ...
                }), Iterators.transform(Sets.difference(this.graph.successors(this.node), ImmutableSet.m1564of(this.node)).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda1
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
    ...
    protected final <T> Set<T> nodeInvalidatableSet(Set<T> set, final Object obj) {
        return InvalidatableSet.m1632of((Set) set, new Supplier() { // from class: com.google.common.graph.AbstractBaseGraph$$ExternalSyntheticLambda2
    ...
    protected final <T> Set<T> nodePairInvalidatableSet(Set<T> set, final Object obj, final Object obj2) {
        return InvalidatableSet.m1632of((Set) set, new Supplier() { // from class: com.google.common.graph.AbstractBaseGraph$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
