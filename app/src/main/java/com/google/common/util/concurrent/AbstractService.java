...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() throws Exception {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C41296.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    protected final void notifyFailed(Throwable th) throws Exception {
        ...
        try {
            Service.State state = state();
            int i = C41296.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
