...
import androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractC1405x75145c29;
...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture abstractFuture, Waiter waiter, Waiter waiter2) {
            return AbstractC1405x75145c29.m395m(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture abstractFuture, Listener listener, Listener listener2) {
            return AbstractC1405x75145c29.m395m(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }
        ...
        boolean casValue(AbstractFuture abstractFuture, Object obj, Object obj2) {
            return AbstractC1405x75145c29.m395m(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casWaiters(AbstractFuture abstractFuture, Waiter waiter, Waiter waiter2) {
            return AbstractC0365xc40028dd.m91m(this.waitersUpdater, abstractFuture, waiter, waiter2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture abstractFuture, Listener listener, Listener listener2) {
            return AbstractC0365xc40028dd.m91m(this.listenersUpdater, abstractFuture, listener, listener2);
        }
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casValue(AbstractFuture abstractFuture, Object obj, Object obj2) {
            return AbstractC0365xc40028dd.m91m(this.valueUpdater, abstractFuture, obj, obj2);
        }
    }
