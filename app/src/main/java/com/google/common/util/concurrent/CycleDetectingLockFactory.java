...
public class CycleDetectingLockFactory {
    ...
    static Map createNodes(Class cls) {
        ...
        for (Enum r6 : enumArr) {
            ...
            enumMapNewEnumMap.put(r6, lockGraphNode);
        }
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        static final ImmutableSet EXCLUDED_CLASS_NAMES = ImmutableSet.m1566of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
