...
public abstract class Striped<L> {
    ...
    static class SmallLazyStriped extends PowerOfTwoStriped {
        ...
        public Object getAt(int i) {
            ...
            while (!AbstractC4178xa7a47114.m1672m(this.locks, i, arrayReference, arrayReference2)) {
        ...
        private void drainQueue() {
            while (true) {
                ...
                AbstractC4178xa7a47114.m1672m(this.locks, arrayReference.index, arrayReference, null);
            }
        }
