...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T t, Class<T> cls, long j, TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new C41751(t, j, timeUnit, findInterruptibleMethods(cls)));
    }

    /* JADX INFO: renamed from: com.google.common.util.concurrent.SimpleTimeLimiter$1 */
    class C41751 implements InvocationHandler {
        ...
        C41751(Object obj, long j, TimeUnit timeUnit, Set set) {
            this.val$target = obj;
        ...
        public Object invoke(Object obj, final Method method, final Object[] objArr) {
            ...
            return SimpleTimeLimiter.this.callWithTimeout(new Callable() { // from class: com.google.common.util.concurrent.SimpleTimeLimiter$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return SimpleTimeLimiter.C41751.lambda$invoke$0(method, obj2, objArr);
                }
    ...
    @Override // com.google.common.util.concurrent.TimeLimiter
    public void runWithTimeout(Runnable runnable, long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
    ...
    private static Set findInterruptibleMethods(Class cls) {
