...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m1495on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m1495on('=').trimResults();
    ...
    CacheBuilder toCacheBuilder() {
        ...
        if (strength != null) {
            if (C37791.$SwitchMap$com$google$common$cache$LocalCache$Strength[strength.ordinal()] == 1) {
        ...
        if (strength2 != null) {
            int i = C37791.$SwitchMap$com$google$common$cache$LocalCache$Strength[strength2.ordinal()];
            if (i == 1) {
