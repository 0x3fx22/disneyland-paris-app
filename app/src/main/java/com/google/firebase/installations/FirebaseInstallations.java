...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C41912.f3569xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C41912.f3570xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C41912 {
        ...
        static {
            ...
            try {
                f3570xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3570xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            int[] iArr2 = new int[InstallationResponse.ResponseCode.values().length];
            f3569xc38d2559 = iArr2;
            try {
                iArr2[InstallationResponse.ResponseCode.OK.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3569xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
