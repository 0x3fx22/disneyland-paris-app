...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable iterable, Collection collection) {
        ...
        arrayList.add(Component.m1674of(eventBus, EventBus.class, Subscriber.class, Publisher.class));
        arrayList.add(Component.m1674of(this, ComponentLoader.class, new Class[0]));
    ...
    public <T> Deferred<T> getDeferred(Class<T> cls) {
        ...
        return OptionalProvider.m1675of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
