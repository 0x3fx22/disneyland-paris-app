    ...
    public static void logNotificationReceived(Intent intent) {
        ...
        if (shouldUploadFirelogAnalytics(intent)) {
            ...
            if (transportFactory != null) {
                logToFirelog(Constants.FirelogAnalytics.EventType.MESSAGE_DELIVERED, intent, transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, String.class, Encoding.m1428of("json"), MessagingAnalytics$$Lambda$0.$instance));
            } else {
