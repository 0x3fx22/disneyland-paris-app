...
class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        ((NotificationManager) this.context.getSystemService(TransferService.INTENT_KEY_NOTIFICATION)).notify(displayNotificationInfo.tag, displayNotificationInfo.f3573id, displayNotificationInfo.notificationBuilder.build());
    }
}
