...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public RemoteMessage(@SafeParcelable.Param(m1452id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            bundle.putString(Constants.MessagePayloadKeys.f3574TO, str);
        }
        ...
        @NonNull
        public Builder setTtl(@IntRange(from = 0, m4to = 86400) int i) {
    ...
    public final String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f3574TO);
    }
