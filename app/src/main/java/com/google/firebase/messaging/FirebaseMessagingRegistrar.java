...
public class FirebaseMessagingRegistrar implements ComponentRegistrar {
    ...
    static TransportFactory determineFactory(TransportFactory transportFactory) {
        return (transportFactory == null || !CCTDestination.LEGACY_INSTANCE.getSupportedEncodings().contains(Encoding.m1428of("json"))) ? new DevNullTransportFactory() : transportFactory;
    }
