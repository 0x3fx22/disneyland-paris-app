...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = new ComponentRuntime(UI_EXECUTOR, listDiscover, (Component<?>[]) new Component[]{Component.m1674of(context, Context.class, new Class[0]), Component.m1674of(this, FirebaseApp.class, new Class[0]), Component.m1674of(firebaseOptions, FirebaseOptions.class, new Class[0]), LibraryVersionComponent.create("fire-android", ""), LibraryVersionComponent.create("fire-core", BuildConfig.VERSION_NAME), strDetectVersion != null ? LibraryVersionComponent.create("kotlin", strDetectVersion) : null, DefaultUserAgentPublisher.component(), DefaultHeartBeatInfo.component()});
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(INSTANCE, null, globalBackgroundStateListener)) {
