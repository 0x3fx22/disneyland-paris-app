...
public class VisionImageMetadataParcel extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    @SafeParcelable.Field(m1451id = 1)
    ...
    public VisionImageMetadataParcel(@SafeParcelable.Param(m1452id = 1) int i, @SafeParcelable.Param(m1452id = 2) int i2, @SafeParcelable.Param(m1452id = 3) int i3, @SafeParcelable.Param(m1452id = 4) long j, @SafeParcelable.Param(m1452id = 5) int i4) {
        this.width = i;
        this.height = i2;
        this.zza = i3;
