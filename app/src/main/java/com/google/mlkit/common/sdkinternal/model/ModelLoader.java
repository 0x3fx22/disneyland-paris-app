...
public class ModelLoader {
    ...
    private final synchronized boolean zzb(ModelContentHandler modelContentHandler, List list) {
        ...
        try {
            ...
            zza.m1441d("ModelLoader", "Local model source is loaded successfully");
            return true;
        ...
        if (remoteModelLoader != null) {
            try {
                ...
                if (mappedByteBufferLoad != null) {
                    try {
                        modelContentHandler.constructModel(mappedByteBufferLoad);
                        zza.m1441d("ModelLoader", "Remote model source is loaded successfully");
                        return true;
                    } catch (RuntimeException e) {
                        list.add(19);
                        throw e;
                ...
                zza.m1441d("ModelLoader", "Remote model source can NOT be loaded, try local model.");
                list.add(21);
