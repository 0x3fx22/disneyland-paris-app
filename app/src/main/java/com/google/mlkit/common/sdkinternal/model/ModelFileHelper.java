...
public class ModelFileHelper {
    ...
    private final File zzc(String str, ModelType modelType, boolean z) throws MlKitException {
        ...
        if (!modelDirUnsafe.exists()) {
            zzd.m1441d("ModelFileHelper", "model folder does not exist, creating one: ".concat(String.valueOf(modelDirUnsafe.getAbsolutePath())));
    ...
    public void deleteTempFilesInPrivateFolder(@NonNull String str, @NonNull ModelType modelType) throws MlKitException {
        ...
        zzd.m1443e("ModelFileHelper", "Failed to delete the temp labels file directory: ".concat(String.valueOf(fileZzc != null ? fileZzc.getAbsolutePath() : null)));
    }
        ...
        if (fileArrListFiles != null && (fileArrListFiles.length) != 0) {
            for (File file2 : fileArrListFiles) {
                try {
                    ...
                    zzd.m1441d("ModelFileHelper", "Contains non-integer file name ".concat(String.valueOf(file2.getName())));
                }
            }
        }
        return iMax;
    ...
    public File getTempFileInPrivateFolder(@NonNull String str, @NonNull ModelType modelType, @NonNull String str2) throws MlKitException {
        ...
        if (!fileZzc.exists()) {
            zzd.m1441d("ModelFileHelper", "Temp labels folder does not exist, creating one: ".concat(String.valueOf(fileZzc.getAbsolutePath())));
            if (!fileZzc.mkdirs()) {
    ...
    public boolean modelExistsLocally(@NonNull String str, @NonNull ModelType modelType) throws MlKitException {
        ...
        zzd.m1445i("ModelFileHelper", "Model file path: ".concat(String.valueOf(file2.getAbsolutePath())));
        return file2.exists();
    }
