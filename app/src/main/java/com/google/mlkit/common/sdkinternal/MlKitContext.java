...
public class MlKitContext {
    ...
    public static MlKitContext initialize(@NonNull Context context, @NonNull List<ComponentRegistrar> list) {
        ...
        synchronized (zza) {
            try {
                ...
                ComponentRuntime componentRuntime = new ComponentRuntime(TaskExecutors.MAIN_THREAD, new ArrayList(map.values()), (Component<?>[]) new Component[]{Component.m1674of(contextZzc, Context.class, new Class[0]), Component.m1674of(mlKitContext2, MlKitContext.class, new Class[0])});
    ...
    public static MlKitContext zzb(@NonNull Context context, @NonNull Executor executor) {
        ...
        synchronized (zza) {
            ...
            zzb = mlKitContext2;
            Context contextZzc = zzc(context);
            ComponentRuntime componentRuntimeBuild = ComponentRuntime.builder(executor).addLazyComponentRegistrars(ComponentDiscovery.forContext(contextZzc, MlKitComponentDiscoveryService.class).discoverLazy()).addComponent(Component.m1674of(contextZzc, Context.class, new Class[0])).addComponent(Component.m1674of(mlKitContext2, MlKitContext.class, new Class[0])).build();
