    ...
    public synchronized File moveModelToPrivateFolder(@NonNull ParcelFileDescriptor parcelFileDescriptor, @NonNull String str, @NonNull RemoteModel remoteModel) throws MlKitException {
        ...
        try {
            ...
            try {
                    ...
                    try {
                        ...
                        if (zZza && (modelValidator = this.zze) != null) {
                            ...
                            if (validationResultValidateModel.getErrorCode().equals(ModelValidator.ValidationResult.ErrorCode.TFLITE_VERSION_INCOMPATIBLE)) {
                                ...
                                gmsLogger.m1441d("RemoteModelFileManager", "Model is not compatible. Model hash: ".concat(strValueOf));
                                gmsLogger.m1441d("RemoteModelFileManager", "The current app version is: ".concat(String.valueOf(appVersion)));
                            }
                        }
                        ...
                        if (zZza) {
                            ...
                            zza.m1441d("RemoteModelFileManager", "Hash does not match with expected: ".concat(String.valueOf(str)));
                        ...
                        zza.m1441d("RemoteModelFileManager", "Failed to delete the temp file: ".concat(String.valueOf(file.getAbsolutePath())));
                        throw mlKitException;
                    } catch (Throwable th2) {
                        try {
                            fileOutputStream.close();
                ...
                zza.m1443e("RemoteModelFileManager", "Failed to copy downloaded model file to private folder: ".concat(e.toString()));
                return null;
            }
        } catch (Throwable th5) {
            throw th5;
