...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean z) {
        ...
        valueAnimatorOfObject.setInterpolator(ReversableAnimatedValueInterpolator.m1476of(z, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
    ...
    private Animator getExpandedViewChildrenAlphaAnimator(boolean z) {
        ...
        valueAnimatorOfFloat.setInterpolator(ReversableAnimatedValueInterpolator.m1476of(z, AnimationUtils.LINEAR_INTERPOLATOR));
    ...
    private Animator getEndAnchoredViewsTranslateAnimator(boolean z) {
        ...
        valueAnimatorOfFloat.setDuration(this.duration);
        valueAnimatorOfFloat.setInterpolator(ReversableAnimatedValueInterpolator.m1476of(z, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return valueAnimatorOfFloat;
    }
