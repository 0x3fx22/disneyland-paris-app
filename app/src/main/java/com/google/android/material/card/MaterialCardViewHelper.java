...
class MaterialCardViewHelper {
    ...
    private float getParentCardViewCalculatedCornerPadding() {
        return (this.materialCardView.getPreventCornerOverlap() && this.materialCardView.getUseCompatPadding()) ? (float) ((1.0d - COS_45) * ((double) this.materialCardView.getCardViewRadius())) : BitmapDescriptorFactory.HUE_RED;
    }
