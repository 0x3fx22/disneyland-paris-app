...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f3509x = f;
        pathLineOperation.f3510y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f3509x = f3;
        pathLineOperation2.f3510y = f4;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) Math.hypot(this.operation.f3510y - this.startY, this.operation.f3509x - this.startX), BitmapDescriptorFactory.HUE_RED);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f3510y - this.startY) / (this.operation.f3509x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f3509x - this.startX, this.operation1.f3510y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f3509x - this.operation1.f3509x, this.operation2.f3510y - this.operation1.f3510y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f3509x, this.operation1.f3510y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f3510y - this.startY) / (this.operation1.f3509x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f3510y - this.operation1.f3510y) / (this.operation2.f3509x - this.operation1.f3509x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            path.lineTo(this.f3509x, this.f3510y);
