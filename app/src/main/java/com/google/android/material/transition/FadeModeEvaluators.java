...
abstract class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f3513IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f3513IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f3513IN;
        }
        if (i == 2) {
            return CROSS;
        }
