...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f3 = f * 2.0f;
        boolean z = this.contentBounds.width() - f3 > BitmapDescriptorFactory.HUE_RED;
        boolean z2 = this.contentBounds.height() - f3 > BitmapDescriptorFactory.HUE_RED;
        ...
        if (z) {
            ...
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f2, this.contentBounds.width() - f3, -this.cornerRadius, this.edgeShadowPaint);
        }
        ...
        if (z) {
            canvas.scale(1.0f / f5, 1.0f);
            canvas.drawRect(BitmapDescriptorFactory.HUE_RED, f2, this.contentBounds.width() - f3, (-this.cornerRadius) + this.shadowSize, this.edgeShadowPaint);
        }
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0109: INVOKE (r21v0 'canvas' android.graphics.Canvas), (r15v0 'f5' float), (r6v1 float) VIRTUAL call: android.graphics.Canvas.scale(float, float):void A[MD:(float, float):void (c)] (LINE:274) in method: com.google.android.material.shadow.ShadowDrawableWrapper.drawShadow(android.graphics.Canvas):void, file: classes4.dex
