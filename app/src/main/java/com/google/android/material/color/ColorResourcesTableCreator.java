...
abstract class ColorResourcesTableCreator {
    ...
    private static class StringPoolChunk {
        ...
        StringPoolChunk(boolean z, String... strArr) {
            ...
            for (List list : this.styledSpans) {
                ...
                while (it.hasNext()) {
                    SlidingPaneLayout$$ExternalSyntheticThrowCCEIfNotNull0.m377m(it.next());
                    this.stringIndex.add(Integer.valueOf(length));
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            while (it4.hasNext()) {
                ...
                if (!it5.hasNext()) {
                    ...
                    SlidingPaneLayout$$ExternalSyntheticThrowCCEIfNotNull0.m377m(it5.next());
                    throw null;
                }
            }
        }
    ...
    private static class PackageChunk {
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            this.header.writeTo(byteArrayOutputStream);
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.packageInfo.f3484id));
    ...
    private static class ResEntry {
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.shortToByteArray((short) 8));
            byteArrayOutputStream.write(new byte[]{0, Ascii.f3525FS});
