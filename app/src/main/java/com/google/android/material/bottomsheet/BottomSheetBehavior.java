...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public boolean shouldExpandOnUpwardDrag(long j, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 100.0d) float f) {
        return false;
    }
    ...
    public void setHalfExpandedRatio(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false, m3to = 1.0d, toInclusive = false) float f) {
