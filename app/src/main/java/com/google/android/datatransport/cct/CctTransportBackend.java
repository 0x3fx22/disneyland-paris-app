...
final class CctTransportBackend implements TransportBackend {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m1434e("CctTransportBackend", "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m1428of("proto"))) {
                    builderProtoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m1428of("json"))) {
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m1436w("CctTransportBackend", "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m1431d("CctTransportBackend", "Making request to: %s", httpRequest.url);
        ...
        try {
            try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Logging.m1435i("CctTransportBackend", "Status Code: " + responseCode);
                                ...
                                try {
                                    ...
                                    Logging.m1435i("CctTransportBackend", sb.toString());
                                    ...
                                    try {
                                        ...
                                        Logging.m1435i("CctTransportBackend", sb2.toString());
                ...
                Logging.m1434e("CctTransportBackend", "Couldn't open connection, returning with 500", e7);
                return new HttpResponse(500, null, 0L);
            }
        } catch (EncodingException | IOException e8) {
            Logging.m1434e("CctTransportBackend", "Couldn't encode request, returning with 400", e8);
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (i == 200) {
                return BackendResponse.m1429ok(httpResponse.nextRequestMillis);
            }
            if (i < 500 && i != 404) {
                return BackendResponse.fatalError();
            }
            ...
            Logging.m1434e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m1431d("CctTransportBackend", "Following redirect to: %s", url);
