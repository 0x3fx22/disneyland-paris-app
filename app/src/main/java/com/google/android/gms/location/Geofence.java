...
public interface Geofence {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setCircularRegion(@FloatRange(from = RegionEvent.MIN_LATITUDE, m3to = RegionEvent.MAX_LATITUDE) double d, @FloatRange(from = RegionEvent.MIN_LONGITUDE, m3to = RegionEvent.MAX_LONGITUDE) double d2, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, fromInclusive = false) float f) {
