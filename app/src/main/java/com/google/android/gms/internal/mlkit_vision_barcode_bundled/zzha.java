...
abstract class zzha {
    static /* bridge */ /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzer {
        if (zze(b2) || (((b << Ascii.f3525FS) + (b2 + 112)) >> 30) != 0 || zze(b3) || zze(b4)) {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zzer {
        ...
        cArr[i] = (char) (((b & Ascii.f3534US) << 6) | (b2 & Utf8.REPLACEMENT_BYTE));
    }
    ...
    static /* bridge */ /* synthetic */ void zzb(byte b, byte b2, byte b3, char[] cArr, int i) throws zzer {
        if (!zze(b2)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zze(b3)) {
                        cArr[i] = (char) (((b & Ascii.f3531SI) << 12) | ((b2 & Utf8.REPLACEMENT_BYTE) << 6) | (b3 & Utf8.REPLACEMENT_BYTE));
                        return;
                    }
                } else if (b2 < -96) {
                    b = -19;
