...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    public MethodInvocation(@SafeParcelable.Param(m1452id = 1) int i, @SafeParcelable.Param(m1452id = 2) int i2, @SafeParcelable.Param(m1452id = 3) int i3, @SafeParcelable.Param(m1452id = 4) long j, @SafeParcelable.Param(m1452id = 5) long j2, @Nullable @SafeParcelable.Param(m1452id = 6) String str, @Nullable @SafeParcelable.Param(m1452id = 7) String str2, @SafeParcelable.Param(m1452id = 8) int i4, @SafeParcelable.Param(m1452id = 9) int i5) {
        this.zaa = i;
        this.zab = i2;
        this.zac = i3;
        this.zad = j;
