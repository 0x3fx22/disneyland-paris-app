...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(m1452id = 1) List list, @SafeParcelable.Param(m1452id = 2) long j, @SafeParcelable.Param(m1452id = 3) long j2, @SafeParcelable.Param(m1452id = 4) int i, @Nullable @SafeParcelable.Param(m1452id = 5) Bundle bundle) {
