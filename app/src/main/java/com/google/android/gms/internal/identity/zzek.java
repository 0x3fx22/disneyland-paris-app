...
public final class zzek extends AbstractSafeParcelable implements Geofence {
    ...
    public zzek(@SafeParcelable.Param(m1452id = 1) String str, @SafeParcelable.Param(m1452id = 7) int i, @SafeParcelable.Param(m1452id = 3) short s, @SafeParcelable.Param(m1452id = 4) double d, @SafeParcelable.Param(m1452id = 5) double d2, @SafeParcelable.Param(m1452id = 6) float f, @SafeParcelable.Param(m1452id = 2) long j, @SafeParcelable.Param(m1452id = 8) int i2, @SafeParcelable.Param(m1452id = 9) int i3) {
    ...
    public final String toString() {
        ...
        return String.format(locale, "Geofence[%s id:%s transitions:%d %.6f, %.6f %.0fm, resp=%ds, dwell=%dms, @%d]", str, this.zza.replaceAll("\\p{C}", CallerData.f188NA), Integer.valueOf(this.zzg), Double.valueOf(this.zzd), Double.valueOf(this.zze), Float.valueOf(this.zzf), Integer.valueOf(this.zzh / 1000), Integer.valueOf(this.zzi), Long.valueOf(this.zzb));
    }
