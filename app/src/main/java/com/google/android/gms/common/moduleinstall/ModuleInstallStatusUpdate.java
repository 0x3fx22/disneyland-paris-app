...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(m1452id = 1) int i, @SafeParcelable.Param(m1452id = 2) @InstallState int i2, @Nullable @SafeParcelable.Param(m1452id = 3) Long l, @Nullable @SafeParcelable.Param(m1452id = 4) Long l2, @SafeParcelable.Param(m1452id = 5) int i3) {
        this.zaa = i;
        this.zab = i2;
        this.zac = l;
        this.zad = l2;
