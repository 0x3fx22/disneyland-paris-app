...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    public LocationSettingsResult(@NonNull @SafeParcelable.Param(m1452id = 1) Status status, @Nullable @SafeParcelable.Param(m1452id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
