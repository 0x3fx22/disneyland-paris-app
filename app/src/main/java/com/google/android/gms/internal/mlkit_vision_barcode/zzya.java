...
public final class zzya extends AbstractSafeParcelable {
    ...
    public zzya(@Nullable @SafeParcelable.Param(m1452id = 1) String str, @Nullable @SafeParcelable.Param(m1452id = 2) String str2, @SafeParcelable.Param(m1452id = 3) int i) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = i;
    }
