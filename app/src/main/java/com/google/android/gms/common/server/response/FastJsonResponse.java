...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getTypeIn", m1451id = 2)
        protected final int zaa;

        @SafeParcelable.Field(getter = "isTypeInArray", m1451id = 3)
        protected final boolean zab;

        @SafeParcelable.Field(getter = "getTypeOut", m1451id = 4)
        protected final int zac;

        @SafeParcelable.Field(getter = "isTypeOutArray", m1451id = 5)
        protected final boolean zad;

        @NonNull
        @SafeParcelable.Field(getter = "getOutputFieldName", m1451id = 6)
        protected final String zae;

        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", m1451id = 7)
        ...
        @Nullable
        @SafeParcelable.Field(getter = "getConcreteTypeName", m1451id = 8)
