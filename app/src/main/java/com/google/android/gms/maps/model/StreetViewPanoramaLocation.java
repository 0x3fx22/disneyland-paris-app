...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    public StreetViewPanoramaLocation(@NonNull @SafeParcelable.Param(m1452id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @NonNull @SafeParcelable.Param(m1452id = 3) LatLng latLng, @NonNull @SafeParcelable.Param(m1452id = 4) String str) {
