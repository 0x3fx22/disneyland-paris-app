...
public final class ClientIdentity extends AbstractSafeParcelable {
    ...
    public ClientIdentity(@SafeParcelable.Param(m1452id = 1) int i, @SafeParcelable.Param(m1452id = 3) @NotNull String packageName, @SafeParcelable.Param(m1452id = 4) @Nullable String str, @SafeParcelable.Param(m1452id = 6) @Nullable String str2, @SafeParcelable.Param(m1452id = 8) @Nullable List list, @SafeParcelable.Param(m1452id = 7) @Nullable ClientIdentity clientIdentity) {
