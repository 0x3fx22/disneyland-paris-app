...
final class zzbe implements ObjectEncoderContext {
    ...
    public final ObjectEncoderContext nested(String str) {
        return nested(FieldDescriptor.m1676of(str));
    }
