...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public CameraPosition(@NonNull @SafeParcelable.Param(m1452id = 2) LatLng latLng, @SafeParcelable.Param(m1452id = 3) float f, @SafeParcelable.Param(m1452id = 4) float f2, @SafeParcelable.Param(m1452id = 5) float f3) {
