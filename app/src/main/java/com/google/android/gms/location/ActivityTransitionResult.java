...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m1452id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m1452id = 1) List list, @Nullable @SafeParcelable.Param(m1452id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
