...
public class Logger {
    ...
    public void m1456d(@NonNull String str, @NonNull Object... objArr) {
        if (isLoggable(3)) {
    ...
    public void m1457e(@NonNull String str, @NonNull Throwable th, @NonNull Object... objArr) {
    ...
    public void m1459i(@NonNull String str, @NonNull Object... objArr) {
    ...
    public void m1460v(@NonNull String str, @NonNull Throwable th, @NonNull Object... objArr) {
        if (isLoggable(2)) {
    ...
    public void m1462w(@NonNull String str, @NonNull Object... objArr) {
    ...
    @KeepForSdk
    /* JADX INFO: renamed from: e */
    public void m1458e(@NonNull String str, @NonNull Object... objArr) {
    ...
    @KeepForSdk
    /* JADX INFO: renamed from: v */
    public void m1461v(@NonNull String str, @NonNull Object... objArr) {
        if (isLoggable(2)) {
