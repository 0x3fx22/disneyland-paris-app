...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    public ActivityTransitionRequest(@NonNull @SafeParcelable.Param(m1452id = 1) List list, @Nullable @SafeParcelable.Param(m1452id = 2) String str, @Nullable @SafeParcelable.Param(m1452id = 3) List list2, @Nullable @SafeParcelable.Param(m1452id = 4) String str2) {
