...
public class StreetViewPanoramaCamera extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public StreetViewPanoramaCamera(@SafeParcelable.Param(m1452id = 2) float f, @SafeParcelable.Param(m1452id = 3) float f2, @SafeParcelable.Param(m1452id = 4) float f3) {
        boolean z = false;
