...
public final class zzbr extends AbstractSafeParcelable {
    ...
    public zzbr(@SafeParcelable.Param(m1452id = 1) boolean z, @SafeParcelable.Param(m1452id = 2) byte[] bArr, @SafeParcelable.Param(m1452id = 3) boolean z2, @SafeParcelable.Param(m1452id = 4) float f, @SafeParcelable.Param(m1452id = 5) boolean z3) {
        this.zza = z;
        this.zzb = bArr;
        this.zzc = z2;
        this.zzd = f;
