...
public final class zzk extends AbstractSafeParcelable {
    ...
    public zzk(@SafeParcelable.Param(m1452id = 2) String str, @SafeParcelable.Param(m1452id = 3) String str2, @SafeParcelable.Param(m1452id = 4) String str3, @SafeParcelable.Param(m1452id = 5) String str4, @SafeParcelable.Param(m1452id = 6) String str5, @SafeParcelable.Param(m1452id = 7) zzj zzjVar, @SafeParcelable.Param(m1452id = 8) zzj zzjVar2) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = str4;
