...
public final class zzn extends AbstractSafeParcelable {
    ...
    public zzn(@SafeParcelable.Param(m1452id = 2) int i, @SafeParcelable.Param(m1452id = 3) String str, @SafeParcelable.Param(m1452id = 4) String str2, @SafeParcelable.Param(m1452id = 5) String str3) {
        this.zza = i;
        this.zzb = str;
        this.zzc = str2;
        this.zzd = str3;
