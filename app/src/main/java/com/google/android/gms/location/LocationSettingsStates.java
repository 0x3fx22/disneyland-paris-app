...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    public LocationSettingsStates(@SafeParcelable.Param(m1452id = 1) boolean z, @SafeParcelable.Param(m1452id = 2) boolean z2, @SafeParcelable.Param(m1452id = 3) boolean z3, @SafeParcelable.Param(m1452id = 4) boolean z4, @SafeParcelable.Param(m1452id = 5) boolean z5, @SafeParcelable.Param(m1452id = 6) boolean z6) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = z3;
        this.zzd = z4;
