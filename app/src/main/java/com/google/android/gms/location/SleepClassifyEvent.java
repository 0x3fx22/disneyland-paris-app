...
public class SleepClassifyEvent extends AbstractSafeParcelable {
    ...
    public SleepClassifyEvent(@SafeParcelable.Param(m1452id = 1) int i, @SafeParcelable.Param(m1452id = 2) int i2, @SafeParcelable.Param(m1452id = 3) int i3, @SafeParcelable.Param(m1452id = 4) int i4, @SafeParcelable.Param(m1452id = 5) int i5, @SafeParcelable.Param(m1452id = 6) int i6, @SafeParcelable.Param(m1452id = 7) int i7, @SafeParcelable.Param(m1452id = 8) boolean z, @SafeParcelable.Param(m1452id = 9) int i8) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = i4;
