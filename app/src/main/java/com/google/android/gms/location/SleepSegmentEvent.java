...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    public SleepSegmentEvent(@SafeParcelable.Param(m1452id = 1) long j, @SafeParcelable.Param(m1452id = 2) long j2, @SafeParcelable.Param(m1452id = 3) int i, @SafeParcelable.Param(m1452id = 4) int i2, @SafeParcelable.Param(m1452id = 5) int i3) {
