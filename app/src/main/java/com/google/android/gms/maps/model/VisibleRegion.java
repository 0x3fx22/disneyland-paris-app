...
public final class VisibleRegion extends AbstractSafeParcelable {
    ...
    public VisibleRegion(@NonNull @SafeParcelable.Param(m1452id = 2) LatLng latLng, @NonNull @SafeParcelable.Param(m1452id = 3) LatLng latLng2, @NonNull @SafeParcelable.Param(m1452id = 4) LatLng latLng3, @NonNull @SafeParcelable.Param(m1452id = 5) LatLng latLng4, @NonNull @SafeParcelable.Param(m1452id = 6) LatLngBounds latLngBounds) {
