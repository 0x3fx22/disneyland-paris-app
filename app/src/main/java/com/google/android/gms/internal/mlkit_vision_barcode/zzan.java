...
public final class zzan extends AbstractSafeParcelable {
    ...
    public zzan(@SafeParcelable.Param(m1452id = 2) int i, @SafeParcelable.Param(m1452id = 3) int i2, @SafeParcelable.Param(m1452id = 4) int i3, @SafeParcelable.Param(m1452id = 5) long j, @SafeParcelable.Param(m1452id = 6) int i4) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = j;
