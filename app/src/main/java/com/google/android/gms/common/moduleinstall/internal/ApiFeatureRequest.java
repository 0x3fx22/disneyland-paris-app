...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    public ApiFeatureRequest(@NonNull @SafeParcelable.Param(m1452id = 1) List list, @SafeParcelable.Param(m1452id = 2) boolean z, @Nullable @SafeParcelable.Param(m1452id = 3) String str, @Nullable @SafeParcelable.Param(m1452id = 4) String str2) {
