...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f3580x, point.f3581y)) {
            insert(point.f3580x, point.f3581y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (Item item : set) {
            insert(item.getPoint().f3580x, item.getPoint().f3581y, item);
        }
    }
    ...
    public boolean remove(T t) {
        Point point = t.getPoint();
        if (this.mBounds.contains(point.f3580x, point.f3581y)) {
            return remove(point.f3580x, point.f3581y, t);
        }
        return false;
    }
