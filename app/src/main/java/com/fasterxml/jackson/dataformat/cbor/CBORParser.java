...
import com.fasterxml.jackson.core.p028io.IOContext;
import com.fasterxml.jackson.core.p028io.NumberInput;
...
public class CBORParser extends ParserMinimalBase {
    ...
    private static final long _long(int i, int i2) {
        return (((long) i) << 32) + ((((long) i2) << 32) >>> 32);
    }
    ...
    public JsonToken nextToken() throws IOException {
        ...
        int i2 = (b >> 5) & 7;
        if (i2 == 6) {
            this._tagValue = _decodeTag(b & Ascii.f3534US);
            if (this._inputPtr >= this._inputEnd && !loadMore()) {
                return _handleCBOREOF();
            }
                ...
                if (i4 <= 23) {
                    ...
                    if (i5 == 0) {
                        ...
                        if (i_decode32Bits >= 0) {
                            ...
                            this._numberLong = ((long) i_decode32Bits) & BodyPartID.bodyIdMax;
                ...
                if (i4 <= 23) {
                    ...
                    if (i6 == 0) {
                        ...
                        if (i_decode32Bits2 < 0) {
                            this._numberLong = (-(((long) i_decode32Bits2) & BodyPartID.bodyIdMax)) - 1;
                            this._numTypesValid = 2;
                        } else {
    ...
    public boolean nextFieldName(SerializableString serializableString) throws IOException {
        ...
        if (this._parsingContext.inObject() && this._currToken != JsonToken.FIELD_NAME) {
            ...
            if (i2 + length + 1 < this._inputEnd) {
                ...
                int i3 = i2 + 1;
                byte b = bArr[i2];
                if (((b >> 5) & 7) == 3 && (i = b & Ascii.f3534US) <= 24) {
                    if (i == 23) {
                        i = bArr[i3] & 255;
                        i3 = i2 + 2;
                    }
            ...
            if (b >= 0) {
                ...
                while (true) {
                    ...
                    if (i8 == 0) {
                        ...
                        i2 += 2;
                        i7 = ((b2 & Ascii.f3534US) << 6) | (bArr[i6] & Utf8.REPLACEMENT_BYTE);
                    } else if (i8 == 2) {
                        int i9 = i2 + 2;
                        i2 += 3;
                        i7 = ((bArr[i6] & Utf8.REPLACEMENT_BYTE) << 6) | ((b2 & Ascii.f3531SI) << 12) | (bArr[i9] & Utf8.REPLACEMENT_BYTE);
                    } else if (i8 == 3) {
            ...
            if (i8 == 0 && i2 < length) {
                ...
                if (i8 != 0) {
                    if (i8 == 1) {
                        ...
                        i_decodeChunkedUTF8_3 = (i_nextChunkedByte & 63) | ((b & Ascii.f3534US) << 6);
                    } else if (i8 == 2) {
    ...
    protected byte[] _finishBytes(int i) throws IOException {
        if (i < 0) {
            ...
            while (true) {
                ...
                int i_decodeExplicitLength = _decodeExplicitLength(b & Ascii.f3534US);
                if (i_decodeExplicitLength < 0) {
            ...
            if (iArr[i5] == 0) {
                ...
                while (i2 < i3) {
                    ...
                    if (i9 == 0) {
                        ...
                        i2 += 2;
                        i8 = ((b & Ascii.f3534US) << 6) | (bArr[i7] & Utf8.REPLACEMENT_BYTE);
                    } else if (i9 == 2) {
                        int i10 = i2 + 2;
                        i2 += 3;
                        i8 = ((bArr[i7] & Utf8.REPLACEMENT_BYTE) << 6) | ((b & Ascii.f3531SI) << 12) | (bArr[i10] & Utf8.REPLACEMENT_BYTE);
                    } else if (i9 == 3) {
    ...
    private float _decodeHalfSizeFloat() {
        ...
        if (i2 == 0) {
            float f = (float) (MATH_POW_2_NEG14 * (((double) i3) / MATH_POW_2_10));
            return z ? -f : f;
        }
        if (i2 != 31) {
            float fPow = (float) (Math.pow(2.0d, i2 - 15) * ((((double) i3) / MATH_POW_2_10) + 1.0d));
            return z ? -fPow : fPow;
        }
        if (i3 != 0) {
            return Float.NaN;
