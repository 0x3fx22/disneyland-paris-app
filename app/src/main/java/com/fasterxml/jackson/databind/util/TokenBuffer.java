...
public class TokenBuffer extends JsonGenerator {
    ...
    public void serialize(JsonGenerator jsonGenerator) throws IOException {
        ...
        while (true) {
            ...
            switch (C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenType.ordinal()]) {
                case 1:
    ...
    public TokenBuffer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonParser.getCurrentTokenId() != JsonToken.FIELD_NAME.m1413id()) {
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonParser.getCurrentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
            ...
            case 8:
                ...
                int i2 = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i2 == 3) {
                    writeNumber(jsonParser.getDecimalValue());
                    return;
                } else if (i2 == 4) {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            if (this._mayHaveNativeIds) {
                _checkNativeIds(jsonParser);
            }
    ...
    protected void _copyBufferContents(JsonParser jsonParser) throws IOException {
        ...
        while (true) {
            ...
            int i2 = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonTokenNextToken.ordinal()];
            if (i2 == 1) {
                if (this._mayHaveNativeIds) {
                    _checkNativeIds(jsonParser);
                }
    ...
    private void _copyBufferValue(JsonParser jsonParser, JsonToken jsonToken) throws IOException {
        ...
        switch (C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()]) {
            case 6:
                if (jsonParser.hasTextCharacters()) {
                    writeString(jsonParser.getTextCharacters(), jsonParser.getTextOffset(), jsonParser.getTextLength());
                    return;
    ...
    protected static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            ...
            return jsonLocation == null ? JsonLocation.f3407NA : jsonLocation;
        }
        ...
        public String getText() {
            ...
            int i = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()];
            if (i == 7 || i == 8) {
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            int i = C33811.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[getNumberType().ordinal()];
            if (i != 1) {
                if (i == 2) {
