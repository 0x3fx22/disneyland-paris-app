...
public abstract class TypeSerializer {
    ...
    public abstract JsonTypeInfo.EnumC3332As getTypeInclusion();
    ...
    static /* synthetic */ class C33641 {
        ...
        static {
            int[] iArr = new int[JsonTypeInfo.EnumC3332As.values().length];
            $SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As = iArr;
            try {
                iArr[JsonTypeInfo.EnumC3332As.EXISTING_PROPERTY.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As[JsonTypeInfo.EnumC3332As.EXTERNAL_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As[JsonTypeInfo.EnumC3332As.PROPERTY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As[JsonTypeInfo.EnumC3332As.WRAPPER_ARRAY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As[JsonTypeInfo.EnumC3332As.WRAPPER_OBJECT.ordinal()] = 5;
    ...
    public WritableTypeId typeId(Object obj, JsonToken jsonToken) {
        ...
        int i = C33641.$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As[getTypeInclusion().ordinal()];
        if (i == 1) {
    ...
    public WritableTypeId typeId(Object obj, JsonToken jsonToken, Object obj2) {
        ...
        writableTypeIdTypeId.f3425id = obj2;
