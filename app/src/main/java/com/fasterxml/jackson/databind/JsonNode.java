...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    public final boolean isValueNode() {
        int i = C33351.$SwitchMap$com$fasterxml$jackson$databind$node$JsonNodeType[getNodeType().ordinal()];
    ...
    public final JsonNode mo1414at(JsonPointer jsonPointer) {
        ...
        return jsonNode_at.mo1414at(jsonPointer.tail());
    }

    @Override // com.fasterxml.jackson.core.TreeNode
    /* JADX INFO: renamed from: at */
    public final JsonNode mo1415at(String str) {
        return mo1414at(JsonPointer.compile(str));
    }
