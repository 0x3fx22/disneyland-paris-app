...
public class TreeTraversingParser extends ParserMinimalBase {
    ...
    public String getText() {
        ...
        int i = C33661.$SwitchMap$com$fasterxml$jackson$core$JsonToken[this._currToken.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.fasterxml.jackson.databind.node.TreeTraversingParser$1 */
    static /* synthetic */ class C33661 {
