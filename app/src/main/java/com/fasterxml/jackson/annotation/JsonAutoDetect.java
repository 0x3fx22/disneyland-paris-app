...
public @interface JsonAutoDetect {
    ...
    public enum Visibility {
        ...
        public boolean isVisible(Member member) {
            int i = C33311.f3405x23d16a11[ordinal()];
            if (i == 1) {
                return true;
            }
            if (i == 3) {
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C33311.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    static /* synthetic */ class C33311 {
        ...
        static final /* synthetic */ int[] f3405x23d16a11;
        ...
        static {
            ...
            f3405x23d16a11 = iArr2;
            try {
                iArr2[Visibility.ANY.ordinal()] = 1;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3405x23d16a11[Visibility.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f3405x23d16a11[Visibility.NON_PRIVATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f3405x23d16a11[Visibility.PROTECTED_AND_PUBLIC.ordinal()] = 4;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f3405x23d16a11[Visibility.PUBLIC_ONLY.ordinal()] = 5;
