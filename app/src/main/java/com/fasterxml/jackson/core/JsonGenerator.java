...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        Object obj = writableTypeId.f3425id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C33341.f3406xa51b40dc[inclusion.ordinal()];
            if (i != 1 && i != 2) {
                if (i == 3) {
    ...
    static /* synthetic */ class C33341 {
        ...
        static {
            ...
            try {
                f3406xa51b40dc[WritableTypeId.Inclusion.PAYLOAD_PROPERTY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3406xa51b40dc[WritableTypeId.Inclusion.METADATA_PROPERTY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3406xa51b40dc[WritableTypeId.Inclusion.WRAPPER_OBJECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3406xa51b40dc[WritableTypeId.Inclusion.WRAPPER_ARRAY.ordinal()] = 5;
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C33341.f3406xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f3425id;
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (jsonTokenCurrentToken == null ? -1 : jsonTokenCurrentToken.m1413id()) {
            case -1:
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        JsonToken jsonTokenCurrentToken = jsonParser.currentToken();
        int iM1413id = jsonTokenCurrentToken == null ? -1 : jsonTokenCurrentToken.m1413id();
        if (iM1413id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            JsonToken jsonTokenNextToken = jsonParser.nextToken();
            iM1413id = jsonTokenNextToken != null ? jsonTokenNextToken.m1413id() : -1;
        }
        if (iM1413id == 1) {
            writeStartObject();
    ...
    protected void _copyCurrentContents(JsonParser jsonParser) throws IOException {
        ...
        while (true) {
            ...
            switch (jsonTokenNextToken.m1413id()) {
                case 1:
                    writeStartObject();
                    break;
                case 2:
