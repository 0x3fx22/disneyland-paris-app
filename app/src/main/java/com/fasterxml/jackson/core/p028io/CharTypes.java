package com.fasterxml.jackson.core.p028io;
...
public final class CharTypes {
    ...
    private static final byte[] f3408HB;

    /* JADX INFO: renamed from: HC */
    private static final char[] f3409HC;
    ...
    static {
        ...
        f3408HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f3408HB[i2] = (byte) f3409HC[i2];
        }
        ...
        for (int i4 = 128; i4 < 256; i4++) {
            if ((i4 & 224) == 192) {
                i = 2;
            } else if ((i4 & PsExtractor.VIDEO_STREAM_MASK) == 224) {
                i = 3;
            } else {
                i = (i4 & 248) == 240 ? 4 : -1;
            }
    ...
    public static char[] copyHexChars() {
        return (char[]) f3409HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f3408HB.clone();
    }
