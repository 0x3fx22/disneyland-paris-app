...
public final class JsonStringEncoder {
    ...
    private static final char[] f3411HC = CharTypes.copyHexChars();

    /* JADX INFO: renamed from: HB */
    private static final byte[] f3410HB = CharTypes.copyHexBytes();
    ...
    public char[] quoteAsString(String str) {
        int i_appendNamed;
        char[] cArrFinishCurrentSegment = new char[SyslogConstants.LOG_CLOCK];
