...
public final class NameN extends Name {
    ...
    private final int[] f3420q;

    /* JADX INFO: renamed from: q1 */
    private final int f3421q1;

    /* JADX INFO: renamed from: q2 */
    private final int f3422q2;

    /* JADX INFO: renamed from: q3 */
    private final int f3423q3;

    /* JADX INFO: renamed from: q4 */
    private final int f3424q4;
    ...
    public boolean equals(int[] iArr, int i) {
        if (i != this.qlen || iArr[0] != this.f3421q1 || iArr[1] != this.f3422q2 || iArr[2] != this.f3423q3 || iArr[3] != this.f3424q4) {
            return false;
        }
        switch (i) {
            case 4:
                return true;
            case 5:
                if (iArr[4] != this.f3420q[0]) {
                    return false;
                }
                return true;
            case 6:
                if (iArr[5] != this.f3420q[1]) {
                    return false;
                }
                if (iArr[4] != this.f3420q[0]) {
                    return false;
