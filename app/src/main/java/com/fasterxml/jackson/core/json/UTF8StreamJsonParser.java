...
import com.fasterxml.jackson.core.p028io.CharTypes;
...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    protected final String _getText2(JsonToken jsonToken) {
        ...
        int iM1413id = jsonToken.m1413id();
        if (iM1413id == 5) {
            return this._parsingContext.getCurrentName();
        }
        if (iM1413id == 6 || iM1413id == 7 || iM1413id == 8) {
            return this._textBuffer.contentsAsString();
        }
        ...
        while (i14 < i12) {
            ...
            if (i17 > 127) {
                if ((i16 & 224) == 192) {
                    ...
                    if ((i16 & PsExtractor.VIDEO_STREAM_MASK) == 224) {
                        i4 = i16 & 15;
                        i5 = 2;
                    } else if ((i16 & 248) == 240) {
                        i4 = i16 & 7;
                    ...
                    if (i5 > i8) {
                        ...
                        cArrEmptyAndGetCurrentSegment[i15] = (char) ((i19 >> 10) + 55296);
                        i17 = (i19 & AnalyticsListener.EVENT_DRM_KEYS_LOADED) | 56320;
                        i15++;
                    }
                }
                i5 = 1;
                ...
                if (i5 > i8) {
                    ...
                    cArrEmptyAndGetCurrentSegment[i15] = (char) ((i110 >> 10) + 55296);
                    i17 = (i110 & AnalyticsListener.EVENT_DRM_KEYS_LOADED) | 56320;
                    i15++;
                }
            }
            i14 = i18;
