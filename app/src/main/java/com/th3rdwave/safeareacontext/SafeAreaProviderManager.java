...
public final class SafeAreaProviderManager extends ViewGroupManager<SafeAreaProvider> implements RNCSafeAreaProviderManagerInterface<SafeAreaProvider> {
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m1842to(InsetsChangeEvent.EVENT_NAME, MapsKt.mutableMapOf(TuplesKt.m1842to("registrationName", "onInsetsChange"))));
    }
    ...
    /* synthetic */ class C46341 extends FunctionReferenceImpl implements Function3<SafeAreaProvider, EdgeInsets, Rect, Unit> {
        public static final C46341 INSTANCE = new C46341();
    ...
    public void addEventEmitters(@NotNull ThemedReactContext reactContext, @NotNull SafeAreaProvider view) {
        ...
        view.setOnInsetsChangeHandler(C46341.INSTANCE);
    }
}
