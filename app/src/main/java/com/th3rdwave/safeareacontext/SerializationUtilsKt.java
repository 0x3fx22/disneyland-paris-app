...
@Metadata(m1835d1 = {"\u0000&\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u000e\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u001a\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u00052\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u000e\u0010\b\u001a\u00020\u00012\u0006\u0010\t\u001a\u00020\n\u001a\u001a\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u00052\u0006\u0010\t\u001a\u00020\n¨\u0006\f"}, m1836d2 = {"edgeInsetsToJsMap", "Lcom/facebook/react/bridge/WritableMap;", "insets", "Lcom/th3rdwave/safeareacontext/EdgeInsets;", "edgeInsetsToJavaMap", "", "", "", "rectToJsMap", "rect", "Lcom/th3rdwave/safeareacontext/Rect;", "rectToJavaMap", "react-native-safe-area-context_release"}, m1837k = 2, m1838mv = {2, 0, 0}, m1840xi = 48)
public final class SerializationUtilsKt {
    ...
    public static final Map<String, Float> edgeInsetsToJavaMap(@NotNull EdgeInsets insets) {
        Intrinsics.checkNotNullParameter(insets, "insets");
        return MapsKt.mapOf(TuplesKt.m1842to(ViewProps.TOP, Float.valueOf(PixelUtil.toDIPFromPixel(insets.getTop()))), TuplesKt.m1842to(ViewProps.RIGHT, Float.valueOf(PixelUtil.toDIPFromPixel(insets.getRight()))), TuplesKt.m1842to(ViewProps.BOTTOM, Float.valueOf(PixelUtil.toDIPFromPixel(insets.getBottom()))), TuplesKt.m1842to(ViewProps.LEFT, Float.valueOf(PixelUtil.toDIPFromPixel(insets.getLeft()))));
    }
    ...
    public static final Map<String, Float> rectToJavaMap(@NotNull Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "rect");
        return MapsKt.mapOf(TuplesKt.m1842to("x", Float.valueOf(PixelUtil.toDIPFromPixel(rect.getX()))), TuplesKt.m1842to("y", Float.valueOf(PixelUtil.toDIPFromPixel(rect.getY()))), TuplesKt.m1842to("width", Float.valueOf(PixelUtil.toDIPFromPixel(rect.getWidth()))), TuplesKt.m1842to("height", Float.valueOf(PixelUtil.toDIPFromPixel(rect.getHeight()))));
    }
}
