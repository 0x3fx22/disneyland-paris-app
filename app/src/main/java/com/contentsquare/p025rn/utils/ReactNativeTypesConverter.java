...
public class ReactNativeTypesConverter {
    public static List<String> readableArrayToStringList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            int i2 = C29751.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()];
            if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: com.contentsquare.rn.utils.ReactNativeTypesConverter$1 */
    ...
    public static Map<String, Object> readableMapToMap(ReadableMap readableMap, List<String> list, List<String> list2) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C29751.$SwitchMap$com$facebook$react$bridge$ReadableType[type.ordinal()]) {
                case 1:
    ...
    public static List<Object> readableArrayToList(ReadableArray readableArray, List<String> list, List<String> list2) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C29751.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(readableArray.getString(i));
                    break;
                case 2:
