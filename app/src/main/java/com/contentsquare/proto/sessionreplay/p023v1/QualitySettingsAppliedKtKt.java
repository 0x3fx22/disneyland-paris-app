...
public final class QualitySettingsAppliedKtKt {
    ...
    @NotNull
    /* JADX INFO: renamed from: -initializequalitySettingsApplied, reason: not valid java name */
    public static final SessionRecordingV1.QualitySettingsApplied m3539initializequalitySettingsApplied(Function1<? super QualitySettingsAppliedKt.Dsl, Unit> block) {
