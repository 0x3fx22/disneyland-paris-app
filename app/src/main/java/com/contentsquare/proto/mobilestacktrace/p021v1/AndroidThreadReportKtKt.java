...
public final class AndroidThreadReportKtKt {
    ...
    @NotNull
    /* JADX INFO: renamed from: -initializeandroidThreadReport, reason: not valid java name */
    public static final MobileStacktrace.AndroidThreadReport m2984initializeandroidThreadReport(Function1<? super AndroidThreadReportKt.Dsl, Unit> block) {
