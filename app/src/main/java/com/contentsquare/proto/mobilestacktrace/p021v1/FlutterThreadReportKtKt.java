...
public final class FlutterThreadReportKtKt {
    ...
    @NotNull
    /* JADX INFO: renamed from: -initializeflutterThreadReport, reason: not valid java name */
    public static final MobileStacktrace.FlutterThreadReport m2993initializeflutterThreadReport(Function1<? super FlutterThreadReportKt.Dsl, Unit> block) {
