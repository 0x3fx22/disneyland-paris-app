...
public final class BuildInformation {
    ...
    private final PackageInfo readPackageInfo(Application application) {
        try {
            ...
            this.logger.m830e(e, "Failed to getPackageInfo from the application");
            return null;
        }
    }
