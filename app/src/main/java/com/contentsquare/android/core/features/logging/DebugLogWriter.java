...
public final class DebugLogWriter {
    ...
    /* JADX INFO: renamed from: com.contentsquare.android.core.features.logging.DebugLogWriter$add$1 */
    @Metadata(m1835d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m1836d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m1837k = 3, m1838mv = {1, 8, 0}, m1840xi = 48)
    @DebugMetadata(m1844c = "com.contentsquare.android.core.features.logging.DebugLogWriter$add$1", m1845f = "DebugLogWriter.kt", m1846i = {}, m1847l = {}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
    public static final class C23871 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<String> $immutableLogs;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C23871(List<String> list, Continuation<? super C23871> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return DebugLogWriter.this.new C23871(this.$immutableLogs, continuation);
        }
    ...
    public DebugLogWriter(FileStorageUtil fileStorageUtil, SystemInstantiable systemInstantiable, CoroutineScope coroutineScope, int i, int i2, String appFilesDir) {
        ...
        new Logger("DebugLogStorage").m831i("A DebugLogStorage has been created. Debug logs will be stored to disk and can be send to Contentsquare through CS InApp menu.");
    }
    ...
    public final synchronized void add(String level, String tag, String msg, Throwable tr) {
        ...
        try {
            ...
            if (this.logs.size() > this.logBatchSize) {
                ...
                this.logs.clear();
                BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C23871(list2, null), 3, null);
            }
        } catch (Throwable th) {
            throw th;
        }
