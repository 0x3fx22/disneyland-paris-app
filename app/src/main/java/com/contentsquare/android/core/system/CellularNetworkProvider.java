...
public final class CellularNetworkProvider {
    ...
    /* JADX INFO: renamed from: callbackStartingApi31$delegate, reason: from kotlin metadata */
    @NotNull
    ...
    @Metadata(m1835d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m1836d2 = {"Lcom/contentsquare/android/core/system/CellularNetworkProvider$CellularNetworkChanged;", "", "onCellularNetworkChanged", "", "connectionType", "Lcom/contentsquare/android/core/system/ConnectionType;", "core_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
    ...
    public CellularNetworkProvider(Context context, CellularNetworkHelper cellularHelper, BuildInstantiable buildInstantiable) {
        ...
        this.callbackStartingApi31 = LazyKt.lazy(new Function0<CellularNetworkProvider$callbackStartingApi31$2.C23881>() { // from class: com.contentsquare.android.core.system.CellularNetworkProvider$callbackStartingApi31$2

            /* JADX INFO: renamed from: com.contentsquare.android.core.system.CellularNetworkProvider$callbackStartingApi31$2$1 */
            @RequiresApi(31)
            @Metadata(m1835d1 = {"\u0000\u001b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\u000b\u0018\u00002\u00020\u00012\u00020\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, m1836d2 = {"com/contentsquare/android/core/system/CellularNetworkProvider$callbackStartingApi31$2$1", "Landroid/telephony/TelephonyCallback;", "Landroid/telephony/TelephonyCallback$DisplayInfoListener;", "onDisplayInfoChanged", "", "telephonyDisplayInfo", "Landroid/telephony/TelephonyDisplayInfo;", "core_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
            public static final class C23881 extends TelephonyCallback implements TelephonyCallback.DisplayInfoListener {
                final /* synthetic */ CellularNetworkProvider this$0;

                public C23881(CellularNetworkProvider cellularNetworkProvider) {
            ...
            @NotNull
            public final C23881 invoke() {
                return new C23881(this.this$0);
            }
        });
        ...
        if (cellularHelper.isCellularPermissionsGranted()) {
            try {
                ...
                this.logger.m830e(e, "We couldn't register on TelephonyManager on SDK " + Build.VERSION.SDK_INT);
            }
        }
    }
    ...
    private final CellularNetworkProvider$callbackStartingApi31$2.C23881 getCallbackStartingApi31() {
        return (CellularNetworkProvider$callbackStartingApi31$2.C23881) this.callbackStartingApi31.getValue();
    }
    ...
    public final ConnectionType determineCellularConnectionType(Network network) {
        ...
        if (!this.cellularHelper.isCellularPermissionsGranted()) {
            this.logger.m834w("Required permissions not granted for determining Cellular Network !");
        ...
        try {
            ...
            this.logger.m830e(e, "Failed to get connection type");
        }
        return this.cellularHelper.determineCellularConnectionType(i);
    }

    /* JADX INFO: renamed from: isListening, reason: from getter */
