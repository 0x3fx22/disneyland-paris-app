...
@Metadata(m1835d1 = {"\u0000\u001c\n\u0002\b\u0002\n\u0002\u0010\u0004\n\u0002\u0010\u0006\n\u0002\b\u0003\n\u0002\u0010\u000f\n\u0002\u0010 \n\u0002\b\u0004\u001a\u001e\u0010\u0000\u001a\u0002H\u0001\"\n\b\u0000\u0010\u0001\u0018\u0001*\u00020\u0002*\u00020\u0003H\u0086\b¢\u0006\u0002\u0010\u0004\u001a)\u0010\u0005\u001a\u00020\u0003\"\u0014\b\u0000\u0010\u0006\u0018\u0001*\u00020\u0002*\b\u0012\u0004\u0012\u0002H\u00060\u0007*\b\u0012\u0004\u0012\u0002H\u00060\bH\u0086\b\u001a6\u0010\t\u001a\u0002H\u0006\"\u0014\b\u0000\u0010\u0006\u0018\u0001*\u00020\u0002*\b\u0012\u0004\u0012\u0002H\u00060\u0007*\b\u0012\u0004\u0012\u0002H\u00060\b2\u0006\u0010\n\u001a\u00020\u0003H\u0086\b¢\u0006\u0002\u0010\u000b¨\u0006\f"}, m1836d2 = {"convert", "R", "", "", "(D)Ljava/lang/Number;", "median", ExifInterface.GPS_DIRECTION_TRUE, "", "", "percentile", ContextChain.TAG_PRODUCT, "(Ljava/util/List;D)Ljava/lang/Number;", "core_release"}, m1837k = 2, m1838mv = {1, 8, 0}, m1840xi = 48)
...
public final class StatisticsKt {
    ...
    public static final /* synthetic */ <T extends Number & Comparable<? super T>> double median(List<? extends T> list) {
        ...
        if (size == 1) {
            ...
            int i2 = size / 2;
            if (i != 1) {
                return (((Number) listSorted.get(i2)).doubleValue() + ((Number) listSorted.get(i2 - 1)).doubleValue()) / ((double) 2);
            }
    ...
    public static final /* synthetic */ <T extends Number & Comparable<? super T>> T percentile(List<? extends T> list, double d) {
        ...
        double d2 = (d * ((double) (size + 1))) / ((double) 100);
        int iFloor = (int) Math.floor(d2);
        double d3 = d2 - ((double) iFloor);
        if (d2 < 1.0d) {
