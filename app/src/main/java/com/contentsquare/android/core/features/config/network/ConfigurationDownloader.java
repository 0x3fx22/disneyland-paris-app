...
public final class ConfigurationDownloader {
    ...
    /* JADX INFO: renamed from: com.contentsquare.android.core.features.config.network.ConfigurationDownloader$execute$1 */
    @Metadata(m1835d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m1836d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m1837k = 3, m1838mv = {1, 8, 0}, m1840xi = 48)
    @DebugMetadata(m1844c = "com.contentsquare.android.core.features.config.network.ConfigurationDownloader$execute$1", m1845f = "ConfigurationDownloader.kt", m1846i = {}, m1847l = {45}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
    public static final class C23861 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: com.contentsquare.android.core.features.config.network.ConfigurationDownloader$execute$1$1, reason: invalid class name */
        @Metadata(m1835d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m1836d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m1837k = 3, m1838mv = {1, 8, 0}, m1840xi = 48)
        @DebugMetadata(m1844c = "com.contentsquare.android.core.features.config.network.ConfigurationDownloader$execute$1$1", m1845f = "ConfigurationDownloader.kt", m1846i = {}, m1847l = {}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
        public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new AnonymousClass1(this.$onDownloadedCallback, continuation);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C23861(String str, String str2, String str3, Function0<Unit> function0, Continuation<? super C23861> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ConfigurationDownloader.this.new C23861(this.$configEndpoint, this.$userId, this.$packageName, this.$onDownloadedCallback, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (strFetchConfig != null) {
                    ...
                    AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$onDownloadedCallback, null);
                    this.label = 1;
        ...
        @Nullable
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C23861) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    private final String handleResponse(HttpResponse response, String endpoint, String packageName) {
        ...
        if (status == 200) {
            ...
            this.logger.m827d("Got remote config: ".concat(stringResponse));
        ...
        if (status != 404) {
            this.logger.m834w("Failed to get the Contentsquare configuration from server: " + response.getStatus() + " HTTP code.");
            return null;
        }
        this.logger.m829e("Got HTTP_NOT_FOUND for endpoint " + endpoint);
        this.logger.m833p("Config for package name '" + packageName + "' could not be retrieved. A Contentsquare project mightnot have been created for you yet. Send your package name to your Contentsquare contact.");
        return null;
    }
    ...
    public final void execute(String userId, String packageName, Function0<Unit> onDownloadedCallback) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C23861(UriBuilder.buildProjectConfigUrl(packageName), userId, packageName, onDownloadedCallback, null), 3, null);
    }
