...
public final class LoggerLevelChooser implements PreferencesStore.PreferencesStoreListener {
    ...
    @Metadata(m1835d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, m1836d2 = {"Lcom/contentsquare/android/core/features/logging/LoggerLevelChooser$LoggerNonStatic;", "", "()V", "setLogLevel", "", "logLevel", "Lcom/contentsquare/android/core/features/logging/LogPrinter$LogLevel;", "core_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
    ...
    private final void resolveLogLevel() {
        LogPrinter.LogLevel logLevel;
        if (this.preferencesStore.getBoolean(PreferencesKey.VERBOSE_LOG, false)) {
            logLevel = LogPrinter.LogLevel.DEBUG;
        } else {
            logLevel = this.preferencesStore.getBoolean(PreferencesKey.CLIENT_MODE_ACTIVATION_STATE, false) ? LogPrinter.LogLevel.CS_IN_APP : LogPrinter.LogLevel.PUBLIC;
        }
