...
public final class NetworkInfoProvider {
    ...
    private final void registerNetworkCallback() {
        ...
        try {
            ...
            this.logger.m830e(e, "We couldn't register a Network Callback, the network information will be less accurate.");
    ...
    public final void setConnectionType(ConnectionType connectionType) {
        if (this.connectionType != connectionType) {
            this.logger.m827d("Network type change from: " + this.connectionType + " to: " + connectionType);
    ...
    public final ConnectionType getConnectionType(Network network, NetworkCapabilities capabilities) {
        ...
        return capabilities.hasTransport(0) ? this.cellularNetworkProvider.determineCellularConnectionType(network) : ConnectionType.OFFLINE;
    }
}
