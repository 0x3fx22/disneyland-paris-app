...
public final class ContentsquareTextPreference extends ConstraintLayout {
    ...
    public final CharSequence getSummaryText() {
        CharSequence text = this.f1192b.getText();
    ...
    public ContentsquareTextPreference(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(context, C2362R.layout.contentsquare_text_preference, this);
        View viewFindViewById = findViewById(C2362R.id.contentsquare_preference_title);
        ...
        View viewFindViewById2 = findViewById(C2362R.id.contentsquare_preference_summary);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2362R.styleable.ContentsquareTextPreference);
        ...
        try {
            textView.setText(typedArrayObtainStyledAttributes.getString(C2362R.styleable.ContentsquareTextPreference_contentsquare_title));
            textView2.setText(typedArrayObtainStyledAttributes.getString(C2362R.styleable.ContentsquareTextPreference_contentsquare_summary));
        } finally {
