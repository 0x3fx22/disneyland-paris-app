...
public final class InstrURLConnectionBase {
    ...
    public final InputStream getErrorStream() {
        ...
        try {
            ...
            this.logger.m828d(e2, "IOException thrown trying to obtain the response code");
        }
