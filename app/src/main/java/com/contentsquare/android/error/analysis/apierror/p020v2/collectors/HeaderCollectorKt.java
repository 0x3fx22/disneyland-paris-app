...
import com.contentsquare.android.error.analysis.apierror.p020v2.AggregatedRules;
    ...
    public static final long sizeInBytes(Map<String, String> map) {
        ...
        if (map != null && (setKeySet = map.keySet()) != null) {
            for (String str : setKeySet) {
                long jUtf8Size2 = jUtf8Size + ((long) SizeUtilsKt.utf8Size(str));
                String str2 = map.get(str);
                jUtf8Size = jUtf8Size2 + ((long) (str2 != null ? SizeUtilsKt.utf8Size(str2) : 0));
            }
        }
        return jUtf8Size;
    }
