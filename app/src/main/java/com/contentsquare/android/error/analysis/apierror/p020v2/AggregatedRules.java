...
public final /* data */ class AggregatedRules {
    ...
    @Metadata(m1835d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010#\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u00020\u00102\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00050\u0012J\u0014\u0010\u0013\u001a\u00020\u00102\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00070\u0012J\u000e\u0010\u0015\u001a\u00020\u00102\u0006\u0010\u0016\u001a\u00020\tJ\u0006\u0010\u0017\u001a\u00020\u0018J\u000e\u0010\u0019\u001a\u00020\u00102\u0006\u0010\u001a\u001a\u00020\u000bJ\u000e\u0010\u001b\u001a\u00020\u00102\u0006\u0010\u001a\u001a\u00020\u000bJ\u000e\u0010\u001c\u001a\u00020\u00102\u0006\u0010\u001a\u001a\u00020\u000bJ\u000e\u0010\u001d\u001a\u00020\u00102\u0006\u0010\u001a\u001a\u00020\u000bR\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00070\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001e"}, m1836d2 = {"Lcom/contentsquare/android/error/analysis/apierror/v2/AggregatedRules$Builder;", "", "()V", "bodyAttributes", "", "Lcom/contentsquare/android/core/features/config/model/JsonConfig$ApiErrorsV2$BodyAttributePath;", "customHeaders", "Lcom/contentsquare/android/core/features/config/model/JsonConfig$ApiErrorsV2$CustomHeader;", "matchingBodyContents", "", "shouldCollectQueryParams", "", "shouldCollectRequestBody", "shouldCollectResponseBody", "shouldCollectStandardHeaders", "addBodyAttributes", "", "attributes", "", "addCustomHeaders", "headers", "addMatchingBodyContent", "matchingBodyContent", "build", "Lcom/contentsquare/android/error/analysis/apierror/v2/AggregatedRules;", "setCollectQueryParams", "collect", "setCollectRequestBody", "setCollectResponseBody", "setCollectStandardHeaders", "error-analysis_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
    ...
    /* JADX WARN: Code duplicated, block: B:36:? A[LOOP:0: B:19:0x0031->B:36:?, LOOP_END, SYNTHETIC] */
    public final boolean anyValuesEncrypted() {
        List<JsonConfig.ApiErrorsV2.BodyAttributePath> list;
        Iterator<T> it;
        List<JsonConfig.ApiErrorsV2.CustomHeader> list2 = this.customHeaders;
        if (list2 == null || !list2.isEmpty()) {
            Iterator<T> it2 = list2.iterator();
            while (it2.hasNext()) {
                if (((JsonConfig.ApiErrorsV2.CustomHeader) it2.next()).getEncrypted()) {
                }
            }
            list = this.bodyAttributes;
            if (list != null || !list.isEmpty()) {
                it = list.iterator();
                while (it.hasNext()) {
                    if (((JsonConfig.ApiErrorsV2.BodyAttributePath) it.next()).getEncrypted()) {
                    }
                }
                if (this.shouldCollectResponseBody && !this.shouldCollectRequestBody && !this.shouldCollectQueryParams) {
                    return false;
                }
            } else if (this.shouldCollectResponseBody) {
            }
        } else {
            list = this.bodyAttributes;
            if (list != null) {
                ...
                if (this.shouldCollectResponseBody) {
                }
            } else {
                it = list.iterator();
                while (it.hasNext()) {
    ...
    public int hashCode() {
        ...
        return this.matchingBodyContents.hashCode() + ((this.customHeaders.hashCode() + ((this.bodyAttributes.hashCode() + ((i3 + (z4 ? 1 : z4)) * 31)) * 31)) * 31);
    }
