    ...
    public LazyBodyHolder(final NetworkEvent event, final ApiErrorTelemetrySender telemetrySender) {
        ...
        this.responseBodyJSON = LazyKt.lazy(new Function0<JSONBody>() { // from class: com.contentsquare.android.error.analysis.apierror.v2.LazyBodyHolder$responseBodyJSON$2
            ...
            public final JSONBody invoke() {
                ...
                if (responseBody.length < 64000) {
                    return new JSONBody(lazyBodyHolder.getResponseBodyString());
                }
                Integer requestBodySize = networkEvent.getRequestBodySize();
                apiErrorTelemetrySender.sendTelemetry(ApiErrorTelemetrySender.RESPONSE_BODY_ATTR_TOO_LARGE, requestBodySize != null ? requestBodySize.intValue() : responseBody.length, 64000L);
                return null;
            }
        });
        this.requestBodyJSON = LazyKt.lazy(new Function0<JSONBody>() { // from class: com.contentsquare.android.error.analysis.apierror.v2.LazyBodyHolder$requestBodyJSON$2
            ...
            public final JSONBody invoke() {
                ...
                NetworkEvent networkEvent = event;
                ApiErrorTelemetrySender apiErrorTelemetrySender = telemetrySender;
                if (requestBody.length < 64000) {
                    byte[] requestBody2 = networkEvent.getRequestBody();
                    return new JSONBody(requestBody2 != null ? new String(requestBody2, Charsets.UTF_8) : null);
                }
                Integer requestBodySize = networkEvent.getRequestBodySize();
                apiErrorTelemetrySender.sendTelemetry(ApiErrorTelemetrySender.REQUEST_BODY_ATTR_TOO_LARGE, requestBodySize != null ? requestBodySize.intValue() : requestBody.length, 64000L);
                return null;
            }
        });
    }
