...
public final class SymmetricCryptor {
        ...
        if (value != null) {
            try {
                try {
                    ...
                    new Logger("NetworkEventCompressor").m829e("Error while gzipping api error details : " + e);
                }
            } finally {
                this.os.reset();
            }
    ...
    @NotNull
    /* JADX INFO: renamed from: getIvSpec$error_analysis_release, reason: from getter */
    public final IvParameterSpec getIvSpec() {
        return this.ivSpec;
    }

    @NotNull
    /* JADX INFO: renamed from: getKeySpec$error_analysis_release, reason: from getter */
