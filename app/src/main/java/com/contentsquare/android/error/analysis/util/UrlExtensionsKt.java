...
import com.contentsquare.android.error.analysis.apierror.p019v1.processors.UrlMasker;
import java.net.URI;
...
@Metadata(m1835d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\u001a$\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u0001*\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u0001H\u0000\u001a\u000e\u0010\u0003\u001a\u0004\u0018\u00010\u0004*\u00020\u0002H\u0000\u001a\u001a\u0010\u0005\u001a\u00020\u0002*\u00020\u00022\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00020\u0007H\u0000\u001a\f\u0010\b\u001a\u00020\u0002*\u00020\u0002H\u0000¨\u0006\t"}, m1836d2 = {"anonymizeValues", "", "", "extractQueryParameters", "", "maskUrl", "patterns", "", "removeUrlParameters", "error-analysis_release"}, m1837k = 2, m1838mv = {1, 8, 0}, m1840xi = 48)
...
public final class UrlExtensionsKt {
    ...
    public static final byte[] extractQueryParameters(String str) {
        ...
        try {
            ...
            new Logger("NetworkEventMetric").m828d(th, "Exception received while parsing query parameters");
            return null;
        }
    }
    ...
    public static final String removeUrlParameters(String str) {
        ...
        try {
            ...
            new Logger(null, 1, null).m828d(th, "Exception received while parsing url");
            return str;
        }
    }
}
