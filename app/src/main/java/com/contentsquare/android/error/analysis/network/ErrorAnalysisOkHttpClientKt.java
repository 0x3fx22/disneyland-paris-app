...
@Metadata(m1835d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\u001a$\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0000¨\u0006\b"}, m1836d2 = {"sendNetworkMetric", "", "Lcom/contentsquare/android/error/analysis/ErrorAnalysis;", "response", "Lokhttp3/Response;", "requestStartTime", "", "responseEndTime", "error-analysis_release"}, m1837k = 2, m1838mv = {1, 8, 0}, m1840xi = 48)
public final class ErrorAnalysisOkHttpClientKt {
    public static final void sendNetworkMetric(ErrorAnalysis errorAnalysis, Response response, long j, long j2) {
        ...
        try {
            ...
            new Logger("ErrorAnalysis").m828d(th, "Exception received while collecting and sending network metric");
        }
    }
}
