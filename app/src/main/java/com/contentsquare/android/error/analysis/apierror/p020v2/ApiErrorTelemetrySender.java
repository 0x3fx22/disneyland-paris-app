package com.contentsquare.android.error.analysis.apierror.p020v2;
...
@Metadata(m1835d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0000\u0018\u0000 \u00132\u00020\u0001:\u0001\u0013B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u0016\u0010\t\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rJ\u001e\u0010\u000e\u001a\u00020\u00062\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\r2\u0006\u0010\u0012\u001a\u00020\rR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, m1836d2 = {"Lcom/contentsquare/android/error/analysis/apierror/v2/ApiErrorTelemetrySender;", "", "errorAnalysisLibraryInterface", "Lcom/contentsquare/android/core/communication/error/ErrorAnalysisLibraryInterface;", "(Lcom/contentsquare/android/core/communication/error/ErrorAnalysisLibraryInterface;)V", "sendCollectionDuration", "", "data", "Lcom/contentsquare/android/error/analysis/apierror/v2/ApiErrorCollectionDuration;", "sendLogMonitor", "event", "Lcom/contentsquare/android/core/communication/error/analysis/NetworkEvent;", "processingTime", "", "sendTelemetry", "name", "", TCEventPropertiesNames.TCP_SIZE, "maxSize", "Companion", "error-analysis_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
public final class ApiErrorTelemetrySender {
    ...
    public final void sendLogMonitor(NetworkEvent event, long processingTime) {
        ...
        Pair pairM1842to = TuplesKt.m1842to(EventProcessorPerformanceManager.LOG_EVENT_ENDPOINT, event.getUrl());
        Pair pairM1842to2 = TuplesKt.m1842to(EventProcessorPerformanceManager.LOG_EVENT_PROCESS_DURATION, Long.valueOf(processingTime));
        byte[] requestBody = event.getRequestBody();
        Pair pairM1842to3 = TuplesKt.m1842to(EventProcessorPerformanceManager.LOG_EVENT_REQUEST_BODY_SIZE, Integer.valueOf(requestBody != null ? requestBody.length : 0));
        byte[] responseBody = event.getResponseBody();
        ErrorAnalysisLibraryInterface.DefaultImpls.storeLogEvent$default(errorAnalysisLibraryInterface, logLevel, "Disabling body attributes collection due to high impact", null, null, null, MapsKt.mapOf(pairM1842to, pairM1842to2, pairM1842to3, TuplesKt.m1842to(EventProcessorPerformanceManager.LOG_EVENT_RESPONSE_BODY_SIZE, Integer.valueOf(responseBody != null ? responseBody.length : 0)), TuplesKt.m1842to(EventProcessorPerformanceManager.LOG_EVENT_DURATION_LEVEL, Integer.valueOf(i))), 28, null);
    }
    ...
    public final void sendTelemetry(String name, long size, long maxSize) {
        ...
        if (RangesKt.doubleRangeContains(RANGE_1, f)) {
            i = 1;
        } else {
            i = RangesKt.doubleRangeContains(RANGE_2, f) ? 2 : 3;
        }
        this.errorAnalysisLibraryInterface.telemetryCollect(name, Integer.valueOf(i));
    }
}
