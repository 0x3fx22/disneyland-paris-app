...
public final class CrashHandlerController {
    ...
    public final void start(Context context) throws PackageManager.NameNotFoundException {
        ...
        this.isStarted = true;
        this.logger.m831i("Crash Reporter is enabled");
    }
    ...
    public final void stop() {
        if (this.isStarted) {
            ...
            this.logger.m831i("Crash Reporter is disabled");
        }
    }
