...
@Metadata(m1835d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m1836d2 = {"com/contentsquare/android/internal/features/srm/SrmJson.Payload.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/contentsquare/android/internal/features/srm/SrmJson$Payload;", "<init>", "()V", "library_release"}, m1837k = 1, m1838mv = {1, 8, 0})
...
public final class SrmJson$Payload$$serializer implements GeneratedSerializer<SrmJson$Payload> {
    ...
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f1323a;
    ...
    static {
        ...
        f1323a = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    @NotNull
    public final KSerializer<?>[] childSerializers() {
        KSerializer<?> kSerializer = SrmJson$Payload.f1319d[2];
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = f1323a;
        CompositeDecoder compositeDecoderBeginStructure = decoder.beginStructure(pluginGeneratedSerialDescriptor);
        KSerializer<Object>[] kSerializerArr = SrmJson$Payload.f1319d;
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        KSerializer<Object>[] kSerializerArr = SrmJson$Payload.f1319d;
        compositeEncoderBeginStructure.encodeIntElement(pluginGeneratedSerialDescriptor, 0, value.f1320a);
        compositeEncoderBeginStructure.encodeIntElement(pluginGeneratedSerialDescriptor, 1, value.f1321b);
        compositeEncoderBeginStructure.encodeSerializableElement(pluginGeneratedSerialDescriptor, 2, kSerializerArr[2], value.f1322c);
