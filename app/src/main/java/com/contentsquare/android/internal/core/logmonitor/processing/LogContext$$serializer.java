...
@Metadata(m1835d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m1836d2 = {"com/contentsquare/android/internal/core/logmonitor/processing/LogContext.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/contentsquare/android/internal/core/logmonitor/processing/LogContext;", "<init>", "()V", "library_release"}, m1837k = 1, m1838mv = {1, 8, 0})
...
public final class LogContext$$serializer implements GeneratedSerializer<LogContext> {
    ...
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f1226a;
    ...
    static {
        ...
        f1226a = pluginGeneratedSerialDescriptor;
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = f1226a;
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        LogContext.C2408a c2408a = LogContext.Companion;
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 0) || !Intrinsics.areEqual(value.f1222a, "")) {
            compositeEncoderBeginStructure.encodeStringElement(pluginGeneratedSerialDescriptor, 0, value.f1222a);
        }
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 1) || value.f1223b != null) {
            compositeEncoderBeginStructure.encodeNullableSerializableElement(pluginGeneratedSerialDescriptor, 1, JsonElementSerializer.INSTANCE, value.f1223b);
        }
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 2) || !Intrinsics.areEqual(value.f1224c, "")) {
            compositeEncoderBeginStructure.encodeStringElement(pluginGeneratedSerialDescriptor, 2, value.f1224c);
        }
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 3) || !Intrinsics.areEqual(value.f1225d, "")) {
            compositeEncoderBeginStructure.encodeStringElement(pluginGeneratedSerialDescriptor, 3, value.f1225d);
        }
