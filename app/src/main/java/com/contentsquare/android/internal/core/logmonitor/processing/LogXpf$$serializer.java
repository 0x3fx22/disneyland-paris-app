...
@Metadata(m1835d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m1836d2 = {"com/contentsquare/android/internal/core/logmonitor/processing/LogXpf.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/contentsquare/android/internal/core/logmonitor/processing/LogXpf;", "<init>", "()V", "library_release"}, m1837k = 1, m1838mv = {1, 8, 0})
...
public final class LogXpf$$serializer implements GeneratedSerializer<LogXpf> {
    ...
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f1253a;
    ...
    static {
        ...
        f1253a = pluginGeneratedSerialDescriptor;
    }
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = f1253a;
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        LogXpf.C2411a c2411a = LogXpf.Companion;
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 0) || value.f1250a != null) {
            compositeEncoderBeginStructure.encodeNullableSerializableElement(pluginGeneratedSerialDescriptor, 0, StringSerializer.INSTANCE, value.f1250a);
        }
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 1) || value.f1251b != null) {
            compositeEncoderBeginStructure.encodeNullableSerializableElement(pluginGeneratedSerialDescriptor, 1, StringSerializer.INSTANCE, value.f1251b);
        }
        if (compositeEncoderBeginStructure.shouldEncodeElementDefault(pluginGeneratedSerialDescriptor, 2) || value.f1252c != null) {
            compositeEncoderBeginStructure.encodeNullableSerializableElement(pluginGeneratedSerialDescriptor, 2, StringSerializer.INSTANCE, value.f1252c);
        }
