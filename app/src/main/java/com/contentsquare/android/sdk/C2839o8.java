...
public final class C2839o8 {
    @NotNull
    /* JADX INFO: renamed from: a */
    public static SessionRecordingV1.View m1190a(@NotNull ViewLight viewLight) {
        ...
        while (it.hasNext()) {
            dsl_create.addChildren(dsl_create.getChildren(), m1190a((ViewLight) it.next()));
        }
