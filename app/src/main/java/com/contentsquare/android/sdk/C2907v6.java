...
import com.contentsquare.proto.sessionreplay.p023v1.RecordingStartKt;
...
/* JADX INFO: renamed from: com.contentsquare.android.sdk.v6 */
...
public final class C2907v6 extends AbstractC2777i6 {

    /* JADX INFO: renamed from: a */
    @NotNull
    public final EnumC2917w6 f3193a;

    /* JADX INFO: renamed from: b */
    public final boolean f3194b;

    public C2907v6(long j, @NotNull EnumC2917w6 reason, boolean z) {
    ...
    public final SessionRecordingV1.Event getBaseEvent() {
        ...
        int iOrdinal = this.f3193a.ordinal();
        if (iOrdinal == 0) {
        ...
        dsl_create.setIsNewSession(this.f3194b);
        dslM1141a.setRecordingStart(dsl_create._build());
