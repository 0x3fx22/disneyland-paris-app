...
/* JADX INFO: renamed from: com.contentsquare.android.sdk.F8 */
...
public final class C2495F8 {
    @NotNull
    /* JADX INFO: renamed from: a */
    public static C2626T0.a m918a(@NotNull C2478E1 eventsBuildersFactory, @NotNull JSONObject dataJsonObject, @NotNull ScreenViewTracker screenViewTracker) {
        Iterator<String> itKeys;
        Intrinsics.checkNotNullParameter(eventsBuildersFactory, "eventsBuildersFactory");
        Intrinsics.checkNotNullParameter(dataJsonObject, "dataJsonObject");
        Intrinsics.checkNotNullParameter(screenViewTracker, "screenViewTracker");
        C2626T0.a aVar = (C2626T0.a) C2478E1.m901a(eventsBuildersFactory, 25);
        ...
        aVar.f2565i = jLongValue;
        aVar.f2142m = Long.valueOf(jLongValue - screenViewTracker.getCurrentScreenTimestamp());
        aVar.f2140k = ExtensionsKt.getStringOrNull(dataJsonObject, "message");
    ...
    public static C2439A2.a m919b(@NotNull C2478E1 eventsBuildersFactory, @NotNull JSONObject dataJsonObject, @NotNull ScreenViewTracker screenViewTracker) {
        Intrinsics.checkNotNullParameter(eventsBuildersFactory, "eventsBuildersFactory");
        Intrinsics.checkNotNullParameter(dataJsonObject, "dataJsonObject");
        Intrinsics.checkNotNullParameter(screenViewTracker, "screenViewTracker");
        C2439A2.a aVar = (C2439A2.a) C2478E1.m901a(eventsBuildersFactory, 26);
        Long longOrNull = ExtensionsKt.getLongOrNull(dataJsonObject, "date");
        long jLongValue = longOrNull != null ? longOrNull.longValue() : System.currentTimeMillis();
        aVar.f2565i = jLongValue;
        aVar.f1386q = Long.valueOf(jLongValue - screenViewTracker.getCurrentScreenTimestamp());
        aVar.f1380k = ExtensionsKt.getStringOrNull(dataJsonObject, "message");
        aVar.f1381l = ExtensionsKt.getStringOrNull(dataJsonObject, "filename");
        aVar.f1382m = ExtensionsKt.getStringOrNull(dataJsonObject, "pageUrl");
        aVar.f1383n = ExtensionsKt.getIntOrNull(dataJsonObject, "lineno");
        aVar.f1384o = ExtensionsKt.getIntOrNull(dataJsonObject, "colno");
        aVar.f1385p = "webview";
        return aVar;
    }
    ...
    @Nullable
    /* JADX INFO: renamed from: a */
    public static NetworkEvent m917a(@NotNull JSONObject json) throws JSONException {
        ...
        networkEventBuilderBuilder.setHttpMethod(ExtensionsKt.getStringOrNull(json, TCEventPropertiesNames.TCE_METHOD));
