...
import com.contentsquare.proto.sessionreplay.p023v1.GestureKt;
...
/* JADX INFO: renamed from: com.contentsquare.android.sdk.Z1 */
...
public final class C2683Z1 extends AbstractC2777i6 {

    /* JADX INFO: renamed from: a */
    @NotNull
    public final C2743f2 f2318a;

    /* JADX INFO: renamed from: b */
    @Nullable
    public ViewLight f2319b;
    ...
    public C2683Z1(long j, @NotNull C2743f2 result) {
        Intrinsics.checkNotNullParameter(result, "result");
        this.f2318a = result;
        this.f2320c = result.f2608i;
        this.f2321d = result.f2609j;
        setTimestamp(j);
    }

    public final boolean equals(@Nullable Object obj) {
        if (!(obj instanceof C2683Z1)) {
            return super.equals(obj);
        }
        String string = toProto().toString();
        Intrinsics.checkNotNullExpressionValue(string, "toProto().toString()");
        String string2 = ((C2683Z1) obj).toProto().toString();
    ...
    public final SessionRecordingV1.Event toProto() {
        SessionRecordingV1.Gesture.Direction direction;
        SessionRecordingV1.Gesture.Direction direction2;
        switch (this.f2318a.f2601b) {
            case 6:
                ...
                ViewLight viewLight = this.f2319b;
                ...
                dsl_create2.setX(this.f2320c);
                dsl_create2.setY(this.f2321d);
                dsl_create.setTap(dsl_create2._build());
                dslM1141a.setGesture(dsl_create._build());
            ...
            case 8:
                EventKt.Dsl dslM1141a2 = C2757g6.m1141a("newBuilder()", EventKt.Dsl.INSTANCE);
                ...
                ViewLight viewLight2 = this.f2319b;
                ...
                dslM1141a2.setGesture(dsl_create3._build());
                return dslM1141a2._build();
            case 9:
                EventKt.Dsl dslM1141a3 = C2757g6.m1141a("newBuilder()", EventKt.Dsl.INSTANCE);
                ...
                ViewLight viewLight3 = this.f2319b;
                ...
                int i = this.f2318a.f2603d;
                if (i == 1) {
                    direction = SessionRecordingV1.Gesture.Direction.DIRECTION_UP;
                } else if (i == 2) {
                    direction = SessionRecordingV1.Gesture.Direction.DIRECTION_DOWN;
                } else if (i != 3) {
                    direction = i != 4 ? SessionRecordingV1.Gesture.Direction.UNRECOGNIZED : SessionRecordingV1.Gesture.Direction.DIRECTION_RIGHT;
                } else {
                    direction = SessionRecordingV1.Gesture.Direction.DIRECTION_LEFT;
                }
                dsl_create5.setDirection(direction);
                dsl_create4.setDrag(dsl_create5._build());
                dslM1141a3.setGesture(dsl_create4._build());
                return dslM1141a3._build();
            case 10:
                EventKt.Dsl dslM1141a4 = C2757g6.m1141a("newBuilder()", EventKt.Dsl.INSTANCE);
                ...
                ViewLight viewLight4 = this.f2319b;
                ...
                int i2 = this.f2318a.f2603d;
                if (i2 == 1) {
                    direction2 = SessionRecordingV1.Gesture.Direction.DIRECTION_UP;
                } else if (i2 == 2) {
                    direction2 = SessionRecordingV1.Gesture.Direction.DIRECTION_DOWN;
                } else if (i2 != 3) {
                    direction2 = i2 != 4 ? SessionRecordingV1.Gesture.Direction.UNRECOGNIZED : SessionRecordingV1.Gesture.Direction.DIRECTION_RIGHT;
                } else {
                    direction2 = SessionRecordingV1.Gesture.Direction.DIRECTION_LEFT;
                }
                dsl_create7.setDirection(direction2);
                dsl_create6.setFlick(dsl_create7._build());
                dslM1141a4.setGesture(dsl_create6._build());
                return dslM1141a4._build();
        }
    }
