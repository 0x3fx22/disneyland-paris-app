...
public final class C2599Q2 {
    /* JADX INFO: renamed from: a */
    public static final void m1011a(@NotNull Logger logger, @NotNull String description, @Nullable Throwable th) {
        Intrinsics.checkNotNullParameter(logger, "<this>");
        Intrinsics.checkNotNullParameter(description, "description");
        logger.m830e(th, description);
