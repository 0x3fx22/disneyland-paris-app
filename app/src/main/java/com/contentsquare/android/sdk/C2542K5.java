...
import com.contentsquare.proto.sessionreplay.p023v1.GraphMetadataKt;
import com.contentsquare.proto.sessionreplay.p023v1.SessionRecordingV1;
import com.contentsquare.proto.sessionreplay.p023v1.ViewKt;
...
public final class C2542K5 {

    /* JADX INFO: renamed from: a */
    @NotNull
    public final PreferencesStore f1787a;

    /* JADX INFO: renamed from: b */
    @NotNull
    public final Logger f1788b;

    /* JADX INFO: renamed from: c */
    @Nullable
    public ViewLight f1789c;

    /* JADX INFO: renamed from: d */
    @Nullable
    public Bitmap f1790d;
    ...
    public C2542K5(Context context, PreferencesStore preferencesStore) {
        Logger logger = new Logger("SessionReplayTreeLogger");
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(preferencesStore, "preferencesStore");
        Intrinsics.checkNotNullParameter(logger, "logger");
        this.f1787a = preferencesStore;
        this.f1788b = logger;
        this.f1792f = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), CommonProperties.FRAMES);
    }

    /* JADX INFO: renamed from: a */
    public static SessionRecordingV1.View m965a(ViewLight viewLight) {
        ...
        while (it.hasNext()) {
            dsl_create.addChildren(dsl_create.getChildren(), m965a((ViewLight) it.next()));
        }
