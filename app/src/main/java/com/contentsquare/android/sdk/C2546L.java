...
import com.contentsquare.proto.sessionreplay.p023v1.AssetHashKt;
import com.contentsquare.proto.sessionreplay.p023v1.AssetHashesKt;
...
public final class C2546L extends AbstractC2777i6 {

    /* JADX INFO: renamed from: a */
    @NotNull
    public final List<WebViewAsset> f1801a;

    public C2546L(@NotNull ArrayList assets) {
    ...
    public final SessionRecordingV1.Event getBaseEvent() {
        ...
        List<WebViewAsset> list = this.f1801a;
        ...
        for (WebViewAsset webViewAsset : list) {
            ...
            dsl_create2.setAssetId(webViewAsset.f1340a);
            String str = webViewAsset.f1344e;
            Intrinsics.checkNotNull(str);
            dsl_create2.setHash(str);
            arrayList.add(dsl_create2._build());
        }
        dsl_create.addAllAssetHashes(assetHashes, arrayList);
        dslM1141a.setAssetHashes(dsl_create._build());
