...
import com.contentsquare.proto.sessionreplay.p023v1.OnlineAssetsKt;
...
public final class C2565M8 extends AbstractC2485E8 {

    /* JADX INFO: renamed from: a */
    @NotNull
    public final List<String> f1875a;

    public C2565M8(@NotNull ArrayList urls) {
        Intrinsics.checkNotNullParameter(urls, "urls");
        this.f1875a = urls;
    }

    public final boolean equals(@Nullable Object obj) {
        return (obj instanceof C2565M8) && Intrinsics.areEqual(this.f1875a, ((C2565M8) obj).f1875a);
    }

    public final int hashCode() {
        return this.f1875a.hashCode() + 31;
    }
    ...
    public final SessionRecordingV1.Event getBaseEvent() {
        ...
        Iterator<T> it = this.f1875a.iterator();
        while (it.hasNext()) {
            dsl_create.addUrls(dsl_create.getUrls(), (String) it.next());
        }
        dslM1141a.setOnlineAssets(dsl_create._build());
