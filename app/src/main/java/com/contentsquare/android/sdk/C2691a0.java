...
public final class C2691a0 {
    ...
    public C2691a0(@NotNull C2560M3 perceptualHash, @NotNull ViewLight viewLight, @NotNull Bitmap viewBitmap) {
        String str;
        String str2;
        ...
        this.f2350a = perceptualHash;
        boolean isMasked = viewLight.getIsMasked();
        this.f2353d = isMasked;
