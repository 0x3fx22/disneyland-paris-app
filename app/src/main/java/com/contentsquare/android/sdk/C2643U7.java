...
public final class C2643U7 extends Lambda implements Function2<View, C2499G2, Unit> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ List<C2499G2> f2181a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2643U7(ArrayList arrayList) {
        super(2);
