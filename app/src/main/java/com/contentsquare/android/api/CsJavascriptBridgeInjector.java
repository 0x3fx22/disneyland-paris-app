...
public final class CsJavascriptBridgeInjector {
    ...
    @NotNull
    private static final Lazy logger = LazyKt.lazy(C2371a.f1203a);

    /* JADX INFO: renamed from: com.contentsquare.android.api.CsJavascriptBridgeInjector$a */
    public static final class C2371a extends Lambda implements Function0<Logger> {

        /* JADX INFO: renamed from: a */
        public static final C2371a f1203a = new C2371a();
    ...
    public static final void ensureBridgeInjected$lambda$0(WebView webView, C2557M0 jsInterface, String jsInterfaceName, String str) {
        ...
        if (!TextUtils.isEmpty(str) && !str.equals("undefined") && !str.equals("null")) {
            INSTANCE.getLogger().m831i("Javascript bridge already injected");
            return;
        }
        CsJavascriptBridgeInjector csJavascriptBridgeInjector = INSTANCE;
        csJavascriptBridgeInjector.getLogger().m831i("Injecting Javascript bridge");
        csJavascriptBridgeInjector.injectJavascriptBridge(webView, jsInterface, jsInterfaceName);
    }

    private final void evaluateMethod(String methodName, JSONArray jsonArgs, C2557M0 jsInterface) throws IllegalAccessException, InvocationTargetException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void handleMessage(WebMessage webMessage, C2557M0 jsInterface) throws IllegalAccessException, InvocationTargetException {
        ...
        try {
            ...
            String methodName = jSONObject.getString(TCEventPropertiesNames.TCE_METHOD);
            ...
            getLogger().m829e(e.getMessage());
        }
    }

    @SuppressLint({"WebViewApiAvailability"})
    private final void initializeBridge(WebView webView, final C2557M0 jsInterface) {
        ...
        webMessagePort.setWebMessageCallback(new WebMessagePort.WebMessageCallback() { // from class: com.contentsquare.android.api.CsJavascriptBridgeInjector.initializeBridge.1
            ...
            public void onMessage(@Nullable WebMessagePort port, @Nullable WebMessage message) throws IllegalAccessException, InvocationTargetException {
    ...
    private final void injectJavascriptBridge(WebView webView, C2557M0 jsInterface, String jsInterfaceName) {
    ...
    private final String serializeJavascriptInterface(C2557M0 jsInterface, String jsInterfaceName) throws IllegalAccessException, InvocationTargetException {
        Object objInvoke;
        StringBuilder sb;
    ...
    public final void ensureBridgeInjected(@NotNull final WebView webView, @NotNull final C2557M0 jsInterface, @NotNull final String jsInterfaceName) {
        Intrinsics.checkNotNullParameter(webView, "webView");
        Intrinsics.checkNotNullParameter(jsInterface, "jsInterface");
        Intrinsics.checkNotNullParameter(jsInterfaceName, "jsInterfaceName");
