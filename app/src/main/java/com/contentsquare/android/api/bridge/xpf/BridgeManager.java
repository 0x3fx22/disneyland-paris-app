...
import com.contentsquare.android.sdk.C2921x0;
...
public final class BridgeManager implements PreferencesStore.PreferencesStoreListener {
    ...
    private final boolean getCurrentApiErrorEnabledState() {
        ArrayList arrayList = C2714c3.f2439b;
        ArrayList arrayList2 = new ArrayList();
        for (Object obj : arrayList) {
            if (obj instanceof ErrorAnalysisInterface) {
                arrayList2.add(obj);
            }
        }
    ...
    private final void handleConfigurationForWebViews() {
        ...
        boolean zM1230a = C2921x0.m1230a(CoreModule.INSTANCE.getInstance(), featureFlag.getName());
        if (C2624S8.f2123f != zM1230a) {
            C2624S8.f2123f = zM1230a;
            Iterator<Map.Entry<WebView, C2557M0>> it = C2624S8.f2124g.entrySet().iterator();
            while (it.hasNext()) {
                it.next().getValue().f1848g.f1799b = zM1230a;
            }
            C2624S8.m1029a();
        }
    }
    ...
    public final void enableSessionReplay(boolean enable) {
        ...
        C2624S8.f2118a.getClass();
        ((Logger) C2624S8.f2119b.getValue()).m827d("enableSessionReplay " + enable);
        for (C2557M0 c2557m0 : C2624S8.f2124g.values()) {
            if (!enable) {
                c2557m0.f1848g.m975d();
            } else if (c2557m0.m984a()) {
                c2557m0.f1848g.m973b();
            }
        }
    }
