...
public final class TelemetryInterface {
    ...
    public final <T> void setXPFBridgeVersion(@NotNull T value) {
        ...
        C2768h7 telemetryManager$library_release = Telemetry.INSTANCE.getTelemetryManager$library_release();
        if (telemetryManager$library_release != null) {
            telemetryManager$library_release.m1147a("xpf_bridge_version", value);
        }
        C2644U8.f2184c = value.toString();
    }
    ...
    public final <T> void setXPFType(@NotNull T value) {
        ...
        C2768h7 telemetryManager$library_release = Telemetry.INSTANCE.getTelemetryManager$library_release();
        if (telemetryManager$library_release != null) {
            telemetryManager$library_release.m1147a("xpf_type", value);
        }
        C2644U8.f2182a = value.toString();
    }
    ...
    public final <T> void setXPFVersion(@NotNull T value) {
        ...
        C2768h7 telemetryManager$library_release = Telemetry.INSTANCE.getTelemetryManager$library_release();
        if (telemetryManager$library_release != null) {
            telemetryManager$library_release.m1147a("xpf_version", value);
        }
        C2644U8.f2183b = value.toString();
    }
