...
@Metadata(m1835d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b \u0018\u0000 \u00072\u00020\u0001:\u0001\u0007B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, m1836d2 = {"Lcom/contentsquare/android/api/model/DynamicVarValidator;", "", "key", "", "(Ljava/lang/String;)V", "getKey", "()Ljava/lang/String;", "Companion", "library_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
public abstract class DynamicVarValidator {
    ...
    public DynamicVarValidator(@NotNull String key) {
        ...
        if (key.length() == 0) {
            logger.m831i("Dynamic Variable key is empty. Dynamic Variable is sent but the key is set to \"cs-empty\"");
            key = DEFAULT_KEY_VALUE;
        } else if (key.length() > 512) {
            logger.m831i("Dynamic Variable key is too long: the current input has a length of " + key.length() + " while the limit is 512. Dynamic Variable is sent but the key truncated");
