...
@Metadata(m1835d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001c\u0010\u0005\u001a\u00020\u00062\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\u00010\bH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, m1836d2 = {"Lcom/contentsquare/android/api/bridge/reactnative/ReactNativeBridge;", "", "()V", "logger", "Lcom/contentsquare/android/core/features/logging/Logger;", "sendError", "", ErrorBundle.DETAIL_ENTRY, "", "", "library_release"}, m1837k = 1, m1838mv = {1, 8, 0}, m1840xi = 48)
public final class ReactNativeBridge {
    ...
    public static final void sendError(@NotNull Map<String, ? extends Object> details) {
        ...
        if (errorAnalysisInterface != null) {
            ...
            logger.m829e("Unable to send React Native error - Error Analysis module is not available");
        }
    }
}
