...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m434of(CmcdData.Factory.OBJECT_TYPE_AUDIO_ONLY, ContextChain.TAG_PRODUCT, CmcdData.Factory.STREAMING_FORMAT_SS, "rz", "r", "o", "so", "eo", "sk", "sa");
    private static final JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m434of("k");
