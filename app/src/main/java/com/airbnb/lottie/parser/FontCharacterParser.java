...
abstract class FontCharacterParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m434of("ch", TCEventPropertiesNames.TCP_SIZE, DeviceInfo.WIDTH, "style", "fFamily", "data");
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m434of("shapes");
