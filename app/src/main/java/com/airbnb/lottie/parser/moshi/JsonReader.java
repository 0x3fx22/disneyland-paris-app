...
public abstract class JsonReader implements Closeable {
    ...
    public static JsonReader m433of(BufferedSource bufferedSource) {
    ...
    public static final class Options {
        ...
        /* JADX INFO: renamed from: of */
        public static Options m434of(String... strArr) {
            try {
                ...
                return new Options((String[]) strArr.clone(), okio.Options.m1934of(byteStringArr));
            } catch (IOException e) {
