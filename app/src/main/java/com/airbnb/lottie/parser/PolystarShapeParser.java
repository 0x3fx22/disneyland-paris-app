...
abstract class PolystarShapeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m434of("nm", "sy", "pt", ContextChain.TAG_PRODUCT, "r", JsonPredicate.OR_PREDICATE_TYPE, "os", "ir", "is", "hd", "d");
