...
abstract class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m434of("nm", "g", "o", "t", CmcdData.Factory.STREAMING_FORMAT_SS, "e", DeviceInfo.WIDTH, "lc", "lj", "ml", "hd", "d");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m434of(ContextChain.TAG_PRODUCT, "k");
