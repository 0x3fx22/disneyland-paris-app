...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m434of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", DeviceInfo.WIDTH, "h", "ip", "op", "tm", "cl", "hd", "ao", "bm");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m434of("d", CmcdData.Factory.OBJECT_TYPE_AUDIO_ONLY);
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m434of("ty", "nm");
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
            ...
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 9:
                    ...
                    if (iNextInt4 >= Layer.MatteType.values().length) {
                        ...
                        int i = C18311.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[matteType2.ordinal()];
                        if (i == 1) {
        ...
        if (fNextDouble > BitmapDescriptorFactory.HUE_RED) {
            arrayList4.add(new Keyframe(lottieComposition, fValueOf, fValueOf, null, BitmapDescriptorFactory.HUE_RED, Float.valueOf(fNextDouble)));
