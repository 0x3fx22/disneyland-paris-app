...
public class ShapeStroke implements ContentModel {
    ...
    public enum LineCapType {
        ...
        public Paint.Cap toPaintCap() {
            int i = C18231.f209xd9891597[ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C18231 {
        ...
        static {
            ...
            try {
                f210x8c4dd79[LineJoinType.MITER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f210x8c4dd79[LineJoinType.ROUND.ordinal()] = 3;
            ...
            try {
                f209xd9891597[LineCapType.ROUND.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f209xd9891597[LineCapType.UNKNOWN.ordinal()] = 3;
    ...
    public enum LineJoinType {
        ...
        public Paint.Join toPaintJoin() {
            int i = C18231.f210x8c4dd79[ordinal()];
            if (i == 1) {
