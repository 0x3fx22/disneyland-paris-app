...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        ...
        int i = C18171.f208x7df623d1[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
    ...
    static /* synthetic */ class C18171 {
        ...
        static final /* synthetic */ int[] f208x7df623d1;
        ...
        static {
            ...
            try {
                f208x7df623d1[MergePaths.MergePathsMode.ADD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f208x7df623d1[MergePaths.MergePathsMode.SUBTRACT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f208x7df623d1[MergePaths.MergePathsMode.INTERSECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f208x7df623d1[MergePaths.MergePathsMode.EXCLUDE_INTERSECTIONS.ordinal()] = 5;
