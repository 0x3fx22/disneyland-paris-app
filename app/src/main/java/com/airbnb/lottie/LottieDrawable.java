...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public AsyncUpdates getAsyncUpdates() {
        ...
        return asyncUpdates != null ? asyncUpdates : C1806L.getDefaultAsyncUpdates();
    }
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(@IntRange(from = 0, m4to = ScatterMapKt.Sentinel) int i) {
        this.alpha = i;
        invalidateSelf();
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (asyncUpdatesEnabled) {
            try {
                ...
                if (C1806L.isTraceEnabled()) {
                    C1806L.endSection("Drawable#draw");
                }
                if (!asyncUpdatesEnabled) {
                    return;
                }
        ...
        if (C1806L.isTraceEnabled()) {
            C1806L.beginSection("Drawable#draw");
        }
    ...
    public void setMaxProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) final float f, @FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) final float f2) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
    ...
    public void setProgress(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) final float f) {
        if (this.composition == null) {
        ...
        if (C1806L.isTraceEnabled()) {
            C1806L.beginSection("Drawable#setProgress");
        }
        this.animator.setFrame(this.composition.getFrameForProgress(f));
        if (C1806L.isTraceEnabled()) {
            C1806L.endSection("Drawable#setProgress");
        }
    }
    ...
    public boolean animationsEnabled(@Nullable Context context) {
        ...
        return this.systemAnimationsEnabled && C1806L.getReducedMotionOption().getCurrentReducedMotionMode(context) == ReducedMotionMode.STANDARD_MOTION;
    }
    ...
    public <T> void addValueCallback(KeyPath keyPath, T t, final SimpleLottieValueCallback<T> simpleLottieValueCallback) {
        addValueCallback(keyPath, t, new LottieValueCallback() { // from class: com.airbnb.lottie.LottieDrawable.1
