...
public class LottieCompositionFactory {
    ...
    private static final byte[] GZIP_MAGIC = {Ascii.f3534US, -117, 8};
    ...
    public static void clearCache(Context context) {
        ...
        NetworkCache networkCache = C1806L.networkCache(context);
    ...
    public static /* synthetic */ LottieResult lambda$fromUrl$0(Context context, String str, String str2) {
        LottieResult<LottieComposition> lottieResultFetchSync = C1806L.networkFetcher(context).fetchSync(context, str, str2);
    ...
    public static LottieResult<LottieComposition> fromAssetSync(Context context, String str, @Nullable String str2) {
        ...
        try {
            ...
            return fromJsonReaderSync(JsonReader.m433of(bufferedSourceBuffer), str2);
        } catch (IOException e) {
    ...
    public static LottieResult<LottieComposition> fromRawResSync(Context context, @RawRes int i, @Nullable String str) {
        ...
        try {
            ...
            return fromJsonReaderSync(JsonReader.m433of(bufferedSourceBuffer), str);
    ...
    public static LottieResult<LottieComposition> fromJsonSourceSync(Source source, @Nullable String str, boolean z) {
        return fromJsonReaderSyncInternal(JsonReader.m433of(Okio.buffer(source)), str, z);
    }
    ...
    private static LottieResult fromZipStreamSyncInternal(Context context, ZipInputStream zipInputStream, String str) {
        ...
        while (nextEntry != null) {
            ...
            if (name.contains("__MACOSX")) {
                ...
                lottieComposition2 = (LottieComposition) fromJsonReaderSyncInternal(JsonReader.m433of(Okio.buffer(Okio.source(zipInputStream))), null, false).getValue();
