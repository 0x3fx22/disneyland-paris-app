...
public class DeviceIdResolver {
    ...
    String getGmsInstanceId() throws IllegalAccessException, InvocationTargetException {
    ...
    String getFirebaseInstanceId() throws IllegalAccessException, InvocationTargetException {
