...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    public boolean isLocationEnabledSync() {
        try {
            return ((LocationManager) getReactApplicationContext().getSystemService(EnableFeatureAction.FEATURE_LOCATION)).isLocationEnabled();
        } catch (Exception unused) {
    ...
    public WritableMap getAvailableLocationProvidersSync() {
        LocationManager locationManager = (LocationManager) getReactApplicationContext().getSystemService(EnableFeatureAction.FEATURE_LOCATION);
        WritableMap writableMapCreateMap = Arguments.createMap();
        try {
