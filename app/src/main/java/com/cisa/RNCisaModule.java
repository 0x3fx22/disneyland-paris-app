...
public class RNCisaModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void fetchPayloads(Boolean bool, String str, String str2, String str3, Promise promise) {
    ...
    @ReactMethod
    public void searchForDevices(ReadableArray readableArray, double d, final Promise promise) {
            ...
            this.deviceSearchUtility.setDeviceSearchListener(new IAlDeviceSearchListener() { // from class: com.cisa.RNCisaModule.3
                ...
                public void onScanStateChange(Boolean bool) {
                    ...
                    try {
                        ...
                        promise.reject(RNCisaModule.E_ALLEGION_SEARCH_FOR_DEVICES, e);
                        this.deviceSearchUtility = null;
                    }
                }
            });
    ...
    @ReactMethod
    public void cancelSearch(Promise promise) {
