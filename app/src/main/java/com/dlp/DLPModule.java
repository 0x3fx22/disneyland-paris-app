...
public class DLPModule extends ReactContextBaseJavaModule {
    ...
    public void isLocationEnabled(Promise promise) {
        promise.resolve(Boolean.valueOf(LocationManagerCompat.isLocationEnabled((LocationManager) getReactApplicationContext().getSystemService(EnableFeatureAction.FEATURE_LOCATION))));
    }
}
