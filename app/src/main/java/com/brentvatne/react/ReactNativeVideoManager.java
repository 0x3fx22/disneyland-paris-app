...
public final class ReactNativeVideoManager implements RNVPlugin {
    ...
    @Metadata(m1835d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0006\u0010\b\u001a\u00020\u0007R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, m1836d2 = {"Lcom/brentvatne/react/ReactNativeVideoManager$Companion;", "", "<init>", "()V", "TAG", "", "instance", "Lcom/brentvatne/react/ReactNativeVideoManager;", "getInstance", "react-native-video_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
    ...
    public final void registerView(@NotNull Object newInstance) {
        ...
        if (this.instanceList.size() > 2) {
            DebugLog.m729d("ReactNativeVideoManager", "multiple Video displayed ?");
        }
    ...
    private final void maybeRegisterExoplayerPlugin(RNVPlugin plugin) {
        ...
        if ((plugin instanceof RNVExoplayerPlugin) && (dRMManager = ((RNVExoplayerPlugin) plugin).getDRMManager()) != null) {
            if (this.customDRMManager != null) {
                DebugLog.m733w("ReactNativeVideoManager", "Multiple DRM managers registered. This is not supported. Using first registered manager.");
            } else {
