...
public final class CMCDConfig {
    ...
    private final int intToCmcdMode(int mode) {
        ...
        DebugLog.m730e("CMCDConfig", "Unsupported mode: " + mode + ", fallback on MODE_REQUEST_HEADER");
        return 0;
    }
