...
public final class ReactExoplayerViewManager extends ViewGroupManager<ReactExoplayerView> {
    ...
    */
    public final void setResizeMode(@NotNull ReactExoplayerView videoView, @NotNull String resizeMode) {
        Intrinsics.checkNotNullParameter(videoView, "videoView");
        ...
        switch (resizeMode.hashCode()) {
            case -1881872635:
                ...
                DebugLog.m733w(TAG, "Unsupported resize mode: " + resizeMode + " - falling back to fit");
