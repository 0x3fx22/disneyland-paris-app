...
import androidx.media3.p008ui.R;
...
public final class VideoPlaybackService extends MediaSessionService {
    ...
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (intExtra < 0) {
                DebugLog.m733w("VideoPlaybackService", "Received Command without playerId");
                return super.onStartCommand(intent, flags, startId);
            }
            if (stringExtra == null) {
                DebugLog.m733w("VideoPlaybackService", "Received Command without action command");
                return super.onStartCommand(intent, flags, startId);
            }
    ...
    public static final class Companion {
        ...
        @Metadata(m1835d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u000b\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\r¨\u0006\u000e"}, m1836d2 = {"Lcom/brentvatne/exoplayer/VideoPlaybackService$Companion$COMMAND;", "", "stringValue", "", "<init>", "(Ljava/lang/String;ILjava/lang/String;)V", "getStringValue", "()Ljava/lang/String;", "NONE", "SEEK_FORWARD", "SEEK_BACKWARD", "TOGGLE_PLAY", "PLAY", "PAUSE", "react-native-video_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
        public enum COMMAND {
            NONE("NONE"),
        ...
        public final void handleCommand(@NotNull COMMAND command, @NotNull MediaSession session) {
            ...
            if (i == 4) {
                ...
                DebugLog.m733w("VideoPlaybackService", "Received COMMAND.NONE - was there an error?");
            }
        }
    }
}
