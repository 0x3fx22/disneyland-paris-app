...
public class ReactSliderManagerImpl {
    ...
    public static Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.m1373of("topChange", MapBuilder.m1373of("registrationName", "topChange"));
    }

    public static Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m1374of(ReactSlidingStartEvent.EVENT_NAME, MapBuilder.m1373of("registrationName", ReactSlidingStartEvent.EVENT_NAME), ReactSlidingCompleteEvent.EVENT_NAME, MapBuilder.m1373of("registrationName", ReactSlidingCompleteEvent.EVENT_NAME));
    }
}
