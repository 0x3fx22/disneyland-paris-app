                    ...
                    for (int i = 0; i < readableArray.size(); i += 999) {
                        ...
                        try {
                            try {
                                ...
                                FLog.m1332w(ReactConstants.TAG, e.getMessage(), e);
                    ...
                    try {
                        try {
                            ...
                            for (int i = 0; i < readableArray.size(); i++) {
                                ...
                                if (readableArray.getArray(i).getString(0) == null) {
                                    ...
                                    try {
                                        ...
                                        FLog.m1332w(ReactConstants.TAG, e2.getMessage(), e2);
                                ...
                                if (readableArray.getArray(i).getString(1) == null) {
                                    ...
                                    try {
                                        ...
                                        FLog.m1332w(ReactConstants.TAG, e3.getMessage(), e3);
                            ...
                            try {
                                ...
                                FLog.m1332w(ReactConstants.TAG, e4.getMessage(), e4);
                                error = AsyncStorageErrorUtil.getError(null, e4.getMessage());
                            }
                        } catch (Exception e5) {
                            FLog.m1332w(ReactConstants.TAG, e5.getMessage(), e5);
                            WritableMap error2 = AsyncStorageErrorUtil.getError(null, e5.getMessage());
                            try {
                                AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                            } catch (Exception e6) {
                                FLog.m1332w(ReactConstants.TAG, e6.getMessage(), e6);
                                if (error2 == null) {
                        ...
                        try {
                            ...
                            FLog.m1332w(ReactConstants.TAG, e7.getMessage(), e7);
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.m1332w(ReactConstants.TAG, e8.getMessage(), e8);
