...
public class ReactViewPagerManager extends ViewGroupManager<ViewPager2> {
    ...
    private void setCurrentItem(final ViewPager2 viewPager2, int i, boolean z) {
        viewPager2.post(new Runnable() { // from class: com.reactnativecommunity.viewpager.ReactViewPagerManager.2
            ...
            public void run() {
                ...
                viewPager3.measure(View.MeasureSpec.makeMeasureSpec(viewPager3.getWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(viewPager2.getHeight(), 1073741824));
                ViewPager2 viewPager4 = viewPager2;
                viewPager4.layout(viewPager4.getLeft(), viewPager2.getTop(), viewPager2.getRight(), viewPager2.getBottom());
            }
        });
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m1375of(PageScrollEvent.EVENT_NAME, MapBuilder.m1373of("registrationName", "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m1373of("registrationName", "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m1373of("registrationName", "onPageSelected"));
    }

    @Override // com.facebook.react.uimanager.ViewManager
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m1375of("setPage", 1, "setPageWithoutAnimation", 2, "setScrollEnabled", 3);
    }

    @Override // com.facebook.react.uimanager.ViewManager
    public void receiveCommand(@NonNull ViewPager2 viewPager2, int i, @Nullable ReadableArray readableArray) {
        super.receiveCommand(viewPager2, i, readableArray);
