...
public class RNCWebViewModuleImpl implements ActivityEventListener {
    ...
    static /* synthetic */ class C45862 {
        ...
        static {
            ...
            try {
                f3678xec4499b[MimeType.VIDEO.ordinal()] = 2;
    ...
    public File getCapturedFile(MimeType mimeType) throws IOException {
        String str;
        String str2;
        int i = C45862.f3678xec4499b[mimeType.ordinal()];
        if (i == 1) {
