    ...
    protected void createRNCWebViewBridge(RNCWebView rNCWebView) {
        if (WebViewFeature.isFeatureSupported("WEB_MESSAGE_LISTENER")) {
            if (this.bridgeListener == null) {
                ...
                WebViewCompat.addWebMessageListener(rNCWebView, JAVASCRIPT_INTERFACE, RNCWebView$$ExternalSyntheticBackport1.m1737m(new Object[]{"*"}), this.bridgeListener);
            }
    ...
    protected class RNCWebViewBridge {
        ...
        public void postMessage(String str) {
            if (this.mWebView.getMessagingEnabled()) {
                ...
                FLog.m1331w(this.TAG, "ReactNativeWebView.postMessage method was called but messaging is disabled. Pass an onMessage handler to the WebView.");
            }
        }
    }
