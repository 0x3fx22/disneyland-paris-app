...
public class RNPermissionsModule extends NativePermissionsModuleSpec implements PermissionListener {
    ...
    public void checkNotifications(Promise promise) {
        ...
        writableMapCreateMap.putString("status", zAreNotificationsEnabled ? PermissionsResponse.GRANTED_KEY : "blocked");
    ...
    public boolean onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        try {
            ...
            FLog.m1294e("PermissionsModule", e2, "Unexpected invocation of `onRequestPermissionsResult` with invalid request code", new Object[0]);
            return false;
        }
    }
