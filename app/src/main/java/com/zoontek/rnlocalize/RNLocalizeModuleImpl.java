...
public final class RNLocalizeModuleImpl {
    ...
    public final String getCountry(@NotNull ReactApplicationContext reactContext) {
        ...
        return countryCodeForLocale.length() == 0 ? AirshipConfigOptions.SITE_US : countryCodeForLocale;
    }
    ...
    public final String getTemperatureUnit(@NotNull ReactApplicationContext reactContext) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            String identifier = RNLocalizeModuleImpl$$ExternalSyntheticApiModelOutline2.m1790m(RNLocalizeModuleImpl$$ExternalSyntheticApiModelOutline2.m1790m(NumberFormatter.with().usage("weather")).unit(MeasureUnit.CELSIUS)).locale(getSystemLocale(reactContext)).format(1L).getOutputUnit().getIdentifier();
