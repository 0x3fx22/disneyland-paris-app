...
public class CustomToolbar extends Toolbar {
    ...
    public WindowInsets onApplyWindowInsets(@Nullable WindowInsets insets) {
        ...
        Insets insetsM101of = Insets.m101of(insetsResolveInsetsOrZero$default.left + insetsResolveInsetsOrZero$default2.left, 0, insetsResolveInsetsOrZero$default.right + insetsResolveInsetsOrZero$default2.right, 0);
        Intrinsics.checkNotNullExpressionValue(insetsM101of, "of(...)");
        Insets insetsM101of2 = Insets.m101of(0, Math.max(insetsResolveInsetsOrZero$default.top, getShouldApplyTopInset() ? insetsResolveInsetsOrZero.top : 0), 0, Math.max(insetsResolveInsetsOrZero$default.bottom, 0));
        Intrinsics.checkNotNullExpressionValue(insetsM101of2, "of(...)");
        Insets insetsAdd = Insets.add(insetsM101of, insetsM101of2);
