...
public final class RNGestureHandlerRootViewManager extends ViewGroupManager<RNGestureHandlerRootView> implements RNGestureHandlerRootViewManagerInterface<RNGestureHandlerRootView> {
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m1842to("onGestureHandlerEvent", MapsKt.mutableMapOf(TuplesKt.m1842to("registrationName", "onGestureHandlerEvent"))), TuplesKt.m1842to(RNGestureHandlerStateChangeEvent.EVENT_NAME, MapsKt.mutableMapOf(TuplesKt.m1842to("registrationName", RNGestureHandlerStateChangeEvent.EVENT_NAME))));
    }
}
