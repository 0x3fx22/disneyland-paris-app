...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1008ix = readShort();
        this.header.currentFrame.f1009iy = readShort();
        this.header.currentFrame.f1007iw = readShort();
        this.header.currentFrame.f1006ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
