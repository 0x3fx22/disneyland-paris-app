...
public class WebpFrameLoader {
    ...
    private void loadNextFrame() {
        ...
        long jUptimeMillis = SystemClock.uptimeMillis() + ((long) this.webpDecoder.getNextDelay());
        ...
        this.requestBuilder.apply((BaseRequestOptions<?>) RequestOptions.signatureOf(getFrameSignature(currentFrameIndex)).skipMemoryCache(this.webpDecoder.getCacheStrategy().noCache())).mo2952load((Object) this.webpDecoder).into(this.next);
    }
