...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    @NonNull
    @CheckResult
    public T sizeMultiplier(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().sizeMultiplier(f);
        }
    ...
    public T useUnlimitedSourceGeneratorsPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().useUnlimitedSourceGeneratorsPool(z);
        }
    ...
    public T useAnimationPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().useAnimationPool(z);
        }
    ...
    public T onlyRetrieveFromCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().onlyRetrieveFromCache(z);
        }
    ...
    public T diskCacheStrategy(@NonNull DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public T priority(@NonNull Priority priority) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().priority(priority);
        }
    ...
    public T placeholder(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().placeholder(drawable);
        }
    ...
    public T placeholder(@DrawableRes int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().placeholder(i);
        }
    ...
    public T fallback(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().fallback(drawable);
        }
    ...
    public T fallback(@DrawableRes int i) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().fallback(i);
        }
        this.fallbackId = i;
    ...
    public T error(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().error(drawable);
        }
    ...
    public T theme(@Nullable Resources.Theme theme) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().theme(theme);
        }
        this.theme = theme;
        if (theme != null) {
            this.fields |= 32768;
    ...
    public T skipMemoryCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().skipMemoryCache(true);
        }
        this.isCacheable = !z;
        this.fields |= 256;
        return (T) selfOrThrowIfLocked();
    ...
    public T override(int i, int i2) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().override(i, i2);
        }
    ...
    public T signature(@NonNull Key key) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().signature(key);
        }
    ...
    public <Y> T set(@NonNull Option<Y> option, @NonNull Y y) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().set(option, y);
        }
    ...
    T removeOption(@NonNull Option<?> option) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().removeOption(option);
        }
    ...
    public T decode(@NonNull Class<?> cls) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().decode(cls);
        }
    ...
    @NonNull
    @CheckResult
    public T encodeQuality(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
    ...
    final T optionalTransform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    final T transform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    T transform(@NonNull Transformation<Bitmap> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().transform(transformation, z);
        }
    ...
    <Y> T transform(@NonNull Class<Y> cls, @NonNull Transformation<Y> transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().transform(cls, transformation, z);
        }
    ...
    public T dontTransform() {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().dontTransform();
        }
    ...
    public T apply(@NonNull BaseRequestOptions<?> baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return (T) mo2946clone().apply(baseRequestOptions);
        }
