...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
