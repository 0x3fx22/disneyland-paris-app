...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x005b A[Catch: all -> 0x0061, TRY_LEAVE, TryCatch #0 {all -> 0x0061, blocks: (B:23:0x0055, B:25:0x005b), top: B:36:0x0055 }] */
    /* JADX WARN: Code duplicated, block: B:30:0x0065 A[DONT_GENERATE] */
