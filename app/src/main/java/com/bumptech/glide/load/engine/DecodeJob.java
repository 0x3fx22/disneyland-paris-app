...
class DecodeJob implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable, FactoryPools.Poolable {
    ...
    private void runWrapped() {
        int i = C22961.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C22961.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage) {
        int i = C22961.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage.ordinal()];
        if (i == 1) {
    ...
    Resource onResourceDecoded(DataSource dataSource, Resource resource) {
        ...
        int i = C22961.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
        if (i == 1) {
