...
@Metadata(m1835d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\u0018\u0000 \u00042\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, m1836d2 = {"Lcom/mrousavy/camera/core/utils/CamcorderProfileUtils;", "", "<init>", "()V", "Companion", "react-native-vision-camera_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
            ...
            try {
                if (Build.VERSION.SDK_INT >= 31 && (all = CamcorderProfile.getAll(cameraId, 1)) != null) {
                    ...
                    if (it.hasNext()) {
                        next = it.next();
                        if (it.hasNext()) {
                            EncoderProfiles.VideoProfile videoProfileM1730m = AbstractC4513xa98325cf.m1730m(next);
                            int width = videoProfileM1730m.getWidth() * videoProfileM1730m.getHeight();
                            do {
                                Object next2 = it.next();
                                EncoderProfiles.VideoProfile videoProfileM1730m2 = AbstractC4513xa98325cf.m1730m(next2);
                                int width2 = videoProfileM1730m2.getWidth() * videoProfileM1730m2.getHeight();
                                if (width < width2) {
                                    next = next2;
                                    width = width2;
                                }
                    ...
                    EncoderProfiles.VideoProfile videoProfileM1730m3 = AbstractC4513xa98325cf.m1730m(next);
                    if (videoProfileM1730m3 != null) {
                        return new Size(videoProfileM1730m3.getWidth(), videoProfileM1730m3.getHeight());
                    }
                }
                Integer intOrNull = StringsKt.toIntOrNull(cameraId);
                if (intOrNull == null) {
        ...
        public final Integer getMaximumFps(@NotNull String cameraId, @NotNull Size size) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 31 && (all = CamcorderProfile.getAll(cameraId, iFindClosestCamcorderProfileQuality)) != null) {
                    ...
                    Integer numValueOf = Integer.valueOf(AbstractC4513xa98325cf.m1730m(it.next()).getFrameRate());
                    while (it.hasNext()) {
                        Integer numValueOf2 = Integer.valueOf(AbstractC4513xa98325cf.m1730m(it.next()).getFrameRate());
        ...
        public final Integer getRecommendedBitRate(@NotNull String cameraId, @NotNull Size videoSize) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 31 && (all = CamcorderProfile.getAll(cameraId, iFindClosestCamcorderProfileQuality)) != null) {
                    ...
                    Integer numValueOf = Integer.valueOf(AbstractC4513xa98325cf.m1730m(it.next()).getBitrate());
                    while (it.hasNext()) {
                        Integer numValueOf2 = Integer.valueOf(AbstractC4513xa98325cf.m1730m(it.next()).getBitrate());
                        if (numValueOf.compareTo(numValueOf2) < 0) {
                            numValueOf = numValueOf2;
                        }
                    }
