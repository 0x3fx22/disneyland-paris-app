...
public final class MetadataProvider implements LocationListener {
    ...
    public MetadataProvider(@NotNull Context context) {
        ...
        Object systemService = context.getSystemService(EnableFeatureAction.FEATURE_LOCATION);
