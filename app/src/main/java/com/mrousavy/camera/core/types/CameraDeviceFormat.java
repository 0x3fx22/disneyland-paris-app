...
public final /* data */ class CameraDeviceFormat {
    ...
    public CameraDeviceFormat(int i, int i2, int i3, int i4, double d, double d2, double d3, double d4, double d5, @NotNull List<? extends VideoStabilizationMode> videoStabilizationModes, @NotNull AutoFocusSystem autoFocusSystem, boolean z, boolean z2, boolean z3) {
        ...
        this.qualitySizes = MapsKt.mapOf(TuplesKt.m1842to(Quality.f29SD, 345600), TuplesKt.m1842to(Quality.f28HD, 921600), TuplesKt.m1842to(Quality.FHD, 2073600), TuplesKt.m1842to(Quality.UHD, 8294400));
    }
    ...
    @Metadata(m1835d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, m1836d2 = {"Lcom/mrousavy/camera/core/types/CameraDeviceFormat$Companion;", "", "<init>", "()V", "fromJSValue", "Lcom/mrousavy/camera/core/types/CameraDeviceFormat;", "value", "Lcom/facebook/react/bridge/ReadableMap;", "react-native-vision-camera_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
