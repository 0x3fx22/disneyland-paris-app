...
public class SystemSetting extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    public SystemSetting(ReactApplicationContext reactApplicationContext) {
        ...
        this.f3673am = (AudioManager) this.mContext.getApplicationContext().getSystemService(MimeTypes.BASE_TYPE_AUDIO);
        this.f3675wm = (WifiManager) this.mContext.getApplicationContext().getSystemService("wifi");
        this.f3674lm = (LocationManager) this.mContext.getApplicationContext().getSystemService(EnableFeatureAction.FEATURE_LOCATION);
    ...
    public void setVolume(float f, ReadableMap readableMap) {
        ...
        try {
            AudioManager audioManager = this.f3673am;
            audioManager.setStreamVolume(volType, (int) (audioManager.getStreamMaxVolume(volType) * f), i);
    ...
    */
    private void checkAndSet(String str, int i, Promise promise) {
        if (Settings.System.canWrite(this.mContext)) {
            try {
                ...
                Log.e(this.TAG, NotificationCompat.CATEGORY_ERROR, e2);
            }
        }
    ...
    public float getNormalizationVolume(String str) {
        ...
        return (this.f3673am.getStreamVolume(volType) * 1.0f) / this.f3673am.getStreamMaxVolume(volType);
    }
    ...
    public void isWifiEnabled(Promise promise) {
        WifiManager wifiManager = this.f3675wm;
        if (wifiManager != null) {
    ...
    public int getLocationMode() {
        boolean zIsProviderEnabled = this.f3674lm.isProviderEnabled("gps");
        return this.f3674lm.isProviderEnabled(TCEventPropertiesNames.TCN_NETWORK) ? (zIsProviderEnabled ? 1 : 0) | 2 : zIsProviderEnabled ? 1 : 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean isLocationEnable() {
        return this.f3674lm.isProviderEnabled("gps") || this.f3674lm.isProviderEnabled(TCEventPropertiesNames.TCN_NETWORK);
    }
