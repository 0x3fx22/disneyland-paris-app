...
public final class AlNFCPayload implements Serializable {
    ...
    public AlNFCPayload(@NotNull byte[] rawPayload) throws AlNFCComponentException, AlSecurityException {
    ...
    @NotNull
    /* JADX INFO: renamed from: getPayload$AccessNFCCredential_release, reason: from getter */
