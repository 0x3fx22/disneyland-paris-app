...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0018\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016R\u001a\u0010\u0007\u001a\u00020\bX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\f¨\u0006\u0013"}, m1836d2 = {"Lcom/allegion/accessnfccredential/communication/AlSchlageAccessMediator;", "Lcom/allegion/accessnfccredential/communication/AlSessionMediator;", "config", "Lcom/allegion/accessnfccredential/communication/IAlNFCConfig;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lcom/allegion/accessnfccredential/listeners/IAlOnNFCPeripheralInteractionListener;", "(Lcom/allegion/accessnfccredential/communication/IAlNFCConfig;Lcom/allegion/accessnfccredential/listeners/IAlOnNFCPeripheralInteractionListener;)V", "unlockTime", "", "getUnlockTime", "()J", "setUnlockTime", "(J)V", "processMessage", "", "context", "Landroid/content/Context;", "intent", "Landroid/content/Intent;", "AccessNFCCredential_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlSchlageAccessMediator extends AlSessionMediator {
    ...
    public void processMessage(@NotNull Context context, @NotNull Intent intent) {
        ...
        if (Intrinsics.areEqual(action, AlAPDUInstruction.GET_DATA.toString())) {
            AlLog.m444d("GET_DATA", new Object[0]);
        ...
        if (Intrinsics.areEqual(action, AlAPDUInstruction.VERIFY.toString())) {
            ...
            if (i == 1 || i == 2) {
                ...
                AlLog.m444d("TIMING (Connection Time, Unlock Time): " + getConnectionTime() + ", " + this.unlockTime, new Object[0]);
