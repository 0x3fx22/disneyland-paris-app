...
public abstract class AlAPDUMessage {
    ...
    @NotNull
    /* JADX INFO: renamed from: getParser$AccessNFCCredential_release, reason: from getter */
    public final AlAPDUParser getParser() {
        return this.parser;
    }

    @NotNull
    /* JADX INFO: renamed from: getProtocolVersion$AccessNFCCredential_release, reason: from getter */
