...
public class AlSessionMediator extends BroadcastReceiver {
    ...
    public void onReceive(@NotNull Context context, @NotNull Intent intent) {
        ...
        if (Intrinsics.areEqual(action, AlAPDUInstruction.SELECT.toString())) {
            ...
            AlLog.m444d("SELECT (" + alAPDUParameterKey + "): " + Hex.toHexString(this.aid), new Object[0]);
            return;
        }
        if (Intrinsics.areEqual(action, AlAPDUInstruction.GET_CHALLENGE.toString())) {
            ...
            AlLog.m444d("GET_CHALLENGE (" + alAPDUParameterKey2 + ", " + alAPDUParameterKey3 + "): " + Hex.toHexString(byteArray) + ", " + String.valueOf(companion.fromInt(extras3.getInt(alAPDUParameterKey3.toString()))), new Object[0]);
            return;
        }
        if (Intrinsics.areEqual(action, AlAPDUInstruction.MUTUAL_AUTHENTICATE.toString())) {
            ...
            this.startTime = System.currentTimeMillis();
            AlLog.m444d("MUTUAL_AUTHENTICATE", new Object[0]);
        ...
        if (Intrinsics.areEqual(action, AlAPDUInstruction.TERMINATE_CARD_USAGE.toString())) {
            ...
            if (i == 0) {
                AlLog.m444d("TERMINATE_CARD_USAGE (" + alAPDUParameterKey4 + "): 0", new Object[0]);
            } else if (i == 1) {
                AlLog.m444d("TERMINATE_CARD_USAGE (" + alAPDUParameterKey4 + "): 1", new Object[0]);
            } else {
                AlLog.m444d("TERMINATE_CARD_USAGE (" + alAPDUParameterKey4 + "): " + i, new Object[0]);
            }
        ...
        if (Intrinsics.areEqual(action, AlAPDUInstruction.VERIFY.toString())) {
            ...
            AlLog.m444d(sb.toString(), new Object[0]);
            if (alAPDUVerifyResponseFromByteArray != null && WhenMappings.$EnumSwitchMapping$0[alAPDUVerifyResponseFromByteArray.ordinal()] == 1) {
                ...
                AlLog.m447e(String.valueOf(alNFCComponentException.getErrorMessage()), new Object[0]);
