...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\b\u0000\u0018\u0000 \u00042\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, m1836d2 = {"Lcom/allegion/accesssdk/utilities/LoggingUtility;", "", "<init>", "()V", "Companion", "AccessSdk_qaRelease"}, m1837k = 1, m1838mv = {1, 4, 0})
public final class LoggingUtility {

    /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    @Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010$\n\u0000\n\u0002\u0010\u0002\n\u0002\b\t\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\r\u0010\u000eJ-\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0014\b\u0002\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bJ+\u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\b\u0002\u0010\t\u001a\u00020\u00022\b\b\u0002\u0010\n\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u000b\u0010\f¨\u0006\u000f"}, m1836d2 = {"Lcom/allegion/accesssdk/utilities/LoggingUtility$Companion;", "", "", "methodName", "", "passParams", "", "logMethodEntry", "(Ljava/lang/String;Ljava/util/Map;)V", "returnResult", "additionalInformation", "logMethodExit", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "<init>", "()V", "AccessSdk_qaRelease"}, m1837k = 1, m1838mv = {1, 4, 0})
    public static final class Companion {
        ...
        public final void logMethodEntry(@NotNull String methodName, @NotNull Map<String, String> passParams) {
            ...
            AlLog.m450i("Entering: " + methodName, new Object[0]);
            ...
            AlLog.m444d(string, new Object[0]);
        }
        ...
        public final void logMethodExit(@NotNull String methodName, @NotNull String returnResult, @NotNull String additionalInformation) {
            ...
            String string = sb.toString();
            Intrinsics.checkExpressionValueIsNotNull(string, "stringBuilder.toString()");
            AlLog.m450i(string, new Object[0]);
            if (returnResult.length() > 0) {
                AlLog.m444d("Returning Result: " + returnResult, new Object[0]);
            }
        }
