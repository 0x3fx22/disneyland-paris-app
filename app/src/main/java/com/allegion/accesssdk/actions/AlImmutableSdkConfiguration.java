...
public final class AlImmutableSdkConfiguration implements IAlSdkConfiguration, IAlBLEConfig, IAlNFCConfig {
    ...
    /* JADX INFO: renamed from: keyManagement$delegate, reason: from kotlin metadata */
    @NotNull
