...
public final class AccountPersistenceManager implements IModelPersistenceManager<Account> {
    ...
    public Account retrieve() {
        ...
        try {
            ...
            AlLog.m447e("Retrieve method failed", e);
            ...
            throw new MobileAccessException(e, mobileAccessExceptionType, companion2.getString(C1849R.string.retrieve_account_failed_error_description), companion2.getString(C1849R.string.retrieve_account_failed_failure_reason), companion2.getString(C1849R.string.default_recovery_suggestion), null, 32, null);
        }
    }
    ...
    public void store(@NotNull Account src) {
        ...
        try {
            ...
            AlLog.m447e("Failed to store Account. Account details- account ID: " + src.getAccountID() + ", device ID: " + src.getDeviceID(), e);
            MobileAccessExceptionType mobileAccessExceptionType = MobileAccessExceptionType.FAILED_TO_STORE_MODEL;
            StringHelper.Companion companion2 = StringHelper.INSTANCE;
            throw new MobileAccessException(e, mobileAccessExceptionType, companion2.getString(C1849R.string.store_account_failed_error_description), companion2.getString(C1849R.string.store_account_failed_failure_reason), companion2.getString(C1849R.string.default_recovery_suggestion), null, 32, null);
        }
    }
}
