...
import com.allegion.accesssdk.C1849R;
...
public final class ConnectedAccountPersistenceManager implements IModelPersistenceManager<ArrayList<ConnectedAccount>> {
    ...
    public ArrayList<ConnectedAccount> retrieve() {
        ...
        try {
            ...
            AlLog.m449e(e, "Encountered an unexpected error while attempting to retrieve Connected Accounts", new Object[0]);
            ...
            throw new MobileAccessException(e, mobileAccessExceptionType, companion2.getString(C1849R.string.retrieve_connected_accounts_failed_error_description), companion2.getString(C1849R.string.retrieve_connected_accounts_failed_failure_reason), companion2.getString(C1849R.string.default_recovery_suggestion), null, 32, null);
        }
    }
    ...
    public void store(@NotNull ArrayList<ConnectedAccount> src) {
        ...
        LoggingUtility.Companion companion = LoggingUtility.INSTANCE;
        companion.logMethodEntry("store", MapsKt.mapOf(TuplesKt.m1842to("src", src.toString())));
        try {
            ...
            AlLog.m449e(e, "Encountered an unexpected error while attempting to store Connected Account", new Object[0]);
            MobileAccessExceptionType mobileAccessExceptionType = MobileAccessExceptionType.FAILED_TO_STORE_MODEL;
            StringHelper.Companion companion2 = StringHelper.INSTANCE;
            throw new MobileAccessException(e, mobileAccessExceptionType, companion2.getString(C1849R.string.store_connected_accounts_failed_error_description), companion2.getString(C1849R.string.store_connected_accounts_failed_failure_reason), companion2.getString(C1849R.string.default_recovery_suggestion), null, 32, null);
        }
    }
}
