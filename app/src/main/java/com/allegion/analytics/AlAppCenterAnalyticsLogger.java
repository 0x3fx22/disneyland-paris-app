...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0007H\u0002J\u0015\u0010\b\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\tH\u0001¢\u0006\u0002\b\n¨\u0006\u000b"}, m1836d2 = {"Lcom/allegion/analytics/AlAppCenterAnalyticsLogger;", "", "()V", "write", "", "event", "Lcom/allegion/logging/event/IAlActionEvent;", "Lcom/allegion/logging/event/IAlCustomEvent;", "writeEntry", "Lcom/allegion/logging/entry/IAlEntry;", "writeEntry$Analytics_release", "Analytics_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlAppCenterAnalyticsLogger {
    ...
    private final void write(IAlActionEvent event) {
        ...
        try {
            ...
            AlLog.m447e("Event: `%s` contains missing arguments!! %s", action2, e.getMessage());
            str = action2;
        }
        Map<String, Serializable> mapConsolidate = AlPropertyKt.consolidate(AlLogging.getProperties(), event);
        Map mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.m1842to("Action Type", event.getType().toString()));
    ...
    private final void write(IAlCustomEvent event) {
        ...
        String json2;
        Map<String, Serializable> mapConsolidate = AlPropertyKt.consolidate(AlLogging.getProperties(), event);
        Map mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.m1842to("Event Type", event.getType().toString()));
