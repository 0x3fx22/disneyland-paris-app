...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0007H\u0002J\u0015\u0010\b\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\nH\u0001¢\u0006\u0002\b\u000b¨\u0006\f"}, m1836d2 = {"Lcom/allegion/analytics/AlAppCenterExceptionLogger;", "", "()V", "write", "", "entry", "Lcom/allegion/logging/entry/IAlExceptionEntry;", "Lcom/allegion/logging/entry/IAlExceptionLogEntry;", "writeEntry", "event", "Lcom/allegion/logging/entry/IAlEntry;", "writeEntry$Analytics_release", "Analytics_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlAppCenterExceptionLogger {
    ...
    private final void write(IAlExceptionEntry entry) {
        ...
        Map mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.m1842to("Log Level", entry.getLevel().toString()));
    ...
    private final void write(IAlExceptionLogEntry entry) {
        ...
        try {
            ...
            AlLog.m447e("Entry: `%s` contains missing arguments!! %s", str, e.getMessage());
        }
        Map<String, Serializable> mapConsolidate = AlPropertyKt.consolidate(AlLogging.getProperties(), entry);
        Map mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.m1842to("Log Level", entry.getLevel().toString()), TuplesKt.m1842to("Description", str));
        for (Map.Entry<String, Serializable> entry2 : mapConsolidate.entrySet()) {
            String key = entry2.getKey();
            Serializable value = entry2.getValue();
            if (value instanceof String) {
