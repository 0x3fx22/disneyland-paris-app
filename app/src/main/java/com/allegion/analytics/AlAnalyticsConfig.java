...
public final /* data */ class AlAnalyticsConfig implements IAlAnalyticsConfig {
    ...
    public int hashCode() {
        ...
        return i + (enableDistribute ? 1 : enableDistribute);
    }
