...
public abstract class WriteData {
    ...
    private void extractData(URI uri) throws IOException {
        ...
        if (uri != null && uri.isAbsolute()) {
            ...
            AlLog.m444d(".createSendList: file length: " + length + " name: " + file.getName(), new Object[0]);
            this.isMultiPackageDataWrite = false;
            if (length > getBlockSize()) {
                this.isMultiPackageDataWrite = true;
                this.totalWritePackages = (int) Math.ceil(((double) length) / ((double) getBlockSize()));
                AlLog.m444d(".createSendList: Number of packages to write: " + this.totalWritePackages, new Object[0]);
            }
            ...
            try {
                ...
                AlLog.m444d(".createSendList: Stream is closed", new Object[0]);
    ...
    public boolean sendRemainingPackages() {
        AlLog.m444d(".sendRemainingPackages: " + this.currentWritePackage + " of " + this.totalWritePackages, new Object[0]);
    ...
    public byte[] getSendCRC() {
        ...
        AlLog.m444d(".getSendCRC: CRC hex: " + HexConverter.bytesToString(bArr), new Object[0]);
        return bArr;
    }
}
