...
public abstract class BleScanner implements BluetoothAdapter.LeScanCallback {
    ...
    private Runnable mStartRunnable = new Runnable() { // from class: com.allegion.core.scanning.BleScanner.3
        @Override // java.lang.Runnable
        public void run() {
            AlLog.m444d("starting scan", new Object[0]);
    ...
    public BleScanner(Context context) {
        ...
        this.mScanCallback = new ScanCallback() { // from class: com.allegion.core.scanning.BleScanner.1
            ...
            public void onBatchScanResults(List<ScanResult> list) {
                ...
                while (it.hasNext()) {
                    AlLog.m450i("ScanResult - Results : %s", it.next().toString());
                }
            }

            @Override // android.bluetooth.le.ScanCallback
            public void onScanFailed(int i) {
                AlLog.m447e("Scan FailedError Code: " + i, new Object[0]);
            }
        };
    ...
    public void startScan(int i) {
        ...
        AlLog.m444d("Scan for locks in range: set up schedulers", new Object[0]);
    ...
    /* JADX INFO: renamed from: stopScan, reason: merged with bridge method [inline-methods] */
    public void lambda$new$2() {
        AlLog.m444d("stopping scan", new Object[0]);
        try {
            this.mContext.unregisterReceiver(this.scanReceiver);
        } catch (IllegalArgumentException e) {
            AlLog.m448e(e);
        }
        AlLog.m444d("Scan for locks in range: stop scanning", new Object[0]);
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = this.scheduledThread;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: pauseScan, reason: merged with bridge method [inline-methods] */
    public void lambda$new$3() {
        ...
        AlLog.m447e("Bluetooth stop scan failed.", new Object[0]);
    }
