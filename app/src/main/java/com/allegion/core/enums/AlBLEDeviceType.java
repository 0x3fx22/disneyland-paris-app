...
public enum AlBLEDeviceType {
    ...
    @Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\bH\u0007¨\u0006\t"}, m1836d2 = {"Lcom/allegion/core/enums/AlBLEDeviceType$Companion;", "", "()V", "fromByteArray", "Lcom/allegion/core/enums/AlBLEDeviceType;", "value", "", "fromString", "", "AlBle_release"}, m1837k = 1, m1838mv = {1, 1, 15})
    public static final class Companion {
        ...
        public final AlBLEDeviceType fromByteArray(@NotNull byte[] value) {
            ...
            if (Arrays.equals(value, new byte[]{0, Ascii.f3535VT})) {
                return AlBLEDeviceType.BARRACUDA;
            }
            if (Arrays.equals(value, new byte[]{0, Ascii.f3524FF})) {
                return AlBLEDeviceType.WIFI;
            }
            if (Arrays.equals(value, new byte[]{0, Ascii.f3522CR})) {
                return AlBLEDeviceType.GHI_TRILOCK;
            }
            if (Arrays.equals(value, new byte[]{0, Ascii.f3532SO})) {
                return AlBLEDeviceType.GHI_GATEWAY;
            }
            if (Arrays.equals(value, new byte[]{0, Ascii.f3531SI})) {
            ...
            if (Arrays.equals(value, new byte[]{0, Ascii.f3523EM})) {
            ...
            if (Arrays.equals(value, new byte[]{0, Ascii.f3525FS})) {
                return AlBLEDeviceType.E_SIGNO_SMARTHANDLE;
            }
            if (Arrays.equals(value, new byte[]{0, Ascii.f3526GS}) || Arrays.equals(value, new byte[]{0, Ascii.f3530RS}) || Arrays.equals(value, new byte[]{0, Ascii.f3534US})) {
                return AlBLEDeviceType.CISA_RESERVED;
            }
            if (Arrays.equals(value, new byte[]{0, 32})) {
                return AlBLEDeviceType.E_SIGNO_READER_OUTDOOR;
            }
            if (Arrays.equals(value, new byte[]{0, 33})) {
                return AlBLEDeviceType.E_SIGNO_READER_PLASTIC;
            }
            if (Arrays.equals(value, new byte[]{0, 34})) {
                return AlBLEDeviceType.UWE;
            }
            if (Arrays.equals(value, new byte[]{0, 35})) {
                return AlBLEDeviceType.ZION;
            }
            if (Arrays.equals(value, new byte[]{0, 36})) {
                return AlBLEDeviceType.GHI_JACKALOPE;
            }
            if (Arrays.equals(value, new byte[]{0, 37})) {
                return AlBLEDeviceType.GHI_JACKALOPE_LEVER;
            }
            if (Arrays.equals(value, new byte[]{0, 38})) {
                return AlBLEDeviceType.GHI_WIFI_TRILOCK;
            }
            if (Arrays.equals(value, new byte[]{0, 39})) {
                return AlBLEDeviceType.INTERFLEX_READER;
            }
            if (Arrays.equals(value, new byte[]{0, 40})) {
                return AlBLEDeviceType.INTERFLEX_LOCK;
            }
            return Arrays.equals(value, new byte[]{0, 41}) ? AlBLEDeviceType.WIFI_KEYPAD_DEADBOLT : AlBLEDeviceType.UNKNOWN;
        }
