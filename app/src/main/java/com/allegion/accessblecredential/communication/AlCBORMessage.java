...
public abstract class AlCBORMessage {
    ...
    @NotNull
    /* JADX INFO: renamed from: getCborUtility$AccessBleCredential_release, reason: from getter */
    public final IAlCborUtility getCborUtility() {
        return this.cborUtility;
    }

    @NotNull
    /* JADX INFO: renamed from: getGenerator$AccessBleCredential_release, reason: from getter */
    public final CBORGenerator getGenerator() {
        return this.generator;
    }

    @Nullable
    /* JADX INFO: renamed from: getProtocolVersion$AccessBleCredential_release, reason: from getter */
    public final AlProtocolVersion getProtocolVersion() {
        return this.protocolVersion;
    }

    @NotNull
    /* JADX INFO: renamed from: getStream$AccessBleCredential_release, reason: from getter */
