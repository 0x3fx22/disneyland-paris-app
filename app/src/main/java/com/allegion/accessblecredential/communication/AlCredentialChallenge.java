...
public final class AlCredentialChallenge extends AlCBORMessage {
    ...
    private final boolean validatePinnedDevices(byte[] devAuthKey, AlSignatures[] signatures) throws AlBleComponentException, AlSecurityException, AlTranslationComponentException {
    ...
    @Nullable
    /* JADX INFO: renamed from: getDevAuthKey$AccessBleCredential_release, reason: from getter */
    ...
    @Nullable
    /* JADX INFO: renamed from: getSignatures$AccessBleCredential_release, reason: from getter */
