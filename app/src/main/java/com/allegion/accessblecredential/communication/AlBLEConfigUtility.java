...
public final class AlBLEConfigUtility {
    ...
    public final KeyPair getDeviceKey() throws AlBleComponentException {
        ...
        try {
            ...
            AlLog.m447e("Unable to get key pair: %s", message);
            try {
                AlLog.m451i(e);
