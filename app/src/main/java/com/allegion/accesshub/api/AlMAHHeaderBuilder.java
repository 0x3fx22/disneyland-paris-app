...
public final class AlMAHHeaderBuilder {
    ...
    private final void m438a(Request.Builder builder, IAlConfig config) {
    ...
    public final void headerBuilder(@NotNull Request.Builder builder, @NotNull Header[] headers, @Nullable String body, @NotNull IAlConfig config) throws AlMAHException {
        ...
        for (Header header : headers) {
            ...
            if (iOrdinal == 0) {
                ...
                String str = string + "_" + simpleDateFormat.format(Long.valueOf(new Date().getTime() + ((long) 3600000)));
                ...
                builder.addHeader(Header.AUTOMATED_TEST.getValue(), "true");
            }
        }
    }
}
