...
public final class AlAes implements IAlAes {
    ...
    private final byte[] decryptPKCS7PaddingAes(SecretKey key, byte[] encryptedData) throws InvalidCipherTextException {
    ...
    private final byte[] encryptPKCS7PaddingAes(SecretKey key, byte[] input) throws InvalidCipherTextException {
        PaddedBufferedBlockCipher paddedBufferedBlockCipherInitializePaddedCipher = initializePaddedCipher();
