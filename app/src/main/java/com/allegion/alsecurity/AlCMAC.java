...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0007\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\u000f\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006H\u0002J\u001c\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u000b0\n2\u0006\u0010\f\u001a\u00020\u0006H\u0002J \u0010\r\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\u00062\u0006\u0010\u000e\u001a\u00020\u00062\u0006\u0010\u000f\u001a\u00020\u0006H\u0002J\u000e\u0010\u0010\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\u0006R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, m1836d2 = {"Lcom/allegion/alsecurity/AlCMAC;", "", "key", "Ljavax/crypto/SecretKey;", "(Ljavax/crypto/SecretKey;)V", "iv", "", "createK", "k", "padMessage", "Lkotlin/Pair;", "", "message", "prepareMessage", "k1", "k2", "sign", "Companion", "AlSecurity_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlCMAC {
    private static final int BLOCK_SIZE = 16;
    private static final byte PADDING = -128;

    /* JADX INFO: renamed from: RB */
    private static final byte f315RB = -121;
    ...
    public final byte[] sign(@NotNull byte[] message) throws AlSecurityException {
        ...
        AlLog.m444d("K0: " + Hex.toHexString(bArrEncrypt), new Object[0]);
        byte[] bArrCreateK = createK(bArrEncrypt);
        AlLog.m444d("K1: " + Hex.toHexString(bArrCreateK), new Object[0]);
        byte[] bArrCreateK2 = createK(bArrCreateK);
        AlLog.m444d("K2: " + Hex.toHexString(bArrCreateK2), new Object[0]);
        ...
        AlLog.m444d("CMAC: " + Hex.toHexString(bArrEncrypt2), new Object[0]);
        return bArrEncrypt2;
    }
    ...
    private final byte[] prepareMessage(byte[] message, byte[] k1, byte[] k2) throws AlSecurityException {
        ...
        AlLog.m444d("Padded Message: " + Hex.toHexString(bArrComponent1), new Object[0]);
        if (!zBooleanValue) {
            ...
            AlLog.m444d("Padded Message XORed with K1: " + Hex.toHexString(bArrComponent1), new Object[0]);
        } else {
            ...
            AlLog.m444d("Padded Message XORed with K2: " + Hex.toHexString(bArrComponent1), new Object[0]);
        }
