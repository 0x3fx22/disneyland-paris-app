...
public final class AlEcc implements IAlEcc {
    ...
    @Override // com.allegion.alsecurity.interfaces.IAlEcc
    @NotNull
    public ECPublicKey encodeEccPublicKey(@NotNull byte[] eccPublicKey) throws AlSecurityException {
    ...
    @NotNull
    public final SecretKey generateAesKeyFromEcdh(@NotNull PublicKey publicKeyReceived, @NotNull PrivateKey privateKeyLocal) throws AlSecurityException {
    ...
    @NotNull
    public final SecretKey generateAesKeyFromEcdh(@NotNull PublicKey publicKeyReceived, @NotNull PrivateKey privateKeyLocal, @NotNull byte[] otherInfo) throws AlSecurityException {
        Intrinsics.checkParameterIsNotNull(publicKeyReceived, "publicKeyReceived");
        Intrinsics.checkParameterIsNotNull(privateKeyLocal, "privateKeyLocal");
