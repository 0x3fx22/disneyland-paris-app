...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0007H\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\bH\u0002J\u0010\u0010\t\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\nH\u0007¨\u0006\u000b"}, m1836d2 = {"Lcom/allegion/logging/logger/AlTimberEntryLogger;", "", "()V", "write", "", "entry", "Lcom/allegion/logging/entry/IAlExceptionEntry;", "Lcom/allegion/logging/entry/IAlExceptionLogEntry;", "Lcom/allegion/logging/entry/IAlLogEntry;", "writeEntry", "Lcom/allegion/logging/entry/IAlEntry;", "AlLogging_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlTimberEntryLogger {
    ...
    private final void write(IAlLogEntry entry) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[entry.getLevel().ordinal()]) {
            case 1:
                ...
                Timber.m2149d(message, Arrays.copyOf(args, args.length));
                break;
            case 2:
                String message2 = entry.getMessage();
                Object[] args2 = entry.getArgs();
                Timber.m2161w(message2, Arrays.copyOf(args2, args2.length));
                break;
            case 3:
                String message3 = entry.getMessage();
                Object[] args3 = entry.getArgs();
                Timber.m2155i(message3, Arrays.copyOf(args3, args3.length));
                break;
            case 4:
                String message4 = entry.getMessage();
                Object[] args4 = entry.getArgs();
                Timber.m2152e(message4, Arrays.copyOf(args4, args4.length));
                break;
            case 5:
                String message5 = entry.getMessage();
                Object[] args5 = entry.getArgs();
                Timber.m2158v(message5, Arrays.copyOf(args5, args5.length));
                break;
            case 6:
    ...
    private final void write(IAlExceptionEntry entry) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$1[entry.getLevel().ordinal()]) {
            case 1:
                Timber.m2150d(entry.getException());
                break;
            case 2:
                Timber.m2162w(entry.getException());
                break;
            case 3:
                Timber.m2156i(entry.getException());
                break;
            case 4:
                Timber.m2153e(entry.getException());
                break;
            case 5:
                Timber.m2159v(entry.getException());
                break;
            case 6:
    ...
    private final void write(IAlExceptionLogEntry entry) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$2[entry.getLevel().ordinal()]) {
            case 1:
                ...
                String message = entry.getMessage();
                Object[] args = entry.getArgs();
                Timber.m2151d(exception, message, Arrays.copyOf(args, args.length));
                break;
            case 2:
                Throwable exception2 = entry.getException();
                String message2 = entry.getMessage();
                Object[] args2 = entry.getArgs();
                Timber.m2163w(exception2, message2, Arrays.copyOf(args2, args2.length));
                break;
            case 3:
                Throwable exception3 = entry.getException();
                String message3 = entry.getMessage();
                Object[] args3 = entry.getArgs();
                Timber.m2157i(exception3, message3, Arrays.copyOf(args3, args3.length));
                break;
            case 4:
                Throwable exception4 = entry.getException();
                String message4 = entry.getMessage();
                Object[] args4 = entry.getArgs();
                Timber.m2154e(exception4, message4, Arrays.copyOf(args4, args4.length));
                break;
            case 5:
                Throwable exception5 = entry.getException();
                String message5 = entry.getMessage();
                Object[] args5 = entry.getArgs();
                Timber.m2160v(exception5, message5, Arrays.copyOf(args5, args5.length));
                break;
            case 6:
