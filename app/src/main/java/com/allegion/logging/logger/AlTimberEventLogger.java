...
@Metadata(m1834bv = {1, 0, 3}, m1835d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\tH\u0002J\u0015\u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u000bH\u0001¢\u0006\u0002\b\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\r"}, m1836d2 = {"Lcom/allegion/logging/logger/AlTimberEventLogger;", "", "()V", "EVENT_MESSAGE_FORMAT", "", "write", "", "entry", "Lcom/allegion/logging/event/IAlActionEvent;", "Lcom/allegion/logging/event/IAlCustomEvent;", "writeEntry", "Lcom/allegion/logging/entry/IAlEntry;", "writeEntry$AlLogging_release", "AlLogging_release"}, m1837k = 1, m1838mv = {1, 1, 15})
public final class AlTimberEventLogger {
    ...
    private final void write(IAlActionEvent entry) {
        ...
        if (i == 1) {
            ...
            Timber.m2155i(action, Arrays.copyOf(args, args.length));
        } else if (i == 2) {
            String action2 = entry.getAction();
            Object[] args2 = entry.getArgs();
            Timber.m2152e(action2, Arrays.copyOf(args2, args2.length));
        } else {
            if (i != 3) {
                return;
            }
            ...
            Timber.m2155i(action3, Arrays.copyOf(args3, args3.length));
        }
    }
    ...
    private final void write(IAlCustomEvent entry) {
        ...
        if (i == 1) {
            Timber.m2155i(EVENT_MESSAGE_FORMAT, entry.getAction(), AlJsonKt.toJson(entry.getProperties()), json);
        } else if (i == 2) {
            Timber.m2152e(EVENT_MESSAGE_FORMAT, entry.getAction(), AlJsonKt.toJson(entry.getProperties()), json);
        } else {
            if (i != 3) {
                return;
            }
