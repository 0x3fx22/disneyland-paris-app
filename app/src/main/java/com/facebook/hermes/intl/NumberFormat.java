...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map map) throws JSRangeErrorException {
        ...
        this.mResolvedStyle = (IPlatformNumberFormatter.Style) OptionHelpers.searchEnum(IPlatformNumberFormatter.Style.class, JSObjects.getJavaString(OptionHelpers.GetOption(map, "style", optionType, new String[]{"decimal", "percent", TCEventPropertiesNames.TCE_CURRENCY, "unit"}, "decimal")));
        Object objGetOption = OptionHelpers.GetOption(map, TCEventPropertiesNames.TCE_CURRENCY, optionType, JSObjects.Undefined(), JSObjects.Undefined());
    ...
    public Map<String, Object> resolvedOptions() throws JSRangeErrorException {
        ...
        IPlatformNumberFormatter.Style style = this.mResolvedStyle;
        if (style == IPlatformNumberFormatter.Style.CURRENCY) {
            linkedHashMap.put(TCEventPropertiesNames.TCE_CURRENCY, this.mResolvedCurrency);
