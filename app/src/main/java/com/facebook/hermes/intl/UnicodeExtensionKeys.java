...
public class UnicodeExtensionKeys {
    ...
    public static Object resolveKnownAliases(String str, Object obj) {
        ...
        return ((str.equals(Constants.COLLATION_EXTENSION_PARAM_NUMERIC_SHORT) || str.equals(Constants.COLLATION_EXTENSION_PARAM_CASEFIRST_SHORT)) && JSObjects.isString(obj) && obj.equals(BooleanUtils.f3980NO)) ? JSObjects.newString("false") : obj;
    }
}
