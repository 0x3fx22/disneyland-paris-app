...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    public PlatformNumberFormatterICU setSignDisplay(IPlatformNumberFormatter.SignDisplay signDisplay) {
        ...
        if (numberFormat instanceof DecimalFormat) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                int i = C30691.f3382xa920794a[signDisplay.ordinal()];
                if (i == 1) {
                ...
                int i2 = C30691.f3382xa920794a[signDisplay.ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class C30691 {
        ...
        static final /* synthetic */ int[] f3382xa920794a;
        ...
        static {
            ...
            try {
                f3382xa920794a[IPlatformNumberFormatter.SignDisplay.ALWAYS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3382xa920794a[IPlatformNumberFormatter.SignDisplay.EXCEPTZERO.ordinal()] = 3;
