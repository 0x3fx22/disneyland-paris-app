...
public class PlatformNumberFormatterAndroid implements IPlatformNumberFormatter {
    ...
    public PlatformNumberFormatterAndroid setCurrency(String str, IPlatformNumberFormatter.CurrencyDisplay currencyDisplay) throws JSRangeErrorException {
        if (this.mStyle == IPlatformNumberFormatter.Style.CURRENCY) {
            ...
            int i = C30681.f3381x4080d5f6[currencyDisplay.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C30681 {
        ...
        static final /* synthetic */ int[] f3381x4080d5f6;
        ...
        static {
            ...
            try {
                f3381x4080d5f6[IPlatformNumberFormatter.CurrencyDisplay.CODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3381x4080d5f6[IPlatformNumberFormatter.CurrencyDisplay.SYMBOL.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3381x4080d5f6[IPlatformNumberFormatter.CurrencyDisplay.NARROWSYMBOL.ordinal()] = 4;
