...
public interface IPlatformCollator {
    ...
    public enum Sensitivity {
        ...
        public String toString() {
            int i = C30611.f3356x17be7a55[ordinal()];
            if (i == 1) {
    ...
    public enum Usage {
        ...
        @Override // java.lang.Enum
        public String toString() {
            int i = C30611.$SwitchMap$com$facebook$hermes$intl$IPlatformCollator$Usage[ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C30611 {
        ...
        static final /* synthetic */ int[] f3356x17be7a55;
        ...
        static {
            ...
            f3356x17be7a55 = iArr3;
            try {
                iArr3[Sensitivity.BASE.ordinal()] = 1;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3356x17be7a55[Sensitivity.ACCENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f3356x17be7a55[Sensitivity.CASE.ordinal()] = 3;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3356x17be7a55[Sensitivity.VARIANT.ordinal()] = 4;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f3356x17be7a55[Sensitivity.LOCALE.ordinal()] = 5;
    ...
    public enum CaseFirst {
        ...
        @Override // java.lang.Enum
        public String toString() {
            int i = C30611.$SwitchMap$com$facebook$hermes$intl$IPlatformCollator$CaseFirst[ordinal()];
            if (i == 1) {
