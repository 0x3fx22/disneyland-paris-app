...
public abstract class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() { // from class: com.facebook.common.references.CloseableReference.2
        ...
        public void reportLeak(SharedReference sharedReference, Throwable th) {
            ...
            FLog.m1329w((Class<?>) CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), obj == null ? null : obj.getClass().getName());
        }
    };
    ...
    public abstract CloseableReference<T> mo4126clone();
    ...
    public static CloseableReference m1345of(@PropagatesNullable Closeable closeable) {
        return m1347of(closeable, (ResourceReleaser<Closeable>) DEFAULT_CLOSEABLE_RELEASER);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1347of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser) {
        return m1348of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }
    ...
    /* JADX INFO: renamed from: of */
    public static CloseableReference m1346of(@PropagatesNullable @Nullable Closeable closeable, LeakHandler leakHandler) {
        if (closeable == null) {
            return null;
        }
        return m1349of(closeable, DEFAULT_CLOSEABLE_RELEASER, leakHandler, leakHandler.requiresStacktrace() ? new Throwable() : null);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1348of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        if (t == null) {
            return null;
        }
        return m1349of(t, resourceReleaser, leakHandler, leakHandler.requiresStacktrace() ? new Throwable() : null);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1349of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler, @Nullable Throwable th) {
        if (t == null) {
            return null;
        }
