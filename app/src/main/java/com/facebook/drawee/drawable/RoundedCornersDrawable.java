...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
    ...
    static /* synthetic */ class C30571 {
        ...
        static {
            ...
            try {
                f3353xda0cffae[Type.OVERLAY_COLOR.ordinal()] = 2;
    ...
    public void draw(Canvas canvas) {
        ...
        int i = C30571.f3353xda0cffae[this.mType.ordinal()];
        if (i == 1) {
