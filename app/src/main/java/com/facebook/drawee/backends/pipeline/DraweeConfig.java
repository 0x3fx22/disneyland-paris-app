...
public class DraweeConfig {
    ...
    private DraweeConfig(Builder builder) {
        ...
        if (builder.mDebugOverlayEnabledSupplier != null) {
            supplierM1270of = builder.mDebugOverlayEnabledSupplier;
        } else {
            supplierM1270of = Suppliers.m1270of(Boolean.FALSE);
        }
        this.mDebugOverlayEnabledSupplier = supplierM1270of;
    ...
    public static final class Builder {
        ...
        public Builder setDrawDebugOverlay(boolean z) {
            return setDebugOverlayEnabledSupplier(Suppliers.m1270of(Boolean.valueOf(z)));
        }
