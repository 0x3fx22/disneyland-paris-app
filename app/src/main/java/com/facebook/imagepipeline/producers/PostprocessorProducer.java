    ...
    private class PostprocessorConsumer extends DelegatingConsumer {
        ...
        private Map getExtraMap(ProducerListener2 producerListener2, ProducerContext producerContext, Postprocessor postprocessor) {
            if (producerListener2.requiresExtraMap(producerContext, PostprocessorProducer.NAME)) {
                return ImmutableMap.m1263of("Postprocessor", postprocessor.getName());
            }
            return null;
        }
        ...
        private CloseableReference postprocessInternal(CloseableImage closeableImage) {
            ...
            try {
                CloseableStaticBitmap closeableStaticBitmapM1364of = CloseableStaticBitmap.m1364of(closeableReferenceProcess, closeableImage.getQualityInfo(), closeableStaticBitmap.getRotationAngle(), closeableStaticBitmap.getExifOrientation());
                closeableStaticBitmapM1364of.putExtras(closeableStaticBitmap.getExtras());
                return CloseableReference.m1345of(closeableStaticBitmapM1364of);
            } finally {
