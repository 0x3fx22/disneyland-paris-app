...
public class DiskCacheReadProducer implements Producer<EncodedImage> {
    ...
    static Map getExtraMap(ProducerListener2 producerListener2, ProducerContext producerContext, boolean z, int i) {
        ...
        if (!z) {
            return ImmutableMap.m1263of("cached_value_found", String.valueOf(z));
        }
        return ImmutableMap.m1264of("cached_value_found", String.valueOf(z), "encodedImageSize", String.valueOf(i));
    }
