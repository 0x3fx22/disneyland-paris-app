...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    protected EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        CloseableReference closeableReferenceM1345of;
        CloseableReference closeableReference = null;
        try {
            if (i <= 0) {
                closeableReferenceM1345of = CloseableReference.m1345of(this.mPooledByteBufferFactory.newByteBuffer(inputStream));
            } else {
                closeableReferenceM1345of = CloseableReference.m1345of(this.mPooledByteBufferFactory.newByteBuffer(inputStream, i));
            }
            closeableReference = closeableReferenceM1345of;
