...
public final class SimpleImageTranscoder implements ImageTranscoder {
    ...
    public ImageTranscodeResult transcode(@NotNull EncodedImage encodedImage, @NotNull OutputStream outputStream, @Nullable RotationOptions rotationOptions, @Nullable ResizeOptions resizeOptions, @Nullable ImageFormat outputFormat, @Nullable Integer quality, @Nullable ColorSpace colorSpace) throws Throwable {
        ...
        try {
            ...
            if (bitmapDecodeStream == null) {
                FLog.m1291e("SimpleImageTranscoder", "Couldn't decode the EncodedImage InputStream ! ");
            ...
            if (transformationMatrix != null) {
                try {
                    ...
                    FLog.m1292e("SimpleImageTranscoder", "Out-Of-Memory during transcode", e);
            ...
            FLog.m1292e("SimpleImageTranscoder", "Out-Of-Memory during transcode", e3);
            return new ImageTranscodeResult(2);
        }
    }
    ...
    @Metadata(m1835d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0012\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tH\u0002R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\n"}, m1836d2 = {"Lcom/facebook/imagepipeline/transcoder/SimpleImageTranscoder$Companion;", "", "<init>", "()V", "TAG", "", "getOutputFormat", "Landroid/graphics/Bitmap$CompressFormat;", "format", "Lcom/facebook/imageformat/ImageFormat;", "imagepipeline_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
