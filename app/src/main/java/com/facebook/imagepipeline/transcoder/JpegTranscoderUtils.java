...
public final class JpegTranscoderUtils {
    ...
    static {
        ImmutableList<Integer> immutableListM1261of = ImmutableList.m1261of((Object[]) new Integer[]{2, 7, 4, 5});
        Intrinsics.checkNotNullExpressionValue(immutableListM1261of, "of(...)");
        INVERTED_EXIF_ORIENTATIONS = immutableListM1261of;
    }
