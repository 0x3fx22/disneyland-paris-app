...
public abstract class BasePool<V> implements Pool<V> {
            ...
            try {
                ...
                if (bucket != null && (value = getValue(bucket)) != null) {
                    ...
                    if (FLog.isLoggable(2)) {
                        FLog.m1313v((Class<?>) this.TAG, "get (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSizeForValue));
                    }
                    return value;
                }
                ...
                synchronized (this) {
                    try {
                        ...
                        logStats();
                        if (FLog.isLoggable(2)) {
                            FLog.m1313v((Class<?>) this.TAG, "get (alloc) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(vAlloc)), Integer.valueOf(bucketedSize));
                        }
                    } catch (Throwable th3) {
                        throw th3;
                    }
        ...
        synchronized (this) {
            try {
                ...
                if (!this.mInUseValues.remove(v)) {
                    FLog.m1289e((Class<?>) this.TAG, "release (free, value unrecognized) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                    free(v);
                    ...
                    if (FLog.isLoggable(2)) {
                        FLog.m1313v((Class<?>) this.TAG, "release (free) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                    }
                    free(v);
                    ...
                    if (FLog.isLoggable(2)) {
                        FLog.m1313v((Class<?>) this.TAG, "release (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                    }
                }
                logStats();
            } catch (Throwable th) {
    ...
    synchronized void trimToSize(int i) {
        try {
            ...
            if (FLog.isLoggable(2)) {
                FLog.m1314v((Class<?>) this.TAG, "trimToSize: TargetSize = %d; Initial Size = %d; Bytes to free = %d", Integer.valueOf(i), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes), Integer.valueOf(iMin));
            }
            logStats();
            ...
            logStats();
            if (FLog.isLoggable(2)) {
                FLog.m1313v((Class<?>) this.TAG, "trimToSize: TargetSize = %d; Final Size = %d", Integer.valueOf(i), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes));
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    synchronized Bucket getBucket(int i) {
        try {
            ...
            if (bucket == null && this.mAllowNewBuckets) {
                if (FLog.isLoggable(2)) {
                    FLog.m1312v((Class<?>) this.TAG, "creating new bucket %s", Integer.valueOf(i));
                }
    ...
    private void logStats() {
        if (FLog.isLoggable(2)) {
            FLog.m1315v((Class<?>) this.TAG, "Used = (%d, %d); Free = (%d, %d)", Integer.valueOf(this.mUsed.mCount), Integer.valueOf(this.mUsed.mNumBytes), Integer.valueOf(this.mFree.mCount), Integer.valueOf(this.mFree.mNumBytes));
        }
    }
