...
public final class MemoryPooledByteBufferFactory implements PooledByteBufferFactory {
    ...
    public MemoryPooledByteBuffer newByteBuffer(int size) {
        ...
        CloseableReference closeableReferenceM1347of = CloseableReference.m1347of(this.pool.get(size), this.pool);
        Intrinsics.checkNotNullExpressionValue(closeableReferenceM1347of, "of(...)");
        try {
            return new MemoryPooledByteBuffer(closeableReferenceM1347of, size);
        } finally {
            closeableReferenceM1347of.close();
        }
    }
