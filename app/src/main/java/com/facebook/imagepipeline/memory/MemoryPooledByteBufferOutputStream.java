...
public final class MemoryPooledByteBufferOutputStream extends PooledByteBufferOutputStream {
    ...
    public MemoryPooledByteBufferOutputStream(@NotNull MemoryChunkPool pool, int i) {
        ...
        this.pool = pool;
        this.count = 0;
        this.bufRef = CloseableReference.m1347of(pool.get(i), pool);
    }
    ...
    public final void realloc(int newLength) throws Throwable {
        ...
        this.bufRef = CloseableReference.m1347of(memoryChunk2, this.pool);
    }
    ...
    @Metadata(m1835d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00060\u0002j\u0002`\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m1836d2 = {"Lcom/facebook/imagepipeline/memory/MemoryPooledByteBufferOutputStream$InvalidStreamException;", "Lkotlin/RuntimeException;", "Ljava/lang/RuntimeException;", "<init>", "()V", "imagepipeline_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
