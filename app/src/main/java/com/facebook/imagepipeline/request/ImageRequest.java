...
public class ImageRequest {
    public static final InterfaceC3034Fn<ImageRequest, Uri> REQUEST_TO_URI_FN = new InterfaceC3034Fn() { // from class: com.facebook.imagepipeline.request.ImageRequest.1
        @Override // com.facebook.common.internal.InterfaceC3034Fn
