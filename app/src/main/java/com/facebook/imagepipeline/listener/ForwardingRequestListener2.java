    ...
    public void onProducerEvent(@NotNull ProducerContext producerContext, @NotNull String producerName, @NotNull String producerEventName) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onIntermediateChunkStart", e);
            }
        }
    }
    ...
    public void onProducerFinishWithCancellation(@Nullable ProducerContext producerContext, @Nullable String producerName, @Nullable Map<String, String> extraMap) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onProducerFinishWithCancellation", e);
            }
        }
    }
    ...
    public void onProducerFinishWithFailure(@Nullable ProducerContext producerContext, @Nullable String producerName, @Nullable Throwable t, @Nullable Map<String, String> extraMap) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onProducerFinishWithFailure", e);
            }
        }
    }
    ...
    public void onProducerFinishWithSuccess(@Nullable ProducerContext producerContext, @Nullable String producerName, @Nullable Map<String, String> extraMap) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onProducerFinishWithSuccess", e);
            }
        }
    }
    ...
    public void onProducerStart(@NotNull ProducerContext producerContext, @NotNull String producerName) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onProducerStart", e);
            }
        }
    }
    ...
    public void onRequestCancellation(@NotNull ProducerContext producerContext) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onRequestCancellation", e);
            }
        }
    }
    ...
    public void onRequestFailure(@NotNull ProducerContext producerContext, @NotNull Throwable throwable) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onRequestFailure", e);
            }
        }
    }
    ...
    public void onRequestStart(@NotNull ProducerContext producerContext) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onRequestStart", e);
            }
        }
    }
    ...
    public void onRequestSuccess(@NotNull ProducerContext producerContext) {
        ...
        while (it.hasNext()) {
            try {
                ...
                FLog.m1292e("ForwardingRequestListener2", "InternalListener exception in onRequestSuccess", e);
            }
        }
    }
