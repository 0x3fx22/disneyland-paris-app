...
public final class ImagePipeline {
    ...
    private final DataSource submitPrefetchRequest(Producer producerSequence, ImageRequest imageRequest, ImageRequest.RequestLevel lowestPermittedRequestLevelOnSubmit, Object callerContext, Priority priority, RequestListener requestListener) {
