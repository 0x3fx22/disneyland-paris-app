...
public class ImagePipelineFactory {
    ...
    public static synchronized void initialize(ImagePipelineConfigInterface imagePipelineConfigInterface) {
        if (sInstance != null) {
            FLog.m1327w((Class<?>) TAG, "ImagePipelineFactory has already been initialized! `ImagePipelineFactory.initialize(...)` should only be called once to avoid unexpected behavior.");
