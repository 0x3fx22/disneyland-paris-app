...
public class DefaultImageDecoder implements ImageDecoder {
    ...
    public CloseableStaticBitmap decodeStaticImage(EncodedImage encodedImage, ImageDecodeOptions imageDecodeOptions) {
        ...
        try {
            ...
            CloseableStaticBitmap closeableStaticBitmapM1364of = CloseableStaticBitmap.m1364of(closeableReferenceDecodeFromEncodedImageWithColorSpace, ImmutableQualityInfo.FULL_QUALITY, encodedImage.getRotationAngle(), encodedImage.getExifOrientation());
            closeableStaticBitmapM1364of.putExtra("is_rounded", Boolean.valueOf(zMaybeApplyTransformation && (imageDecodeOptions.bitmapTransformation instanceof CircularTransformation)));
            return closeableStaticBitmapM1364of;
        } finally {
    ...
    public CloseableStaticBitmap decodeJpeg(EncodedImage encodedImage, int i, QualityInfo qualityInfo, ImageDecodeOptions imageDecodeOptions, @Nullable ColorSpace colorSpace) {
        ...
        try {
            ...
            CloseableStaticBitmap closeableStaticBitmapM1364of = CloseableStaticBitmap.m1364of(closeableReferenceDecodeJPEGFromEncodedImageWithColorSpace, qualityInfo, encodedImage.getRotationAngle(), encodedImage.getExifOrientation());
            closeableStaticBitmapM1364of.putExtra("is_rounded", Boolean.valueOf(zMaybeApplyTransformation && (imageDecodeOptions.bitmapTransformation instanceof CircularTransformation)));
            return closeableStaticBitmapM1364of;
        } finally {
