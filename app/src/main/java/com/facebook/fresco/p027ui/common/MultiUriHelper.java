...
import com.facebook.common.internal.InterfaceC3034Fn;
...
public final class MultiUriHelper {
    ...
    @JvmStatic
    @Nullable
    public static final <T> Uri getMainUri(@Nullable T mainRequest, @Nullable T lowResRequest, @Nullable T[] firstAvailableRequest, @NotNull InterfaceC3034Fn<T, Uri> requestToUri) {
