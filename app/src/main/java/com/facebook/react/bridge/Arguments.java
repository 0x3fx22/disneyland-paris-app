...
public class Arguments {
    ...
    public static ArrayList toList(@Nullable ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C31802.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
    ...
    public static Bundle toBundle(@Nullable ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C31802.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
