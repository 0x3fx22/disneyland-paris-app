...
class JavaMethodWrapper implements JavaModuleWrapper.NativeMethod {
    ...
    private void processArguments() {
        ...
        SystraceMessage.beginSection(0L, "processArguments").arg(TCEventPropertiesNames.TCE_METHOD, this.mModuleWrapper.getName() + InstructionFileId.DOT + this.mMethod.getName()).flush();
        try {
    ...
    public void invoke(JSInstance jSInstance, ReadableArray readableArray) {
        ...
        SystraceMessage.beginSection(0L, "callJavaModuleMethod").arg(TCEventPropertiesNames.TCE_METHOD, str).flush();
        if (DEBUG) {
