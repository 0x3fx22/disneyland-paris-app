...
public class JsonWriterHelper {
    ...
    private static void dynamicValue(JsonWriter jsonWriter, Dynamic dynamic) throws IOException {
        switch (C31971.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()]) {
            case 1:
    ...
    private static void readableMapValue(JsonWriter jsonWriter, ReadableMap readableMap) throws IOException {
        ...
        try {
            ...
            while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
                ...
                switch (C31971.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        continue;
                    case 2:
    ...
    public static void readableArrayValue(JsonWriter jsonWriter, ReadableArray readableArray) throws IOException {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            try {
                switch (C31971.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                    case 1:
                        jsonWriter.nullValue();
                        continue;
                        break;
