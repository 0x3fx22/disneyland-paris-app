    ...
    private void updateNodes(List<AnimatedNode> list) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            try {
                ...
                FLog.m1292e(TAG, "Native animation workaround, frame lost as result of race condition", e);
            }
        ...
        if (i3 != i11) {
            ...
            FLog.m1291e(TAG, "Detected animation cycle or disconnected graph. ");
            Iterator<AnimatedNode> it = list.iterator();
            while (it.hasNext()) {
                FLog.m1291e(TAG, it.next().prettyPrintWithChildren());
            }
