...
public class TransformHelper {
                    ...
                    if ("rotate".equals(strNextKey) || "rotateZ".equals(strNextKey)) {
                        ...
                        if ("translate".equals(strNextKey)) {
                            ...
                            if (ViewProps.TRANSLATE_X.equals(strNextKey)) {
                                ...
                                FLog.m1331w(ReactConstants.TAG, "Unsupported transform type: " + strNextKey);
                            }
                        }
                    }
                    MatrixMathHelper.multiplyInto(dArr, dArr, dArr2);
    ...
    private static double parseTranslateValue(String str, double d) {
        try {
            ...
            FLog.m1331w(ReactConstants.TAG, "Invalid translate value: " + str);
    ...
    private static float[] getTranslateForTransformOrigin(float f, float f2, ReadableArray readableArray, boolean z) {
        ...
        while (i < readableArray.size() && i < 3) {
            int i2 = C32822.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()];
            if (i2 == 1) {
