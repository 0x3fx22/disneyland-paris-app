...
public final class BorderDrawable extends Drawable {
    ...
    public void draw(@NotNull Canvas canvas) {
        ColorEdges colorEdgesM4491resolveimpl;
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        updatePathEffect();
        Integer[] numArr = this.borderColors;
        if (numArr == null || (colorEdgesM4491resolveimpl = BorderColors.m4491resolveimpl(numArr, getLayoutDirection(), this.context)) == null) {
            colorEdgesM4491resolveimpl = this.computedBorderColors;
        }
        this.computedBorderColors = colorEdgesM4491resolveimpl;
    ...
    public final void setBorderColor(@NotNull LogicalEdge position, @Nullable Integer color) {
        ...
        Integer[] numArrM4487constructorimpl$default = this.borderColors;
        if (numArrM4487constructorimpl$default == null) {
            numArrM4487constructorimpl$default = BorderColors.m4487constructorimpl$default(null, 1, null);
        }
        this.borderColors = numArrM4487constructorimpl$default;
        if (numArrM4487constructorimpl$default != null) {
            numArrM4487constructorimpl$default[position.ordinal()] = color;
        }
        this.needUpdatePath = true;
        invalidateSelf();
    }
    ...
    private final void drawRoundedBorders(Canvas canvas) {
        ...
        RectF rectFComputeBorderInsets = computeBorderInsets();
        float f = rectFComputeBorderInsets.top;
        float vertical = BitmapDescriptorFactory.HUE_RED;
        if (f > BitmapDescriptorFactory.HUE_RED || rectFComputeBorderInsets.bottom > BitmapDescriptorFactory.HUE_RED || rectFComputeBorderInsets.left > BitmapDescriptorFactory.HUE_RED || rectFComputeBorderInsets.right > BitmapDescriptorFactory.HUE_RED) {
            ...
            if (rectFComputeBorderInsets.top != fullBorderWidth || rectFComputeBorderInsets.bottom != fullBorderWidth || rectFComputeBorderInsets.left != fullBorderWidth || rectFComputeBorderInsets.right != fullBorderWidth || this.computedBorderColors.getLeft() != borderColor || this.computedBorderColors.getTop() != borderColor || this.computedBorderColors.getRight() != borderColor || this.computedBorderColors.getBottom() != borderColor) {
                ...
                if (rectFComputeBorderInsets.left > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    drawQuadrilateral(canvas, this.computedBorderColors.getLeft(), f2, f4 - f6, pointF3.x, pointF3.y - f6, pointF5.x, pointF5.y + f6, f2, f5 + f6);
                }
                if (rectFComputeBorderInsets.top > BitmapDescriptorFactory.HUE_RED) {
                    float f7 = this.gapBetweenPaths;
                    pointF = pointF4;
                    drawQuadrilateral(canvas, this.computedBorderColors.getTop(), f2 - f7, f4, pointF3.x - f7, pointF3.y, pointF4.x + f7, pointF4.y, f3 + f7, f4);
                } else {
                    pointF = pointF4;
                }
                if (rectFComputeBorderInsets.right > BitmapDescriptorFactory.HUE_RED) {
                    float f8 = this.gapBetweenPaths;
                    PointF pointF7 = pointF;
                    pointF2 = pointF6;
                    drawQuadrilateral(canvas, this.computedBorderColors.getRight(), f3, f4 - f8, pointF7.x, pointF7.y - f8, pointF6.x, pointF6.y + f8, f3, f5 + f8);
                } else {
                    pointF2 = pointF6;
                }
                if (rectFComputeBorderInsets.bottom > BitmapDescriptorFactory.HUE_RED) {
                    ...
                    drawQuadrilateral(canvas, this.computedBorderColors.getBottom(), f2 - f9, f5, pointF5.x - f9, pointF5.y, pointF8.x + f9, pointF8.y, f3 + f9, f5);
                }
