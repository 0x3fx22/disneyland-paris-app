...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m4485boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m4486constructorimpl(@ColorInt @NotNull Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m4488equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m4493unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4489equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m4490hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m4492toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m4488equalsimpl(this.edgeColors, obj);
    }

    public int hashCode() {
        return m4490hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m4492toStringimpl(this.edgeColors);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m4493unboximpl() {
    ...
    public static /* synthetic */ Integer[] m4487constructorimpl$default(Integer[] numArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m4486constructorimpl(numArr);
    }
    ...
    public static final ColorEdges m4491resolveimpl(Integer[] numArr, int i, @NotNull Context context) {
