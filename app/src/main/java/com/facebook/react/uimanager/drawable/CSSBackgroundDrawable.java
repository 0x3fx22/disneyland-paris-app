...
public class CSSBackgroundDrawable extends Drawable {
    ...
    /* JADX INFO: renamed from: com.facebook.react.uimanager.drawable.CSSBackgroundDrawable$1 */
    ...
    private static PathEffect getPathEffect(BorderStyle borderStyle, float f) {
        int i = C32941.$SwitchMap$com$facebook$react$uimanager$style$BorderStyle[borderStyle.ordinal()];
        if (i == 2) {
            float f2 = f * 3.0f;
        ...
        if (directionAwareBorderInsets.top > BitmapDescriptorFactory.HUE_RED || directionAwareBorderInsets.bottom > BitmapDescriptorFactory.HUE_RED || directionAwareBorderInsets.left > BitmapDescriptorFactory.HUE_RED || directionAwareBorderInsets.right > BitmapDescriptorFactory.HUE_RED) {
            ...
            if (directionAwareBorderInsets.top != fullBorderWidth || directionAwareBorderInsets.bottom != fullBorderWidth || directionAwareBorderInsets.left != fullBorderWidth || directionAwareBorderInsets.right != fullBorderWidth || borderColor != borderColor8 || i4 != borderColor8 || borderColor3 != borderColor8 || borderColor7 != borderColor8) {
                ...
                if (directionAwareBorderInsets.top > BitmapDescriptorFactory.HUE_RED) {
                    drawQuadrilateral(canvas, i4, f - 0.8f, f3, pointF2.x - 0.8f, pointF2.y, pointF3.x + 0.8f, pointF3.y, f2 + 0.8f, f3);
                }
        ...
        if (iRound > 0 || iRound3 > 0 || iRound2 > 0 || iRound4 > 0) {
            ...
            if (iRound2 > 0) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0236: MOVE (r10v8 'f10' float) = (r10v5 int) A[DECLARE_VAR] in method: com.facebook.react.uimanager.drawable.CSSBackgroundDrawable.drawRectangularBackgroundWithBorders(android.graphics.Canvas):void, file: classes3.dex
