        ...
        switch (prop.hashCode()) {
            ...
            case -1971292586:
                if (prop.equals(BORDER_RIGHT_WIDTH)) {
                    return map.isNull(BORDER_RIGHT_WIDTH) || map.getDouble(BORDER_RIGHT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            case -1470826662:
            ...
            case -1452542531:
                if (prop.equals(BORDER_TOP_WIDTH)) {
                    return map.isNull(BORDER_TOP_WIDTH) || map.getDouble(BORDER_TOP_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            case -1308858324:
            ...
            case -1290574193:
                if (prop.equals(BORDER_BOTTOM_WIDTH)) {
                    return map.isNull(BORDER_BOTTOM_WIDTH) || map.getDouble(BORDER_BOTTOM_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            case -1267206133:
            ...
            case -223992013:
                if (prop.equals(BORDER_LEFT_WIDTH)) {
                    return map.isNull(BORDER_LEFT_WIDTH) || map.getDouble(BORDER_LEFT_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            case 306963138:
            ...
            case 741115130:
                if (prop.equals(BORDER_WIDTH)) {
                    return map.isNull(BORDER_WIDTH) || map.getDouble(BORDER_WIDTH) == AudioStats.AUDIO_AMPLITUDE_NONE;
                }
                return false;
            case 762983977:
