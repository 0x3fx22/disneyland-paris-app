...
public class UIViewOperationQueue {
    ...
    private final class UpdateLayoutOperation extends ViewOperation {
        ...
        private final int f3396mX;

        /* JADX INFO: renamed from: mY */
        private final int f3397mY;
        ...
        public void execute() {
            ...
            UIViewOperationQueue.this.mNativeViewHierarchyManager.updateLayout(this.mParentTag, this.mTag, this.f3396mX, this.f3397mY, this.mWidth, this.mHeight, this.mLayoutDirection);
        }
    }
    ...
    */
    ...
    public void flushPendingBatches() {
        if (this.mIsInIllegalUIState) {
            FLog.m1331w(ReactConstants.TAG, "Not flushing pending UI operations because of previously thrown Exception");
            return;
        }
        synchronized (this.mDispatchRunnablesLock) {
