...
public final class BackgroundDrawable extends Drawable {
    ...
    private final void updatePath() {
        ...
        if (this.needUpdatePath) {
            ...
            float fDpToPx = BitmapDescriptorFactory.HUE_RED;
            if (Intrinsics.areEqual(fValueOf, BitmapDescriptorFactory.HUE_RED)) {
                RectF rectF2 = this.computedBorderInsets;
                if (Intrinsics.areEqual(rectF2 != null ? Float.valueOf(rectF2.top) : null, BitmapDescriptorFactory.HUE_RED)) {
                    RectF rectF3 = this.computedBorderInsets;
                    if (Intrinsics.areEqual(rectF3 != null ? Float.valueOf(rectF3.right) : null, BitmapDescriptorFactory.HUE_RED)) {
                        RectF rectF4 = this.computedBorderInsets;
                        if (Intrinsics.areEqual(rectF4 != null ? Float.valueOf(rectF4.bottom) : null, BitmapDescriptorFactory.HUE_RED)) {
                            z = false;
                        } else {
                            z = true;
                        }
