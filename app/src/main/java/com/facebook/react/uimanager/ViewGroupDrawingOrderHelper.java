...
public class ViewGroupDrawingOrderHelper {
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        if (iArr != null && (i2 >= iArr.length || iArr[i2] >= i)) {
            FLog.m1333w(ReactConstants.TAG, "getChildDrawingOrder index out of bounds! Please check any custom view manipulations you may have done. childCount = %d, index = %d", Integer.valueOf(i), Integer.valueOf(i2));
            update();
        }
