...
public class LayoutShadowNode extends ReactShadowNodeImpl {
        ...
        void setFromDynamic(Dynamic dynamic) {
            ...
            if (dynamic.getType() == ReadableType.String) {
                ...
                if (strAsString.equals("auto")) {
                    ...
                    FLog.m1331w(ReactConstants.TAG, "Unknown value: " + strAsString);
                    this.unit = YogaUnit.UNDEFINED;
                    this.value = Float.NaN;
                    return;
                }
    ...
    public void setWidth(Dynamic dynamic) {
        ...
        int i = C32761.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public void setFlexDirection(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "column-reverse":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for flexDirection: " + str);
                setFlexDirection(YogaFlexDirection.COLUMN);
                break;
        }
    }
    ...
    public void setFlexWrap(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "wrap":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for flexWrap: " + str);
                setFlexWrap(YogaWrap.NO_WRAP);
                break;
        }
    }
    ...
    public void setAlignSelf(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "space-around":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for alignSelf: " + str);
                setAlignSelf(YogaAlign.AUTO);
                break;
        }
    }
    ...
    public void setAlignItems(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "space-around":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for alignItems: " + str);
                setAlignItems(YogaAlign.STRETCH);
                break;
        }
    }
    ...
    public void setAlignContent(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "space-evenly":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for alignContent: " + str);
                setAlignContent(YogaAlign.FLEX_START);
                break;
        }
    }
    ...
    public void setJustifyContent(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "space-evenly":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for justifyContent: " + str);
                setJustifyContent(YogaJustify.FLEX_START);
                break;
        }
    }
    ...
    public void setOverflow(@Nullable String str) {
        ...
        switch (str) {
            ...
            case "visible":
                ...
                break;
            default:
                FLog.m1331w(ReactConstants.TAG, "invalid value for overflow: " + str);
                setOverflow(YogaOverflow.VISIBLE);
                break;
        }
    }
    ...
    public void setDisplay(@Nullable String str) {
        ...
        FLog.m1331w(ReactConstants.TAG, "invalid value for display: " + str);
        setDisplay(YogaDisplay.FLEX);
    }
    ...
    public void setMargins(int i, Dynamic dynamic) {
        ...
        this.mTempYogaValue.setFromDynamic(dynamic);
        int i2 = C32761.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
        if (i2 == 1 || i2 == 2) {
    ...
    public void setPosition(@Nullable String str) {
        ...
        FLog.m1331w(ReactConstants.TAG, "invalid value for position: " + str);
        setPositionType(YogaPositionType.RELATIVE);
    }
