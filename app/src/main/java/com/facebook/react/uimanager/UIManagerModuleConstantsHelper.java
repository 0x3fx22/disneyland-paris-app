...
public class UIManagerModuleConstantsHelper {
    ...
    public static Map<String, Object> getDefaultExportableEventTypes() {
        return MapBuilder.m1374of(BUBBLING_EVENTS_KEY, UIManagerModuleConstants.getBubblingEventTypeConstants(), DIRECT_EVENTS_KEY, UIManagerModuleConstants.getDirectEventTypeConstants());
    }
    ...
    private static void validateDirectEventNames(String str, @Nullable Map<String, Object> map) {
        ...
        for (String str3 : map.keySet()) {
            ...
            if (obj != null && (obj instanceof Map) && (str2 = (String) ((Map) obj).get("registrationName")) != null && str3.startsWith(ViewProps.TOP) && str2.startsWith("on") && !str3.substring(3).equals(str2.substring(2))) {
                FLog.m1291e(TAG, String.format("Direct event name for '%s' doesn't correspond to the naming convention, expected 'topEventName'->'onEventName', got '%s'->'%s'", str, str3, str2));
            }
        }
    }
