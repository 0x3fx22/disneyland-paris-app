...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    private class ResponderImpl implements Responder {
        ...
        public void respond(Object obj) {
            try {
                ...
                FLog.m1292e(JSPackagerClient.TAG, "Responding failed", e);
            }
        }
        ...
        public void error(Object obj) {
            try {
                ...
                FLog.m1292e(JSPackagerClient.TAG, "Responding with error failed", e);
            }
        }
    }
    ...
    public void onMessage(String str) {
        try {
            ...
            String strOptString = jSONObject.optString(TCEventPropertiesNames.TCE_METHOD);
            Object objOpt = jSONObject.opt("id");
            Object objOpt2 = jSONObject.opt("params");
            if (iOptInt != 2) {
                FLog.m1291e(TAG, "Message with incompatible or missing version of protocol received: " + iOptInt);
                return;
            }
            ...
            FLog.m1292e(TAG, "Handling the message failed", e);
        }
    }

    @Override // com.facebook.react.packagerconnection.ReconnectingWebSocket.MessageCallback
    public void onMessage(ByteString byteString) {
        FLog.m1331w(TAG, "Websocket received message with payload of unexpected type binary");
    }
    ...
    private void abortOnMessage(Object obj, String str) {
        ...
        FLog.m1291e(TAG, "Handling the message failed with reason: " + str);
    }
}
