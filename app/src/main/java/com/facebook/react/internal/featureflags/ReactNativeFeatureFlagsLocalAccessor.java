...
public final class ReactNativeFeatureFlagsLocalAccessor implements ReactNativeFeatureFlagsAccessor {
    ...
    public boolean mo1381xd4703a8a() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.mo1381xd4703a8a());
