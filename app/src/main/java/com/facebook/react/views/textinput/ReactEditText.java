...
public class ReactEditText extends AppCompatEditText {
    ...
    protected void finalize() {
        if (DEBUG_MODE) {
            FLog.m1291e(this.TAG, "finalize[" + getId() + "] delete cached spannable");
        }
    ...
    public void setSelection(int i, int i2) {
        if (DEBUG_MODE) {
            FLog.m1291e(this.TAG, "setSelection[" + getId() + "]: " + i + " " + i2);
        }
    ...
    protected void onSelectionChanged(int i, int i2) {
        if (DEBUG_MODE) {
            FLog.m1291e(this.TAG, "onSelectionChanged[" + getId() + "]: " + i + " " + i2);
        }
    ...
    public void maybeSetText(ReactTextUpdate reactTextUpdate) {
        if (!(isSecureText() && TextUtils.equals(getText(), reactTextUpdate.getText())) && canUpdateWithEventCount(reactTextUpdate.getJsEventCounter())) {
            if (DEBUG_MODE) {
                FLog.m1291e(this.TAG, "maybeSetText[" + getId() + "]: current text: " + ((Object) getText()) + " update: " + ((Object) reactTextUpdate.getText()));
            }
    ...
    private void updateImeOptions() {
        ...
        if (this.mDisableFullscreen) {
            setImeOptions(i | PendingIntentCompat.FLAG_MUTABLE);
        } else {
            setImeOptions(i);
        }
    }
    ...
    private class TextWatcherDelegator implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            if (ReactEditText.DEBUG_MODE) {
                FLog.m1291e(ReactEditText.this.TAG, "onTextChanged[" + ReactEditText.this.getId() + "]: " + ((Object) charSequence) + " " + i + " " + i2 + " " + i3);
            }
            ReactEditText reactEditText = ReactEditText.this;
            if (!reactEditText.mIsSettingTextFromJS && reactEditText.mListeners != null) {
                Iterator it = ReactEditText.this.mListeners.iterator();
