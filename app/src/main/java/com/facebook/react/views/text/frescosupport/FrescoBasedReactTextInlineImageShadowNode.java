...
class FrescoBasedReactTextInlineImageShadowNode extends ReactTextInlineImageShadowNode {
    ...
    public void setWidth(Dynamic dynamic) {
        if (dynamic.getType() == ReadableType.Number) {
            ...
            FLog.m1331w(ReactConstants.TAG, "Inline images must not have percentage based width");
    ...
    public void setHeight(Dynamic dynamic) {
        if (dynamic.getType() == ReadableType.Number) {
            ...
            FLog.m1331w(ReactConstants.TAG, "Inline images must not have percentage based height");
