...
public class ReactViewManager extends ReactClippingViewManager<ReactViewGroup> {
    ...
    public void setHitSlop(@NotNull ReactViewGroup view, @NotNull Dynamic hitSlop) {
        ...
        if (i == 1) {
            ...
            view.setHitSlopRect(new Rect(m1401px(readableMapAsMap, ViewProps.LEFT), m1401px(readableMapAsMap, ViewProps.TOP), m1401px(readableMapAsMap, ViewProps.RIGHT), m1401px(readableMapAsMap, ViewProps.BOTTOM)));
            return;
        }
        if (i == 2) {
            ...
            FLog.m1331w(ReactConstants.TAG, "Invalid type for 'hitSlop' value " + hitSlop.getType());
            view.setHitSlopRect(null);
        }
    }

    /* JADX INFO: renamed from: px */
    private final int m1401px(ReadableMap readableMap, String str) {
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapsKt.mutableMapOf(TuplesKt.m1842to(HOTSPOT_UPDATE_KEY, 1), TuplesKt.m1842to("setPressed", 2));
    }
