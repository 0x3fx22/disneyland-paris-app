...
final class IntBufferBatchMountItem implements BatchMountItem {
    ...
    public void execute(MountingManager mountingManager) {
        ...
        if (surfaceManager == null) {
            FLog.m1293e(TAG, "Skipping batch of MountItems; no SurfaceMountingManager found for [%d].", Integer.valueOf(this.mSurfaceId));
            return;
        }
        if (surfaceManager.isStopped()) {
            FLog.m1293e(TAG, "Skipping batch of MountItems; was stopped [%d].", Integer.valueOf(this.mSurfaceId));
            return;
        }
        if (ReactNativeFeatureFlags.enableFabricLogs()) {
            FLog.m1280d(TAG, "Executing IntBufferBatchMountItem on surface [%d]", Integer.valueOf(this.mSurfaceId));
        }
                ...
                for (int i9 = 0; i9 < i8; i9++) {
                    if (i7 == 2) {
                        ...
                        if (i7 == 32) {
                            ...
                            FLog.m1291e(TAG, "String so far: " + sb.toString());
