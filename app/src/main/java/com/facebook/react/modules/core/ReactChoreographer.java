...
public final class ReactChoreographer {
    ...
    @Metadata(m1835d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\n\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0014\u0010\u0002\u001a\u00020\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\f¨\u0006\r"}, m1836d2 = {"Lcom/facebook/react/modules/core/ReactChoreographer$CallbackType;", "", "order", "", "<init>", "(Ljava/lang/String;II)V", "getOrder$ReactAndroid_release", "()I", "PERF_MARKERS", "DISPATCH_UI", "NATIVE_ANIMATED_MODULE", "TIMERS_EVENTS", "IDLE_EVENT", "ReactAndroid_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (frameCallbackPollFirst != null) {
                            ...
                            FLog.m1291e(ReactConstants.TAG, "Tried to execute non-existent frame callback");
                        }
                    }
                }
        ...
        synchronized (this.callbackQueues) {
            try {
                if (this.callbackQueues[type.getOrder()].removeFirstOccurrence(frameCallback)) {
                    ...
                    FLog.m1291e(ReactConstants.TAG, "Tried to remove non-existent frame callback");
                }
                Unit unit = Unit.INSTANCE;
            } catch (Throwable th) {
                throw th;
