...
public final class LogBoxDialogSurfaceDelegate implements SurfaceDelegate {
    ...
    public void createContentView(@NotNull String appKey) {
        ...
        if (viewCreateRootView == null) {
            RNLog.m1397e("Unable to launch logbox because react was unable to create the root view");
        }
    }
    ...
    public void show() {
        ...
        if (currentActivity == null || currentActivity.isFinishing()) {
            RNLog.m1397e("Unable to launch logbox because react activity is not available, here is the error that logbox would've displayed: ");
            return;
        }
