...
public final class PausedInDebuggerOverlayDialogManager implements PausedInDebuggerOverlayManager {
    ...
    public static final void showPausedInDebuggerOverlay$lambda$3(PausedInDebuggerOverlayDialogManager pausedInDebuggerOverlayDialogManager, String str, final DevSupportManager.PausedInDebuggerOverlayCommandListener pausedInDebuggerOverlayCommandListener) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C3142R.layout.paused_in_debugger_view, (ViewGroup) null);
        Intrinsics.checkNotNullExpressionValue(viewInflate, "inflate(...)");
        InstrumentationCallbacks.setOnClickListenerCalled(viewInflate.findViewById(C3142R.id.button), new View.OnClickListener() { // from class: com.facebook.react.devsupport.PausedInDebuggerOverlayDialogManager$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                pausedInDebuggerOverlayCommandListener.onResume();
            }
        });
        ((TextView) viewInflate.findViewById(C3142R.id.button_text)).setText(str);
        Dialog dialog2 = new Dialog(context, C3142R.style.NoAnimationDialog);
        ...
        if (window != null) {
            ...
            window.setBackgroundDrawableResource(C3142R.drawable.paused_in_debugger_background);
        }
