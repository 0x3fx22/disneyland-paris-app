...
public abstract class DevSupportManagerBase implements DevSupportManager {
    ...
    private void logJSException(Exception exc) {
        ...
        if (exc instanceof JavascriptException) {
            FLog.m1292e(ReactConstants.TAG, "Exception in native call from JS", exc);
    ...
    public void showNewJavaError(@Nullable String str, Throwable th) {
        FLog.m1292e(ReactConstants.TAG, "Exception in native call", th);
    ...
    public void showDevOptionsDialog() {
        ...
        if (this.mDevOptionsDialog == null && this.mIsDevSupportEnabled && !ActivityManager.isUserAMonkey()) {
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C3142R.string.catalyst_reload), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.2
                ...
                public void onOptionSelected() {
                    if (!DevSupportManagerBase.this.mDevSettings.isJSDevModeEnabled() && DevSupportManagerBase.this.mDevSettings.isHotModuleReplacementEnabled()) {
                        Toast.makeText(DevSupportManagerBase.this.mApplicationContext, DevSupportManagerBase.this.mApplicationContext.getString(C3142R.string.catalyst_hot_reloading_auto_disable), 1).show();
            ...
            if (this.mDevSettings.getIsDeviceDebugEnabled()) {
                ...
                String string3 = this.mApplicationContext.getString(z ? C3142R.string.catalyst_debug_open : C3142R.string.catalyst_debug_open_disabled);
                if (!z) {
                    hashSet.add(string3);
                }
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C3142R.string.catalyst_change_bundle_location), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda5
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
                    this.f$0.lambda$showDevOptionsDialog$3();
                }
            });
            linkedHashMap.put(this.mApplicationContext.getString(C3142R.string.catalyst_inspector_toggle), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.4
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public void onOptionSelected() {
            ...
            if (this.mDevSettings.isHotModuleReplacementEnabled()) {
                string = this.mApplicationContext.getString(C3142R.string.catalyst_hot_reloading_stop);
            } else {
                string = this.mApplicationContext.getString(C3142R.string.catalyst_hot_reloading);
            }
            ...
            if (this.mDevSettings.isFpsDebugEnabled()) {
                string2 = this.mApplicationContext.getString(C3142R.string.catalyst_perf_monitor_stop);
            } else {
                string2 = this.mApplicationContext.getString(C3142R.string.catalyst_perf_monitor);
            }
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C3142R.string.catalyst_settings), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda8
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
            ...
            Activity currentActivity = this.mReactInstanceDevHelper.getCurrentActivity();
            if (currentActivity == null || currentActivity.isFinishing()) {
                FLog.m1291e(ReactConstants.TAG, "Unable to launch dev options menu because react activity isn't available");
                return;
            }
            LinearLayout linearLayout = new LinearLayout(currentActivity);
            linearLayout.setOrientation(1);
            TextView textView = new TextView(currentActivity);
            textView.setText(currentActivity.getString(C3142R.string.catalyst_dev_menu_header, getUniqueTag()));
            ...
            if (jSExecutorDescription != null) {
                ...
                textView2.setText(currentActivity.getString(C3142R.string.catalyst_dev_menu_sub_header, jSExecutorDescription));
                textView2.setPadding(0, 20, 0, 0);
                textView2.setGravity(17);
                textView2.setTextSize(14.0f);
                linearLayout.addView(textView2);
            }
            AlertDialog alertDialogCreate = new AlertDialog.Builder(currentActivity).setCustomTitle(linearLayout).setAdapter(new ArrayAdapter<String>(currentActivity, R.layout.simple_list_item_1, (String[]) linkedHashMap.keySet().toArray(new String[0])) { // from class: com.facebook.react.devsupport.DevSupportManagerBase.5
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$3() {
        Activity currentActivity = this.mReactInstanceDevHelper.getCurrentActivity();
        if (currentActivity == null || currentActivity.isFinishing()) {
            FLog.m1291e(ReactConstants.TAG, "Unable to launch change bundle location because react activity is not available");
            return;
        }
        final EditText editText = new EditText(currentActivity);
        editText.setHint("localhost:8081");
        new AlertDialog.Builder(currentActivity).setTitle(this.mApplicationContext.getString(C3142R.string.catalyst_change_bundle_location)).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.3
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$4() {
        ...
        Toast.makeText(context, context.getString(C3142R.string.catalyst_hot_reloading_auto_enable), 1).show();
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$5() {
        if (!this.mDevSettings.isFpsDebugEnabled()) {
            ...
            if (currentActivity == null) {
                FLog.m1291e(ReactConstants.TAG, "Unable to get reference to react activity");
            } else {
    ...
    public boolean hasUpToDateJSBundleInCache() {
        if (this.mIsDevSupportEnabled && this.mJSBundleDownloadedFile.exists()) {
            try {
                ...
                FLog.m1291e(ReactConstants.TAG, "DevSupport is unable to get current app info");
            }
        }
        return false;
    }
    ...
    private void showDevLoadingViewForUrl(String str) {
        ...
        try {
            ...
            this.mDevLoadingViewManager.showMessage(this.mApplicationContext.getString(C3142R.string.catalyst_loading_from_url, url.getHost() + ":" + port));
            this.mDevLoadingViewVisible = true;
        } catch (MalformedURLException e) {
            FLog.m1291e(ReactConstants.TAG, "Bundle url format is invalid. \n\n" + e.toString());
        }
    }
    ...
    protected void showDevLoadingViewForRemoteJSEnabled() {
        ...
        this.mDevLoadingViewManager.showMessage(context.getString(C3142R.string.catalyst_debug_connecting));
        this.mDevLoadingViewVisible = true;
    }
    ...
    public /* synthetic */ void lambda$fetchSplitBundleAndCreateBundleLoader$9(String str, File file, CallbackWithBundleLoader callbackWithBundleLoader) {
        ...
        this.mDevServerHelper.downloadBundleFromURL(new C32246(str, file, callbackWithBundleLoader), file, str, null);
    }

    /* JADX INFO: renamed from: com.facebook.react.devsupport.DevSupportManagerBase$6 */
    class C32246 implements DevBundleDownloadListener {
        ...
        C32246(String str, File file, CallbackWithBundleLoader callbackWithBundleLoader) {
    ...
    public void reloadJSFromServer(String str, final BundleLoadCallback bundleLoadCallback) {
        ...
        this.mDevServerHelper.downloadBundleFromURL(new DevBundleDownloadListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.7
            ...
            public void onFailure(Exception exc) {
                ...
                FLog.m1292e(ReactConstants.TAG, "Unable to download JS bundle", exc);
    ...
    public /* synthetic */ void lambda$reportBundleLoadingFailure$11(Exception exc) {
        if (exc instanceof DebugServerException) {
            ...
            showNewJavaError(this.mApplicationContext.getString(C3142R.string.catalyst_reload_error), exc);
        }
    }
    ...
    public void reload() {
        ...
        if (this.mIsDevSupportEnabled) {
            ...
            this.mDevServerHelper.openPackagerConnection(getClass().getSimpleName(), new C32268());
            return;
        }
    ...
    class C32268 implements DevServerHelper.PackagerCommandListener {
        C32268() {
        }
    ...
    public void lambda$showDevOptionsDialog$2() {
        this.mDevServerHelper.openDebugger(this.mCurrentReactContext, this.mApplicationContext.getString(C3142R.string.catalyst_open_debugger_error));
    }
