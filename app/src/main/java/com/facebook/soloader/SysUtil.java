...
public final class SysUtil {
    ...
    public static void deleteOrThrow(File file) throws IOException {
        ...
        if (parentFile != null && !parentFile.canWrite() && !parentFile.setWritable(true)) {
            LogUtil.m1405e("SysUtil", "Enable write permission failed: " + parentFile);
        }
    ...
    private static final class LollipopSysdeps {
        ...
        public static String[] getSupportedAbis() {
            ...
            try {
                ...
                LogUtil.m1405e("SysUtil", String.format("Could not read /proc/self/exe. Falling back to default ABI list: %s. errno: %d Err msg: %s", Arrays.toString(strArr), Integer.valueOf(e.errno), e.getMessage()));
        ...
        while (!stack.isEmpty()) {
            ...
            if (file2.isDirectory()) {
                ...
                try {
                    ...
                    LogUtil.m1405e("SysUtil", "Syncing failed for " + file2 + ": " + e.getMessage());
                }
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (!file.setWritable(false)) {
                    LogUtil.m1411w("SysUtil", "error removing " + file.getCanonicalPath() + " write permission");
                }
                return fileLocker;
            } catch (Throwable th) {
                th = th;
    ...
    public static String getClassLoaderLdLoadLibrary() {
        ...
        try {
            ...
            LogUtil.m1406e("SysUtil", "Cannot call getLdLibraryPath", e);
            return null;
        }
    }
}
