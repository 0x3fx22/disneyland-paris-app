...
public class DirectApkSoSource extends SoSource implements RecoverableSoSource {
    ...
    public int loadLibrary(String str, int i, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        ...
        for (String str2 : this.mDirectApkLdPaths) {
            ...
            if (TextUtils.isEmpty(str2) || set == null || !set.contains(str)) {
                LogUtil.m1409v(SoLoader.TAG, str + " not found on " + str2);
            } else {
                loadDependencies(str2, str, i, threadPolicy);
                try {
                    i |= 4;
                    SoLoader.sSoFileLoader.load(str2 + File.separator + str, i);
                    LogUtil.m1403d(SoLoader.TAG, str + " found on " + str2);
                    return 1;
                } catch (UnsatisfiedLinkError e) {
                    LogUtil.m1412w(SoLoader.TAG, str + " not found on " + str2 + " flag: " + i, e);
                }
            }
        }
        return 0;
    ...
    private static String getFallbackApkLdPath(String str) {
        ...
        if (str == null || str.isEmpty()) {
            ...
            LogUtil.m1411w(SoLoader.TAG, sb.toString());
            return null;
        }
        if (supportedAbis == null || supportedAbis.length == 0) {
            ...
            LogUtil.m1411w(SoLoader.TAG, sb2.toString());
            return null;
        }
    ...
    private void buildLibDepsCache(String str, String str2) throws IOException {
        ...
        try {
            ...
            if (entry == null) {
                LogUtil.m1405e(SoLoader.TAG, libraryPathInApk + " not found in " + apkPathFromLdPath);
                zipFile.close();
                return;
            }
