...
public final class WebpUtil {
    ...
    private final String getHeader(byte[] header) {
        ...
        for (byte b : header) {
            sb.append((char) (UShort.m5362constructorimpl(b) & UShort.MAX_VALUE));
        }
