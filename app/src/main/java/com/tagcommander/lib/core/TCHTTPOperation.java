...
public class TCHTTPOperation {
    ...
    /* JADX INFO: renamed from: com.tagcommander.lib.core.TCHTTPOperation$2 */
    static /* synthetic */ class C46262 {

        /* JADX INFO: renamed from: $SwitchMap$com$tagcommander$lib$core$TCHTTPOperationInformation$EType */
        static final /* synthetic */ int[] f3701xec335a7a;
        ...
        static {
            ...
            try {
                f3701xec335a7a[TCHTTPOperationInformation.EType.CONFIGURATION.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3701xec335a7a[TCHTTPOperationInformation.EType.VENDOR_DISCLOSURE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3701xec335a7a[TCHTTPOperationInformation.EType.PARTNER.ordinal()] = 4;
    ...
    private void sendResponse(String str) {
        int i = C46262.f3701xec335a7a[this.information.hitType.ordinal()];
        if (i == 1) {
