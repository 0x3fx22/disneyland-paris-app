...
import com.tagcommander.lib.p193serverside.schemas.TCDevice;
...
public class TCServerSide implements TCEventManager.TCServerSideStateListener {
    ...
    public TCServerSide(int i, String str, Context context) {
        this.appContext = context.getApplicationContext();
        initTagCommander(i, str, context, ETCConsentBehaviour.PB_DEFAULT_BEHAVIOUR);
    }

    public TCServerSide(int i, String str, Context context, ETCConsentBehaviour eTCConsentBehaviour) {
        this.appContext = context.getApplicationContext();
        initTagCommander(i, str, context, eTCConsentBehaviour);
    }

    void initTagCommander(int i, String str, Context context, ETCConsentBehaviour eTCConsentBehaviour) {
        ...
        int i2 = C46322.$SwitchMap$com$tagcommander$lib$core$ETCConsentBehaviour[eTCConsentBehaviour.ordinal()];
        if (i2 == 1) {
            try {
    ...
    /* JADX INFO: renamed from: com.tagcommander.lib.serverside.TCServerSide$2 */
    static /* synthetic */ class C46322 {
    ...
    public void execute(@NonNull TCEvent tCEvent) {
