...
public class TCRefundEvent extends TCECommerceEvent {
    ...
    public boolean verifyEvent() {
        return TCUtils.testString(this.f3705ID) & TCUtils.testString(this.currency) & TCUtils.testString(this.type) & (this.revenue != null) & (this.value != null);
    }
    ...
    public JSONObject getJsonObject() {
        ...
        try {
            if (testString(this.f3705ID)) {
                jsonObject.put("id", this.f3705ID);
            }
