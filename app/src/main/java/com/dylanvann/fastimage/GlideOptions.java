...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    @NonNull
    @CheckResult
    public static GlideOptions sizeMultiplierOf(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
    ...
    @NonNull
    @CheckResult
    public static GlideOptions encodeQualityOf(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
    ...
    @NonNull
    @CheckResult
    public GlideOptions sizeMultiplier(@FloatRange(from = AudioStats.AUDIO_AMPLITUDE_NONE, m3to = 1.0d) float f) {
    ...
    public GlideOptions mo2946clone() {
        return (GlideOptions) super.mo2946clone();
    }
    ...
    @NonNull
    @CheckResult
    public GlideOptions encodeQuality(@IntRange(from = 0, m4to = WebToNativeBridgeBase.CLOSE_WAIT_DURATION_MILLISECONDS) int i) {
