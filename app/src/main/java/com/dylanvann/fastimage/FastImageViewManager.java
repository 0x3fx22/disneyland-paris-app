...
class FastImageViewManager extends SimpleViewManager<FastImageViewWithUrl> implements FastImageProgressListener, FastImageViewManagerInterface<FastImageViewWithUrl> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(REACT_ON_LOAD_START_EVENT, MapBuilder.m1373of("registrationName", REACT_ON_LOAD_START_EVENT)).put(REACT_ON_PROGRESS_EVENT, MapBuilder.m1373of("registrationName", REACT_ON_PROGRESS_EVENT)).put("onFastImageLoad", MapBuilder.m1373of("registrationName", "onFastImageLoad")).put("onFastImageError", MapBuilder.m1373of("registrationName", "onFastImageError")).put("onFastImageLoadEnd", MapBuilder.m1373of("registrationName", "onFastImageLoadEnd")).build();
    }
