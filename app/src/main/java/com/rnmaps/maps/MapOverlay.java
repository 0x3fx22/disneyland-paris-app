...
public class MapOverlay extends MapFeature {
    ...
    public void setImage(String str) {
        ...
        if (str.startsWith("http://") || str.startsWith("https://") || str.startsWith("file://") || str.startsWith("asset://") || str.startsWith("data:")) {
            ...
            this.dataSource.subscribe(new C45951(), Executors.newSingleThreadExecutor());
            return;
        }
        this.bitmapDescriptor = getBitmapDescriptorByName(str);
    }

    /* JADX INFO: renamed from: com.rnmaps.maps.MapOverlay$1 */
    class C45951 extends BaseDataSubscriber {
