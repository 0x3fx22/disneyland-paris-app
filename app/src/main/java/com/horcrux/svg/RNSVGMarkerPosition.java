...
class RNSVGMarkerPosition {
    ...
    private static double SlopeAngleRadians(Point point) {
        return Math.atan2(point.f3640y, point.f3639x);
    }
    ...
    private static double CurrentAngle(RNSVGMarkerType rNSVGMarkerType) {
        ...
        int i = C43701.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[rNSVGMarkerType.ordinal()];
        if (i == 1) {
    ...
    private static Point subtract(Point point, Point point2) {
        return new Point(point2.f3639x - point.f3639x, point2.f3640y - point.f3640y);
    }

    private static boolean isZero(Point point) {
        return point.f3639x == AudioStats.AUDIO_AMPLITUDE_NONE && point.f3640y == AudioStats.AUDIO_AMPLITUDE_NONE;
    }
    ...
    private static SegmentData ExtractPathElementFeatures(PathElement pathElement) {
        ...
        int i = C43701.$SwitchMap$com$horcrux$svg$ElementType[pathElement.type.ordinal()];
        if (i == 1) {
