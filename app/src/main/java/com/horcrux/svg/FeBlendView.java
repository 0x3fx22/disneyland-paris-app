...
class FeBlendView extends FilterPrimitiveView {
    ...
    public FeBlendView(ReactContext reactContext) {
        super(reactContext);
        this.mFilterSubregion.f3616mX = new SVGLength(AudioStats.AUDIO_AMPLITUDE_NONE);
        this.mFilterSubregion.f3617mY = new SVGLength(AudioStats.AUDIO_AMPLITUDE_NONE);
        this.mFilterSubregion.f3615mW = new SVGLength("100%");
        this.mFilterSubregion.f3614mH = new SVGLength("100%");
    }
    ...
    public Bitmap applyFilter(HashMap<String, Bitmap> map, Bitmap bitmap) {
        ...
        int i = C43641.$SwitchMap$com$horcrux$svg$FilterProperties$FeBlendMode[this.mMode.ordinal()];
        if (i == 1 || i == 2) {
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.FeBlendView$1 */
    static /* synthetic */ class C43641 {
