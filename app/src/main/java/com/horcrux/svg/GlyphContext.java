...
class GlyphContext {
    ...
    private void reset() {
        ...
        this.f3623mY = AudioStats.AUDIO_AMPLITUDE_NONE;
        this.f3622mX = AudioStats.AUDIO_AMPLITUDE_NONE;
    }
    ...
    double nextX(double d) {
        ...
        if (i < sVGLengthArr.length) {
            this.mDX = AudioStats.AUDIO_AMPLITUDE_NONE;
            this.mXIndex = i;
            this.f3622mX = PropHelper.fromRelative(sVGLengthArr[i], this.mWidth, AudioStats.AUDIO_AMPLITUDE_NONE, this.mScale, this.mFontSize);
        }
        double d2 = this.f3622mX + d;
        this.f3622mX = d2;
        return d2;
    }
    ...
    double nextY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDY = AudioStats.AUDIO_AMPLITUDE_NONE;
            this.mYIndex = i;
            this.f3623mY = PropHelper.fromRelative(sVGLengthArr[i], this.mHeight, AudioStats.AUDIO_AMPLITUDE_NONE, this.mScale, this.mFontSize);
        }
        return this.f3623mY;
    }
