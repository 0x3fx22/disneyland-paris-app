...
class SvgViewManager extends ReactViewManager implements RNSVGSvgViewAndroidManagerInterface<SvgView> {
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.SvgViewManager$1 */
    static /* synthetic */ class C44041 {
    ...
    public void setHitSlop(SvgView svgView, Dynamic dynamic) {
        int i = C44041.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()];
        if (i == 1) {
            ...
            if (i != 3) {
                FLog.m1331w(ReactConstants.TAG, "Invalid type for 'hitSlop' value " + dynamic.getType());
            }
