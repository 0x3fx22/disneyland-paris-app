...
class MarkerView extends GroupView {
    ...
    void renderMarker(Canvas canvas, Paint paint, float f, RNSVGMarkerPosition rNSVGMarkerPosition, float f2) {
        ...
        this.markerTransform.setTranslate((float) point.f3639x, (float) point.f3640y);
        ...
        RectF rectF = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) (relativeOnWidth(this.mMarkerWidth) / ((double) this.mScale)), (float) (relativeOnHeight(this.mMarkerHeight) / ((double) this.mScale)));
        if (this.mAlign != null) {
            float f4 = this.mMinX;
