...
class FeColorMatrixView extends FilterPrimitiveView {
    ...
    public Bitmap applyFilter(HashMap<String, Bitmap> map, Bitmap bitmap) {
        ...
        int i = C43651.$SwitchMap$com$horcrux$svg$FilterProperties$FeColorMatrixType[this.mType.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.FeColorMatrixView$1 */
