...
public abstract class VirtualView extends ReactViewGroup {
        ...
        if (this.mClipPath != null) {
            ...
            if (clipPathView != null) {
                ...
                if (i == 0) {
                    ...
                    FLog.m1331w(ReactConstants.TAG, "RNSVG: clipRule: " + this.mClipRule + " unrecognized");
                }
                this.mCachedClipPath = path;
            } else {
                FLog.m1331w(ReactConstants.TAG, "RNSVG: Undefined clipPath: " + this.mClipPath);
            }
        }
        return getClipPath();
    }
    ...
    public SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            FLog.m1291e(ReactConstants.TAG, "RNSVG: " + getClass().getName() + " should be descendant of a SvgView.");
        }
        return this.svgView;
    }
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        ...
        switch (C44081.$SwitchMap$com$horcrux$svg$SVGLength$UnitType[sVGLength.unit.ordinal()]) {
            case 1:
