...
class FeCompositeView extends FilterPrimitiveView {
    ...
    public Bitmap applyFilter(HashMap<String, Bitmap> map, Bitmap bitmap) {
        ...
        switch (C43661.$SwitchMap$com$horcrux$svg$FilterProperties$FeCompositeOperator[this.mOperator.ordinal()]) {
            case 1:
                bitmap2 = source2;
                canvas = canvas2;
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.FeCompositeView$1 */
    static /* synthetic */ class C43661 {
