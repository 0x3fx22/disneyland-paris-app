...
class FeFloodView extends FilterPrimitiveView {
    ...
    public void setFloodColor(@Nullable Dynamic dynamic) {
        ...
        if (type.equals(ReadableType.Number)) {
            this.floodColor = JavaOnlyArray.m1368of(0, Integer.valueOf(dynamic.asInt()));
    ...
    public void setFloodColor(@Nullable ReadableMap readableMap) {
        ...
        if (i == 0) {
            ...
            if (type.equals(ReadableType.Number)) {
                this.floodColor = JavaOnlyArray.m1368of(0, Integer.valueOf(readableMap.getInt("payload")));
            } else if (type.equals(ReadableType.Map)) {
                this.floodColor = JavaOnlyArray.m1368of(0, readableMap.getMap("payload"));
            }
        } else if (i == 1) {
            this.floodColor = JavaOnlyArray.m1368of(1, readableMap.getString("brushRef"));
        } else {
            this.floodColor = JavaOnlyArray.m1368of(Integer.valueOf(i));
        }
        invalidate();
    }
