...
import com.disney.p026id.android.EditableField;
import com.disney.p026id.android.NotInitialized;
import com.disney.p026id.android.OneID;
import com.disney.p026id.android.OneIDListener;
...
public final class OneidModule extends ReactContextBaseJavaModule {
    ...
    public OneidModule(@NotNull ReactApplicationContext reactContext) {
        ...
        this.oneIdListener = new OneIDListener() { // from class: com.oneid.OneidModule$oneIdListener$1
            @Override // com.disney.p026id.android.OneIDListener
    ...
    @ReactMethod
    public final void updateProfile(@NotNull String json, @NotNull Promise promise) throws NotInitialized {
    ...
    public final void internalGetSessionData(final boolean sinkEventNeeded, boolean serverUpdate, final EventId eventId, final Function1<? super Exception, Unit> onError, final Function1<? super EventResult, Unit> callback) throws NotInitialized {
        ...
        }, new C45432(this), callback, onError);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit internalGetSessionData$lambda$9(OneidModule oneidModule, boolean z, EventId eventId, Function1 function1, Function1 function2) throws NotInitialized {
        oneidModule.internalGetSessionData(z, false, eventId, function1, function2);
        return Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: com.oneid.OneidModule$internalGetSessionData$2 */
    /* synthetic */ class C45432 extends FunctionReferenceImpl implements Function2 {
        C45432(Object obj) {
