...
/* synthetic */ class OneidModule$launchProfileDelegate$1 extends FunctionReferenceImpl implements Function5 {
    ...
    public final void invoke(boolean z, boolean z2, EventId p2, Function1 function1, Function1 function2) throws NotInitialized {
        Intrinsics.checkNotNullParameter(p2, "p2");
        ((OneidModule) this.receiver).internalGetSessionData(z, z2, p2, function1, function2);
    }
}
