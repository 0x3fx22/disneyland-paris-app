...
/* JADX INFO: renamed from: com.appdynamics.eumagent.runtime.private.co */
/* JADX INFO: loaded from: classes2.dex */
public final class C2119co extends Throwable {
    public C2119co(Throwable th) {
        super(th);
    }
    ...
    /* JADX INFO: renamed from: a */
    public final <T extends Throwable> void m653a(Class<T> cls) throws T {
        Throwable cause = getCause();
        if (cause == null) {
            ADLog.logAgentError("Somehow a ClientCausedThrowable doesn't have a caused by", this);
        } else {
