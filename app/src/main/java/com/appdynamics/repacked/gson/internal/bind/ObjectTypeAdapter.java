...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    /* JADX INFO: renamed from: com.appdynamics.repacked.gson.internal.bind.ObjectTypeAdapter$2 */
    ...
    private Object tryBeginNesting(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i = C22132.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
        if (i == 1) {
