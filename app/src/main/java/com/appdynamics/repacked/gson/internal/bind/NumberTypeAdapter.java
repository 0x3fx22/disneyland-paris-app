...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    ...
    /* JADX INFO: renamed from: com.appdynamics.repacked.gson.internal.bind.NumberTypeAdapter$2 */
    static /* synthetic */ class C22112 {
    ...
    public Number read(JsonReader jsonReader) throws IOException {
        ...
        int i = C22112.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        if (i == 1) {
            jsonReader.nextNull();
            return null;
        }
