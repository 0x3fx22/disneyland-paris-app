...
public final class JsonTreeReader extends JsonReader {
    ...
    /* JADX INFO: renamed from: com.appdynamics.repacked.gson.internal.bind.JsonTreeReader$2 */
    ...
    public void skipValue() throws IOException {
        int i = C22082.$SwitchMap$com$google$gson$stream$JsonToken[peek().ordinal()];
        if (i == 1) {
            nextName(true);
            return;
        }
