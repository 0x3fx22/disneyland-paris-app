...
public final class OneIDSCALPController implements SCALPController {
    ...
    /* JADX INFO: renamed from: isLoaded$delegate, reason: from kotlin metadata */
    ...
    @Override // com.disney.p026id.android.SCALPController
    @Nullable
    ...
    @Nullable
    /* JADX INFO: renamed from: getMobileConfig$OneID_release, reason: from getter */
    ...
    public final void populateController(JSONObject config) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getMain()), null, null, new C29942(null), 3, null);
    }

    /* JADX INFO: renamed from: com.disney.id.android.OneIDSCALPController$populateController$2 */
    static final class C29942 extends SuspendLambda implements Function2 {
        int label;

        C29942(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return OneIDSCALPController.this.new C29942(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C29942) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final InputStream resourceStreamForLanguagePref$OneID_release(@NotNull Context context, @NotNull String languagePref) {
        ...
        try {
            ...
            logger$OneID_release.mo1257e(TAG2, "Unable to find resource stream for language: " + languagePref, e);
            return null;
        } catch (Exception e2) {
            Logger logger$OneID_release2 = getLogger$OneID_release();
            String TAG3 = TAG;
            Intrinsics.checkNotNullExpressionValue(TAG3, "TAG");
            logger$OneID_release2.mo1257e(TAG3, "Error opening stream for language: " + languagePref, e2);
            return null;
        }
    }
            ...
            try {
                ...
                if (text.length() > 0) {
                    try {
                        ...
                        String TAG2 = TAG;
                        Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
                        logger$OneID_release.mo1257e(TAG2, "Unable to serialize locally stored text file to JSON", e);
                    }
                }
            } catch (Throwable th) {
                try {
    ...
    public boolean isExpiredNotificationEnabled() {
        ...
        JSONObject jSONObject = this.siteConfig;
        if (jSONObject == null || (jSONObjectOptJSONObject = jSONObject.optJSONObject(BuildConfig.SESSION_KEY_REFERENCE)) == null || (jSONObjectOptJSONObject2 = jSONObjectOptJSONObject.optJSONObject("expiredNotification")) == null) {
            return false;
        }
        return jSONObjectOptJSONObject2.optBoolean("enabled");
    }
