...
import com.disney.p026id.android.OptionalConfigs;
import com.disney.p026id.android.SWID;
import com.disney.p026id.android.dagger.OneIDDagger;
import com.disney.p026id.android.databinding.ActivityLightboxBinding;
...
public class LightboxActivity extends AppCompatActivity implements LightboxWebView.WebViewHolder {
    ...
    @Metadata(m1835d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u0016\u0010\n\u001a\n \u000b*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u0014\u0010\r\u001a\u00020\u000eX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, m1836d2 = {"Lcom/disney/id/android/lightbox/LightboxActivity$Companion;", "", "()V", "ACTION_NAME_EXTRA", "", "CONFIGS_EXTRA", "EVENT_ID_EXTRA", "PAGE_EXTRA", "STANDARD_BACKGROUND_DIM_AMOUNT", "", "TAG", "kotlin.jvm.PlatformType", "UI_VERSION_EXTRA", "isPresenting", "Ljava/util/concurrent/atomic/AtomicBoolean;", "isPresenting$OneID_release", "()Ljava/util/concurrent/atomic/AtomicBoolean;", "OneID_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
            ...
            if (event != null) {
                ...
                if (lightboxActivity != null) {
                    ...
                    if (extras4 != null && (string = extras4.getString(ACTION_NAME_EXTRA)) != null) {
                        OneIDTrackerEvent.appendCodes$OneID_release$default(event, null, null, "previousAction(" + string + ")", 3, null);
                    }
                }
            }
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, null, null, new C30091(null), 3, null);
    }

    /* JADX INFO: renamed from: com.disney.id.android.lightbox.LightboxActivity$onDestroy$1 */
    static final class C30091 extends SuspendLambda implements Function2 {
        int label;

        C30091(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return LightboxActivity.this.new C30091(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C30091) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            LightboxActivity.this.runOnUiThread(new Runnable() { // from class: com.disney.id.android.lightbox.LightboxActivity$onDestroy$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    LightboxActivity.C30091.invokeSuspend$lambda$0();
                }
            });
    ...
    /* JADX INFO: renamed from: com.disney.id.android.lightbox.LightboxActivity$finish$1 */
    static final class C30081 extends SuspendLambda implements Function2 {
        int label;

        C30081(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return LightboxActivity.this.new C30081(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C30081) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    @Override // android.app.Activity
    public void finish() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getMain().getImmediate().plus(JobKt__JobKt.Job$default((Job) null, 1, (Object) null))), null, null, new C30081(null), 3, null);
    }
}
