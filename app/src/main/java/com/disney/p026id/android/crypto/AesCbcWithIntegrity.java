...
abstract class AesCbcWithIntegrity {
    ...
    public static class CipherTextIvMac {
        ...
        public CipherTextIvMac(String str) {
            ...
            this.f3338iv = Base64.decode(strArrSplit[0], 2);
        ...
        public String toString() {
            String strEncodeToString = Base64.encodeToString(this.f3338iv, 2);
        ...
        public int hashCode() {
            return ((((Arrays.hashCode(this.cipherText) + 31) * 31) + Arrays.hashCode(this.f3338iv)) * 31) + Arrays.hashCode(this.mac);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (Arrays.equals(this.cipherText, cipherTextIvMac.cipherText) && Arrays.equals(this.f3338iv, cipherTextIvMac.f3338iv)) {
