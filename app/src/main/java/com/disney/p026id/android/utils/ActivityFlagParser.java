        ...
        for (Field field : declaredFields) {
            ...
            if (StringsKt.startsWith$default(name, "FLAG_", false, 2, (Object) null)) {
                try {
                    ...
                    logger$OneID_release.mo1260w(TAG, "Failed to get Activity Flags associated with id " + overrideFlags, e);
                }
            }
        }
