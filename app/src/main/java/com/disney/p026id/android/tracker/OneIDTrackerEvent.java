...
public final class OneIDTrackerEvent implements Serializable {
    ...
    @NotNull
    /* JADX INFO: renamed from: getThrottle$OneID_release, reason: from getter */
    ...
    /* JADX INFO: renamed from: getInitialElapsedTimeInMillis$OneID_release, reason: from getter */
    ...
    public final boolean getProblem$OneID_release() {
        return Intrinsics.areEqual("true", this.currentStateParam.get(EVENT_PARAM_PROBLEM));
    }

    @Nullable
    /* JADX INFO: renamed from: getReportBase64$OneID_release, reason: from getter */
