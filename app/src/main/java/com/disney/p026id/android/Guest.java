...
public final /* data */ class Guest {
    ...
    @Nullable
    /* JADX INFO: renamed from: component10$OneID_release, reason: from getter */
    public final Token getToken() {
        return this.token;
    }

    @Nullable
    /* JADX INFO: renamed from: component11$OneID_release, reason: from getter */
