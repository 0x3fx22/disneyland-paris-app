...
@Metadata(m1835d1 = {"\u0000t\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0000\u0018\u0000 /2\u00020\u0001:\u0003/01B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010'\u001a\u00020(2\u0006\u0010)\u001a\u00020\u001cH\u0016J\b\u0010*\u001a\u00020(H\u0002J\b\u0010+\u001a\u00020\u0018H\u0016J\b\u0010,\u001a\u00020-H\u0016J\u0010\u0010.\u001a\u00020(2\u0006\u0010)\u001a\u00020\u001cH\u0016R\u001e\u0010\u0003\u001a\u00020\u00048\u0000@\u0000X\u0081.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bR\u001e\u0010\t\u001a\u0012\u0012\u0004\u0012\u00020\u000b0\nj\b\u0012\u0004\u0012\u00020\u000b`\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0012X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0014X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0016X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0017\u001a\u00020\u0018X\u0082\u000e¢\u0006\u0002\n\u0000R \u0010\u0019\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u001c0\u001b0\u001aX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u001d\u0010\u001eR\u001e\u0010\u001f\u001a\u00020 8\u0000@\u0000X\u0081.¢\u0006\u000e\n\u0000\u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$R\u0012\u0010%\u001a\u00060&R\u00020\u0000X\u0082\u0004¢\u0006\u0002\n\u0000¨\u00062"}, m1836d2 = {"Lcom/disney/id/android/OneIDConnectivity;", "Lcom/disney/id/android/Connectivity;", "()V", "appContext", "Landroid/content/Context;", "getAppContext$OneID_release", "()Landroid/content/Context;", "setAppContext$OneID_release", "(Landroid/content/Context;)V", "availableNetworks", "Ljava/util/HashSet;", "Landroid/net/Network;", "Lkotlin/collections/HashSet;", "connectivityHandler", "Landroid/os/Handler;", "connectivityManager", "Landroid/net/ConnectivityManager;", "connectivityRunner", "Ljava/lang/Runnable;", "connectivityThread", "Landroid/os/HandlerThread;", "countNetworks", "", "lastBroadcastWasConnected", "", "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;", "Ljava/lang/ref/WeakReference;", "Lcom/disney/id/android/Connectivity$Listener;", "getListeners$OneID_release", "()Ljava/util/concurrent/CopyOnWriteArrayList;", "logger", "Lcom/disney/id/android/logging/Logger;", "getLogger$OneID_release", "()Lcom/disney/id/android/logging/Logger;", "setLogger$OneID_release", "(Lcom/disney/id/android/logging/Logger;)V", "networkCallback", "Lcom/disney/id/android/OneIDConnectivity$OneIDNetworkCallback;", "addListener", "", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "communicateConnectionState", "isConnected", "networkType", "", "removeListener", "Companion", "ConnectivityHandler", "OneIDNetworkCallback", "OneID_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
public final class OneIDConnectivity implements Connectivity {
    ...
    public OneIDConnectivity() {
        ...
        if (this.lastBroadcastWasConnected) {
            try {
                ...
                logger$OneID_release.mo1257e(TAG2, "Unexpected exception attempting to retrieve network capabilities", e);
    ...
    @Override // com.disney.p026id.android.Connectivity
    ...
    public boolean isConnected() {
        try {
            ...
            String TAG2 = TAG;
            Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
            logger$OneID_release.mo1257e(TAG2, "Unexpected exception attempting to iterate availableNetworks // " + message, e);
    ...
    public String networkType() {
        ...
        if (Intrinsics.areEqual(str, "none")) {
            ...
            if (linkProperties == null || (interfaceName = linkProperties.getInterfaceName()) == null) {
                ...
                lowerCase = interfaceName.toLowerCase(ROOT);
        ...
        return ((Object) str2) + " (disconnected)";
    }
    ...
    @Metadata(m1835d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\t"}, m1836d2 = {"Lcom/disney/id/android/OneIDConnectivity$ConnectivityHandler;", "Landroid/os/Handler;", "looper", "Landroid/os/Looper;", "(Lcom/disney/id/android/OneIDConnectivity;Landroid/os/Looper;)V", "handleMessage", "", NotificationCompat.CATEGORY_MESSAGE, "Landroid/os/Message;", "OneID_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    @Metadata(m1835d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\b"}, m1836d2 = {"Lcom/disney/id/android/OneIDConnectivity$OneIDNetworkCallback;", "Landroid/net/ConnectivityManager$NetworkCallback;", "(Lcom/disney/id/android/OneIDConnectivity;)V", "onAvailable", "", TCEventPropertiesNames.TCN_NETWORK, "Landroid/net/Network;", "onLost", "OneID_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
