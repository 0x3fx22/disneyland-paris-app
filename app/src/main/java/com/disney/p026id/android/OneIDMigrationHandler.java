...
import com.disney.p026id.android.version.LibraryVersion;
import com.disney.p026id.android.version.SemanticVersion;
...
public final class OneIDMigrationHandler implements MigrationHandler {
    ...
    @Override // com.disney.p026id.android.MigrationHandler
    ...
    public MigrationInfo migrate() throws IOException {
        ...
        if (Integer.compareUnsigned(libraryVersionVersionFromString.mo4084getMajorpVg5ArA(), 4) < 0 && libraryVersionVersionFromString2.mo4084getMajorpVg5ArA() == 4) {
            migrationInfo = migrateToVersionFour(libraryVersionVersionFromString, libraryVersionVersionFromString2);
        } else if (libraryVersionVersionFromString.mo4084getMajorpVg5ArA() == 4 && libraryVersionVersionFromString2.mo4084getMajorpVg5ArA() == 4) {
    ...
    private final MigrationInfo migrateToVersionFour(LibraryVersion from, LibraryVersion to) {
        ...
        if (string3 != null) {
            try {
                ...
                logger$OneID_release.mo1257e(TAG2, "Error reading v3 guest object", e);
    ...
    private final MigrationInfo migrateBundlerByVersion(String useVersion, MigrationInfo migrationInfo) {
        ...
        if (previousCachedBundle != null) {
            ...
            try {
                ...
                String TAG2 = TAG;
                Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
                logger$OneID_release.mo1257e(TAG2, "Error copying bundler cache", e);
                migrationInfo.setCategory("UNKNOWN_ERROR");
                migrationInfo.setCodes("INVALID_JSON");
