...
public final class OneIDSCALPBundle implements SCALPBundle {
    ...
    public OneIDSCALPBundle() {
        ...
        if (!Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(JobKt__JobKt.Job$default((Job) null, 1, (Object) null).plus(Dispatchers.getMain().getImmediate())), null, null, new C29932(null), 3, null);
            return;
        }
    ...
    @Metadata(m1835d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m1836d2 = {"Lcom/disney/id/android/OneIDSCALPBundle$Companion;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "getTAG$OneID_release", "()Ljava/lang/String;", "OneID_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    /* JADX INFO: renamed from: com.disney.id.android.OneIDSCALPBundle$2 */
    static final class C29932 extends SuspendLambda implements Function2 {
        private /* synthetic */ Object L$0;
        int label;

        C29932(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C29932 c29932 = OneIDSCALPBundle.this.new C29932(continuation);
            c29932.L$0 = obj;
            return c29932;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C29932) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    @Override // com.disney.p026id.android.SCALPBundle
    @Nullable
        ...
        getScalpController$OneID_release().load(trackerEventKeyStartTransactionEvent$default.getId(), getContext$OneID_release(), ageBand, new SCALPController.LoadListener() { // from class: com.disney.id.android.OneIDSCALPBundle$loadSCALP$2$loadListener$1
            ...
            public void configLoadComplete(@NotNull String bundleVersion, @NotNull String bundlerURL) {
                ...
                try {
                    ...
                    continuation2.resumeWith(Result.m5277constructorimpl(new ConfigData(bundleVersion, bundlerURL, lightboxReady)));
            ...
            public void configLoadError(@NotNull TrackerEventKey transactionEventKey, @NotNull String error) {
                ...
                try {
                    Continuation continuation2 = safeContinuation;
                    Result.Companion companion = Result.INSTANCE;
                    continuation2.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(new Throwable("SCALP load failed // " + error))));
                } catch (IllegalStateException unused) {
    ...
    @Override // com.disney.p026id.android.SCALPBundle
    public boolean loadBundleIntoWebview(@NotNull TrackerEventKey conversationEventKey, boolean z, boolean previousLightboxReadyState) {
        Context context$OneID_release;
        LightboxWebView lightboxWebView;
        boolean zLoadBundle$default;
        boolean z2;
        LightboxWebView lightboxWebView2;
        LightboxWebView lightboxWebView3;
        Intrinsics.checkNotNullParameter(conversationEventKey, "conversationEventKey");
        OneIDTrackerEvent event = getTracker$OneID_release().getEvent(conversationEventKey);
        setVersion$OneID_release(getBundler$OneID_release().getBundleVersion());
        LightboxWebView lightboxWebView4 = this.oneIDWebView;
        if (lightboxWebView4 != null) {
            lightboxWebView4.bundleVersion(getVersion$OneID_release());
        }
        if (z || (lightboxWebView2 = this.oneIDWebView) == null) {
            Logger logger$OneID_release = getLogger$OneID_release();
            String TAG2 = TAG;
            Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
            Logger.DefaultImpls.d$default(logger$OneID_release, TAG2, "Bundler telling webview to load bundle", null, 4, null);
            if (event != null) {
                event.appendCodes$OneID_release(null, null, "bundle(loading)");
            }
            context$OneID_release = getContext$OneID_release();
            lightboxWebView = this.oneIDWebView;
            if (lightboxWebView != null) {
                zLoadBundle$default = LightboxWebView.DefaultImpls.loadBundle$default(lightboxWebView, context$OneID_release, conversationEventKey, false, 4, null);
            } else {
                zLoadBundle$default = false;
            }
            z2 = zLoadBundle$default;
        } else {
            z2 = true;
            if (!lightboxWebView2.getBundleLoaded()) {
                Logger logger$OneID_release2 = getLogger$OneID_release();
                String TAG3 = TAG;
                Intrinsics.checkNotNullExpressionValue(TAG3, "TAG");
                Logger.DefaultImpls.d$default(logger$OneID_release2, TAG3, "Bundler telling webview to load bundle", null, 4, null);
                if (event != null) {
                    event.appendCodes$OneID_release(null, null, "bundle(loading)");
                }
                context$OneID_release = getContext$OneID_release();
                ...
                Logger.DefaultImpls.d$default(logger$OneID_release3, TAG4, "Bundler resetting lightboxReady to " + previousLightboxReadyState, null, 4, null);
                if (event != null) {
                ...
                if (lightboxWebView5 != null) {
                    lightboxWebView5.setLightboxReady(previousLightboxReadyState);
                }
                LightboxWebView lightboxWebView6 = this.oneIDWebView;
                if (lightboxWebView6 != null && lightboxWebView6.getLightboxReady() && (lightboxWebView3 = this.oneIDWebView) != null) {
                    lightboxWebView3.setStarterPage();
                }
                Tracker.DefaultImpls.finishEvent$default(getTracker$OneID_release(), conversationEventKey, false, null, null, null, false, 62, null);
            }
        }
        if (z2 && getInitializationCallbackHolder$OneID_release().getCurrentState() != OneIDState.Renewing) {
            InitializationCallbackHolder initializationCallbackHolder$OneID_release = getInitializationCallbackHolder$OneID_release();
            OneIDState oneIDState = OneIDState.Ready;
            initializationCallbackHolder$OneID_release.reportState(oneIDState);
            TrackerEventKey trackerEventKey = getInitializationCallbackHolder$OneID_release().getTrackerEventKey();
            if ((trackerEventKey != null ? trackerEventKey.getId() : null) != null) {
                Tracker tracker$OneID_release = getTracker$OneID_release();
                TrackerEventKey trackerEventKey2 = getInitializationCallbackHolder$OneID_release().getTrackerEventKey();
                Intrinsics.checkNotNull(trackerEventKey2);
                Tracker.DefaultImpls.finishEvent$default(tracker$OneID_release, trackerEventKey2, false, null, null, "oneidstate(" + oneIDState + ")", false, 44, null);
                getInitializationCallbackHolder$OneID_release().setTrackerEventKey(null);
            }
        }
        return z2;
    }
    ...
    public Object initializeBundle(@NotNull final TrackerEventKey trackerEventKey, @NotNull final ConfigData configData, @NotNull Continuation<? super Boolean> continuation) throws Throwable {
        ...
        Bundler.Listener listener = new Bundler.Listener() { // from class: com.disney.id.android.OneIDSCALPBundle$initializeBundle$2$listener$1
            ...
            public void onComplete(boolean z) {
                ...
                Continuation continuation2 = safeContinuation;
                Result.Companion companion = Result.INSTANCE;
                continuation2.resumeWith(Result.m5277constructorimpl(Boolean.TRUE));
            }
            ...
            public void onFailure(@NotNull TrackerEventKey transactionEventKey) {
                ...
                Continuation continuation2 = safeContinuation;
                Result.Companion companion = Result.INSTANCE;
                continuation2.resumeWith(Result.m5277constructorimpl(Boolean.FALSE));
            }
        };
        Logger logger$OneID_release = getLogger$OneID_release();
        String TAG2 = TAG;
