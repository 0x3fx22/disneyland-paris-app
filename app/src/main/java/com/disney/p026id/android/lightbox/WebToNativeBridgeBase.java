...
import com.disney.p026id.android.NewslettersResult;
...
import com.disney.p026id.android.utils.StringPatterns;
...
public final class WebToNativeBridgeBase {
    ...
    @Nullable
    /* JADX INFO: renamed from: getTimeoutHandler$OneID_release, reason: from getter */
    ...
    @Nullable
    /* JADX INFO: renamed from: getTimeoutRunnable$OneID_release, reason: from getter */
    ...
    @NotNull
    /* JADX INFO: renamed from: getGson$OneID_release, reason: from getter */
    ...
    public final void setData(@NotNull String jsonBody) {
        String strValueOf;
        Intrinsics.checkNotNullParameter(jsonBody, "jsonBody");
        Logger logger$OneID_release = getLogger$OneID_release();
        String TAG2 = TAG;
    ...
    public final void close() {
        ...
        while (!booleanRef.element && intRef.element > 0) {
            BuildersKt__BuildersKt.runBlocking$default(null, new C30121(intRef, booleanRef, null), 1, null);
        }
        long j = 2000 - (((long) intRef.element) * 100);
    ...
    /* JADX INFO: renamed from: com.disney.id.android.lightbox.WebToNativeBridgeBase$close$1 */
    static final class C30121 extends SuspendLambda implements Function2 {
        final /* synthetic */ Ref.IntRef $attemptsRemaining;
        final /* synthetic */ Ref.BooleanRef $lightBoxFinished;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C30121(Ref.IntRef intRef, Ref.BooleanRef booleanRef, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new C30121(this.$attemptsRemaining, this.$lightBoxFinished, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C30121) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.$attemptsRemaining.element--;
                this.label = 1;
