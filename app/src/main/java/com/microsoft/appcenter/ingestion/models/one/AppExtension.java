...
public class AppExtension implements Model {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.f3665id;
        if (str == null ? appExtension.f3665id != null : !str.equals(appExtension.f3665id)) {
            return false;
        }
        ...
        if (str5 != null) {
            return str5.equals(appExtension.userId);
        }
        return appExtension.userId == null;
    }
