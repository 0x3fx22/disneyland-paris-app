...
public abstract class CommonSchemaLog extends AbstractLog {
    ...
    public boolean equals(Object obj) {
        ...
        String str4 = this.f3666cV;
        if (str4 == null ? commonSchemaLog.f3666cV != null : !str4.equals(commonSchemaLog.f3666cV)) {
            return false;
        }
        ...
        Data data = this.data;
        if (data != null) {
            return data.equals(commonSchemaLog.data);
        }
        return commonSchemaLog.data == null;
    }
