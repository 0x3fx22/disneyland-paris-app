...
public class Extensions implements Model {
    ...
    private NetExtension f4970net;

    /* JADX INFO: renamed from: os */
    private OsExtension f3667os;
    ...
    public NetExtension getNet() {
        return this.f4970net;
    }

    public void setNet(NetExtension netExtension) {
        this.f4970net = netExtension;
    }
    ...
    public boolean equals(Object obj) {
        ...
        OsExtension osExtension = this.f3667os;
        if (osExtension == null ? extensions.f3667os != null : !osExtension.equals(extensions.f3667os)) {
            return false;
        }
        ...
        NetExtension netExtension = this.f4970net;
        if (netExtension == null ? extensions.f4970net != null : !netExtension.equals(extensions.f4970net)) {
            return false;
        }
        ...
        if (locExtension != null) {
            return locExtension.equals(extensions.loc);
        }
        return extensions.loc == null;
    }
