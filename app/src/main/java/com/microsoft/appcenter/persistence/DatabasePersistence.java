...
public class DatabasePersistence extends Persistence {
    ...
    private static ContentValues getContentValues(String str, String str2, String str3, String str4, String str5, int i) {
        ...
        contentValues.put(com.google.firebase.messaging.Constants.FirelogAnalytics.PARAM_PRIORITY, Integer.valueOf(i));
    ...
    @Override // com.microsoft.appcenter.persistence.Persistence
    public long putLog(@NonNull Log log, @NonNull String str, @IntRange(from = 1, m4to = 2) int i) throws Persistence.PersistenceException {
        String strEncrypt;
        String targetKey;
        try {
            try {
                ...
                long jPut = this.mDatabaseManager.put(getContentValues(str, z ? null : strSerializeLog, strEncrypt, log.getType(), targetKey, Flags.getPersistenceFlag(i, false)), com.google.firebase.messaging.Constants.FirelogAnalytics.PARAM_PRIORITY);
                if (jPut == -1) {
    ...
    public String getLogs(@NonNull String str, @NonNull Collection<String> collection, @IntRange(from = 0) int i, @NonNull List<Log> list) {
        ...
        while (cursor != null) {
            ...
            if (asLong == null) {
                ...
                for (Long l : getLogsIds(sQLiteQueryBuilderNewSQLiteQueryBuilder, strArr)) {
        ...
        if (arrayList2.size() > 0) {
            ...
            while (it.hasNext()) {
                deleteLog(largePayloadGroupDirectory, ((Long) it.next()).longValue());
            }
