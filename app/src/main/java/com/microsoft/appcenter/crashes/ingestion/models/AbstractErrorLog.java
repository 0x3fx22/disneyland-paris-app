...
public abstract class AbstractErrorLog extends AbstractLog {
    ...
    public boolean equals(Object obj) {
        ...
        UUID uuid = this.f3659id;
        if (uuid == null ? abstractErrorLog.f3659id != null : !uuid.equals(abstractErrorLog.f3659id)) {
            return false;
        }
        ...
        if (str4 != null) {
            return str4.equals(abstractErrorLog.architecture);
        }
        return abstractErrorLog.architecture == null;
    }
