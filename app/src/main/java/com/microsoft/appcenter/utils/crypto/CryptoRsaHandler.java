...
class CryptoRsaHandler implements CryptoHandler {
    ...
    @Override // com.microsoft.appcenter.utils.crypto.CryptoHandler
    public byte[] encrypt(CryptoUtils.ICryptoFactory iCryptoFactory, int i, KeyStore.Entry entry, byte[] bArr) throws CertificateNotYetValidException, InvalidKeyException {
