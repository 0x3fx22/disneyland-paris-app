...
public class EventApiClient {
    ...
    Response sendEvents(String str, List list, Map map) throws RequestException {
        ...
        map2.put("X-UA-Sent-At", String.format(Locale.US, "%.3f", Double.valueOf(dCurrentTimeMillis)));
        ...
        UALog.m1741d("Sending analytics events. Request: %s Events: %s", request, list);
        ...
        UALog.m1741d("Analytics event response: %s", responseExecute);
