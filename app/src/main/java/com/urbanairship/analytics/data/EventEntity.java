...
public class EventEntity {
    ...
    public String toString() {
        return "EventEntity{id=" + this.f3716id + ", type='" + this.type + CoreConstants.SINGLE_QUOTE_CHAR + ", eventId='" + this.eventId + CoreConstants.SINGLE_QUOTE_CHAR + ", time=" + this.time + ", data='" + this.data.toString() + CoreConstants.SINGLE_QUOTE_CHAR + ", sessionId='" + this.sessionId + CoreConstants.SINGLE_QUOTE_CHAR + ", eventSize=" + this.eventSize + '}';
    }
