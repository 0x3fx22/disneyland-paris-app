...
public final class AirshipEventData {
    ...
    public AirshipEventData(@NotNull String id, @NotNull String sessionId, @NotNull JsonValue body, @NotNull EventType type, long j) {
        ...
        this.type = type;
        this.timeMs = j;
        Pair pairM1842to = TuplesKt.m1842to("type", type.getReportingName());
        Pair pairM1842to2 = TuplesKt.m1842to(TCEventPropertiesNames.TCE_EVENTID, id);
        Pair pairM1842to3 = TuplesKt.m1842to("time", Event.millisecondsToSecondsString(j));
        JsonMap jsonMapOptMap = this.body.optMap();
        Intrinsics.checkNotNullExpressionValue(jsonMapOptMap, "optMap(...)");
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(pairM1842to, pairM1842to2, pairM1842to3, TuplesKt.m1842to("data", JsonExtensionsKt.extend(jsonMapOptMap, TuplesKt.m1842to(TCEventPropertiesNames.TCL_SESSION_ID, sessionId)))).getJsonValue();
