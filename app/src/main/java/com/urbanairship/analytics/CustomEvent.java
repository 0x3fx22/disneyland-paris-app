...
public final class CustomEvent extends Event implements JsonSerializable {
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Type type) {
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Properties properties) {
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Type type) {
        return INSTANCE.newBuilder(type);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Properties properties) {
        return INSTANCE.newBuilder(type, properties);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Type type) {
        return INSTANCE.newBuilder(type);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Properties properties) {
        return INSTANCE.newBuilder(type, properties);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Type type) {
        return INSTANCE.newBuilder(type);
    }
    ...
    @JvmOverloads
    @NotNull
    public static final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Properties properties) {
        return INSTANCE.newBuilder(type, properties);
    }
    ...
    @Nullable
    /* JADX INFO: renamed from: getSendId$urbanairship_core_release, reason: from getter */
    public final String getSendId() {
        return this.sendId;
    }

    @Nullable
    /* JADX INFO: renamed from: getTemplateType$urbanairship_core_release, reason: from getter */
    public final String getTemplateType() {
        return this.templateType;
    }

    @Nullable
    /* JADX INFO: renamed from: getInAppContext$urbanairship_core_release, reason: from getter */
    ...
    public JsonValue toJsonValue() {
        Pair pairM1842to = TuplesKt.m1842to("event_name", this.eventName);
        BigDecimal bigDecimal = this.eventValue;
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(pairM1842to, TuplesKt.m1842to(EVENT_VALUE, bigDecimal != null ? Double.valueOf(bigDecimal.doubleValue()) : null), TuplesKt.m1842to(INTERACTION_ID, this.interactionId), TuplesKt.m1842to(INTERACTION_TYPE, this.interactionType), TuplesKt.m1842to("transaction_id", this.transactionId), TuplesKt.m1842to("in_app", this.inAppContext), TuplesKt.m1842to(PROPERTIES, this.properties)).toJsonValue();
    ...
    public boolean isValid() {
        if (UAStringUtil.isEmpty(this.eventName) || !CustomEventKt.isLengthValid(this.eventName)) {
            UALog.m1744e("Event name must not be null, empty, or larger than 255 characters.", new Object[0]);
            return false;
        }
        BigDecimal bigDecimal = this.eventValue;
        if (bigDecimal != null) {
            ...
            if (bigDecimal.compareTo(bigDecimal2) > 0) {
                UALog.m1744e("Event value is bigger than " + bigDecimal2, new Object[0]);
                return false;
            }
            BigDecimal bigDecimal3 = MIN_VALUE;
            if (bigDecimal.compareTo(bigDecimal3) < 0) {
                UALog.m1744e("Event value is smaller than " + bigDecimal3, new Object[0]);
                return false;
            }
        }
        String str = this.transactionId;
        if (str != null && !CustomEventKt.isLengthValid(str)) {
            UALog.m1744e("Transaction ID is larger than 255 characters.", new Object[0]);
            return false;
        }
        String str2 = this.interactionId;
        if (str2 != null && !CustomEventKt.isLengthValid(str2)) {
            UALog.m1744e("Interaction ID is larger than 255 characters.", new Object[0]);
            return false;
        }
        String str3 = this.interactionType;
        if (str3 != null && !CustomEventKt.isLengthValid(str3)) {
            UALog.m1744e("Interaction type is larger than 255 characters.", new Object[0]);
            return false;
        }
        ...
        if (str4 == null || CustomEventKt.isLengthValid(str4)) {
            ...
            UALog.m1744e("Total custom properties size (" + CustomEventKt.sizeInBytes(this.properties) + " bytes) exceeds maximum size of 65536 bytes.", new Object[0]);
            return false;
        }
        UALog.m1744e("Template type is larger than 255 characters.", new Object[0]);
        return false;
    }
    ...
    @Metadata(m1835d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\b\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00192\b\b\u0002\u0010\u001a\u001a\u00020\u001bH\u0007J\u001a\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u001c2\b\b\u0002\u0010\u001a\u001a\u00020\u001dH\u0007J\u001a\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u001e2\b\b\u0002\u0010\u001a\u001a\u00020\u001fH\u0007J\u001a\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020 2\b\b\u0002\u0010\u001a\u001a\u00020!H\u0007J\u0010\u0010\u0016\u001a\u00020\u00172\u0006\u0010\"\u001a\u00020\u0004H\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\rX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0010X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0014\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006#"}, m1836d2 = {"Lcom/urbanairship/analytics/CustomEvent$Companion;", "", "()V", "CONVERSION_METADATA", "", "CONVERSION_SEND_ID", "EVENT_NAME", "EVENT_VALUE", "INTERACTION_ID", "INTERACTION_TYPE", "IN_APP_KEY", "LAST_RECEIVED_METADATA", "MAX_CHARACTER_LENGTH", "", "MAX_TOTAL_PROPERTIES_SIZE", "MAX_VALUE", "Ljava/math/BigDecimal;", "MCRAP_TRANSACTION_TYPE", "MIN_VALUE", "PROPERTIES", "TEMPLATE_TYPE", "TRANSACTION_ID", "newBuilder", "Lcom/urbanairship/analytics/CustomEvent$Builder;", "type", "Lcom/urbanairship/analytics/templates/AccountEventTemplate$Type;", CustomEvent.PROPERTIES, "Lcom/urbanairship/analytics/templates/AccountEventTemplate$Properties;", "Lcom/urbanairship/analytics/templates/MediaEventTemplate$Type;", "Lcom/urbanairship/analytics/templates/MediaEventTemplate$Properties;", "Lcom/urbanairship/analytics/templates/RetailEventTemplate$Type;", "Lcom/urbanairship/analytics/templates/RetailEventTemplate$Properties;", "Lcom/urbanairship/analytics/templates/SearchEventTemplate$Type;", "Lcom/urbanairship/analytics/templates/SearchEventTemplate$Properties;", "name", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    public static final class Companion {
        ...
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Type type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return newBuilder$default(this, type, (com.urbanairship.analytics.templates.AccountEventTemplate.Properties) null, 2, (Object) null);
        }

        @JvmStatic
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Type type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return newBuilder$default(this, type, (com.urbanairship.analytics.templates.MediaEventTemplate.Properties) null, 2, (Object) null);
        }

        @JvmStatic
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Type type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return newBuilder$default(this, type, (com.urbanairship.analytics.templates.RetailEventTemplate.Properties) null, 2, (Object) null);
        }

        @JvmStatic
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Type type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return newBuilder$default(this, type, (com.urbanairship.analytics.templates.SearchEventTemplate.Properties) null, 2, (Object) null);
        }
        ...
        public static /* synthetic */ Builder newBuilder$default(Companion companion, com.urbanairship.analytics.templates.MediaEventTemplate.Type type, com.urbanairship.analytics.templates.MediaEventTemplate.Properties properties, int i, Object obj) {
            com.urbanairship.analytics.templates.MediaEventTemplate.Properties properties2;
            if ((i & 2) != 0) {
                properties2 = new com.urbanairship.analytics.templates.MediaEventTemplate.Properties(null, null, null, null, null, null, null, false, null, null, AnalyticsListener.EVENT_DRM_KEYS_LOADED, null);
            } else {
        ...
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.MediaEventTemplate.Properties properties) {
            Intrinsics.checkNotNullParameter(type, "type");
            Intrinsics.checkNotNullParameter(properties, "properties");
            if (type instanceof com.urbanairship.analytics.templates.MediaEventTemplate.Type.Shared) {
                com.urbanairship.analytics.templates.MediaEventTemplate.Properties.Builder builder = new com.urbanairship.analytics.templates.MediaEventTemplate.Properties.Builder(properties);
                com.urbanairship.analytics.templates.MediaEventTemplate.Type.Shared shared = (com.urbanairship.analytics.templates.MediaEventTemplate.Type.Shared) type;
        ...
        public static /* synthetic */ Builder newBuilder$default(Companion companion, com.urbanairship.analytics.templates.AccountEventTemplate.Type type, com.urbanairship.analytics.templates.AccountEventTemplate.Properties properties, int i, Object obj) {
            if ((i & 2) != 0) {
                properties = new com.urbanairship.analytics.templates.AccountEventTemplate.Properties(null, null, null, false, 15, null);
            }
        ...
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.AccountEventTemplate.Properties properties) {
            Intrinsics.checkNotNullParameter(type, "type");
            Intrinsics.checkNotNullParameter(properties, "properties");
            return newBuilder(type.getEventName()).setTemplateType("account").setProperties(properties.toJsonValue().optMap());
        }

        public static /* synthetic */ Builder newBuilder$default(Companion companion, com.urbanairship.analytics.templates.RetailEventTemplate.Type type, com.urbanairship.analytics.templates.RetailEventTemplate.Properties properties, int i, Object obj) {
            if ((i & 2) != 0) {
                properties = new com.urbanairship.analytics.templates.RetailEventTemplate.Properties(null, null, null, null, null, null, null, false, 255, null);
            }
            return companion.newBuilder(type, properties);
        }
        ...
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.RetailEventTemplate.Properties properties) {
            Intrinsics.checkNotNullParameter(type, "type");
            Intrinsics.checkNotNullParameter(properties, "properties");
            if (type instanceof com.urbanairship.analytics.templates.RetailEventTemplate.Type.Shared) {
                com.urbanairship.analytics.templates.RetailEventTemplate.Properties.Builder builder = new com.urbanairship.analytics.templates.RetailEventTemplate.Properties.Builder(properties);
                com.urbanairship.analytics.templates.RetailEventTemplate.Type.Shared shared = (com.urbanairship.analytics.templates.RetailEventTemplate.Type.Shared) type;
                properties = builder.setSource$urbanairship_core_release(shared.getSource()).setMedium$urbanairship_core_release(shared.getMedium()).build();
            } else if (type instanceof com.urbanairship.analytics.templates.RetailEventTemplate.Type.Wishlist) {
                com.urbanairship.analytics.templates.RetailEventTemplate.Properties.Builder builder2 = new com.urbanairship.analytics.templates.RetailEventTemplate.Properties.Builder(properties);
                com.urbanairship.analytics.templates.RetailEventTemplate.Type.Wishlist wishlist = (com.urbanairship.analytics.templates.RetailEventTemplate.Type.Wishlist) type;
        ...
        public static /* synthetic */ Builder newBuilder$default(Companion companion, com.urbanairship.analytics.templates.SearchEventTemplate.Type type, com.urbanairship.analytics.templates.SearchEventTemplate.Properties properties, int i, Object obj) {
            if ((i & 2) != 0) {
                properties = new com.urbanairship.analytics.templates.SearchEventTemplate.Properties(null, null, null, null, null, false, 63, null);
            }
            return companion.newBuilder(type, properties);
        }
        ...
        @JvmOverloads
        @NotNull
        public final Builder newBuilder(@NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Type type, @NotNull com.urbanairship.analytics.templates.SearchEventTemplate.Properties properties) {
            Intrinsics.checkNotNullParameter(type, "type");
            Intrinsics.checkNotNullParameter(properties, "properties");
