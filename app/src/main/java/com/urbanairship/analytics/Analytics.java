...
public final class Analytics extends AirshipComponent {
    ...
    @Metadata(m1835d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\bg\u0018\u00002\u00020\u0001J\u0016\u0010\u0002\u001a\u0010\u0012\u0004\u0012\u00020\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u00040\u0003H&¨\u0006\u0005À\u0006\u0003"}, m1836d2 = {"Lcom/urbanairship/analytics/Analytics$AnalyticsHeaderDelegate;", "", "onCreateAnalyticsHeaders", "", "", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    public final AssociatedIdentifiers getAssociatedIdentifiers() {
        synchronized (this.associatedIdentifiersLock) {
            try {
                ...
                UALog.m1747e(e, new Function0() { // from class: com.urbanairship.analytics.Analytics$associatedIdentifiers$1$1
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
    ...
    private final Map getAnalyticHeaders() {
        ...
        for (final Permission permission : this.permissionsManager.getConfiguredPermissions()) {
            try {
                ...
                UALog.m1747e(e, (Function0<String>) new Function0() { // from class: com.urbanairship.analytics.Analytics$analyticHeaders$1
                    {
                        super(0);
                    }
