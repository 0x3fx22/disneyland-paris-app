...
@Dao
@Metadata(m1835d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0006\ba\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H'J\u0010\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH'J\b\u0010\t\u001a\u00020\u0003H'J\u001c\u0010\t\u001a\u00020\u00032\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\b0\u000bH\u0097@¢\u0006\u0002\u0010\fJ\u0016\u0010\r\u001a\u00020\u00032\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\b0\u000bH'J\u000e\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00050\u000bH'J\u0012\u0010\u000f\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0010\u001a\u00020\bH'¨\u0006\u0011À\u0006\u0003"}, m1836d2 = {"Lcom/urbanairship/meteredusage/EventsDao;", "", "addEvent", "", "event", "Lcom/urbanairship/meteredusage/MeteredUsageEventEntity;", "delete", LightboxActivity.EVENT_ID_EXTRA, "", "deleteAll", "eventIds", "", "(Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "deleteAllBatchInternal", "getAllEvents", "getEventWithId", "id", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
...
public interface EventsDao {
    ...
    /* JADX INFO: renamed from: com.urbanairship.meteredusage.EventsDao$deleteAll$2 */
    static final class C56392 extends SuspendLambda implements Function2 {
        final /* synthetic */ List $eventIds;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C56392(List list, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return EventsDao.this.new C56392(this.$eventIds, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(List list, Continuation continuation) {
            return ((C56392) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ Object deleteAll$suspendImpl(EventsDao eventsDao, List<String> list, Continuation<? super Unit> continuation) {
        Object objRunBatched = SuspendingBatchedQueryHelper.INSTANCE.runBatched(list, eventsDao.new C56392(list, null), continuation);
