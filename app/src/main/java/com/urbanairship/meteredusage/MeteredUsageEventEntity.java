...
public final /* data */ class MeteredUsageEventEntity {
    ...
    public final JsonValue toJson$urbanairship_core_release() {
        Pair pairM1842to = TuplesKt.m1842to(TCEventPropertiesNames.TCE_EVENTID, this.eventId);
        Pair pairM1842to2 = TuplesKt.m1842to("usage_type", this.type.getValue());
        Pair pairM1842to3 = TuplesKt.m1842to(TCEventPropertiesNames.TCI_PRODUCT, this.product);
        Pair pairM1842to4 = TuplesKt.m1842to("reporting_context", this.reportingContext);
        Long l = this.timestamp;
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(pairM1842to, pairM1842to2, pairM1842to3, pairM1842to4, TuplesKt.m1842to("occurred", l != null ? DateUtils.createIso8601TimeStamp(l.longValue()) : null), TuplesKt.m1842to("entity_id", this.entityId), TuplesKt.m1842to(DeferredApiClient.KEY_CONTACT_ID, this.contactId)).toJsonValue();
