...
public class AirshipConfigOptions {
    ...
    public void validate() {
        ...
        if (j < 60000) {
            UALog.m1754w("AirshipConfigOptions - The backgroundReportingIntervalMS %s may decrease battery life.", Long.valueOf(j));
        } else if (j > 86400000) {
            UALog.m1754w("AirshipConfigOptions - The backgroundReportingIntervalMS %s may provide less detailed analytic reports.", Long.valueOf(j));
        }
    }
    ...
    public static final class Builder {
        ...
        private void applyConfigParser(Context context, ConfigParser configParser) {
            ...
            for (int i2 = 0; i2 < configParser.getCount(); i2++) {
                try {
                    ...
                    if (name != null) {
                        ...
                        switch (name.hashCode()) {
                            ...
                            case 1186886991:
                                ...
                                break;
                            case 1219349575:
                                if (name.equals("productionLogPrivacyLevel")) {
                                    b = Ascii.SUB;
                                } else {
                                    b = -1;
                                }
                                break;
                            case 1345735557:
                                if (name.equals("developmentLogPrivacyLevel")) {
                                    b = Ascii.f3523EM;
                                } else {
                                    b = -1;
                                }
                        ...
                        switch (b) {
                            ...
                            case 14:
                                ...
                                break;
                            case 15:
                                UALog.m1744e("Parameter whitelist is deprecated and will be removed in a future version of the SDK. Use urlAllowList instead.", new Object[0]);
                            ...
                            case 24:
                                ...
                                break;
                            case 25:
                                setDevelopmentLogPrivacyLevel(AirshipConfigOptions.parseLogPrivacyLevel(configParser.getString(name)));
                                break;
                            case 26:
                                setProductionLogPrivacyLevel(AirshipConfigOptions.parseLogPrivacyLevel(configParser.getString(name)));
                                break;
                            case 27:
                            ...
                            case 36:
                            case 37:
                                UALog.m1744e("Support for Sender ID override has been removed. Configure a FirebaseApp and use fcmFirebaseAppName instead.", new Object[0]);
                                break;
                            case 38:
                                setFcmFirebaseAppName(configParser.getString(name));
                                break;
                            case 39:
                                UALog.m1744e("Parameter enableUrlWhitelisting has been removed. See urlAllowListScopeJavaScriptBridge and urlAllowListScopeOpen instead.", new Object[0]);
                                break;
                            case 40:
                            ...
                            case 48:
                                ...
                                if (i != -1) {
                                    setEnabledFeatures(new PrivacyManager.Feature(i));
                                } else {
                    ...
                    UALog.m1746e(e, "Unable to set config field '%s' due to invalid configuration value.", configParser.getName(i2));
                }
            }
        ...
        private PrivacyManager.Feature convertFeatureNames(String[] strArr) {
            try {
                ...
                UALog.m1746e(e, "Failed to parse features array " + String.join(",", strArr), new Object[0]);
        ...
        public Builder detectProvisioningMode(@NonNull Context context) {
            try {
                ...
                UALog.m1754w("AirshipConfigOptions - Unable to determine the build mode. Defaulting to debug.", new Object[0]);
        ...
        public AirshipConfigOptions build() {
            ...
            if (str != null && str.equals(this.developmentAppKey)) {
                UALog.m1754w("Production App Key matches Development App Key", new Object[0]);
            }
            String str2 = this.productionAppSecret;
            if (str2 != null && str2.equals(this.developmentAppSecret)) {
                UALog.m1754w("Production App Secret matches Development App Secret", new Object[0]);
            }
            if (this.dataCollectionOptInEnabled) {
                UALog.m1754w("dataCollectionOptInEnabled is deprecated. Use enabledFeatures instead.", new Object[0]);
