...
public final class MessageListItemAnimator {
    ...
    /* JADX INFO: renamed from: fadeIn$delegate, reason: from kotlin metadata */
    private final Lazy fadeIn;

    /* JADX INFO: renamed from: fadeOut$delegate, reason: from kotlin metadata */
    private final Lazy fadeOut;

    /* JADX INFO: renamed from: flipLeftIn$delegate, reason: from kotlin metadata */
    private final Lazy flipLeftIn;

    /* JADX INFO: renamed from: flipLeftOut$delegate, reason: from kotlin metadata */
    private final Lazy flipLeftOut;

    /* JADX INFO: renamed from: flipRightIn$delegate, reason: from kotlin metadata */
    private final Lazy flipRightIn;

    /* JADX INFO: renamed from: flipRightOut$delegate, reason: from kotlin metadata */
    ...
    public final Animator loadAnimator(int animatorRes) {
