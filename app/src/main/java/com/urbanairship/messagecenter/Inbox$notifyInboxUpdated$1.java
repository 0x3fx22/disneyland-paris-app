...
final class Inbox$notifyInboxUpdated$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (it.hasNext()) {
            ...
            C54741 c54741 = new C54741(inboxListener, null);
            this.L$0 = it;
            this.label = 1;
            if (BuildersKt.withContext(main, c54741, this) == coroutine_suspended) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.messagecenter.Inbox$notifyInboxUpdated$1$1 */
    static final class C54741 extends SuspendLambda implements Function2 {
        final /* synthetic */ InboxListener $listener;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C54741(InboxListener inboxListener, Continuation continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return new C54741(this.$listener, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C54741) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
