...
import com.urbanairship.messagecenter.p040ui.MessageCenterActivity;
...
public final class MessageCenter extends AirshipComponent {
    ...
    @Metadata(m1835d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&¨\u0006\u0006À\u0006\u0003"}, m1836d2 = {"Lcom/urbanairship/messagecenter/MessageCenter$OnShowMessageCenterListener;", "", "onShowMessageCenter", "", Constants.FirelogAnalytics.PARAM_MESSAGE_ID, "", "urbanairship-message-center_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    /* JADX INFO: renamed from: com.urbanairship.messagecenter.MessageCenter$onPerformJob$1 */
    static final class C55061 extends SuspendLambda implements Function2 {
        int label;

        C55061(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return MessageCenter.this.new C55061(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C55061) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object objM5148performUpdateIoAF18A$urbanairship_message_center_release;
            ...
            if (i == 0) {
                ...
                this.label = 1;
                objM5148performUpdateIoAF18A$urbanairship_message_center_release = inbox.m5148performUpdateIoAF18A$urbanairship_message_center_release(this);
                if (objM5148performUpdateIoAF18A$urbanairship_message_center_release == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objM5148performUpdateIoAF18A$urbanairship_message_center_release = ((Result) obj).getValue();
            }
            if (Result.m5280exceptionOrNullimpl(objM5148performUpdateIoAF18A$urbanairship_message_center_release) != null) {
                return JobResult.FAILURE;
            }
            if (((Boolean) objM5148performUpdateIoAF18A$urbanairship_message_center_release).booleanValue()) {
    ...
    public JobResult onPerformJob(@NotNull UAirship airship, @NotNull JobInfo jobInfo) {
        ...
        if (this.privacyManager.isEnabled(PrivacyManager.Feature.MESSAGE_CENTER)) {
            return (JobResult) BuildersKt__BuildersKt.runBlocking$default(null, new C55061(null), 1, null);
        }
        return JobResult.SUCCESS;
    }
    ...
    @Metadata(m1835d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\t\u001a\u0004\u0018\u00010\u00042\b\u0010\n\u001a\u0004\u0018\u00010\u000bH\u0007J\b\u0010\f\u001a\u00020\rH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000e"}, m1836d2 = {"Lcom/urbanairship/messagecenter/MessageCenter$Companion;", "", "()V", MessageCenter.ACTION_UPDATE_INBOX, "", "DEEP_LINK_HOST", "MESSAGE_DATA_SCHEME", "VIEW_MESSAGE_CENTER_INTENT_ACTION", "VIEW_MESSAGE_INTENT_ACTION", "parseMessageId", "intent", "Landroid/content/Intent;", "shared", "Lcom/urbanairship/messagecenter/MessageCenter;", "urbanairship-message-center_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
