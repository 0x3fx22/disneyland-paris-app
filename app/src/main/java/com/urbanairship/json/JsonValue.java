...
public class JsonValue implements Parcelable, JsonSerializable {
    ...
    public static final Parcelable.Creator<JsonValue> CREATOR = new Parcelable.Creator() { // from class: com.urbanairship.json.JsonValue.1
        ...
        public JsonValue createFromParcel(Parcel parcel) {
            try {
                ...
                UALog.m1746e(e, "JsonValue - Unable to create JsonValue from parcel.", new Object[0]);
    ...
    public String coerceString() {
        ...
        if (isNumber()) {
            try {
                ...
                UALog.m1746e(e, "JsonValue - Failed to coerce JSON Number into String.", new Object[0]);
                return null;
            }
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (isNumber() && jsonValue.isNumber()) {
            if (isDouble() || jsonValue.isDouble()) {
                return Double.compare(getDouble(AudioStats.AUDIO_AMPLITUDE_NONE), jsonValue.getDouble(AudioStats.AUDIO_AMPLITUDE_NONE)) == 0;
            }
            if (isFloat() || jsonValue.isFloat()) {
                return Float.compare(getFloat(BitmapDescriptorFactory.HUE_RED), jsonValue.getFloat(BitmapDescriptorFactory.HUE_RED)) == 0;
            }
            return getLong(0L) == jsonValue.getLong(0L);
        }
    ...
    public String toString(Boolean bool) {
        ...
        try {
            ...
            UALog.m1746e(e, "JsonValue - Failed to create JSON String.", new Object[0]);
            return "";
        }
    }
