...
public class JsonMatcher implements JsonSerializable, Predicate<JsonSerializable> {
    ...
    public JsonValue getJsonValue() {
        return JsonMap.newBuilder().putOpt("key", this.key).putOpt("scope", this.scopeList).put("value", this.value).putOpt("ignore_case", this.ignoreCase).build().getJsonValue();
    }
    ...
    public static JsonMatcher parse(@Nullable JsonValue jsonValue) throws JsonException {
        ...
        JsonValue jsonValueOpt = jsonMapOptMap.opt("scope");
