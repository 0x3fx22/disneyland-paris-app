...
public final class StringContainsMatcher extends ValueMatcher {
    ...
    @NotNull
    /* JADX INFO: renamed from: getExpected$urbanairship_core_release, reason: from getter */
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(STRING_CONTAINS, this.expected)).getJsonValue();
