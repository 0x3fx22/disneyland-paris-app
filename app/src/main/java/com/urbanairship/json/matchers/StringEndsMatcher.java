...
public final class StringEndsMatcher extends ValueMatcher {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(STRING_ENDS, this.expected)).getJsonValue();
