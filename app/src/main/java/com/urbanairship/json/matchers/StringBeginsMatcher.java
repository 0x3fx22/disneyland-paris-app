...
public final class StringBeginsMatcher extends ValueMatcher {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(STRING_BEGINS, this.expected)).getJsonValue();
