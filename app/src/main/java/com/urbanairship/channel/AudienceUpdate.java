...
final class AudienceUpdate implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(FetchDeviceInfoAction.TAGS_KEY, this.tags), TuplesKt.m1842to("attributes", this.attributes), TuplesKt.m1842to("subscription_lists", this.subscriptions), TuplesKt.m1842to("live_updates", this.liveUpdates)).getJsonValue();
