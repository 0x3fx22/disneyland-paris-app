    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (subscriptionsResult == null || !Intrinsics.areEqual(subscriptionsResult.getChannelId(), this.$channelId)) {
                ...
                return Result.m5276boximpl(Result.m5277constructorimpl(subscriptionsResult.getSubscriptions()));
            }
        } else {
            if (i != 1) {
        ...
        if (requestResult.isSuccessful() && requestResult.getValue() != null) {
            ...
            return Result.m5276boximpl(Result.m5277constructorimpl(requestResult.getValue()));
        }
        Result.Companion companion3 = Result.INSTANCE;
        return Result.m5276boximpl(Result.m5277constructorimpl(ResultKt.createFailure(new RequestException("Failed to fetch subscription lists with status: " + requestResult.getStatus()))));
    }
}
