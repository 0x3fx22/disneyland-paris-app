...
public final class SubscriptionsProvider extends AutoRefreshingDataProvider<Set<? extends String>, AudienceOverrides.Channel> {
    ...
    @Override // com.urbanairship.util.AutoRefreshingDataProvider
    @Nullable
    /* JADX INFO: renamed from: onFetch-gIAlu-s, reason: not valid java name */
    public Object mo5079onFetchgIAlus(@NotNull String str, @NotNull Continuation<? super Result<? extends Set<? extends String>>> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (!this.privacyManager.isEnabled(PrivacyManager.Feature.TAGS_AND_ATTRIBUTES)) {
                ...
                return Result.m5277constructorimpl(ResultKt.createFailure(new IllegalStateException("Unable to fetch subscriptions when FEATURE_TAGS_AND_ATTRIBUTES are disabled")));
            }
    ...
    @NotNull
    /* JADX INFO: renamed from: onApplyOverrides, reason: avoid collision after fix types in other method */
