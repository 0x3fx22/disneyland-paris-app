...
public abstract class AttributeEditor {
    ...
    public final AttributeEditor setAttribute(@Size(min = 1) @NotNull String attribute, @Size(max = 1024, min = 1) @NotNull String string) throws IllegalArgumentException {
        ...
        ResultKt.throwOnFailure(m5074addMutation0E7RQCE$default(this, attribute, null, JsonValue.wrap(string), 2, null));
        return this;
    }
    ...
    public final AttributeEditor setAttribute(@Size(min = 1) @NotNull String attribute, int number) throws IllegalArgumentException {
        Intrinsics.checkNotNullParameter(attribute, "attribute");
        ResultKt.throwOnFailure(m5074addMutation0E7RQCE$default(this, attribute, null, JsonValue.wrap(number), 2, null));
        return this;
    }
    ...
    public final AttributeEditor setAttribute(@Size(min = 1) @NotNull String attribute, float number) throws IllegalArgumentException {
        ...
        ResultKt.throwOnFailure(m5074addMutation0E7RQCE$default(this, attribute, null, JsonValue.wrap(Float.valueOf(number)), 2, null));
        return this;
    }
    ...
    public final AttributeEditor setAttribute(@Size(min = 1) @NotNull String attribute, @NotNull Date date) throws IllegalArgumentException {
        ...
        ResultKt.throwOnFailure(m5074addMutation0E7RQCE$default(this, attribute, null, JsonValue.wrap(strCreateIso8601TimeStamp), 2, null));
        return this;
    }
    ...
    public final AttributeEditor removeAttribute(@Size(min = 1) @NotNull String attribute) throws IllegalArgumentException {
        Intrinsics.checkNotNullParameter(attribute, "attribute");
        ResultKt.throwOnFailure(m5074addMutation0E7RQCE$default(this, attribute, null, null, 2, null));
        return this;
    }
    ...
    public final AttributeEditor removeAttribute(@Size(min = 1) @NotNull String attribute, @Size(min = 1) @NotNull String instanceId) throws IllegalArgumentException {
        Intrinsics.checkNotNullParameter(attribute, "attribute");
        Intrinsics.checkNotNullParameter(instanceId, "instanceId");
        ResultKt.throwOnFailure(m5073addMutation0E7RQCE(attribute, instanceId, null));
        return this;
    }
    ...
    public final AttributeEditor setAttribute(@Size(min = 1) @NotNull String attribute, @Size(min = 1) @NotNull String instanceId, @Nullable Date expiration, @NotNull JsonMap json) throws IllegalArgumentException {
        ...
        if (expiration != null) {
            ...
            long jM5807plusLRDsOJo = Duration.m5807plusLRDsOJo(duration, DurationKt.toDuration(731, DurationUnit.DAYS));
            if (Duration.m5771compareToLRDsOJo(duration2, duration) <= 0 || Duration.m5771compareToLRDsOJo(duration2, jM5807plusLRDsOJo) > 0) {
        ...
        if (expiration != null) {
            builderPutAll.put("exp", Duration.m5793getInWholeSecondsimpl(DurationKt.toDuration(expiration.getTime(), durationUnit)));
        }
        JsonValue jsonValue = builderPutAll.build().getJsonValue();
        Intrinsics.checkNotNullExpressionValue(jsonValue, "toJsonValue(...)");
        ResultKt.throwOnFailure(m5073addMutation0E7RQCE(attribute, instanceId, jsonValue));
        return this;
    }
    ...
    public final void apply() {
        ...
        while (it.hasNext()) {
            try {
                ...
                UALog.m1746e(e, "Invalid attribute mutation.", new Object[0]);
            }
        }
    ...
    /* JADX INFO: renamed from: addMutation-0E7RQCE$default, reason: not valid java name */
    static /* synthetic */ Object m5074addMutation0E7RQCE$default(AttributeEditor attributeEditor, String str, String str2, JsonValue jsonValue, int i, Object obj) {
        if (obj != null) {
        ...
        return attributeEditor.m5073addMutation0E7RQCE(str, str2, jsonValue);
    }

    /* JADX INFO: renamed from: addMutation-0E7RQCE, reason: not valid java name */
    private final Object m5073addMutation0E7RQCE(String attribute, String instanceId, JsonValue value) {
        if (attribute.length() == 0 || StringsKt.contains$default((CharSequence) attribute, (CharSequence) GherkinLanguageConstants.COMMENT_PREFIX, false, 2, (Object) null)) {
            ...
            return Result.m5277constructorimpl(ResultKt.createFailure(new IllegalArgumentException("Attribute must not be empty or contain '#'")));
        }
        if (instanceId != null && (instanceId.length() == 0 || StringsKt.contains$default((CharSequence) instanceId, (CharSequence) GherkinLanguageConstants.COMMENT_PREFIX, false, 2, (Object) null))) {
            ...
            return Result.m5277constructorimpl(ResultKt.createFailure(new IllegalArgumentException("Instance ID must not be empty or contain '#'")));
        }
        if (instanceId != null) {
        ...
        return Result.m5277constructorimpl(Unit.INSTANCE);
    }
