...
final class ChannelAuthTokenProvider$fetchToken$2 extends SuspendLambda implements Function1 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (str != null && Intrinsics.areEqual(this.$identifier, str)) {
                ...
                if (cachedToken == null) {
                    ...
                    return Result.m5276boximpl(Result.m5277constructorimpl(cachedToken));
                }
            } else {
                Result.Companion companion = Result.INSTANCE;
                return Result.m5276boximpl(Result.m5277constructorimpl(ResultKt.createFailure(new RequestException("Channel mismatch."))));
            }
        } else {
            if (i != 1) {
        ...
        if (requestResult.isSuccessful() && requestResult.getValue() != null) {
            ...
            objM5277constructorimpl = Result.m5277constructorimpl(((AuthToken) requestResult.getValue()).getToken());
        } else {
            Result.Companion companion3 = Result.INSTANCE;
            objM5277constructorimpl = Result.m5277constructorimpl(ResultKt.createFailure(new RequestException("Failed to fetch token: " + requestResult.getStatus())));
        }
