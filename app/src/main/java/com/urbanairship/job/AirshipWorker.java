...
public class AirshipWorker extends ListenableWorker {
    ...
    public /* synthetic */ Object lambda$startWork$1(final CallbackToFutureAdapter.Completer completer) {
        ...
        UALog.m1751v("Running job: %s, work Id: %s run attempt: %s", jobInfo, id, Integer.valueOf(runAttemptCount));
    ...
    /* JADX INFO: renamed from: com.urbanairship.job.AirshipWorker$1 */
    static /* synthetic */ class C53891 {
    ...
    public static /* synthetic */ void lambda$startWork$0(CallbackToFutureAdapter.Completer completer, JobResult jobResult) {
        int i = C53891.$SwitchMap$com$urbanairship$job$JobResult[jobResult.ordinal()];
        if (i == 1) {
    ...
    private JobInfo parseJobInfo() {
        try {
            ...
            UALog.m1746e(e, "Failed to parse jobInfo.", new Object[0]);
            return null;
        }
    }
}
