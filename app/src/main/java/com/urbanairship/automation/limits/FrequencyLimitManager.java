...
public final class FrequencyLimitManager {
    ...
    /* JADX INFO: renamed from: com.urbanairship.automation.limits.FrequencyLimitManager$writePending$1 */
    static final class C51041 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C51041(Continuation continuation) {
            super(continuation);
        }
            ...
            if (!constraintIDs.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (constraintInfo != null && constraintInfo.getOccurrences().size() >= constraintInfo.getConstraint().getCount()) {
                        ...
                        if (Duration.m5771compareToLRDsOJo(DurationKt.toDuration(this.clock.currentTimeMillis() - timeStamp, DurationUnit.MILLISECONDS), constraintInfo.getConstraint().m5059getRangeUwyO8pc()) <= 0) {
                            z = true;
                            break;
                        }
                    }
    ...
    private final void recordOccurrence(List constraintIDs) {
        ...
        try {
            ...
            reentrantLock.unlock();
            BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C51022(null), 3, null);
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
    ...
    /* JADX INFO: renamed from: com.urbanairship.automation.limits.FrequencyLimitManager$recordOccurrence$2 */
    static final class C51022 extends SuspendLambda implements Function2 {
        int label;

        C51022(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return FrequencyLimitManager.this.new C51022(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C51022) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: renamed from: com.urbanairship.automation.limits.FrequencyLimitManager$writePendingInQueue$2 */
    static final class C51052 extends SuspendLambda implements Function1 {
        int label;

        C51052(Continuation continuation) {
            super(1, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Continuation continuation) {
            return FrequencyLimitManager.this.new C51052(continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation continuation) {
            return ((C51052) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object writePendingInQueue(@NotNull Continuation<? super Unit> continuation) {
        Object objRun = this.queue.run(new C51052(null), continuation);
    ...
    public final java.lang.Object writePending(kotlin.coroutines.Continuation r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof com.urbanairship.automation.limits.FrequencyLimitManager.C51041
            if (r0 == 0) goto L13
            r0 = r8
            com.urbanairship.automation.limits.FrequencyLimitManager$writePending$1 r0 = (com.urbanairship.automation.limits.FrequencyLimitManager.C51041) r0
            int r1 = r0.label
        ...
        L94:
            ...
            r8 = r6
        L98:
            com.urbanairship.UALog.m1752v(r8)
            goto L92
        L9c:
    ...
    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Nullable
    /* JADX INFO: renamed from: getFrequencyChecker-gIAlu-s, reason: not valid java name */
    public final Object m5057getFrequencyCheckergIAlus(@Nullable List<String> list, @NotNull Continuation<? super Result<? extends FrequencyChecker>> continuation) {
        FrequencyLimitManager$getFrequencyChecker$1 frequencyLimitManager$getFrequencyChecker$1;
        if (continuation instanceof FrequencyLimitManager$getFrequencyChecker$1) {
            frequencyLimitManager$getFrequencyChecker$1 = (FrequencyLimitManager$getFrequencyChecker$1) continuation;
            int i = frequencyLimitManager$getFrequencyChecker$1.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                frequencyLimitManager$getFrequencyChecker$1.label = i - Integer.MIN_VALUE;
            } else {
                frequencyLimitManager$getFrequencyChecker$1 = new FrequencyLimitManager$getFrequencyChecker$1(this, continuation);
            }
        } else {
            frequencyLimitManager$getFrequencyChecker$1 = new FrequencyLimitManager$getFrequencyChecker$1(this, continuation);
        }
        Object objRun = frequencyLimitManager$getFrequencyChecker$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = frequencyLimitManager$getFrequencyChecker$1.label;
        if (i2 == 0) {
            ...
            FrequencyLimitManager$getFrequencyChecker$2 frequencyLimitManager$getFrequencyChecker$2 = new FrequencyLimitManager$getFrequencyChecker$2(this, list, null);
            frequencyLimitManager$getFrequencyChecker$1.label = 1;
            objRun = serialQueue.run(frequencyLimitManager$getFrequencyChecker$2, frequencyLimitManager$getFrequencyChecker$1);
    ...
    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Nullable
    /* JADX INFO: renamed from: setConstraints-gIAlu-s, reason: not valid java name */
    public final Object m5058setConstraintsgIAlus(@NotNull List<FrequencyConstraint> list, @NotNull Continuation<? super Result<Unit>> continuation) {
        FrequencyLimitManager$setConstraints$1 frequencyLimitManager$setConstraints$1;
        if (continuation instanceof FrequencyLimitManager$setConstraints$1) {
            frequencyLimitManager$setConstraints$1 = (FrequencyLimitManager$setConstraints$1) continuation;
            int i = frequencyLimitManager$setConstraints$1.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                frequencyLimitManager$setConstraints$1.label = i - Integer.MIN_VALUE;
            } else {
                frequencyLimitManager$setConstraints$1 = new FrequencyLimitManager$setConstraints$1(this, continuation);
            }
        } else {
            frequencyLimitManager$setConstraints$1 = new FrequencyLimitManager$setConstraints$1(this, continuation);
        }
        Object objRun = frequencyLimitManager$setConstraints$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = frequencyLimitManager$setConstraints$1.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objRun);
            SerialQueue serialQueue = this.queue;
            FrequencyLimitManager$setConstraints$2 frequencyLimitManager$setConstraints$2 = new FrequencyLimitManager$setConstraints$2(this, list, null);
            frequencyLimitManager$setConstraints$1.label = 1;
            objRun = serialQueue.run(frequencyLimitManager$setConstraints$2, frequencyLimitManager$setConstraints$1);
            if (objRun == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
