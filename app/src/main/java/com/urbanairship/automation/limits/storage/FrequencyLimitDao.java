...
import com.urbanairship.p039db.SuspendingBatchedQueryHelper;
...
public interface FrequencyLimitDao {
    ...
    /* JADX INFO: renamed from: com.urbanairship.automation.limits.storage.FrequencyLimitDao$delete$2 */
    static final class C51062 extends SuspendLambda implements Function2 {
        final /* synthetic */ List $constraintIds;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C51062(List list, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return FrequencyLimitDao.this.new C51062(this.$constraintIds, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(List list, Continuation continuation) {
            return ((C51062) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ Object delete$suspendImpl(FrequencyLimitDao frequencyLimitDao, List<String> list, Continuation<? super Unit> continuation) {
        Object objRunBatched = SuspendingBatchedQueryHelper.INSTANCE.runBatched(list, frequencyLimitDao.new C51062(list, null), continuation);
        return objRunBatched == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objRunBatched : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: com.urbanairship.automation.limits.storage.FrequencyLimitDao$deleteOccurrences$2 */
    static final class C51072 extends SuspendLambda implements Function2 {
        final /* synthetic */ List $constraintIds;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C51072(List list, Continuation continuation) {
            super(2, continuation);
            this.$constraintIds = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return FrequencyLimitDao.this.new C51072(this.$constraintIds, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(List list, Continuation continuation) {
            return ((C51072) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ Object deleteOccurrences$suspendImpl(FrequencyLimitDao frequencyLimitDao, List<String> list, Continuation<? super Unit> continuation) {
        Object objRunBatched = SuspendingBatchedQueryHelper.INSTANCE.runBatched(list, frequencyLimitDao.new C51072(list, null), continuation);
        return objRunBatched == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objRunBatched : Unit.INSTANCE;
    }
}
