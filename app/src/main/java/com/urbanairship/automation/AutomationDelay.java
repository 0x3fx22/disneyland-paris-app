...
public final class AutomationDelay implements JsonSerializable {
    ...
    @Nullable
    /* JADX INFO: renamed from: getSeconds$urbanairship_automation_release, reason: from getter */
    ...
    @Nullable
    /* JADX INFO: renamed from: getExecutionWindow$urbanairship_automation_release, reason: from getter */
        ...
        public final AutomationDelay fromJson(@NotNull JsonValue value) throws JsonException {
            ...
            if (jsonValue2 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    lValueOf = (Long) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue2.getLong(0L)));
                    ...
                    lValueOf = (Long) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue2.getInt(0)));
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("seconds", this.seconds), TuplesKt.m1842to("app_state", this.appState), TuplesKt.m1842to(TCEventPropertiesNames.TCD_SCREEN, this.screens), TuplesKt.m1842to(RegionEvent.REGION_ID, this.regionId), TuplesKt.m1842to("cancellation_triggers", this.cancellationTriggers), TuplesKt.m1842to("execution_window", this.executionWindow)).getJsonValue();
