...
public final /* data */ class PreparedScheduleInfo implements JsonSerializable {
    ...
    @Nullable
    /* JADX INFO: renamed from: component5$urbanairship_automation_release, reason: from getter */
    public final ExperimentResult getExperimentResult() {
        return this.experimentResult;
    }

    @Nullable
    /* JADX INFO: renamed from: component6$urbanairship_automation_release, reason: from getter */
    public final JsonValue getReportingContext() {
        return this.reportingContext;
    }

    @NotNull
    /* JADX INFO: renamed from: component7$urbanairship_automation_release, reason: from getter */
    public final String getTriggerSessionId() {
        return this.triggerSessionId;
    }

    /* JADX INFO: renamed from: component8$urbanairship_automation_release, reason: from getter */
    public final boolean getAdditionalAudienceCheckResult() {
        return this.additionalAudienceCheckResult;
    }

    /* JADX INFO: renamed from: component9$urbanairship_automation_release, reason: from getter */
        ...
        public final PreparedScheduleInfo fromJson(@NotNull JsonValue value) throws JsonException {
            ...
            if (jsonValue3 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass2, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    strOptString2 = (String) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue3.getLong(0L)));
                    ...
                    strOptString2 = (String) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue3.getInt(0)));
            ...
            if (jsonValue5 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    strOptString3 = (String) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue5.getLong(0L)));
                    ...
                    strOptString3 = (String) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue5.getInt(0)));
            ...
            if (jsonValue9 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    boolValueOf = (Boolean) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue9.getLong(0L)));
                    ...
                    boolValueOf = (Boolean) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue9.getInt(0)));
            ...
            if (jsonValue10 != null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass6, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass6, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    numValueOf = (Integer) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue10.getLong(0L)));
                    ...
                    numValueOf = (Integer) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue10.getInt(0)));
    ...
    public JsonValue toJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("schedule_id", this.scheduleId), TuplesKt.m1842to("product_id", this.productId), TuplesKt.m1842to("campaigns", this.campaigns), TuplesKt.m1842to(DeferredApiClient.KEY_CONTACT_ID, this.contactId), TuplesKt.m1842to("experiment_result", this.experimentResult), TuplesKt.m1842to("reporting_context", this.reportingContext), TuplesKt.m1842to("trigger_session_id", this.triggerSessionId), TuplesKt.m1842to("additional_audience_check_result", Boolean.valueOf(this.additionalAudienceCheckResult)), TuplesKt.m1842to("PRIORITY", Integer.valueOf(this.priority))).toJsonValue();
