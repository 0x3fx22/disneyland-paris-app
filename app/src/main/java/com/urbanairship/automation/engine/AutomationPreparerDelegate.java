...
public interface AutomationPreparerDelegate<DataIn, DataOut> {
    ...
    Object mo5033prepare0E7RQCE(DataIn datain, @NotNull PreparedScheduleInfo preparedScheduleInfo, @NotNull Continuation<? super Result<? extends DataOut>> continuation);
}
