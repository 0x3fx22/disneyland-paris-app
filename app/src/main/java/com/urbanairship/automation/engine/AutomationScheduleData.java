...
public final class AutomationScheduleData {
    ...
    public final boolean shouldDelete$urbanairship_automation_release(long date) {
        ...
        ULong uLongM5016getEditGracePeriodDays6VbMDqA = this.schedule.getEditGracePeriodDays();
        if (uLongM5016getEditGracePeriodDays6VbMDqA != null) {
            return date - this.scheduleStateChangeDate >= TimeUnit.DAYS.toMillis(uLongM5016getEditGracePeriodDays6VbMDqA.getData());
        }
        return true;
    }

    public final boolean isExpired$urbanairship_automation_release(long date) {
        ULong uLongM5017getEndDate6VbMDqA = this.schedule.getEndDate();
        return uLongM5017getEndDate6VbMDqA != null && Long.compareUnsigned(uLongM5017getEndDate6VbMDqA.getData(), ULong.m5337constructorimpl(date)) <= 0;
    }
    ...
    public final boolean isActive$urbanairship_automation_release(long date) {
        ...
        ULong uLongM5020getStartDate6VbMDqA = this.schedule.getStartDate();
        return uLongM5020getStartDate6VbMDqA == null || date >= uLongM5020getStartDate6VbMDqA.getData();
    }

    public final boolean isOverLimit$urbanairship_automation_release() {
        UInt uIntM5019getLimit0hXNFcg = this.schedule.getLimit();
        int data = uIntM5019getLimit0hXNFcg != null ? uIntM5019getLimit0hXNFcg.getData() : 1;
        return data != 0 && Integer.compareUnsigned(data, UInt.m5312constructorimpl(this.executionCount)) <= 0;
    }
    ...
    @Metadata(m1835d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0003\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0018\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\u0002H\u0016R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\f"}, m1836d2 = {"Lcom/urbanairship/automation/engine/AutomationScheduleData$Comparator;", "Ljava/util/Comparator;", "Lcom/urbanairship/automation/engine/AutomationScheduleData;", "date", "", "(J)V", "getDate", "()J", "compare", "", ViewProps.LEFT, ViewProps.RIGHT, "urbanairship-automation_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
