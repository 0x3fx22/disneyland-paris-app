...
@Metadata(m1835d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b7\u0018\u00002\u00020\u0001:\u0002\u0003\u0004B\u0007\b\u0004¢\u0006\u0002\u0010\u0002\u0082\u0001\u0002\u0005\u0006¨\u0006\u0007"}, m1836d2 = {"Lcom/urbanairship/automation/ExecutionWindowResult;", "", "()V", "Now", "Retry", "Lcom/urbanairship/automation/ExecutionWindowResult$Now;", "Lcom/urbanairship/automation/ExecutionWindowResult$Retry;", "urbanairship-automation_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
...
public abstract class ExecutionWindowResult {
    ...
    @Metadata(m1835d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\bÆ\n\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0013\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006HÖ\u0003J\t\u0010\u0007\u001a\u00020\bHÖ\u0001J\t\u0010\t\u001a\u00020\nHÖ\u0001¨\u0006\u000b"}, m1836d2 = {"Lcom/urbanairship/automation/ExecutionWindowResult$Now;", "Lcom/urbanairship/automation/ExecutionWindowResult;", "()V", ExactValueMatcher.EQUALS_VALUE_KEY, "", ETCPaymentMethod.OTHER, "", "hashCode", "", "toString", "", "urbanairship-automation_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    public static final class Retry extends ExecutionWindowResult {
        ...
        /* JADX INFO: renamed from: getDelay-UwyO8pc, reason: not valid java name and from getter */
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Duration.m5777equalsimpl0(this.delay, ((Retry) other).delay);
        }

        public int hashCode() {
            return Duration.m5799hashCodeimpl(this.delay);
        }

        @NotNull
        public String toString() {
            return "Retry(delay=" + ((Object) Duration.m5820toStringimpl(this.delay)) + CoreConstants.RIGHT_PARENTHESIS_CHAR;
        }
    }
}
