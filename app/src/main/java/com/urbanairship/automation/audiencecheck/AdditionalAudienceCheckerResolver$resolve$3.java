...
final class AdditionalAudienceCheckerResolver$resolve$3 extends SuspendLambda implements Function1 {
    ...
    public final Object invokeSuspend(Object obj) {
        JsonValue context;
        Object objM5039doResolveBWLJW6A;
        ...
        if (i == 0) {
            ...
            this.label = 1;
            objM5039doResolveBWLJW6A = additionalAudienceCheckerResolver.m5039doResolveBWLJW6A(str, context, deviceInfoProvider, this);
            if (objM5039doResolveBWLJW6A == coroutine_suspended) {
            ...
            ResultKt.throwOnFailure(obj);
            objM5039doResolveBWLJW6A = ((Result) obj).getValue();
        }
        return Result.m5276boximpl(objM5039doResolveBWLJW6A);
    }
}
