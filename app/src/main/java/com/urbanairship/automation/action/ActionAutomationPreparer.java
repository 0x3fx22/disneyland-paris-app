...
public final class ActionAutomationPreparer implements AutomationPreparerDelegate<JsonValue, JsonValue> {
    ...
    @Nullable
    /* JADX INFO: renamed from: prepare-0E7RQCE, reason: avoid collision after fix types in other method and not valid java name and merged with bridge method [inline-methods] */
    public Object mo5033prepare0E7RQCE(@NotNull JsonValue jsonValue, @NotNull PreparedScheduleInfo preparedScheduleInfo, @NotNull Continuation<? super Result<? extends JsonValue>> continuation) {
        return Result.m5277constructorimpl(jsonValue);
    }
