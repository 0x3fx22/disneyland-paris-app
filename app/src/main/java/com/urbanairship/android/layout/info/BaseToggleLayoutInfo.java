...
public class BaseToggleLayoutInfo extends ViewGroupInfo<ItemInfo.ViewItemInfo> implements Identifiable, View {
    ...
    public BaseToggleLayoutInfo(@NotNull JsonMap json) throws JsonException {
        ...
        if (jsonValue5 == null) {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                ...
                jsonValue = (JsonValue) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue5.getInt(0)));
    ...
    @Metadata(m1835d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u000e\u0010\u0002\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0005R\u0019\u0010\u0002\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m1836d2 = {"Lcom/urbanairship/android/layout/info/BaseToggleLayoutInfo$ToggleActions;", "", "stateActions", "", "Lcom/urbanairship/android/layout/property/StateAction;", "(Ljava/util/List;)V", "getStateActions", "()Ljava/util/List;", "urbanairship-layout_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
