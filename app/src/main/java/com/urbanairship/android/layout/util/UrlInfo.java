...
public class UrlInfo {
    ...
    public static Set<UrlInfo> from(@NonNull ViewInfo viewInfo) {
        ...
        int i = C48801.$SwitchMap$com$urbanairship$android$layout$property$ViewType[viewInfo.getType().ordinal()];
        if (i == 1) {
            MediaInfo mediaInfo = (MediaInfo) viewInfo;
            int i2 = C48801.$SwitchMap$com$urbanairship$android$layout$property$MediaType[mediaInfo.getMediaType().ordinal()];
            if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.util.UrlInfo$1 */
    static /* synthetic */ class C48801 {
