...
public final class ConstraintSetBuilder {
    ...
    public ConstraintSetBuilder width(@Nullable Size size, boolean z, @IdRes int i, int i2) {
        if (size != null) {
            if (size instanceof ConstrainedSize) {
                ...
                if (minWidth != null) {
                    int i3 = C48741.f3731x1524574e[minWidth.getType().ordinal()];
                    if (i3 == 1) {
                ...
                if (maxWidth != null) {
                    int i4 = C48741.f3731x1524574e[maxWidth.getType().ordinal()];
                    if (i4 == 1) {
            ...
            int i5 = C48741.f3733x7247d114[width.getType().ordinal()];
            if (i5 == 1) {
    ...
    public ConstraintSetBuilder height(@Nullable Size size, boolean z, @IdRes int i, int i2) {
        if (size != null) {
            if (size instanceof ConstrainedSize) {
                ...
                if (minHeight != null) {
                    int i3 = C48741.f3731x1524574e[minHeight.getType().ordinal()];
                    if (i3 == 1) {
                ...
                if (maxHeight != null) {
                    int i4 = C48741.f3731x1524574e[maxHeight.getType().ordinal()];
                    if (i4 == 1) {
            ...
            int i5 = C48741.f3733x7247d114[height.getType().ordinal()];
            if (i5 == 1) {
    ...
    public ConstraintSetBuilder position(@Nullable Position position, @IdRes int i) {
        if (position != null) {
            ...
            int i2 = C48741.f3732x7ea2d444[position.getHorizontal().ordinal()];
            if (i2 == 1) {
            ...
            int i3 = C48741.f3734x50c60756[position.getVertical().ordinal()];
            if (i3 == 1) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.util.ConstraintSetBuilder$1 */
    static /* synthetic */ class C48741 {

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$ConstrainedSize$ConstrainedDimensionType */
        static final /* synthetic */ int[] f3731x1524574e;

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$HorizontalPosition */
        static final /* synthetic */ int[] f3732x7ea2d444;

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$Size$DimensionType */
        static final /* synthetic */ int[] f3733x7247d114;

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$VerticalPosition */
        static final /* synthetic */ int[] f3734x50c60756;
        ...
        static {
            ...
            try {
                f3734x50c60756[VerticalPosition.BOTTOM.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3734x50c60756[VerticalPosition.CENTER.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            int[] iArr2 = new int[HorizontalPosition.values().length];
            f3732x7ea2d444 = iArr2;
            try {
                iArr2[HorizontalPosition.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3732x7ea2d444[HorizontalPosition.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3732x7ea2d444[HorizontalPosition.CENTER.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            int[] iArr3 = new int[Size.DimensionType.values().length];
            f3733x7247d114 = iArr3;
            try {
                iArr3[Size.DimensionType.AUTO.ordinal()] = 1;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f3733x7247d114[Size.DimensionType.PERCENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3733x7247d114[Size.DimensionType.ABSOLUTE.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            int[] iArr4 = new int[ConstrainedSize.ConstrainedDimensionType.values().length];
            f3731x1524574e = iArr4;
            try {
                iArr4[ConstrainedSize.ConstrainedDimensionType.PERCENT.ordinal()] = 1;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f3731x1524574e[ConstrainedSize.ConstrainedDimensionType.ABSOLUTE.ordinal()] = 2;
