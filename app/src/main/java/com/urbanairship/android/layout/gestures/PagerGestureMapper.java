...
@Metadata(m1835d1 = {"\u0000`\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0006\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0000\u0018\u0000 %2\u00020\u0001:\u0001%B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J(\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0014\u001a\u00020\u00122\u0006\u0010\u0015\u001a\u00020\u0012H\u0002J(\u0010\u0016\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0014\u001a\u00020\u00122\u0006\u0010\u0015\u001a\u00020\u0012H\u0002J*\u0010\u0017\u001a\u0004\u0018\u00010\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u001a2\u0006\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u001c\u001a\u00020\u00122\u0006\u0010\u001d\u001a\u00020\u0012J\u001e\u0010\u001e\u001a\n\u0012\u0004\u0012\u00020 \u0018\u00010\u001f2\u0006\u0010!\u001a\u00020\u00122\u0006\u0010\"\u001a\u00020\u0012J\u0016\u0010#\u001a\u00020$2\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006&"}, m1836d2 = {"Lcom/urbanairship/android/layout/gestures/PagerGestureMapper;", "", "rect", "Landroid/graphics/RectF;", "isRtl", "", "(Landroid/graphics/RectF;Z)V", "bottomRegion", "Lcom/urbanairship/android/layout/gestures/BottomRegion;", "leftRegion", "Lcom/urbanairship/android/layout/gestures/LeftRegion;", "rightRegion", "Lcom/urbanairship/android/layout/gestures/RightRegion;", "topRegion", "Lcom/urbanairship/android/layout/gestures/TopRegion;", "getSwipeAngle", "", "x1", "", "y1", "x2", "y2", "getSwipeDistance", "mapSwipe", "Lcom/urbanairship/android/layout/property/GestureDirection;", "e1", "Landroid/view/MotionEvent;", "e2", "velocityX", "velocityY", "mapTap", "", "Lcom/urbanairship/android/layout/property/GestureLocation;", "x", "y", "onLayoutChanged", "", "Companion", "urbanairship-layout_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
public final class PagerGestureMapper {
    ...
    public final GestureDirection mapSwipe(@Nullable MotionEvent e1, @NotNull MotionEvent e2, float velocityX, float velocityY) {
        ...
        UALog.m1754w("PagerGestureMapper - mapSwipe: " + e1 + ", " + e2 + ", " + velocityX + ", " + velocityY, new Object[0]);
        if (e1.getPointerCount() > 1 || e2.getPointerCount() > 1) {
            return null;
        }
        Pair pairM1842to = TuplesKt.m1842to(Float.valueOf(e1.getX()), Float.valueOf(e1.getY()));
        float fFloatValue = ((Number) pairM1842to.component1()).floatValue();
        float fFloatValue2 = ((Number) pairM1842to.component2()).floatValue();
        Pair pairM1842to2 = TuplesKt.m1842to(Float.valueOf(e2.getX()), Float.valueOf(e2.getY()));
        float fFloatValue3 = ((Number) pairM1842to2.component1()).floatValue();
        float fFloatValue4 = ((Number) pairM1842to2.component2()).floatValue();
    ...
    private final double getSwipeAngle(float x1, float y1, float x2, float y2) {
        double dAtan2 = ((double) ((float) Math.atan2(y1 - y2, x2 - x1))) + 3.141592653589793d;
        double d = RotationOptions.ROTATE_180;
        return (((dAtan2 * d) / 3.141592653589793d) + d) % ((double) Currencies.IDR);
    }
