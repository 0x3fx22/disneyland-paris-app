...
public class ConstrainedViewDelegate {
    ...
    private int constrainDimension(ConstrainedSize.ConstrainedDimension constrainedDimension, ConstrainedSize.ConstrainedDimension constrainedDimension2, int i, int i2) {
        ...
        if (constrainedDimension != null) {
            int i3 = C49481.f3736x1524574e[constrainedDimension.getType().ordinal()];
        ...
        int i4 = C49481.f3736x1524574e[constrainedDimension2.getType().ordinal()];
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.widget.ConstrainedViewDelegate$1 */
    static /* synthetic */ class C49481 {

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$ConstrainedSize$ConstrainedDimensionType */
        static final /* synthetic */ int[] f3736x1524574e;
        ...
        static {
            ...
            try {
                f3736x1524574e[ConstrainedSize.ConstrainedDimensionType.ABSOLUTE.ordinal()] = 2;
