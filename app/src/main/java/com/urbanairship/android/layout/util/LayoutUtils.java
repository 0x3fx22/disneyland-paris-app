...
public final class LayoutUtils {
    ...
    public static void applyMediaImageBorderAndBackground(@NonNull ShapeableImageView shapeableImageView, @Nullable Drawable drawable, @Nullable Border border, @Nullable Color color) {
        ...
        Integer num = border.strokeWidth;
        if (num != null) {
            shapeableImageView.setStrokeWidth(dpToPx(context, num.intValue()));
        }
        Color color2 = border.strokeColor;
        if (color2 != null) {
            int iResolve = color2.resolve(context);
    ...
    public static void applyTextAppearance(@NonNull TextView textView, @NonNull TextAppearance textAppearance) {
        ...
        while (it.hasNext()) {
            int i3 = C48762.$SwitchMap$com$urbanairship$android$layout$property$TextStyle[it.next().ordinal()];
            if (i3 == 1) {
                i |= 1;
            } else if (i3 == 2) {
                i |= 2;
        ...
        int i4 = C48762.f3735x665b25ff[textAppearance.getAlignment().ordinal()];
        if (i4 == 1) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.util.LayoutUtils$2 */
    static /* synthetic */ class C48762 {

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$TextAlignment */
        static final /* synthetic */ int[] f3735x665b25ff;
        ...
        static {
            ...
            try {
                f3735x665b25ff[TextAlignment.START.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3735x665b25ff[TextAlignment.END.ordinal()] = 3;
