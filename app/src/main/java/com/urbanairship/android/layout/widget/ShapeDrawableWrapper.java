...
public class ShapeDrawableWrapper extends DrawableWrapper {
    ...
    /* synthetic */ ShapeDrawableWrapper(ShapeState shapeState, Resources resources, C49501 c49501) {
    ...
    protected void onBoundsChange(@NonNull Rect rect) {
        ...
        int i2 = C49501.f3737x7ea2d444[this.gravityPosition.ordinal()];
        if (i2 == 1) {
            rect2.left += iWidth2;
            rect2.right -= iWidth2;
        } else if (i2 == 2) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.widget.ShapeDrawableWrapper$1 */
    static /* synthetic */ class C49501 {

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$android$layout$property$HorizontalPosition */
        static final /* synthetic */ int[] f3737x7ea2d444;
        ...
        static {
            ...
            try {
                f3737x7ea2d444[HorizontalPosition.START.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3737x7ea2d444[HorizontalPosition.END.ordinal()] = 3;
