...
public final class ButtonLayoutView extends FrameLayout implements BaseView, TappableView, ShrinkableView {
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.view.ButtonLayoutView$triggerDefaultAnimation$1 */
    static final class C48941 extends SuspendLambda implements Function2 {
        final /* synthetic */ MotionEvent $event;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C48941(MotionEvent motionEvent, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return ButtonLayoutView.this.new C48941(this.$event, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C48941) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    private final void triggerDefaultAnimation(MotionEvent event) {
        BuildersKt__Builders_commonKt.launch$default(this.model.getViewScope(), null, null, new C48941(event, null), 3, null);
    }
