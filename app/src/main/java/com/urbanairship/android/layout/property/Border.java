...
public final class Border {
    ...
    public final boolean applyToShape(@NotNull ShapeAppearanceModel.Builder shape, @NotNull Function1<? super Integer, Integer> toPxConverter) {
        ...
        if (cornerRadius != null) {
            ...
            Integer num = this.radius;
            if (num != null) {
                shape.setAllCorners(0, toPxConverter.invoke(num).intValue());
            }
        }
    ...
    public final void applyToClippable(@NotNull Clippable view, @NotNull Function1<? super Integer, Float> toPxConverter) {
        ...
        if (cornerRadius != null) {
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                Integer maxCornerRadius$urbanairship_layout_release = cornerRadius.getMaxCornerRadius$urbanairship_layout_release();
                view.setClipPathBorderRadius(maxCornerRadius$urbanairship_layout_release != null ? maxCornerRadius$urbanairship_layout_release.intValue() : 0);
                return;
            }
        }
        Integer num = this.radius;
    ...
    public static final class CornerRadius {
        ...
        @Metadata(m1835d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\f"}, m1836d2 = {"Lcom/urbanairship/android/layout/property/Border$CornerRadius$Companion;", "", "()V", "BOTTOM_LEFT", "", "BOTTOM_RIGHT", "TOP_LEFT", "TOP_RIGHT", "fromJson", "Lcom/urbanairship/android/layout/property/Border$CornerRadius;", "value", "Lcom/urbanairship/json/JsonValue;", "urbanairship-layout_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
            ...
            public final CornerRadius fromJson(@NotNull JsonValue value) throws JsonException {
                ...
                if (jsonValue3 == null) {
                    ...
                    if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                        ...
                        numValueOf3 = (Integer) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue3.getLong(0L)));
                        ...
                        numValueOf3 = (Integer) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue3.getInt(0)));
                ...
                if (jsonValue4 != null) {
                    ...
                    if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                        ...
                        numValueOf4 = (Integer) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue4.getInt(0)));
        ...
        public final void applyToShape$urbanairship_layout_release(@NotNull ShapeAppearanceModel.Builder shape, @NotNull Function1<? super Integer, Integer> toPxConverter) {
            ...
            if (num != null) {
                shape.setTopLeftCornerSize(toPxConverter.invoke(Integer.valueOf(num.intValue())).intValue());
            }
            Integer num2 = this.topRight;
            if (num2 != null) {
                shape.setTopRightCornerSize(toPxConverter.invoke(Integer.valueOf(num2.intValue())).intValue());
            }
            Integer num3 = this.bottomLeft;
            if (num3 != null) {
                shape.setBottomLeftCornerSize(toPxConverter.invoke(Integer.valueOf(num3.intValue())).intValue());
            }
            Integer num4 = this.bottomRight;
            if (num4 != null) {
                shape.setBottomRightCornerSize(toPxConverter.invoke(Integer.valueOf(num4.intValue())).intValue());
            }
        }
    ...
    @Metadata(m1835d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, m1836d2 = {"Lcom/urbanairship/android/layout/property/Border$Companion;", "", "()V", "fromJson", "Lcom/urbanairship/android/layout/property/Border;", "json", "Lcom/urbanairship/json/JsonMap;", "urbanairship-layout_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
