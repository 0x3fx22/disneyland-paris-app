...
public class ConstrainedSize extends Size {
    ...
    public ConstrainedSize(@NonNull String str, @NonNull String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6) {
        super(str, str2);
        this.minWidth = ConstrainedDimension.m1758of(str3);
        this.minHeight = ConstrainedDimension.m1758of(str4);
        this.maxWidth = ConstrainedDimension.m1758of(str5);
        this.maxHeight = ConstrainedDimension.m1758of(str6);
    }
    ...
    public static abstract class ConstrainedDimension {
        ...
        public static ConstrainedDimension m1758of(@Nullable String str) {
            if (str == null) {
                return null;
            }
