...
public final class PagersViewTracker {
    ...
    /* JADX INFO: renamed from: onPageView-HG0u8IE, reason: not valid java name */
    public final void m4959onPageViewHG0u8IE(@NotNull ReportingEvent.PageViewData pageEvent, long currentDisplayTime) {
        Object value;
        Map mutableMap;
        Object value2;
        Map mutableMap2;
        ...
        tracker.m4962startHG0u8IE(new ViewedPage(pageEvent.getPageIdentifier(), pageEvent.getPageIndex()), currentDisplayTime);
    ...
    /* JADX INFO: renamed from: stop-HG0u8IE, reason: not valid java name */
    public final void m4960stopHG0u8IE(@NotNull String pagerId, long currentDisplayTime) {
        Intrinsics.checkNotNullParameter(pagerId, "pagerId");
        Tracker tracker = (Tracker) ((Map) this.trackers.getValue()).get(pagerId);
        if (tracker != null) {
            tracker.m4963stopLRDsOJo(currentDisplayTime);
        }
    }

    /* JADX INFO: renamed from: stopAll-LRDsOJo, reason: not valid java name */
    public final void m4961stopAllLRDsOJo(long currentDisplayTime) {
        Iterator it = ((Map) this.trackers.getValue()).values().iterator();
        while (it.hasNext()) {
            ((Tracker) it.next()).m4963stopLRDsOJo(currentDisplayTime);
        }
    }
    ...
    private static final class Tracker {
        ...
        /* JADX INFO: renamed from: start-HG0u8IE, reason: not valid java name */
        public final void m4962startHG0u8IE(ViewedPage page, long j) {
            ...
            this.currentPageViewStartedTime = Duration.m5770boximpl(j);
        }

        /* JADX INFO: renamed from: stop-LRDsOJo, reason: not valid java name */
        public final void m4963stopLRDsOJo(long j) {
            ...
            if (duration != null) {
                ...
                if (Duration.m5771compareToLRDsOJo(j, rawValue) < 0) {
                ...
                this.viewHistory.add(new ReportingEvent.PageSummaryData.PageView(viewedPage.getIdentifier(), viewedPage.getIndex(), Duration.m5778getAbsoluteValueUwyO8pc(Duration.m5806minusLRDsOJo(j, rawValue)), null));
