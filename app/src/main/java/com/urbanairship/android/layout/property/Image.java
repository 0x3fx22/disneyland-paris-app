...
public abstract class Image {
    ...
    /* synthetic */ Image(Type type, C48501 c48501) {
        this(type);
    }
    ...
    /* JADX INFO: renamed from: com.urbanairship.android.layout.property.Image$1 */
    static /* synthetic */ class C48501 {
    ...
    public static Image fromJson(@NonNull JsonMap jsonMap) throws JsonException {
        ...
        int i = C48501.$SwitchMap$com$urbanairship$android$layout$property$Image$Type[Type.from(strOptString).ordinal()];
        if (i == 1) {
