...
public final /* data */ class LayoutInfo {
    ...
    public LayoutInfo(@NotNull JsonMap json) throws JsonException {
        ...
        if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(String.class))) {
            ...
            jsonMapOptMap2 = (JsonMap) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue5.getLong(0L)));
            ...
            jsonMapOptMap2 = (JsonMap) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue5.getInt(0)));
