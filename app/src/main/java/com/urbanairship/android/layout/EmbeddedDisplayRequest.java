...
public final /* data */ class EmbeddedDisplayRequest {
    ...
    public static /* synthetic */ EmbeddedDisplayRequest copy$default(EmbeddedDisplayRequest embeddedDisplayRequest, String str, String str2, int i, JsonMap jsonMap, Function0 function0, Function0 function1, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 32) != 0) {
            function1 = embeddedDisplayRequest.displayArgsProvider;
        }
        return embeddedDisplayRequest.copy(str, str3, i3, jsonMap2, function2, function1);
    }
