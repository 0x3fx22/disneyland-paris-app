...
public class BaseNotificationProvider extends AirshipNotificationProvider {
    ...
    @NotNull
    /* JADX INFO: renamed from: getContext$airship_framework_proxy_release, reason: from getter */
