    ...
    public AttributeOperation(@NotNull JsonMap json) throws JsonException {
        ...
        if (jsonValue9 == null) {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(String.class))) {
                ...
                lValueOf = (Long) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue9.getLong(0L)));
                ...
                lValueOf = (Long) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue9.getInt(0)));
