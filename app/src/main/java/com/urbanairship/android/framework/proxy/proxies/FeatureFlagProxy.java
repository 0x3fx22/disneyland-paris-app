...
public final /* data */ class FeatureFlagProxy implements JsonSerializable {
    ...
    @NotNull
    /* JADX INFO: renamed from: component1$airship_framework_proxy_release, reason: from getter */
    ...
    public FeatureFlagProxy(@NotNull JsonValue jsonValue) throws JsonException {
        ...
        if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(String.class))) {
            ...
            jsonValue2 = (JsonValue) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue3.getLong(0L)));
            ...
            jsonValue2 = (JsonValue) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue3.getInt(0)));
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("isEligible", Boolean.valueOf(this.original.getIsEligible())), TuplesKt.m1842to("exists", Boolean.valueOf(this.original.getExists())), TuplesKt.m1842to("variables", this.original.getVariables()), TuplesKt.m1842to("_internal", this.original)).getJsonValue();
