...
public final class DeepLinkEvent implements Event {
    ...
    public DeepLinkEvent(@NotNull String deepLink) {
        ...
        this.body = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("deepLink", deepLink));
    }
