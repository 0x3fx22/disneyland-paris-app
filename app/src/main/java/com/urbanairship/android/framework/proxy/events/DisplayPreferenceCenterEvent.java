...
public final class DisplayPreferenceCenterEvent implements Event {
    ...
    public DisplayPreferenceCenterEvent(@NotNull String preferenceCenterId) {
        ...
        this.body = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("preferenceCenterId", preferenceCenterId));
    }
