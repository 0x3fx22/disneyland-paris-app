...
@Metadata(m1835d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\b"}, m1836d2 = {"Lcom/urbanairship/permission/SystemSettingsLauncher;", "", "()V", "openAppNotificationSettings", "", "context", "Landroid/content/Context;", "openAppSettings", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
public final class SystemSettingsLauncher {
    ...
    public final boolean openAppNotificationSettings(@NotNull Context context) {
        ...
        try {
            ...
            UALog.m1750i(e, new Function0() { // from class: com.urbanairship.permission.SystemSettingsLauncher.openAppNotificationSettings.1
            ...
            try {
                ...
                UALog.m1750i(e2, new Function0() { // from class: com.urbanairship.permission.SystemSettingsLauncher.openAppNotificationSettings.2
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Failed to launch notification settings.";
                    }
    ...
    public final boolean openAppSettings(@NotNull Context context) {
        ...
        try {
            ...
            UALog.m1750i(e, new Function0() { // from class: com.urbanairship.permission.SystemSettingsLauncher.openAppSettings.1
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
            ...
            try {
                ...
                UALog.m1750i(e2, new Function0() { // from class: com.urbanairship.permission.SystemSettingsLauncher.openAppSettings.2
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
