...
public class PermissionsActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        ...
        for (Intent intent : this.intents) {
            UALog.m1751v("Permission request cancelled", intent);
    ...
    private void processNextIntent() {
        ...
        if (this.isResumed && this.currentRequest == null) {
            ...
            UALog.m1751v("Requesting permission %s", stringExtra);
    ...
    public void onPermissionResult(Boolean bool) {
        ...
        UALog.m1751v("Received permission result: permission %s, shouldShowRequestPermissionRationale before: %s, shouldShowRequestPermissionRationale after: %s, granted: %s, time: %s", permissionRequest.permission, Boolean.valueOf(permissionRequest.startShowRationale), Boolean.valueOf(zShouldShowRequestPermissionRationale), bool, Long.valueOf(jCurrentTimeMillis));
