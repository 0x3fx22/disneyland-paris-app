...
public class AirshipWebViewClient extends WebViewClient {
    ...
    private WebResourceResponse generateEmptyFaviconResponse(WebView webView) {
        try {
            ...
            UALog.m1746e(e, "Failed to read blank favicon with IOException.", new Object[0]);
            return null;
        }
    }
    ...
    public void onPageFinished(@Nullable WebView webView, @Nullable String str) {
        ...
        if (!isAllowed(str)) {
            UALog.m1741d("%s is not an allowed URL. Airship Javascript interface will not be accessible.", str);
            return;
        }
