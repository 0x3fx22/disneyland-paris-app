...
final class FlagDeferredResolver$resolve$2$execution$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            objM5110resolveBWLJW6A = flagDeferredResolver.m5110resolveBWLJW6A(deferredRequest, featureFlagInfo, str, this);
            if (objM5110resolveBWLJW6A == coroutine_suspended) {
            ...
            ResultKt.throwOnFailure(obj);
            objM5110resolveBWLJW6A = ((Result) obj).getValue();
        }
        return Result.m5276boximpl(objM5110resolveBWLJW6A);
    }
}
