...
public final class FeatureFlagResultCache {
    ...
    public final Object m5105cache8Mi8wO0(@NotNull FeatureFlag featureFlag, long j, @NotNull Continuation<? super Unit> continuation) {
        Object objM5067storeexY8QGI;
        String strMakeKey = makeKey(featureFlag.getName());
        return (strMakeKey != null && (objM5067storeexY8QGI = this.cache.m5067storeexY8QGI(featureFlag, strMakeKey, j, continuation)) == IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? objM5067storeexY8QGI : Unit.INSTANCE;
    }
    ...
    /* JADX INFO: renamed from: cacheAsync-2TYgG_w, reason: not valid java name */
    public final void m5106cacheAsync2TYgG_w(@NotNull FeatureFlag flag, long ttlMilliseconds) {
    ...
    /* JADX INFO: renamed from: com.urbanairship.featureflag.FeatureFlagResultCache$flagAsync$1 */
    static final class C52981 extends SuspendLambda implements Function2 {
        ...
        C52981(PendingResult pendingResult, FeatureFlagResultCache featureFlagResultCache, String str, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new C52981(this.$pendingResult, this.this$0, this.$name, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C52981) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final PendingResult<FeatureFlag> flagAsync(@NotNull String name) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.pendingResultScope, null, null, new C52981(pendingResult, this, name, null), 3, null);
        return pendingResult;
    }

    /* JADX INFO: renamed from: com.urbanairship.featureflag.FeatureFlagResultCache$removeCachedFlagAsync$1 */
    static final class C52991 extends SuspendLambda implements Function2 {
        final /* synthetic */ String $name;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C52991(String str, Continuation continuation) {
            super(2, continuation);
            this.$name = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return FeatureFlagResultCache.this.new C52991(this.$name, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C52991) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final void removeCachedFlagAsync(@NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        BuildersKt__Builders_commonKt.launch$default(this.pendingResultScope, null, null, new C52991(name, null), 3, null);
    }
