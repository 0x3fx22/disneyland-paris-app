...
public class RetryingExecutor implements Executor {
    ...
    static {
        long j = -1;
        RunnableC58811 runnableC58811 = null;
        FINISHED_RESULT = new Result(Status.FINISHED, j, runnableC58811);
        CANCEL_RESULT = new Result(Status.CANCEL, j, runnableC58811);
    }
    ...
    /* JADX INFO: renamed from: com.urbanairship.util.RetryingExecutor$1 */
    class RunnableC58811 implements Runnable {
        final /* synthetic */ long val$nextBackOff;
        final /* synthetic */ Operation val$operation;

        RunnableC58811(Operation operation, long j) {
    ...
    public void execute(@NonNull Operation operation, long j) {
        this.executor.execute(new RunnableC58811(operation, j));
    }
    ...
    public static class Result {
        ...
        /* synthetic */ Result(Status status, long j, RunnableC58811 runnableC58811) {
            this(status, j);
        }
