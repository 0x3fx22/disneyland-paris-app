...
public abstract class DataManager {
    ...
    public DataManager(@NonNull Context context, @NonNull String str, @NonNull String str2, int i) {
        ...
        this.openHelper = new SQLiteOpenHelper(context, strMigrateDatabase, null, i) { // from class: com.urbanairship.util.DataManager.1
            ...
            public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
                UALog.m1741d("Upgrading database %s from version %s to %s", sQLiteDatabase, Integer.valueOf(i2), Integer.valueOf(i3));
                DataManager.this.onUpgrade(sQLiteDatabase, i2, i3);
            }

            @Override // android.database.sqlite.SQLiteOpenHelper
            public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
                UALog.m1741d("Downgrading database %s from version %s to %s", sQLiteDatabase, Integer.valueOf(i2), Integer.valueOf(i3));
    ...
    protected SQLiteDatabase getWritableDatabase() {
        for (int i = 0; i < 3; i++) {
            try {
                ...
                UALog.m1746e(e, "DataManager - Error opening writable database. Retrying...", new Object[0]);
            }
        }
        return null;
    }
    ...
    protected SQLiteDatabase getReadableDatabase() {
        for (int i = 0; i < 3; i++) {
            try {
                ...
                SystemClock.sleep(100L);
                UALog.m1746e(e, "DataManager - Error opening readable database. Retrying...", new Object[0]);
            }
        }
        return null;
    }
    ...
    protected void onUpgrade(@NonNull SQLiteDatabase sQLiteDatabase, int i, int i2) {
        UALog.m1741d("onUpgrade not implemented yet.", new Object[0]);
    }
    ...
    public int delete(@NonNull String str, @Nullable String str2, @Nullable String[] strArr) {
        ...
        for (int i = 0; i < 3; i++) {
            try {
                ...
                UALog.m1746e(e, "Unable to delete item from a database", new Object[0]);
            }
        }
        return -1;
    }
    ...
    @NonNull
    public List<ContentValues> bulkInsert(@NonNull String str, @NonNull ContentValues[] contentValuesArr) {
        SQLiteDatabase writableDatabase = getWritableDatabase();
        ...
        for (ContentValues contentValues : contentValuesArr) {
            try {
                ...
                UALog.m1746e(e, "Unable to insert into database", new Object[0]);
    ...
    public int update(@NonNull String str, @Nullable ContentValues contentValues, @Nullable String str2, @Nullable String[] strArr) {
        ...
        for (int i = 0; i < 3; i++) {
            try {
                ...
                UALog.m1746e(e, "Update Failed", new Object[0]);
            }
        }
        return -1;
    }
    ...
    public Cursor query(@NonNull String str, @Nullable String[] strArr, @Nullable String str2, @Nullable String[] strArr2, @Nullable String str3, @Nullable String str4) {
        ...
        for (int i = 0; i < 3; i++) {
            try {
                ...
                UALog.m1746e(e, "Query Failed", new Object[0]);
            }
        }
        return null;
    }
    ...
    public void close() {
        try {
            ...
            UALog.m1746e(e, "Failed to close the database.", new Object[0]);
        }
    }
    ...
    public boolean deleteDatabase(@NonNull Context context) {
        try {
            ...
            UALog.m1746e(e, "Failed to delete database: " + this.path, new Object[0]);
            return false;
        }
    }
    ...
    protected static String migrateDatabase(@NonNull Context context, String str, String str2) {
        ...
        if (!file.exists() && !file.mkdirs()) {
            UALog.m1744e("Failed to create UA no backup directory.", new Object[0]);
        }
            ...
            if (file3.exists()) {
                ...
                if (file4.exists()) {
                    if (!file4.renameTo(new File(file2.getAbsolutePath() + "-journal"))) {
                        UALog.m1744e("Failed to move the journal file: " + file4, new Object[0]);
                    }
                }
            }
        }
