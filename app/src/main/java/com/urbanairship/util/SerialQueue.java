...
public final class SerialQueue {
    ...
    public final <T> Object run(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        return CoroutineScopeKt.coroutineScope(new C58832(function1, this.nextTaskNumber.getAndIncrement(), null), continuation);
    }

    /* JADX INFO: renamed from: com.urbanairship.util.SerialQueue$run$2 */
    static final class C58832 extends SuspendLambda implements Function2 {
        final /* synthetic */ long $myTask;
        final /* synthetic */ Function1 $operation;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C58832(Function1 function1, long j, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return SerialQueue.this.new C58832(this.$operation, this.$myTask, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C58832) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX INFO: renamed from: com.urbanairship.util.SerialQueue$run$2$1, reason: invalid class name */
