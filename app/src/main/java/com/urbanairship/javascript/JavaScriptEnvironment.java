...
public class JavaScriptEnvironment {
    ...
    public String getJavaScript(@NonNull Context context) {
        ...
        try {
            ...
            UALog.m1744e("Failed to read native bridge.", new Object[0]);
            return "";
        }
    }

    private static String readNativeBridge(Context context) {
        ...
        try {
            ...
            try {
                ...
                UALog.m1742d(e, "Failed to close streams", new Object[0]);
            }
            return string;
        } catch (Throwable th) {
            try {
                ...
                UALog.m1742d(e2, "Failed to close streams", new Object[0]);
            }
            throw th;
        }
    }
