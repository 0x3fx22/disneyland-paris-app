...
public final /* data */ class RemoteDataInfo implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("url", this.url), TuplesKt.m1842to("lastModified", this.lastModified), TuplesKt.m1842to("source", this.source.name()), TuplesKt.m1842to("contactId", this.contactId)).getJsonValue();
