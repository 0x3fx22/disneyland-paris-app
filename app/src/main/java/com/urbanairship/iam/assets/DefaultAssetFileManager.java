...
@Metadata(m1835d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\t\b\u0000\u0018\u0000 \u00172\u00020\u0001:\u0001\u0017B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0016J\u0010\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0005H\u0016J\u0010\u0010\u0011\u001a\u00020\u00072\u0006\u0010\u0010\u001a\u00020\u0005H\u0016J\b\u0010\u0012\u001a\u00020\rH\u0002J\b\u0010\u0013\u001a\u00020\rH\u0016J\u0018\u0010\u0014\u001a\u00020\u000f2\u0006\u0010\u0015\u001a\u00020\r2\u0006\u0010\u0016\u001a\u00020\rH\u0016R\u000e\u0010\u0004\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0018"}, m1836d2 = {"Lcom/urbanairship/iam/assets/DefaultAssetFileManager;", "Lcom/urbanairship/iam/assets/AssetFileManager;", "context", "Landroid/content/Context;", "rootFolder", "", "(Landroid/content/Context;Ljava/lang/String;)V", "Ljava/io/File;", "storageManager", "Landroid/os/storage/StorageManager;", "assetItemExists", "", "cacheUri", "Landroid/net/Uri;", "clearAssets", "", "identifier", "ensureCacheDirectory", "ensureRootCacheDirectory", "getRootDirectory", "moveAsset", "from", TypedValues.TransitionType.S_TO, "Companion", "urbanairship-automation_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
...
public final class DefaultAssetFileManager implements AssetFileManager {
    ...
    public File ensureCacheDirectory(@NotNull String identifier) throws IOException {
        ...
        try {
            ...
            UALog.m1747e(e, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAssetFileManager.ensureCacheDirectory.1
    ...
    public void moveAsset(@NotNull final Uri from, @NotNull final Uri to) throws IOException {
        ...
        if (!file.renameTo(file2)) {
            try {
                ...
                UALog.m1747e(e, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAssetFileManager.moveAsset.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
