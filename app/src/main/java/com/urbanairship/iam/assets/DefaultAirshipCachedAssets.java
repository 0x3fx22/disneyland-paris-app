...
public final class DefaultAirshipCachedAssets implements AirshipCachedAssets {
    ...
    public Uri cacheUri(@NotNull final String remoteUrl) {
        ...
        try {
            ...
            UALog.m1747e(e, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.cacheUri.1
    ...
    public boolean isCached(@NotNull final String remoteUrl) {
        ...
        try {
            ...
            UALog.m1747e(e, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.isCached.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            try {
                if (this.fileManager.assetItemExists(uriCacheUri)) {
                    ...
                    try {
                        ...
                        UALog.m1747e(e, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets$generateAndStoreMetadata$json$1
                            @Override // kotlin.jvm.functions.Function0
                            public final String invoke() {
                ...
                UALog.m1747e(e2, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets$generateAndStoreMetadata$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
    ...
    private final JsonValue sizeToJson(Size size) {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("height", Integer.valueOf(size.getHeight())), TuplesKt.m1842to("width", Integer.valueOf(size.getWidth()))).getJsonValue();
    ...
    private final void writeJson(File destination, JsonValue jsonValue) {
        try {
            ...
            UALog.m1747e(e, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.writeJson.2
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
    ...
    private final JsonValue readJson(File metadata) {
        ...
        try {
            ...
            UALog.m1747e(e, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.readJson.3
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
            ...
            UALog.m1747e(e2, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.readJson.2
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Failed to read cached asset metadata!";
                }
            });
            JsonValue NULL3 = JsonValue.NULL;
    ...
    public void writeToParcel(@NotNull Parcel parcel, int flags) {
        ...
        try {
            ...
            UALog.m1747e(e, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets.writeToParcel.1
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
    ...
    /* JADX INFO: renamed from: com.urbanairship.iam.assets.DefaultAirshipCachedAssets$CREATOR, reason: from kotlin metadata */
    @Metadata(m1835d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0012\u0010\t\u001a\u0004\u0018\u00010\u00022\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u001d\u0010\f\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016¢\u0006\u0002\u0010\u0010R\u0016\u0010\u0004\u001a\u00020\u00058\u0000X\u0081T¢\u0006\b\n\u0000\u0012\u0004\b\u0006\u0010\u0003R\u000e\u0010\u0007\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0011"}, m1836d2 = {"Lcom/urbanairship/iam/assets/DefaultAirshipCachedAssets$CREATOR;", "Landroid/os/Parcelable$Creator;", "Lcom/urbanairship/iam/assets/AirshipCachedAssets;", "()V", "METADATA_EXTENSION", "", "getMETADATA_EXTENSION$urbanairship_automation_release$annotations", "METADATA_IMAGE_HEIGHT", "METADATA_IMAGE_WIDTH", "createFromParcel", "parcel", "Landroid/os/Parcel;", "newArray", "", TCEventPropertiesNames.TCP_SIZE, "", "(I)[Lcom/urbanairship/iam/assets/AirshipCachedAssets;", "urbanairship-automation_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    public static final class Companion implements Parcelable.Creator<AirshipCachedAssets> {
        ...
        @VisibleForTesting
        /* JADX INFO: renamed from: getMETADATA_EXTENSION$urbanairship_automation_release$annotations */
        public static /* synthetic */ void m1769x243f94b() {
        }
        ...
        public AirshipCachedAssets createFromParcel(@NotNull Parcel parcel) throws JsonException {
            ...
            try {
                ...
                UALog.m1747e(e, new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets$CREATOR$createFromParcel$metadata$1
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
            ...
            try {
                ...
                UALog.m1747e(e2, (Function0<String>) new Function0() { // from class: com.urbanairship.iam.assets.DefaultAirshipCachedAssets$CREATOR$createFromParcel$directory$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
