...
public final /* data */ class InAppCustomEventContext implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("id", this.id), TuplesKt.m1842to("context", this.context)).getJsonValue();
