...
public final /* data */ class AirshipDeviceAudienceResult implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("is_match", Boolean.valueOf(this.isMatch)), TuplesKt.m1842to("reporting_metadata", this.reportingMetadata)).getJsonValue();
