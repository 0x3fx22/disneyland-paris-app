...
public final class AudienceHashSelector implements JsonSerializable {
    ...
    @NotNull
    /* JADX INFO: renamed from: getHash$urbanairship_core_release, reason: from getter */
    public final AudienceHash getHash() {
        return this.hash;
    }

    @NotNull
    /* JADX INFO: renamed from: getBucket$urbanairship_core_release, reason: from getter */
    public final BucketSubset getBucket() {
        return this.bucket;
    }

    @Nullable
    /* JADX INFO: renamed from: getSticky$urbanairship_core_release, reason: from getter */
    public final AudienceSticky getSticky() {
        return this.sticky;
    }

    @Metadata(m1835d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0017\u0010\u0007\u001a\u0004\u0018\u00010\b2\u0006\u0010\t\u001a\u00020\nH\u0000¢\u0006\u0002\b\u000bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\f"}, m1836d2 = {"Lcom/urbanairship/audience/AudienceHashSelector$Companion;", "", "()V", "KEY_BUCKET_SUBSET", "", "KEY_HASH", "KEY_STICKY", "fromJson", "Lcom/urbanairship/audience/AudienceHashSelector;", "json", "Lcom/urbanairship/json/JsonMap;", "fromJson$urbanairship_core_release", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    ...
    public final boolean evaluate$urbanairship_core_release(@NotNull String channelId, @NotNull String contactId) {
        ...
        ULong uLongM5004generateJlBESG8$urbanairship_core_release = this.hash.m5004generateJlBESG8$urbanairship_core_release(MapsKt.mapOf(TuplesKt.m1842to(HashIdentifiers.CONTACT.getJsonValue(), contactId), TuplesKt.m1842to(HashIdentifiers.CHANNEL.getJsonValue(), channelId)));
        if (uLongM5004generateJlBESG8$urbanairship_core_release == null) {
            return false;
        }
        return this.bucket.m5009containsVKZWuLQ(uLongM5004generateJlBESG8$urbanairship_core_release.getData());
    }
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("audience_hash", this.hash), TuplesKt.m1842to("audience_subset", this.bucket), TuplesKt.m1842to("sticky", this.sticky)).getJsonValue();
