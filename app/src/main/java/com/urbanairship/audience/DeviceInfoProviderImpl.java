...
public final class DeviceInfoProviderImpl implements DeviceInfoProvider {
    ...
    /* JADX INFO: renamed from: com.urbanairship.audience.DeviceInfoProviderImpl$getPermissionStatuses$1 */
    static final class C49631 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        C49631(Continuation continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: renamed from: com.urbanairship.audience.DeviceInfoProviderImpl$getStableContactInfo$1 */
    static final class C49641 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49641(Continuation continuation) {
            super(continuation);
        }
    ...
    /* JADX WARN: Code duplicated, block: B:19:0x0092 A[RETURN] */
    ...
    public java.lang.Object getPermissionStatuses(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.util.Map<com.urbanairship.permission.Permission, ? extends com.urbanairship.permission.PermissionStatus>> r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof com.urbanairship.audience.DeviceInfoProviderImpl.C49631
            if (r0 == 0) goto L13
            r0 = r8
            com.urbanairship.audience.DeviceInfoProviderImpl$getPermissionStatuses$1 r0 = (com.urbanairship.audience.DeviceInfoProviderImpl.C49631) r0
            int r1 = r0.label
    ...
    public Object getStableContactInfo(@NotNull Continuation<? super StableContactInfo> continuation) {
        ...
        if (continuation instanceof C49641) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                c49641.label = i - Integer.MIN_VALUE;
            } else {
        ...
        Object objStableContactInfo$urbanairship_core_release = c49641.result;
        ...
        if (i2 == 0) {
            ...
            c49641.L$0 = this;
            c49641.label = 1;
            objStableContactInfo$urbanairship_core_release = contact.stableContactInfo$urbanairship_core_release(c49641);
            ...
            this = (DeviceInfoProviderImpl) c49641.L$0;
            ResultKt.throwOnFailure(objStableContactInfo$urbanairship_core_release);
        }
        StableContactInfo stableContactInfo = (StableContactInfo) objStableContactInfo$urbanairship_core_release;
        return (this.contactId == null || Intrinsics.areEqual(stableContactInfo.getContactId(), this.contactId)) ? stableContactInfo : new StableContactInfo(this.contactId, null);
    }
