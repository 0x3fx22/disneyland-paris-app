...
public final /* data */ class RemoteConfig implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        RemoteAirshipConfig remoteAirshipConfig = this.airshipConfig;
        Pair pairM1842to = TuplesKt.m1842to("airship_config", remoteAirshipConfig != null ? remoteAirshipConfig.getJsonValue() : null);
        MeteredUsageConfig meteredUsageConfig = this.meteredUsageConfig;
        Pair pairM1842to2 = TuplesKt.m1842to("metered_usage", meteredUsageConfig != null ? meteredUsageConfig.getJsonValue() : null);
        Pair pairM1842to3 = TuplesKt.m1842to("fetch_contact_remote_data", this.fetchContactRemoteData);
        ContactConfig contactConfig = this.contactConfig;
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(pairM1842to, pairM1842to2, pairM1842to3, TuplesKt.m1842to("contact_config", contactConfig != null ? contactConfig.getJsonValue() : null), TuplesKt.m1842to("disabled_features", this.disabledFeatures), TuplesKt.m1842to("remote_data_refresh_interval", this.remoteDataRefreshInterval), TuplesKt.m1842to("in_app_config", this.iaaConfig)).getJsonValue();
        Intrinsics.checkNotNullExpressionValue(jsonValue, "toJsonValue(...)");
        return jsonValue;
    }

    @Metadata(m1835d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0007J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000fH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m1836d2 = {"Lcom/urbanairship/remoteconfig/RemoteConfig$Companion;", "", "()V", "AIRSHIP_CONFIG_KEY", "", "CONTACT_CONFIG_KEY", "DISABLED_FEATURES_KEY", "FETCH_CONTACT_REMOTE_DATA_KEY", "IAA_CONFIG", "METERED_USAGE_CONFIG_KEY", "REMOTE_DATA_REFRESH_INTERVAL_KEY", "fromJson", "Lcom/urbanairship/remoteconfig/RemoteConfig;", "json", "Lcom/urbanairship/json/JsonMap;", "Lcom/urbanairship/json/JsonValue;", "urbanairship-core_release"}, m1837k = 1, m1838mv = {1, 9, 0}, m1840xi = 48)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        ...
        public final RemoteConfig fromJson(@NotNull JsonMap json) {
            ...
            if (jsonValue4 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass, Reflection.getOrCreateKotlinClass(String.class))) {
                    ...
                    jsonValue = (JsonValue) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue4.getLong(0L)));
                    ...
                    jsonValue = (JsonValue) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue4.getInt(0)));
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(String.class))) {
                    ...
                    if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(Boolean.TYPE))) {
                        ...
                        if (Intrinsics.areEqual(orCreateKotlinClass3, Reflection.getOrCreateKotlinClass(ULong.class))) {
                            boolValueOf = (Boolean) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue6.getLong(0L)));
                            ...
                            boolValueOf = (Boolean) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue6.getInt(0)));
            ...
            if (jsonValue8 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(String.class))) {
                    ...
                    if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                        ...
                        jsonValue3 = (JsonValue) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue8.getLong(0L)));
                        ...
                        jsonValue3 = (JsonValue) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue8.getInt(0)));
            ...
            if (jsonValue10 == null) {
                ...
                if (Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                    ...
                    lValueOf = (Long) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue10.getLong(0L)));
                    ...
                    lValueOf = (Long) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue10.getInt(0)));
