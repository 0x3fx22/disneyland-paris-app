...
public final /* data */ class RemoteAirshipConfig implements JsonSerializable {
    ...
    public JsonValue toJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("remote_data_url", this.remoteDataUrl), TuplesKt.m1842to("device_api_url", this.deviceApiUrl), TuplesKt.m1842to("analytics_url", this.analyticsUrl), TuplesKt.m1842to("wallet_url", this.walletUrl), TuplesKt.m1842to("metered_usage_url", this.meteredUsageUrl)).toJsonValue();
    ...
    public RemoteAirshipConfig(@NotNull JsonValue jsonValue) throws JsonException {
        ...
        if (jsonValue5 == null) {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                ...
                strOptString4 = (String) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue5.getLong(0L)));
                ...
                strOptString4 = (String) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue5.getInt(0)));
        ...
        if (jsonValue6 != null) {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass5, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                ...
                strOptString5 = (String) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue6.getLong(0L)));
                ...
                strOptString5 = (String) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue6.getInt(0)));
