...
public /* data */ class ContactIdentity implements JsonSerializable {
    ...
    /* JADX INFO: renamed from: isAnonymous, reason: from getter */
    ...
    public ContactIdentity(@NotNull JsonValue jsonValue) throws JsonException {
        ...
        if (jsonValue6 == null) {
            ...
            if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(String.class)) || Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(CharSequence.class))) {
                ...
                lValueOf = (Long) ULong.m5336boximpl(ULong.m5337constructorimpl(jsonValue6.getLong(0L)));
            } else {
                String str2 = str;
                if (Intrinsics.areEqual(orCreateKotlinClass4, Reflection.getOrCreateKotlinClass(Double.TYPE))) {
                    ...
                    lValueOf = (Long) UInt.m5311boximpl(UInt.m5312constructorimpl(jsonValue6.getInt(0)));
    ...
    public JsonValue getJsonValue() {
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(DeferredApiClient.KEY_CONTACT_ID, getContactId()), TuplesKt.m1842to("is_anonymous", Boolean.valueOf(getIsAnonymous())), TuplesKt.m1842to("named_user_id", getNamedUserId()), TuplesKt.m1842to("resolve_date_ms", getResolveDateMs())).getJsonValue();
