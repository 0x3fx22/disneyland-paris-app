...
public final class ReactMessageViewManager extends SimpleViewManager<ReactMessageView> implements RNAirshipMessageViewManagerInterface<ReactMessageView> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        List<Pair> listListOf = CollectionsKt.listOf((Object[]) new Pair[]{TuplesKt.m1842to("topClose", "onClose"), TuplesKt.m1842to(ReactMessageView.EVENT_LOAD_ERROR_REGISTRATION_NAME, ReactMessageView.EVENT_LOAD_ERROR_HANDLER_NAME), TuplesKt.m1842to(ReactMessageView.EVENT_LOAD_FINISHED_REGISTRATION_NAME, ReactMessageView.EVENT_LOAD_FINISHED_HANDLER_NAME), TuplesKt.m1842to(ReactMessageView.EVENT_LOAD_STARTED_REGISTRATION_NAME, ReactMessageView.EVENT_LOAD_STARTED_HANDLER_NAME)});
        MapBuilder.Builder builder = MapBuilder.builder();
        Intrinsics.checkNotNullExpressionValue(builder, "builder(...)");
        for (Pair pair : listListOf) {
            builder.put((String) pair.component1(), MapBuilder.m1373of("phasedRegistrationNames", MapBuilder.m1373of("bubbled", (String) pair.component2())));
        }
