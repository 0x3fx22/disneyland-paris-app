...
@Metadata(m1835d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0007\u001a\u00020\bX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0014\u0010\u000b\u001a\u00020\fX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, m1836d2 = {"Lcom/urbanairship/reactnative/PendingEmbeddedUpdated;", "Lcom/urbanairship/android/framework/proxy/Event;", ETCPurchaseStatus.PENDING, "", "Lcom/urbanairship/embedded/AirshipEmbeddedInfo;", "<init>", "(Ljava/util/List;)V", "type", "Lcom/urbanairship/android/framework/proxy/EventType;", "getType", "()Lcom/urbanairship/android/framework/proxy/EventType;", RateAppAction.BODY_KEY, "Lcom/urbanairship/json/JsonMap;", "getBody", "()Lcom/urbanairship/json/JsonMap;", "ua_react-native-airship_release"}, m1837k = 1, m1838mv = {2, 0, 0}, m1840xi = 48)
...
public final class PendingEmbeddedUpdated implements Event {
    ...
    public PendingEmbeddedUpdated(@NotNull List<AirshipEmbeddedInfo> pending) {
        ...
        while (it.hasNext()) {
            arrayList.add(JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to("embeddedId", ((AirshipEmbeddedInfo) it.next()).getEmbeddedId())));
        }
        this.body = JsonExtensionsKt.jsonMapOf(TuplesKt.m1842to(ETCPurchaseStatus.PENDING, arrayList));
    }
