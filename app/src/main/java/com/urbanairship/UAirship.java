...
public class UAirship {
    ...
    public static void takeOff(@NonNull final Application application2, @Nullable final AirshipConfigOptions airshipConfigOptions, @Nullable final OnReadyCallback onReadyCallback) {
        ...
        if (Looper.myLooper() == null || Looper.getMainLooper() != Looper.myLooper()) {
            UALog.m1744e("takeOff() must be called on the main thread!", new Object[0]);
        }
        ...
        if (LOG_TAKE_OFF_STACKTRACE) {
            ...
            UALog.m1741d("Takeoff stack trace: %s", sb.toString());
        }
        synchronized (airshipLock) {
            try {
                if (!isFlying && !isTakingOff) {
                    UALog.m1748i("Airship taking off!", new Object[0]);
                    isTakingOff = true;
                ...
                UALog.m1744e("You can only call takeOff() once.", new Object[0]);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public static void executeTakeOff(Application application2, AirshipConfigOptions airshipConfigOptions, OnReadyCallback onReadyCallback) {
        ...
        UALog.m1748i("Airship taking off!", new Object[0]);
        UALog.m1748i("Airship log level: %s", Integer.valueOf(airshipConfigOptions.logLevel));
        UALog.m1748i("UA Version: %s / App key = %s Production = %s", getVersion(), airshipConfigOptions.appKey, Boolean.valueOf(airshipConfigOptions.inProduction));
        UALog.m1751v(BuildConfig.SDK_VERSION, new Object[0]);
        ...
        synchronized (airshipLock) {
            try {
                ...
                isTakingOff = false;
                sharedAirship.init();
                UALog.m1748i("Airship ready!", new Object[0]);
    ...
    public static PackageInfo getPackageInfo() {
        try {
            ...
            UALog.m1756w(e, "UAirship - Unable to get package info.", new Object[0]);
            return null;
        }
    }
    ...
    public <T extends AirshipComponent> T getComponent(@NonNull Class<T> cls) {
        ...
        if (t == null) {
            for (AirshipComponent airshipComponent : this.components) {
    ...
    public boolean deepLink(@NonNull String str) {
        ...
        if ("uairship".equals(uri.getScheme())) {
            ...
            UALog.m1741d("Airship deep link not handled: %s", str);
            return true;
        }
