...
final class DefaultRequestSession$getToken$result$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        Object objMo5075fetchTokengIAlus;
        ...
        if (i == 0) {
            ...
            this.label = 1;
            objMo5075fetchTokengIAlus = authTokenProvider.mo5075fetchTokengIAlus(str, this);
            if (objMo5075fetchTokengIAlus == coroutine_suspended) {
            ...
            ResultKt.throwOnFailure(obj);
            objMo5075fetchTokengIAlus = ((Result) obj).getValue();
        }
        return Result.m5276boximpl(objMo5075fetchTokengIAlus);
    }
}
