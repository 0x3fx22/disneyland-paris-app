...
public final class SuspendingRequestSession {
    ...
    /* JADX INFO: renamed from: com.urbanairship.http.SuspendingRequestSession$execute$4 */
    static final class C53034 extends SuspendLambda implements Function2 {
        final /* synthetic */ ResponseParser $parser;
        final /* synthetic */ Request $request;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C53034(Request request, ResponseParser responseParser, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return SuspendingRequestSession.this.new C53034(this.$request, this.$parser, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C53034) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <T> Object execute(@NotNull Request request, @NotNull ResponseParser<T> responseParser, @NotNull Continuation<? super RequestResult<T>> continuation) {
        return BuildersKt.withContext(AirshipDispatchers.INSTANCE.getIO(), new C53034(request, responseParser, null), continuation);
    }
}
