...
class QuietTimeInterval implements JsonSerializable {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder setStartHour(@IntRange(from = 0, m4to = 23) int i) {
            this.startHour = i;
            return this;
        }

        @NonNull
        public Builder setStartMin(@IntRange(from = 0, m4to = 59) int i) {
            this.startMin = i;
            return this;
        }

        @NonNull
        public Builder setEndHour(@IntRange(from = 0, m4to = 23) int i) {
            this.endHour = i;
            return this;
        }

        @NonNull
        public Builder setEndMin(@IntRange(from = 0, m4to = 59) int i) {
            this.endMin = i;
            return this;
        }
