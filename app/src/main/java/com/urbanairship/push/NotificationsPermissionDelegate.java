...
class NotificationsPermissionDelegate implements PermissionDelegate {
    ...
    public void checkPermissionStatus(Context context, Consumer consumer) {
        ...
        if (this.notificationManager.areNotificationsEnabled()) {
            ...
            int i = C57322.f3785xa7fe1a80[this.notificationManager.getPromptSupport().ordinal()];
    ...
    /* JADX INFO: renamed from: com.urbanairship.push.NotificationsPermissionDelegate$2 */
    static /* synthetic */ class C57322 {

        /* JADX INFO: renamed from: $SwitchMap$com$urbanairship$push$AirshipNotificationManager$PromptSupport */
        static final /* synthetic */ int[] f3785xa7fe1a80;
        ...
        static {
            ...
            try {
                f3785xa7fe1a80[AirshipNotificationManager.PromptSupport.SUPPORTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3785xa7fe1a80[AirshipNotificationManager.PromptSupport.NOT_SUPPORTED.ordinal()] = 3;
