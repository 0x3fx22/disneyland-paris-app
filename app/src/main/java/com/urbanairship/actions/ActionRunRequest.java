...
public class ActionRunRequest {
    ...
    public ActionResult runSync() {
        ...
        try {
            ...
            UALog.m1744e("Failed to run action with arguments %s", actionArgumentsCreateActionArguments);
    ...
    public ActionResult executeAction(ActionArguments actionArguments) {
        ...
        if (str != null) {
            ...
            if (entryLookUpAction.getPredicate() != null && !entryLookUpAction.getPredicate().apply(actionArguments)) {
                UALog.m1748i("Action %s will not be run. Registry predicate rejected the arguments: %s", this.actionName, actionArguments);
