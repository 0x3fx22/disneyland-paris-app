    ...
    final ActionResult run(ActionArguments actionArguments) {
        try {
            if (!acceptsArguments(actionArguments)) {
                UALog.m1741d("Action %s is unable to accept arguments: %s", this, actionArguments);
                return ActionResult.newEmptyResultWithStatus(2);
            }
            UALog.m1748i("Running action: %s arguments: %s", this, actionArguments);
            ...
            UALog.m1746e(e, "Failed to run action %s", this);
