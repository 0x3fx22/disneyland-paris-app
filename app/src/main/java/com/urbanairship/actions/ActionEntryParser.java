...
abstract class ActionEntryParser {
    public static List fromXml(Context context, int i) {
        ...
        try {
            ...
            UALog.m1746e(e, "Failed to parse action entries.", new Object[0]);
    ...
    private static ActionRegistry.Entry parseEntry(XmlResourceParser xmlResourceParser) throws XmlPullParserException {
        ...
        if (arrayList.isEmpty()) {
            UALog.m1744e("Action names not found.", new Object[0]);
            return null;
        }
        try {
            ...
            if (!UAStringUtil.isEmpty(attributeValue2)) {
                try {
                    ...
                    UALog.m1744e("Predicate class %s not found. Skipping predicate.", attributeValue2);
                }
            }
            return entry;
        } catch (ClassNotFoundException unused2) {
            UALog.m1744e("Action class %s not found.", attributeValue);
            return null;
        }
    }
