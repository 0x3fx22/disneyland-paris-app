...
public class AddCustomEventAction extends Action {
    ...
    public ActionResult perform(@NonNull ActionArguments actionArguments) {
        ...
        if (string7 != null) {
            try {
                ...
                UALog.m1754w("Failed to parse in-app context for custom event", e);
            }
        }
    ...
    public boolean acceptsArguments(@NonNull ActionArguments actionArguments) {
        if (actionArguments.getValue().getMap() != null) {
            ...
            UALog.m1744e("CustomEventAction requires an event name in the event data.", new Object[0]);
            return false;
        }
        UALog.m1744e("CustomEventAction requires a map of event data.", new Object[0]);
        return false;
    }
