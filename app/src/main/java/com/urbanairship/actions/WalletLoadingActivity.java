...
public class WalletLoadingActivity extends ThemedActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (data == null) {
            UALog.m1754w("User URI null, unable to process link.", new Object[0]);
            finish();
        } else {
    ...
    public /* synthetic */ void lambda$resolveWalletUrl$2(Uri uri) {
        try {
            UALog.m1741d("Runner starting", new Object[0]);
            ...
            if (responseExecute.getResult() != null) {
                ...
                UALog.m1754w("No result found for Wallet URL, finishing action.", new Object[0]);
