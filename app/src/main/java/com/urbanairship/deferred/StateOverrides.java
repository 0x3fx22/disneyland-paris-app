...
public final /* data */ class StateOverrides implements JsonSerializable {
    ...
    public JsonValue getJsonValue() {
        Pair pairM1842to = TuplesKt.m1842to("app_version", this.appVersionName);
        Pair pairM1842to2 = TuplesKt.m1842to(OneIDTrackerEvent.EVENT_PARAM_SDK_VERSION, this.sdkVersion);
        Pair pairM1842to3 = TuplesKt.m1842to("notification_opt_in", Boolean.valueOf(this.notificationOptIn));
        Locale locale = this.locale;
        Pair pairM1842to4 = TuplesKt.m1842to("locale_country", locale != null ? locale.getCountry() : null);
        Locale locale2 = this.locale;
        JsonValue jsonValue = JsonExtensionsKt.jsonMapOf(pairM1842to, pairM1842to2, pairM1842to3, pairM1842to4, TuplesKt.m1842to("locale_language", locale2 != null ? locale2.getLanguage() : null)).getJsonValue();
