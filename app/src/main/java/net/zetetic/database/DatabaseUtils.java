...
public class DatabaseUtils {
        ...
        if (!(exc instanceof FileNotFoundException)) {
            if (exc instanceof IllegalArgumentException) {
                ...
                if (!(exc instanceof OperationCanceledException)) {
                    ...
                    Logger.m1917e("DatabaseUtils", "Writing exception to parcel", exc);
                    return;
                }
                i2 = 11;
            }
    ...
    public static void cursorFillWindow(Cursor cursor, int i, CursorWindow cursorWindow) {
        ...
        if (cursor.moveToPosition(i)) {
            loop0: while (cursorWindow.allocRow()) {
    ...
    public static class InsertHelper {
        ...
        private long insertInternal(ContentValues contentValues, boolean z) {
            ...
            try {
                ...
                Logger.m1917e("DatabaseUtils", "Error inserting " + contentValues + " into table  " + this.mTableName, e);
                return -1L;
            } finally {
        ...
        public long execute() {
            ...
            try {
                ...
                Logger.m1917e("DatabaseUtils", "Error executing InsertHelper with table " + this.mTableName, e);
                return -1L;
            } finally {
    ...
    public static void createDbFromSqlStatements(Context context, String str, int i, String str2) {
        ...
        SQLiteDatabase sQLiteDatabaseOpenOrCreateDatabase = SQLiteDatabase.openOrCreateDatabase(databasePath, (SQLiteDatabase.CursorFactory) null);
