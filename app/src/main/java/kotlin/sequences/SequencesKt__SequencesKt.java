...
public abstract class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C72111 extends RestrictedSuspendLambda implements Function2 {
        ...
        C72111(Sequence sequence, Function0 function0, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            C72111 c72111 = new C72111(this.$this_ifEmpty, this.$defaultValue, continuation);
            c72111.L$0 = obj;
            return c72111;
        }
        ...
        public final Object invoke(SequenceScope sequenceScope, Continuation continuation) {
            return ((C72111) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(@NotNull Sequence<? extends T> sequence, @NotNull Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C72111(sequence, defaultValue, null));
    }
    ...
    public static final <T, R> Pair<List<T>, List<R>> unzip(@NotNull Sequence<? extends Pair<? extends T, ? extends R>> sequence) {
        ...
        return TuplesKt.m1842to(arrayList, arrayList2);
    }
    ...
    static final class C72121 extends RestrictedSuspendLambda implements Function2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C72121(Sequence sequence, Random random, Continuation continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C72121 c72121 = new C72121(this.$this_shuffled, this.$random, continuation);
            c72121.L$0 = obj;
            return c72121;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope sequenceScope, Continuation continuation) {
            return ((C72121) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> shuffled(@NotNull Sequence<? extends T> sequence, @NotNull Random random) {
        ...
        return SequencesKt.sequence(new C72121(sequence, random, null));
    }

    /* JADX INFO: renamed from: kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1 */
    static final class C72051 extends RestrictedSuspendLambda implements Function2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C72051(Sequence sequence, Function2 function2, Function1 function1, Continuation continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C72051 c72051 = new C72051(this.$source, this.$transform, this.$iterator, continuation);
            c72051.L$0 = obj;
            return c72051;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope sequenceScope, Continuation continuation) {
            return ((C72051) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(@NotNull Sequence<? extends T> source, @NotNull Function2<? super Integer, ? super T, ? extends C> transform, @NotNull Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        return SequencesKt.sequence(new C72051(source, transform, iterator, null));
    }
