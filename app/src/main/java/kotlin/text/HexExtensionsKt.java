...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m5341toStringimpl(ULong.m5337constructorimpl(j))));
    }
            ...
            if (i14 == bytesPerLine) {
                ...
                if (i15 == bytesPerGroup) {
                    if (groupSeparator.length() == 0) {
                        ...
                        while (i16 < length4) {
                            int i17 = i14;
                            int i18 = length4;
                            if (!CharsKt__CharKt.equals(groupSeparator.charAt(i16), str.charAt(length3 + i16), ignoreCase$kotlin_stdlib)) {
                    ...
                    if (i15 != 0) {
                        if (byteSeparator.length() == 0) {
                            ...
                            while (i20 < length5) {
                                int i21 = length5;
                                int i22 = i15;
                                if (!CharsKt__CharKt.equals(byteSeparator.charAt(i20), str.charAt(length3 + i20), ignoreCase$kotlin_stdlib)) {
                ...
                if (bytePrefix.length() == 0) {
                    ...
                    while (i7 < length) {
                        int i24 = length;
                        int i25 = i6;
                        if (!CharsKt__CharKt.equals(bytePrefix.charAt(i7), str.charAt(length3 + i7), ignoreCase$kotlin_stdlib)) {
                ...
                if (byteSuffix.length() == 0) {
                    ...
                    while (i10 < length2) {
                        int i26 = i9;
                        if (!CharsKt__CharKt.equals(byteSuffix.charAt(i10), str.charAt(length3 + i10), ignoreCase$kotlin_stdlib)) {
    ...
    public static final String toHexString(byte b, @NotNull HexFormat format) {
        ...
        if (number.getIsDigitsOnlyAndNoPadding()) {
            char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & Ascii.f3531SI)};
