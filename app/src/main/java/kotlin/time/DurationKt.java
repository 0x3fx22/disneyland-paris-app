...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM5853getZEROUwyO8pc = companion.m5853getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar != DurationUnit.SECONDS || iIndexOf$default <= 0) {
                        jM5853getZEROUwyO8pc = Duration.m5807plusLRDsOJo(jM5853getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    } else {
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring2 = strSubstring.substring(0, iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring2, "substring(...)");
                        long jM5807plusLRDsOJo = Duration.m5807plusLRDsOJo(jM5853getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM5853getZEROUwyO8pc = Duration.m5807plusLRDsOJo(jM5807plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    }
                    i = i3;
            ...
            long jM5807plusLRDsOJo2 = jM5853getZEROUwyO8pc;
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM5853getZEROUwyO8pc = companion.m5851getINFINITEUwyO8pc();
            } else {
                boolean z6 = !z3;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM5807plusLRDsOJo3 = Duration.m5807plusLRDsOJo(jM5807plusLRDsOJo2, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM5807plusLRDsOJo2 = Duration.m5807plusLRDsOJo(jM5807plusLRDsOJo3, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            length2 = length2;
                        ...
                        jM5807plusLRDsOJo2 = Duration.m5807plusLRDsOJo(jM5807plusLRDsOJo2, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str3;
                    durationUnit2 = durationUnitDurationUnitByShortName;
                    z7 = true;
                }
                jM5853getZEROUwyO8pc = jM5807plusLRDsOJo2;
            }
        }
        return z4 ? Duration.m5824unaryMinusUwyO8pc(jM5853getZEROUwyO8pc) : jM5853getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m5772constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m5772constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m5772constructorimpl((j << 1) + ((long) i));
    }
