...
final class ULongProgressionIterator implements Iterator, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m5337constructorimpl(j3);
        this.next = this.hasNext ? j : j2;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ Object next() {
        return ULong.m5336boximpl(m5697nextsVKNKU());
    }
    ...
    public long m5697nextsVKNKU() {
        ...
        if (j == this.finalElement) {
            ...
            this.next = ULong.m5337constructorimpl(this.step + j);
        }
        return j;
    }
}
