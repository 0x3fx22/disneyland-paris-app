        ...
        while (true) {
            ...
            try {
                ...
                if (objInvokeSuspend == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    result = Result.m5277constructorimpl(objInvokeSuspend);
                }
            } catch (Throwable th) {
                Result.Companion companion = Result.INSTANCE;
                result = Result.m5277constructorimpl(ResultKt.createFailure(th));
            }
