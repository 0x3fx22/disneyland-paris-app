...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(@NotNull Object result) {
        while (true) {
            ...
            if (obj == coroutineSingletons) {
                if (AbstractC0365xc40028dd.m91m(RESULT, this, coroutineSingletons, result)) {
                    return;
                }
            } else {
                ...
                if (AbstractC0365xc40028dd.m91m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() throws Throwable {
        ...
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.UNDECIDED;
        if (obj == coroutineSingletons) {
            if (AbstractC0365xc40028dd.m91m(RESULT, this, coroutineSingletons, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
