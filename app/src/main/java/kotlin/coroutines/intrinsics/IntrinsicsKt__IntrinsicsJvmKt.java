...
public abstract class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Object wrapWithContinuationImpl(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> completion) {
        ...
        return ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function1, 1)).invoke(m1843xca667f36(DebugProbesKt.probeCoroutineCreated(completion)));
    }
    ...
    public static <R, T> Object wrapWithContinuationImpl(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> completion) {
        ...
        Intrinsics.checkNotNullParameter(completion, "completion");
        return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(r, m1843xca667f36(DebugProbesKt.probeCoroutineCreated(completion)));
    }
    ...
    public static <R, P, T> Object wrapWithContinuationImpl(@NotNull Function3<? super R, ? super P, ? super Continuation<? super T>, ? extends Object> function3, R r, P p, @NotNull Continuation<? super T> completion) {
        ...
        Intrinsics.checkNotNullParameter(completion, "completion");
        return ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(r, p, m1843xca667f36(DebugProbesKt.probeCoroutineCreated(completion)));
    }
    ...
    private static final Continuation m1843xca667f36(final Continuation continuation) {
