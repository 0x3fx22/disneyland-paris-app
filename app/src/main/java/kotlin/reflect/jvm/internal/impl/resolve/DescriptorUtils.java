...
public class DescriptorUtils {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 55:
                ...
                break;
            case 56:
                objArr[0] = EnableFeatureAction.FEATURE_LOCATION;
                break;
    ...
    public static ModuleDescriptor getContainingModuleOrNull(@NotNull KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo5739getDeclarationDescriptor);
    }
    ...
    public static boolean isDirectSubclass(@NotNull ClassDescriptor classDescriptor, @NotNull ClassDescriptor classDescriptor2) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo5740getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo5739getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(@NotNull KotlinType kotlinType, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo5740getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo5739getDeclarationDescriptor();
        if (classDescriptor == null) {
            $$$reportNull$$$0(47);
        }
