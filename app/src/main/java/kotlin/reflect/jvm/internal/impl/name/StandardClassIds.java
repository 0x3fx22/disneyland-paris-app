...
public final class StandardClassIds {
    ...
    static {
        ...
        FqName fqNameChild14 = fqName.child(Name.identifier(InstrumentationResultPrinter.REPORT_KEY_NAME_TEST));
        ...
        Set set = primitiveTypes;
        Set set2 = unsignedTypes;
        Set setPlus = SetsKt.plus(set, (Iterable) set2);
        ...
        allBuiltinTypes = SetsKt.plus((Set<? extends ClassId>) SetsKt.plus((Set<? extends ClassId>) SetsKt.plus((Set<? extends ClassId>) SetsKt.plus((Set<? extends ClassId>) SetsKt.plus(set, (Iterable) set2), classId), Unit), Any), Enum);
    }
