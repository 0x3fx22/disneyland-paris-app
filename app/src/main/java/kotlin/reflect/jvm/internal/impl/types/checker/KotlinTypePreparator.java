...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo5740getSupertypes = capturedTypeConstructorImpl.mo5740getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo5740getSupertypes, 10));
                Iterator<T> it = collectionMo5740getSupertypes.iterator();
                while (it.hasNext()) {
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo5740getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo5740getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo5740getSupertypes2, 10));
            Iterator<T> it2 = collectionMo5740getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo5740getSupertypes3 = intersectionTypeConstructor.mo5740getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo5740getSupertypes3, 10));
        Iterator<T> it3 = collectionMo5740getSupertypes3.iterator();
        while (it3.hasNext()) {
    ...
    public UnwrappedType prepareType(@NotNull KotlinTypeMarker type) {
        ...
        return TypeWithEnhancementKt.inheritEnhancement(unwrappedTypeFlexibleType, unwrappedTypeUnwrap, new C71841(this));
    }

    /* JADX INFO: renamed from: kotlin.reflect.jvm.internal.impl.types.checker.KotlinTypePreparator$prepareType$1 */
    /* synthetic */ class C71841 extends FunctionReference implements Function1 {
        C71841(Object obj) {
            super(1, obj);
        }
