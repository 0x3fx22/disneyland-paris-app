...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo5741getContributedClassifier(@NotNull Name name, @NotNull LookupLocation lookupLocation);
    ...
    void mo5745recordLookup(@NotNull Name name, @NotNull LookupLocation lookupLocation);
