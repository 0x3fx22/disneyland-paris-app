...
public class TypeCheckerState {
    ...
    public static abstract class SupertypesPolicy {
        ...
        public abstract SimpleTypeMarker mo5743transformType(@NotNull TypeCheckerState typeCheckerState, @NotNull KotlinTypeMarker kotlinTypeMarker);
        ...
        public static final class None extends SupertypesPolicy {
            ...
            public /* bridge */ /* synthetic */ SimpleTypeMarker mo5743transformType(TypeCheckerState typeCheckerState, KotlinTypeMarker kotlinTypeMarker) {
        ...
        public static final class UpperIfFlexible extends SupertypesPolicy {
            ...
            @NotNull
            /* JADX INFO: renamed from: transformType */
            public SimpleTypeMarker mo5743transformType(@NotNull TypeCheckerState state, @NotNull KotlinTypeMarker type) {
                Intrinsics.checkNotNullParameter(state, "state");
                Intrinsics.checkNotNullParameter(type, "type");
