...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public static final List supertypes_delegate$lambda$18(final Data data, final KClassImpl kClassImpl) {
            Collection<KotlinType> collectionMo5740getSupertypes = data.getDescriptor().getTypeConstructor().mo5740getSupertypes();
            Intrinsics.checkNotNullExpressionValue(collectionMo5740getSupertypes, "getSupertypes(...)");
            ArrayList arrayList = new ArrayList(collectionMo5740getSupertypes.size());
            for (final KotlinType kotlinType : collectionMo5740getSupertypes) {
        ...
        public static final Type supertypes_delegate$lambda$18$lambda$15$lambda$14(KotlinType kotlinType, Data data, KClassImpl kClassImpl) {
            ...
            if (!(classifierDescriptorMo5739getDeclarationDescriptor instanceof ClassDescriptor)) {
                throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo5739getDeclarationDescriptor);
            }
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo5739getDeclarationDescriptor);
            if (javaClass == null) {
                throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo5739getDeclarationDescriptor);
            }
            ...
            throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo5739getDeclarationDescriptor);
        }
