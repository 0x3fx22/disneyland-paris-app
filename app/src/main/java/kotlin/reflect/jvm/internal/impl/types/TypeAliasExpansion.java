...
public final class TypeAliasExpansion {
    ...
    public final TypeProjection getReplacement(@NotNull TypeConstructor constructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = constructor.mo5739getDeclarationDescriptor();
        if (classifierDescriptorMo5739getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return (TypeProjection) this.mapping.get(classifierDescriptorMo5739getDeclarationDescriptor);
        }
        return null;
    }
