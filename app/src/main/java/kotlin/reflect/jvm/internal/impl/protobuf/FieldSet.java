...
final class FieldSet {
    ...
    private static void verifyType(WireFormat.FieldType fieldType, Object obj) {
        ...
        boolean z = true;
        boolean z2 = false;
        switch (C71331.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 1:
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z) {
        switch (C71331.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
