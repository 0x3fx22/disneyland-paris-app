...
public final class ClassMapperLite {
    ...
    private static final String f4971kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        linkedHashMap.put(f4971kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f4971kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map map2, String str, String str2) {
        map2.put(f4971kotlin + '/' + str, Matrix.MATRIX_TYPE_RANDOM_LT + str2 + ';');
    }
