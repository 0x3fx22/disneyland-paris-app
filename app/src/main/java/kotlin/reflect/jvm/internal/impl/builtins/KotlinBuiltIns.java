...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo5741getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo5741getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                if (!(classifierDescriptorMo5741getContributedClassifier instanceof ClassDescriptor)) {
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo5741getContributedClassifier);
                }
                return (ClassDescriptor) classifierDescriptorMo5741getContributedClassifier;
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (classifierDescriptorMo5739getDeclarationDescriptor == null) {
            return null;
        }
        UnsignedTypes unsignedTypes = UnsignedTypes.INSTANCE;
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo5739getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo5739getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = kotlinType.getConstructor().mo5739getDeclarationDescriptor();
        return (classifierDescriptorMo5739getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo5739getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo5739getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = kotlinType.getConstructor().mo5739getDeclarationDescriptor();
        return (classifierDescriptorMo5739getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo5739getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo5739getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo5739getDeclarationDescriptor, fqNameUnsafe);
    }
