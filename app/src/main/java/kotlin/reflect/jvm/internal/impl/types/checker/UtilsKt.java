...
public final class UtilsKt {
    ...
    public static final KotlinType findCorrespondingSupertype(@NotNull KotlinType subtype, @NotNull KotlinType supertype, @NotNull TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo5740getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (DeclarationDescriptor declarationDescriptorMo5739getDeclarationDescriptor = typeConstructor.mo5739getDeclarationDescriptor(); declarationDescriptorMo5739getDeclarationDescriptor != null; declarationDescriptorMo5739getDeclarationDescriptor = declarationDescriptorMo5739getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo5739getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + declarationDescriptorMo5739getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
