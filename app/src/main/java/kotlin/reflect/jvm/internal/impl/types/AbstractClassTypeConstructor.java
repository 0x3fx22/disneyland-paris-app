...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    public abstract ClassDescriptor mo5739getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo5739getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo5739getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    @NotNull
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo5739getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo5732getCompanionObjectDescriptor = classDescriptor.mo5732getCompanionObjectDescriptor();
        if (z && classDescriptorMo5732getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo5732getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo5739getDeclarationDescriptor())) {
            return null;
        }
