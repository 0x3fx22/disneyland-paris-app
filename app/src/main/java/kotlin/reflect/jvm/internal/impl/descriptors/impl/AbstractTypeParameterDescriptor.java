...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    protected abstract void mo5742reportSupertypeLoopError(@NotNull KotlinType kotlinType);
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo5740getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo5740getSupertypes();
        if (listMo5740getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo5740getSupertypes;
    }
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public ClassifierDescriptor mo5739getDeclarationDescriptor() {
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo5742reportSupertypeLoopError(kotlinType);
        }
