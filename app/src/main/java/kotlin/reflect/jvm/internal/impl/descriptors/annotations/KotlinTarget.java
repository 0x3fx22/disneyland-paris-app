...
public final class KotlinTarget {
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m1842to(annotationUseSiteTarget, kotlinTarget13), TuplesKt.m1842to(AnnotationUseSiteTarget.FIELD, kotlinTarget9), TuplesKt.m1842to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget8), TuplesKt.m1842to(AnnotationUseSiteTarget.FILE, kotlinTarget12), TuplesKt.m1842to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget11), TuplesKt.m1842to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget10), TuplesKt.m1842to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget13), TuplesKt.m1842to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget13), TuplesKt.m1842to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget9));
    }
