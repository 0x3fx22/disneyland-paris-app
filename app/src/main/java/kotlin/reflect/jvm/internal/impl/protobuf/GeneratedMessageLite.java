...
public abstract class GeneratedMessageLite extends AbstractMessageLite implements Serializable {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite, BuilderType extends Builder> extends AbstractMessageLite.Builder<BuilderType> {
        ...
        public BuilderType mo5737clone() {
            throw new UnsupportedOperationException("This is supposed to be overridden by subclasses.");
        }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType>> extends GeneratedMessageLite implements ExtendableMessageOrBuilder<MessageType> {
        ...
        public class ExtensionWriter {
            ...
            /* synthetic */ ExtensionWriter(ExtendableMessage extendableMessage, boolean z, C71341 c71341) {
                this(z);
            }
    ...
    public static boolean parseUnknownField(FieldSet fieldSet, MessageLite messageLite, CodedInputStream codedInputStream, CodedOutputStream codedOutputStream, ExtensionRegistryLite extensionRegistryLite, int i) throws IOException {
        boolean z;
        boolean z2;
        Object objBuild;
        MessageLite messageLite2;
        int tagWireType = WireFormat.getTagWireType(i);
        GeneratedExtension generatedExtensionFindLiteExtensionByNumber = extensionRegistryLite.findLiteExtensionByNumber(messageLite, WireFormat.getTagFieldNumber(i));
        ...
        if (z) {
            ...
            int i2 = C71341.$SwitchMap$com$google$protobuf$WireFormat$JavaType[generatedExtensionFindLiteExtensionByNumber.descriptor.getLiteJavaType().ordinal()];
            if (i2 == 1) {
                MessageLite.Builder builder = (generatedExtensionFindLiteExtensionByNumber.descriptor.isRepeated() || (messageLite2 = (MessageLite) fieldSet.getField(generatedExtensionFindLiteExtensionByNumber.descriptor)) == null) ? null : messageLite2.toBuilder();
                if (builder == null) {
