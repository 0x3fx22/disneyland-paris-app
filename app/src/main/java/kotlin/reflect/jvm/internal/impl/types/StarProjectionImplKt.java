    ...
    private static final KotlinType buildStarProjectionTypeByTypeParameters(final List list, List list2, KotlinBuiltIns kotlinBuiltIns) {
        KotlinType kotlinTypeSubstitute = TypeSubstitutor.create(new TypeConstructorSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.StarProjectionImplKt.buildStarProjectionTypeByTypeParameters.1
            ...
            public TypeProjection get(TypeConstructor key) {
                ...
                ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = key.mo5739getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo5739getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.TypeParameterDescriptor");
                return TypeUtils.makeStarProjection((TypeParameterDescriptor) classifierDescriptorMo5739getDeclarationDescriptor);
            }
