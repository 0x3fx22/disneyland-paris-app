...
public class OverridingUtil {
    ...
    public OverrideCompatibilityInfo isOverridableBy(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, @Nullable ClassDescriptor classDescriptor, boolean z) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY && (!z2 || externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.SUCCESS_ONLY)) {
                int i = C71578.f3942x42e2f52f[externalOverridabilityCondition.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i == 1) {
                    z2 = true;
                } else if (i == 2) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition2 : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition2.getContract() == ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY) {
                int i2 = C71578.f3942x42e2f52f[externalOverridabilityCondition2.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i2 == 1) {
    ...
    private Collection extractAndBindOverridesForMember(CallableMemberDescriptor callableMemberDescriptor, Collection collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        while (it.hasNext()) {
            ...
            int i = C71578.f3943xb0ae9f3b[result.ordinal()];
            if (i == 1) {
    ...
    /* JADX INFO: renamed from: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil$8 */
    static /* synthetic */ class C71578 {
        static final /* synthetic */ int[] $SwitchMap$org$jetbrains$kotlin$descriptors$Modality;

        /* JADX INFO: renamed from: $SwitchMap$org$jetbrains$kotlin$resolve$ExternalOverridabilityCondition$Result */
        static final /* synthetic */ int[] f3942x42e2f52f;

        /* JADX INFO: renamed from: $SwitchMap$org$jetbrains$kotlin$resolve$OverridingUtil$OverrideCompatibilityInfo$Result */
        static final /* synthetic */ int[] f3943xb0ae9f3b;
        ...
        static {
            ...
            f3943xb0ae9f3b = iArr2;
            try {
                iArr2[OverrideCompatibilityInfo.Result.OVERRIDABLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3943xb0ae9f3b[OverrideCompatibilityInfo.Result.CONFLICT.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3943xb0ae9f3b[OverrideCompatibilityInfo.Result.INCOMPATIBLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            int[] iArr3 = new int[ExternalOverridabilityCondition.Result.values().length];
            f3942x42e2f52f = iArr3;
            try {
                iArr3[ExternalOverridabilityCondition.Result.OVERRIDABLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3942x42e2f52f[ExternalOverridabilityCondition.Result.INCOMPATIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f3942x42e2f52f[ExternalOverridabilityCondition.Result.UNKNOWN.ordinal()] = 3;
    ...
    private static Modality determineModalityForFakeOverride(Collection collection, ClassDescriptor classDescriptor) {
        ...
        while (it.hasNext()) {
            ...
            int i = C71578.$SwitchMap$org$jetbrains$kotlin$descriptors$Modality[callableMemberDescriptor.getModality().ordinal()];
            if (i == 1) {
    ...
    @NotNull
    public static <H> Collection<H> extractMembersOverridableInBothWays(@NotNull H h, @NotNull Collection<H> collection, @NotNull Function1<H, CallableDescriptor> function1, @NotNull Function1<H, Unit> function2) {
        if (h == null) {
            $$$reportNull$$$0(97);
        }
        if (collection == null) {
    ...
    public static class OverrideCompatibilityInfo {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int i) {
            ...
            if (i == 1 || i == 2) {
                ...
                objArr[0] = OneIDTrackerEvent.EVENT_PARAM_SUCCESS;
            } else if (i != 4) {
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    break;
                default:
                    objArr[1] = OneIDTrackerEvent.EVENT_PARAM_SUCCESS;
                    break;
            }
            if (i == 1) {
