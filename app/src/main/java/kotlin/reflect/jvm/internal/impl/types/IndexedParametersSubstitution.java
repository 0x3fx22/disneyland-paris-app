...
public final class IndexedParametersSubstitution extends TypeSubstitution {
    ...
    public TypeProjection mo5744get(@NotNull KotlinType key) {
        Intrinsics.checkNotNullParameter(key, "key");
        ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = key.getConstructor().mo5739getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = classifierDescriptorMo5739getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo5739getDeclarationDescriptor : null;
