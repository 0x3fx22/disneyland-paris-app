...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName topLevelClassFqName, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo5741getContributedClassifier = memberScope.mo5741getContributedClassifier(nameShortName, location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(@NotNull ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo5740getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo5739getDeclarationDescriptor)) {
                    Intrinsics.checkNotNull(classifierDescriptorMo5739getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                    return (ClassDescriptor) classifierDescriptorMo5739getDeclarationDescriptor;
                }
            }
        }
        return null;
    ...
    /* JADX INFO: renamed from: kotlin.reflect.jvm.internal.impl.resolve.descriptorUtil.DescriptorUtilsKt$declaresOrInheritsDefaultValue$2 */
    /* synthetic */ class C71602 extends FunctionReference implements Function1 {
        public static final C71602 INSTANCE = new C71602();
    ...
    public static final ClassDescriptor getAnnotationClass(@NotNull AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo5739getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo5739getDeclarationDescriptor();
