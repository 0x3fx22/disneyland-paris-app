...
public final class JavaDescriptorResolver {
    ...
    public final ClassDescriptor resolveClass(@NotNull JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            ClassifierDescriptor classifierDescriptorMo5741getContributedClassifier = unsubstitutedInnerClassesScope != null ? unsubstitutedInnerClassesScope.mo5741getContributedClassifier(javaClass.getName(), NoLookupLocation.FROM_JAVA_LOADER) : null;
