        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m5461contentEqualskV0jMPg(((UByteArray) objArr).getStorage(), ((UByteArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UShortArray) && (objArr2 instanceof UShortArray)) {
                    if (!UArraysKt.m5459contentEqualsFGO6Aew(((UShortArray) objArr).getStorage(), ((UShortArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!UArraysKt.m5460contentEqualsKJPZfPQ(((UIntArray) objArr).getStorage(), ((UIntArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!UArraysKt.m5462contentEqualslec5QzE(((ULongArray) objArr).getStorage(), ((ULongArray) objArr2).getStorage())) {
                        return false;
                    }
    ...
    private static final void contentDeepToStringInternal$ArraysKt__ArraysKt(Object[] objArr, StringBuilder sb, List list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (obj == null) {
                ...
                sb.append(UArraysKt.m5467contentToString2csIQuQ(((UByteArray) obj).getStorage()));
            } else if (obj instanceof UShortArray) {
                sb.append(UArraysKt.m5469contentToStringd6D3K8(((UShortArray) obj).getStorage()));
            } else if (obj instanceof UIntArray) {
                sb.append(UArraysKt.m5468contentToStringXUkPCBk(((UIntArray) obj).getStorage()));
            } else if (obj instanceof ULongArray) {
                sb.append(UArraysKt.m5470contentToStringuLth9ew(((ULongArray) obj).getStorage()));
            } else {
