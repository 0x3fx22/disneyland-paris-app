...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C74431 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C74431(Continuation continuation) {
            super(continuation);
        }
    ...
    static final class C74441 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C74441(Continuation continuation) {
            super(continuation);
        }
    ...
    public final Object waitUntilSelected(Continuation continuation) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.STATE_REG) {
                if (AbstractC0365xc40028dd.m91m(state$volatile$FU, this, obj, cancellableContinuationImpl)) {
                    CancellableContinuationKt.invokeOnCancellation(cancellableContinuationImpl, this);
                    break;
                }
            } else if (obj instanceof List) {
                if (AbstractC0365xc40028dd.m91m(state$volatile$FU, this, obj, SelectKt.STATE_REG)) {
    ...
    public final Object doSelectSuspend(Continuation continuation) {
        C74431 c74431;
        if (continuation instanceof C74431) {
            c74431 = (C74431) continuation;
            int i = c74431.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c74431.label = i - Integer.MIN_VALUE;
            } else {
                c74431 = new C74431(continuation);
            }
        } else {
            c74431 = new C74431(continuation);
        }
        Object objComplete = c74431.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c74431.label;
        if (i2 != 0) {
            if (i2 == 1) {
                this = (SelectImplementation) c74431.L$0;
        ...
        c74431.L$0 = this;
        c74431.label = 1;
        if (waitUntilSelected(c74431) == coroutine_suspended) {
            return coroutine_suspended;
        }
        c74431.L$0 = null;
        c74431.label = 2;
        objComplete = this.complete(c74431);
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (AbstractC0365xc40028dd.m91m(state$volatile$FU, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (AbstractC0365xc40028dd.m91m(state$volatile$FU, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (AbstractC0365xc40028dd.m91m(state$volatile$FU, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    public final Object processResultAndInvokeBlockRecoveringException(ClauseData clauseData, Object obj, Continuation continuation) {
        C74441 c74441;
        if (continuation instanceof C74441) {
            c74441 = (C74441) continuation;
            int i = c74441.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c74441.label = i - Integer.MIN_VALUE;
            } else {
                c74441 = new C74441(continuation);
            }
        } else {
            c74441 = new C74441(continuation);
        }
        Object objInvokeBlock = c74441.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c74441.label;
        if (i2 == 0) {
            ...
            c74441.label = 1;
            objInvokeBlock = clauseData.invokeBlock(objProcessResult, c74441);
    ...
    public void invoke(@Nullable Throwable cause) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List list = this.clauses;
        if (list == null) {
            return;
        }
