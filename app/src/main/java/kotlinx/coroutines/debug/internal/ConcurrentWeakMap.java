...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int i) {
            ...
            } while (!AbstractC4178xa7a47114.m1672m(getValues(), i, obj, null));
        ...
        public final Object putImpl(Object obj, Object obj2, HashedWeakRef hashedWeakRef) {
            ...
            while (true) {
                ...
                if (hashedWeakRef2 != null) {
                    ...
                    if (AbstractC4178xa7a47114.m1672m(getKeys(), iIndex, null, hashedWeakRef)) {
                        break;
                    }
                } else {
                    return null;
            ...
            } while (!AbstractC4178xa7a47114.m1672m(getValues(), iIndex, obj3, obj2));
            return obj3;
        }
        ...
        public final Core rehash() {
            ...
            while (true) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    } while (!AbstractC4178xa7a47114.m1672m(getValues(), i2, obj, ConcurrentWeakMapKt.mark(obj)));
