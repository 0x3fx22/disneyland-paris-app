...
public final class DebugProbesImpl {
    ...
    private final Function1 getDynamicAttach() {
        ...
        try {
            ...
            objM5277constructorimpl = Result.m5277constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
        ...
        return (Function1) objM5277constructorimpl;
    }
    ...
    private final List enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM5277constructorimpl = Result.m5277constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5277constructorimpl = Result.m5277constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM5277constructorimpl;
    ...
    private final Pair findContinuationStartIndex(int indexOfResumeWith, StackTraceElement[] actualTrace, List coroutineTrace) {
        for (int i = 0; i < 3; i++) {
            ...
            if (iFindIndexOfFrame != -1) {
                return TuplesKt.m1842to(Integer.valueOf(iFindIndexOfFrame), Integer.valueOf(i));
            }
        }
        return TuplesKt.m1842to(-1, 0);
    }
