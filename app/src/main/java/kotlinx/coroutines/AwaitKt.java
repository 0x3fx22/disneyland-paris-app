...
public final class AwaitKt {
    ...
    static final class C72581 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        int label;
        ...
        C72581(Continuation continuation) {
            super(continuation);
        }
    ...
    static final class C72593 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C72593(Continuation continuation) {
            super(continuation);
        }
    ...
    public static final java.lang.Object joinAll(@org.jetbrains.annotations.NotNull kotlinx.coroutines.Job[] r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            boolean r0 = r7 instanceof kotlinx.coroutines.AwaitKt.C72581
            if (r0 == 0) goto L13
            r0 = r7
            kotlinx.coroutines.AwaitKt$joinAll$1 r0 = (kotlinx.coroutines.AwaitKt.C72581) r0
            int r1 = r0.label
    ...
    public static final Object joinAll(@NotNull Collection<? extends Job> collection, @NotNull Continuation<? super Unit> continuation) {
        C72593 c72593;
        Iterator it;
        if (continuation instanceof C72593) {
            c72593 = (C72593) continuation;
            int i = c72593.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c72593.label = i - Integer.MIN_VALUE;
            } else {
                c72593 = new C72593(continuation);
            }
        } else {
            c72593 = new C72593(continuation);
        }
        Object obj = c72593.result;
        ...
        while (it.hasNext()) {
            ...
            c72593.L$0 = it;
            c72593.label = 1;
            if (job.join(c72593) == coroutine_suspended) {
