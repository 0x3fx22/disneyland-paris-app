...
import com.google.common.util.concurrent.AbstractC4178xa7a47114;
...
public class SemaphoreAndMutexImpl {
    ...
    protected final void acquire(@NotNull CancellableContinuation<? super Unit> waiter) {
        ...
        waiter.resume(Unit.INSTANCE, (Function3<? super Throwable, ? super Unit, ? super CoroutineContext, Unit>) this.onCancellationRelease);
    }
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m5996getSegmentimpl(objFindSegmentInternal);
        int i = (int) (andIncrement % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (!AbstractC4178xa7a47114.m1672m(semaphoreSegment2.getAcquirers(), i, null, waiter)) {
            if (!AbstractC4178xa7a47114.m1672m(semaphoreSegment2.getAcquirers(), i, SemaphoreKt.PERMIT, SemaphoreKt.TAKEN)) {
                return false;
            }
            if (waiter instanceof CancellableContinuation) {
                ...
                ((CancellableContinuation) waiter).resume(Unit.INSTANCE, (Function3<? super Throwable, ? super Unit, ? super CoroutineContext, Unit>) this.onCancellationRelease);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (andSet == null) {
            ...
            return !AbstractC4178xa7a47114.m1672m(semaphoreSegment2.getAcquirers(), i, SemaphoreKt.PERMIT, SemaphoreKt.BROKEN);
        }
