...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(lastScheduledTask$volatile$FU, this, task, null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task == null || task.taskContext != onlyBlocking || !AbstractC4178xa7a47114.m1672m(this.buffer, i, task, null)) {
            return null;
        }
        if (onlyBlocking) {
            blockingTasksInBuffer$volatile$FU.decrementAndGet(this);
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef stolenTaskRef) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(lastScheduledTask$volatile$FU, this, r0, null));
