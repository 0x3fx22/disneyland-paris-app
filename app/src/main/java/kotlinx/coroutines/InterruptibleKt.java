...
public final class InterruptibleKt {
    ...
    static final class C72622 extends SuspendLambda implements Function2 {
        final /* synthetic */ Function0 $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C72622(Function0 function0, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            C72622 c72622 = new C72622(this.$block, continuation);
            c72622.L$0 = obj;
            return c72622;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C72622) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(@NotNull CoroutineContext coroutineContext, @NotNull Function0<? extends T> function0, @NotNull Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C72622(function0, null), continuation);
    }
