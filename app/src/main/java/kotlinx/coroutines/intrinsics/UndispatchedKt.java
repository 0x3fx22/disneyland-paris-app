        ...
        try {
            ...
            try {
                ...
                if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    continuationProbeCoroutineCreated.resumeWith(Result.m5277constructorimpl(objWrapWithContinuationImpl));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                throw th;
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(th2)));
        }
    }
