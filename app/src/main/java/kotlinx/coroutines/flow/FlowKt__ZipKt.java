...
abstract /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final Flow flowCombineTransform(Flow flow, Flow flow2, Function4 function4) {
        return FlowKt.flow(new C7415xd7c321e6(new Flow[]{flow, flow2}, null, function4));
    }

    public static final Flow combineTransform(Flow flow, Flow flow2, Function4 function4) {
        return FlowKt.flow(new C7416xd7c321e7(new Flow[]{flow, flow2}, null, function4));
    }
    ...
    public static final Flow combine(Flow flow, Flow flow2, Flow flow3, final Function4 function4) {
        ...
        return new Flow<Object>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            ...
            public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
                ...
                }, new C74102(null, function4), continuation);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2 */
            @Metadata(m1835d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n¨\u0006\u0007"}, m1836d2 = {"<anonymous>", "", "R", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = 48)
            @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2", m1845f = "Zip.kt", m1846i = {}, m1847l = {259, BZip2Constants.MAX_ALPHA_SIZE}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
            @SourceDebugExtension({"SMAP\nZip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1\n+ 2 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt\n*L\n1#1,258:1\n116#2,5:259\n*E\n"})
            public static final class C74102 extends SuspendLambda implements Function3<FlowCollector<Object>, Object[], Continuation<? super Unit>, Object> {
                ...
                public C74102(Continuation continuation, Function4 function4) {
                ...
                public final Object invoke(FlowCollector<Object> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C74102 c74102 = new C74102(continuation, this.$transform$inlined);
                    c74102.L$0 = flowCollector;
                    c74102.L$1 = objArr;
                    return c74102.invokeSuspend(Unit.INSTANCE);
                }
    ...
    public static final Flow combineTransform(Flow flow, Flow flow2, Flow flow3, Function5 function5) {
        return FlowKt.flow(new C7417xd7c321e8(new Flow[]{flow, flow2, flow3}, null, function5));
    }
    ...
    public static final Flow combine(Flow flow, Flow flow2, Flow flow3, Flow flow4, final Function5 function5) {
        ...
        return new Flow<Object>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            ...
            public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
                ...
                }, new C74112(null, function5), continuation);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2 */
            @Metadata(m1835d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n¨\u0006\u0007"}, m1836d2 = {"<anonymous>", "", "R", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = 48)
            @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2", m1845f = "Zip.kt", m1846i = {}, m1847l = {259, BZip2Constants.MAX_ALPHA_SIZE}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
            @SourceDebugExtension({"SMAP\nZip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1\n+ 2 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt\n*L\n1#1,258:1\n153#2,6:259\n*E\n"})
            public static final class C74112 extends SuspendLambda implements Function3<FlowCollector<Object>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C74112(Continuation continuation, Function5 function5) {
                    super(3, continuation);
                ...
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(FlowCollector<Object> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C74112 c74112 = new C74112(continuation, this.$transform$inlined);
                    c74112.L$0 = flowCollector;
                    c74112.L$1 = objArr;
                    return c74112.invokeSuspend(Unit.INSTANCE);
                }
    ...
    public static final Flow combineTransform(Flow flow, Flow flow2, Flow flow3, Flow flow4, Function6 function6) {
        return FlowKt.flow(new C7418xd7c321e9(new Flow[]{flow, flow2, flow3, flow4}, null, function6));
    }
    ...
    public static final Flow combine(Flow flow, Flow flow2, Flow flow3, Flow flow4, Flow flow5, final Function6 function6) {
        ...
        return new Flow<Object>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            ...
            public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
                ...
                }, new C74122(null, function6), continuation);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2 */
            @Metadata(m1835d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n¨\u0006\u0007"}, m1836d2 = {"<anonymous>", "", "R", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = 48)
            @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2", m1845f = "Zip.kt", m1846i = {}, m1847l = {259, BZip2Constants.MAX_ALPHA_SIZE}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
            @SourceDebugExtension({"SMAP\nZip.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1\n+ 2 Zip.kt\nkotlinx/coroutines/flow/FlowKt__ZipKt\n*L\n1#1,258:1\n194#2,7:259\n*E\n"})
            public static final class C74122 extends SuspendLambda implements Function3<FlowCollector<Object>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C74122(Continuation continuation, Function6 function6) {
                    super(3, continuation);
                ...
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(FlowCollector<Object> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C74122 c74122 = new C74122(continuation, this.$transform$inlined);
                    c74122.L$0 = flowCollector;
                    c74122.L$1 = objArr;
                    return c74122.invokeSuspend(Unit.INSTANCE);
                }
    ...
    public static final Flow combineTransform(Flow flow, Flow flow2, Flow flow3, Flow flow4, Flow flow5, Function7 function7) {
        return FlowKt.flow(new C7419xd7c321ea(new Flow[]{flow, flow2, flow3, flow4, flow5}, null, function7));
    }
    ...
    @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", m1845f = "Zip.kt", m1846i = {}, m1847l = {247}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
    public static final class C74206 extends SuspendLambda implements Function2<FlowCollector<Object>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C74206(Flow<Object>[] flowArr, Function3<? super FlowCollector<Object>, ? super Object[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C74206> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C74206 c74206 = new C74206(this.$flows, this.$transform, continuation);
            c74206.L$0 = obj;
            return c74206;
        }
        ...
        public final Object invoke(FlowCollector<Object> flowCollector, Continuation<? super Unit> continuation) {
            return ((C74206) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        @Metadata(m1835d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n"}, m1836d2 = {"<anonymous>", "", "R", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", m1845f = "Zip.kt", m1846i = {}, m1847l = {247}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
    ...
    public static final /* synthetic */ Flow combineTransform(Flow[] flowArr, Function3 function3) {
        Intrinsics.needClassReification();
        return FlowKt.flow(new C74206(flowArr, function3, null));
    }
    ...
    @Metadata(m1835d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\n"}, m1836d2 = {"<anonymous>", "", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
    @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m1845f = "Zip.kt", m1846i = {}, m1847l = {304}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
    public static final class C74217 extends SuspendLambda implements Function2<FlowCollector<Object>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C74217(Flow<Object>[] flowArr, Function3<? super FlowCollector<Object>, ? super Object[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C74217> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C74217 c74217 = new C74217(this.$flowArray, this.$transform, continuation);
            c74217.L$0 = obj;
            return c74217;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<Object> flowCollector, Continuation<? super Unit> continuation) {
            return ((C74217) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        @Metadata(m1835d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0006\b\u0001\u0010\u0003\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0006H\n"}, m1836d2 = {"<anonymous>", "", "R", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m1845f = "Zip.kt", m1846i = {}, m1847l = {304}, m1848m = "invokeSuspend", m1849n = {}, m1850s = {})
        public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<Object>, Object[], Continuation<? super Unit>, Object> {
            final /* synthetic */ Function3 $transform;
            private /* synthetic */ Object L$0;
            /* synthetic */ Object L$1;
    ...
    public static final /* synthetic */ Flow combineTransform(Iterable iterable, Function3 function3) {
        Flow[] flowArr = (Flow[]) CollectionsKt.toList(iterable).toArray(new Flow[0]);
        Intrinsics.needClassReification();
        return FlowKt.flow(new C74217(flowArr, function3, null));
    }
