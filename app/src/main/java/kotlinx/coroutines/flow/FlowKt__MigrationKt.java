...
abstract /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final void subscribe(Flow flow, Function2 function2, Function2 function3) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    static final class C73742 extends SuspendLambda implements Function3 {
        ...
        C73742(Function1 function1, Object obj, Continuation continuation) {
        ...
        public final Object invoke(FlowCollector flowCollector, Throwable th, Continuation continuation) {
            C73742 c73742 = new C73742(this.$predicate, this.$fallback, continuation);
            c73742.L$0 = flowCollector;
            c73742.L$1 = th;
            return c73742.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Flow onErrorReturn(Flow flow, Object obj, Function1 function1) {
        return FlowKt.m5961catch(flow, new C73742(function1, obj, null));
    }
    ...
    static final class C73731 extends SuspendLambda implements Function2 {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C73731(long j, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new C73731(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector flowCollector, Continuation continuation) {
            return ((C73731) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Flow delayFlow(Flow flow, long j) {
        return FlowKt.onStart(flow, new C73731(j, null));
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1 */
    static final class C73721 extends SuspendLambda implements Function2 {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C73721(long j, Continuation continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return new C73721(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation continuation) {
            return ((C73721) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Flow delayEach(Flow flow, long j) {
        return FlowKt.onEach(flow, new C73721(j, null));
    }
