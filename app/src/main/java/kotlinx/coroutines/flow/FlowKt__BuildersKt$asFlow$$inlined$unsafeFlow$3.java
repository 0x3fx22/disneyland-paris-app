...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3 implements Flow<Object> {
    ...
    @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", m1845f = "Builders.kt", m1846i = {0}, m1847l = {111}, m1848m = "collect", m1849n = {"$this$asFlow_u24lambda_u243"}, m1850s = {"L$0"})
    public static final class C73301 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C73301(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation<? super Unit> continuation) {
        C73301 c73301;
        Iterator it;
        if (continuation instanceof C73301) {
            c73301 = (C73301) continuation;
            int i = c73301.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c73301.label = i - Integer.MIN_VALUE;
            } else {
                c73301 = new C73301(continuation);
            }
        } else {
            c73301 = new C73301(continuation);
        }
        Object obj = c73301.result;
        ...
        if (i2 == 0) {
            ...
            it = (Iterator) c73301.L$1;
            flowCollector = (FlowCollector) c73301.L$0;
            ResultKt.throwOnFailure(obj);
        }
        while (it.hasNext()) {
            Object next = it.next();
            c73301.L$0 = flowCollector;
            c73301.L$1 = it;
            c73301.label = 1;
            if (flowCollector.emit(next, c73301) == coroutine_suspended) {
