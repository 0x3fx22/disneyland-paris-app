...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    static final class C74241 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        C74241(Continuation continuation) {
            super(continuation);
        }
        ...
        synchronized (this) {
            try {
                if (tryPeekLocked(sharedFlowSlot) >= 0) {
                    ...
                    cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(Unit.INSTANCE));
                } else {
    ...
    public final Object emitSuspend(Object obj, Continuation continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m5277constructorimpl(Unit.INSTANCE));
            }
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    static /* synthetic */ Object collect$suspendImpl(SharedFlowImpl sharedFlowImpl, FlowCollector flowCollector, Continuation continuation) throws Throwable {
        ...
        if (continuation instanceof C74241) {
            c74241 = (C74241) continuation;
            int i = c74241.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c74241.label = i - Integer.MIN_VALUE;
            } else {
                c74241 = new C74241(continuation);
            }
        } else {
            c74241 = new C74241(continuation);
        }
        Object obj = c74241.result;
        ...
        if (i2 == 0) {
            ...
            try {
                if (flowCollector instanceof SubscribedFlowCollector) {
                    c74241.L$0 = sharedFlowImpl;
                    c74241.L$1 = flowCollector;
                    c74241.L$2 = sharedFlowSlotAllocateSlot;
                    c74241.label = 1;
                    if (((SubscribedFlowCollector) flowCollector).onSubscription(c74241) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                flowCollector2 = flowCollector;
                sharedFlowSlot = sharedFlowSlotAllocateSlot;
                job = (Job) c74241.getContext().get(Job.INSTANCE);
            ...
            if (i2 == 1) {
                sharedFlowSlot = (SharedFlowSlot) c74241.L$2;
                FlowCollector flowCollector4 = (FlowCollector) c74241.L$1;
                SharedFlowImpl sharedFlowImpl3 = (SharedFlowImpl) c74241.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                ...
                Job job2 = (Job) c74241.L$3;
                sharedFlowSlot = (SharedFlowSlot) c74241.L$2;
                FlowCollector flowCollector5 = (FlowCollector) c74241.L$1;
                sharedFlowImpl2 = (SharedFlowImpl) c74241.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
        ...
        while (true) {
            ...
            if (objTryTakeValue == SharedFlowKt.NO_VALUE) {
                c74241.L$0 = sharedFlowImpl;
                c74241.L$1 = flowCollector3;
                c74241.L$2 = sharedFlowSlot;
                c74241.L$3 = job;
                c74241.label = 2;
                if (sharedFlowImpl.awaitValue(sharedFlowSlot, c74241) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (job != null) {
                ...
                c74241.L$3 = job;
                c74241.label = 3;
                if (flowCollector3.emit(objTryTakeValue, c74241) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        }
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m5277constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
