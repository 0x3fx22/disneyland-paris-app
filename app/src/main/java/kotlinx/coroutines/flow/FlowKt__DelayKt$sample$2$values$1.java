...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2 {
    ...
    static final class C73501 implements FlowCollector {
        final /* synthetic */ ProducerScope $$this$produce;

        C73501(ProducerScope producerScope) {
        ...
        public final Object emit(Object obj, Continuation continuation) {
            ...
            if (i2 == 0) {
                ...
                if (producerScope.send(obj, flowKt__DelayKt$sample$2$values$1$1$emit$1) == coroutine_suspended) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C73501 c73501 = new C73501(producerScope);
            this.label = 1;
            if (flow.collect(c73501, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
