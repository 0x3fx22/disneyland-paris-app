...
public final class FlowKt__TransformKt$filterIsInstance$$inlined$filter$1 implements Flow<Object> {
    ...
    public static final class C73992<T> implements FlowCollector {
        ...
        @Metadata(m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$$inlined$filter$1$2", m1845f = "Transform.kt", m1846i = {}, m1847l = {50}, m1848m = "emit", m1849n = {}, m1850s = {})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C73992.this.emit(null, this);
            }
        }

        public C73992(FlowCollector flowCollector) {
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        ...
        Object objCollect = flow.collect(new C73992(flowCollector), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Flow flow = this.$this_unsafeTransform$inlined;
        Intrinsics.needClassReification();
        C73992 c73992 = new C73992(flowCollector);
        InlineMarker.mark(0);
        flow.collect(c73992, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
