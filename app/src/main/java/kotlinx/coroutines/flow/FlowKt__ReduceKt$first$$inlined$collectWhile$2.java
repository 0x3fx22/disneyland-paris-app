...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2 implements FlowCollector<Object> {
    ...
    @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m1845f = "Reduce.kt", m1846i = {0, 0}, m1847l = {131}, m1848m = "emit", m1849n = {"this", "it"}, m1850s = {"L$0", "L$1"})
    public static final class C73751 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C73751(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object emit(Object obj, Continuation<? super Unit> continuation) {
        C73751 c73751;
        T t;
        if (continuation instanceof C73751) {
            c73751 = (C73751) continuation;
            int i = c73751.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c73751.label = i - Integer.MIN_VALUE;
            } else {
                c73751 = new C73751(continuation);
            }
        } else {
            c73751 = new C73751(continuation);
        }
        Object objInvoke = c73751.result;
        ...
        if (i2 == 0) {
            ...
            c73751.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(obj, c73751);
            InlineMarker.mark(7);
            ...
            Object obj2 = c73751.L$1;
            this = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c73751.L$0;
            ResultKt.throwOnFailure(objInvoke);
            t = obj2;
        }
        t = obj;
