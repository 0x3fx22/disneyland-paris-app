...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    protected Object invokeSuspend(@NotNull Object result) {
        Throwable thM5280exceptionOrNullimpl = Result.m5280exceptionOrNullimpl(result);
        if (thM5280exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM5280exceptionOrNullimpl, getContext());
        }
        Continuation continuation = this.completion_;
