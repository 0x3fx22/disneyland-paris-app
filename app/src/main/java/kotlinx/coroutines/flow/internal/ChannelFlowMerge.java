...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        Object objCollect = this.flow.collect(new C74322((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    static final class C74322 implements FlowCollector {
        final /* synthetic */ SendingCollector $collector;
        final /* synthetic */ Job $job;
        final /* synthetic */ ProducerScope $scope;
        final /* synthetic */ Semaphore $semaphore;

        C74322(Job job, Semaphore semaphore, ProducerScope producerScope, SendingCollector sendingCollector) {
            this.$job = job;
        ...
        public final Object emit(Flow flow, Continuation continuation) {
            ...
            if (i2 == 0) {
                ...
                this = (C74322) channelFlowMerge$collectTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
