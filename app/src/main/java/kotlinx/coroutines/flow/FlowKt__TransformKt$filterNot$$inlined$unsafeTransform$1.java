...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    public static final class C74022<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        ...
        @Metadata(m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m1845f = "Transform.kt", m1846i = {0, 0}, m1847l = {50, 50}, m1848m = "emit", m1849n = {"value", "$this$filterNot_u24lambda_u241"}, m1850s = {"L$0", "L$1"})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C74022.this.emit(null, this);
            }
        }

        public C74022(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C74022(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C74022 c74022 = new C74022(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c74022, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
