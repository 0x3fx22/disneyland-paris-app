...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    public static final class C73972<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        ...
        @Metadata(m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m1845f = "Transform.kt", m1846i = {0, 0}, m1847l = {50, 50}, m1848m = "emit", m1849n = {"value", "$this$filter_u24lambda_u240"}, m1850s = {"L$0", "L$1"})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C73972.this.emit(null, this);
            }
        }

        public C73972(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C73972(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C73972 c73972 = new C73972(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c73972, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
