...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    public static final class C74052<T> implements FlowCollector {
        ...
        @Metadata(m1837k = 3, m1838mv = {2, 0, 0}, m1840xi = SyslogConstants.LOG_LOCAL6)
        @DebugMetadata(m1844c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m1845f = "Transform.kt", m1846i = {}, m1847l = {50, 50}, m1848m = "emit", m1849n = {}, m1850s = {})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C74052.this.emit(null, this);
            }
        }

        public C74052(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C74052(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C74052 c74052 = new C74052(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c74052, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
