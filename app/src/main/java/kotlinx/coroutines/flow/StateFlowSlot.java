...
final class StateFlowSlot extends AbstractSharedFlowSlot {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (value == StateFlowKt.NONE) {
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this._state, value, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this._state, value, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) value).resumeWith(Result.m5277constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final Object awaitPending(Continuation continuation) {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m87m(this._state, StateFlowKt.NONE, cancellableContinuationImpl)) {
            Result.Companion companion = Result.INSTANCE;
