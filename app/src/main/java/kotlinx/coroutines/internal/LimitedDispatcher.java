...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo5991scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo5991scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo5990dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        ...
        this.dispatcher.mo5990dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo5990dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
