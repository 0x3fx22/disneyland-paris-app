...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM5277constructorimpl2;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM5277constructorimpl = Result.m5277constructorimpl(BaseContinuationImpl.class.getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5277constructorimpl = Result.m5277constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5280exceptionOrNullimpl(objM5277constructorimpl) != null) {
            objM5277constructorimpl = "kotlin.coroutines.jvm.internal.BaseContinuationImpl";
        }
        baseContinuationImplClassName = (String) objM5277constructorimpl;
        try {
            objM5277constructorimpl2 = Result.m5277constructorimpl(StackTraceRecoveryKt.class.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion3 = Result.INSTANCE;
            objM5277constructorimpl2 = Result.m5277constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5280exceptionOrNullimpl(objM5277constructorimpl2) != null) {
            objM5277constructorimpl2 = "kotlinx.coroutines.internal.StackTraceRecoveryKt";
        }
        stackTraceRecoveryClassName = (String) objM5277constructorimpl2;
    }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), th.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m1842to(cause, stackTrace);
                }
            }
            return TuplesKt.m1842to(th, new StackTraceElement[0]);
        }
        return TuplesKt.m1842to(th, new StackTraceElement[0]);
    }
