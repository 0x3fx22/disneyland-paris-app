...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(@Nullable Object takenState, @NotNull Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                if (AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, cause, 15, null))) {
                    completedContinuation.invokeHandlers(this, cause);
                    return;
                }
            } else if (AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, null, null, null, cause, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(@Nullable Throwable cause) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        AbstractC0365xc40028dd.m91m(_parentHandle$volatile$FU, this, null, disposableHandleInvokeOnCompletion$default);
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, handler)) {
                    return;
                }
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                } else {
                    ...
                    Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                    if (AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
    ...
    public final <R> void resumeImpl$kotlinx_coroutines_core(R proposedUpdate, int resumeMode, @Nullable Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> onCancellation) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, resumeMode, onCancellation, null)));
        detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function3 onCancellation) {
        ...
        } while (!AbstractC0365xc40028dd.m91m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, this.resumeMode, onCancellation, idempotent)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
