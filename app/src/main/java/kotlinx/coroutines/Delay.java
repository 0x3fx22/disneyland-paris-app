...
public interface Delay {
    ...
    void mo5991scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(@NotNull Delay delay, long j, @NotNull Continuation<? super Unit> continuation) {
            ...
            delay.mo5991scheduleResumeAfterDelay(j, cancellableContinuationImpl);
