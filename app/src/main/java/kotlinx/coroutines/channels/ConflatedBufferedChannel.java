...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ Object send$suspendImpl(ConflatedBufferedChannel conflatedBufferedChannel, Object obj, Continuation continuation) throws Throwable {
        ...
        Object objM5959trySendImplMj0NB7M = conflatedBufferedChannel.m5959trySendImplMj0NB7M(obj, true);
        if (objM5959trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5944exceptionOrNullimpl(objM5959trySendImplMj0NB7M);
    ...
    static /* synthetic */ Object sendBroadcast$suspendImpl(ConflatedBufferedChannel conflatedBufferedChannel, Object obj, Continuation continuation) {
        Object objM5959trySendImplMj0NB7M = conflatedBufferedChannel.m5959trySendImplMj0NB7M(obj, true);
        if (!(objM5959trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo5925trySendJP2dKIU(E element) {
        return m5959trySendImplMj0NB7M(element, false);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5959trySendImplMj0NB7M(Object element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5958trySendDropLatestMj0NB7M(element, isSendOp) : m5934trySendDropOldestJP2dKIU(element);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5958trySendDropLatestMj0NB7M(Object element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo5925trySendJP2dKIU = super.mo5925trySendJP2dKIU(element);
        if (ChannelResult.m5950isSuccessimpl(objMo5925trySendJP2dKIU) || ChannelResult.m5948isClosedimpl(objMo5925trySendJP2dKIU)) {
            return objMo5925trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(@NotNull SelectInstance<?> select, @Nullable Object element) {
        Object objMo5925trySendJP2dKIU = mo5925trySendJP2dKIU(element);
        if (!(objMo5925trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo5925trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable");
            }
            ChannelResult.m5944exceptionOrNullimpl(objMo5925trySendJP2dKIU);
