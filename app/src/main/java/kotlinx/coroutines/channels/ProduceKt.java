...
public final class ProduceKt {
    ...
    public static final Object awaitClose(@NotNull ProducerScope<?> producerScope, @NotNull Function0<Unit> function0, @NotNull Continuation<? super Unit> continuation) {
        C73151 c73151;
        if (continuation instanceof C73151) {
            c73151 = (C73151) continuation;
            int i = c73151.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c73151.label = i - Integer.MIN_VALUE;
            } else {
                c73151 = new C73151(continuation);
            }
        } else {
            c73151 = new C73151(continuation);
        }
        Object obj = c73151.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c73151.label;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                if (c73151.getContext().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context");
                }
                c73151.L$0 = producerScope;
                c73151.L$1 = function0;
                c73151.label = 1;
                final CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c73151), 1);
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c73151);
                }
                ...
                function0 = (Function0) c73151.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
