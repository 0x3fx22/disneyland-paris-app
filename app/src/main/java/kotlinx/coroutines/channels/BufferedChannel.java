...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo5932receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        return m5930receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
        ...
        if (i >= 0) {
            ...
            this.onUndeliveredElementReceiveCancellationConstructor = function1 != 0 ? new Function3() { // from class: kotlinx.coroutines.channels.BufferedChannel$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    return BufferedChannel.m1909xa189d599(this.f$0, (SelectInstance) obj, obj2, obj3);
                }
            } : null;
    ...
    public final void onClosedSendOnNoWaiterSuspend(Object element, CancellableContinuation cont) {
        ...
        cont.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    @NotNull
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo5925trySendJP2dKIU(E element) {
        ChannelSegment channelSegment;
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.INSTANCE.m5954failurePtdJZtk();
        }
        ...
        return ChannelResult.INSTANCE.m5953closedJP2dKIU(getSendException());
    }
    ...
    public final Object onClosedSend(Object obj, Continuation continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, obj, null, 2, null)) != null) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(undeliveredElementExceptionCallUndeliveredElementCatchingException$default)));
        } else {
            Throwable sendException = getSendException();
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    static /* synthetic */ Object sendBroadcast$suspendImpl(BufferedChannel bufferedChannel, Object obj, Continuation continuation) {
        ChannelSegment channelSegment;
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        cancellableContinuationImpl.initCancellability();
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            int iUpdateCellSend = bufferedChannel.updateCellSend(channelSegment, i2, obj, j, sendBroadcast, zIsClosedForSend0);
            if (iUpdateCellSend == 0) {
            ...
            cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(Boxing.boxBoolean(true)));
            break;
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    protected final Object m5934trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegment;
    ...
    public final Object sendOnNoWaiterSuspend(ChannelSegment channelSegment, int i, Object obj, long j, Continuation continuation) {
        ...
        try {
                    ...
                    if (iUpdateCellSend != 2) {
                        if (iUpdateCellSend != 4) {
                            ...
                            while (true) {
                                ...
                                int iUpdateCellSend2 = updateCellSend(channelSegment2, i3, obj, j2, orCreateCancellableContinuation, zIsClosedForSend0);
            ...
            orCreateCancellableContinuation.resumeWith(objM5277constructorimpl);
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
            }
    ...
    private final boolean tryResumeReceiver(Object obj, Object obj2) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM5940boximpl = ChannelResult.m5940boximpl(ChannelResult.INSTANCE.m5955successJP2dKIU(obj2));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM5940boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(getReceiveException())));
    }

    /* JADX WARN: Code duplicated, block: B:8:0x0014  */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: receiveCatching-JP2dKIU$suspendImpl, reason: not valid java name */
    static /* synthetic */ Object m5930receiveCatchingJP2dKIU$suspendImpl(BufferedChannel bufferedChannel, Continuation continuation) {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM5931receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m5931receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i4, andIncrement, bufferedChannel$receiveCatching$2);
                        return objM5931receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM5931receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m5955successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m5953closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    public final Object m5931receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment channelSegment, int i, long j, Continuation continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM5940boximpl;
        Function3 function3;
            ...
            try {
                ...
                if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                    if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                        ...
                        while (true) {
                            ...
                            if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                    ...
                                    channelSegment2.cleanPrev();
                                    channelResultM5940boximpl = ChannelResult.m5940boximpl(ChannelResult.INSTANCE.m5955successJP2dKIU(objUpdateCellReceive2));
                                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                        ...
                        channelSegment.cleanPrev();
                        channelResultM5940boximpl = ChannelResult.m5940boximpl(ChannelResult.INSTANCE.m5955successJP2dKIU(objUpdateCellReceive));
                        Function1<E, Unit> function2 = this.onUndeliveredElement;
                        function3 = (Function3) (function2 != null ? bindCancellationFunResult(function2) : null);
                    }
                    orCreateCancellableContinuation.resume(channelResultM5940boximpl, (Function3<? super Throwable, ? super ChannelResult, ? super CoroutineContext, Unit>) function3);
                    break;
                }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m5277constructorimpl(ChannelResult.m5940boximpl(ChannelResult.INSTANCE.m5953closedJP2dKIU(getCloseCause()))));
    }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m5940boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m5953closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m5955successJP2dKIU(selectResult));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: onUndeliveredElementReceiveCancellationConstructor$lambda$57$lambda$56 */
    public static final Function3 m1909xa189d599(final BufferedChannel bufferedChannel, final SelectInstance selectInstance, Object obj, final Object obj2) {
        return new Function3() { // from class: kotlinx.coroutines.channels.BufferedChannel$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function3
            public final Object invoke(Object obj3, Object obj4, Object obj5) {
                return BufferedChannel.m1910xc6272352(obj2, bufferedChannel, selectInstance, (Throwable) obj3, obj4, (CoroutineContext) obj5);
            }
        };
    }
    ...
    public static final Unit m1910xc6272352(Object obj, BufferedChannel bufferedChannel, SelectInstance selectInstance, Throwable th, Object obj2, CoroutineContext coroutineContext) {
    ...
    private final class BufferedChannelIterator implements ChannelIterator, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(Boolean.FALSE));
            } else {
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(closeCause)));
            }
        }
    ...
    protected boolean closeOrCancelImpl(@Nullable Throwable cause, boolean cancel) {
        ...
        boolean zM91m = AbstractC0365xc40028dd.m91m(_closeCause$volatile$FU, this, BufferedChannelKt.NO_CLOSE_CAUSE, cause);
        if (cancel) {
            markCancelled();
        } else {
            markClosed();
    ...
    private final void invokeCloseHandler() {
        ...
        } while (!AbstractC0365xc40028dd.m91m(atomicReferenceFieldUpdater, this, obj, obj == null ? BufferedChannelKt.CLOSE_HANDLER_CLOSED : BufferedChannelKt.CLOSE_HANDLER_INVOKED));
        if (obj == null) {
            return;
        }
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> handler) {
        if (AbstractC0365xc40028dd.m91m(closeHandler$volatile$FU, this, null, handler)) {
            return;
        }
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = closeHandler$volatile$FU;
        do {
        ...
        } while (!AbstractC0365xc40028dd.m91m(closeHandler$volatile$FU, this, BufferedChannelKt.CLOSE_HANDLER_CLOSED, BufferedChannelKt.CLOSE_HANDLER_INVOKED));
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private final long markAllEmptyCellsAsClosed(ChannelSegment lastSegment) {
        do {
            int i = BufferedChannelKt.SEGMENT_SIZE;
            while (true) {
                i--;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private final void removeUnprocessedElements(ChannelSegment lastSegment) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException = null;
        Object objM5981constructorimpl$default = InlineList.m5981constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM5981constructorimpl$default = InlineList.m5986plusFjFbRPM(objM5981constructorimpl$default, waiter);
        ...
        if (objM5981constructorimpl$default != null) {
            if (objM5981constructorimpl$default instanceof ArrayList) {
                Intrinsics.checkNotNull(objM5981constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) objM5981constructorimpl$default;
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    resumeSenderOnCancelledChannel((Waiter) arrayList.get(size));
                }
            } else {
                resumeSenderOnCancelledChannel((Waiter) objM5981constructorimpl$default);
            }
        }
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM5981constructorimpl$default = InlineList.m5986plusFjFbRPM(objM5981constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM5981constructorimpl$default = InlineList.m5986plusFjFbRPM(objM5981constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM5981constructorimpl$default != null) {
            ...
            resumeReceiverOnClosedChannel((Waiter) objM5981constructorimpl$default);
        }
    }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m5277constructorimpl(Boolean.FALSE));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m5277constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
        } else if (waiter instanceof ReceiveCatching) {
            CancellableContinuationImpl cancellableContinuationImpl = ((ReceiveCatching) waiter).cont;
            Result.Companion companion3 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m5277constructorimpl(ChannelResult.m5940boximpl(ChannelResult.INSTANCE.m5953closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment findSegmentSend(long id, ChannelSegment startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m5998isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM5996getSegmentimpl = SegmentOrClosed.m5996getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM5996getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM5996getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractC0365xc40028dd.m91m(atomicReferenceFieldUpdater, this, segment, segmentM5996getSegmentimpl)) {
                    ...
                    if (segmentM5996getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM5996getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment channelSegment = (ChannelSegment) SegmentOrClosed.m5996getSegmentimpl(objFindSegmentInternal);
    ...
    public final ChannelSegment findSegmentReceive(long id, ChannelSegment startFrom) {
        ...
        if (!isRendezvousOrUnlimited() && id <= getBufferEndCounter() / ((long) BufferedChannelKt.SEGMENT_SIZE)) {
            ...
            while (true) {
                ...
                if (AbstractC0365xc40028dd.m91m(atomicReferenceFieldUpdater2, this, segment2, channelSegment)) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private final void moveSegmentBufferEndToSpecifiedOrLast(long id, ChannelSegment startFrom) {
        ChannelSegment channelSegment;
        ChannelSegment channelSegment2;
        ...
        while (true) {
            if (!startFrom.isRemoved() || (channelSegment = (ChannelSegment) startFrom.getNext()) == null) {
                ...
                while (true) {
                    ...
                    if (AbstractC0365xc40028dd.m91m(atomicReferenceFieldUpdater, this, segment, startFrom)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                            return;
                        }
        ...
        loop2: while (true) {
            ...
            for (int i4 = i2; i4 < i3; i4++) {
                ...
                if (element$kotlinx_coroutines_core != null) {
                    sb.append(CoreConstants.LEFT_PARENTHESIS_CHAR + string + ',' + element$kotlinx_coroutines_core + "),");
                } else {
                    sb.append(string + ',');
                }
            }
    ...
    /* synthetic */ class C72721 extends FunctionReferenceImpl implements Function3 {
        C72721(Object obj) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            m5935invoke5_sEAP8((Throwable) obj, ((ChannelResult) obj2).getHolder(), (CoroutineContext) obj3);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m5935invoke5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
            ((BufferedChannel) this.receiver).m5929onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, coroutineContext);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final KFunction bindCancellationFunResult(Function1 function1) {
        return new C72721(this);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: onCancellationChannelResultImplDoNotCall-5_sEAP8, reason: not valid java name */
    public final void m5929onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable cause, Object element, CoroutineContext context) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object objM5945getOrNullimpl = ChannelResult.m5945getOrNullimpl(element);
        Intrinsics.checkNotNull(objM5945getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM5945getOrNullimpl, context);
    }
    ...
    /* synthetic */ class C72712 extends FunctionReferenceImpl implements Function3 {
        C72712(Object obj) {
