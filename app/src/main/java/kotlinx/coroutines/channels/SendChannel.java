...
public interface SendChannel<E> {
    ...
    Object mo5925trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo5925trySendJP2dKIU = sendChannel.mo5925trySendJP2dKIU(e);
            if (ChannelResult.m5950isSuccessimpl(objMo5925trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5944exceptionOrNullimpl = ChannelResult.m5944exceptionOrNullimpl(objMo5925trySendJP2dKIU);
