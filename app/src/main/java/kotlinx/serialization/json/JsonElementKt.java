...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m6043JsonPrimitive7apg3OU(byte b) {
        return m6044JsonPrimitiveVKZWuLQ(ULong.m5337constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    @NotNull
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m6046JsonPrimitivexj2QHRw(short s) {
        return m6044JsonPrimitiveVKZWuLQ(ULong.m5337constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    @NotNull
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m6045JsonPrimitiveWZ4Q5Ns(int i) {
        return m6044JsonPrimitiveVKZWuLQ(ULong.m5337constructorimpl(((long) i) & BodyPartID.bodyIdMax));
    }
    ...
    public static final JsonPrimitive m6044JsonPrimitiveVKZWuLQ(long j) {
