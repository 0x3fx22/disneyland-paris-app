        ...
        if (kSerializer2 != null) {
            ...
            for (Object obj2 : MapsKt.asSequence((Map) obj)) {
                if (((Map.Entry) obj2).getValue() == kSerializer2) {
                    throw new IllegalArgumentException("Multiple polymorphic serializers for base class '" + baseClass + "' have the same serial name '" + serialName + "': '" + concreteClass + "' and '" + ((Map.Entry) obj2) + CoreConstants.SINGLE_QUOTE_CHAR);
                }
            }
            obj2 = null;
            throw new IllegalArgumentException("Multiple polymorphic serializers for base class '" + baseClass + "' have the same serial name '" + serialName + "': '" + concreteClass + "' and '" + ((Map.Entry) obj2) + CoreConstants.SINGLE_QUOTE_CHAR);
