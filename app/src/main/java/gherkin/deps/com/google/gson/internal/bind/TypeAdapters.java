...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapter2 = new TypeAdapter() { // from class: gherkin.deps.com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = C663932.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        ...
        TypeAdapter<Number> typeAdapter7 = new TypeAdapter() { // from class: gherkin.deps.com.google.gson.internal.bind.TypeAdapters.11
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken jsonTokenPeek = jsonReader.peek();
                int i = C663932.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                if (i == 1) {
        ...
        TypeAdapter<JsonElement> typeAdapter18 = new TypeAdapter() { // from class: gherkin.deps.com.google.gson.internal.bind.TypeAdapters.25
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (C663932.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    /* JADX INFO: renamed from: gherkin.deps.com.google.gson.internal.bind.TypeAdapters$32 */
    static /* synthetic */ class C663932 {
