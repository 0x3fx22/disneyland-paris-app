        ...
        while (true) {
            ...
            for (ScenarioDefinition scenarioDefinition : feature.getChildren()) {
                if (scenarioDefinition instanceof Background) {
                    ...
                    compileScenario(arrayList, list, (Scenario) scenarioDefinition, tags, language);
                } else {
                    compileScenarioOutline(arrayList, list, (ScenarioOutline) scenarioDefinition, tags, language);
                }
            }
            return arrayList;
        }
