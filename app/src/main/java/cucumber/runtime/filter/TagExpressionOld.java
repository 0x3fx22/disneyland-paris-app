...
class TagExpressionOld {
    ...
    private void add(String[] strArr) {
        ...
        for (String str : strArr) {
            ...
            if (z) {
                c6030Or.add(new Not(new TagExp(strTrim)));
            } else {
                c6030Or.add(new TagExp(strTrim));
            }
        }
        this.and.add(c6030Or);
    }
    ...
    /* JADX INFO: renamed from: cucumber.runtime.filter.TagExpressionOld$Or */
    private class C6030Or implements Expression {
        private List expressions;
