...
import com.michaelflisar.lumberjack.C4425L;
...
public abstract class BaseTree extends Timber.Tree {
    ...
    final String getTag() {
        ...
        return tag == null ? stackTag : C4425L.getFormatter().combineTagAndGroup(stackTag, tag);
    }

    @Override // timber.log.Timber.Tree
    protected final void log(int i, String str, String str2, Throwable th) {
        if (isReady()) {
            String strExtractGroupFromTag = this.mCombineTags ? C4425L.getFormatter().extractGroupFromTag(str) : str;
