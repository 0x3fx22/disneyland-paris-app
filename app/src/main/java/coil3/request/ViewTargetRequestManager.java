...
public final class ViewTargetRequestManager implements View.OnAttachStateChangeListener {
    ...
    /* JADX INFO: renamed from: coil3.request.ViewTargetRequestManager$dispose$1 */
    static final class C17791 extends SuspendLambda implements Function2 {
        int label;

        C17791(Continuation continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            return ViewTargetRequestManager.this.new C17791(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C17791) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final synchronized void dispose() {
        try {
            ...
            this.pendingClear = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain().getImmediate(), null, new C17791(null), 2, null);
