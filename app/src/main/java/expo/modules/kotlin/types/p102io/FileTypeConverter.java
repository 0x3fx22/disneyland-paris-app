...
public final class FileTypeConverter extends DynamicAwareTypeConverters<File> {
    ...
    @NotNull
    public File convertFromDynamic(@NotNull Dynamic value, @Nullable AppContext context) {
    ...
    @Override // expo.modules.kotlin.types.DynamicAwareTypeConverters
    @NotNull
    public File convertFromAny(@NotNull Object value, @Nullable AppContext context) {
        Intrinsics.checkNotNullParameter(value, "value");
