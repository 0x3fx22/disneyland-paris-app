...
public final class UriTypeConverter extends DynamicAwareTypeConverters<Uri> {
    ...
    @NotNull
    public Uri convertFromDynamic(@NotNull Dynamic value, @Nullable AppContext context) {
        Intrinsics.checkNotNullParameter(value, "value");
        Uri uri = Uri.parse(value.asString());
    ...
    @Override // expo.modules.kotlin.types.DynamicAwareTypeConverters
    @NotNull
    public Uri convertFromAny(@NotNull Object value, @Nullable AppContext context) {
        Intrinsics.checkNotNullParameter(value, "value");
