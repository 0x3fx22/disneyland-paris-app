package expo.modules.kotlin.types.p102io;
...
public final class PathTypeConverter extends DynamicAwareTypeConverters<Path> {
    ...
    @NotNull
    public Path convertFromDynamic(@NotNull Dynamic value, @Nullable AppContext context) {
    ...
    @Override // expo.modules.kotlin.types.DynamicAwareTypeConverters
    @NotNull
    public Path convertFromAny(@NotNull Object value, @Nullable AppContext context) {
        Intrinsics.checkNotNullParameter(value, "value");
