...
public final class Uint32Array implements TypedArray, GenericTypedArray<UInt>, RawTypedArrayHolder {
    ...
    public int m5264getOGnWXxg(int index) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
        return UInt.m5312constructorimpl(read4Byte(index * 4));
    }

    /* JADX INFO: renamed from: set-Qn1smSk, reason: not valid java name */
    public void m5265setQn1smSk(int index, int value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
    ...
    public Uint32Array(@NotNull JavaScriptTypedArray rawArray) {
    ...
    public /* bridge */ /* synthetic */ UInt get(int i) {
        return UInt.m5311boximpl(m5264getOGnWXxg(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, UInt uInt) {
        m5265setQn1smSk(i, uInt.getData());
    }
}
