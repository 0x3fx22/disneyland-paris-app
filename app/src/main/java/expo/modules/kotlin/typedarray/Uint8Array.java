...
public final class Uint8Array implements TypedArray, GenericTypedArray<UByte>, RawTypedArrayHolder {
    ...
    public byte m5266getWa3L5BU(int index) {
    ...
    public void m5267setEK6454(int index, byte value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
    ...
    public Uint8Array(@NotNull JavaScriptTypedArray rawArray) {
    ...
    public /* bridge */ /* synthetic */ UByte get(int i) {
        return UByte.m5286boximpl(m5266getWa3L5BU(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, UByte uByte) {
        m5267setEK6454(i, uByte.getData());
    }
}
