...
public final class BigUint64Array implements TypedArray, GenericTypedArray<ULong>, RawTypedArrayHolder {
    ...
    public long m5260getI7RO_PI(int index) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
        return ULong.m5337constructorimpl(read8Byte(index * 8));
    }

    /* JADX INFO: renamed from: set-2TYgG_w, reason: not valid java name */
    public void m5261set2TYgG_w(int index, long value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
    ...
    public BigUint64Array(@NotNull JavaScriptTypedArray rawArray) {
    ...
    public /* bridge */ /* synthetic */ ULong get(int i) {
        return ULong.m5336boximpl(m5260getI7RO_PI(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, ULong uLong) {
        m5261set2TYgG_w(i, uLong.getData());
    }
}
