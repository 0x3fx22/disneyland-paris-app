...
public final class Float64Array implements TypedArray, GenericTypedArray<Double>, RawTypedArrayHolder {
    ...
    public Float64Array(@NotNull JavaScriptTypedArray rawArray) {
