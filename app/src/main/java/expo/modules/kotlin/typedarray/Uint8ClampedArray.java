...
public final class Uint8ClampedArray implements TypedArray, GenericTypedArray<UByte>, RawTypedArrayHolder {
    ...
    public byte m5268getWa3L5BU(int index) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
        return UByte.m5287constructorimpl(readByte(index));
    }

    /* JADX INFO: renamed from: set-EK-6454, reason: not valid java name */
    public void m5269setEK6454(int index, byte value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
    ...
    public Uint8ClampedArray(@NotNull JavaScriptTypedArray rawArray) {
    ...
    public /* bridge */ /* synthetic */ UByte get(int i) {
        return UByte.m5286boximpl(m5268getWa3L5BU(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, UByte uByte) {
        m5269setEK6454(i, uByte.getData());
    }
}
