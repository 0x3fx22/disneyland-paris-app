...
public final class Float32Array implements TypedArray, GenericTypedArray<Float>, RawTypedArrayHolder {
    ...
    public Float32Array(@NotNull JavaScriptTypedArray rawArray) {
