...
public final class FlowAdapters {
    ...
    public static <T> Flow.Publisher<T> toFlowPublisher(Publisher<? extends T> publisher) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline0.m2130m(publisher)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline1.m2131m(publisher);
        }
    ...
    public static <T, U> Flow.Processor<T, U> toFlowProcessor(Processor<? super T, ? extends U> processor) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline4.m2134m(processor)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline5.m2135m(processor);
        }
    ...
    public static <T> Flow.Subscriber<T> toFlowSubscriber(Subscriber<T> subscriber) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline2.m2132m(subscriber)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline3.m2133m(subscriber);
        }
