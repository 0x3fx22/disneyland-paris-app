...
import org.hamcrest.core.C7998Is;
...
public class Matchers {
    ...
    public static <T> Matcher<T> m2121is(T t) {
        return C7998Is.m2126is(t);
    }

    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m2122is(Matcher<T> matcher) {
        return C7998Is.m2127is((Matcher) matcher);
    }

    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m2120is(Class<T> cls) {
        return C7998Is.m2125is((Class) cls);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C7998Is.isA(cls);
    }
