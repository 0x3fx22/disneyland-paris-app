...
public class CombinableMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    public CombinableMatcher<T> m2123or(Matcher<? super T> matcher) {
    ...
    public static final class CombinableEitherMatcher<X> {
        ...
        /* JADX INFO: renamed from: or */
        public CombinableMatcher<X> m2124or(Matcher<? super X> matcher) {
            return new CombinableMatcher(this.first).m2123or(matcher);
        }
    }
}
