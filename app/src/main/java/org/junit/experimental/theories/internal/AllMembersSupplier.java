...
public class AllMembersSupplier extends ParameterSupplier {
    ...
    private void addMultiPointFields(ParameterSignature parameterSignature, List list) {
    ...
    private void addDataPointsValues(Class cls, ParameterSignature parameterSignature, String str, List list, Object obj) {
        if (cls.isArray()) {
    ...
    private void addArrayValues(ParameterSignature parameterSignature, String str, List list, Object obj) {
