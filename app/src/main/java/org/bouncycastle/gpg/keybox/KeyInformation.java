...
public class KeyInformation {
    ...
    static KeyInformation getInstance(Object obj, int i, int i2) throws IOException {
        ...
        byte[] bArrM2094bN = keyBoxByteBufferWrap.m2094bN(20);
        ...
        return new KeyInformation(bArrM2094bN, jU32, iU16, keyBoxByteBufferWrap.m2094bN(i - (keyBoxByteBufferWrap.position() - iPosition)), bArr);
    }
