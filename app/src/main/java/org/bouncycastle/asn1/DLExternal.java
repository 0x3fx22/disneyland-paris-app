...
public class DLExternal extends ASN1External {
    ...
    void encode(ASN1OutputStream aSN1OutputStream, boolean z) throws IOException {
        ...
        if (aSN1ObjectIdentifier != null) {
            byteArrayOutputStream.write(aSN1ObjectIdentifier.getEncoded(ASN1Encoding.f4000DL));
        }
        ASN1Integer aSN1Integer = this.indirectReference;
        if (aSN1Integer != null) {
            byteArrayOutputStream.write(aSN1Integer.getEncoded(ASN1Encoding.f4000DL));
        }
        ASN1Primitive aSN1Primitive = this.dataValueDescriptor;
        if (aSN1Primitive != null) {
            byteArrayOutputStream.write(aSN1Primitive.getEncoded(ASN1Encoding.f4000DL));
        }
        byteArrayOutputStream.write(new DLTaggedObject(true, this.encoding, this.externalContent).getEncoded(ASN1Encoding.f4000DL));
