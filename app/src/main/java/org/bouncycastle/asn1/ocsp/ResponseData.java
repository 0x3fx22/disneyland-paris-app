...
public class ResponseData extends ASN1Object {
    ...
    private static final ASN1Integer f4020V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f4020V1, responderID, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f4020V1, responderID, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f4020V1)) {
