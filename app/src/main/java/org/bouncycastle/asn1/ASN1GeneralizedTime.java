...
public class ASN1GeneralizedTime extends ASN1Primitive {
    ...
    public Date getDate() throws ParseException {
        ...
        if (strFromByteArray.endsWith("Z")) {
            if (hasFractionalSeconds()) {
                simpleDateFormatCalculateGMTDateFormat = new SimpleDateFormat("yyyyMMddHHmmss.SSS'Z'");
            } else if (hasSeconds()) {
                simpleDateFormatCalculateGMTDateFormat = new SimpleDateFormat("yyyyMMddHHmmss'Z'");
            } else {
                simpleDateFormatCalculateGMTDateFormat = hasMinutes() ? new SimpleDateFormat("yyyyMMddHHmm'Z'") : new SimpleDateFormat("yyyyMMddHH'Z'");
            }
