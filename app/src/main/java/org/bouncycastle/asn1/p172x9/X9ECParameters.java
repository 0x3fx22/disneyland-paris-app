...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f4082g;

    /* JADX INFO: renamed from: h */
    private BigInteger f4083h;

    /* JADX INFO: renamed from: n */
    private BigInteger f4084n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f4084n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        if (aSN1Sequence.size() == 6) {
            this.f4083h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.f4084n, this.f4083h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f4082g = (X9ECPoint) objectAt;
        } else {
            this.f4082g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f4082g = x9ECPoint;
        this.f4084n = bigInteger;
        this.f4083h = bigInteger2;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f4082g);
        aSN1EncodableVector.add(new ASN1Integer(this.f4084n));
        BigInteger bigInteger = this.f4083h;
        if (bigInteger != null) {
