...
public class X9FieldElement extends ASN1Object {
    ...
    protected ECFieldElement f4087f;
    ...
    public X9FieldElement(BigInteger bigInteger, ASN1OctetString aSN1OctetString) {
        this(new ECFieldElement.C7836Fp(bigInteger, new BigInteger(1, aSN1OctetString.getOctets())));
    }

    public X9FieldElement(ECFieldElement eCFieldElement) {
        this.f4087f = eCFieldElement;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f4087f.toBigInteger(), converter.getByteLength(this.f4087f)));
    }
}
