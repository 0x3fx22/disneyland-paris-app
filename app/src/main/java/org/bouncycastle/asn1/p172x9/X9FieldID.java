...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private ASN1ObjectIdentifier f4088id;
    ...
    public X9FieldID(int i, int i2, int i3, int i4) {
        this.f4088id = X9ObjectIdentifiers.characteristic_two_field;
    ...
    public X9FieldID(BigInteger bigInteger) {
        this.f4088id = X9ObjectIdentifiers.prime_field;
        this.parameters = new ASN1Integer(bigInteger);
    }

    private X9FieldID(ASN1Sequence aSN1Sequence) {
        this.f4088id = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0));
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f4088id);
