    ...
    static void _dumpAsString(String str, boolean z, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (aSN1Primitive instanceof ASN1Sequence) {
            ...
            if (aSN1Primitive instanceof BERSequence) {
                ...
                str4 = aSN1Primitive instanceof DERSequence ? "DER Sequence" : "Sequence";
            }
            ...
            while (true) {
                ...
                while (objects.hasMoreElements()) {
                    ...
                    if (objNextElement == null || objNextElement.equals(DERNull.INSTANCE)) {
                        ...
                        _dumpAsString(str5, z, objNextElement instanceof ASN1Primitive ? (ASN1Primitive) objNextElement : ((ASN1Encodable) objNextElement).toASN1Primitive(), stringBuffer);
                    }
                }
                return;
            }
        ...
        if (aSN1Primitive instanceof ASN1Set) {
            ...
            if (aSN1Primitive instanceof BERSet) {
                ...
                str3 = aSN1Primitive instanceof DERSet ? "DER Set" : "Set";
            }
            ...
            while (true) {
                ...
                while (objects2.hasMoreElements()) {
                    ...
                    if (objNextElement2 == null) {
                        ...
                        _dumpAsString(str7, z, objNextElement2 instanceof ASN1Primitive ? (ASN1Primitive) objNextElement2 : ((ASN1Encodable) objNextElement2).toASN1Primitive(), stringBuffer);
                    }
                }
                return;
            }
