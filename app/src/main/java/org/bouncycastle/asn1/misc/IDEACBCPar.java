...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f4019iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f4019iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f4019iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f4019iv;
