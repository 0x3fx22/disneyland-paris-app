...
public class CBZip2OutputStream extends OutputStream implements BZip2Constants {
    ...
    private void qSort3(int i, int i2, int i3) {
        ...
        stackElem.f3999ll = i;
        stackElem.f3998hh = i2;
        stackElem.f3997dd = i3;
        int i5 = 1;
        while (i5 > 0) {
            if (i5 >= 1000) {
                panic();
            ...
            int i7 = stackElem2.f3999ll;
            int i8 = stackElem2.f3998hh;
            int i9 = stackElem2.f3997dd;
            if (i8 - i7 < 20 || i9 > 10) {
                simpleSort(i7, i8, i9);
                if (this.workDone > this.workLimit && this.firstAttempt) {
                    return;
                ...
                if (i13 < i11) {
                    ...
                    stackElem3.f3999ll = i7;
                    stackElem3.f3998hh = i8;
                    stackElem3.f3997dd = i9 + 1;
                } else {
                    int i19 = i11 - i7;
                    int i20 = i10 - i11;
                    if (i19 >= i20) {
                    ...
                    stackElem4.f3999ll = i7;
                    stackElem4.f3998hh = i23 - 1;
                    stackElem4.f3997dd = i9;
                    StackElem stackElem5 = stackElemArr[i5];
                    stackElem5.f3999ll = i23;
                    stackElem5.f3998hh = i24;
                    stackElem5.f3997dd = i9 + 1;
                    StackElem stackElem6 = stackElemArr[i5 + 1];
                    stackElem6.f3999ll = i24 + 1;
                    stackElem6.f3998hh = i8;
                    stackElem6.f3997dd = i9;
                    i5 += 2;
                }
            }
        }
    ...
    private void sendMTFValues() throws IOException {
        ...
        while (i10 > 0) {
            ...
            int i12 = 0;
            int i13 = i9 - 1;
            while (i12 < i11 && i13 < i4 + 1) {
                i13++;
                i12 += this.mtfFreq[i13];
            }
            if (i13 > i9 && i10 != i && i10 != 1 && (i - i10) % 2 == 1) {
                i12 -= this.mtfFreq[i13];
                i13--;
            }
        ...
        while (true) {
            ...
            for (int i19 = s; i19 < i; i19++) {
                for (int i20 = s; i20 < i5; i20++) {
                    iArr[i19][i20] = s;
                }
            }
            int i21 = s;
            ...
            for (int i31 = s; i31 < i; i31++) {
                hbMakeCodeLengths(cArr[i31], iArr[i31], i5, i17);
            }
            i15++;
        }
        if (i >= 8) {
