...
public class JcaEACSignerBuilder {
    ...
    private class SignatureOutputStream extends OutputStream {
        ...
        public void write(int i) throws OperatorStreamException {
            try {
        ...
        @Override // java.io.OutputStream
        public void write(byte[] bArr) throws OperatorStreamException {
            try {
        ...
        @Override // java.io.OutputStream
        public void write(byte[] bArr, int i, int i2) throws OperatorStreamException {
            try {
            ...
            return new EACSigner() { // from class: org.bouncycastle.eac.operator.jcajce.JcaEACSignerBuilder.1
                ...
                public byte[] getSignature() {
                    try {
                        ...
                        return aSN1ObjectIdentifier.m1988on(EACObjectIdentifiers.id_TA_ECDSA) ? JcaEACSignerBuilder.reencode(signature2) : signature2;
                    } catch (SignatureException e) {
