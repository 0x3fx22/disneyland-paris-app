...
public class VMPCMac implements Mac {
    ...
    private byte f4477x1;

    /* JADX INFO: renamed from: x2 */
    private byte f4478x2;

    /* JADX INFO: renamed from: x3 */
    private byte f4479x3;

    /* JADX INFO: renamed from: x4 */
    private byte f4480x4;

    /* JADX INFO: renamed from: n */
    private byte f4475n = 0;

    /* JADX INFO: renamed from: P */
    private byte[] f4472P = null;

    /* JADX INFO: renamed from: s */
    private byte f4476s = 0;

    private void initKey(byte[] bArr, byte[] bArr2) {
        this.f4476s = (byte) 0;
        this.f4472P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f4472P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f4472P;
            byte b = this.f4476s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        for (int i2 = 1; i2 < 25; i2++) {
            byte[] bArr2 = this.f4472P;
            byte b = this.f4476s;
            byte b2 = this.f4475n;
            byte b3 = bArr2[(b + bArr2[b2 & 255]) & 255];
            this.f4476s = b3;
            byte b4 = this.f4480x4;
            byte b5 = this.f4479x3;
            byte b6 = bArr2[(b4 + b5 + i2) & 255];
            this.f4480x4 = b6;
            byte b7 = this.f4478x2;
            byte b8 = bArr2[(b5 + b7 + i2) & 255];
            this.f4479x3 = b8;
            byte b9 = this.f4477x1;
            byte b10 = bArr2[(b7 + b9 + i2) & 255];
            this.f4478x2 = b10;
            byte b11 = bArr2[(b9 + b3 + i2) & 255];
            this.f4477x1 = b11;
            byte[] bArr3 = this.f4473T;
            byte b12 = this.f4474g;
            bArr3[b12 & Ascii.f3534US] = (byte) (b11 ^ bArr3[b12 & Ascii.f3534US]);
            bArr3[(b12 + 1) & 31] = (byte) (b10 ^ bArr3[(b12 + 1) & 31]);
            bArr3[(b12 + 2) & 31] = (byte) (b8 ^ bArr3[(b12 + 2) & 31]);
            bArr3[(b12 + 3) & 31] = (byte) (b6 ^ bArr3[(b12 + 3) & 31]);
            this.f4474g = (byte) ((b12 + 4) & 31);
            byte b13 = bArr2[b2 & 255];
            bArr2[b2 & 255] = bArr2[b3 & 255];
            bArr2[b3 & 255] = b13;
            this.f4475n = (byte) ((b2 + 1) & 255);
        }
        for (int i3 = 0; i3 < 768; i3++) {
            byte[] bArr4 = this.f4472P;
            byte b14 = this.f4476s;
            int i4 = i3 & 255;
            byte b15 = bArr4[i4];
            byte b16 = bArr4[(b14 + b15 + this.f4473T[i3 & 31]) & 255];
            this.f4476s = b16;
        ...
        for (int i5 = 0; i5 < 20; i5++) {
            byte[] bArr6 = this.f4472P;
            int i6 = i5 & 255;
            byte b17 = bArr6[(this.f4476s + bArr6[i6]) & 255];
            this.f4476s = b17;
