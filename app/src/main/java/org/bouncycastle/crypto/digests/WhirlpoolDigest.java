...
public final class WhirlpoolDigest implements ExtendedDigest, Memoable {
    ...
    private long[] f4303_K;

    /* JADX INFO: renamed from: _L */
    private long[] f4304_L;
    ...
    public WhirlpoolDigest() {
        ...
        this.f4303_K = new long[8];
        this.f4304_L = new long[8];
        ...
        for (int i = 0; i < 256; i++) {
            ...
            f4295C0[i] = packIntoLong(i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4);
            f4296C1[i] = packIntoLong(i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial);
            f4297C2[i] = packIntoLong(iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3);
            f4298C3[i] = packIntoLong(i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3);
            f4299C4[i] = packIntoLong(iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2);
            f4300C5[i] = packIntoLong(i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2);
            f4301C6[i] = packIntoLong(iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2);
            f4302C7[i] = packIntoLong(i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2);
        }
        this._rc[0] = 0;
        for (int i5 = 1; i5 <= 10; i5++) {
            int i6 = (i5 - 1) * 8;
            this._rc[i5] = (((((((f4295C0[i6] & (-72057594037927936L)) ^ (f4296C1[i6 + 1] & 71776119061217280L)) ^ (f4297C2[i6 + 2] & 280375465082880L)) ^ (f4298C3[i6 + 3] & 1095216660480L)) ^ (f4299C4[i6 + 4] & 4278190080L)) ^ (f4300C5[i6 + 5] & 16711680)) ^ (f4301C6[i6 + 6] & 65280)) ^ (f4302C7[i6 + 7] & 255);
        }
    }
    ...
    protected void processBlock() {
        ...
        while (i2 <= 10) {
            int i3 = 0;
            while (i3 < 8) {
                long[] jArr4 = this.f4304_L;
                jArr4[i3] = 0;
                long[] jArr5 = f4295C0;
                long[] jArr6 = this.f4303_K;
                long j3 = jArr5[((int) (jArr6[i3 & 7] >>> 56)) & 255];
                jArr4[i3] = j3;
                long j4 = f4296C1[((int) (jArr6[(i3 - 1) & 7] >>> 48)) & 255] ^ j3;
                jArr4[i3] = j4;
                long j5 = j4 ^ f4297C2[((int) (jArr6[(i3 - 2) & 7] >>> 40)) & 255];
                jArr4[i3] = j5;
                long j6 = j5 ^ f4298C3[((int) (jArr6[(i3 - 3) & 7] >>> 32)) & 255];
                jArr4[i3] = j6;
                long j7 = j6 ^ f4299C4[((int) (jArr6[(i3 - 4) & 7] >>> 24)) & 255];
                jArr4[i3] = j7;
                long j8 = j7 ^ f4300C5[((int) (jArr6[(i3 - 5) & 7] >>> 16)) & 255];
                jArr4[i3] = j8;
                long j9 = j8 ^ f4301C6[((int) (jArr6[(i3 - 6) & 7] >>> 8)) & 255];
                jArr4[i3] = j9;
                jArr4[i3] = j9 ^ f4302C7[((int) jArr6[(i3 - 7) & 7]) & 255];
                i3++;
                i2 = i2;
            }
            int i4 = i2;
            long[] jArr7 = this.f4304_L;
            long[] jArr8 = this.f4303_K;
            System.arraycopy(jArr7, 0, jArr8, 0, jArr8.length);
            long[] jArr9 = this.f4303_K;
            jArr9[0] = jArr9[0] ^ this._rc[i4];
            int i5 = 0;
            while (true) {
                jArr = this.f4304_L;
                if (i5 < 8) {
                    long j10 = this.f4303_K[i5];
                    jArr[i5] = j10;
                    long[] jArr10 = f4295C0;
                    long[] jArr11 = this._state;
                    long j11 = jArr10[((int) (jArr11[i5 & 7] >>> 56)) & 255] ^ j10;
                    jArr[i5] = j11;
                    long j12 = j11 ^ f4296C1[((int) (jArr11[(i5 - 1) & 7] >>> 48)) & 255];
                    jArr[i5] = j12;
                    long j13 = j12 ^ f4297C2[((int) (jArr11[(i5 - 2) & 7] >>> 40)) & 255];
                    jArr[i5] = j13;
                    long j14 = j13 ^ f4298C3[((int) (jArr11[(i5 - 3) & 7] >>> 32)) & 255];
                    jArr[i5] = j14;
                    long j15 = j14 ^ f4299C4[((int) (jArr11[(i5 - 4) & 7] >>> 24)) & 255];
                    jArr[i5] = j15;
                    long j16 = j15 ^ f4300C5[((int) (jArr11[(i5 - 5) & 7] >>> 16)) & 255];
                    jArr[i5] = j16;
                    long j17 = j16 ^ f4301C6[((int) (jArr11[(i5 - 6) & 7] >>> 8)) & 255];
                    jArr[i5] = j17;
                    jArr[i5] = j17 ^ f4302C7[((int) jArr11[(i5 - 7) & 7]) & 255];
                    i5++;
                }
            }
    ...
    public void reset() {
        ...
        Arrays.fill(this.f4303_K, 0L);
        Arrays.fill(this.f4304_L, 0L);
    ...
    public void reset(Memoable memoable) {
        ...
        long[] jArr5 = whirlpoolDigest.f4303_K;
        long[] jArr6 = this.f4303_K;
        System.arraycopy(jArr5, 0, jArr6, 0, jArr6.length);
        long[] jArr7 = whirlpoolDigest.f4304_L;
        long[] jArr8 = this.f4304_L;
        System.arraycopy(jArr7, 0, jArr8, 0, jArr8.length);
