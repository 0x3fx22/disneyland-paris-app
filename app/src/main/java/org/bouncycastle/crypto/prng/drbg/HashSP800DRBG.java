...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    private byte[] f4606_C;

    /* JADX INFO: renamed from: _V */
    private byte[] f4607_V;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (bArr2 != null) {
            byte[] bArr3 = this.f4607_V;
            byte[] bArr4 = new byte[bArr3.length + 1 + bArr2.length];
            bArr4[0] = 2;
            System.arraycopy(bArr3, 0, bArr4, 1, bArr3.length);
            System.arraycopy(bArr2, 0, bArr4, this.f4607_V.length + 1, bArr2.length);
            addTo(this.f4607_V, hash(bArr4));
        }
        byte[] bArrHashgen = hashgen(this.f4607_V, length);
        byte[] bArr5 = this.f4607_V;
        byte[] bArr6 = new byte[bArr5.length + 1];
        System.arraycopy(bArr5, 0, bArr6, 1, bArr5.length);
        bArr6[0] = 3;
        addTo(this.f4607_V, hash(bArr6));
        addTo(this.f4607_V, this.f4606_C);
        long j = this._reseedCounter;
        addTo(this.f4607_V, new byte[]{(byte) (j >> 24), (byte) (j >> 16), (byte) (j >> 8), (byte) j});
        this._reseedCounter++;
    ...
    public void reseed(byte[] bArr) {
        byte[] bArrHash_df = Utils.hash_df(this._digest, Arrays.concatenate(ONE, this.f4607_V, getEntropy(), bArr), this._seedLength);
        this.f4607_V = bArrHash_df;
        byte[] bArr2 = new byte[bArrHash_df.length + 1];
        bArr2[0] = 0;
        System.arraycopy(bArrHash_df, 0, bArr2, 1, bArrHash_df.length);
        this.f4606_C = Utils.hash_df(this._digest, bArr2, this._seedLength);
        this._reseedCounter = 1L;
    }
}
