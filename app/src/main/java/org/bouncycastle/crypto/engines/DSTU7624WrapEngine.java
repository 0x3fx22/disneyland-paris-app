...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public DSTU7624WrapEngine(int i) {
        ...
        this.f4361B = new byte[dSTU7624Engine.getBlockSize() / 2];
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        ...
        System.arraycopy(bArr, i, bArr2, 0, i2);
        System.arraycopy(bArr2, 0, this.f4361B, 0, this.engine.getBlockSize() / 2);
        this.Btemp.clear();
        ...
        int i5 = 0;
        while (i5 < i4) {
            System.arraycopy(this.f4361B, 0, bArr2, 0, this.engine.getBlockSize() / 2);
            ...
            System.arraycopy(bArr2, this.engine.getBlockSize() / 2, this.f4361B, 0, this.engine.getBlockSize() / 2);
            for (int i7 = 2; i7 < blockSize; i7++) {
