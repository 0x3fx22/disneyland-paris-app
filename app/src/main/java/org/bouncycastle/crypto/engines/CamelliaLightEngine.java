...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, CBORConstants.BYTE_ARRAY_2_ELEMENTS, 44, -20, -77, 39, -64, -27, -28, -123, 87, 53, -22, Ascii.f3524FF, -82, 65, 35, -17, 107, -109, 69, Ascii.f3523EM, -91, 33, -19, Ascii.f3532SO, 79, 78, Ascii.f3526GS, 101, -110, -67, -122, -72, -81, -113, 124, -21, Ascii.f3534US, -50, 62, 48, -36, 95, 94, CBORConstants.BYTE_TAG_BIGFLOAT, Ascii.f3535VT, Ascii.SUB, -90, -31, 57, -54, -43, 71, 93, Base64.padSymbol, -39, 1, 90, -42, 81, 86, 108, 77, -117, Ascii.f3522CR, -102, 102, -5, -52, -80, 45, 116, Ascii.DC2, 43, 32, -16, -79, -124, -103, -33, 76, -53, CBORConstants.BYTE_TAG_BIGNUM_POS, 52, 126, 118, 5, 109, -73, -87, 49, -47, Ascii.ETB, 4, -41, Ascii.DC4, 88, 58, 97, -34, Ascii.ESC, 17, Ascii.f3525FS, 50, Ascii.f3531SI, -100, Ascii.SYN, 83, Ascii.CAN, -14, 34, -2, 68, -49, -78, CBORConstants.BYTE_TAG_BIGNUM_NEG, -75, 122, -111, 36, 8, -24, -88, CBORConstants.BYTE_EMPTY_STRING, -4, 105, 80, -86, -48, -96, 125, -95, -119, 98, -105, 84, 91, Ascii.f3530RS, -107, -32, -1, 100, -46, Ascii.DLE, CBORConstants.BYTE_TAG_DECIMAL_FRACTION, 0, 72, -93, -9, 117, -37, -118, 3, -26, -38, 9, Utf8.REPLACEMENT_BYTE, -35, -108, -121, 92, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, 127, -65, -30, 82, -101, -40, 38, -56, 55, -58, 59, -127, -106, 111, 75, 19, -66, 99, 46, -23, CBORConstants.BYTE_STRING_2BYTE_LEN, -89, -116, CBORConstants.BYTE_ARRAY_INDEFINITE, 110, PSSSigner.TRAILER_IMPLICIT, -114, 41, CBORConstants.BYTE_TRUE, -7, -74, 47, -3, -76, 89, CBORConstants.BYTE_STRING_1BYTE_LEN, -104, 6, 106, -25, 70, 113, -70, -44, 37, -85, 66, -120, -94, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, 54, 73, 42, 104, 60, 56, -15, -92, 64, 40, -45, 123, -69, -55, 67, -63, Ascii.NAK, -29, -83, CBORConstants.BYTE_FALSE, 119, -57, -128, -98};
    private int[] subkey = new int[96];

    /* JADX INFO: renamed from: kw */
    private int[] f4347kw = new int[8];

    /* JADX INFO: renamed from: ke */
    private int[] f4346ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f4346ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyis128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f4346ke, 4);
                ...
                roldq(15, iArr2, 0, this.f4346ke, 0);
                ...
                roldq(17, iArr2, 0, this.f4347kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f4346ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f4346ke, 4);
            ...
            roldq(17, iArr2, 0, this.f4347kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f4347kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f4347kw, 0);
    }
