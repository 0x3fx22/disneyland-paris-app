...
public class VMPCEngine implements StreamCipher {
    ...
    protected byte f4415n = 0;

    /* JADX INFO: renamed from: P */
    protected byte[] f4414P = null;

    /* JADX INFO: renamed from: s */
    protected byte f4416s = 0;
    ...
    protected void initKey(byte[] bArr, byte[] bArr2) {
        this.f4416s = (byte) 0;
        this.f4414P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f4414P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f4414P;
            byte b = this.f4416s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];
