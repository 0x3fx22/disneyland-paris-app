...
public class RC564Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            jBytesToWord2 = rotateRight(jBytesToWord2 - this.f4384_S[i4 + 1], jBytesToWord) ^ jBytesToWord;
            jBytesToWord = rotateRight(jBytesToWord - this.f4384_S[i4], jBytesToWord2) ^ jBytesToWord2;
        }
        wordToBytes(jBytesToWord - this.f4384_S[0], bArr2, i2);
        wordToBytes(jBytesToWord2 - this.f4384_S[1], bArr2, i2 + 8);
        return 16;
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        long jBytesToWord = bytesToWord(bArr, i) + this.f4384_S[0];
        long jBytesToWord2 = bytesToWord(bArr, i + 8) + this.f4384_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            jBytesToWord = rotateLeft(jBytesToWord ^ jBytesToWord2, jBytesToWord2) + this.f4384_S[i4];
            jBytesToWord2 = rotateLeft(jBytesToWord2 ^ jBytesToWord, jBytesToWord) + this.f4384_S[i4 + 1];
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int i5 = 0; i5 < length2; i5++) {
            ...
            length3 = (length3 + 1) % this.f4384_S.length;
            i4 = (i4 + 1) % length;
        }
    }
