...
public class CramerShoupCiphertext {
    ...
    public CramerShoupCiphertext(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        this.f4349u1 = bigInteger;
        this.f4350u2 = bigInteger2;
        this.f4348e = bigInteger3;
        this.f4351v = bigInteger4;
    }

    public CramerShoupCiphertext(byte[] bArr) {
        int iBigEndianToInt = Pack.bigEndianToInt(bArr, 0);
        int i = 4 + iBigEndianToInt;
        this.f4349u1 = new BigInteger(Arrays.copyOfRange(bArr, 4, i));
        int i2 = iBigEndianToInt + 8;
        int iBigEndianToInt2 = Pack.bigEndianToInt(bArr, i) + i2;
        this.f4350u2 = new BigInteger(Arrays.copyOfRange(bArr, i2, iBigEndianToInt2));
        int iBigEndianToInt3 = Pack.bigEndianToInt(bArr, iBigEndianToInt2);
        int i3 = iBigEndianToInt2 + 4;
        int i4 = iBigEndianToInt3 + i3;
        this.f4348e = new BigInteger(Arrays.copyOfRange(bArr, i3, i4));
        int iBigEndianToInt4 = Pack.bigEndianToInt(bArr, i4);
        int i5 = i4 + 4;
        this.f4351v = new BigInteger(Arrays.copyOfRange(bArr, i5, iBigEndianToInt4 + i5));
    }
    ...
    public void setU2(BigInteger bigInteger) {
        this.f4350u2 = bigInteger;
    }

    public void setV(BigInteger bigInteger) {
        this.f4351v = bigInteger;
    }

    public byte[] toByteArray() {
        byte[] byteArray = this.f4349u1.toByteArray();
        int length = byteArray.length;
        byte[] byteArray2 = this.f4350u2.toByteArray();
        int length2 = byteArray2.length;
        byte[] byteArray3 = this.f4348e.toByteArray();
        int length3 = byteArray3.length;
        byte[] byteArray4 = this.f4351v.toByteArray();
    ...
    public String toString() {
        ...
        stringBuffer.append("u1: " + this.f4349u1.toString());
        stringBuffer.append("\nu2: " + this.f4350u2.toString());
        stringBuffer.append("\ne: " + this.f4348e.toString());
        stringBuffer.append("\nv: " + this.f4351v.toString());
