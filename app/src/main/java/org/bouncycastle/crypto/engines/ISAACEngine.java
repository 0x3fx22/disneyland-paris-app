    ...
    private void isaac() {
        ...
        for (int i5 = 0; i5 < 256; i5++) {
            ...
            if (i7 == 0) {
                ...
                int i8 = this.f4375a + iArr[(i5 + 128) & 255];
                this.f4375a = i8;
                int i9 = iArr[(i6 >>> 2) & 255] + i8 + this.f4376b;
                iArr[i5] = i9;
            ...
            this.f4375a = i ^ i2;
            int i11 = this.f4375a + iArr[(i5 + 128) & 255];
            this.f4375a = i11;
            int i12 = iArr[(i6 >>> 2) & 255] + i11 + this.f4376b;
            iArr[i5] = i12;
            int[] iArr3 = this.results;
            int i13 = iArr[(i12 >>> 10) & 255] + i6;
            this.f4376b = i13;
            iArr3[i5] = i13;
        }
    }
