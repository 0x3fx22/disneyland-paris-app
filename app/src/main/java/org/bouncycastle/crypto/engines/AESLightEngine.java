...
public class AESLightEngine implements BlockCipher {
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[i2];
        int i3 = i ^ iArr2[0];
        int i4 = this.f4326C1 ^ iArr2[1];
        int i5 = this.f4327C2 ^ iArr2[2];
        int i6 = i2 - 1;
        int iInv_mcol = iArr2[3] ^ this.f4328C3;
        while (true) {
            byte[] bArr = f4324Si;
            int i7 = i3 & 255;
            if (i6 <= 1) {
                ...
                int[] iArr3 = iArr[0];
                this.f4325C0 = i8 ^ iArr3[0];
                this.f4326C1 = ((((bArr[iInv_mcol3 & 255] & 255) ^ ((bArr[(iInv_mcol2 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iInv_mcol5 >> 16) & 255] & 255) << 16)) ^ (bArr[(iInv_mcol4 >> 24) & 255] << Ascii.CAN)) ^ iArr3[1];
                this.f4327C2 = ((((bArr[iInv_mcol4 & 255] & 255) ^ ((bArr[(iInv_mcol3 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iInv_mcol2 >> 16) & 255] & 255) << 16)) ^ (bArr[(iInv_mcol5 >> 24) & 255] << Ascii.CAN)) ^ iArr3[2];
                this.f4328C3 = ((((bArr[iInv_mcol5 & 255] & 255) ^ ((bArr[(iInv_mcol4 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iInv_mcol3 >> 16) & 255] & 255) << 16)) ^ (bArr[(iInv_mcol2 >> 24) & 255] << Ascii.CAN)) ^ iArr3[3];
                return;
            }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[0];
        int i2 = i ^ iArr2[0];
        int i3 = this.f4326C1 ^ iArr2[1];
        int i4 = this.f4327C2 ^ iArr2[2];
        int iMcol = iArr2[3] ^ this.f4328C3;
        int i5 = 1;
        ...
        int[] iArr3 = iArr[i5 + 1];
        this.f4325C0 = iArr3[0] ^ i8;
        this.f4326C1 = ((((bArr2[iMcol10 & 255] & 255) ^ ((bArr2[(iMcol11 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol12 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol9 >> 24) & 255] << Ascii.CAN)) ^ iArr3[1];
        this.f4327C2 = ((((bArr2[iMcol11 & 255] & 255) ^ ((bArr2[(iMcol12 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol10 >> 24) & 255] << Ascii.CAN)) ^ iArr3[2];
        this.f4328C3 = ((((bArr2[iMcol12 & 255] & 255) ^ ((bArr2[(iMcol9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol10 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol11 >> 24) & 255] << Ascii.CAN)) ^ iArr3[3];
    }
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.f4325C0 = i4;
        this.f4325C0 = i4 | (bArr[i + 3] << Ascii.CAN);
        int i5 = bArr[i + 4] & 255;
        this.f4326C1 = i5;
        ...
        this.f4326C1 = i7;
        this.f4326C1 = i7 | (bArr[i + 7] << Ascii.CAN);
        int i8 = bArr[i + 8] & 255;
        this.f4327C2 = i8;
        ...
        this.f4327C2 = i10;
        this.f4327C2 = i10 | (bArr[i + 11] << Ascii.CAN);
        ...
        this.f4328C3 = i13;
        this.f4328C3 = (bArr[i + 15] << Ascii.CAN) | i13;
    }
