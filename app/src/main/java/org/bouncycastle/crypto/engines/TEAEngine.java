...
public class TEAEngine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i4 = 0; i4 != 32; i4++) {
            iBytesToInt2 -= (((iBytesToInt << 4) + this.f4407_c) ^ (iBytesToInt + i3)) ^ ((iBytesToInt >>> 5) + this.f4408_d);
            iBytesToInt -= (((iBytesToInt2 << 4) + this.f4405_a) ^ (iBytesToInt2 + i3)) ^ ((iBytesToInt2 >>> 5) + this.f4406_b);
            i3 += 1640531527;
        }
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i5 = 0; i5 != 32; i5++) {
            i4 -= 1640531527;
            i3 += (((iBytesToInt2 << 4) + this.f4405_a) ^ (iBytesToInt2 + i4)) ^ ((iBytesToInt2 >>> 5) + this.f4406_b);
            iBytesToInt2 += (((i3 << 4) + this.f4407_c) ^ (i3 + i4)) ^ ((i3 >>> 5) + this.f4408_d);
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        this.f4405_a = bytesToInt(bArr, 0);
        this.f4406_b = bytesToInt(bArr, 4);
        this.f4407_c = bytesToInt(bArr, 8);
        this.f4408_d = bytesToInt(bArr, 12);
    }
