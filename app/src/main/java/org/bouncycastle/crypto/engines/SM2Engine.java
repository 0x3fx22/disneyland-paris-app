...
public class SM2Engine {
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) {
        ...
        return C77401.$SwitchMap$org$bouncycastle$crypto$engines$SM2Engine$Mode[this.mode.ordinal()] != 1 ? Arrays.concatenate(encoded, bArr2, bArr3) : Arrays.concatenate(encoded, bArr3, bArr2);
    }
