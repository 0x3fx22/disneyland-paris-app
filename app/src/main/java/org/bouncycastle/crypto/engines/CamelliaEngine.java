...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f4345kw = new int[8];

    /* JADX INFO: renamed from: ke */
    private int[] f4344ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f4344ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f4344ke, 4);
                ...
                roldq(15, iArr2, 0, this.f4344ke, 0);
                ...
                roldq(17, iArr2, 0, this.f4345kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f4344ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f4344ke, 4);
            ...
            roldq(17, iArr2, 0, this.f4345kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f4345kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f4345kw, 0);
    }
