...
public class RC532Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            iBytesToWord2 = rotateRight(iBytesToWord2 - this.f4383_S[i4 + 1], iBytesToWord) ^ iBytesToWord;
            iBytesToWord = rotateRight(iBytesToWord - this.f4383_S[i4], iBytesToWord2) ^ iBytesToWord2;
        }
        wordToBytes(iBytesToWord - this.f4383_S[0], bArr2, i2);
        wordToBytes(iBytesToWord2 - this.f4383_S[1], bArr2, i2 + 4);
        return 8;
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int iBytesToWord = bytesToWord(bArr, i) + this.f4383_S[0];
        int iBytesToWord2 = bytesToWord(bArr, i + 4) + this.f4383_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            iBytesToWord = rotateLeft(iBytesToWord ^ iBytesToWord2, iBytesToWord2) + this.f4383_S[i4];
            iBytesToWord2 = rotateLeft(iBytesToWord2 ^ iBytesToWord, iBytesToWord) + this.f4383_S[i4 + 1];
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int i5 = 0; i5 < length2; i5++) {
            ...
            length3 = (length3 + 1) % this.f4383_S.length;
            i4 = (i4 + 1) % length;
        }
    }
