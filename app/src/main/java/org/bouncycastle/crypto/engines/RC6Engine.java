...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i4 >= 1) {
            ...
            int i5 = i4 * 2;
            int iRotateRight2 = rotateRight(iBytesToWord2 - this.f4385_S[i5 + 1], iRotateLeft) ^ iRotateLeft2;
            i4--;
            int i6 = iRotateRight;
            iRotateRight = rotateRight(iBytesToWord4 - this.f4385_S[i5], iRotateLeft2) ^ iRotateLeft;
            iBytesToWord4 = i3;
            i3 = iRotateRight2;
            iBytesToWord2 = i6;
        }
        int[] iArr2 = this.f4385_S;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i5 <= 20) {
            ...
            int i6 = i5 * 2;
            int iRotateLeft3 = rotateLeft(iBytesToWord ^ iRotateLeft, iRotateLeft2) + this.f4385_S[i6];
            int iRotateLeft4 = rotateLeft(iBytesToWord3 ^ iRotateLeft2, iRotateLeft) + this.f4385_S[i6 + 1];
            i5++;
            iBytesToWord3 = i4;
            i4 = iRotateLeft3;
            iBytesToWord = i3;
    ...
    private void setKey(byte[] bArr) {
        ...
        for (int i4 = 0; i4 < length4; i4++) {
            ...
            length5 = (length5 + 1) % this.f4385_S.length;
            i3 = (i3 + 1) % length2;
        }
    }
