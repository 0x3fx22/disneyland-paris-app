...
public class DESedeWrapEngine implements Wrapper {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof KeyParameter) {
            ...
            if (this.forWrapping) {
                ...
                this.paramPlusIV = new ParametersWithIV(this.param, this.f4352iv);
                return;
            }
            return;
        }
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f4352iv = parametersWithIV.getIV();
            this.param = (KeyParameter) this.paramPlusIV.getParameters();
            if (!this.forWrapping) {
                throw new IllegalArgumentException("You should not supply an IV for unwrapping");
            }
            byte[] bArr2 = this.f4352iv;
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f4352iv);
        this.paramPlusIV = parametersWithIV;
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        ...
        byte[] bArr5 = this.f4352iv;
        byte[] bArr6 = new byte[bArr5.length + length];
        System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
        System.arraycopy(bArr4, 0, bArr6, this.f4352iv.length, length);
