...
public class SkipjackEngine implements BlockCipher {
    ...
    private int m2079g(int i, int i2) {
        int i3 = (i2 >> 8) & 255;
        int i4 = i2 & 255;
        short[] sArr = ftable;
    ...
    private int m2080h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            int i9 = 0;
            while (i9 < 8) {
                int iM2080h = m2080h(i7, i4);
                int i10 = (i5 ^ iM2080h) ^ (i7 + 1);
                i7--;
                i9++;
                int i11 = i6;
                i6 = i3;
