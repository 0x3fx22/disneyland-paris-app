...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    private BigInteger f4546y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f4546y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f4546y) && super.equals(obj);
    }
    ...
    @Override // org.bouncycastle.crypto.params.DHKeyParameters
    public int hashCode() {
        return super.hashCode() ^ this.f4546y.hashCode();
    }
}
