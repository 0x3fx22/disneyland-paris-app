...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((bArrProcessBlock[bArrProcessBlock.length - 1] & Ascii.f3531SI) ^ 12) != 0) {
            throw new InvalidCipherTextException("malformed signature");
        }
        ...
        int i3 = 0;
        while (i3 != bArrProcessBlock.length && ((bArrProcessBlock[i3] & Ascii.f3531SI) ^ 10) != 0) {
            i3++;
        }
        int i4 = i3 + 1;
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (((bArrProcessBlock[0] & 192) ^ 64) == 0 && ((bArrProcessBlock[bArrProcessBlock.length - 1] & Ascii.f3531SI) ^ 12) == 0) {
            if (((bArrProcessBlock[bArrProcessBlock.length - 1] & 255) ^ 188) == 0) {
                i = 1;
            } else {
                i = 2;
