...
public class ISO9796d1Encoding implements AsymmetricBlockCipher {
    ...
    private static byte[] shadows = {Ascii.f3532SO, 3, 5, 8, 9, 4, 2, Ascii.f3531SI, 0, Ascii.f3522CR, Ascii.f3535VT, 6, 7, 10, Ascii.f3524FF, 1};
    private static byte[] inverse = {8, Ascii.f3531SI, 6, 1, 5, 2, Ascii.f3535VT, Ascii.f3524FF, 3, 4, Ascii.f3522CR, 10, Ascii.f3532SO, 9, 0, 7};
    ...
    private byte[] decodeBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if ((bArrConvertOutputDecryptOnly[bArrConvertOutputDecryptOnly.length - 1] & Ascii.f3531SI) != 6) {
        ...
        byte b2 = (byte) (bArr2[b & Ascii.f3531SI] | (bArr2[(b & 255) >>> 4] << 4));
        ...
        for (int length = bArrConvertOutputDecryptOnly.length - 1; length >= bArrConvertOutputDecryptOnly.length - (i3 * 2); length -= 2) {
            ...
            int i6 = bArr3[b3 & Ascii.f3531SI] | (bArr3[(b3 & 255) >>> 4] << 4);
            int i7 = length - 1;
    ...
    private byte[] encodeBlock(byte[] bArr, int i, int i2) {
        ...
        for (int i10 = i4 - (i7 * 2); i10 != i4; i10 += 2) {
            ...
            byte[] bArr3 = shadows;
            bArr2[i10] = (byte) (bArr3[b & Ascii.f3531SI] | (bArr3[(b & 255) >>> 4] << 4));
            bArr2[i10 + 1] = b;
        }
        int i11 = i4 - (i2 * 2);
