...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    public KDFDoublePipelineIterationBytesGenerator(Mac mac) {
        ...
        this.f4434h = macSize;
        this.f4433a = new byte[macSize];
        this.f4435k = new byte[macSize];
    }
    ...
    private void generateNext() {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f4433a, 0);
        } else {
            Mac mac2 = this.prf;
        ...
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f4434h) + 1;
            byte[] bArr4 = this.ios;
        ...
        this.prf.doFinal(this.f4435k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f4435k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f4434h, i8);
            System.arraycopy(this.f4435k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f4434h));
