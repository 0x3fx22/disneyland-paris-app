...
public class Poly1305KeyGenerator extends CipherKeyGenerator {
    public static void checkKey(byte[] bArr) {
        ...
        checkMask(bArr[3], Ascii.f3531SI);
        checkMask(bArr[7], Ascii.f3531SI);
        checkMask(bArr[11], Ascii.f3531SI);
        checkMask(bArr[15], Ascii.f3531SI);
    ...
    public static void clamp(byte[] bArr) {
        ...
        bArr[3] = (byte) (bArr[3] & Ascii.f3531SI);
        bArr[7] = (byte) (bArr[7] & Ascii.f3531SI);
        bArr[11] = (byte) (bArr[11] & Ascii.f3531SI);
        bArr[15] = (byte) (bArr[15] & Ascii.f3531SI);
