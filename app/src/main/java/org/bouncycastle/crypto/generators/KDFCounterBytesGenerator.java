...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f4431h = macSize;
        this.f4432k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f4431h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f4432k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f4432k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f4431h, i8);
            System.arraycopy(this.f4432k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f4431h));
