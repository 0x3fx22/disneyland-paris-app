...
public class RSAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        while (!z) {
            ...
            do {
                bigIntegerChooseRandomPrime = this.chooseRandomPrime(i, publicExponent, bigIntegerShiftLeft);
                while (true) {
                    bigIntegerChooseRandomPrime2 = this.chooseRandomPrime(i2, publicExponent, bigIntegerShiftLeft);
