...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    private byte[] f4507FR;
    private byte[] FRE;

    /* JADX INFO: renamed from: IV */
    private byte[] f4508IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f4508IV = new byte[blockSize];
        this.f4507FR = new byte[blockSize];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (i7 > i6) {
            ...
            byte b2 = bArr[i + 1];
            byte[] bArr3 = this.f4507FR;
            int i10 = this.blockSize;
            bArr3[i10 - 1] = b2;
            bArr2[i2 + 1] = encryptByte(b2, i10 - 1);
            this.cipher.processBlock(this.f4507FR, 0, this.FRE, 0);
        ...
        if (i5 > i4) {
            ...
            if (i5 != 0) {
                if (i5 == i4) {
                    ...
                    byte[] bArr6 = this.f4507FR;
                    System.arraycopy(bArr6, 2, bArr6, 0, this.blockSize - 2);
                    System.arraycopy(bArr2, i2, this.f4507FR, this.blockSize - 2, 2);
                    this.cipher.processBlock(this.f4507FR, 0, this.FRE, 0);
                    while (true) {
                        i3 = this.blockSize;
                        if (i6 >= i3) {
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f4508IV;
        byte[] bArr2 = this.f4507FR;
