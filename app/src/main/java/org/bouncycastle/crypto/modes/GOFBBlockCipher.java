...
public class GOFBBlockCipher extends StreamBlockCipher {
    ...
    public GOFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f4497IV = new byte[blockCipher.getBlockSize()];
    ...
    protected byte calculateByte(byte b) {
        if (this.byteCount == 0) {
            if (this.firstStep) {
                ...
                this.f4498N3 = bytesToint(this.ofbOutV, 0);
                this.f4499N4 = bytesToint(this.ofbOutV, 4);
            }
            int i = this.f4498N3 + R.attr.cacheColorHint;
            this.f4498N3 = i;
            int i2 = this.f4499N4;
            int i3 = i2 + R.attr.hand_minute;
            this.f4499N4 = i3;
            if (i3 < 16843012 && i3 > 0) {
                this.f4499N4 = i2 + R.attr.format;
            }
            intTobytes(i, this.ofbV, 0);
            intTobytes(this.f4499N4, this.ofbV, 4);
            this.cipher.processBlock(this.ofbV, 0, this.ofbOutV, 0);
        }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f4497IV;
            if (length < bArr.length) {
                System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
                int i = 0;
                while (true) {
                    byte[] bArr2 = this.f4497IV;
