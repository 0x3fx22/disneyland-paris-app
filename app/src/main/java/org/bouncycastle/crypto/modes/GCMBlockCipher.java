...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f4496S, 0, 16);
        }
    }
    ...
    private void processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            gHASHBlock(this.f4496S, bArr3);
            System.arraycopy(bArr3, 0, bArr2, i2, 16);
        } else {
            gHASHBlock(this.f4496S, bArr, i);
    ...
    private void processPartial(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.forEncryption) {
            ...
            gHASHPartial(this.f4496S, bArr, i, i2);
        } else {
            gHASHPartial(this.f4496S, bArr, i, i2);
            GCMUtil.xor(bArr, i, bArr3, 0, i2);
        }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0L;
        this.atLengthPre = 0L;
        this.counter = Arrays.clone(this.f4495J0);
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                basicGCMExponentiator.init(this.f4494H);
            }
            this.exp.exponentiateX(j3, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f4496S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        ...
        this.cipher.processBlock(this.f4495J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f4496S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (key != null) {
            ...
            this.multiplier.init(this.f4494H);
            this.exp = null;
