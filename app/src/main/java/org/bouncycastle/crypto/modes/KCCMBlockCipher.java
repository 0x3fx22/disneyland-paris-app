...
public class KCCMBlockCipher implements AEADBlockCipher {
    ...
    public KCCMBlockCipher(BlockCipher blockCipher, int i) {
        ...
        this.f4500G1 = new byte[blockCipher.getBlockSize()];
        this.buffer = new byte[blockCipher.getBlockSize()];
        this.f4501s = new byte[blockCipher.getBlockSize()];
    ...
    private void ProcessBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        while (true) {
            ...
            byte[] bArr4 = this.f4501s;
            bArr4[i4] = (byte) (bArr4[i4] + bArr3[i4]);
            i4++;
        }
        this.engine.processBlock(this.f4501s, 0, this.buffer, 0);
    ...
    private void processAAD(byte[] bArr, int i, int i2, int i3) {
        ...
        System.arraycopy(bArr2, 0, this.f4500G1, 0, (bArr2.length - this.Nb_) - 1);
        intToBytes(i3, this.buffer, 0);
        System.arraycopy(this.buffer, 0, this.f4500G1, (this.nonce.length - this.Nb_) - 1, 4);
        byte[] bArr3 = this.f4500G1;
        bArr3[bArr3.length - 1] = getFlag(true, this.macSize);
        this.engine.processBlock(this.f4500G1, 0, this.macBlock, 0);
    ...
    public int processPacket(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws InvalidCipherTextException, IllegalStateException, IOException {
        ...
        if (!this.forEncryption) {
            ...
            this.engine.processBlock(this.nonce, 0, this.f4501s, 0);
    ...
    public void reset() throws IOException {
        Arrays.fill(this.f4500G1, (byte) 0);
