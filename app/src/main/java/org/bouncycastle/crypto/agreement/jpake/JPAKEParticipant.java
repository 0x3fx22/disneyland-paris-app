...
public class JPAKEParticipant {
    ...
    private BigInteger f4130b;
    private final Digest digest;

    /* JADX INFO: renamed from: g */
    private final BigInteger f4131g;
    ...
    private final BigInteger f4132p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* JADX INFO: renamed from: q */
    private final BigInteger f4133q;
    private final SecureRandom random;
    private int state;

    /* JADX INFO: renamed from: x1 */
    private BigInteger f4134x1;

    /* JADX INFO: renamed from: x2 */
    private BigInteger f4135x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f4132p = jPAKEPrimeOrderGroup.getP();
        this.f4133q = jPAKEPrimeOrderGroup.getQ();
        this.f4131g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f4132p, this.f4133q, this.gx4, this.f4135x2, bigIntegerCalculateS, this.f4130b);
        this.f4134x1 = null;
        this.f4135x2 = null;
        this.f4130b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f4134x1 = JPAKEUtil.generateX1(this.f4133q, this.random);
        this.f4135x2 = JPAKEUtil.generateX2(this.f4133q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f4132p, this.f4131g, this.f4134x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f4132p, this.f4131g, this.f4135x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f4132p, this.f4133q, this.f4131g, this.gx1, this.f4134x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f4132p, this.f4133q, this.f4131g, this.gx2, this.f4135x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f4132p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f4133q, this.f4135x2, JPAKEUtil.calculateS(this.password));
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f4132p, this.f4133q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f4132p, this.f4133q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f4132p, this.f4133q, this.f4131g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f4132p, this.f4133q, this.f4131g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f4132p, this.gx3, this.gx1, this.gx2);
        this.f4130b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f4132p, this.f4133q, bigIntegerCalculateGA, this.f4130b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
