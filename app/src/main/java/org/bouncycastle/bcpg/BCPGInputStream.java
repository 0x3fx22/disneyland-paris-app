...
public class BCPGInputStream extends InputStream implements PacketTags {
    ...
    private static class PartialInputStream extends InputStream {
        ...
        private int loadDataLength() throws IOException {
            ...
            if (i >= 192) {
                if (i <= 223) {
                    i = ((i - 192) << 8) + this.f4092in.read() + 192;
                } else if (i == 255) {
                    i = (this.f4092in.read() << 24) | (this.f4092in.read() << 16) | (this.f4092in.read() << 8) | this.f4092in.read();
                } else {
                    this.partial = true;
                    i = 1 << (i & 31);
                }
        ...
        public int available() throws IOException {
            int iAvailable = this.f4092in.available();
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            do {
                ...
                if (i3 != 0) {
                    ...
                    int i4 = this.f4092in.read(bArr, i, i2);
                    if (i4 < 0) {
                        throw new EOFException("premature end of stream in PartialInputStream");
                    }
                    this.dataLength -= i4;
    ...
    public BCPGInputStream(InputStream inputStream) {
        this.f4091in = inputStream;
    }

    @Override // java.io.InputStream
    public int available() throws IOException {
        return this.f4091in.available();
    }
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (!this.next) {
            return this.f4091in.read(bArr, i, i2);
        }
        int i3 = this.nextB;
        if (i3 < 0) {
            return -1;
    ...
    public Packet readPacket() throws IOException {
        ...
        if ((i5 & 64) != 0) {
            ...
            if (i2 < 192) {
                ...
                i2 = ((i2 - 192) << 8) + this.f4091in.read() + 192;
                z = false;
            } else if (i2 == 255) {
                i3 = (this.f4091in.read() << 24) | (this.f4091in.read() << 16) | (this.f4091in.read() << 8);
                i4 = this.f4091in.read();
                i2 = i3 | i4;
                z = false;
            } else {
                i2 = 1 << (i2 & 31);
