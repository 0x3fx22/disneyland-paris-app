...
public class SignatureSubpacketInputStream extends InputStream implements SignatureSubpacketTags {
    ...
    private final InputStream f4114in;
    ...
    public int available() throws IOException {
        return this.f4114in.available();
    }

    @Override // java.io.InputStream
    public int read() throws IOException {
        return this.f4114in.read();
    }
    ...
    public SignatureSubpacket readPacket() throws IOException {
        ...
        if (i < 192) {
            ...
            i = ((i - 192) << 8) + this.f4114in.read() + 192;
            z = false;
        } else {
            if (i != 255) {
                throw new IOException("unexpected length header");
            }
            i = (this.f4114in.read() << 24) | (this.f4114in.read() << 16) | (this.f4114in.read() << 8) | this.f4114in.read();
            z = true;
        }
        int i2 = this.f4114in.read();
        if (i2 < 0) {
        ...
        int fully = Streams.readFully(this.f4114in, bArrCheckData);
        boolean z2 = (i2 & 128) != 0;
        int i4 = i2 & 127;
        if (fully != i3) {
            if (i4 == 2) {
