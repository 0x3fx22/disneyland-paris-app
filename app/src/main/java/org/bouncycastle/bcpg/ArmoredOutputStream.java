...
public class ArmoredOutputStream extends OutputStream {
    ...
    public ArmoredOutputStream(OutputStream outputStream) {
        ...
        this.newLine = false;
        this.f4090nl = Strings.lineSeparator();
        ...
        if (this.f4090nl == null) {
            this.f4090nl = IOUtils.LINE_SEPARATOR_WINDOWS;
        }
    ...
    private void writeHeaderEntry(String str, String str2) throws IOException {
        ...
        for (int i3 = 0; i3 != this.f4090nl.length(); i3++) {
            this.out.write(this.f4090nl.charAt(i3));
        }
    }
    ...
    public void beginClearText(int i) throws IOException {
        ...
        String str2 = "-----BEGIN PGP SIGNED MESSAGE-----" + this.f4090nl;
        String str3 = "Hash: " + str + this.f4090nl + this.f4090nl;
        for (int i2 = 0; i2 != str2.length(); i2++) {
            this.out.write(str2.charAt(i2));
        }
    ...
    public void close() throws IOException {
        if (this.type != null) {
            ...
            for (int i = 0; i != this.f4090nl.length(); i++) {
                this.out.write(this.f4090nl.charAt(i));
            }
            this.out.write(61);
            ...
            for (int i2 = 0; i2 != this.f4090nl.length(); i2++) {
                this.out.write(this.f4090nl.charAt(i2));
            }
            ...
            for (int i6 = 0; i6 != this.f4090nl.length(); i6++) {
                this.out.write(this.f4090nl.charAt(i6));
            }
            this.out.flush();
            this.type = null;
            this.start = true;
    ...
    public void write(int i) throws IOException {
        ...
        if (this.start) {
            ...
            if (i2 == 2) {
                ...
                str = i2 != 6 ? "MESSAGE" : "PUBLIC KEY BLOCK";
            } else {
            ...
            while (enumerationKeys.hasMoreElements()) {
                ...
                if (!str2.equals("Version")) {
                    Iterator it = ((ArrayList) this.headers.get(str2)).iterator();
                    while (it.hasNext()) {
                        writeHeaderEntry(str2, it.next().toString());
                    }
                }
            }
            for (int i7 = 0; i7 != this.f4090nl.length(); i7++) {
                this.out.write(this.f4090nl.charAt(i7));
            }
            this.start = false;
        }
        int i8 = this.bufPtr;
        if (i8 == 3) {
            ...
            this.chunkCount = i9;
            if ((i9 & 15) == 0) {
                for (int i10 = 0; i10 != this.f4090nl.length(); i10++) {
                    this.out.write(this.f4090nl.charAt(i10));
                }
            }
        }
        this.crc.update(i);
