...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    private CipherParameters adjustParameters(AlgorithmParameterSpec algorithmParameterSpec, CipherParameters cipherParameters) {
        ...
        if (algorithmParameterSpec instanceof IvParameterSpec) {
            ...
            parametersWithSBox = new ParametersWithSBox(cipherParameters, gOST28147ParameterSpec2.getSbox());
            if (gOST28147ParameterSpec2.getIV() != null && this.ivLength != 0) {
                cipherParameters2 = parametersWithSBox;
                cipherParameters2 = parametersWithSBox;
                return new ParametersWithIV(parametersWithSBox, gOST28147ParameterSpec2.getIV());
            }
        }
        cipherParameters2 = parametersWithSBox;
        cipherParameters2 = parametersWithSBox;
    ...
    /* JADX WARN: Code duplicated, block: B:217:0x0414  */
    /* JADX WARN: Code duplicated, block: B:226:0x0435  */
    /* JADX WARN: Code duplicated, block: B:232:0x0452  */
    /* JADX WARN: Code duplicated, block: B:233:0x0454 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:234:0x0456 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:236:0x0459 A[Catch: Exception -> 0x0475, IllegalArgumentException -> 0x0477, TRY_ENTER, TryCatch #3 {IllegalArgumentException -> 0x0477, Exception -> 0x0475, blocks: (B:236:0x0459, B:237:0x0474, B:242:0x0479, B:244:0x0485, B:246:0x048b, B:248:0x048f, B:243:0x0480), top: B:258:0x0450 }] */
    /* JADX WARN: Code duplicated, block: B:243:0x0480 A[Catch: Exception -> 0x0475, IllegalArgumentException -> 0x0477, TryCatch #3 {IllegalArgumentException -> 0x0477, Exception -> 0x0475, blocks: (B:236:0x0459, B:237:0x0474, B:242:0x0479, B:244:0x0485, B:246:0x048b, B:248:0x048f, B:243:0x0480), top: B:258:0x0450 }] */
 ...
 binds: [B:104:0x01fe, B:61:0x0146, B:50:0x00fa, B:34:0x00ac] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Instruction removed from duplicated block: B:236:0x0459, please report this as an issue */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v15, types: [org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher] */
    /* JADX WARN: Type inference failed for: r1v22, types: [org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher] */
    ...
    /* JADX WARN: Type inference failed for: r5v21, types: [org.bouncycastle.crypto.CipherParameters] */
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        try {
            if (!(algorithmParameterSpec instanceof AEADParameterSpec)) {
                if (algorithmParameterSpec instanceof IvParameterSpec) {
                    ...
                    if (cls == null || !cls.isInstance(algorithmParameterSpec)) {
                        ...
                        rC5Parameters = GcmSpecUtil.extractAeadParameters(rC5Parameters instanceof ParametersWithIV ? (KeyParameter) ((ParametersWithIV) rC5Parameters).getParameters() : (KeyParameter) rC5Parameters, algorithmParameterSpec);
                    }
                }
                parametersWithRandom = rC5Parameters;
                if (this.ivLength != 0 && !(rC5Parameters instanceof ParametersWithIV) && !(rC5Parameters instanceof AEADParameters)) {
            ...
            rC5Parameters = new AEADParameters(rC5Parameters instanceof ParametersWithIV ? (KeyParameter) ((ParametersWithIV) rC5Parameters).getParameters() : (KeyParameter) rC5Parameters, aEADParameterSpec.getMacSizeInBits(), aEADParameterSpec.getNonce(), aEADParameterSpec.getAssociatedData());
            if (i == 1) {
                this.cipher.init(true, parametersWithRandom);
            } else {
                if (i != 2) {
        ...
        if (this.ivLength != 0) {
            ...
            if (i != 1) {
                ...
                ParametersWithIV parametersWithIV3 = new ParametersWithIV(rC5Parameters, bArr2);
                ...
                ParametersWithIV parametersWithIV4 = new ParametersWithIV(rC5Parameters, bArr3);
