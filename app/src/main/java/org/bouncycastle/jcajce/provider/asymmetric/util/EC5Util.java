...
import org.bouncycastle.asn1.p172x9.X962Parameters;
...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C7835Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C7835Fp c7835Fp = new ECCurve.C7835Fp(((ECFieldFp) field).getP(), a2, b);
            return customCurves.containsKey(c7835Fp) ? (ECCurve) customCurves.get(c7835Fp) : c7835Fp;
        }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p183ec.ECPoint eCPoint) {
        org.bouncycastle.math.p183ec.ECPoint eCPointNormalize = eCPoint.normalize();
        return new ECPoint(eCPointNormalize.getAffineXCoord().toBigInteger(), eCPointNormalize.getAffineYCoord().toBigInteger());
    }

    public static org.bouncycastle.math.p183ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p183ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p183ec.ECPoint eCPointConvertPoint = convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator());
