...
public class AlgorithmParameterGeneratorSpi extends BaseAlgorithmParameterGeneratorSpi {
    ...
    protected AlgorithmParameters engineGenerateParameters() {
        ...
        try {
            ...
            algorithmParametersCreateParametersInstance.init(new DHParameterSpec(elGamalParametersGenerateParameters.getP(), elGamalParametersGenerateParameters.getG(), this.f4631l));
    ...
    protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        this.f4631l = dHGenParameterSpec.getExponentSize();
        this.random = secureRandom;
    }
}
