...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        return keySpec instanceof java.security.spec.ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((java.security.spec.ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        return keySpec instanceof java.security.spec.ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((java.security.spec.ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
