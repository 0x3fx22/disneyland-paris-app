...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f4635y = new BigInteger(1, bArr);
    ...
    public boolean equals(Object obj) {
        ...
        return this.f4635y.equals(bCGOST3410PublicKey.f4635y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
    }
    ...
    public int hashCode() {
        return this.gost3410Spec.hashCode() ^ this.f4635y.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f4635y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
