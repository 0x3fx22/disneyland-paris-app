...
public class BCElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    private BigInteger f4633y;

    BCElGamalPublicKey(DHPublicKey dHPublicKey) {
        this.f4633y = dHPublicKey.getY();
    ...
    BCElGamalPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f4633y = dHPublicKeySpec.getY();
    ...
    BCElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f4633y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    BCElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f4633y = elGamalPublicKeyParameters.getY();
    ...
    BCElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f4633y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    BCElGamalPublicKey(ElGamalPublicKeySpec elGamalPublicKeySpec) {
        this.f4633y = elGamalPublicKeySpec.getY();
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f4633y)).getEncoded(ASN1Encoding.DER);
        } catch (IOException unused) {
            return null;
        }
    }
