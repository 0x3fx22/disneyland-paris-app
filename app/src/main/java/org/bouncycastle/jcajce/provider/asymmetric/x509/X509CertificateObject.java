...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f4638c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f4638c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f4638c.getSignature())) {
                return false;
            }
        }
