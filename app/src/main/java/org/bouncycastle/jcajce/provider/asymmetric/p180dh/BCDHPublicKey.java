package org.bouncycastle.jcajce.provider.asymmetric.p180dh;
...
import org.bouncycastle.asn1.p172x9.DomainParameters;
import org.bouncycastle.asn1.p172x9.ValidationParams;
import org.bouncycastle.asn1.p172x9.X9ObjectIdentifiers;
...
public class BCDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f4621y;

    BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f4621y = bigInteger;
    ...
    BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f4621y = dHPublicKey.getY();
        DHParameterSpec params = dHPublicKey.getParams();
        this.dhSpec = params;
        if (params instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, ((DHDomainParameterSpec) params).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
        }
    }

    BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f4621y = dHPublicKeySpec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, new DHParameters(dHPublicKeySpec.getP(), dHPublicKeySpec.getG()));
        }
    }
    ...
    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f4621y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(aSN1Sequence)) {
                ...
                if (dHParameter.getL() != null) {
                    ...
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f4621y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
                } else {
                    this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f4621y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
                }
            ...
            if (validationParams != null) {
                this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
            } else {
                this.dhPublicKey = new DHPublicKeyParameters(this.f4621y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
            }
    ...
    BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f4621y = dHPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (!(dHParameterSpec instanceof DHDomainParameterSpec) || ((DHDomainParameterSpec) dHParameterSpec).getQ() == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.f4621y));
        }
    ...
    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f4621y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
