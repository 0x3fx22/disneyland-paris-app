...
class X509CRLObject extends X509CRLImpl {
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f4637c, this.sigAlgName, this.sigAlgParams, this.isIndirect, encoded);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f4637c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f4637c.getSignature())) {
                return false;
            }
        }
