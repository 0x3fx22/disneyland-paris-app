...
public class LocalizedMessage {
    ...
    protected final String f4616id;
    ...
    public String getEntry(String str, Locale locale, TimeZone timeZone) throws MissingEntryException {
        ...
        try {
            ...
            throw new MissingEntryException(str4, str5, str3, locale, classLoader2 != null ? classLoader2 : getClassLoader());
        }
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f4616id);
        stringBuffer.append("\"");
