...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    private short[] f4918b1;

    /* JADX INFO: renamed from: b2 */
    private short[] f4919b2;
    ...
    public boolean equals(Object obj) {
        ...
        boolean zEquals = RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1()) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2()) && RainbowUtil.equals(this.f4918b1, bCRainbowPrivateKey.getB1()) && RainbowUtil.equals(this.f4919b2, bCRainbowPrivateKey.getB2()) && Arrays.equals(this.f4920vi, bCRainbowPrivateKey.getVi());
    ...
    public byte[] getEncoded() {
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.rainbow, DERNull.INSTANCE), new RainbowPrivateKey(this.A1inv, this.f4918b1, this.A2inv, this.f4919b2, this.f4920vi, this.layers)).getEncoded();
    ...
    public int hashCode() {
        int length = (((((((((this.layers.length * 37) + org.bouncycastle.util.Arrays.hashCode(this.A1inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f4918b1)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f4919b2)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f4920vi);
