...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f4882n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f4881k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f4884t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f4882n = mcElieceCCA2PublicKeyParameters.getN();
        this.f4881k = mcElieceCCA2PublicKeyParameters.getK();
        this.f4884t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f4883sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f4883sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f4882n, bArr));
        ...
        byte[] bArrConcatenate = ByteUtils.concatenate(ByteUtils.concatenate(bArr2, Conversions.decode(this.f4882n, this.f4884t, gF2Vector)), encoded);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        int digestSize = this.messDigest.getDigestSize();
        int i = this.f4881k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f4882n, this.f4884t).bitLength() - 1) >> 3;
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f4881k, bArr9), Conversions.encode(this.f4882n, this.f4884t, bArr8)).getEncoded();
