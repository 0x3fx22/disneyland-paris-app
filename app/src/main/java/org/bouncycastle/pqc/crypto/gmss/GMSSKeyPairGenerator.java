...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i5] = new Treehash[i7 - this.f4822K[i5]];
            if (i5 > 0) {
                int i8 = i5 - 1;
                bArr2[i8] = (byte[][]) Array.newInstance((Class<?>) cls, i7, this.mdLength);
                treehashArr2[i8] = new Treehash[this.heightOfTrees[i5] - this.f4822K[i5]];
            }
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f4822K[i], this.digestProvider);
