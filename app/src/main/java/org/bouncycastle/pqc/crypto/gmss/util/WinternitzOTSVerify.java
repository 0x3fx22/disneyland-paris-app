...
public class WinternitzOTSVerify {
    ...
    public byte[] Verify(byte[] bArr, byte[] bArr2) {
        ...
        int i7 = winternitzOTSVerify.f4833w;
        int i8 = (i6 + (i7 - 1)) / i7;
        int log = winternitzOTSVerify.getLog((i8 << i7) + 1);
        int i9 = winternitzOTSVerify.f4833w;
        ...
        if (8 % i9 == 0) {
            ...
            while (i17 < i4) {
                ...
                while (i19 < i13) {
                    ...
                    bArr3[i23] = (byte) (bArr3[i23] >>> winternitzOTSVerify.f4833w);
                    i18++;
                    i19++;
                    i15 = i21;
                    i17 = i23;
            ...
            if (i9 < 8) {
                ...
                while (i34 < i29) {
                    ...
                    int i36 = i5;
                    long j2 = 0;
                    while (i36 < winternitzOTSVerify.f4833w) {
                ...
                int i43 = log;
                int i44 = i30;
                int i45 = winternitzOTSVerify.mdsize % winternitzOTSVerify.f4833w;
                int i46 = 0;
                while (i46 < i45) {
                ...
                while (i49 < i48) {
                    ...
                    int i53 = winternitzOTSVerify.f4833w;
                    j >>>= i53;
                    i47++;
                    i49 += i53;
                    i32 = i51;
                }
                int i54 = (i8 << winternitzOTSVerify.f4833w) - i32;
                int i55 = 0;
                while (i55 < i43) {
                    int i56 = winternitzOTSVerify.mdsize;
                    hashSignatureBlock(bArr2, i47 * i56, i44 - (i54 & i44), bArr4, i47 * i56);
                    int i57 = winternitzOTSVerify.f4833w;
                    i54 >>>= i57;
                    i47++;
                    i55 += i57;
                }
                ...
                if (i9 < 57) {
                    ...
                    while (i60 <= i58) {
                        ...
                        int i64 = i60 % 8;
                        int i65 = i58;
                        int i66 = i60 + winternitzOTSVerify.f4833w;
                        int i67 = (i66 + 7) >>> 3;
                        long j3 = 0;
                        int i68 = 0;
                        while (i63 < i67) {
                    ...
                    int i79 = (i74 << winternitzOTSVerify.f4833w) - i61;
                    int i80 = 0;
                    while (i80 < log) {
                        ...
                        int i83 = winternitzOTSVerify.f4833w;
                        i79 >>>= i83;
                        i62++;
                        i80 += i83;
                    }
