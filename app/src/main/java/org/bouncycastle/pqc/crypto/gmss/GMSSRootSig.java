...
public class GMSSRootSig {
    ...
    private void oneStep() {
        ...
        if (8 % i == 0) {
            ...
            if (i2 == 0) {
                ...
                if (i3 < this.mdsize) {
                    byte[] bArr = this.hash;
                    byte b = bArr[i3];
                    this.test = this.f4830k & b;
                    bArr[i3] = (byte) (b >>> this.f4832w);
                } else {
                    int i4 = this.checksum;
                    this.test = this.f4830k & i4;
                    this.checksum = i4 >>> this.f4832w;
                }
            } else if (i2 > 0) {
        ...
        if (i < 8) {
            ...
            if (i8 == 0) {
                int i9 = this.counter;
                if (i9 % 8 == 0) {
                    int i10 = this.f4829ii;
                    int i11 = this.mdsize;
                    if (i10 < i11) {
                        this.big8 = 0L;
                        if (i9 < ((i11 / i) << 3)) {
                            for (int i12 = 0; i12 < this.f4832w; i12++) {
                                long j2 = this.big8;
                                byte[] bArr6 = this.hash;
                                int i13 = this.f4829ii;
                                this.big8 = j2 ^ ((long) ((bArr6[i13] & 255) << (i12 << 3)));
                                this.f4829ii = i13 + 1;
                            }
                        } else {
                            for (int i14 = 0; i14 < this.mdsize % this.f4832w; i14++) {
                                long j3 = this.big8;
                                byte[] bArr7 = this.hash;
                                int i15 = this.f4829ii;
                ...
                this.test = (int) (this.big8 & ((long) this.f4830k));
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (i8 > 0) {
            ...
            if (j4 == 0) {
                ...
                if (i20 < i21) {
                    ...
                    long j5 = j >>> i19;
                    this.big8 = j5;
                    this.test8 = j5 & ((long) this.f4830k);
                } else {
                    int i25 = this.checksum;
                    this.test8 = this.f4830k & i25;
                    this.checksum = i25 >>> i;
                }
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (j4 > 0) {
    ...
    public int[] getStatInt() {
        return new int[]{this.counter, this.test, this.f4829ii, this.f4831r, this.steps, this.keysize, this.height, this.f4832w, this.checksum};
    }
    ...
    public void initSign(byte[] bArr, byte[] bArr2) {
        ...
        int log = getLog((this.messagesize << this.f4832w) + 1);
        int i4 = this.f4832w;
        int i5 = 8;
        if (8 % i4 == 0) {
            int i6 = 8 / i4;
            ...
            for (int i7 = 0; i7 < this.mdsize; i7++) {
                for (int i8 = 0; i8 < i6; i8++) {
                    byte b = bArr4[i7];
                    i += this.f4830k & b;
                    bArr4[i7] = (byte) (b >>> this.f4832w);
                }
            }
            int i9 = (this.messagesize << this.f4832w) - i;
            this.checksum = i9;
            int i10 = 0;
            while (i10 < log) {
                i += this.f4830k & i9;
            ...
            while (i13 < i12) {
                long j = 0;
                for (int i16 = 0; i16 < this.f4832w; i16++) {
                    j ^= (long) ((bArr4[i14] & 255) << (i16 << 3));
                    i14++;
                }
                int i17 = 0;
                while (i17 < i5) {
                    i15 += (int) (((long) this.f4830k) & j);
                    j >>>= this.f4832w;
                    i17++;
                    i12 = i12;
                    i5 = 8;
            ...
            int i18 = this.mdsize % this.f4832w;
            long j2 = 0;
            ...
            int i21 = 0;
            while (i21 < i20) {
                i15 += (int) (((long) this.f4830k) & j2);
                int i22 = this.f4832w;
                j2 >>>= i22;
                i21 += i22;
            }
            int i23 = (this.messagesize << this.f4832w) - i15;
            this.checksum = i23;
            int i24 = 0;
            i = i15;
            while (i24 < log) {
            ...
            while (true) {
                ...
                i27 = (int) (((long) i27) + ((j3 >>> i29) & ((long) this.f4830k)));
            }
            int i33 = i26 >>> 3;
            if (i33 < i2) {
                int i34 = i26 % 8;
                ...
                i27 = (int) (((long) i27) + ((j4 >>> i34) & ((long) this.f4830k)));
            }
            int i36 = (this.messagesize << this.f4832w) - i27;
            this.checksum = i36;
            int i37 = 0;
            i = i27;
            while (i37 < log) {
        ...
        int iCeil = this.messagesize + ((int) Math.ceil(((double) log) / ((double) this.f4832w)));
        this.keysize = iCeil;
