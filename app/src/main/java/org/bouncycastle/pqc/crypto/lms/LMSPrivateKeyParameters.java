...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    private static CacheKey f4849T1;
    private static CacheKey[] internedKeys;

    /* JADX INFO: renamed from: I */
    private final byte[] f4850I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f4851q = i;
        this.f4850I = lMSPrivateKeyParameters.f4850I;
        this.maxQ = i2;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f4851q != lMSPrivateKeyParameters.f4851q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f4850I, lMSPrivateKeyParameters.f4850I)) {
            return false;
        }
    ...
    LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            try {
                ...
                lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f4850I, i, this.masterSecret);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f4850I).u32str(this.f4851q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f4850I);
    }
        ...
        synchronized (this) {
            try {
                if (this.publicKey == null) {
                    this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f4849T1), this.f4850I);
                }
    ...
    public long getUsagesRemaining() {
        return this.maxQ - this.f4851q;
    }

    public int hashCode() {
        int iHashCode = ((this.f4851q * 31) + Arrays.hashCode(this.f4850I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
