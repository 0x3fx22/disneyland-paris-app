...
abstract class ErrorCorrection {
    static short LDDecode(int i, int i2, int i3, int i4) {
        return (short) (((((m2106g(i) + m2106g(i2)) + m2106g(i3)) + m2106g(i4)) - 98312) >>> 31);
    }
    ...
    static int m2105f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
    ...
    static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        while (i < 256) {
            ...
            int i3 = i + 256;
            int i4 = i + 512;
            int iM2105f = m2105f(iArr, 0, 4, (sArr2[i] * s) + i2) + m2105f(iArr, 1, 5, (sArr2[i3] * s) + i2) + m2105f(iArr, 2, 6, (sArr2[i4] * s) + i2);
            int i5 = i + ViewUtils.EDGE_TO_EDGE_FLAGS;
            int iM2105f2 = (24577 - (iM2105f + m2105f(iArr, 3, 7, (sArr2[i5] * s) + i2))) >> 31;
            int i6 = ~iM2105f2;
            int[] iArr2 = {(i6 & iArr[0]) ^ (iArr[4] & iM2105f2), (i6 & iArr[1]) ^ (iArr[5] & iM2105f2), (i6 & iArr[2]) ^ (iArr[6] & iM2105f2), (iArr[7] & iM2105f2) ^ (i6 & iArr[3])};
            int i7 = iArr2[0];
            int i8 = iArr2[3];
            sArr[i] = (short) ((i7 - i8) & 3);
            sArr[i3] = (short) ((iArr2[1] - i8) & 3);
            sArr[i4] = (short) ((iArr2[2] - i8) & 3);
            sArr[i5] = (short) (((-iM2105f2) + (i8 * 2)) & 3);
            i++;
            s = 8;
        }
    }
