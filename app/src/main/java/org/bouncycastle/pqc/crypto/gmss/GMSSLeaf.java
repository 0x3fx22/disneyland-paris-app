...
public class GMSSLeaf {
    ...
    public GMSSLeaf(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        int digestSize = this.messDigestOTS.getDigestSize();
        this.mdsize = digestSize;
        int iCeil = (int) Math.ceil(((double) (digestSize << 3)) / ((double) this.f4825w));
        this.keysize = iCeil + ((int) Math.ceil(((double) getLog((iCeil << this.f4825w) + 1)) / ((double) this.f4825w)));
        this.two_power_w = 1 << this.f4825w;
    ...
    private GMSSLeaf(GMSSLeaf gMSSLeaf) {
        ...
        this.f4823i = gMSSLeaf.f4823i;
        this.f4824j = gMSSLeaf.f4824j;
        this.two_power_w = gMSSLeaf.two_power_w;
        this.f4825w = gMSSLeaf.f4825w;
    ...
    private void updateLeafCalc() {
        ...
        for (int i = 0; i < this.steps + 10000; i++) {
            int i2 = this.f4823i;
            if (i2 == this.keysize && this.f4824j == this.two_power_w - 1) {
            ...
            if (i2 == 0 || this.f4824j == this.two_power_w - 1) {
                this.f4823i = i2 + 1;
                this.f4824j = 0;
                ...
                int i3 = this.f4824j + 1;
                this.f4824j = i3;
                if (i3 == this.two_power_w - 1) {
                    byte[] bArr5 = this.privateKeyOTS;
                    byte[] bArr6 = this.concHashs;
                    int i4 = this.mdsize;
                    System.arraycopy(bArr5, 0, bArr6, (this.f4823i - 1) * i4, i4);
                }
            }
        }
        throw new IllegalStateException("unable to updateLeaf in steps: " + this.steps + " " + this.f4823i + " " + this.f4824j);
    }
    ...
    public int[] getStatInt() {
        return new int[]{this.f4823i, this.f4824j, this.steps, this.f4825w};
    }
