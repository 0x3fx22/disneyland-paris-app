...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    private final byte[] f4852I;

    /* JADX INFO: renamed from: T1 */
    private final byte[] f4853T1;
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f4852I = Arrays.clone(bArr2);
        this.f4853T1 = Arrays.clone(bArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f4852I, lMSPublicKeyParameters.f4852I)) {
            return Arrays.areEqual(this.f4853T1, lMSPublicKeyParameters.f4853T1);
        }
        return false;
    }
    ...
    LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f4852I, lMSSignature.getQ(), null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f4852I);
    }
    ...
    public byte[] getT1() {
        return Arrays.clone(this.f4853T1);
    }

    public int hashCode() {
        return (((((this.parameterSet.hashCode() * 31) + this.lmOtsType.hashCode()) * 31) + Arrays.hashCode(this.f4852I)) * 31) + Arrays.hashCode(this.f4853T1);
    }

    boolean matchesT1(byte[] bArr) {
        return Arrays.constantTimeAreEqual(this.f4853T1, bArr);
    }

    byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f4852I).bytes(this.f4853T1).build();
    }
