...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private byte[] f4819b1;

    /* JADX INFO: renamed from: b2 */
    private byte[] f4820b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f4819b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f4820b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f4821vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f4821vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f4821vi;
            int i11 = i10 + 1;
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f4819b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f4820b2 = RainbowUtil.convertArray(sArr4);
        this.f4821vi = RainbowUtil.convertIntArray(iArr);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f4819b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f4820b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f4821vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f4819b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f4820b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f4821vi));
