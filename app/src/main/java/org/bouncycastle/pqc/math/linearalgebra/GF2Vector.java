...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f4931v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f4931v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f4931v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f4931v = IntUtils.clone(gF2Vector.f4931v);
    }
    ...
    public Vector add(Vector vector) {
        ...
        int[] iArrClone = IntUtils.clone(gF2Vector.f4931v);
        for (int length = iArrClone.length - 1; length >= 0; length--) {
            iArrClone[length] = iArrClone[length] ^ this.f4931v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f4931v, gF2Vector.f4931v);
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        ...
        int i3 = i >> 5;
        int i4 = i & 31;
        System.arraycopy(this.f4931v, 0, gF2Vector.f4931v, 0, i3);
        if (i4 != 0) {
            gF2Vector.f4931v[i3] = this.f4931v[i3] & ((1 << i4) - 1);
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        if (i6 != 0) {
            while (true) {
                ...
                int[] iArr = gF2Vector.f4931v;
                int[] iArr2 = this.f4931v;
                int i9 = i5 + 1;
                iArr[i8] = (iArr2[i5] >>> i6) | (iArr2[i9] << (32 - i6));
                i8++;
                i5 = i9;
            }
            int[] iArr3 = gF2Vector.f4931v;
            int[] iArr4 = this.f4931v;
            int i10 = i5 + 1;
            int i11 = iArr4[i5] >>> i6;
            iArr3[i2] = i11;
            if (i10 < iArr4.length) {
            ...
            System.arraycopy(this.f4931v, i5, gF2Vector.f4931v, 0, i7);
        }
        return gF2Vector;
    }
    ...
    public int getBit(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        return (this.f4931v[i2] & (1 << i3)) >>> i3;
    }

    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f4931v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f4931v);
    }

    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f4931v.length - 1; length >= 0; length--) {
            if (this.f4931v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f4931v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }
