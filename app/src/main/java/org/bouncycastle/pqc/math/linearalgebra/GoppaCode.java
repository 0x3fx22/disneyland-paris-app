...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        private GF2Matrix f4934h;

        /* JADX INFO: renamed from: p */
        private Permutation f4935p;

        /* JADX INFO: renamed from: s */
        private GF2Matrix f4936s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f4936s = gF2Matrix;
            this.f4934h = gF2Matrix2;
            this.f4935p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        private GF2Matrix f4937g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f4937g = gF2Matrix;
            this.setJ = iArr;
        }
