...
public class PolynomialRingGF2m {
    ...
    private PolynomialGF2mSmallM f4939p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f4939p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f4939p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        while (i < degree) {
            ...
            iArr2[i4] = 1;
            this.sqMatrix[i] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f4939p);
            i++;
        }
    }
