...
abstract class RFC3280CertPathUtilities {
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x0109 A[PHI: r0
 ...
 binds: [B:38:0x00bb, B:44:0x00fe, B:40:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    protected static void checkCRLs(PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, PKIXExtendedParameters pKIXExtendedParameters, Date date, Date date2, X509Certificate x509Certificate, X509Certificate x509Certificate2, PublicKey publicKey, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException {
        ...
        try {
            ...
            try {
                Iterator it = CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(cRLDistPoint, pKIXExtendedParameters.getNamedCRLStoreMap(), date2, jcaJceHelper).iterator();
                while (it.hasNext()) {
                        ...
                        if (distributionPoints != null) {
                            ...
                            while (i5 < distributionPoints.length && certStatus4.getCertStatus() == i4 && !reasonsMask.isAllReasons()) {
                                try {
                                    ...
                                    try {
                                        checkCRL(pKIXCertRevocationCheckerParameters, distributionPoints[i5], pKIXExtendedParametersBuild, date, date2, x509Certificate, x509Certificate2, publicKey, certStatus4, reasonsMask, list, jcaJceHelper);
                                        z = true;
                                    } catch (AnnotatedException e2) {
                                        e = e2;
                                    }
    ...
    protected static int prepareNextCertI1(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
        try {
    ...
    protected static int prepareNextCertI2(CertPath certPath, int i, int i2) throws ExtCertPathValidatorException {
        try {
            ASN1Sequence aSN1Sequence = ASN1Sequence.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i), POLICY_CONSTRAINTS));
            if (aSN1Sequence != null) {
                Enumeration objects = aSN1Sequence.getObjects();
