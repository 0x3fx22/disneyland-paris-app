...
public abstract class JceKeyAgreeRecipient implements KeyAgreeRecipient {
     ...
     */
    private SecretKey calculateAgreedWrapKey(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, PublicKey publicKey, ASN1OctetString aSN1OctetString, PrivateKey privateKey, KeyMaterialGenerator keyMaterialGenerator) throws InvalidKeySpecException, CMSException, InvalidKeyException, InvalidAlgorithmParameterException {
