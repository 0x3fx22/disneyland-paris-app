package org.bouncycastle.openpgp.operator.p186bc;

import java.io.OutputStream;
import java.security.SecureRandom;
import org.bouncycastle.crypto.BufferedBlockCipher;
import org.bouncycastle.crypto.p177io.CipherOutputStream;
...
public class BcPGPDataEncryptorBuilder implements PGPDataEncryptorBuilder {
    ...
    private class MyPGPDataEncryptor implements PGPDataEncryptor {
        ...
        private final BufferedBlockCipher f4800c;

        MyPGPDataEncryptor(byte[] bArr) throws PGPException {
            try {
                this.f4800c = BcUtil.createStreamCipher(true, BcImplProvider.createBlockCipher(BcPGPDataEncryptorBuilder.this.encAlgorithm), BcPGPDataEncryptorBuilder.this.withIntegrityPacket, bArr);
        ...
        public int getBlockSize() {
            return this.f4800c.getBlockSize();
        }
        ...
        public OutputStream getOutputStream(OutputStream outputStream) {
            return new CipherOutputStream(outputStream, this.f4800c);
        }
    }
