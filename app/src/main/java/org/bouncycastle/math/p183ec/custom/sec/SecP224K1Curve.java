...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4737q = SecP224K1FieldElement.f4739Q;
    ...
    public SecP224K1Curve() {
        ...
        this.f4688a = fromBigInteger(ECConstants.ZERO);
        this.f4689b = fromBigInteger(BigInteger.valueOf(5L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawXCoord()).f4740x, 0, iArr, i3);
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawYCoord()).f4740x, 0, iArr, i3 + 7);
            i3 += 14;
        }
