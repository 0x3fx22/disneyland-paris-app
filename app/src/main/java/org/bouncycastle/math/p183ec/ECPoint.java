...
public abstract class ECPoint {
    ...
    protected ECFieldElement f4703x;

    /* JADX INFO: renamed from: y */
    protected ECFieldElement f4704y;

    /* JADX INFO: renamed from: zs */
    protected ECFieldElement[] f4705zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f4705zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            boolean zIsZero = eCFieldElement.isZero();
            ECFieldElement eCFieldElement5 = this.f4704y;
            if (zIsZero) {
        ...
        public AbstractF2m tau() {
            ...
            ECFieldElement eCFieldElement = this.f4703x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f4704y.square());
            } else {
                if (coordinateSystem != 1) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f4704y.square(), new ECFieldElement[]{this.f4705zs[0].square()});
            }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            ECFieldElement eCFieldElement = this.f4703x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f4704y.squarePow(i));
            } else {
                if (coordinateSystem != 1) {
                    if (coordinateSystem == 5) {
                        eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f4704y.squarePow(i));
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f4704y.squarePow(i), new ECFieldElement[]{this.f4705zs[0].squarePow(i)});
            }
            return (AbstractF2m) eCPointCreateRawPoint;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply6 = this.f4703x;
            ECFieldElement eCFieldElement = eCPoint.f4703x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement2 = this.f4704y;
                ECFieldElement eCFieldElement3 = eCPoint.f4704y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f4704y;
                ECFieldElement eCFieldElementMultiply7 = this.f4705zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.f4704y;
                ECFieldElement eCFieldElement6 = eCPoint.f4705zs[0];
            ...
            ECFieldElement eCFieldElement7 = this.f4704y;
            ECFieldElement eCFieldElement8 = this.f4705zs[0];
            ECFieldElement eCFieldElement9 = eCPoint.f4704y;
            ECFieldElement eCFieldElement10 = eCPoint.f4705zs[0];
        ...
        public ECPoint negate() {
            ...
            int curveCoordinateSystem = getCurveCoordinateSystem();
            if (curveCoordinateSystem == 0) {
                return new F2m(this.curve, eCFieldElement, this.f4704y.add(eCFieldElement));
            }
            if (curveCoordinateSystem == 1) {
                return new F2m(this.curve, eCFieldElement, this.f4704y.add(eCFieldElement), new ECFieldElement[]{this.f4705zs[0]});
            }
            if (curveCoordinateSystem == 5) {
                return new F2m(this.curve, eCFieldElement, this.f4704y.addOne());
            }
            if (curveCoordinateSystem != 6) {
                throw new IllegalStateException("unsupported coordinate system");
            }
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementMultiply = this.f4703x;
            if (eCFieldElementMultiply.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f4704y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f4704y;
                ECFieldElement eCFieldElement = this.f4705zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f4703x;
            ECFieldElement eCFieldElement3 = eCPoint.f4705zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f4704y;
            ECFieldElement eCFieldElement5 = this.f4705zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f4704y;
    ...
    public static class C7838Fp extends AbstractFp {
        C7838Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        }

        C7838Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        /*  JADX ERROR: Type inference failed
            jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 5301. Try increasing type updates limit count.
            ...
            */
        @Override // org.bouncycastle.math.p183ec.ECPoint
        public org.bouncycastle.math.p183ec.ECPoint add(org.bouncycastle.math.p183ec.ECPoint r17) {
            /*
                Method dump skipped, instruction units count: 530
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p183ec.ECPoint.C7838Fp.add(org.bouncycastle.math.ec.ECPoint):org.bouncycastle.math.ec.ECPoint");
        }
        ...
        @Override // org.bouncycastle.math.p183ec.ECPoint
        protected ECPoint detach() {
            return new C7838Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        protected ECFieldElement getJacobianModifiedW() {
            ECFieldElement[] eCFieldElementArr = this.f4705zs;
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new C7838Fp(curve, this.f4703x, this.f4704y.negate(), this.f4705zs) : new C7838Fp(curve, this.f4703x, this.f4704y.negate());
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f4704y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
            ...
            ECFieldElement eCFieldElement2 = this.f4703x;
            ...
            return new C7838Fp(curve, eCFieldElementAdd2, eCFieldElement2.subtract(eCFieldElementAdd2).multiply(eCFieldElementSubtract2).subtract(eCFieldElement));
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f4704y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ...
            if (coordinateSystem == 0) {
                ...
                return new C7838Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementSquare2), eCFieldElementSubtract.multiply(eCFieldElementSquare2.multiply(eCFieldElementInvert)));
            }
            if (coordinateSystem == 1) {
                return new C7838Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementFromBigInteger), eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger.multiply(eCFieldElementFromBigInteger.square())});
            }
            if (coordinateSystem == 2) {
                return new C7838Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger});
            }
            if (coordinateSystem == 4) {
                return new C7838Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a2});
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                return new C7838Fp(curve, eCFieldElementSubtract2, eCFieldElementDivide.multiply(eCFieldElement2.subtract(eCFieldElementSubtract2)).subtract(eCFieldElement));
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement3 = this.f4705zs[0];
                ...
                return new C7838Fp(curve, eCFieldElementMultiply3, eCFieldElementFour.subtract(eCFieldElementSubtract3).multiply(eCFieldElementAdd).subtract(two(eCFieldElementTwo2.square())), new ECFieldElement[]{two(zIsOne ? two(eCFieldElementTwo2) : eCFieldElementTwo.square()).multiply(eCFieldElementMultiply2)});
            }
            if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
            ...
            return new C7838Fp(curve, eCFieldElementSubtract4, eCFieldElementSubtract5, new ECFieldElement[]{eCFieldElementTwo3});
        }

        protected C7838Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f4703x;
            ECFieldElement eCFieldElement2 = this.f4704y;
            ECFieldElement eCFieldElement3 = this.f4705zs[0];
            ...
            return new C7838Fp(getCurve(), eCFieldElementSubtract, eCFieldElementSubtract2, new ECFieldElement[]{eCFieldElementTwo, eCFieldElementTwo4});
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f4703x;
            ECFieldElement eCFieldElement3 = eCPoint.f4703x;
            ECFieldElement eCFieldElement4 = eCPoint.f4704y;
            ...
            return new C7838Fp(curve, eCFieldElementAdd, eCFieldElement2.subtract(eCFieldElementAdd).multiply(eCFieldElementSubtract4).subtract(eCFieldElement));
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f4703x = eCFieldElement;
        this.f4704y = eCFieldElement2;
        this.f4705zs = eCFieldElementArr;
    }
    ...
    boolean implIsValid(final boolean z, final boolean z2) {
        ...
        return !((ValidityPrecompInfo) getCurve().precompute(this, "bc_validity", new PreCompCallback() { // from class: org.bouncycastle.math.ec.ECPoint.1
            @Override // org.bouncycastle.math.p183ec.PreCompCallback
    ...
    public boolean isInfinity() {
        if (this.f4703x != null && this.f4704y != null) {
            ECFieldElement[] eCFieldElementArr = this.f4705zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f4705zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f4705zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f4705zs[i]);
        }
