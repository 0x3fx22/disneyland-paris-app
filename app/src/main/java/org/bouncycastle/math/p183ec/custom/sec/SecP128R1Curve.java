...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4716q = SecP128R1FieldElement.f4718Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f4719x, 0, iArr, i3);
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f4719x, 0, iArr, i3 + 4);
            i3 += 8;
        }
