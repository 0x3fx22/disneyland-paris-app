...
public class SecP192R1Field {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(6, iArr, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f4734P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j4 = j2 + (BodyPartID.bodyIdMax & ((long) iArr[2])) + 1;
        iArr[2] = (int) j4;
        if ((j4 >> 32) != 0) {
            Nat.incAt(6, iArr, 3);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(6, iArr2, Nat192.add(iArr, f4734P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4734P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(6, iArr, f4734P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j7 = (((long) iArr[0]) & BodyPartID.bodyIdMax) + j5;
        int i = (int) j7;
        long j8 = (j7 >> 32) + (((long) iArr[1]) & BodyPartID.bodyIdMax) + j6;
        int i2 = (int) j8;
        iArr2[1] = i2;
        long j9 = j5 + j3;
        long j10 = j6 + j4;
        long j11 = (j8 >> 32) + (((long) iArr[2]) & BodyPartID.bodyIdMax) + j9;
        long j12 = j11 & BodyPartID.bodyIdMax;
        long j13 = (j11 >> 32) + (((long) iArr[3]) & BodyPartID.bodyIdMax) + j10;
        iArr2[3] = (int) j13;
        long j14 = j10 - j2;
        long j15 = (j13 >> 32) + (((long) iArr[4]) & BodyPartID.bodyIdMax) + (j9 - j);
        iArr2[4] = (int) j15;
        long j16 = (j15 >> 32) + (((long) iArr[5]) & BodyPartID.bodyIdMax) + j14;
        iArr2[5] = (int) j16;
        long j17 = j16 >> 32;
        long j18 = j12 + j17;
        ...
        long j20 = j19 >> 32;
        if (j20 != 0) {
            long j21 = j20 + (BodyPartID.bodyIdMax & ((long) i2));
            iArr2[1] = (int) j21;
            j18 += j21 >> 32;
        }
        iArr2[2] = (int) j18;
        if (((j18 >> 32) == 0 || Nat.incAt(6, iArr2, 3) == 0) && !(iArr2[5] == -1 && Nat192.gte(iArr2, f4734P))) {
            return;
        }
        addPInvTo(iArr2);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j6 = j4 + (BodyPartID.bodyIdMax & ((long) iArr[2])) + j2;
            iArr[2] = (int) j6;
            j = j6 >> 32;
        } else {
            j = 0;
        }
        if ((j == 0 || Nat.incAt(6, iArr, 3) == 0) && !(iArr[5] == -1 && Nat192.gte(iArr, f4734P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(6, iArr, 0, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f4734P))) {
            addPInvTo(iArr2);
        }
    }
}
