...
public class SecP521R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4757q = SecP521R1FieldElement.f4759Q;
    ...
    public SecP521R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0051953EB9618E1C9A1F929A21A0B68540EEA2DA725B99B315F3B8B489918EF109E156193951EC7E937B1652C0BD3BB1BF073573DF883D2C34F1EF451FD46B503F00")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawXCoord()).f4760x, 0, iArr, i3);
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawYCoord()).f4760x, 0, iArr, i3 + 17);
            i3 += 34;
        }
