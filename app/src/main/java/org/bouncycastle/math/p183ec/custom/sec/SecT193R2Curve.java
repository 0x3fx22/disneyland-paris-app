...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawXCoord()).f4764x, 0, jArr, i3);
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawYCoord()).f4764x, 0, jArr, i3 + 4);
            i3 += 8;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT193R2Curve.1
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < 4; i8++) {
                        ...
                        jArrCreate65[i8] = jArrCreate65[i8] ^ (jArr2[(i6 + 4) + i8] & j);
                    }
                    i6 += 8;
                }
            ...
            public ECPoint lookupVar(int i5) {
                ...
                for (int i7 = 0; i7 < 4; i7++) {
                    ...
                    jArrCreate65[i7] = jArrCreate65[i7] ^ jArr2[(4 + i6) + i7];
                }
                return createPoint(jArrCreate64, jArrCreate65);
            }
        };
