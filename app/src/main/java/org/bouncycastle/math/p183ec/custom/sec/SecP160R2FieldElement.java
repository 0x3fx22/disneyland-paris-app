...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
    ...
    public static final BigInteger f4727Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73"));

    /* JADX INFO: renamed from: x */
    protected int[] f4728x;

    public SecP160R2FieldElement() {
        this.f4728x = Nat160.create();
    }

    public SecP160R2FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f4727Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP160R2FieldElement");
        }
        this.f4728x = SecP160R2Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP160R2Field.add(this.f4728x, ((SecP160R2FieldElement) eCFieldElement).f4728x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.addOne(this.f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.inv(((SecP160R2FieldElement) eCFieldElement).f4728x, iArrCreate);
        SecP160R2Field.multiply(iArrCreate, this.f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.m2101eq(this.f4728x, ((SecP160R2FieldElement) obj).f4728x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f4727Q.bitLength();
    }

    public int hashCode() {
        return Arrays.hashCode(this.f4728x, 0, 5) ^ f4727Q.hashCode();
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.inv(this.f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f4728x);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f4728x);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.multiply(this.f4728x, ((SecP160R2FieldElement) eCFieldElement).f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.negate(this.f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f4728x;
        ...
        if (Nat160.m2101eq(iArr, iArrCreate)) {
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(this.f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.subtract(this.f4728x, ((SecP160R2FieldElement) eCFieldElement).f4728x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f4728x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f4728x);
    }
}
