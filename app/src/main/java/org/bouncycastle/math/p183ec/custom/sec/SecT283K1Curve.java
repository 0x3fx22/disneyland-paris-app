...
public class SecT283K1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawXCoord()).f4767x, 0, jArr, i3);
            Nat320.copy64(((SecT283FieldElement) eCPoint.getRawYCoord()).f4767x, 0, jArr, i3 + 5);
            i3 += 10;
        }
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < 5; i8++) {
                        ...
                        jArrCreate65[i8] = jArrCreate65[i8] ^ (jArr2[(i6 + 5) + i8] & j);
                    }
                    i6 += 10;
                }
