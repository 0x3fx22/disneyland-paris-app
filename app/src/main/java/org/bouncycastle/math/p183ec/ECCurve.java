...
import org.bouncycastle.math.p183ec.endo.ECEndomorphism;
import org.bouncycastle.math.p183ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    protected ECFieldElement f4688a;

    /* JADX INFO: renamed from: b */
    protected ECFieldElement f4689b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        synchronized BigInteger[] getSi() {
            try {
                if (this.f4690si == null) {
                    this.f4690si = Tnaf.getSi(this);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f4689b.isOne() && (this.f4688a.isZero() || this.f4688a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f4688a).multiply(eCFieldElementFromBigInteger).add(this.f4689b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f4688a = fromBigInteger(bigInteger);
            this.f4689b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f4688a = eCFieldElement;
            this.f4689b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.f4694m, this.f4691k1, this.f4692k2, this.f4693k3, this.f4688a, this.f4689b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.p183ec.ECCurve
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
            final int i3 = (this.f4694m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f4691k1} : new int[]{this.f4691k1, this.f4692k2, this.f4693k3};
            final long[] jArr = new long[i2 * i3 * 2];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f4699x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f4699x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.ECCurve.F2m.1
                private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f4694m, iArr, new LongArray(jArr2)), new ECFieldElement.F2m(F2m.this.f4694m, iArr, new LongArray(jArr3)));
                }
                ...
                public ECPoint lookup(int i7) {
                    ...
                    long[] jArrCreate65 = Nat.create64(i3);
                    int i9 = 0;
                    for (int i10 = 0; i10 < i2; i10++) {
                        ...
                        while (true) {
                            ...
                            if (i11 < i8) {
                                ...
                                jArrCreate65[i11] = jArrCreate65[i11] ^ (jArr2[(i8 + i9) + i11] & j);
                                i11++;
                            }
                        }
                        i9 += i8 * 2;
                ...
                public ECPoint lookupVar(int i7) {
                    ...
                    while (true) {
                        ...
                        jArrCreate65[i9] = jArr2[i10 + i8 + i9];
                        i9++;
                    }
                }
            };
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f4694m, this.f4691k1, this.f4692k2, this.f4693k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f4692k2 == 0 && this.f4693k3 == 0;
        }
    ...
    public static class C7835Fp extends AbstractFp {
        ECPoint.C7838Fp infinity;
        ...
        public C7835Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, null, null);
        }

        public C7835Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f4695q = bigInteger;
            this.f4696r = ECFieldElement.C7836Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C7838Fp(this, null, null);
            this.f4688a = fromBigInteger(bigInteger2);
            this.f4689b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C7835Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f4695q = bigInteger;
            this.f4696r = bigInteger2;
            this.infinity = new ECPoint.C7838Fp(this, null, null);
            this.f4688a = eCFieldElement;
            this.f4689b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        @Override // org.bouncycastle.math.p183ec.ECCurve
        protected ECCurve cloneCurve() {
            return new C7835Fp(this.f4695q, this.f4696r, this.f4688a, this.f4689b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.p183ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C7838Fp(this, eCFieldElement, eCFieldElement2);
        }

        @Override // org.bouncycastle.math.p183ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C7838Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        @Override // org.bouncycastle.math.p183ec.ECCurve
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C7836Fp(this.f4695q, this.f4696r, bigInteger);
        }

        @Override // org.bouncycastle.math.p183ec.ECCurve
        public int getFieldSize() {
            return this.f4695q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.C7838Fp(this, fromBigInteger(eCPoint.f4703x.toBigInteger()), fromBigInteger(eCPoint.f4704y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f4705zs[0].toBigInteger())});
        }
