...
public class SecP256R1Field {
    ...
    static final int[] f4750P = {-1, -1, -1, 0, 0, 0, 1, -1};
    private static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f4750P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f4750P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j5 = j2 + ((((long) iArr[3]) & BodyPartID.bodyIdMax) - 1);
        iArr[3] = (int) j5;
        long j6 = j5 >> 32;
        if (j6 != 0) {
        ...
        long j9 = j6 + ((((long) iArr[6]) & BodyPartID.bodyIdMax) - 1);
        iArr[6] = (int) j9;
        iArr[7] = (int) ((j9 >> 32) + (BodyPartID.bodyIdMax & ((long) iArr[7])) + 1);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f4750P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4750P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f4750P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j16 = j7 + j8;
        long j17 = j15 - j10;
        long j18 = ((((long) iArr[0]) & BodyPartID.bodyIdMax) - j13) - j17;
        iArr2[0] = (int) j18;
        long j19 = (j18 >> 32) + ((((((long) iArr[1]) & BodyPartID.bodyIdMax) + j11) - j14) - j16);
        iArr2[1] = (int) j19;
        long j20 = (j19 >> 32) + (((((long) iArr[2]) & BodyPartID.bodyIdMax) + j12) - j15);
        iArr2[2] = (int) j20;
        long j21 = (j20 >> 32) + ((((((long) iArr[3]) & BodyPartID.bodyIdMax) + (j13 << 1)) + j17) - j16);
        iArr2[3] = (int) j21;
        long j22 = (j21 >> 32) + ((((((long) iArr[4]) & BodyPartID.bodyIdMax) + (j14 << 1)) + j7) - j11);
        iArr2[4] = (int) j22;
        long j23 = (j22 >> 32) + (((((long) iArr[5]) & BodyPartID.bodyIdMax) + (j15 << 1)) - j12);
        iArr2[5] = (int) j23;
        long j24 = (j23 >> 32) + (((long) iArr[6]) & BodyPartID.bodyIdMax) + (j16 << 1) + j17;
        iArr2[6] = (int) j24;
        long j25 = (j24 >> 32) + (((((((long) iArr[7]) & BodyPartID.bodyIdMax) + (j8 << 1)) + j9) - j12) - j14);
        iArr2[7] = (int) j25;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j7 = j4 + ((((long) iArr[3]) & BodyPartID.bodyIdMax) - j2);
            iArr[3] = (int) j7;
            long j8 = j7 >> 32;
            if (j8 != 0) {
            ...
            long j11 = j8 + ((((long) iArr[6]) & BodyPartID.bodyIdMax) - j2);
            iArr[6] = (int) j11;
            long j12 = (j11 >> 32) + (BodyPartID.bodyIdMax & ((long) iArr[7])) + j2;
            iArr[7] = (int) j12;
            j = j12 >> 32;
        } else {
            j = 0;
        }
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f4750P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f4750P))) {
            addPInvTo(iArr2);
        }
    }
}
