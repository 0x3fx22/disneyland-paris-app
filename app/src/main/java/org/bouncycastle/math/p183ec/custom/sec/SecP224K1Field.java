...
public class SecP224K1Field {
    ...
    static final int[] f4738P = {-6803, -2, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f4738P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f4738P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (iArrFromBigInteger[6] == -1 && Nat224.gte(iArrFromBigInteger, f4738P)) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f4738P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4738P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(7, iArr, f4738P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat224.mul33DWordAdd(6803, Nat224.mul33Add(6803, iArr, 7, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f4738P))) {
            Nat.add33To(7, 6803, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat224.mul33WordAdd(6803, i, iArr, 0) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f4738P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f4738P))) {
            Nat.add33To(7, 6803, iArr2);
        }
    }
}
