...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT409R1Curve() {
        ...
        this.f4688a = fromBigInteger(BigInteger.valueOf(1L));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawXCoord()).f4768x, 0, jArr, i3);
            Nat448.copy64(((SecT409FieldElement) eCPoint.getRawYCoord()).f4768x, 0, jArr, i3 + 7);
            i3 += 14;
        }
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < 7; i8++) {
                        ...
                        jArrCreate65[i8] = jArrCreate65[i8] ^ (jArr2[(i6 + 7) + i8] & j);
                    }
                    i6 += 14;
                }
