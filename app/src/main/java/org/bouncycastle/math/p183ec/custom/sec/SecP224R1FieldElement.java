...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public static final BigInteger f4743Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"));

    /* JADX INFO: renamed from: x */
    protected int[] f4744x;

    public SecP224R1FieldElement() {
        this.f4744x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f4743Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f4744x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    private static void m2096RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    private static void m2097RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                i2--;
                if (i2 >= 0) {
                    m2098RS(iArr2, iArr3, iArr4, iArr5);
                }
            }
            m2096RM(iArr, iArrCreate, iArrCreate2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* JADX INFO: renamed from: RS */
    private static void m2098RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m2097RP(iArr, iArrCreate, iArrCreate2, iArrCreate3, iArr3);
        ...
        for (int i = 1; i < 96; i++) {
            ...
            m2098RS(iArrCreate, iArrCreate2, iArrCreate3, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.add(this.f4744x, ((SecP224R1FieldElement) eCFieldElement).f4744x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.addOne(this.f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) eCFieldElement).f4744x, iArrCreate);
        SecP224R1Field.multiply(iArrCreate, this.f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224R1FieldElement) {
            return Nat224.m2103eq(this.f4744x, ((SecP224R1FieldElement) obj).f4744x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f4743Q.bitLength();
    }

    public int hashCode() {
        return Arrays.hashCode(this.f4744x, 0, 7) ^ f4743Q.hashCode();
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.inv(this.f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f4744x);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f4744x);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.multiply(this.f4744x, ((SecP224R1FieldElement) eCFieldElement).f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.negate(this.f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f4744x;
        if (Nat224.isZero(iArr) || Nat224.isOne(iArr)) {
            return this;
        }
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.negate(iArr, iArrCreate);
        int[] iArrRandom = Mod.random(SecP224R1Field.f4742P);
        int[] iArrCreate2 = Nat224.create();
        if (!isSquare(iArr)) {
            return null;
        }
        ...
        if (Nat224.m2103eq(iArr, iArrRandom)) {
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.square(this.f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.subtract(this.f4744x, ((SecP224R1FieldElement) eCFieldElement).f4744x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f4744x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p183ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f4744x);
    }
}
