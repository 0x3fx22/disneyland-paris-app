package org.bouncycastle.math.p183ec.custom.djb;
...
public class Curve25519Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        Curve25519FieldElement curve25519FieldElement = (Curve25519FieldElement) this.f4703x;
        Curve25519FieldElement curve25519FieldElement2 = (Curve25519FieldElement) this.f4704y;
        Curve25519FieldElement curve25519FieldElement3 = (Curve25519FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = curve25519FieldElement4.f4711x;
            iArr2 = curve25519FieldElement5.f4711x;
        } else {
            Curve25519Field.square(curve25519FieldElement3.f4711x, iArrCreate2);
            Curve25519Field.multiply(iArrCreate2, curve25519FieldElement4.f4711x, iArrCreate);
            Curve25519Field.multiply(iArrCreate2, curve25519FieldElement3.f4711x, iArrCreate2);
            Curve25519Field.multiply(iArrCreate2, curve25519FieldElement5.f4711x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = curve25519FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = curve25519FieldElement.f4711x;
            iArr4 = curve25519FieldElement2.f4711x;
        } else {
            Curve25519Field.square(curve25519FieldElement6.f4711x, iArrCreate3);
            Curve25519Field.multiply(iArrCreate3, curve25519FieldElement.f4711x, iArrCreateExt);
            Curve25519Field.multiply(iArrCreate3, curve25519FieldElement6.f4711x, iArrCreate3);
            Curve25519Field.multiply(iArrCreate3, curve25519FieldElement2.f4711x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        Curve25519Field.square(iArrCreate, curve25519FieldElement7.f4711x);
        int[] iArr5 = curve25519FieldElement7.f4711x;
        ...
        Curve25519Field.subtract(iArrCreate2, curve25519FieldElement7.f4711x, curve25519FieldElement8.f4711x);
        Curve25519Field.multiplyAddToExt(curve25519FieldElement8.f4711x, iArrCreate, iArrCreateExt);
        Curve25519Field.reduce(iArrCreateExt, curve25519FieldElement8.f4711x);
        Curve25519FieldElement curve25519FieldElement9 = new Curve25519FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = curve25519FieldElement9.f4711x;
            Curve25519Field.multiply(iArr6, curve25519FieldElement3.f4711x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = curve25519FieldElement9.f4711x;
            Curve25519Field.multiply(iArr7, curve25519FieldElement6.f4711x, iArr7);
        }
        if (!zIsOne || !zIsOne2) {
            iArrCreate5 = null;
        }
    ...
    protected Curve25519FieldElement calculateJacobianModifiedW(Curve25519FieldElement curve25519FieldElement, int[] iArr) {
        ...
        if (iArr == null) {
            iArr = curve25519FieldElement3.f4711x;
            Curve25519Field.square(curve25519FieldElement.f4711x, iArr);
        }
        Curve25519Field.square(iArr, curve25519FieldElement3.f4711x);
        int[] iArr2 = curve25519FieldElement3.f4711x;
        Curve25519Field.multiply(iArr2, curve25519FieldElement2.f4711x, iArr2);
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new Curve25519Point(getCurve(), this.f4703x, this.f4704y.negate(), this.f4705zs);
    }

    @Override // org.bouncycastle.math.p183ec.ECPoint
    public ECPoint threeTimes() {
        return (isInfinity() || this.f4704y.isZero()) ? this : twiceJacobianModified(false).add(this);
    }
    ...
    public ECPoint twice() {
        ...
        return this.f4704y.isZero() ? getCurve().getInfinity() : twiceJacobianModified(true);
    }

    protected Curve25519Point twiceJacobianModified(boolean z) {
        Curve25519FieldElement curve25519FieldElement;
        Curve25519FieldElement curve25519FieldElement2 = (Curve25519FieldElement) this.f4703x;
        Curve25519FieldElement curve25519FieldElement3 = (Curve25519FieldElement) this.f4704y;
        Curve25519FieldElement curve25519FieldElement4 = (Curve25519FieldElement) this.f4705zs[0];
        Curve25519FieldElement jacobianModifiedW = getJacobianModifiedW();
        int[] iArrCreate = Nat256.create();
        Curve25519Field.square(curve25519FieldElement2.f4711x, iArrCreate);
        Curve25519Field.reduce27(Nat256.addBothTo(iArrCreate, iArrCreate, iArrCreate) + Nat256.addTo(jacobianModifiedW.f4711x, iArrCreate), iArrCreate);
        int[] iArrCreate2 = Nat256.create();
        Curve25519Field.twice(curve25519FieldElement3.f4711x, iArrCreate2);
        int[] iArrCreate3 = Nat256.create();
        Curve25519Field.multiply(iArrCreate2, curve25519FieldElement3.f4711x, iArrCreate3);
        int[] iArrCreate4 = Nat256.create();
        Curve25519Field.multiply(iArrCreate3, curve25519FieldElement2.f4711x, iArrCreate4);
        ...
        Curve25519Field.square(iArrCreate, curve25519FieldElement5.f4711x);
        int[] iArr = curve25519FieldElement5.f4711x;
        Curve25519Field.subtract(iArr, iArrCreate4, iArr);
        int[] iArr2 = curve25519FieldElement5.f4711x;
        ...
        Curve25519Field.subtract(iArrCreate4, curve25519FieldElement5.f4711x, curve25519FieldElement6.f4711x);
        int[] iArr3 = curve25519FieldElement6.f4711x;
        Curve25519Field.multiply(iArr3, iArrCreate, iArr3);
        int[] iArr4 = curve25519FieldElement6.f4711x;
        ...
        if (!Nat256.isOne(curve25519FieldElement4.f4711x)) {
            int[] iArr5 = curve25519FieldElement7.f4711x;
            Curve25519Field.multiply(iArr5, curve25519FieldElement4.f4711x, iArr5);
        }
        if (z) {
            curve25519FieldElement = new Curve25519FieldElement(iArrCreate5);
            int[] iArr6 = curve25519FieldElement.f4711x;
            Curve25519Field.multiply(iArr6, jacobianModifiedW.f4711x, iArr6);
            int[] iArr7 = curve25519FieldElement.f4711x;
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return this.f4704y.isZero() ? eCPoint : twiceJacobianModified(false).add(eCPoint);
    }
}
