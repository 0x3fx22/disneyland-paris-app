...
public class SecP224R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4741q = SecP224R1FieldElement.f4743Q;
    ...
    public SecP224R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawXCoord()).f4744x, 0, iArr, i3);
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawYCoord()).f4744x, 0, iArr, i3 + 7);
            i3 += 14;
        }
