...
public class SecP384R1Field {
    ...
    static final int[] f4754P = {-1, 0, 0, -1, -2, -1, -1, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat.add(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && Nat.gte(12, iArr3, f4754P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(12, iArr, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f4754P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        iArr[0] = (int) j;
        long j2 = (j >> 32) + ((((long) iArr[1]) & BodyPartID.bodyIdMax) - 1);
        iArr[1] = (int) j2;
        long j3 = j2 >> 32;
        if (j3 != 0) {
        ...
        long j5 = j3 + (((long) iArr[3]) & BodyPartID.bodyIdMax) + 1;
        iArr[3] = (int) j5;
        long j6 = (j5 >> 32) + (BodyPartID.bodyIdMax & ((long) iArr[4])) + 1;
        iArr[4] = (int) j6;
        if ((j6 >> 32) != 0) {
            Nat.incAt(12, iArr, 5);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(12, iArr2, Nat.add(12, iArr, f4754P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4754P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(12, iArr, f4754P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j15 = j7 - j8;
        long j16 = j9 + j14;
        long j17 = (((long) iArr[0]) & BodyPartID.bodyIdMax) + j16;
        iArr2[0] = (int) j17;
        long j18 = (j17 >> 32) + (((((long) iArr[1]) & BodyPartID.bodyIdMax) + j8) - j9) + j10;
        iArr2[1] = (int) j18;
        long j19 = (j18 >> 32) + (((((long) iArr[2]) & BodyPartID.bodyIdMax) - j6) - j10) + j11;
        iArr2[2] = (int) j19;
        long j20 = (j19 >> 32) + ((((long) iArr[3]) & BodyPartID.bodyIdMax) - j11) + j12 + j16;
        iArr2[3] = (int) j20;
        long j21 = (j20 >> 32) + (((((((long) iArr[4]) & BodyPartID.bodyIdMax) + j) + j6) + j10) - j12) + j16;
        iArr2[4] = (int) j21;
        long j22 = (j21 >> 32) + ((((long) iArr[5]) & BodyPartID.bodyIdMax) - j) + j10 + j11 + j13;
        iArr2[5] = (int) j22;
        long j23 = (j22 >> 32) + (((((long) iArr[6]) & BodyPartID.bodyIdMax) + j3) - j2) + j11 + j12;
        iArr2[6] = (int) j23;
        long j24 = (j23 >> 32) + ((((((long) iArr[7]) & BodyPartID.bodyIdMax) + j) + j4) - j3) + j12;
        iArr2[7] = (int) j24;
        long j25 = (j24 >> 32) + (((((((long) iArr[8]) & BodyPartID.bodyIdMax) + j) + j2) + j5) - j4);
        iArr2[8] = (int) j25;
        long j26 = (j25 >> 32) + (((((long) iArr[9]) & BodyPartID.bodyIdMax) + j3) - j5) + j13;
        iArr2[9] = (int) j26;
        long j27 = (j26 >> 32) + ((((((long) iArr[10]) & BodyPartID.bodyIdMax) + j3) + j4) - j14) + j15;
        iArr2[10] = (int) j27;
        long j28 = (j27 >> 32) + ((((((long) iArr[11]) & BodyPartID.bodyIdMax) + j4) + j5) - j15);
        iArr2[11] = (int) j28;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j3 = (((long) iArr[0]) & BodyPartID.bodyIdMax) + j2;
            iArr[0] = (int) j3;
            long j4 = (j3 >> 32) + ((((long) iArr[1]) & BodyPartID.bodyIdMax) - j2);
            iArr[1] = (int) j4;
            long j5 = j4 >> 32;
            if (j5 != 0) {
            ...
            long j7 = j5 + (((long) iArr[3]) & BodyPartID.bodyIdMax) + j2;
            iArr[3] = (int) j7;
            long j8 = (j7 >> 32) + (BodyPartID.bodyIdMax & ((long) iArr[4])) + j2;
            iArr[4] = (int) j8;
            j = j8 >> 32;
        } else {
            j = 0;
        }
        if ((j == 0 || Nat.incAt(12, iArr, 5) == 0) && !(iArr[11] == -1 && Nat.gte(12, iArr, f4754P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(12, iArr, 0, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f4754P))) {
            addPInvTo(iArr2);
        }
    }
}
