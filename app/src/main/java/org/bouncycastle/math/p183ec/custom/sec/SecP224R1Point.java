...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f4703x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f4704y;
        ...
        SecP224R1FieldElement secP224R1FieldElement5 = (SecP224R1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP224R1FieldElement3.f4744x;
            iArr2 = secP224R1FieldElement4.f4744x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f4744x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement3.f4744x, iArrCreate);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement5.f4744x, iArrCreate2);
            SecP224R1Field.multiply(iArrCreate2, secP224R1FieldElement4.f4744x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224R1FieldElement.f4744x;
            iArr4 = secP224R1FieldElement2.f4744x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f4744x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement.f4744x, iArrCreateExt);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement6.f4744x, iArrCreate3);
            SecP224R1Field.multiply(iArrCreate3, secP224R1FieldElement2.f4744x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224R1Field.square(iArrCreate, secP224R1FieldElement7.f4744x);
        int[] iArr5 = secP224R1FieldElement7.f4744x;
        ...
        SecP224R1Field.subtract(iArrCreate2, secP224R1FieldElement7.f4744x, secP224R1FieldElement8.f4744x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f4744x, iArrCreate, iArrCreateExt);
        SecP224R1Field.reduce(iArrCreateExt, secP224R1FieldElement8.f4744x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP224R1FieldElement9.f4744x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement5.f4744x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP224R1FieldElement9.f4744x;
            SecP224R1Field.multiply(iArr7, secP224R1FieldElement6.f4744x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f4704y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f4703x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat224.create();
        int[] iArrCreate2 = Nat224.create();
        int[] iArrCreate3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f4744x, iArrCreate3);
        int[] iArrCreate4 = Nat224.create();
        SecP224R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f4744x;
        if (!zIsOne) {
            SecP224R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f4744x, iArr, iArrCreate);
        SecP224R1Field.add(secP224R1FieldElement2.f4744x, iArr, iArrCreate2);
        ...
        SecP224R1Field.square(iArrCreate2, secP224R1FieldElement4.f4744x);
        int[] iArr2 = secP224R1FieldElement4.f4744x;
        SecP224R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP224R1FieldElement4.f4744x;
        ...
        SecP224R1Field.subtract(iArrCreate3, secP224R1FieldElement4.f4744x, secP224R1FieldElement5.f4744x);
        int[] iArr4 = secP224R1FieldElement5.f4744x;
        SecP224R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP224R1FieldElement5.f4744x;
        ...
        SecP224R1Field.twice(secP224R1FieldElement.f4744x, secP224R1FieldElement6.f4744x);
        if (!zIsOne) {
            int[] iArr6 = secP224R1FieldElement6.f4744x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement3.f4744x, iArr6);
        }
