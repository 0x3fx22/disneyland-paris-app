...
public class SecP256K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f4703x;
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f4704y;
        ...
        SecP256K1FieldElement secP256K1FieldElement5 = (SecP256K1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP256K1FieldElement3.f4748x;
            iArr2 = secP256K1FieldElement4.f4748x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement5.f4748x, iArrCreate2);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement3.f4748x, iArrCreate);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement5.f4748x, iArrCreate2);
            SecP256K1Field.multiply(iArrCreate2, secP256K1FieldElement4.f4748x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP256K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP256K1FieldElement.f4748x;
            iArr4 = secP256K1FieldElement2.f4748x;
        } else {
            SecP256K1Field.square(secP256K1FieldElement6.f4748x, iArrCreate3);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement.f4748x, iArrCreateExt);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement6.f4748x, iArrCreate3);
            SecP256K1Field.multiply(iArrCreate3, secP256K1FieldElement2.f4748x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP256K1Field.square(iArrCreate, secP256K1FieldElement7.f4748x);
        int[] iArr5 = secP256K1FieldElement7.f4748x;
        ...
        SecP256K1Field.subtract(iArrCreate2, secP256K1FieldElement7.f4748x, secP256K1FieldElement8.f4748x);
        SecP256K1Field.multiplyAddToExt(secP256K1FieldElement8.f4748x, iArrCreate, iArrCreateExt);
        SecP256K1Field.reduce(iArrCreateExt, secP256K1FieldElement8.f4748x);
        SecP256K1FieldElement secP256K1FieldElement9 = new SecP256K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP256K1FieldElement9.f4748x;
            SecP256K1Field.multiply(iArr6, secP256K1FieldElement5.f4748x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP256K1FieldElement9.f4748x;
            SecP256K1Field.multiply(iArr7, secP256K1FieldElement6.f4748x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256K1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256K1FieldElement secP256K1FieldElement = (SecP256K1FieldElement) this.f4704y;
        if (secP256K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256K1FieldElement secP256K1FieldElement2 = (SecP256K1FieldElement) this.f4703x;
        SecP256K1FieldElement secP256K1FieldElement3 = (SecP256K1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement.f4748x, iArrCreate);
        int[] iArrCreate2 = Nat256.create();
        SecP256K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat256.create();
        SecP256K1Field.square(secP256K1FieldElement2.f4748x, iArrCreate3);
        SecP256K1Field.reduce32(Nat256.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP256K1Field.multiply(iArrCreate, secP256K1FieldElement2.f4748x, iArrCreate);
        ...
        SecP256K1Field.square(iArrCreate3, secP256K1FieldElement4.f4748x);
        int[] iArr = secP256K1FieldElement4.f4748x;
        SecP256K1Field.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = secP256K1FieldElement4.f4748x;
        ...
        SecP256K1Field.subtract(iArrCreate, secP256K1FieldElement4.f4748x, secP256K1FieldElement5.f4748x);
        int[] iArr3 = secP256K1FieldElement5.f4748x;
        SecP256K1Field.multiply(iArr3, iArrCreate3, iArr3);
        int[] iArr4 = secP256K1FieldElement5.f4748x;
        ...
        SecP256K1Field.twice(secP256K1FieldElement.f4748x, secP256K1FieldElement6.f4748x);
        if (!secP256K1FieldElement3.isOne()) {
            int[] iArr5 = secP256K1FieldElement6.f4748x;
            SecP256K1Field.multiply(iArr5, secP256K1FieldElement3.f4748x, iArr5);
        }
