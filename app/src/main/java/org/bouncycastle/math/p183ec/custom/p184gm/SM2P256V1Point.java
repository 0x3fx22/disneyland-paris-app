package org.bouncycastle.math.p183ec.custom.p184gm;
...
public class SM2P256V1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SM2P256V1FieldElement sM2P256V1FieldElement = (SM2P256V1FieldElement) this.f4703x;
        SM2P256V1FieldElement sM2P256V1FieldElement2 = (SM2P256V1FieldElement) this.f4704y;
        ...
        SM2P256V1FieldElement sM2P256V1FieldElement5 = (SM2P256V1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = sM2P256V1FieldElement3.f4715x;
            iArr2 = sM2P256V1FieldElement4.f4715x;
        } else {
            SM2P256V1Field.square(sM2P256V1FieldElement5.f4715x, iArrCreate2);
            SM2P256V1Field.multiply(iArrCreate2, sM2P256V1FieldElement3.f4715x, iArrCreate);
            SM2P256V1Field.multiply(iArrCreate2, sM2P256V1FieldElement5.f4715x, iArrCreate2);
            SM2P256V1Field.multiply(iArrCreate2, sM2P256V1FieldElement4.f4715x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = sM2P256V1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = sM2P256V1FieldElement.f4715x;
            iArr4 = sM2P256V1FieldElement2.f4715x;
        } else {
            SM2P256V1Field.square(sM2P256V1FieldElement6.f4715x, iArrCreate3);
            SM2P256V1Field.multiply(iArrCreate3, sM2P256V1FieldElement.f4715x, iArrCreateExt);
            SM2P256V1Field.multiply(iArrCreate3, sM2P256V1FieldElement6.f4715x, iArrCreate3);
            SM2P256V1Field.multiply(iArrCreate3, sM2P256V1FieldElement2.f4715x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SM2P256V1Field.square(iArrCreate, sM2P256V1FieldElement7.f4715x);
        int[] iArr5 = sM2P256V1FieldElement7.f4715x;
        ...
        SM2P256V1Field.subtract(iArrCreate2, sM2P256V1FieldElement7.f4715x, sM2P256V1FieldElement8.f4715x);
        SM2P256V1Field.multiplyAddToExt(sM2P256V1FieldElement8.f4715x, iArrCreate, iArrCreateExt);
        SM2P256V1Field.reduce(iArrCreateExt, sM2P256V1FieldElement8.f4715x);
        SM2P256V1FieldElement sM2P256V1FieldElement9 = new SM2P256V1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = sM2P256V1FieldElement9.f4715x;
            SM2P256V1Field.multiply(iArr6, sM2P256V1FieldElement5.f4715x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = sM2P256V1FieldElement9.f4715x;
            SM2P256V1Field.multiply(iArr7, sM2P256V1FieldElement6.f4715x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SM2P256V1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SM2P256V1FieldElement sM2P256V1FieldElement = (SM2P256V1FieldElement) this.f4704y;
        if (sM2P256V1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SM2P256V1FieldElement sM2P256V1FieldElement2 = (SM2P256V1FieldElement) this.f4703x;
        SM2P256V1FieldElement sM2P256V1FieldElement3 = (SM2P256V1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat256.create();
        int[] iArrCreate2 = Nat256.create();
        int[] iArrCreate3 = Nat256.create();
        SM2P256V1Field.square(sM2P256V1FieldElement.f4715x, iArrCreate3);
        int[] iArrCreate4 = Nat256.create();
        SM2P256V1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = sM2P256V1FieldElement3.isOne();
        int[] iArr = sM2P256V1FieldElement3.f4715x;
        if (!zIsOne) {
            SM2P256V1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SM2P256V1Field.subtract(sM2P256V1FieldElement2.f4715x, iArr, iArrCreate);
        SM2P256V1Field.add(sM2P256V1FieldElement2.f4715x, iArr, iArrCreate2);
        ...
        SM2P256V1Field.square(iArrCreate2, sM2P256V1FieldElement4.f4715x);
        int[] iArr2 = sM2P256V1FieldElement4.f4715x;
        SM2P256V1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = sM2P256V1FieldElement4.f4715x;
        ...
        SM2P256V1Field.subtract(iArrCreate3, sM2P256V1FieldElement4.f4715x, sM2P256V1FieldElement5.f4715x);
        int[] iArr4 = sM2P256V1FieldElement5.f4715x;
        SM2P256V1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = sM2P256V1FieldElement5.f4715x;
        ...
        SM2P256V1Field.twice(sM2P256V1FieldElement.f4715x, sM2P256V1FieldElement6.f4715x);
        if (!zIsOne) {
            int[] iArr6 = sM2P256V1FieldElement6.f4715x;
            SM2P256V1Field.multiply(iArr6, sM2P256V1FieldElement3.f4715x, iArr6);
        }
