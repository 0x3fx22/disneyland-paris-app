...
public class SecP384R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f4703x;
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f4704y;
        ...
        SecP384R1FieldElement secP384R1FieldElement5 = (SecP384R1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP384R1FieldElement3.f4756x;
            iArr2 = secP384R1FieldElement4.f4756x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement5.f4756x, iArrCreate3);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement3.f4756x, iArrCreate2);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement5.f4756x, iArrCreate3);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement4.f4756x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP384R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP384R1FieldElement.f4756x;
            iArr4 = secP384R1FieldElement2.f4756x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement6.f4756x, iArrCreate4);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement.f4756x, iArrCreate);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement6.f4756x, iArrCreate4);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement2.f4756x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP384R1Field.square(iArrCreate6, secP384R1FieldElement7.f4756x);
        int[] iArr5 = secP384R1FieldElement7.f4756x;
        ...
        SecP384R1Field.subtract(iArrCreate3, secP384R1FieldElement7.f4756x, secP384R1FieldElement8.f4756x);
        Nat384.mul(secP384R1FieldElement8.f4756x, iArrCreate6, iArrCreate2);
        SecP384R1Field.addExt(iArrCreate, iArrCreate2, iArrCreate);
        SecP384R1Field.reduce(iArrCreate, secP384R1FieldElement8.f4756x);
        SecP384R1FieldElement secP384R1FieldElement9 = new SecP384R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            int[] iArr6 = secP384R1FieldElement9.f4756x;
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement5.f4756x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP384R1FieldElement9.f4756x;
            SecP384R1Field.multiply(iArr7, secP384R1FieldElement6.f4756x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP384R1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f4704y;
        if (secP384R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f4703x;
        SecP384R1FieldElement secP384R1FieldElement3 = (SecP384R1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat.create(12);
        int[] iArrCreate2 = Nat.create(12);
        int[] iArrCreate3 = Nat.create(12);
        SecP384R1Field.square(secP384R1FieldElement.f4756x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(12);
        SecP384R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP384R1FieldElement3.isOne();
        int[] iArr = secP384R1FieldElement3.f4756x;
        if (!zIsOne) {
            SecP384R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP384R1Field.subtract(secP384R1FieldElement2.f4756x, iArr, iArrCreate);
        SecP384R1Field.add(secP384R1FieldElement2.f4756x, iArr, iArrCreate2);
        ...
        SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement2.f4756x, iArrCreate3);
        ...
        SecP384R1Field.square(iArrCreate2, secP384R1FieldElement4.f4756x);
        int[] iArr2 = secP384R1FieldElement4.f4756x;
        SecP384R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP384R1FieldElement4.f4756x;
        ...
        SecP384R1Field.subtract(iArrCreate3, secP384R1FieldElement4.f4756x, secP384R1FieldElement5.f4756x);
        int[] iArr4 = secP384R1FieldElement5.f4756x;
        SecP384R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP384R1FieldElement5.f4756x;
        ...
        SecP384R1Field.twice(secP384R1FieldElement.f4756x, secP384R1FieldElement6.f4756x);
        if (!zIsOne) {
            int[] iArr6 = secP384R1FieldElement6.f4756x;
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement3.f4756x, iArr6);
        }
