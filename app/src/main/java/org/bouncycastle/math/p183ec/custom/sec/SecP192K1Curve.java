...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4729q = SecP192K1FieldElement.f4731Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f4689b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f4732x, 0, iArr, i3);
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f4732x, 0, iArr, i3 + 6);
            i3 += 12;
        }
