...
public class SecP384R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4753q = SecP384R1FieldElement.f4755Q;
    ...
    public SecP384R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawXCoord()).f4756x, 0, iArr, i3);
            Nat.copy(12, ((SecP384R1FieldElement) eCPoint.getRawYCoord()).f4756x, 0, iArr, i3 + 12);
            i3 += 24;
        }
