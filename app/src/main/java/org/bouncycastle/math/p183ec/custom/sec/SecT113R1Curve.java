...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("003088250CA6E7C7FE649CE85820F7")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00E8BEE4D3E2260744188BE0E9C723")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawXCoord()).f4761x, 0, jArr, i3);
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawYCoord()).f4761x, 0, jArr, i3 + 2);
            i3 += 4;
        }
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < 2; i8++) {
                        ...
                        jArrCreate65[i8] = jArrCreate65[i8] ^ (jArr2[(i6 + 2) + i8] & j);
                    }
                    i6 += 4;
                }
