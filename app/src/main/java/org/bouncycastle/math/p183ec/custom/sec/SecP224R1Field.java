...
public class SecP224R1Field {
    ...
    static final int[] f4742P = {1, 0, 0, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f4742P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f4742P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j5 = j2 + (BodyPartID.bodyIdMax & ((long) iArr[3])) + 1;
        iArr[3] = (int) j5;
        if ((j5 >> 32) != 0) {
            Nat.incAt(7, iArr, 4);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f4742P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4742P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(7, iArr, f4742P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j8 = (((long) iArr[0]) & BodyPartID.bodyIdMax) - j5;
        long j9 = j8 & BodyPartID.bodyIdMax;
        long j10 = (j8 >> 32) + ((((long) iArr[1]) & BodyPartID.bodyIdMax) - j6);
        int i = (int) j10;
        iArr2[1] = i;
        long j11 = (j10 >> 32) + ((((long) iArr[2]) & BodyPartID.bodyIdMax) - j7);
        int i2 = (int) j11;
        iArr2[2] = i2;
        long j12 = (j11 >> 32) + (((((long) iArr[3]) & BodyPartID.bodyIdMax) + j5) - j);
        long j13 = j12 & BodyPartID.bodyIdMax;
        long j14 = (j12 >> 32) + (((((long) iArr[4]) & BodyPartID.bodyIdMax) + j6) - j2);
        iArr2[4] = (int) j14;
        long j15 = (j14 >> 32) + (((((long) iArr[5]) & BodyPartID.bodyIdMax) + j7) - j3);
        iArr2[5] = (int) j15;
        long j16 = (j15 >> 32) + (((((long) iArr[6]) & BodyPartID.bodyIdMax) + j) - j4);
        iArr2[6] = (int) j16;
        long j17 = (j16 >> 32) + 1;
        long j18 = j13 + j17;
        long j19 = j9 - j17;
        ...
        long j20 = j19 >> 32;
        if (j20 != 0) {
            long j21 = j20 + (((long) i) & BodyPartID.bodyIdMax);
            iArr2[1] = (int) j21;
            long j22 = (j21 >> 32) + (BodyPartID.bodyIdMax & ((long) i2));
            iArr2[2] = (int) j22;
            j18 += j22 >> 32;
        }
        iArr2[3] = (int) j18;
        if (((j18 >> 32) == 0 || Nat.incAt(7, iArr2, 4) == 0) && !(iArr2[6] == -1 && Nat224.gte(iArr2, f4742P))) {
            return;
        }
        addPInvTo(iArr2);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j7 = j4 + (BodyPartID.bodyIdMax & ((long) iArr[3])) + j2;
            iArr[3] = (int) j7;
            j = j7 >> 32;
        } else {
            j = 0;
        }
        if ((j == 0 || Nat.incAt(7, iArr, 4) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f4742P))) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f4742P))) {
            addPInvTo(iArr2);
        }
    }
}
