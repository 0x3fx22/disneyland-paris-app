...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4749q = SecP256R1FieldElement.f4751Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f4688a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f4689b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f4752x, 0, iArr, i3);
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f4752x, 0, iArr, i3 + 8);
            i3 += 16;
        }
