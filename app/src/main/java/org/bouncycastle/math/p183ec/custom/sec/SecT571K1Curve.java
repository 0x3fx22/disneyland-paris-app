...
public class SecT571K1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawXCoord()).f4769x, 0, jArr, i3);
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawYCoord()).f4769x, 0, jArr, i3 + 9);
            i3 += 18;
        }
            ...
            public ECPoint lookup(int i5) {
                ...
                for (int i7 = 0; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < 9; i8++) {
                        ...
                        jArrCreate65[i8] = jArrCreate65[i8] ^ (jArr2[(i6 + 9) + i8] & j);
                    }
                    i6 += 18;
                }
