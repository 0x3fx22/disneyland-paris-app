...
public class SecP256R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f4703x;
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f4704y;
        ...
        SecP256R1FieldElement secP256R1FieldElement5 = (SecP256R1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP256R1FieldElement3.f4752x;
            iArr2 = secP256R1FieldElement4.f4752x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement5.f4752x, iArrCreate2);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement3.f4752x, iArrCreate);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement5.f4752x, iArrCreate2);
            SecP256R1Field.multiply(iArrCreate2, secP256R1FieldElement4.f4752x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP256R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP256R1FieldElement.f4752x;
            iArr4 = secP256R1FieldElement2.f4752x;
        } else {
            SecP256R1Field.square(secP256R1FieldElement6.f4752x, iArrCreate3);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement.f4752x, iArrCreateExt);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement6.f4752x, iArrCreate3);
            SecP256R1Field.multiply(iArrCreate3, secP256R1FieldElement2.f4752x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP256R1Field.square(iArrCreate, secP256R1FieldElement7.f4752x);
        int[] iArr5 = secP256R1FieldElement7.f4752x;
        ...
        SecP256R1Field.subtract(iArrCreate2, secP256R1FieldElement7.f4752x, secP256R1FieldElement8.f4752x);
        SecP256R1Field.multiplyAddToExt(secP256R1FieldElement8.f4752x, iArrCreate, iArrCreateExt);
        SecP256R1Field.reduce(iArrCreateExt, secP256R1FieldElement8.f4752x);
        SecP256R1FieldElement secP256R1FieldElement9 = new SecP256R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP256R1FieldElement9.f4752x;
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement5.f4752x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP256R1FieldElement9.f4752x;
            SecP256R1Field.multiply(iArr7, secP256R1FieldElement6.f4752x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP256R1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP256R1FieldElement secP256R1FieldElement = (SecP256R1FieldElement) this.f4704y;
        if (secP256R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP256R1FieldElement secP256R1FieldElement2 = (SecP256R1FieldElement) this.f4703x;
        SecP256R1FieldElement secP256R1FieldElement3 = (SecP256R1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat256.create();
        int[] iArrCreate2 = Nat256.create();
        int[] iArrCreate3 = Nat256.create();
        SecP256R1Field.square(secP256R1FieldElement.f4752x, iArrCreate3);
        int[] iArrCreate4 = Nat256.create();
        SecP256R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP256R1FieldElement3.isOne();
        int[] iArr = secP256R1FieldElement3.f4752x;
        if (!zIsOne) {
            SecP256R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP256R1Field.subtract(secP256R1FieldElement2.f4752x, iArr, iArrCreate);
        SecP256R1Field.add(secP256R1FieldElement2.f4752x, iArr, iArrCreate2);
        ...
        SecP256R1Field.square(iArrCreate2, secP256R1FieldElement4.f4752x);
        int[] iArr2 = secP256R1FieldElement4.f4752x;
        SecP256R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP256R1FieldElement4.f4752x;
        ...
        SecP256R1Field.subtract(iArrCreate3, secP256R1FieldElement4.f4752x, secP256R1FieldElement5.f4752x);
        int[] iArr4 = secP256R1FieldElement5.f4752x;
        SecP256R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP256R1FieldElement5.f4752x;
        ...
        SecP256R1Field.twice(secP256R1FieldElement.f4752x, secP256R1FieldElement6.f4752x);
        if (!zIsOne) {
            int[] iArr6 = secP256R1FieldElement6.f4752x;
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement3.f4752x, iArr6);
        }
