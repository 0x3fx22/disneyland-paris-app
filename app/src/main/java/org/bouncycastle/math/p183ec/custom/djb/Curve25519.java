...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4708q = Curve25519FieldElement.f4710Q;
    ...
    public Curve25519() {
        ...
        this.f4688a = fromBigInteger(C_a);
        this.f4689b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f4711x, 0, iArr, i3);
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f4711x, 0, iArr, i3 + 8);
            i3 += 16;
        }
