...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f4703x;
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f4704y;
        ...
        SecP160R2FieldElement secP160R2FieldElement5 = (SecP160R2FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP160R2FieldElement3.f4728x;
            iArr2 = secP160R2FieldElement4.f4728x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement5.f4728x, iArrCreate2);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement3.f4728x, iArrCreate);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement5.f4728x, iArrCreate2);
            SecP160R2Field.multiply(iArrCreate2, secP160R2FieldElement4.f4728x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R2FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R2FieldElement.f4728x;
            iArr4 = secP160R2FieldElement2.f4728x;
        } else {
            SecP160R2Field.square(secP160R2FieldElement6.f4728x, iArrCreate3);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement.f4728x, iArrCreateExt);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement6.f4728x, iArrCreate3);
            SecP160R2Field.multiply(iArrCreate3, secP160R2FieldElement2.f4728x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R2Field.square(iArrCreate, secP160R2FieldElement7.f4728x);
        int[] iArr5 = secP160R2FieldElement7.f4728x;
        ...
        SecP160R2Field.subtract(iArrCreate2, secP160R2FieldElement7.f4728x, secP160R2FieldElement8.f4728x);
        SecP160R2Field.multiplyAddToExt(secP160R2FieldElement8.f4728x, iArrCreate, iArrCreateExt);
        SecP160R2Field.reduce(iArrCreateExt, secP160R2FieldElement8.f4728x);
        SecP160R2FieldElement secP160R2FieldElement9 = new SecP160R2FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP160R2FieldElement9.f4728x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement5.f4728x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP160R2FieldElement9.f4728x;
            SecP160R2Field.multiply(iArr7, secP160R2FieldElement6.f4728x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R2FieldElement secP160R2FieldElement = (SecP160R2FieldElement) this.f4704y;
        if (secP160R2FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R2FieldElement secP160R2FieldElement2 = (SecP160R2FieldElement) this.f4703x;
        SecP160R2FieldElement secP160R2FieldElement3 = (SecP160R2FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f4728x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R2Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f4728x;
        if (!zIsOne) {
            SecP160R2Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f4728x, iArr, iArrCreate);
        SecP160R2Field.add(secP160R2FieldElement2.f4728x, iArr, iArrCreate2);
        ...
        SecP160R2Field.square(iArrCreate2, secP160R2FieldElement4.f4728x);
        int[] iArr2 = secP160R2FieldElement4.f4728x;
        SecP160R2Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP160R2FieldElement4.f4728x;
        ...
        SecP160R2Field.subtract(iArrCreate3, secP160R2FieldElement4.f4728x, secP160R2FieldElement5.f4728x);
        int[] iArr4 = secP160R2FieldElement5.f4728x;
        SecP160R2Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP160R2FieldElement5.f4728x;
        ...
        SecP160R2Field.twice(secP160R2FieldElement.f4728x, secP160R2FieldElement6.f4728x);
        if (!zIsOne) {
            int[] iArr6 = secP160R2FieldElement6.f4728x;
            SecP160R2Field.multiply(iArr6, secP160R2FieldElement3.f4728x, iArr6);
        }
