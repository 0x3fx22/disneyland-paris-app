...
public class SecP224K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f4703x;
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f4704y;
        ...
        SecP224K1FieldElement secP224K1FieldElement5 = (SecP224K1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP224K1FieldElement3.f4740x;
            iArr2 = secP224K1FieldElement4.f4740x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement5.f4740x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement3.f4740x, iArrCreate);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement5.f4740x, iArrCreate2);
            SecP224K1Field.multiply(iArrCreate2, secP224K1FieldElement4.f4740x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP224K1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP224K1FieldElement.f4740x;
            iArr4 = secP224K1FieldElement2.f4740x;
        } else {
            SecP224K1Field.square(secP224K1FieldElement6.f4740x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement.f4740x, iArrCreateExt);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement6.f4740x, iArrCreate3);
            SecP224K1Field.multiply(iArrCreate3, secP224K1FieldElement2.f4740x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP224K1Field.square(iArrCreate, secP224K1FieldElement7.f4740x);
        int[] iArr5 = secP224K1FieldElement7.f4740x;
        ...
        SecP224K1Field.subtract(iArrCreate2, secP224K1FieldElement7.f4740x, secP224K1FieldElement8.f4740x);
        SecP224K1Field.multiplyAddToExt(secP224K1FieldElement8.f4740x, iArrCreate, iArrCreateExt);
        SecP224K1Field.reduce(iArrCreateExt, secP224K1FieldElement8.f4740x);
        SecP224K1FieldElement secP224K1FieldElement9 = new SecP224K1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP224K1FieldElement9.f4740x;
            SecP224K1Field.multiply(iArr6, secP224K1FieldElement5.f4740x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP224K1FieldElement9.f4740x;
            SecP224K1Field.multiply(iArr7, secP224K1FieldElement6.f4740x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224K1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224K1FieldElement secP224K1FieldElement = (SecP224K1FieldElement) this.f4704y;
        if (secP224K1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement) this.f4703x;
        SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement.f4740x, iArrCreate);
        int[] iArrCreate2 = Nat224.create();
        SecP224K1Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat224.create();
        SecP224K1Field.square(secP224K1FieldElement2.f4740x, iArrCreate3);
        SecP224K1Field.reduce32(Nat224.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP224K1Field.multiply(iArrCreate, secP224K1FieldElement2.f4740x, iArrCreate);
        ...
        SecP224K1Field.square(iArrCreate3, secP224K1FieldElement4.f4740x);
        int[] iArr = secP224K1FieldElement4.f4740x;
        SecP224K1Field.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = secP224K1FieldElement4.f4740x;
        ...
        SecP224K1Field.subtract(iArrCreate, secP224K1FieldElement4.f4740x, secP224K1FieldElement5.f4740x);
        int[] iArr3 = secP224K1FieldElement5.f4740x;
        SecP224K1Field.multiply(iArr3, iArrCreate3, iArr3);
        int[] iArr4 = secP224K1FieldElement5.f4740x;
        ...
        SecP224K1Field.twice(secP224K1FieldElement.f4740x, secP224K1FieldElement6.f4740x);
        if (!secP224K1FieldElement3.isOne()) {
            int[] iArr5 = secP224K1FieldElement6.f4740x;
            SecP224K1Field.multiply(iArr5, secP224K1FieldElement3.f4740x, iArr5);
        }
