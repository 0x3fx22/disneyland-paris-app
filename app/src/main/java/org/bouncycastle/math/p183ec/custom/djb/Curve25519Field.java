...
public class Curve25519Field {
    ...
    static final int[] f4709P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        int[] iArr2 = PExt;
        long j2 = j + (((long) iArr2[0]) & BodyPartID.bodyIdMax);
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(8, iArr, 1);
        }
        long j3 = jIncAt + ((((long) iArr[8]) & BodyPartID.bodyIdMax) - 19);
        iArr[8] = (int) j3;
        long jDecAt = j3 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j4 = jDecAt + (((long) iArr[15]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) (iArr2[15] + 1)));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }

    private static int addPTo(int[] iArr) {
        long j = (((long) iArr[0]) & BodyPartID.bodyIdMax) - 19;
        iArr[0] = (int) j;
        long jDecAt = j >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(7, iArr, 1);
        }
        long j2 = jDecAt + (BodyPartID.bodyIdMax & ((long) iArr[7])) + 2147483648L;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat256.add(iArr, f4709P, iArr2);
            Nat.shiftDownBit(8, iArr2, 0);
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4709P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f4709P) == 0);
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j3 = jDecAt + (((long) iArr[8]) & BodyPartID.bodyIdMax) + 19;
        iArr[8] = (int) j3;
        long jIncAt = j3 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j4 = jIncAt + ((((long) iArr[15]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) (iArr2[15] + 1))));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = jIncAt + ((BodyPartID.bodyIdMax & ((long) iArr[7])) - 2147483648L);
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
