...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f4728x, iArrCreate);
        int[] iArrCreate2 = Nat160.create();
        SecP160R2Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f4728x, iArrCreate3);
        SecP160R2Field.reduce32(Nat160.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP160R2Field.multiply(iArrCreate, secP160R2FieldElement2.f4728x, iArrCreate);
        ...
        SecP160R2Field.square(iArrCreate3, secP160R2FieldElement4.f4728x);
        int[] iArr = secP160R2FieldElement4.f4728x;
        ...
        SecP160R2Field.subtract(iArrCreate, secP160R2FieldElement4.f4728x, secP160R2FieldElement5.f4728x);
        int[] iArr3 = secP160R2FieldElement5.f4728x;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f4728x;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f4728x, iArr5);
        }
