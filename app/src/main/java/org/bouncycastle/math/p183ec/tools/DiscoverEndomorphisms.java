package org.bouncycastle.math.p183ec.tools;
...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] solveQuadraticEquation(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        ECFieldElement eCFieldElementSqrt = new ECFieldElement.C7836Fp(bigInteger, bigInteger3.multiply(bigInteger3).subtract(bigInteger2.multiply(bigInteger4).shiftLeft(2)).mod(bigInteger)).sqrt();
        if (eCFieldElementSqrt == null) {
