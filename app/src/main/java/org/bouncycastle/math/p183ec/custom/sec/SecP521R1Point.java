...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f4703x;
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f4704y;
        ...
        SecP521R1FieldElement secP521R1FieldElement5 = (SecP521R1FieldElement) this.f4705zs[0];
        ...
        if (zIsOne) {
            iArr = secP521R1FieldElement3.f4760x;
            iArr2 = secP521R1FieldElement4.f4760x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement5.f4760x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement3.f4760x, iArrCreate2);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement5.f4760x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement4.f4760x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP521R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP521R1FieldElement.f4760x;
            iArr4 = secP521R1FieldElement2.f4760x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement6.f4760x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement.f4760x, iArrCreate);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement6.f4760x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement2.f4760x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement7.f4760x);
        int[] iArr5 = secP521R1FieldElement7.f4760x;
        SecP521R1Field.add(iArr5, iArrCreate6, iArr5);
        int[] iArr6 = secP521R1FieldElement7.f4760x;
        SecP521R1Field.subtract(iArr6, iArrCreate3, iArr6);
        int[] iArr7 = secP521R1FieldElement7.f4760x;
        ...
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement7.f4760x, secP521R1FieldElement8.f4760x);
        SecP521R1Field.multiply(secP521R1FieldElement8.f4760x, iArrCreate2, iArrCreate2);
        SecP521R1Field.subtract(iArrCreate2, iArrCreate, secP521R1FieldElement8.f4760x);
        SecP521R1FieldElement secP521R1FieldElement9 = new SecP521R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            int[] iArr8 = secP521R1FieldElement9.f4760x;
            SecP521R1Field.multiply(iArr8, secP521R1FieldElement5.f4760x, iArr8);
        }
        if (!zIsOne2) {
            int[] iArr9 = secP521R1FieldElement9.f4760x;
            SecP521R1Field.multiply(iArr9, secP521R1FieldElement6.f4760x, iArr9);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP521R1Point(this.curve, this.f4703x, this.f4704y.negate(), this.f4705zs);
    }
    ...
    public ECPoint threeTimes() {
        return (isInfinity() || this.f4704y.isZero()) ? this : twice().add(this);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f4704y;
        if (secP521R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f4703x;
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) this.f4705zs[0];
        int[] iArrCreate = Nat.create(17);
        int[] iArrCreate2 = Nat.create(17);
        int[] iArrCreate3 = Nat.create(17);
        SecP521R1Field.square(secP521R1FieldElement.f4760x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(17);
        SecP521R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP521R1FieldElement3.isOne();
        int[] iArr = secP521R1FieldElement3.f4760x;
        if (!zIsOne) {
            SecP521R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP521R1Field.subtract(secP521R1FieldElement2.f4760x, iArr, iArrCreate);
        SecP521R1Field.add(secP521R1FieldElement2.f4760x, iArr, iArrCreate2);
        ...
        SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement2.f4760x, iArrCreate3);
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement4.f4760x);
        int[] iArr2 = secP521R1FieldElement4.f4760x;
        SecP521R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP521R1FieldElement4.f4760x;
        ...
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement4.f4760x, secP521R1FieldElement5.f4760x);
        int[] iArr4 = secP521R1FieldElement5.f4760x;
        SecP521R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP521R1FieldElement5.f4760x;
        ...
        SecP521R1Field.twice(secP521R1FieldElement.f4760x, secP521R1FieldElement6.f4760x);
        if (!zIsOne) {
            int[] iArr6 = secP521R1FieldElement6.f4760x;
            SecP521R1Field.multiply(iArr6, secP521R1FieldElement3.f4760x, iArr6);
        }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return this.f4704y.isZero() ? eCPoint : twice().add(eCPoint);
    }
