...
import org.bouncycastle.math.p183ec.rfc7748.X448;
import org.bouncycastle.math.p183ec.rfc7748.X448Field;
...
public abstract class Ed448 {
    ...
    private static final int[] f4787P = {-1, -1, -1, -1, -1, -1, -1, -2, -1, -1, -1, -1, -1, -1};

    /* JADX INFO: renamed from: L */
    private static final int[] f4786L = {-1420278541, 595116690, -1916432555, 560775794, -1361693040, -1001465015, 2093622249, -1, -1, -1, -1, -1, -1, LockFreeTaskQueueCore.MAX_CAPACITY_MASK};
    ...
    private static class PointExt {
        ...
        private PointExt() {
            this.f4788x = X448Field.create();
            this.f4789y = X448Field.create();
            this.f4790z = X448Field.create();
        }
    }
    ...
    private static class PointPrecomp {
        ...
        private PointPrecomp() {
            this.f4791x = X448Field.create();
            this.f4792y = X448Field.create();
        }
    }
    ...
    private static boolean decodePointVar(byte[] bArr, int i, boolean z, PointExt pointExt) {
        ...
        X448Field.decode(bArrCopyOfRange, 0, pointExt.f4789y);
        int[] iArrCreate = X448Field.create();
        int[] iArrCreate2 = X448Field.create();
        X448Field.sqr(pointExt.f4789y, iArrCreate);
        ...
        if (!X448Field.sqrtRatioVar(iArrCreate, iArrCreate2, pointExt.f4788x)) {
            return false;
        }
        X448Field.normalize(pointExt.f4788x);
        if (i2 == 1 && X448Field.isZeroVar(pointExt.f4788x)) {
            return false;
        }
        int[] iArr = pointExt.f4788x;
        if (z ^ (i2 != (iArr[0] & 1))) {
    ...
    private static int encodePoint(PointExt pointExt, byte[] bArr, int i) {
        int[] iArrCreate = X448Field.create();
        int[] iArrCreate2 = X448Field.create();
        X448Field.inv(pointExt.f4790z, iArrCreate2);
        X448Field.mul(pointExt.f4788x, iArrCreate2, iArrCreate);
        X448Field.mul(pointExt.f4789y, iArrCreate2, iArrCreate2);
        X448Field.normalize(iArrCreate);
    ...
    private static void pointAddPrecomp(PointPrecomp pointPrecomp, PointExt pointExt) {
        ...
        X448Field.sqr(pointExt.f4790z, iArrCreate);
        X448Field.mul(pointPrecomp.f4791x, pointExt.f4788x, iArrCreate2);
        X448Field.mul(pointPrecomp.f4792y, pointExt.f4789y, iArrCreate3);
        ...
        X448Field.add(pointPrecomp.f4791x, pointPrecomp.f4792y, iArrCreate);
        X448Field.add(pointExt.f4788x, pointExt.f4789y, iArrCreate4);
        ...
        X448Field.mul(iArrCreate7, pointExt.f4790z, iArrCreate7);
        X448Field.mul(iArrCreate4, pointExt.f4790z, iArrCreate4);
        X448Field.mul(iArrCreate5, iArrCreate7, pointExt.f4788x);
        X448Field.mul(iArrCreate4, iArrCreate6, pointExt.f4789y);
        X448Field.mul(iArrCreate5, iArrCreate6, pointExt.f4790z);
    }
    ...
    private static void pointAddVar(boolean z, PointExt pointExt, PointExt pointExt2) {
        ...
        if (z) {
            X448Field.sub(pointExt.f4789y, pointExt.f4788x, iArrCreate8);
            iArr2 = iArrCreate2;
            iArr = iArrCreate5;
            iArr4 = iArrCreate6;
            iArr3 = iArrCreate7;
        } else {
            X448Field.add(pointExt.f4789y, pointExt.f4788x, iArrCreate8);
            iArr = iArrCreate2;
            iArr2 = iArrCreate5;
            iArr3 = iArrCreate6;
            iArr4 = iArrCreate7;
        }
        X448Field.mul(pointExt.f4790z, pointExt2.f4790z, iArrCreate);
        X448Field.sqr(iArrCreate, iArrCreate2);
        X448Field.mul(pointExt.f4788x, pointExt2.f4788x, iArrCreate3);
        X448Field.mul(pointExt.f4789y, pointExt2.f4789y, iArrCreate4);
        ...
        X448Field.add(pointExt2.f4788x, pointExt2.f4789y, iArrCreate5);
        ...
        X448Field.mul(iArrCreate6, iArrCreate8, pointExt2.f4788x);
        X448Field.mul(iArrCreate5, iArrCreate7, pointExt2.f4789y);
        X448Field.mul(iArrCreate6, iArrCreate7, pointExt2.f4790z);
    }
    ...
    private static void pointCopy(PointExt pointExt, PointExt pointExt2) {
        X448Field.copy(pointExt.f4788x, 0, pointExt2.f4788x, 0);
        X448Field.copy(pointExt.f4789y, 0, pointExt2.f4789y, 0);
        X448Field.copy(pointExt.f4790z, 0, pointExt2.f4790z, 0);
    }
    ...
    private static void pointDouble(PointExt pointExt) {
        ...
        int[] iArrCreate5 = X448Field.create();
        int[] iArrCreate6 = X448Field.create();
        X448Field.add(pointExt.f4788x, pointExt.f4789y, iArrCreate);
        X448Field.sqr(iArrCreate, iArrCreate);
        X448Field.sqr(pointExt.f4788x, iArrCreate2);
        X448Field.sqr(pointExt.f4789y, iArrCreate3);
        X448Field.add(iArrCreate2, iArrCreate3, iArrCreate4);
        X448Field.carry(iArrCreate4);
        X448Field.sqr(pointExt.f4790z, iArrCreate5);
        ...
        X448Field.mul(iArrCreate, iArrCreate6, pointExt.f4788x);
        X448Field.mul(iArrCreate4, iArrCreate2, pointExt.f4789y);
        X448Field.mul(iArrCreate4, iArrCreate6, pointExt.f4790z);
    }

    private static void pointExtendXY(PointExt pointExt) {
        X448Field.one(pointExt.f4790z);
    }
    ...
    private static void pointLookup(int i, int i2, PointPrecomp pointPrecomp) {
        ...
        for (int i4 = 0; i4 < 16; i4++) {
            int i5 = ((i4 ^ i2) - 1) >> 31;
            X448Field.cmov(i5, precompBase, i3, pointPrecomp.f4791x, 0);
            X448Field.cmov(i5, precompBase, i3 + 16, pointPrecomp.f4792y, 0);
            i3 += 32;
        }
    }
    ...
    private static void pointSetNeutral(PointExt pointExt) {
        X448Field.zero(pointExt.f4788x);
        X448Field.one(pointExt.f4789y);
        X448Field.one(pointExt.f4790z);
    }
    ...
    public static void precompute() {
        synchronized (precompLock) {
            try {
                ...
                PointExt pointExt = new PointExt();
                X448Field.copy(B_x, 0, pointExt.f4788x, 0);
                X448Field.copy(B_y, 0, pointExt.f4789y, 0);
                pointExtendXY(pointExt);
                ...
                for (int i2 = 0; i2 < 5; i2++) {
                    ...
                    int[] iArrCreate = X448Field.create();
                    X448Field.copy(pointExtArr2[0].f4790z, 0, iArrCreate, 0);
                    ...
                    while (true) {
                        ...
                        X448Field.mul(iArrCreate, pointExtArr2[i10].f4790z, iArrCreate);
                    ...
                    while (i9 > 0) {
                        ...
                        X448Field.mul(iArrCreate, pointExtArr2[i9].f4790z, iArrCreate);
                        i9 = i11;
                    }
                    X448Field.copy(iArrCreate, 0, iArrCreateTable, 0);
                    for (int i12 = 0; i12 < 16; i12++) {
                        PointExt pointExt3 = pointExtArr2[i12];
                        X448Field.copy(iArrCreateTable, i12 * 16, pointExt3.f4790z, 0);
                        int[] iArr = pointExt3.f4788x;
                        X448Field.mul(iArr, pointExt3.f4790z, iArr);
                        int[] iArr2 = pointExt3.f4789y;
                        X448Field.mul(iArr2, pointExt3.f4790z, iArr2);
                        X448Field.copy(pointExt3.f4788x, 0, precompBase, i);
                        X448Field.copy(pointExt3.f4789y, 0, precompBase, i + 16);
                        i += 32;
                    }
                }
            } catch (Throwable th) {
    ...
    private static byte[] reduceScalar(byte[] bArr) {
        ...
        long jDecode39 = ((long) decode32(bArr, 49)) & BodyPartID.bodyIdMax;
        long jDecode211 = ((long) (decode24(bArr, 53) << 4)) & BodyPartID.bodyIdMax;
        long jDecode310 = ((long) decode32(bArr, 56)) & BodyPartID.bodyIdMax;
        long jDecode212 = ((long) (decode24(bArr, 60) << 4)) & BodyPartID.bodyIdMax;
        long jDecode311 = ((long) decode32(bArr, 63)) & BodyPartID.bodyIdMax;
        long jDecode213 = ((long) (decode24(bArr, 67) << 4)) & BodyPartID.bodyIdMax;
        long jDecode312 = ((long) decode32(bArr, 70)) & BodyPartID.bodyIdMax;
        long jDecode214 = ((long) (decode24(bArr, 74) << 4)) & BodyPartID.bodyIdMax;
        long jDecode313 = ((long) decode32(bArr, 77)) & BodyPartID.bodyIdMax;
        long jDecode215 = ((long) (decode24(bArr, 81) << 4)) & BodyPartID.bodyIdMax;
        long jDecode314 = decode32(bArr, 84);
        long j = jDecode314 & BodyPartID.bodyIdMax;
        long jDecode216 = ((long) (decode24(bArr, 88) << 4)) & BodyPartID.bodyIdMax;
        long jDecode315 = decode32(bArr, 91);
        long j2 = jDecode315 & BodyPartID.bodyIdMax;
        long jDecode217 = ((long) (decode24(bArr, 95) << 4)) & BodyPartID.bodyIdMax;
        long jDecode316 = decode32(bArr, 98);
        long j3 = jDecode316 & BodyPartID.bodyIdMax;
        long jDecode218 = ((long) (decode24(bArr, 102) << 4)) & BodyPartID.bodyIdMax;
        long jDecode317 = decode32(bArr, 105);
        long j4 = jDecode317 & BodyPartID.bodyIdMax;
        long jDecode219 = ((long) (decode24(bArr, 109) << 4)) & BodyPartID.bodyIdMax;
        long jDecode16 = ((long) decode16(bArr, SyslogConstants.LOG_ALERT)) & BodyPartID.bodyIdMax;
        long j5 = jDecode219 + (j4 >>> 28);
        long j6 = jDecode317 & 268435455;
        long j7 = jDecode214 + (jDecode16 * 227822194) + (j5 * 149865618);
        long j8 = jDecode313 + (jDecode16 * 149865618) + (j5 * 550336261);
        long j9 = jDecode39 + (j6 * 43969588);
        long j10 = jDecode211 + (j5 * 43969588) + (j6 * 30366549);
        long j11 = jDecode310 + (jDecode16 * 43969588) + (j5 * 30366549) + (j6 * 163752818);
        long j12 = jDecode212 + (jDecode16 * 30366549) + (j5 * 163752818) + (j6 * 258169998);
        long j13 = jDecode311 + (jDecode16 * 163752818) + (j5 * 258169998) + (j6 * 96434764);
        long j14 = jDecode213 + (jDecode16 * 258169998) + (j5 * 96434764) + (j6 * 227822194);
        long j15 = jDecode312 + (jDecode16 * 96434764) + (j5 * 227822194) + (j6 * 149865618);
        long j16 = jDecode218 + (j3 >>> 28);
        long j17 = jDecode316 & 268435455;
        long j18 = jDecode210 + (j16 * 43969588);
        long j19 = j14 + (j16 * 149865618);
        long j20 = j15 + (j16 * 550336261);
        long j21 = jDecode38 + (j17 * 43969588);
        ...
        long j27 = jDecode217 + (j2 >>> 28);
        long j28 = jDecode315 & 268435455;
        long j29 = jDecode29 + (j27 * 43969588);
        long j30 = j26 + (j27 * 550336261);
        long j31 = jDecode37 + (j28 * 43969588);
        ...
        long j38 = jDecode216 + (j >>> 28);
        long j39 = j7 + (j6 * 550336261) + (j20 >>> 28);
        long j40 = j8 + (j39 >>> 28);
        long j41 = jDecode215 + (jDecode16 * 550336261) + (j40 >>> 28);
        long j42 = j40 & 268435455;
        long j43 = (jDecode314 & 268435455) + (j41 >>> 28);
        long j44 = j41 & 268435455;
        long j45 = jDecode27 + (j44 * 43969588);
        long j46 = jDecode36 + (j43 * 43969588) + (j44 * 30366549);
        long j47 = jDecode28 + (j38 * 43969588) + (j43 * 30366549) + (j44 * 163752818);
        ...
        long j53 = jDecode35 + (j42 * 43969588);
        long j54 = j30 + (j37 >>> 28);
        ...
        long j60 = jDecode34 + (j59 * 43969588);
        long j61 = jDecode26 + (j58 * 43969588) + (j59 * 30366549);
        ...
        long j77 = jDecode33 + (j71 * 43969588) + (30366549 * j72) + (175155932 * j75);
        long j78 = jDecode25 + (j57 * 43969588) + (j71 * 30366549) + (163752818 * j72) + (64542499 * j75);
    ...
    private static void scalarMultBase(byte[] bArr, PointExt pointExt) {
        ...
        int[] iArr = new int[15];
        decodeScalar(bArr, 0, iArr);
        iArr[14] = Nat.cadd(14, (~iArr[0]) & 1, iArr, f4786L, iArr) + 4;
        ...
        while (true) {
            ...
            for (int i3 = 0; i3 < 5; i3++) {
                ...
                X448Field.cnegate(i6, pointPrecomp.f4791x);
    ...
    public static void scalarMultBaseXY(X448.Friend friend, byte[] bArr, int i, int[] iArr, int[] iArr2) {
        ...
        if (checkPoint(pointExt.f4788x, pointExt.f4789y, pointExt.f4790z) == 0) {
            throw new IllegalStateException();
        }
        X448Field.copy(pointExt.f4788x, 0, iArr, 0);
        X448Field.copy(pointExt.f4789y, 0, iArr2, 0);
    }
