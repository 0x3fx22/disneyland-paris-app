...
public abstract class Nat160 {
    ...
    public static int addTo(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        iArr2[i6] = (int) j4;
        int i7 = i2 + 4;
        long j5 = (j4 >>> 32) + (((long) iArr[i + 4]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i7]));
        iArr2[i7] = (int) j5;
        return (int) (j5 >>> 32);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        long j4 = (j3 >>> 32) + (((long) iArr[3]) & BodyPartID.bodyIdMax) + (((long) iArr2[3]) & BodyPartID.bodyIdMax);
        iArr2[3] = (int) j4;
        long j5 = (j4 >>> 32) + (((long) iArr[4]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[4]));
        iArr2[4] = (int) j5;
        return (int) (j5 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        int i13 = i + 4;
        int i14 = i2 + 4;
        long j5 = (j4 >>> 32) + (((long) iArr[i13]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i14]));
        int i15 = (int) j5;
        iArr[i13] = i15;
        iArr2[i14] = i15;
        return (int) (j5 >>> 32);
    ...
    public static boolean m2101eq(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        long j6 = ((long) iArr[i]) & BodyPartID.bodyIdMax;
        long j7 = j6 * j;
        iArr3[i3] = (int) j7;
        long j8 = (j7 >>> 32) + (j6 * j2);
        iArr3[i3 + 1] = (int) j8;
        ...
        while (i4 < 5) {
            int i6 = i5 + 1;
            long j12 = ((long) iArr[i + i4]) & BodyPartID.bodyIdMax;
            long j13 = j;
            long j14 = (j12 * j) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j14;
            int i7 = i5 + 2;
            long j15 = (j14 >>> 32) + (j12 * j2) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax);
            iArr3[i7] = (int) j15;
            int i8 = i5 + 3;
            long j16 = j3;
            long j17 = (j15 >>> 32) + (j12 * j3) + (((long) iArr3[i8]) & BodyPartID.bodyIdMax);
            iArr3[i8] = (int) j17;
            int i9 = i5 + 4;
            int i10 = i5;
            long j18 = (j17 >>> 32) + (j12 * j4) + (((long) iArr3[i9]) & BodyPartID.bodyIdMax);
            iArr3[i9] = (int) j18;
            int i11 = i10 + 5;
            long j19 = (j18 >>> 32) + (j12 * j5) + (((long) iArr3[i11]) & BodyPartID.bodyIdMax);
            iArr3[i11] = (int) j19;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 5; i < i2; i2 = 5) {
            ...
            long j13 = (j12 * j) + (((long) iArr3[i]) & BodyPartID.bodyIdMax);
            iArr3[i] = (int) j13;
            int i3 = i + 1;
            long j14 = (j13 >>> 32) + (j12 * j2) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
            iArr3[i3] = (int) j14;
            int i4 = i + 2;
            long j15 = j2;
            long j16 = (j14 >>> 32) + (j12 * j3) + (((long) iArr3[i4]) & BodyPartID.bodyIdMax);
            iArr3[i4] = (int) j16;
            int i5 = i + 3;
            long j17 = (j16 >>> 32) + (j12 * j4) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j17;
            int i6 = i + 4;
            long j18 = (j17 >>> 32) + (j12 * j5) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j18;
    ...
    public static long mul33Add(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j12 = (j10 >>> 32) + (j * j11) + j9 + (BodyPartID.bodyIdMax & ((long) iArr2[i3 + 4]));
        iArr3[i4 + 4] = (int) j12;
        return (j12 >>> 32) + j11;
    }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        int i5 = i3;
        while (i4 < 5) {
            long j7 = ((long) iArr[i + i4]) & BodyPartID.bodyIdMax;
            long j8 = j;
            long j9 = (j7 * j) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j9;
            int i6 = i5 + 1;
            long j10 = (j9 >>> 32) + (j7 * j2) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j10;
            int i7 = i5 + 2;
            long j11 = (j10 >>> 32) + (j7 * j3) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax);
            iArr3[i7] = (int) j11;
            int i8 = i5 + 3;
            long j12 = (j11 >>> 32) + (j7 * j4) + (((long) iArr3[i8]) & BodyPartID.bodyIdMax);
            iArr3[i8] = (int) j12;
            int i9 = i5 + 4;
            long j13 = (j12 >>> 32) + (j7 * j5) + (((long) iArr3[i9]) & BodyPartID.bodyIdMax);
            iArr3[i9] = (int) j13;
            int i10 = i5 + 5;
            long j14 = j6 + (j13 >>> 32) + (((long) iArr3[i10]) & BodyPartID.bodyIdMax);
            iArr3[i10] = (int) j14;
            j6 = j14 >>> 32;
            i4++;
            i5 = i6;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            long j9 = j;
            long j10 = (j8 * j) + (((long) iArr3[i]) & BodyPartID.bodyIdMax);
            iArr3[i] = (int) j10;
            int i2 = i + 1;
            long j11 = (j10 >>> 32) + (j8 * j2) + (((long) iArr3[i2]) & BodyPartID.bodyIdMax);
            iArr3[i2] = (int) j11;
            int i3 = i + 2;
            long j12 = (j11 >>> 32) + (j8 * j3) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
            iArr3[i3] = (int) j12;
            int i4 = i + 3;
            long j13 = (j12 >>> 32) + (j8 * j4) + (((long) iArr3[i4]) & BodyPartID.bodyIdMax);
            iArr3[i4] = (int) j13;
            int i5 = i + 4;
            long j14 = (j13 >>> 32) + (j8 * j5) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j14;
            int i6 = i + 5;
            long j15 = j7 + (j14 >>> 32) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j15;
            j6 = j15 >>> 32;
            j = j9;
            i = i2;
    ...
    public static int mulWordAddExt(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        iArr2[i6] = (int) j5;
        int i7 = i3 + 4;
        long j6 = (j5 >>> 32) + (j * (((long) iArr[i2 + 4]) & BodyPartID.bodyIdMax)) + (((long) iArr2[i7]) & BodyPartID.bodyIdMax);
        iArr2[i7] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static int mulWordsAdd(int i, int i2, int[] iArr, int i3) {
        long j = ((((long) i2) & BodyPartID.bodyIdMax) * (((long) i) & BodyPartID.bodyIdMax)) + (((long) iArr[i3]) & BodyPartID.bodyIdMax);
        iArr[i3] = (int) j;
        int i4 = i3 + 1;
        long j2 = (j >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[i4]));
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[3] = (int) j4;
        long j5 = (j4 >> 32) + ((((long) iArr2[4]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[4])));
        iArr2[4] = (int) j5;
        return (int) (j5 >> 32);
    }
