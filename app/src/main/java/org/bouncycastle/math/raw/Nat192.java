...
public abstract class Nat192 {
    ...
    public static int addTo(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        iArr2[i7] = (int) j5;
        int i8 = i2 + 5;
        long j6 = (j5 >>> 32) + (((long) iArr[i + 5]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i8]));
        iArr2[i8] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        long j5 = (j4 >>> 32) + (((long) iArr[4]) & BodyPartID.bodyIdMax) + (((long) iArr2[4]) & BodyPartID.bodyIdMax);
        iArr2[4] = (int) j5;
        long j6 = (j5 >>> 32) + (((long) iArr[5]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[5]));
        iArr2[5] = (int) j6;
        return (int) (j6 >>> 32);
    }
    ...
    public static int addToEachOther(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        int i16 = i + 5;
        int i17 = i2 + 5;
        long j6 = (j5 >>> 32) + (((long) iArr[i16]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i17]));
        int i18 = (int) j6;
        iArr[i16] = i18;
        iArr2[i17] = i18;
        return (int) (j6 >>> 32);
    ...
    public static boolean m2102eq(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        long j7 = ((long) iArr[i]) & BodyPartID.bodyIdMax;
        long j8 = j7 * j;
        iArr3[i3] = (int) j8;
        long j9 = (j8 >>> 32) + (j7 * j2);
        iArr3[i3 + 1] = (int) j9;
        ...
        while (i4 < 6) {
            int i6 = i5 + 1;
            long j14 = ((long) iArr[i + i4]) & BodyPartID.bodyIdMax;
            long j15 = j6;
            long j16 = (j14 * j) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j16;
            int i7 = i5 + 2;
            int i8 = i4;
            long j17 = (j16 >>> 32) + (j14 * j2) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax);
            iArr3[i7] = (int) j17;
            int i9 = i5 + 3;
            long j18 = (j17 >>> 32) + (j14 * j3) + (((long) iArr3[i9]) & BodyPartID.bodyIdMax);
            iArr3[i9] = (int) j18;
            int i10 = i5 + 4;
            int i11 = i5;
            long j19 = (j18 >>> 32) + (j14 * j4) + (((long) iArr3[i10]) & BodyPartID.bodyIdMax);
            iArr3[i10] = (int) j19;
            int i12 = i11 + 5;
            long j20 = (j19 >>> 32) + (j14 * j5) + (((long) iArr3[i12]) & BodyPartID.bodyIdMax);
            iArr3[i12] = (int) j20;
            int i13 = i11 + 6;
            long j21 = (j20 >>> 32) + (j14 * j15) + (((long) iArr3[i13]) & BodyPartID.bodyIdMax);
            iArr3[i13] = (int) j21;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            ...
            long j15 = (j14 * j) + (((long) iArr3[i]) & BodyPartID.bodyIdMax);
            iArr3[i] = (int) j15;
            int i3 = i + 1;
            long j16 = (j15 >>> 32) + (j14 * j2) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
            iArr3[i3] = (int) j16;
            int i4 = i + 2;
            long j17 = j2;
            long j18 = (j16 >>> 32) + (j14 * j3) + (((long) iArr3[i4]) & BodyPartID.bodyIdMax);
            iArr3[i4] = (int) j18;
            int i5 = i + 3;
            long j19 = (j18 >>> 32) + (j14 * j4) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j19;
            int i6 = i + 4;
            long j20 = (j19 >>> 32) + (j14 * j5) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j20;
            int i7 = i + 5;
            long j21 = (j20 >>> 32) + (j14 * j6) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax);
            iArr3[i7] = (int) j21;
    ...
    public static long mul33Add(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j14 = (j12 >>> 32) + (j * j13) + j11 + (BodyPartID.bodyIdMax & ((long) iArr2[i3 + 5]));
        iArr3[i4 + 5] = (int) j14;
        return (j14 >>> 32) + j13;
    }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        int i5 = i3;
        while (i4 < 6) {
            long j8 = ((long) iArr[i + i4]) & BodyPartID.bodyIdMax;
            long j9 = j;
            long j10 = (j8 * j) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j10;
            int i6 = i5 + 1;
            long j11 = (j10 >>> 32) + (j8 * j2) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j11;
            int i7 = i5 + 2;
            long j12 = (j11 >>> 32) + (j8 * j3) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax);
            iArr3[i7] = (int) j12;
            int i8 = i5 + 3;
            long j13 = (j12 >>> 32) + (j8 * j4) + (((long) iArr3[i8]) & BodyPartID.bodyIdMax);
            iArr3[i8] = (int) j13;
            int i9 = i5 + 4;
            long j14 = (j13 >>> 32) + (j8 * j5) + (((long) iArr3[i9]) & BodyPartID.bodyIdMax);
            iArr3[i9] = (int) j14;
            int i10 = i5 + 5;
            long j15 = (j14 >>> 32) + (j8 * j6) + (((long) iArr3[i10]) & BodyPartID.bodyIdMax);
            iArr3[i10] = (int) j15;
            int i11 = i5 + 6;
            long j16 = (j15 >>> 32) + (((long) iArr3[i11]) & BodyPartID.bodyIdMax) + j7;
            iArr3[i11] = (int) j16;
            j7 = j16 >>> 32;
            i4++;
            j = j9;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 6) {
            ...
            long j10 = j;
            long j11 = (((long) iArr3[i]) & BodyPartID.bodyIdMax) + (j9 * j);
            iArr3[i] = (int) j11;
            int i2 = i + 1;
            long j12 = (j11 >>> 32) + (j9 * j2) + (((long) iArr3[i2]) & BodyPartID.bodyIdMax);
            iArr3[i2] = (int) j12;
            int i3 = i + 2;
            long j13 = (j12 >>> 32) + (j9 * j3) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
            iArr3[i3] = (int) j13;
            int i4 = i + 3;
            long j14 = (j13 >>> 32) + (j9 * j4) + (((long) iArr3[i4]) & BodyPartID.bodyIdMax);
            iArr3[i4] = (int) j14;
            int i5 = i + 4;
            long j15 = (j14 >>> 32) + (j9 * j5) + (((long) iArr3[i5]) & BodyPartID.bodyIdMax);
            iArr3[i5] = (int) j15;
            int i6 = i + 5;
            long j16 = (j15 >>> 32) + (j9 * j8) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j16;
            int i7 = i + 6;
            long j17 = (j16 >>> 32) + (((long) iArr3[i7]) & BodyPartID.bodyIdMax) + j7;
            iArr3[i7] = (int) j17;
            j7 = j17 >>> 32;
            i = i2;
            j6 = j8;
    ...
    public static int mulWordAddExt(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        iArr2[i7] = (int) j6;
        int i8 = i3 + 5;
        long j7 = (j6 >>> 32) + (j * (((long) iArr[i2 + 5]) & BodyPartID.bodyIdMax)) + (((long) iArr2[i8]) & BodyPartID.bodyIdMax);
        iArr2[i8] = (int) j7;
        return (int) (j7 >>> 32);
    }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i32 = i31 >>> 31;
                int i33 = i2 + 11;
                iArr2[i33] = i32 | ((iArr2[i33] + ((int) (j51 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[4] = (int) j5;
        long j6 = (j5 >> 32) + ((((long) iArr2[5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[5])));
        iArr2[5] = (int) j6;
        return (int) (j6 >> 32);
    }
