...
public abstract class Nat {
    public static int add(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((long) iArr[i2]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i2]));
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        long j = (((long) iArr[i3]) & BodyPartID.bodyIdMax) + (((long) i2) & BodyPartID.bodyIdMax);
        iArr[i3] = (int) j;
        int i4 = i3 + 1;
        long j2 = (j >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[i4])) + 1;
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) iArr[i5]) & BodyPartID.bodyIdMax) + (((long) i2) & BodyPartID.bodyIdMax);
        iArr[i5] = (int) j;
        int i6 = i5 + 1;
        long j2 = (j >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[i6])) + 1;
        iArr[i6] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i, int i2, int[] iArr) {
        long j = (((long) iArr[0]) & BodyPartID.bodyIdMax) + (((long) i2) & BodyPartID.bodyIdMax);
        iArr[0] = (int) j;
        long j2 = (j >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[1])) + 1;
        iArr[1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax) + (((long) iArr2[i3 + i5]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr3[i6]));
            iArr3[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addBothTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((long) iArr[i2]) & BodyPartID.bodyIdMax) + (((long) iArr2[i2]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr3[i2]));
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        long j2 = (((long) iArr[i2]) & BodyPartID.bodyIdMax) + (j & BodyPartID.bodyIdMax);
        iArr[i2] = (int) j2;
        int i3 = i2 + 1;
        long j3 = (j2 >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[i3])) + (j >>> 32);
        iArr[i3] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        int i4 = i2 + i3;
        long j2 = (((long) iArr[i4]) & BodyPartID.bodyIdMax) + (j & BodyPartID.bodyIdMax);
        iArr[i4] = (int) j2;
        int i5 = i4 + 1;
        long j3 = (j2 >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[i5])) + (j >>> 32);
        iArr[i5] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i, long j, int[] iArr) {
        long j2 = (((long) iArr[0]) & BodyPartID.bodyIdMax) + (j & BodyPartID.bodyIdMax);
        iArr[0] = (int) j2;
        long j3 = (j2 >>> 32) + (BodyPartID.bodyIdMax & ((long) iArr[1])) + (j >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = j + (((long) iArr[i2 + i4]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i5]));
            iArr2[i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        long j = ((long) i4) & BodyPartID.bodyIdMax;
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i3 + i5;
            long j2 = j + (((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax) + (((long) iArr2[i6]) & BodyPartID.bodyIdMax);
            iArr2[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i2 + i4;
            int i6 = i3 + i4;
            long j2 = j + (((long) iArr[i5]) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr2[i6]));
            int i7 = (int) j2;
            iArr[i5] = i7;
            iArr2[i6] = i7;
            j = j2 >>> 32;
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (((long) i2) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr[i3]));
        iArr[i3] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        ...
        int i5 = i3 + i4;
        long j2 = j + (BodyPartID.bodyIdMax & ((long) iArr[i5]));
        iArr[i5] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i, int i2, int[] iArr) {
        long j = (((long) i2) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) iArr[0]));
        iArr[0] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int cadd(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = ((long) (-(i2 & 1))) & BodyPartID.bodyIdMax;
        long j2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + (((long) iArr[i3]) & BodyPartID.bodyIdMax) + (((long) iArr2[i3]) & j);
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        long j2 = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j3 = j2 + ((((long) iArr[i3 + i6]) & BodyPartID.bodyIdMax) - (((long) iArr2[i4 + i6]) & j));
            iArr3[i5 + i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static boolean m2099eq(int i, int[] iArr, int[] iArr2) {
        for (int i2 = i - 1; i2 >= 0; i2--) {
            if (iArr[i2] != iArr2[i2]) {
                return false;
            }
    ...
    public static int lessThan(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            j = (j + ((((long) iArr[i2 + i4]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr2[i3 + i4])))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int lessThan(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            j = (j + ((((long) iArr[i2]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr2[i2])))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j4 = j3 + ((((long) iArr[i5]) & BodyPartID.bodyIdMax) * j) + ((((long) iArr2[i5]) & BodyPartID.bodyIdMax) * j2) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
            iArr3[i6] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4)) & BodyPartID.bodyIdMax) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & BodyPartID.bodyIdMax) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j2 + ((((long) iArr[i3 + i5]) & BodyPartID.bodyIdMax) * j);
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j3 = j2 + ((((long) iArr[i3 + i5]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i6]) & BodyPartID.bodyIdMax);
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        ...
        long j3 = ((j & BodyPartID.bodyIdMax) * j2) + (((long) iArr[i3]) & BodyPartID.bodyIdMax);
        iArr[i3] = (int) j3;
        long j4 = j2 * (j >>> 32);
        int i4 = i3 + 1;
        long j5 = (j3 >>> 32) + j4 + (((long) iArr[i4]) & BodyPartID.bodyIdMax);
        iArr[i4] = (int) j5;
        int i5 = i3 + 2;
        long j6 = (j5 >>> 32) + (((long) iArr[i5]) & BodyPartID.bodyIdMax);
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) == 0) {
            return 0;
        }
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        do {
            i7--;
            long j = ((long) iArr[i2 + i7]) & BodyPartID.bodyIdMax;
            long j2 = j * j;
        ...
        long j3 = 0;
        for (i4 = 1; i4 < i; i4++) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, i4, iArr2, i3)) & BodyPartID.bodyIdMax) + (((long) iArr2[i9]) & BodyPartID.bodyIdMax);
            int i10 = i9 + 1;
            iArr2[i9] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (((long) iArr2[i10]) & BodyPartID.bodyIdMax);
            i9 += 2;
            iArr2[i10] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        while (true) {
            i4--;
            long j = ((long) iArr[i4]) & BodyPartID.bodyIdMax;
            long j2 = j * j;
        ...
        int i8 = 2;
        for (i2 = 1; i2 < i; i2++) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, iArr2)) & BodyPartID.bodyIdMax) + (((long) iArr2[i8]) & BodyPartID.bodyIdMax);
            int i9 = i8 + 1;
            iArr2[i8] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (((long) iArr2[i9]) & BodyPartID.bodyIdMax);
            i8 += 2;
            iArr2[i9] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        long j = ((long) iArr[i + i2]) & BodyPartID.bodyIdMax;
        int i4 = 0;
        long j2 = 0;
        int i5 = i3;
        do {
            int i6 = i2 + i5;
            long j3 = j2 + ((((long) iArr[i + i4]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i6]) & BodyPartID.bodyIdMax);
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i3 = i + i2;
            long j3 = j2 + ((((long) iArr[i2]) & BodyPartID.bodyIdMax) * j) + (((long) iArr2[i3]) & BodyPartID.bodyIdMax);
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int sub(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + ((((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr2[i3 + i5])));
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i5;
            long j2 = j + (((((long) iArr3[i6]) & BodyPartID.bodyIdMax) - (((long) iArr[i2 + i5]) & BodyPartID.bodyIdMax)) - (BodyPartID.bodyIdMax & ((long) iArr2[i3 + i5])));
            iArr3[i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((((long) iArr3[i2]) & BodyPartID.bodyIdMax) - (((long) iArr[i2]) & BodyPartID.bodyIdMax)) - (BodyPartID.bodyIdMax & ((long) iArr2[i2])));
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = j + ((((long) iArr2[i5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[i2 + i4])));
            iArr2[i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + ((((long) iArr2[i2]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) iArr[i2])));
            iArr2[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (((long) iArr[i3]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) i2));
        iArr[i3] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) iArr[i5]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) i2));
        iArr[i5] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordFrom(int i, int i2, int[] iArr) {
        long j = (((long) iArr[0]) & BodyPartID.bodyIdMax) - (BodyPartID.bodyIdMax & ((long) i2));
        iArr[0] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
