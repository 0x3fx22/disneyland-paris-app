...
public abstract class Mont256 {
    ...
    public static void multAdd(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i) {
        ...
        while (i2 < 8) {
            ...
            long j6 = j;
            long j7 = ((long) (((int) j5) * i)) & BodyPartID.bodyIdMax;
            int i4 = i2;
            int i5 = i3;
            long j8 = (((long) iArr4[c]) & BodyPartID.bodyIdMax) * j7;
            char c2 = ' ';
            long j9 = ((j5 + (j8 & BodyPartID.bodyIdMax)) >>> 32) + (j4 >>> 32) + (j8 >>> 32);
            int i6 = 1;
            while (i6 < 8) {
                long j10 = (((long) iArr2[i6]) & BodyPartID.bodyIdMax) * j3;
                long j11 = (((long) iArr4[i6]) & BodyPartID.bodyIdMax) * j7;
                long j12 = j9 + (j10 & BodyPartID.bodyIdMax) + (j11 & BodyPartID.bodyIdMax) + (((long) iArr3[i6]) & BodyPartID.bodyIdMax);
                iArr3[i6 - 1] = (int) j12;
            ...
            long j13 = j9 + (((long) i5) & BodyPartID.bodyIdMax);
            iArr3[7] = (int) j13;
            i3 = (int) (j13 >>> c2);
            i2 = i4 + 1;
            j = j6;
    ...
    public static void multAddXF(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
        ...
        while (true) {
            ...
            for (int i4 = 8; i3 < i4; i4 = 8) {
                long j6 = j;
                long j7 = (((long) iArr2[i3]) & BodyPartID.bodyIdMax) * j2;
                long j8 = (((long) iArr4[i3]) & BodyPartID.bodyIdMax) * j4;
                long j9 = j5 + (j7 & BodyPartID.bodyIdMax) + (j8 & BodyPartID.bodyIdMax) + (((long) iArr3[i3]) & BodyPartID.bodyIdMax);
                iArr3[i3 - 1] = (int) j9;
            ...
            long j10 = j5 + (((long) i2) & BodyPartID.bodyIdMax);
            iArr3[7] = (int) j10;
            i2 = (int) (j10 >>> 32);
            i++;
            j = j;
    ...
    public static void reduce(int[] iArr, int[] iArr2, int i) {
        ...
        while (i2 < 8) {
            ...
            int i4 = 1;
            while (i4 < 8) {
                long j3 = j2 + ((((long) iArr2[i4]) & BodyPartID.bodyIdMax) * j) + (((long) iArr[i4]) & BodyPartID.bodyIdMax);
                iArr[i4 - 1] = (int) j3;
                j2 = j3 >>> 32;
                i4++;
                i2 = i2;
    ...
    public static void reduceXF(int[] iArr, int[] iArr2) {
        for (int i = 0; i < 8; i++) {
            ...
            for (int i2 = 1; i2 < 8; i2++) {
                long j3 = j2 + ((((long) iArr2[i2]) & BodyPartID.bodyIdMax) * j) + (((long) iArr[i2]) & BodyPartID.bodyIdMax);
                iArr[i2 - 1] = (int) j3;
                j2 = j3 >>> 32;
            }
            iArr[7] = (int) j2;
