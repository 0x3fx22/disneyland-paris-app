...
public class BOMInputStream extends ProxyInputStream {
    private static final Comparator ByteOrderMarkLengthComparator = new Comparator() { // from class: org.apache.commons.io.input.BOMInputStream.1
    ...
    public BOMInputStream(InputStream inputStream, boolean z, ByteOrderMark... byteOrderMarkArr) {
        ...
        this.include = z;
        List listAsList = Arrays.asList(byteOrderMarkArr);
    ...
    @Override // org.apache.commons.p168io.input.ProxyInputStream, java.io.FilterInputStream, java.io.InputStream
