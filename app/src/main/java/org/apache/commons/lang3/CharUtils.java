...
public class CharUtils {
    ...
    public static final char f3982CR = '\r';

    /* JADX INFO: renamed from: LF */
    public static final char f3983LF = '\n';
    ...
    private static final String[] CHAR_STRING_ARRAY = (String[]) ArrayUtils.setAll(new String[128], new IntFunction() { // from class: org.apache.commons.lang3.CharUtils$$ExternalSyntheticLambda0
        ...
        public final Object apply(int i) {
            return CharUtils.lambda$static$0(i);
        }
    });
    ...
    public static char toChar(Character ch2, char c) {
        return ch2 != null ? ch2.charValue() : c;
    }
    ...
    public static int toIntValue(Character ch2, int i) {
        return ch2 != null ? toIntValue(ch2.charValue(), i) : i;
    }
