...
public class Range<T> implements Serializable {
    ...
    public static Range between(Comparable comparable, Comparable comparable2) {
        return m1951of(comparable, comparable2, null);
    }
    ...
    public static Range m1948is(Comparable comparable) {
        return m1951of(comparable, comparable, null);
    }

    /* JADX INFO: renamed from: is */
    public static <T> Range<T> m1949is(T t, Comparator<T> comparator) {
        return m1951of(t, t, comparator);
    }

    /* JADX WARN: Incorrect types in method signature: <T::Ljava/lang/Comparable<-TT;>;>(TT;TT;)Lorg/apache/commons/lang3/Range<TT;>; */
    /* JADX INFO: renamed from: of */
    public static Range m1950of(Comparable comparable, Comparable comparable2) {
        return m1951of(comparable, comparable2, null);
    }

    /* JADX INFO: renamed from: of */
    public static <T> Range<T> m1951of(T t, T t2, Comparator<T> comparator) {
        return new Range<>(t, t2, comparator);
    }

    Range(Object obj, Object obj2, Comparator comparator) {
    ...
    public T fit(T t) {
        ...
        return isBefore(t) ? (T) this.maximum : t;
    }
    ...
    public Range<T> intersectionWith(Range<T> range) {
        ...
        return m1951of(getComparator().compare(this.minimum, range.minimum) < 0 ? range.minimum : this.minimum, getComparator().compare(this.maximum, range.maximum) < 0 ? this.maximum : range.maximum, getComparator());
    }
