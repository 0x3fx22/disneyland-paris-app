...
public abstract class Pair<L, R> implements Map.Entry<L, R>, Comparable<Pair<L, R>>, Serializable {
    ...
    public static <L, R> Pair<L, R> m1982of(L l, R r) {
        return ImmutablePair.m1976of((Object) l, (Object) r);
    }

    /* JADX INFO: renamed from: of */
    public static <L, R> Pair<L, R> m1983of(Map.Entry<L, R> entry) {
        return ImmutablePair.m1977of((Map.Entry) entry);
    }
