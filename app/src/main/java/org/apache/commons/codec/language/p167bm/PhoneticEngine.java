package org.apache.commons.codec.language.p167bm;
...
public class PhoneticEngine {
    ...
    static final class PhonemeBuilder {
        ...
        /* synthetic */ PhonemeBuilder(Set set, C75241 c75241) {
            this(set);
        }
    ...
    private static final class RulesApplication {
        ...
        public RulesApplication invoke() {
            ...
            int i2 = this.f3973i;
            List<Rule> list = (List) map.get(charSequence.subSequence(i2, i2 + 1));
            if (list != null) {
                i = 1;
                for (Rule rule : list) {
                    int length = rule.getPattern().length();
                    if (rule.patternAndContextMatches(this.input, this.f3973i)) {
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        int i = C75241.$SwitchMap$org$apache$commons$codec$language$bm$NameType[this.nameType.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: org.apache.commons.codec.language.bm.PhoneticEngine$1 */
    static /* synthetic */ class C75241 {
