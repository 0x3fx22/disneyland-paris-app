...
@Metadata(m1835d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0012\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002\u001a\u001e\u0010\u0003\u001a\u00020\u0002*\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0005¨\u0006\u0007"}, m1836d2 = {"commonAsUtf8ToByteArray", "", "", "commonToUtf8String", "beginIndex", "", "endIndex", "okio"}, m1837k = 2, m1838mv = {1, 9, 0}, m1840xi = 48)
            ...
            if (b2 >= 0) {
                ...
                if (i2 <= i15) {
                    ...
                    if ((b4 & 192) == 128) {
                        byte b5 = bArr[i15];
                        if ((b5 & 192) == 128) {
                            int i18 = ((b5 ^ (-123008)) ^ (b4 << 6)) ^ (b2 << Ascii.f3524FF);
                            if (i18 < 2048) {
                                i5 = i11 + 1;
                                cArr[i11] = (char) Utf8.REPLACEMENT_CODE_POINT;
                    ...
                    if (i2 <= i19) {
                        ...
                        if ((b6 & 192) == 128) {
                            ...
                            if ((b7 & 192) == 128) {
                                byte b8 = bArr[i19];
                                if ((b8 & 192) == 128) {
                                    int i22 = (((b8 ^ 3678080) ^ (b7 << 6)) ^ (b6 << Ascii.f3524FF)) ^ (b2 << Ascii.DC2);
                                    if (i22 > 1114111) {
                                        i8 = i11 + 1;
                                        cArr[i11] = Utf8.REPLACEMENT_CHARACTER;
