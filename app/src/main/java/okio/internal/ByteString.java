...
public final class ByteString {
    ...
    public static final String commonHex(@NotNull okio.ByteString byteString) {
        ...
        for (byte b : byteString.getData()) {
            ...
            i += 2;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & Ascii.f3531SI];
        }
        ...
        while (i3 < length) {
            ...
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    ...
                    int i10 = ((b4 << 6) ^ ((-123008) ^ b5)) ^ (b2 << Ascii.f3524FF);
                    if (i10 < 2048) {
                        if (i5 == i) {
                            return i4;
                        }
                    ...
                    int i12 = (((b8 ^ 3678080) ^ (b7 << 6)) ^ (b6 << Ascii.f3524FF)) ^ (b2 << Ascii.DC2);
                    if (i12 > 1114111) {
                        if (i5 == i) {
                            return i4;
                        }
