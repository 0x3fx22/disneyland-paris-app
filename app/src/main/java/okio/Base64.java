...
@Metadata(m1835d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0012\n\u0002\b\b\n\u0002\u0010\u000e\n\u0002\b\u0003\u001a\u000e\u0010\t\u001a\u0004\u0018\u00010\u0001*\u00020\nH\u0000\u001a\u0016\u0010\u000b\u001a\u00020\n*\u00020\u00012\b\b\u0002\u0010\f\u001a\u00020\u0001H\u0000\"\u001c\u0010\u0000\u001a\u00020\u00018\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0002\u0010\u0003\u001a\u0004\b\u0004\u0010\u0005\"\u001c\u0010\u0006\u001a\u00020\u00018\u0000X\u0081\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0007\u0010\u0003\u001a\u0004\b\b\u0010\u0005¨\u0006\r"}, m1836d2 = {"BASE64", "", "getBASE64$annotations", "()V", "getBASE64", "()[B", "BASE64_URL_SAFE", "getBASE64_URL_SAFE$annotations", "getBASE64_URL_SAFE", "decodeBase64ToArray", "", "encodeBase64", "map", "okio"}, m1837k = 2, m1838mv = {1, 9, 0}, m1840xi = 48)
@JvmName(name = "-Base64")
public final class Base64 {
    ...
    public static final String encodeBase64(@NotNull byte[] bArr, @NotNull byte[] map) {
        ...
        while (i < length) {
            ...
            int i4 = i2 + 3;
            bArr2[i2 + 2] = map[((b2 & Ascii.f3531SI) << 2) | ((b3 & 255) >> 6)];
            i2 += 4;
        ...
        if (length2 == 1) {
            ...
            bArr2[i2 + 2] = kotlin.p163io.encoding.Base64.padSymbol;
            bArr2[i2 + 3] = kotlin.p163io.encoding.Base64.padSymbol;
        } else if (length2 == 2) {
            int i5 = i + 1;
            byte b5 = bArr[i];
            byte b6 = bArr[i5];
            ...
            bArr2[i2 + 2] = map[(b6 & Ascii.f3531SI) << 2];
            bArr2[i2 + 3] = kotlin.p163io.encoding.Base64.padSymbol;
        }
