...
public final class C8443SegmentedByteString extends ByteString {
    ...
    public C8443SegmentedByteString(@NotNull byte[][] segments, @NotNull int[] directory) {
