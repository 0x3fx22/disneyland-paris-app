...
public final class Response implements Closeable {
    ...
    public final CacheControl m6173deprecated_cacheControl() {
        return cacheControl();
    }
