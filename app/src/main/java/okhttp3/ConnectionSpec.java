...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m6082deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m6084deprecated_tlsVersions() {
        return tlsVersions();
    }
