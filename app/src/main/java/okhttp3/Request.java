...
public final class Request {
    ...
    @JvmName(name = TCEventPropertiesNames.TCE_METHOD)
    @NotNull
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = TCEventPropertiesNames.TCE_METHOD, imports = {}))
    ...
    public final CacheControl m6168deprecated_cacheControl() {
        return cacheControl();
    }
